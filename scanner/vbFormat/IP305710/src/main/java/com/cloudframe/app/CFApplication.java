...
/**
 * The Ip305710 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Ip305710 ip305710 = (Ip305710) context.getBean("ip305710");
        	    ip305710.process(new GlobalExecutorCtx().getContext(Ip305710Ctx.class)); /*  Ip305710 requires no input parameters  */
