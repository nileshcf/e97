  ...
  @Component("ar648010")
  public class Ar648010Impl extends BaseProcess implements Ar648010 {
  	Logger logger = LoggerFactory.getLogger(Ar648010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ar648010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
