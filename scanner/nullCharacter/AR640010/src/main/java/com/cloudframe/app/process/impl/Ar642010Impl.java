  ...
  @Component("ar642010")
  public class Ar642010Impl extends BaseProcess implements Ar642010 {
  	Logger logger = LoggerFactory.getLogger(Ar642010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ar642010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
