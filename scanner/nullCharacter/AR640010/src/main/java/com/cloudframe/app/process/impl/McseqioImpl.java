  ...
  @Component("mcseqio")
  public class McseqioImpl extends BaseProcess implements Mcseqio {
  	Logger logger = LoggerFactory.getLogger(McseqioImpl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Mcseqioimpl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
