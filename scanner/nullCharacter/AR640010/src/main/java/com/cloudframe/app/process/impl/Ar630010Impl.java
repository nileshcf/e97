  ...
  @Component("ar630010")
  public class Ar630010Impl extends BaseProcess implements Ar630010 {
  	Logger logger = LoggerFactory.getLogger(Ar630010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ar630010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
