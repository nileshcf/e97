...
**/
    public void selectTaraxtk(Messages600 messages600, Taraxtk taraxtk, Itaraxtk itaraxtk, Sqlca sqlca) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
...
**/
    public void selectTarafxs13(ReqWorkAreas810 reqWorkAreas810, Tarafxs tarafxs, CharacterLiterals320 characterLiterals320, Sqlca sqlca, SqlWorkAreas840 sqlWorkAreas840) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
...
**/
    public void fetchFxaResetRowAr640010(Itarafxa itarafxa, Sqlca sqlca, Tarafxa tarafxa) throws Exception {
try {
...
**/
    public void updateTarafxs1(Tarafxs tarafxs, Itarafxs itarafxs, Sqlca sqlca, SqlWorkAreas840 sqlWorkAreas840) throws Exception {
...
**/
    public void selectTaraept12(ReqWorkAreas810 reqWorkAreas810, Tarafpl tarafpl, Sqlca sqlca) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
