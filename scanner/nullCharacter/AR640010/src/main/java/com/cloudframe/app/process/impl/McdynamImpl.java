  ...
  @Component("mcdynam")
  public class McdynamImpl extends BaseProcess implements Mcdynam {
  	Logger logger = LoggerFactory.getLogger(McdynamImpl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Mcdynamimpl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
