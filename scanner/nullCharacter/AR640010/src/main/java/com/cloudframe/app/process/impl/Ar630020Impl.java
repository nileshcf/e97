  ...
  @Component("ar630020")
  public class Ar630020Impl extends BaseProcess implements Ar630020 {
  	Logger logger = LoggerFactory.getLogger(Ar630020Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ar630020impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
