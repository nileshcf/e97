  ...
  @Component("ar649010")
  public class Ar649010Impl extends BaseProcess implements Ar649010 {
  	Logger logger = LoggerFactory.getLogger(Ar649010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ar649010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
