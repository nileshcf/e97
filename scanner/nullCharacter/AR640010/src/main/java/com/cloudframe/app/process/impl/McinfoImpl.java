  ...
  @Component("mcinfo")
  public class McinfoImpl extends BaseProcess implements Mcinfo {
  	Logger logger = LoggerFactory.getLogger(McinfoImpl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Mcinfoimpl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
