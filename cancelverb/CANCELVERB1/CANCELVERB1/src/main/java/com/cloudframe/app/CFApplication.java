...
/**
 * The C88comm application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		C88comm c88comm = (C88comm) context.getBean("c88comm");
        	    c88comm.process(new GlobalExecutorCtx().getContext(C88commCtx.class)); /*  C88comm requires no input parameters  */
