  ...
  @Component("called3")
  public class Called3Impl extends BaseProcess implements Called3 {
  	Logger logger = LoggerFactory.getLogger(Called3Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Called3impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
