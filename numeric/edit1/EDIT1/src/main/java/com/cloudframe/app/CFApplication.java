...
/**
 * The Edit1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Edit1 edit1 = (Edit1) context.getBean("edit1");
        	    edit1.process(new GlobalExecutorCtx().getContext(Edit1Ctx.class)); /*  Edit1 requires no input parameters  */
