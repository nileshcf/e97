...
/**
 * The Numeric0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Numeric0 numeric0 = (Numeric0) context.getBean("numeric0");
        	    numeric0.process(new GlobalExecutorCtx().getContext(Numeric0Ctx.class)); /*  Numeric0 requires no input parameters  */
