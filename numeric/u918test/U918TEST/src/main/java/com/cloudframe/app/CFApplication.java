...
/**
 * The U918test application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		U918test u918test = (U918test) context.getBean("u918test");
        	    u918test.process(new GlobalExecutorCtx().getContext(U918testCtx.class)); /*  U918test requires no input parameters  */
