...
/**
 * The Multi0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Multi0 multi0 = (Multi0) context.getBean("multi0");
        	    multi0.process(new GlobalExecutorCtx().getContext(Multi0Ctx.class)); /*  Multi0 requires no input parameters  */
