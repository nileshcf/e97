...
public class Src166GrpSerialized  extends Field { 
	...
	protected static final int SRC_166_GRP_LENGTH = 40;
	...
	**/
	...
	protected static final int SRC_166_LEN = 4;
    /**
	 * 	serialize this Src166 as String
	 *  @param index
	 *	@param value
	 */
	protected void serializeSrc166(int index, int value) {
           int number = value;
           replaceValue( getBinaryString(number) , (beginSrc166 + index*SRC_166_LEN), SRC_166_LEN);
   }
