...
/**
 * The Divide0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Divide0 divide0 = (Divide0) context.getBean("divide0");
        	    divide0.process(new GlobalExecutorCtx().getContext(Divide0Ctx.class)); /*  Divide0 requires no input parameters  */
