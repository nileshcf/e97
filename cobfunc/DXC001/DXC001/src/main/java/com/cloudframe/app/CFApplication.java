...
/**
 * The Dxc001 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Dxc001 dxc001 = (Dxc001) context.getBean("dxc001");
        	    dxc001.process(new GlobalExecutorCtx().getContext(Dxc001Ctx.class)); /*  Dxc001 requires no input parameters  */
