package com.cloudframe.app.mc081.file;
...
import com.cloudframe.app.mc081.file.records.*;

@Component("mc081_fbFile")
public class FbFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(FbFile.class);
	
	@Value("${MC081.FbFile:FBFILE}")
    ...
    **/
	@Value("${MC081.FbFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MC081.FbFileCRLFflag:no}")
	private String crlfFlag;

	public String getFbFileCharSet() {
		return charSet;
	}
	
	public String getFbFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during FbFile Write: {}",e.getMessage() ); 		}
	}
