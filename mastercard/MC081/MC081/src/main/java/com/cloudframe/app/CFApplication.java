...
/**
 * The Mc081 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mc081 mc081 = (Mc081) context.getBean("mc081");
        	    mc081.process(new GlobalExecutorCtx().getContext(Mc081Ctx.class)); /*  Mc081 requires no input parameters  */
