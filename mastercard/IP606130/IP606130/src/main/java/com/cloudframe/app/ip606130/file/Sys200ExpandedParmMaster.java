...
@Component("ip606130_sys200ExpandedParmMaster")
public class Sys200ExpandedParmMaster extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys200ExpandedParmMaster.class);
	
	@Value("${IP606130.Sys200ExpandedParmMaster:SYS200}")
    ...
    **/
	@Value("${IP606130.Sys200ExpandedParmMasterCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP606130.Sys200ExpandedParmMasterCRLFflag:no}")
	private String crlfFlag;

	public String getSys200ExpandedParmMasterCharSet() {
		return charSet;
	}
	
	public String getSys200ExpandedParmMasterCrlfFlag() {
		return crlfFlag;
	}

	public Sys200ExpandedParmMaster()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys200ExpandedParmMaster Write: {}",e.getMessage() ); 		}
	}
