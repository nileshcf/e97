...
/**
*  The class Sys105TempTable90Rec is used to handle fields declared in it
...
public class Sys105TempTable90Rec extends Sys105TempTable90RecSerialized {
   
      private List<char[]> filler1; 

	
	/**
	* Constructor for Sys105TempTable90Rec
	**/
    public Sys105TempTable90Rec() {
		super();
   ...
   private void setFiller1(int index,char[] value,boolean setModified) {
	...
	// String array will always read from stringValue so no need to explicitly set the array item
  	if (setModified) {
		...
		public static int getSys105TempTable90RecFieldLength() {
			return SYS_105_TEMP_TABLE_90_REC_LENGTH;
		}
