...
/**
*  The class Sys001ReducedParmMasterRec is used to handle fields declared in it
...
public class Sys001ReducedParmMasterRec extends Sys001ReducedParmMasterRecSerialized {
   
      private List<char[]> filler; 

	
	/**
	* Constructor for Sys001ReducedParmMasterRec
	**/
    public Sys001ReducedParmMasterRec() {
		super();
   ...
   private void setFiller(int index,char[] value,boolean setModified) {
	...
	// String array will always read from stringValue so no need to explicitly set the array item
  	if (setModified) {
		...
		public static int getSys001ReducedParmMasterRecFieldLength() {
			return SYS_001_REDUCED_PARM_MASTER_REC_LENGTH;
		}
