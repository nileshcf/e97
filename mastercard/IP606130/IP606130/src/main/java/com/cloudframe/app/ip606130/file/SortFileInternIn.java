...
@Component("ip606130_sortFileInternIn")
public class SortFileInternIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(SortFileInternIn.class);
    ...
    **/
	...
	public void setSortFileInternInCharSet(String charSet) {
	   this.charSet = charSet;
	}
	
	private String crlfFlag;
	
	public void setSortFileInternInCRLFflag(String crlfFlag) {
	   this.crlfFlag = crlfFlag;
	}

	public String getSortFileInternInCharSet() {
		return charSet;
	}
	
	public String getSortFileInternInCrlfFlag() {
		return crlfFlag;
	}
	public SortFileInternIn()
	{
		setVariableBlockFile(true);	
		setRecord(new byte[32752]);
		setFileName("SortFileInternIn");
		setSortFileInternInCharSet("cp1047");
		setSortFileInternInCRLFflag("no");
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during SortFileInternIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
