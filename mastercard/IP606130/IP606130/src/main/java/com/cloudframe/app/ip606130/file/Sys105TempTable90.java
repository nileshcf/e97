...
@Component("ip606130_sys105TempTable90")
public class Sys105TempTable90 extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys105TempTable90.class);
	
	@Value("${IP606130.Sys105TempTable90:SYS105}")
    ...
    **/
	@Value("${IP606130.Sys105TempTable90CharSet:cp1047}")
	private String charSet;
	
	@Value("${IP606130.Sys105TempTable90CRLFflag:no}")
	private String crlfFlag;

	public String getSys105TempTable90CharSet() {
		return charSet;
	}
	
	public String getSys105TempTable90CrlfFlag() {
		return crlfFlag;
	}

	public Sys105TempTable90()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys105TempTable90 Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys105TempTable90 Write: {}",e.getMessage() ); 		}
	}
