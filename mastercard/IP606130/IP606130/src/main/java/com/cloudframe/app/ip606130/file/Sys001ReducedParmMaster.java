...
@Component("ip606130_sys001ReducedParmMaster")
public class Sys001ReducedParmMaster extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001ReducedParmMaster.class);
	
	@Value("${IP606130.Sys001ReducedParmMaster:SYS001}")
    ...
    **/
	@Value("${IP606130.Sys001ReducedParmMasterCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP606130.Sys001ReducedParmMasterCRLFflag:no}")
	private String crlfFlag;

	public String getSys001ReducedParmMasterCharSet() {
		return charSet;
	}
	
	public String getSys001ReducedParmMasterCrlfFlag() {
		return crlfFlag;
	}

	public Sys001ReducedParmMaster()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001ReducedParmMaster Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
