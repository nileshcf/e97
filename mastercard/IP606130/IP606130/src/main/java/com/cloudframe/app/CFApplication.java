...
/**
 * The Ip606130 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Ip606130 ip606130 = (Ip606130) context.getBean("ip606130");
        	    ip606130.process(new GlobalExecutorCtx().getContext(Ip606130Ctx.class)); /*  Ip606130 requires no input parameters  */
