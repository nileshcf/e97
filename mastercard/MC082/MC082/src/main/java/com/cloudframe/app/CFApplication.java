...
/**
 * The Mc082 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mc082 mc082 = (Mc082) context.getBean("mc082");
        	    mc082.process(new GlobalExecutorCtx().getContext(Mc082Ctx.class)); /*  Mc082 requires no input parameters  */
