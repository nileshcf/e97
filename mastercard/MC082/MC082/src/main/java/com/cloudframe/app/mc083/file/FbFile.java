package com.cloudframe.app.mc083.file;
...
public class FbFile extends CFFile {
    ...
    **/
	@Value("${MC083.FbFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MC083.FbFileCRLFflag:no}")
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during FbFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
