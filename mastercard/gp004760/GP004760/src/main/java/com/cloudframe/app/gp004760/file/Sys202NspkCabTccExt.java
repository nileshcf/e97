package com.cloudframe.app.gp004760.file;
...
import com.cloudframe.app.gp004760.file.records.*;

@Component("gp004760_sys202NspkCabTccExt")
public class Sys202NspkCabTccExt extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys202NspkCabTccExt.class);
	
	@Value("${GP004760.Sys202NspkCabTccExt:SYS202}")
    ...
    **/
	@Value("${GP004760.Sys202NspkCabTccExtCharSet:cp1047}")
	private String charSet;
	
	@Value("${GP004760.Sys202NspkCabTccExtCRLFflag:no}")
	private String crlfFlag;

	public String getSys202NspkCabTccExtCharSet() {
		return charSet;
	}
	
	public String getSys202NspkCabTccExtCrlfFlag() {
		return crlfFlag;
	}

	public Sys202NspkCabTccExt()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[10]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys202NspkCabTccExt Write: {}",e.getMessage() ); 		}
	}
