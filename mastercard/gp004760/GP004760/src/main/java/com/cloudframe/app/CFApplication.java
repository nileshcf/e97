...
/**
 * The Gp004760 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Gp004760 gp004760 = (Gp004760) context.getBean("gp004760");
        	    gp004760.process(new GlobalExecutorCtx().getContext(Gp004760Ctx.class)); /*  Gp004760 requires no input parameters  */
