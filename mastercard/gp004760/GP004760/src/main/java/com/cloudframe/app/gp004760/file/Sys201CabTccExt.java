...
@Component("gp004760_sys201CabTccExt")
public class Sys201CabTccExt extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201CabTccExt.class);
	
	@Value("${GP004760.Sys201CabTccExt:SYS201}")
    ...
    **/
	@Value("${GP004760.Sys201CabTccExtCharSet:cp1047}")
	private String charSet;
	
	@Value("${GP004760.Sys201CabTccExtCRLFflag:no}")
	private String crlfFlag;

	public String getSys201CabTccExtCharSet() {
		return charSet;
	}
	
	public String getSys201CabTccExtCrlfFlag() {
		return crlfFlag;
	}

	public Sys201CabTccExt()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[256]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201CabTccExt Write: {}",e.getMessage() ); 		}
	}
