...
/**
 * The Mc071 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mc071 mc071 = (Mc071) context.getBean("mc071");
        	    mc071.process(new GlobalExecutorCtx().getContext(Mc071Ctx.class)); /*  Mc071 requires no input parameters  */
