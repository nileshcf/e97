package com.cloudframe.app.mc071.file;
...
import com.cloudframe.app.mc071.file.records.*;

@Component("mc071_outputFile")
public class OutputFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(OutputFile.class);
	
	@Value("${MC071.OutputFile:OUTFILE}")
    ...
    **/
	@Value("${MC071.OutputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MC071.OutputFileCRLFflag:no}")
