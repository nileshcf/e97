package com.cloudframe.app.mcfile1;
...
@Context
public class Mcfile1Ctx implements ProgramContext, Cloneable {
    ...
    public Mcfile1Ctx clone() {
        Mcfile1Ctx cloneObj = new Mcfile1Ctx();
 ...
 */
     ...
     WfOutput wfOutput = Mcfile1Ctx.this.getWfOutput();
     Output output = Mcfile1Ctx.this.getOutput();
     Work work = Mcfile1Ctx.this.getWork();
   ...
   public boolean isFirsttime() throws CFException {
      return work.isFirsttime();
   }

	/**
	*  set values "Y"
	*/
   	public void setFirsttimeTrue()  throws CFException{  			
    	work.setFirsttimeTrue();
   	}
	/**
	...
	*  @param value
	**/
   public void setFirsttimeFlag(char[] value) throws CFException {
      work.setFirsttimeFlag(value);
   } 


        public Mcfile1Ctx getMcfile1Ctx() {
            return Mcfile1Ctx.this;
        }
