package com.cloudframe.app.mcfile2.file;
...
import com.cloudframe.app.mcfile2.file.records.*;

@Component("mcfile2_flOutputFile")
public class FlOutputFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(FlOutputFile.class);
	
	@Value("${MCFILE2.FlOutputFile:OUTPDD}")
    ...
    **/
	@Value("${MCFILE2.FlOutputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MCFILE2.FlOutputFileCRLFflag:no}")
