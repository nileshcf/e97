package com.cloudframe.app.mcfile1.file;
...
import com.cloudframe.app.mcfile1.file.records.*;

@Component("mcfile1_flOutputFile")
public class FlOutputFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(FlOutputFile.class);
	
	@Value("${MCFILE1.FlOutputFile:OUTPDD}")
    ...
    **/
	@Value("${MCFILE1.FlOutputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MCFILE1.FlOutputFileCRLFflag:no}")
	private String crlfFlag;

	public String getFlOutputFileCharSet() {
		return charSet;
	}
	
	public String getFlOutputFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during FlOutputFile Write: {}",e.getMessage() ); 		}
	}
