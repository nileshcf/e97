...
/**
 * The Move0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Move0 move0 = (Move0) context.getBean("move0");
        	    move0.process(new GlobalExecutorCtx().getContext(Move0Ctx.class)); /*  Move0 requires no input parameters  */
