...
//  FETCH CCUR INTO ?
          cobpgmorRepository.fetchCcurCobpgmor(programCtx.getCcurResultSet(),methodOut.getIbook(),programCtx.getSqlca(),methodOut.getHvErec());
//  EVALUATE SQLCODE
          switch(methodOut.getSqlcode()){
          	case 0:
          break;
...
//  SELECT COUNT ( * ) FROM CLOUDFRM.TBJEMP
          cobpgmorRepository.selectTbjemp(methodOut.getWork(),programCtx.getSqlca());
//  IF SQLCODE NOT = 0
