...
/**
 * The Cobpgmor application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cobpgmor cobpgmor = (Cobpgmor) context.getBean("cobpgmor");
        	    cobpgmor.process(new GlobalExecutorCtx().getContext(CobpgmorCtx.class)); /*  Cobpgmor requires no input parameters  */
