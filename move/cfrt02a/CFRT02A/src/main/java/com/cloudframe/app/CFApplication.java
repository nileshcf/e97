...
/**
 * The Cfrt02a application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfrt02a cfrt02a = (Cfrt02a) context.getBean("cfrt02a");
        	    cfrt02a.process(new GlobalExecutorCtx().getContext(Cfrt02aCtx.class)); /*  Cfrt02a requires no input parameters  */
