...
/**
 * The Bankint1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Bankint1 bankint1 = (Bankint1) context.getBean("bankint1");
        	    bankint1.process(new GlobalExecutorCtx().getContext(Bankint1Ctx.class)); /*  Bankint1 requires no input parameters  */
