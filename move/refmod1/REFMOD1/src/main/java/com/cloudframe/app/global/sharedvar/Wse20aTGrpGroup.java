...
public class Wse20aTGrpGroup extends Wse20aTGrpGroupSerialized  implements InitializingBean {
					...
					@Getter @Setter private Wse20aTGrp wse20aTGrp = new Wse20aTGrp();

						@Getter @Setter private char[] wse20aTGrpR = Field.fillLowValue(60);
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse20aTGrp().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
