...
public class BT19 extends BT19Serialized { 
						...
						@Getter @Setter private char[] bTFld119 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld219 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld319 = Field.fillLowValue(30);
