...
public class Wse5aSGrp extends Wse5aSGrpSerialized  implements InitializingBean {
						...
						@Getter @Setter private char[] wseFiller = Field.fillLowValue(3);
				@Getter @Setter private Wse5aS wse5aS = new Wse5aS();
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse5aS().setParent(this,getStartOffset() + 3);
	   	/*  end of offset */
    }
