...
public class Wse11bT extends Wse11bTSerialized { 
						...
						@Getter @Setter private char[] wse11bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse11bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse11bTFld3 = Field.fillLowValue(30);
