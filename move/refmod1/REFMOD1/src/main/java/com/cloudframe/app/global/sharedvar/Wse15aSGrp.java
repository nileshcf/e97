...
public class Wse15aSGrp extends Wse15aSGrpSerialized  implements InitializingBean {
						...
						@Getter @Setter private char[] wseFiller028 = Field.fillLowValue(3);
				@Getter @Setter private Wse15aS wse15aS = new Wse15aS();
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse15aS().setParent(this,getStartOffset() + 3);
	   	/*  end of offset */
    }
