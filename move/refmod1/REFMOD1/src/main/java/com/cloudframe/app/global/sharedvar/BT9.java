...
public class BT9 extends BT9Serialized { 
						...
						@Getter @Setter private char[] bTFld19 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld29 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld39 = Field.fillLowValue(30);
