...
public class Wse8aTGrpGroup extends Wse8aTGrpGroupSerialized  implements InitializingBean {
					...
					@Getter @Setter private Wse8aTGrp wse8aTGrp = new Wse8aTGrp();

						@Getter @Setter private char[] wse8aTGrpR = Field.fillLowValue(60);
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse8aTGrp().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
