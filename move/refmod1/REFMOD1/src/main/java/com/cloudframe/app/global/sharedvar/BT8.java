...
public class BT8 extends BT8Serialized { 
						...
						@Getter @Setter private char[] bTFld18 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld28 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld38 = Field.fillLowValue(30);
