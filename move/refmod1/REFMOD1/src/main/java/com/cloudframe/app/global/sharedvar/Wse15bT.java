...
public class Wse15bT extends Wse15bTSerialized { 
						...
						@Getter @Setter private char[] wse15bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse15bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse15bTFld3 = Field.fillLowValue(30);
