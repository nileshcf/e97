...
public class Wse2bT extends Wse2bTSerialized { 
						...
						@Getter @Setter private char[] wse2bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse2bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse2bTFld3 = Field.fillLowValue(30);
