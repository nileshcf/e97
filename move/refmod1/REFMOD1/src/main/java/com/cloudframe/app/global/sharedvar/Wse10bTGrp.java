...
public class Wse10bTGrp extends Wse10bTGrpSerialized { 
						...
						@Getter @Setter private char[] wseFiller015 = Field.fillLowValue(5);
				@Getter @Setter private Wse10bT wse10bT = new Wse10bT();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getWse10bT().setParent(this,getStartOffset() + 5);
    } 
