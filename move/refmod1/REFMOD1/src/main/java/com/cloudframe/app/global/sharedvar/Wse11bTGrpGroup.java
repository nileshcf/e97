...
public class Wse11bTGrpGroup extends Wse11bTGrpGroupSerialized  implements InitializingBean {
					...
					@Getter @Setter private Wse11bTGrp wse11bTGrp = new Wse11bTGrp();

						@Getter @Setter private char[] wse11bTGrpR = Field.fillLowValue(60);
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse11bTGrp().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
