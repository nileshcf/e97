...
public class Wse13bTGrpGroup extends Wse13bTGrpGroupSerialized  implements InitializingBean {
					...
					@Getter @Setter private Wse13bTGrp wse13bTGrp = new Wse13bTGrp();

						@Getter @Setter private char[] wse13bTGrpR = Field.fillLowValue(60);
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse13bTGrp().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
