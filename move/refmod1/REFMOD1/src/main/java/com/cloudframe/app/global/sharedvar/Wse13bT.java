...
public class Wse13bT extends Wse13bTSerialized { 
						...
						@Getter @Setter private char[] wse13bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse13bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse13bTFld3 = Field.fillLowValue(30);
