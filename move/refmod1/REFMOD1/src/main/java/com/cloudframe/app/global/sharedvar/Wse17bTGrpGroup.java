...
public class Wse17bTGrpGroup extends Wse17bTGrpGroupSerialized  implements InitializingBean {
					...
					@Getter @Setter private Wse17bTGrp wse17bTGrp = new Wse17bTGrp();

						@Getter @Setter private char[] wse17bTGrpR = Field.fillLowValue(60);
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse17bTGrp().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
