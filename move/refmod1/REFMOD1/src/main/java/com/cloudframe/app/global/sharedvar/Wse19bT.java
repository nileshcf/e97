...
public class Wse19bT extends Wse19bTSerialized { 
						...
						@Getter @Setter private char[] wse19bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse19bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse19bTFld3 = Field.fillLowValue(30);
