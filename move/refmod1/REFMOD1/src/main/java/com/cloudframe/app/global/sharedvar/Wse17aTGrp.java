...
public class Wse17aTGrp extends Wse17aTGrpSerialized { 
						...
						@Getter @Setter private char[] wseFiller032 = Field.fillLowValue(5);
				@Getter @Setter private Wse17aT wse17aT = new Wse17aT();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getWse17aT().setParent(this,getStartOffset() + 5);
    } 
