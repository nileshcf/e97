...
public class Wse4bT extends Wse4bTSerialized { 
						...
						@Getter @Setter private char[] wse4bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse4bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse4bTFld3 = Field.fillLowValue(30);
