...
public class Wse14bT extends Wse14bTSerialized { 
						...
						@Getter @Setter private char[] wse14bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse14bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse14bTFld3 = Field.fillLowValue(30);
