...
public class BT2 extends BT2Serialized { 
						...
						@Getter @Setter private char[] bTFld12 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld22 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld32 = Field.fillLowValue(30);
