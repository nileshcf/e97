...
public class Wse10bT extends Wse10bTSerialized { 
						...
						@Getter @Setter private char[] wse10bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse10bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse10bTFld3 = Field.fillLowValue(30);
