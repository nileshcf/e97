...
public class Wse9bTGrpGroup extends Wse9bTGrpGroupSerialized  implements InitializingBean {
					...
					@Getter @Setter private Wse9bTGrp wse9bTGrp = new Wse9bTGrp();

						@Getter @Setter private char[] wse9bTGrpR = Field.fillLowValue(60);
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getWse9bTGrp().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
