...
public class Wse20aTGrp extends Wse20aTGrpSerialized { 
						...
						@Getter @Setter private char[] wseFiller038 = Field.fillLowValue(5);
				@Getter @Setter private Wse20aT wse20aT = new Wse20aT();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getWse20aT().setParent(this,getStartOffset() + 5);
    } 
