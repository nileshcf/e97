...
public class Wse213bT extends Wse213bTSerialized { 
						...
						@Getter @Setter private char[] wse213bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse213bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse213bTFld3 = Field.fillLowValue(30);
