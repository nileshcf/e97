...
public class Wse29bT extends Wse29bTSerialized { 
						...
						@Getter @Setter private char[] wse29bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse29bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse29bTFld3 = Field.fillLowValue(30);
