...
public class BT21 extends BT21Serialized {
						...
						@Getter @Setter private char[] bTFld121 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld221 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld321 = Field.fillLowValue(30);
