...
/**
 * The Refmod3 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Refmod3 refmod3 = (Refmod3) context.getBean("refmod3");
        	    refmod3.process(new GlobalExecutorCtx().getContext(Refmod3Ctx.class)); /*  Refmod3 requires no input parameters  */
