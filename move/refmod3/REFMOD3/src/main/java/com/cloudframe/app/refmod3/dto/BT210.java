...
public class BT210 extends BT210Serialized { 
						...
						@Getter @Setter private char[] bTFld1210 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld2210 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld3210 = Field.fillLowValue(30);
