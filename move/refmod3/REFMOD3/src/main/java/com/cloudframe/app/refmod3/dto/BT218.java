...
public class BT218 extends BT218Serialized { 
						...
						@Getter @Setter private char[] bTFld1218 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld2218 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld3218 = Field.fillLowValue(30);
