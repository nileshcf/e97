...
public class Wse27bT extends Wse27bTSerialized { 
						...
						@Getter @Setter private char[] wse27bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse27bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse27bTFld3 = Field.fillLowValue(30);
