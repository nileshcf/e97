...
public class Wse28bT extends Wse28bTSerialized { 
						...
						@Getter @Setter private char[] wse28bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse28bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse28bTFld3 = Field.fillLowValue(30);
