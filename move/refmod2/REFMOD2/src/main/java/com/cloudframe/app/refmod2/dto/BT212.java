...
public class BT212 extends BT212Serialized { 
						...
						@Getter @Setter private char[] bTFld1212 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld2212 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld3212 = Field.fillLowValue(30);
