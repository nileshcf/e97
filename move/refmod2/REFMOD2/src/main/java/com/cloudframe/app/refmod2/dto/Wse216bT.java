...
public class Wse216bT extends Wse216bTSerialized {
						...
						@Getter @Setter private char[] wse216bTFld1 = Field.fillLowValue(10);

						@Getter @Setter private char[] wse216bTFld2 = Field.fillLowValue(20);

						@Getter @Setter private char[] wse216bTFld3 = Field.fillLowValue(30);
