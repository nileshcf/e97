...
public class BT28 extends BT28Serialized { 
						...
						@Getter @Setter private char[] bTFld128 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld228 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld328 = Field.fillLowValue(30);
