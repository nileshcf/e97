...
public class BT216 extends BT216Serialized {
						...
						@Getter @Setter private char[] bTFld1216 = Field.fillLowValue(20);

						@Getter @Setter private char[] bTFld2216 = Field.fillLowValue(40);

						@Getter @Setter private char[] bTFld3216 = Field.fillLowValue(30);
