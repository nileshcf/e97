...
/**
 * The Refmod2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Refmod2 refmod2 = (Refmod2) context.getBean("refmod2");
        	    refmod2.process(new GlobalExecutorCtx().getContext(Refmod2Ctx.class)); /*  Refmod2 requires no input parameters  */
