package com.cloudframe.app.cfsort02.dto.serialize;
...
public class WorkSerialized  extends Field { 
   ...
   protected short checkNoMoreRecordsSwMaxLimit(long number) {
	   return (short)checkMaxLimit(number, true/*isSigned*/,2/*dataLen*/);
         ...
         int localStudentSeqNoCounter = -1;
         public boolean isStudentSeqNoModified() {
            int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
            boolean hasModified = localStudentSeqNoCounter != sharedCounter;
            localStudentSeqNoCounter = sharedCounter; return hasModified; 
         }
       
      
   protected short checkStudentSeqNoMaxLimit(long number) {
	   return (short)checkMaxLimit(number, true/*isSigned*/,2/*dataLen*/);
   }
