...
import com.cloudframe.app.process.Cfsort02;
...
/**
 * The Cfsort02 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort02 cfsort02 = (Cfsort02) context.getBean("cfsort02");
        	    cfsort02.process(new GlobalExecutorCtx().getContext(Cfsort02Ctx.class)); /*  Cfsort02 requires no input parameters  */
