package com.cloudframe.app.cfsort06.file;
...
import com.cloudframe.app.cfsort06.file.records.*;

@Component("cfsort06_workInternIn")
public class WorkInternIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(WorkInternIn.class);
    ...
    **/
	...
	public void setWorkInternInCharSet(String charSet) {
	   this.charSet = charSet;
	}
	
	private String crlfFlag;
	
	public void setWorkInternInCRLFflag(String crlfFlag) {
	   this.crlfFlag = crlfFlag;
	}

	public String getWorkInternInCharSet() {
		return charSet;
	}
	
	public String getWorkInternInCrlfFlag() {
		return crlfFlag;
	}
	public WorkInternIn()
	{
		...
		setFileName("WorkInternIn");
		setWorkInternInCharSet("cp1047");
		setWorkInternInCRLFflag("no");
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during WorkInternIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
