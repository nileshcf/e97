package com.cloudframe.app.cfsort06;
...
@Context
public class Cfsort06Ctx implements ProgramContext, Cloneable {
    ...
    public Cfsort06Ctx clone() {
        Cfsort06Ctx cloneObj = new Cfsort06Ctx();
 ...
 */
     ...
     OutputStudent outputStudent = Cfsort06Ctx.this.getOutputStudent();
     WorkStudent workStudent = Cfsort06Ctx.this.getWorkStudent();
	 ...
	 */   
	 public WorkStudent getWorkStudent() {
   	return workStudent;
        ...
        public Cfsort06Ctx getCfsort06Ctx() {
            return Cfsort06Ctx.this;
        }
    ...
    public ProcessInCtx getProcessInCtx() {
     ...
     Work work = Cfsort06Ctx.this.getWork();
     InputStudent inputStudent = Cfsort06Ctx.this.getInputStudent();
     WorkStudent workStudent = Cfsort06Ctx.this.getWorkStudent();
