...
/**
*  The class StudentNameORedefinedSerialized is used to define offsets in order to serialize
*  in a fixed String
...
public class StudentNameORedefinedSerialized  extends Field { 

    protected Logger logger = LoggerFactory.getLogger(StudentNameORedefinedSerialized.class);
	/*  Length of the field, if serialized as a String */
	protected static final int STUDENT_NAME_OREDEFINED_LENGTH = 25;
   /*  offset of each of Child Fields when serialized as a String */
            protected  int beginStudentSeqNo01;
	
	/**
	* Constructor for StudentNameORedefinedSerialized
	**/
    public StudentNameORedefinedSerialized() {
	// TO-DO auto generated code
    }
 
	/**
	* Constructor for StudentNameORedefinedSerialized. sets the parent value to the parent
	* @param parent
	* @param begin
	**/
    public StudentNameORedefinedSerialized(Field parent,int begin) {
    	   setParent(parent,begin);
    }
    
	/**
	* sets parent for this StudentNameORedefinedSerialized to the parent
	* @param parent
	**/
    @Override
	...
	**/
	...
	/**
	* initializes the field in StudentNameORedefinedSerialized
	**/
	@Override
	protected void init(int begin) {
	   setStartOffset(begin);
	   setLength(STUDENT_NAME_OREDEFINED_LENGTH);
