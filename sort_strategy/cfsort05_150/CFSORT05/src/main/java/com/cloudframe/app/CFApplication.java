...
/**
 * The Cfsort05 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort05 cfsort05 = (Cfsort05) context.getBean("cfsort05");
        	    cfsort05.process(new GlobalExecutorCtx().getContext(Cfsort05Ctx.class)); /*  Cfsort05 requires no input parameters  */
