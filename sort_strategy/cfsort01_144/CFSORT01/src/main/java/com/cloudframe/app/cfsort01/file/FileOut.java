package com.cloudframe.app.cfsort01.file;
...
import com.cloudframe.app.cfsort01.file.records.*;

@Component("cfsort01_fileOut")
public class FileOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(FileOut.class);
	
	@Value("${CFSORT01.FileOut:FILEOUT}")
    ...
    **/
	@Value("${CFSORT01.FileOutCharSet:cp1047}")
	private String charSet;
	
	@Value("${CFSORT01.FileOutCRLFflag:no}")
	private String crlfFlag;

	public String getFileOutCharSet() {
		return charSet;
	}
	
	public String getFileOutCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during FileOut Write: {}",e.getMessage() ); 		}
	}
