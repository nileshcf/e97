...
/**
 * The Cfsort01 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort01 cfsort01 = (Cfsort01) context.getBean("cfsort01");
        	    cfsort01.process(new GlobalExecutorCtx().getContext(Cfsort01Ctx.class)); /*  Cfsort01 requires no input parameters  */
