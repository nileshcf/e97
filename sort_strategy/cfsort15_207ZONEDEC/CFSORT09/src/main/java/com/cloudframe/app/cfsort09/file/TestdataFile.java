...
@Component("cfsort09_testdataFile")
public class TestdataFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(TestdataFile.class);
	
	@Value("${CFSORT09.TestdataFile:TESTDATA}")
    ...
    **/
	@Value("${CFSORT09.TestdataFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${CFSORT09.TestdataFileCRLFflag:no}")
	private String crlfFlag;

	public String getTestdataFileCharSet() {
		return charSet;
	}
	
	public String getTestdataFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during TestdataFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
