package com.cloudframe.app.mcsort01.file;
...
import com.cloudframe.app.mcsort01.file.records.*;

@Component("mcsort01_sortFileInternOut")
public class SortFileInternOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(SortFileInternOut.class);
    ...
    **/
	...
	public void setSortFileInternOutCharSet(String charSet) {
	   this.charSet = charSet;
	}
	
	private String crlfFlag;
	
	public void setSortFileInternOutCRLFflag(String crlfFlag) {
	   this.crlfFlag = crlfFlag;
	}

	public String getSortFileInternOutCharSet() {
		return charSet;
	}
	
	public String getSortFileInternOutCrlfFlag() {
		return crlfFlag;
	}
	public SortFileInternOut()
	{
		setVariableBlockFile(true);	
		setRecord(new byte[32752]);
		setFileName("SortFileInternOut");
		setSortFileInternOutCharSet("cp1047");
		setSortFileInternOutCRLFflag("no");
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during SortFileInternOut Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
