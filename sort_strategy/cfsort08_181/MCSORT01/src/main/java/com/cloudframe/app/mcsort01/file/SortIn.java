...
@Component("mcsort01_sortIn")
public class SortIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(SortIn.class);
	
	@Value("${MCSORT01.SortIn:SORTIN}")
    ...
    **/
	@Value("${MCSORT01.SortInCharSet:cp1047}")
	private String charSet;
	
	@Value("${MCSORT01.SortInCRLFflag:no}")
	private String crlfFlag;

	public String getSortInCharSet() {
		return charSet;
	}
	
	public String getSortInCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during SortIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
