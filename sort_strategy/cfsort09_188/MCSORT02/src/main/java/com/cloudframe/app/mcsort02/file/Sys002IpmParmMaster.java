...
@Component("mcsort02_sys002IpmParmMaster")
public class Sys002IpmParmMaster extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys002IpmParmMaster.class);
	
	@Value("${MCSORT02.Sys002IpmParmMaster:SYS002}")
    ...
    **/
	@Value("${MCSORT02.Sys002IpmParmMasterCharSet:cp1047}")
	private String charSet;
	
	@Value("${MCSORT02.Sys002IpmParmMasterCRLFflag:no}")
	private String crlfFlag;

	public String getSys002IpmParmMasterCharSet() {
		return charSet;
	}
	
	public String getSys002IpmParmMasterCrlfFlag() {
		return crlfFlag;
	}

	public Sys002IpmParmMaster()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys002IpmParmMaster Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
