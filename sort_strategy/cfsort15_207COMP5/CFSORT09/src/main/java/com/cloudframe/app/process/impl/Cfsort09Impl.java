...
*/
  ...
  import com.cloudframe.app.cfsort09.Cfsort09Ctx;
  import com.cloudframe.app.process.Cfsort09;
  ...
  public class Cfsort09Impl extends CommonProcess implements Cfsort09, InitializingBean, DisposableBean {
  
  Logger logger = LoggerFactory.getLogger(Cfsort09Impl.class);
  ...
  public void destroy() {
      ...
      @Override
      public int setParameter(Cfsort09Ctx programCtx, String lParmG) throws Exception {
      		if(lParmG != null)
      		    programCtx.getLParmG().setString(com.cloudframe.app.data.Field.getParm(lParmG),new String(CONSTANTS.EBCDIC_ENCODING));
      		setInitDone(false);
      		process(programCtx);
...
// *
Cfsort09Ctx programCtx = methodIn.getCfsort09Ctx();
...
//  OPEN OUTPUT DISPLAY-FILE
          ...
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
//  IF NOT ( WS-DISPLAY-FILE-STATUS = '00' )
//  LITERAL_00 = '00'
          if ((		compareChars(methodOut.getDisplayFileStatus(),CONSTANTS.LITERAL_00) != 0 )) { 
//  DISPLAY 'OPEN DISPLAY-FILE ERROR ' WS-DISPLAY-FILE-STATUS
              logger.info("OPEN DISPLAY-FILE ERROR {}", new String(methodOut.getDisplayFileStatus())); 
//  GOBACK
...
// *
          ...
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_5360028);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );

// *
//  MOVE SPACES TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.SPACE_133);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  PERFORM 0010-INIT THRU 0010-INIT-X
          init(programCtx.getInitInCtx());/*0010-INIT*/
          if (programCtx.isProgramEnded()) {
              return methodOut;
          }
//  EVALUATE TRUE
          if  ( methodIn.isLParmSortBinary()  ) { 
//  SORT SORTWORK-FILE ON ASCENDING KEY SORTWORK-KEY-BINARY USING TESTDATA-FILE OUTPUT PROCEDURE IS 2000-RETURN-RECORDS
          ...
          else if  ( methodIn.isLParmSortComp()  ) { 
//  SORT SORTWORK-FILE ON ASCENDING KEY SORTWORK-KEY-COMP USING TESTDATA-FILE OUTPUT PROCEDURE IS 2000-RETURN-RECORDS
          ...
          else if  ( methodIn.isLParmSortComp4()  ) { 
//  SORT SORTWORK-FILE ON ASCENDING KEY SORTWORK-KEY-COMP-4 USING TESTDATA-FILE OUTPUT PROCEDURE IS 2000-RETURN-RECORDS
          ...
          else if  ( methodIn.isLParmSortComp5()  ) { 
//  SORT SORTWORK-FILE ON ASCENDING KEY SORTWORK-KEY-COMP-5 USING TESTDATA-FILE OUTPUT PROCEDURE IS 2000-RETURN-RECORDS
          ...
          else if  ( methodIn.isLParmSortComp3()  ) { 
//  SORT SORTWORK-FILE ON ASCENDING KEY SORTWORK-KEY-COMP-3 USING TESTDATA-FILE OUTPUT PROCEDURE IS 2000-RETURN-RECORDS
          ...
          else if  ( methodIn.isLParmSortZoneDecimal()  ) { 
//  SORT SORTWORK-FILE ON ASCENDING KEY SORTWORK-KEY-ZONE-DEC USING TESTDATA-FILE OUTPUT PROCEDURE IS 2000-RETURN-RECORDS
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_49171558);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
          ...
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_1411716699);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
// *
Cfsort09Ctx programCtx = methodIn.getCfsort09Ctx();
InitOutCtx methodOut = methodIn.getInitOutCtx();
//  IF L-PARM-LEN < LENGTH OF L-PARM-G
          if (	( methodIn.getLParmLen() < LParmG.getLParmGFieldLength() ) ) { 
//  MOVE SPACES TO DISPLAY-RECORD
              methodOut.getDisplayRecord().setString(CONSTANTS.SPACE_133);
//  STRING 'INVALID OR MISSING PARAMETER PASSED, VALID ' 'VALUES ARE: BINARY, COMP, COMP-3, COMP-4, ' 'COMP-5, ZONE-DEC.' DELIMITED BY SIZE INTO DISPLAY-RECORD END-STRING
              ...
              updated = updateString(methodOut.getDisplayRecord().toCharArray() ,joinCharArray);
              methodOut.getDisplayRecord().setString(  (char[])updated.get("string"));
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
          ...
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_103454680);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE '1. ZONE-DECIMAL' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_537374076);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE '2. COMP-3' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_861811554);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE '3. BINARY' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_827287151);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE '4. COMP  ' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_1198439358);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE '5. COMP-4' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_823506022);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE '6. COMP-5' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_857587048);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
          // MOVE ' ' TO DISPLAY-RECORD
          methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_576124969);
//  WRITE DISPLAY-RECORD
          displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
          methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
          methodOut.setDisplayFileStatus(displayFile.getStatusString() );
//  EVALUATE TRUE
          if  ( methodIn.isLParmSortBinary()  ) { 
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_402884151);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_1043406149);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_34506612);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_1059998611);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_1768784562);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  WRITE DISPLAY-RECORD
              ...
              methodOut.getDisplayRecord().setString(CONSTANTS.LITERAL_1830681894);
//  WRITE DISPLAY-RECORD
              displayFile.write(methodOut.getDisplayRecord().toCharArray()); 
              methodOut.getDisplayRecord().setString(CONSTANTS.LOW_VALUE_215751956);
              methodOut.setDisplayFileStatus(displayFile.getStatusString() );
...
//  PERFORM VARYING J FROM 0 BY 1 UNTIL I = -1
          for (methodOut.setJ(0); (	( methodOut.getI() != -1 )) ; methodOut.setJ(methodOut.getJ() + 1) ) {
//  RETURN SORTWORK-FILE RECORD INTO W-SORTDATA-RECORD
                    if(useSortFileStrategy()) {
                      sortworkFileInternOut.read();
                      if (!sortworkFileInternOut.hasEnded()) {
                      	methodIn.getWSortdataRecord().setString(sortworkFileInternOut.getRecord());
                      }    
                  } else {
              setRecIndex(getRecIndex()+1);
              if (getRecIndex() < sortRecKeys.size() ) { 
                 if (isUsingSortInFile()) methodIn.getWSortdataRecord().setString(convertEbcdicBytes2Char(getReturnRecord(getRecIndex())));
                 else methodIn.getWSortdataRecord().setString(getReturnRecord(getRecIndex())); 
              }
              }
//  AT END
...
//  MOVE -1 TO I
              ...
              // MOVE J TO DISP-J
              methodOut.setDispJ(methodOut.getJ());
//  MOVE W-SORTDATA-KEY-ZONE-DEC TO DISP-I
//  FORMAT_467480023 = "-999999999999999999"
              methodOut.setDispI(CFUtil.cobolNumberFormatter(CONSTANTS.FORMAT_467480023,String.valueOf(methodOut.getWSortdataKeyZoneDec()).toCharArray()));
//  STRING 'RETURNED REC: ' DISP-J ' | ' 'VALUE IS: ' DISP-I ' | ' W-SORTDATA-RECORD DELIMITED BY SIZE INTO DISPLAY-RECORD END-STRING
              charArray = new ArrayList<char[]>();
                 ...
                 charArray.add(String.valueOf(methodOut.getDispJString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_32473216);
                 charArray.add(CONSTANTS.LITERAL_VALUE_B2_IS_CL_);
                 charArray.add(methodOut.getDispI());
                 charArray.add(CONSTANTS.LITERAL_32473216);
                 charArray.add(methodIn.getWSortdataRecord().toCharArray());
...
//  WRITE DISPLAY-RECORD
      ...
      Cfsort09Ctx programCtx = (Cfsort09Ctx) ctx;
      
      int len = params.length;
         if (len > 0 && params[0] != null )
            programCtx.getLParmG().set((Field)params[0]);
             ...
             switch(index) {
              case 0:
              		...
              		if (parameters[index] instanceof LParmG) {
                       	programCtx.setLParmG((LParmG) parameters[index]);
                  	} else {
                       	programCtx.getLParmG().set(parameters[index]);
                  	}
                  }
