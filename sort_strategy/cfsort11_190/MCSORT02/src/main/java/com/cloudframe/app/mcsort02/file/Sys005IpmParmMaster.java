...
@Component("mcsort02_sys005IpmParmMaster")
public class Sys005IpmParmMaster extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys005IpmParmMaster.class);
	
	@Value("${MCSORT02.Sys005IpmParmMaster:SYS005}")
    ...
    **/
	@Value("${MCSORT02.Sys005IpmParmMasterCharSet:cp1047}")
	private String charSet;
	
	@Value("${MCSORT02.Sys005IpmParmMasterCRLFflag:no}")
	private String crlfFlag;

	public String getSys005IpmParmMasterCharSet() {
		return charSet;
	}
	
	public String getSys005IpmParmMasterCrlfFlag() {
		return crlfFlag;
	}

	public Sys005IpmParmMaster()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys005IpmParmMaster Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
