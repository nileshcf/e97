...
*/
  ...
  import com.cloudframe.app.casecb01.dto.Getinventory;
  import com.cloudframe.app.casecb01.dto.Inventoryrequested;
  import java.math.BigDecimal;
  import com.cloudframe.app.utility.CFUtil;
  import com.cloudframe.app.exception.Terminate;
  import com.cloudframe.app.casecb01.dto.*;
  ...
  public class Casecb01 extends CommonProcess {
  
  Logger logger = LoggerFactory.getLogger(Casecb01.class);
  ...
  private boolean doNotSkipInitialize = true;
  private boolean doNotSkipFillInputData = true;
  private boolean doNotSkipFillInputDataSplit0 = true;
  private boolean doNotSkipFillInputDataSplit1 = true;
  private boolean doNotSkipFillInputDataSplit2 = true;
  private boolean doNotSkipDisplayResults = true;
  private boolean doNotSkipDisplayDealers = true;
  private boolean doNotSkipDisplayManufacturers = true;
  private boolean doNotSkipDisplayModels = true;
  private boolean doNotSkipDisplayColors = true;
  private boolean doNotSkipDisplayAccessories = true;
...
//  PERFORM 9999-GOBACK
  ...
  *   COBOL Paragraph - 0000-MAIN-PARAGRAPH COBOL Cyclomatic complexity - 3
      * Input  :  

      * - xmlpc103Linkage                COBOL Name: WSC-XMLPC103-LINKAGE
      * - xmlCode                        COBOL Name: XML-CODE
      *
      * Output :  

      * - xml                            COBOL Name: WS-XML
      *
      * @throws CFException
      */
...
//  PERFORM 0300-DISPLAY-RESULTS THRU 0300-EXIT
          ...
          work.setXml(CONSTANTS.SPACE_30000);
//  XML GENERATE WS-XML FROM WSC-XMLPC103-LINKAGE
          try{
          work.setXml(xmlpc103Linkage.getXml().toCharArray());
//  DISPLAY WS-XML
              logger.info(new String(work.getXml())); 
          }catch(Exception ex) {
//  DISPLAY 'XML generation error ' XML-CODE
              logger.info("XML generation error {}", String.valueOf(xmlCode)); 
...
*/
      ...
      setProgramEnded(false);
       doNotSkipInitialize = true;
       doNotSkipFillInputData = true;
       doNotSkipFillInputDataSplit0 = true;
       doNotSkipFillInputDataSplit1 = true;
       doNotSkipFillInputDataSplit2 = true;
       doNotSkipDisplayResults = true;
       doNotSkipDisplayDealers = true;
       doNotSkipDisplayManufacturers = true;
       doNotSkipDisplayModels = true;
       doNotSkipDisplayColors = true;
       doNotSkipDisplayAccessories = true;
          if(!isInitDone()) {
          	this.setRc(0);
          	setInitDone(true);
          }
