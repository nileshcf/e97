...
public class WorkSerialized  extends Field { 
   ...
   protected char[] checkEditConstraints(char[] value) {
	 ...
	 */ 
     ...
     int localXmlCounter = -1;
     public boolean isXmlModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localXmlCounter != sharedCounter;
         localXmlCounter = sharedCounter; return hasModified;
     }

   protected char[] checkXmlConstraints(char[] value) {
   			return super.checkConstraints(value , 30000 ,false, false);
   }
