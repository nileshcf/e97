...
*/
  ...
  import com.cloudframe.app.casecb01.Casecb01Ctx;
  import com.cloudframe.app.process.Casecb01;
  ...
  public class Casecb01Impl extends CommonProcess implements Casecb01 {
  
  Logger logger = LoggerFactory.getLogger(Casecb01Impl.class);
...
//  PERFORM 0000-MAIN-PARAGRAPH
          mainParagraph(programCtx.getMainParagraphInCtx());/*0000-MAIN-PARAGRAPH*/
...
Casecb01Ctx programCtx = methodIn.getCasecb01Ctx();
MainParagraphOutCtx methodOut = methodIn.getMainParagraphOutCtx();
...
//  PERFORM 0300-DISPLAY-RESULTS THRU 0300-EXIT
          ...
          methodOut.setXml(CONSTANTS.SPACE_30000);
//  XML GENERATE WS-XML FROM WSC-XMLPC103-LINKAGE
          try{
          methodOut.setXml(methodIn.getXmlpc103Linkage().getXml().toCharArray());
//  DISPLAY WS-XML
              logger.info(new String(methodOut.getXml())); 
          }catch(Exception ex) {
//  DISPLAY 'XML generation error ' XML-CODE
              logger.info("XML generation error {}", String.valueOf(programCtx.getXmlCode())); 
