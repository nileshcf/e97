...
/**
 * The Casecb01 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Casecb01 casecb01 = (Casecb01) context.getBean("casecb01");
        	    casecb01.process(new GlobalExecutorCtx().getContext(Casecb01Ctx.class)); /*  Casecb01 requires no input parameters  */
