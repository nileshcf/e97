...
/**
 * The Xmlpars2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Xmlpars2 xmlpars2 = (Xmlpars2) context.getBean("xmlpars2");
        	    xmlpars2.process(new GlobalExecutorCtx().getContext(Xmlpars2Ctx.class)); /*  Xmlpars2 requires no input parameters  */
