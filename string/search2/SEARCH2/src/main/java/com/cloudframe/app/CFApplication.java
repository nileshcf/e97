...
/**
 * The Search2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Search2 search2 = (Search2) context.getBean("search2");
        	    search2.process(new GlobalExecutorCtx().getContext(Search2Ctx.class)); /*  Search2 requires no input parameters  */
