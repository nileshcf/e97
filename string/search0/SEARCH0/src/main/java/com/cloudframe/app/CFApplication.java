...
/**
 * The Search0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Search0 search0 = (Search0) context.getBean("search0");
				...
				search0.setParameter(new GlobalExecutorCtx().getContext(Search0Ctx.class),inputValue,inputValue1,inputValue2);
