...
/**
 * The Inspct1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Inspct1 inspct1 = (Inspct1) context.getBean("inspct1");
        	    inspct1.process(new GlobalExecutorCtx().getContext(Inspct1Ctx.class)); /*  Inspct1 requires no input parameters  */
