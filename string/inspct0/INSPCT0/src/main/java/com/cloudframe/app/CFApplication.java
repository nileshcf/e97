...
/**
 * The Inspct0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Inspct0 inspct0 = (Inspct0) context.getBean("inspct0");
        	    inspct0.process(new GlobalExecutorCtx().getContext(Inspct0Ctx.class)); /*  Inspct0 requires no input parameters  */
