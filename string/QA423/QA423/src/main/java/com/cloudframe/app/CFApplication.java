...
/**
 * The Cpsc4 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cpsc4 cpsc4 = (Cpsc4) context.getBean("cpsc4");
        	    cpsc4.process(new GlobalExecutorCtx().getContext(Cpsc4Ctx.class)); /*  Cpsc4 requires no input parameters  */
