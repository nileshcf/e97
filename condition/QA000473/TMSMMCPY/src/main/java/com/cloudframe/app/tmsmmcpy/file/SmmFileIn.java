...
@Component("tmsmmcpy_smmFileIn")
public class SmmFileIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(SmmFileIn.class);
	
	@Value("${TMSMMCPY.SmmFileIn:TMSMMIN}")
    ...
    **/
	@Value("${TMSMMCPY.SmmFileInCharSet:cp1047}")
	private String charSet;
	
	@Value("${TMSMMCPY.SmmFileInCRLFflag:no}")
	private String crlfFlag;

	public String getSmmFileInCharSet() {
		return charSet;
	}
	
	public String getSmmFileInCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during SmmFileIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
