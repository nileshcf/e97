...
*/
  ...
  Logger logger = LoggerFactory.getLogger(Vp776a00Impl.class);
      ...
      @Override
      public int setParameter(Vp776a00Ctx programCtx, String dfhcommareaGroup,String srpSortRequestParameters,String sdtSortDataTableGroup) throws Exception {
...
//  PERFORM VARYING PWA-SUB1 FROM 1 BY 1 UNTIL PWA-SUB1 > PWA-LIMIT
              for (methodOut.setPwaSub1(1); (	( methodOut.getPwaSub1() <= methodOut.getPwaLimit() )) ; methodOut.setPwaSub1(methodOut.getPwaSub1() + 1) ) {
