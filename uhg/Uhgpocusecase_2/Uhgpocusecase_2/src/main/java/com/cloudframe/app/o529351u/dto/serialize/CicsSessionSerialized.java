...
/**
*  The class CicsSessionSerialized is used to define offsets in order to serialize
*  in a fixed String
...
public class CicsSessionSerialized  extends Field { 

    protected Logger logger = LoggerFactory.getLogger(CicsSessionSerialized.class);
	/*  Length of the field, if serialized as a String */
	protected static final int CICS_SESSION_LENGTH = 85;
   /*  offset of each of Child Fields when serialized as a String */
	...
	/**
	* Constructor for CicsSessionSerialized
	**/
    public CicsSessionSerialized() {
		   			init(0);
    }
 
	/**
	* initializes the field in CicsSessionSerialized
	**/
	@Override
	protected void init(int begin) {
	   setStartOffset(begin);
	   setLength(CICS_SESSION_LENGTH);
