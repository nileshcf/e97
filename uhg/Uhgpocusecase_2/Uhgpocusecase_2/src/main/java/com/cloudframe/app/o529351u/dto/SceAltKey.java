...
public class SceAltKey extends SceAltKeySerialized { 
						...
						@Getter @Setter private char[] sceAltModifier = Field.fillLowValue(1);

						@Getter @Setter private char[] sceAltToHcpcs = Field.fillLowValue(5);

								@Getter @Setter private long sceAltCancDate;
