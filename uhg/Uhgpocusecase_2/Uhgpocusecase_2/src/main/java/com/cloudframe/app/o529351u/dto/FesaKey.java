...
public class FesaKey extends FesaKeySerialized { 
						...
						@Getter @Setter private char[] fesaPolicy = Field.fillLowValue(6);

								@Getter @Setter private int fesaPlanVar;

								@Getter @Setter private int fesaEffDate;

								@Getter @Setter private int fesaSpiNbr;
