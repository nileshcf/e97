...
public class W02FnuLineStartbr extends W02FnuLineStartbrSerialized {
						...
						@Getter @Setter private char[] w02FnuTranStbr = new char[4];


						@Getter @Setter private char[] w02FnuFileStbr = Field.fillLowValue(8);


						@Getter @Setter private char[] w02FnuKeyStbr = Field.fillLowValue(38);
