...
public class HvAuthNbrGroup extends HvAuthNbrGroupSerialized {
  ...
  /**
   * set variable hvAuthNbr Corresponding COBOL Variable is HV-AUTH-NBR
   *
   * @param value
   */
  ...
  /**
   * Update HvAuthNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvAuthNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvAuthNbr(
  ...
  /**
   * Update HvAuthNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvAuthNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvAuthNbr(
