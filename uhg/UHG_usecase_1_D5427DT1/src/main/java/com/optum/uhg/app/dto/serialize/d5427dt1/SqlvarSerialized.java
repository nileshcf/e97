...
/**
 * The class SqlvarSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqlvarSerialized extends Field {
  ...
  /**
   * sets parent for this SqlvarSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
