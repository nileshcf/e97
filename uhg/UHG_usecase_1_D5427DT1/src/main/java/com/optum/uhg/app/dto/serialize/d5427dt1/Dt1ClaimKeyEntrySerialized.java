...
/**
 * The class Dt1ClaimKeyEntrySerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1ClaimKeyEntrySerialized extends Field {
  ...
  /**
   * sets parent for this Dt1ClaimKeyEntrySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDt1ClaimKeyModified() {
    ...
    localDt1ClaimKeyCounter = sharedCounter;
    return hasModified;
  }
