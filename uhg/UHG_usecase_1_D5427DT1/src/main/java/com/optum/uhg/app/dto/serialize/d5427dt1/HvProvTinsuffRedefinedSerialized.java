...
/**
 * The class HvProvTinsuffRedefinedSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvProvTinsuffRedefinedSerialized extends Field {
  ...
  /**
   * sets parent for this HvProvTinsuffRedefinedSerialized to the parent and set the serialize
  ...
  public boolean isHvProvTinModified() {
    ...
    localHvProvTinCounter = sharedCounter;
    return hasModified;
  }
