...
public class PwaPointerGroup extends PwaPointerGroupSerialized {
  ...
  /**
   * Update PwaPointer with the passed value Corresponding COBOL Variable is PWA-POINTER
   *
   * @param number
   */
  ...
  /**
   * Update PwaAddress with the passed value Corresponding COBOL Variable is PWA-ADDRESS
   *
   * @param number
   */
