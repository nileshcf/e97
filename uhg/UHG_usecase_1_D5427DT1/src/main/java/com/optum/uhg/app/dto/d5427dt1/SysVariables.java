...
public class SysVariables extends SysVariablesSerialized {
  ...
  /**
   * Update SysCvdaCicsstatus with the passed value Corresponding COBOL Variable is
   * SYS-CVDA-CICSSTATUS
   *
   * @param number
   */
  ...
  /**
   * Update SysCvdaInitstatus with the passed value Corresponding COBOL Variable is
   * SYS-CVDA-INITSTATUS
   *
   * @param number
   */
  ...
  /**
   * set variable sysDb2conn Corresponding COBOL Variable is SYS-DB2CONN
   *
   * @param value
   */
  ...
  /**
   * Update SysDb2conn with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysDb2conn with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysDb2conn(
  ...
  /**
   * Update SysDb2conn with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysDb2conn with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysDb2conn(
  ...
  /**
   * Update SysJobname with the passed value Corresponding COBOL Variable is SYS-JOBNAME
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobname(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SysJobname with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobname(
  ...
  /**
   * set variable sysMqconn Corresponding COBOL Variable is SYS-MQCONN
   *
   * @param value
   */
  ...
  /**
   * Update SysMqconn with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysMqconn with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysMqconn(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SysMqconn with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysMqconn with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysMqconn(
  ...
  /**
   * Update SysStartupdate with the passed value Corresponding COBOL Variable is SYS-STARTUPDATE
   *
   * @param number
   */
  public void setSysStartupdate(int number) {
    sysStartupdate =
        checkSysStartupdateMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * initializes SysVariables String fields defaults to Spaces short/int/long defaults to zero
