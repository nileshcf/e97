...
/**
 * The class HvSrvcCatgyCdGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvSrvcCatgyCdGroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvSrvcCatgyCdGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvSrvcCatgyCdModified() {
    ...
    localHvSrvcCatgyCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvSrvcCatgyCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvSrvcCatgyCd() {
    return (substring(
        getStringValue(), beginHvSrvcCatgyCd, beginHvSrvcCatgyCd + HV_SRVC_CATGY_CD_LEN));
  }
}
