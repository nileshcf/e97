...
public class HvNextKey extends HvNextKeySerialized {
  ...
  /**
   * set variable hvNextProcDt Corresponding COBOL Variable is HV-NEXT-PROC-DT
   *
   * @param value
   */
  ...
  /**
   * Update HvNextProcDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextProcDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextProcDt(
  ...
  /**
   * Update HvNextProcDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextProcDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextProcDt(
  ...
  /**
   * set variable hvNextProcTm Corresponding COBOL Variable is HV-NEXT-PROC-TM
   *
   * @param value
   */
  ...
  /**
   * Update HvNextProcTm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextProcTm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextProcTm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HvNextProcTm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextProcTm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextProcTm(
  ...
  /**
   * set variable hvNextPgmIdLstCharVal Corresponding COBOL Variable is HV-NEXT-PGM_ID_LST_CHAR_VAL
   *
   * @param value
   */
  ...
  /**
   * Update HvNextPgmIdLstCharVal with a char[] from an offset and length
   *
   * @param value
   */
  public void setHvNextPgmIdLstCharVal(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginHvNextPgmIdLstCharVal,
        hvNextPgmIdLstCharVal.length);
  }

  public void setHvNextPgmIdLstCharVal(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginHvNextPgmIdLstCharVal, hvNextPgmIdLstCharVal.length);
  }

  /**
   * Update HvNextPgmIdLstCharVal with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextPgmIdLstCharVal(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setHvNextPgmIdLstCharVal(Field source) {
    replace(
        source, 0, source.length(), beginHvNextPgmIdLstCharVal, HV_NEXT_PGM_ID_LST_CHAR_VAL_LEN);
  }

  /**
   * Update HvNextPgmIdLstCharVal with another Field from an offset and length
   *
   * @param value
   */
  public void setHvNextPgmIdLstCharVal(Field source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceLen,
        beginHvNextPgmIdLstCharVal,
        HV_NEXT_PGM_ID_LST_CHAR_VAL_LEN);
  }

  /**
   * Update HvNextPgmIdLstCharVal with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextIcnSufxVersNbr with the passed value Corresponding COBOL Variable is
   * HV-NEXT-ICN_SUFX_VERS_NBR
   *
   * @param number
   */
  ...
  public void setHvNextIcnSufxVersNbr(int number) {
    number =
        checkHvNextIcnSufxVersNbrMaxLimit(
  ...
  /**
   * set variable hvNextInvnCtlNbr Corresponding COBOL Variable is HV-NEXT-INVN-CTL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update HvNextInvnCtlNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextInvnCtlNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextInvnCtlNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HvNextInvnCtlNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextInvnCtlNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextInvnCtlNbr(
  ...
  /**
   * set variable hvNextIcnSufxCd Corresponding COBOL Variable is HV-NEXT-ICN_SUFX_CD
   *
   * @param value
   */
  ...
  /**
   * Update HvNextIcnSufxCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextIcnSufxCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextIcnSufxCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HvNextIcnSufxCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvNextIcnSufxCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvNextIcnSufxCd(
  ...
  /**
   * Update HvNextLnId with the passed value Corresponding COBOL Variable is HV-NEXT-LN-ID
   *
   * @param number
   */
