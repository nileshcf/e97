...
/**
 * The class HoldAreaSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class HoldAreaSerialized extends Field {
  ...
  public boolean isHldInvnCtlNbrModified() {
    ...
    localHldInvnCtlNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHldInvnCtlNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHldInvnCtlNbr() {
    return (substring(
        getStringValue(), beginHldInvnCtlNbr, beginHldInvnCtlNbr + HLD_INVN_CTL_NBR_LEN));
  }
  ...
  public boolean isHldIcnSufxCdModified() {
    ...
    localHldIcnSufxCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHldIcnSufxCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHldIcnSufxCd() {
    return (substring(
        getStringValue(), beginHldIcnSufxCd, beginHldIcnSufxCd + HLD_ICN_SUFX_CD_LEN));
  }
  ...
  public boolean isHldProcDtModified() {
    ...
    localHldProcDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isHldProcTmModified() {
    ...
    localHldProcTmCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isHldLstCharValModified() {
    ...
    localHldLstCharValCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHldLstCharVal is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHldLstCharVal() {
    return (substring(
        getStringValue(), beginHldLstCharVal, beginHldLstCharVal + HLD_LST_CHAR_VAL_LEN));
  }
  ...
  public boolean isHldIcnSufxVersNbrModified() {
    ...
    localHldIcnSufxVersNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHldIcnSufxVersNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
