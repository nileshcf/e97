...
public class HvFstDtGroup extends HvFstDtGroupSerialized {
  ...
  /**
   * set variable hvFstDt Corresponding COBOL Variable is HV-FST-DT
   *
   * @param value
   */
  ...
  /**
   * Update HvFstDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvFstDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvFstDt(
  ...
  /**
   * Update HvFstDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvFstDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvFstDt(
