...
public class Dt1ClmVariableArea extends Dt1ClmVariableAreaSerialized {
  ...
  /**
   * Returns the value of dt1ClmClaimItem Corresponding COBOL Variable is DT1-CLM-CLAIM-ITEM
   *
  ...
  public Dt1ClmClaimItem getDt1ClmClaimItem(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "dt1ClmClaimItem - Array index exceeded max Size {}, resetting it to max allowed",
          DT_1_CLM_CLAIM_ITEM_SIZE);
    }
    if (index >= dt1ClmClaimItem.size()) {
      ...
      dt1ClmClaimItem.set(
          ...
          new Dt1ClmClaimItem(
              this,
              beginDt1ClmClaimItem + index * Dt1ClmClaimItem.getDt1ClmClaimItemFieldLength()));
    }
  ...
  /**
   * Update Dt1ClmClaimItem at index with the passed value Corresponding COBOL Variable is
   * DT1-CLM-CLAIM-ITEM
   *
   * @param index
   * @param value
