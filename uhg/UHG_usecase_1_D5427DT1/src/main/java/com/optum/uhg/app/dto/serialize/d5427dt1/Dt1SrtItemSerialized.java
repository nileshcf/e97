...
/**
 * The class Dt1SrtItemSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Dt1SrtItemSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1SrtItemSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDt1SrtFlnCentModified() {
    ...
    localDt1SrtFlnCentCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1SrtFlnCent(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginDt1SrtFlnCent, 2);
    localDt1SrtFlnCentCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1SrtFlnCent;
  }
  ...
  /**
   * refreshDt1SrtFlnCent is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isDt1SrtFlnModified() {
    ...
    localDt1SrtFlnCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean dt1SrtFlnIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtFln,
        DT_1_SRT_FLN_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isDt1SrtIcnModified() {
    ...
    localDt1SrtIcnCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDt1SrtDateModified() {
    ...
    localDt1SrtDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean dt1SrtDateIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtDate,
        DT_1_SRT_DATE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isDt1SrtTimeModified() {
    ...
    localDt1SrtTimeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean dt1SrtTimeIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtTime,
        DT_1_SRT_TIME_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isDt1SrtBankCodeModified() {
    ...
    localDt1SrtBankCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean dt1SrtBankCodeIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtBankCode,
        DT_1_SRT_BANK_CODE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshDt1SrtBankCode is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1SrtDraftModified() {
    ...
    localDt1SrtDraftCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean dt1SrtDraftIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtDraft,
        DT_1_SRT_DRAFT_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isDt1SrtPayeeCodeModified() {
    ...
    localDt1SrtPayeeCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDt1SrtPayeeCode is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1SrtPayeeCode() {
    return (substring(
        getStringValue(), beginDt1SrtPayeeCode, beginDt1SrtPayeeCode + DT_1_SRT_PAYEE_CODE_LEN));
  }
  ...
  public boolean isDt1SrtLineSequenceModified() {
    ...
    localDt1SrtLineSequenceCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1SrtLineSequence(char[] value) {
    ...
    dt1SrtLineSequence =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(1, value, false /*isSigned?*/), beginDt1SrtLineSequence, 1);
    localDt1SrtLineSequenceCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1SrtLineSequence;
  }
  ...
  /**
   * refreshDt1SrtLineSequence is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1SrtTranCodeModified() {
    ...
    localDt1SrtTranCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDt1SrtTranCode is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1SrtTranCode() {
    return (substring(
        getStringValue(), beginDt1SrtTranCode, beginDt1SrtTranCode + DT_1_SRT_TRAN_CODE_LEN));
  }
  ...
  public boolean isDt1SrtApproverAltIdModified() {
    ...
    localDt1SrtApproverAltIdCounter = sharedCounter;
    return hasModified;
  }

  public boolean dt1SrtApproverAltIdIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtApproverAltId,
        DT_1_SRT_APPROVER_ALT_ID_LEN); // check Packed Decimal field to see if it contains valid
                                       // Number
  }
  ...
  /**
   * refreshDt1SrtApproverAltId is used to refresh the latest value of a variable from the
  ...
  public long refreshDt1SrtApproverAltId() throws CFException {
    try {
      ...
      throw getSoc7ABend(
          "dt1SrtApproverAltId", beginDt1SrtApproverAltId, DT_1_SRT_APPROVER_ALT_ID_LEN);
    }
  }
  ...
  public boolean isDt1SrtClmItemModified() {
    ...
    localDt1SrtClmItemCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean dt1SrtClmItemIsNumeric() {
    return decimalIsNumeric(
        beginDt1SrtClmItem,
        DT_1_SRT_CLM_ITEM_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshDt1SrtClmItem is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1SrtSuffixCdModified() {
    ...
    localDt1SrtSuffixCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1SrtSuffixCd(char[] value) {
    ...
    dt1SrtSuffixCd =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginDt1SrtSuffixCd, 2);
    localDt1SrtSuffixCdCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1SrtSuffixCd;
  }
  ...
  /**
   * refreshDt1SrtSuffixCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1SrtProviderIdModified() {
    ...
    localDt1SrtProviderIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDt1SrtProviderId(char[] value) {
    ...
    if (value.length > 0 && value.length != 15) value = new String(value).trim().toCharArray();
    ...
    dt1SrtProviderId =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(15, value, false /*isSigned?*/), beginDt1SrtProviderId, 15);
    localDt1SrtProviderIdCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1SrtProviderId;
  }
  ...
  /**
   * refreshDt1SrtProviderId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1SrtHeaderCtModified() {
    ...
    localDt1SrtHeaderCtCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1SrtHeaderCt(char[] value) {
    ...
    dt1SrtHeaderCt =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(4, value, false /*isSigned?*/), beginDt1SrtHeaderCt, 4);
    localDt1SrtHeaderCtCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1SrtHeaderCt;
  }
  ...
  /**
   * refreshDt1SrtHeaderCt is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1SrtDivNbrModified() {
    ...
    localDt1SrtDivNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDt1SrtDivNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1SrtDivNbr() {
    return (substring(
        getStringValue(), beginDt1SrtDivNbr, beginDt1SrtDivNbr + DT_1_SRT_DIV_NBR_LEN));
  }
  ...
  public boolean isDt1SrtClsNbrModified() {
    ...
    localDt1SrtClsNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDt1SrtClsNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1SrtClsNbr() {
    return (substring(
        getStringValue(), beginDt1SrtClsNbr, beginDt1SrtClsNbr + DT_1_SRT_CLS_NBR_LEN));
  }
}
