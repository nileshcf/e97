...
public class HvSpiCtgyCd4Group extends HvSpiCtgyCd4GroupSerialized {
  ...
  /**
   * set variable hvSpiCtgyCd4 Corresponding COBOL Variable is HV-SPI-CTGY-CD-4
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd4 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd4 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd4(
  ...
  /**
   * Update HvSpiCtgyCd4 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd4 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd4(
