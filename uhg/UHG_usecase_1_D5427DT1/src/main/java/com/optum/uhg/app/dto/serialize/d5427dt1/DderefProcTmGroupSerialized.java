...
/**
 * The class DderefProcTmGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DderefProcTmGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefProcTmGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDderefProcTmModified() {
    ...
    localDderefProcTmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDderefProcTm is used to refresh the latest value of a variable from the Serialized
