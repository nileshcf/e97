...
/**
 * The class SysJobnameSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SysJobnameSerialized extends Field {
  ...
  /**
   * sets parent for this SysJobnameSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isSysJobname14Modified() {
    ...
    localSysJobname14Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSysJobname14 is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isSysJobname5Modified() {
    ...
    localSysJobname5Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSysJobnameCicsJobname68Modified() {
    ...
    localSysJobnameCicsJobname68Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSysJobnameCicsJobname68 is used to refresh the latest value of a variable from the
  ...
  public char[] refreshSysJobnameCicsJobname68() {
    return (substring(
        getStringValue(),
        beginSysJobnameCicsJobname68,
        beginSysJobnameCicsJobname68 + SYS_JOBNAME_CICS_JOBNAME_68_LEN));
  }
}
