...
public class DderefPolNbrGroup extends DderefPolNbrGroupSerialized {
  ...
  /**
   * set variable dderefPolNbr Corresponding COBOL Variable is DDEREF-POL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefPolNbr(
  ...
  /**
   * Update DderefPolNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefPolNbr(
