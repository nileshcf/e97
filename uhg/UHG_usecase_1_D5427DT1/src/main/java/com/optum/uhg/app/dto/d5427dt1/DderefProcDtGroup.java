...
public class DderefProcDtGroup extends DderefProcDtGroupSerialized {
  ...
  /**
   * set variable dderefProcDt Corresponding COBOL Variable is DDEREF-PROC-DT
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcDt(
  ...
  /**
   * Update DderefProcDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcDt(
