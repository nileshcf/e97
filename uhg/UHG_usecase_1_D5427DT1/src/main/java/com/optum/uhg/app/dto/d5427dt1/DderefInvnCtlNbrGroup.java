...
public class DderefInvnCtlNbrGroup extends DderefInvnCtlNbrGroupSerialized {
  ...
  /**
   * set variable dderefInvnCtlNbr Corresponding COBOL Variable is DDEREF-INVN-CTL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update DderefInvnCtlNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefInvnCtlNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefInvnCtlNbr(
  ...
  /**
   * Update DderefInvnCtlNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefInvnCtlNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefInvnCtlNbr(
