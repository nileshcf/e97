...
public class DderefProcTmGroup extends DderefProcTmGroupSerialized {
  ...
  /**
   * set variable dderefProcTm Corresponding COBOL Variable is DDEREF-PROC-TM
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcTm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcTm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcTm(
  ...
  /**
   * Update DderefProcTm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcTm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcTm(
