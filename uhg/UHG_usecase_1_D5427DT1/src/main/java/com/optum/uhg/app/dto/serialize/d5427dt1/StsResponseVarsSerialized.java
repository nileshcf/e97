...
/**
 * The class StsResponseVarsSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class StsResponseVarsSerialized extends Field {
  ...
  /**
   * sets parent for this StsResponseVarsSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isStsRespMessageTypeModified() {
    ...
    localStsRespMessageTypeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsRespMessageType(char[] stsRespMessageType) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginStsRespMessageType,
        STS_RESP_MESSAGE_TYPE_LEN);
  ...
  /**
   * refreshStsRespMessageType is used to refresh the latest value of a variable from the Serialized
  ...
  public char[] refreshStsRespMessageType() {
    return (substring(
        getStringValue(),
        beginStsRespMessageType,
        beginStsRespMessageType + STS_RESP_MESSAGE_TYPE_LEN));
  }
  ...
  public boolean isStsRespAdditionalInfo1Modified() {
    ...
    localStsRespAdditionalInfo1Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshStsRespAdditionalInfo1 is used to refresh the latest value of a variable from the
  ...
  public char[] refreshStsRespAdditionalInfo1() {
    return (substring(
        getStringValue(),
        beginStsRespAdditionalInfo1,
        beginStsRespAdditionalInfo1 + STS_RESP_ADDITIONAL_INFO_1_LEN));
  }
  ...
  public boolean isStsRespAdditionalInfo2Modified() {
    ...
    localStsRespAdditionalInfo2Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshStsRespAdditionalInfo2 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshStsRespAdditionalInfo2() {
    return (substring(
        getStringValue(),
        beginStsRespAdditionalInfo2,
        beginStsRespAdditionalInfo2 + STS_RESP_ADDITIONAL_INFO_2_LEN));
  }
  ...
  public boolean isStsRespDataValueModified() {
    ...
    localStsRespDataValueCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsRespDataValue(char[] stsRespDataValue) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        stsRespDataValue, 0, getStringValue(), beginStsRespDataValue, STS_RESP_DATA_VALUE_LEN);
  ...
  /**
   * refreshStsRespDataValue is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshStsRespDataValue() {
    return (substring(
        getStringValue(), beginStsRespDataValue, beginStsRespDataValue + STS_RESP_DATA_VALUE_LEN));
  }
  ...
  public boolean isStsCicsrespModified() {
    ...
    localStsCicsrespCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeStsCicsresp(char[] value) {
    ...
    replaceValue(padNumber(8, value, false /*isSigned?*/), beginStsCicsresp, 8);
    localStsCicsrespCounter = shareString.getSerializedField().getModifiedCounter();
    return stsCicsresp;
  }
  ...
  public boolean isStsCicsresp2Modified() {
    ...
    localStsCicsresp2Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeStsCicsresp2(char[] value) {
    ...
    stsCicsresp2 =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(8, value, false /*isSigned?*/), beginStsCicsresp2, 8);
    localStsCicsresp2Counter = shareString.getSerializedField().getModifiedCounter();
    return stsCicsresp2;
  }
  ...
  /**
   * refreshStsCicsresp2 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isStsEibtasknModified() {
    ...
    localStsEibtasknCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeStsEibtaskn(char[] value) {
    ...
    stsEibtaskn =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(7, value, false /*isSigned?*/), beginStsEibtaskn, 7);
    localStsEibtasknCounter = shareString.getSerializedField().getModifiedCounter();
    return stsEibtaskn;
  }
  ...
  public boolean isStsSqlcodeModified() {
    ...
    localStsSqlcodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeStsSqlcode(char[] value) {
    ...
    stsSqlcode =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(9, value, false /*isSigned?*/), beginStsSqlcode, 9);
    localStsSqlcodeCounter = shareString.getSerializedField().getModifiedCounter();
    return stsSqlcode;
  }
  ...
  public boolean isStsSqlstateModified() {
    ...
    localStsSqlstateCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isStsParagraphModified() {
    ...
    localStsParagraphCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshStsParagraph is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
