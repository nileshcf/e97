...
public class Sqlvar2 extends Sqlvar2Serialized {
  ...
  /**
   * Update Sqlvar2Reserved1 with the passed value Corresponding COBOL Variable is
   * SQLVAR2-RESERVED-1
   *
   * @param number
   */
  ...
  /**
   * Update Sqllonglen with the passed value Corresponding COBOL Variable is SQLLONGLEN
   *
   * @param number
   */
