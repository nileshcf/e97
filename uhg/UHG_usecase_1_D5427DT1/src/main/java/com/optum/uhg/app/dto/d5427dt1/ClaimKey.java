...
public class ClaimKey extends ClaimKeySerialized {
  ...
  /**
   * set variable claimKeyFln Corresponding COBOL Variable is CLAIM-KEY-FLN
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyFln with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyFln with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyFln(
  ...
  /**
   * Update ClaimKeyFln with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyFln with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyFln(
  ...
  /**
   * set variable claimKeyIcn Corresponding COBOL Variable is CLAIM-KEY-ICN
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyIcn with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyIcn with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyIcn(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update ClaimKeyIcn with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyIcn with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyIcn(
  ...
  /**
   * set variable claimKeySuffixCd Corresponding COBOL Variable is CLAIM-KEY-SUFFIX-CD
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeySuffixCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeySuffixCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeySuffixCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update ClaimKeySuffixCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeySuffixCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeySuffixCd(
  ...
  /**
   * set variable claimKeyProviderNo Corresponding COBOL Variable is CLAIM-KEY-PROVIDER-NO
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyProviderNo with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyProviderNo with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyProviderNo(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update ClaimKeyProviderNo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyProviderNo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyProviderNo(
  ...
  /**
   * set variable claimKeyDraftNo Corresponding COBOL Variable is CLAIM-KEY-DRAFT-NO
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyDraftNo with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyDraftNo with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyDraftNo(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update ClaimKeyDraftNo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyDraftNo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyDraftNo(
  ...
  /**
   * set variable claimKeyHeaderCt Corresponding COBOL Variable is CLAIM-KEY-HEADER-CT
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyHeaderCt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyHeaderCt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyHeaderCt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update ClaimKeyHeaderCt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ClaimKeyHeaderCt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setClaimKeyHeaderCt(
