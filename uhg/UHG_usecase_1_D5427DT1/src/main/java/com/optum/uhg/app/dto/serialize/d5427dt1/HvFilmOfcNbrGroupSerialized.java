...
/**
 * The class HvFilmOfcNbrGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvFilmOfcNbrGroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvFilmOfcNbrGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvFilmOfcNbrModified() {
    ...
    localHvFilmOfcNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvFilmOfcNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvFilmOfcNbr() {
    return (substring(
        getStringValue(), beginHvFilmOfcNbr, beginHvFilmOfcNbr + HV_FILM_OFC_NBR_LEN));
  }
}
