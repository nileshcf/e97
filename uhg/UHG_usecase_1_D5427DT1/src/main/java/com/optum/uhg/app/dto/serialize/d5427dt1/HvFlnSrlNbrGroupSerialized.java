...
/**
 * The class HvFlnSrlNbrGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvFlnSrlNbrGroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvFlnSrlNbrGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvFlnSrlNbrModified() {
    ...
    localHvFlnSrlNbrCounter = sharedCounter;
    return hasModified;
  }
