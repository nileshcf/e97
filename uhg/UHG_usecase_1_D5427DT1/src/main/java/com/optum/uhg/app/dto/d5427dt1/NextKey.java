...
public class NextKey extends NextKeySerialized {
  ...
  /**
   * set variable nextProcDt Corresponding COBOL Variable is NEXT-PROC-DT
   *
   * @param value
   */
  ...
  /**
   * Update NextProcDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextProcDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextProcDt(
  ...
  /**
   * Update NextProcDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextProcDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextProcDt(
  ...
  /**
   * set variable nextProcTm Corresponding COBOL Variable is NEXT-PROC-TM
   *
   * @param value
   */
  ...
  /**
   * Update NextProcTm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextProcTm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextProcTm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update NextProcTm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextProcTm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextProcTm(
  ...
  /**
   * set variable nextPgmIdLstCharVal Corresponding COBOL Variable is NEXT-PGM-ID-LST-CHAR-VAL
   *
   * @param value
   */
  ...
  /**
   * Update NextPgmIdLstCharVal with a char[] from an offset and length
   *
   * @param value
   */
  public void setNextPgmIdLstCharVal(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginNextPgmIdLstCharVal, nextPgmIdLstCharVal.length);
  }
  ...
  /**
   * Update NextPgmIdLstCharVal with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextPgmIdLstCharVal(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update NextPgmIdLstCharVal with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextPgmIdLstCharVal with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextPgmIdLstCharVal(
  ...
  /**
   * Update NextIcnSufxVersNbr with the passed value Corresponding COBOL Variable is
   * NEXT-ICN-SUFX-VERS-NBR
   *
   * @param number
   */
  ...
  /**
   * set variable nextInvnCtlNbr Corresponding COBOL Variable is NEXT-INVN-CTL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update NextInvnCtlNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextInvnCtlNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextInvnCtlNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update NextInvnCtlNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextInvnCtlNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextInvnCtlNbr(
  ...
  /**
   * set variable nextIcnSufxCd Corresponding COBOL Variable is NEXT-ICN-SUFX-CD
   *
   * @param value
   */
  ...
  /**
   * Update NextIcnSufxCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextIcnSufxCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextIcnSufxCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update NextIcnSufxCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NextIcnSufxCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNextIcnSufxCd(
  ...
  /**
   * Update NextLnId with the passed value Corresponding COBOL Variable is NEXT-LN-ID
   *
   * @param number
   */
  ...
  /**
   * Update NextHeaderCt with the passed value Corresponding COBOL Variable is NEXT-HEADER-CT
   *
   * @param number
   */
