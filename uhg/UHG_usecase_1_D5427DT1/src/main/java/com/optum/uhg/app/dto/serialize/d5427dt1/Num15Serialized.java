...
/**
 * The class Num15Serialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Num15Serialized extends Field {
  ...
  public boolean isNum15XModified() {
    ...
    localNum15XCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshNum15X is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isNum159Modified() {
    ...
    localNum159Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeNum159(char[] value) {
    ...
    replaceValue(padNumber(15, value, false /*isSigned?*/), beginNum159, 15);
    localNum159Counter = shareString.getSerializedField().getModifiedCounter();
    return num159;
  }
  ...
  /**
   * refreshNum159 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
