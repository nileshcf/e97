...
public class HoldArea extends HoldAreaSerialized {
  ...
  /**
   * set variable hldInvnCtlNbr Corresponding COBOL Variable is HLD-INVN-CTL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update HldInvnCtlNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldInvnCtlNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldInvnCtlNbr(
  ...
  /**
   * Update HldInvnCtlNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldInvnCtlNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldInvnCtlNbr(
  ...
  /**
   * set variable hldIcnSufxCd Corresponding COBOL Variable is HLD-ICN-SUFX-CD
   *
   * @param value
   */
  ...
  /**
   * Update HldIcnSufxCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldIcnSufxCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldIcnSufxCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HldIcnSufxCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldIcnSufxCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldIcnSufxCd(
  ...
  /**
   * set variable hldProcDt Corresponding COBOL Variable is HLD-PROC-DT
   *
   * @param value
   */
  ...
  /**
   * Update HldProcDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldProcDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldProcDt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HldProcDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldProcDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldProcDt(
  ...
  /**
   * set variable hldProcTm Corresponding COBOL Variable is HLD-PROC-TM
   *
   * @param value
   */
  ...
  /**
   * Update HldProcTm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldProcTm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldProcTm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HldProcTm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldProcTm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldProcTm(
  ...
  /**
   * set variable hldLstCharVal Corresponding COBOL Variable is HLD-LST-CHAR-VAL
   *
   * @param value
   */
  ...
  /**
   * Update HldLstCharVal with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldLstCharVal with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldLstCharVal(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HldLstCharVal with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HldLstCharVal with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHldLstCharVal(
  ...
  /**
   * Update HldIcnSufxVersNbr with the passed value Corresponding COBOL Variable is
   * HLD-ICN-SUFX-VERS-NBR
   *
   * @param number
   */
  ...
  public void setHldIcnSufxVersNbr(int number) {
    number =
        checkHldIcnSufxVersNbrMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * initializes HoldArea String fields defaults to Spaces short/int/long defaults to zero
