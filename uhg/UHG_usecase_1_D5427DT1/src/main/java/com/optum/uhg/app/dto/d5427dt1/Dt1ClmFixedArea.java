...
public class Dt1ClmFixedArea extends Dt1ClmFixedAreaSerialized {
  ...
  /**
   * Update Dt1ClmClmContainerItemCnt with the passed value Corresponding COBOL Variable is
   * DT1-CLM-CLM-CONTAINER-ITEM-CNT
   *
   * @param number
   */
  ...
  /**
   * Update Dt1ClmClmContainerItemLen with the passed value Corresponding COBOL Variable is
   * DT1-CLM-CLM-CONTAINER-ITEM-LEN
   *
   * @param number
   */
  ...
  /**
   * initializes Dt1ClmFixedArea String fields defaults to Spaces short/int/long defaults to zero
