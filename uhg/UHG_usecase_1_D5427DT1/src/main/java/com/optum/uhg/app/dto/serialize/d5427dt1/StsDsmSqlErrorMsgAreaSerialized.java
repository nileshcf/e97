...
/**
 * The class StsDsmSqlErrorMsgAreaSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class StsDsmSqlErrorMsgAreaSerialized extends Field {
  ...
  /**
   * sets parent for this StsDsmSqlErrorMsgAreaSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isStsDsmErrTblNameModified() {
    ...
    localStsDsmErrTblNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsDsmErrTblName(char[] stsDsmErrTblName) {
    ...
    arraycopy(
        stsDsmErrTblName, 0, getStringValue(), beginStsDsmErrTblName, STS_DSM_ERR_TBL_NAME_LEN);
  ...
  /**
   * refreshStsDsmErrTblName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshStsDsmErrTblName() {
    return (substring(
        getStringValue(), beginStsDsmErrTblName, beginStsDsmErrTblName + STS_DSM_ERR_TBL_NAME_LEN));
  }
  ...
  public boolean isStsDsmErrSectnNameModified() {
    ...
    localStsDsmErrSectnNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsDsmErrSectnName(char[] stsDsmErrSectnName) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginStsDsmErrSectnName,
        STS_DSM_ERR_SECTN_NAME_LEN);
  ...
  /**
   * refreshStsDsmErrSectnName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshStsDsmErrSectnName() {
    return (substring(
        getStringValue(),
        beginStsDsmErrSectnName,
        beginStsDsmErrSectnName + STS_DSM_ERR_SECTN_NAME_LEN));
  }
  ...
  public boolean isStsDsmErrPgmNameModified() {
    ...
    localStsDsmErrPgmNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsDsmErrPgmName(char[] stsDsmErrPgmName) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        stsDsmErrPgmName, 0, getStringValue(), beginStsDsmErrPgmName, STS_DSM_ERR_PGM_NAME_LEN);
  ...
  /**
   * refreshStsDsmErrPgmName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshStsDsmErrPgmName() {
    return (substring(
        getStringValue(), beginStsDsmErrPgmName, beginStsDsmErrPgmName + STS_DSM_ERR_PGM_NAME_LEN));
  }
  ...
  public boolean isStsDsmErrClngPgmNameModified() {
    ...
    localStsDsmErrClngPgmNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsDsmErrClngPgmName(char[] stsDsmErrClngPgmName) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        stsDsmErrClngPgmName,
        0,
        getStringValue(),
        beginStsDsmErrClngPgmName,
        STS_DSM_ERR_CLNG_PGM_NAME_LEN);
  ...
  /**
   * refreshStsDsmErrClngPgmName is used to refresh the latest value of a variable from the
  ...
  public char[] refreshStsDsmErrClngPgmName() {
    return (substring(
        getStringValue(),
        beginStsDsmErrClngPgmName,
        beginStsDsmErrClngPgmName + STS_DSM_ERR_CLNG_PGM_NAME_LEN));
  }
  ...
  public boolean isStsDsmErrTblActionModified() {
    ...
    localStsDsmErrTblActionCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsDsmErrTblAction(char[] stsDsmErrTblAction) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginStsDsmErrTblAction,
        STS_DSM_ERR_TBL_ACTION_LEN);
  ...
  /**
   * refreshStsDsmErrTblAction is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshStsDsmErrTblAction() {
    return (substring(
        getStringValue(),
        beginStsDsmErrTblAction,
        beginStsDsmErrTblAction + STS_DSM_ERR_TBL_ACTION_LEN));
  }
  ...
  public boolean isStsDsmErrTxtModified() {
    ...
    localStsDsmErrTxtCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshStsDsmErrTxt is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshStsDsmErrTxt() {
    return (substring(
        getStringValue(), beginStsDsmErrTxt, beginStsDsmErrTxt + STS_DSM_ERR_TXT_LEN));
  }
}
