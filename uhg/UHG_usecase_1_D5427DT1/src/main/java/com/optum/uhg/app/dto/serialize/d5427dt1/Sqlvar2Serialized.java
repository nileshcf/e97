...
/**
 * The class Sqlvar2Serialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Sqlvar2Serialized extends Field {
  ...
  /**
   * sets parent for this Sqlvar2Serialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isSqlvar2Reserved1Modified() {
    ...
    localSqlvar2Reserved1Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSqlvar2Reserved1 is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isSqllonglenModified() {
    ...
    localSqllonglenCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqllonglen(int sqllonglen) {
    replaceValue( //  save the value as string
        getBinaryString(sqllonglen, SQLLONGLEN_LEN), beginSqllonglen, SQLLONGLEN_LEN);
