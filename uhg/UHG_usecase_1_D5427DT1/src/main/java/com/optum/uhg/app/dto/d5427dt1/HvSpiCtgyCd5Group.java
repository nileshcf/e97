...
public class HvSpiCtgyCd5Group extends HvSpiCtgyCd5GroupSerialized {
  ...
  /**
   * set variable hvSpiCtgyCd5 Corresponding COBOL Variable is HV-SPI-CTGY-CD-5
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd5 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd5 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd5(
  ...
  /**
   * Update HvSpiCtgyCd5 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd5 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd5(
