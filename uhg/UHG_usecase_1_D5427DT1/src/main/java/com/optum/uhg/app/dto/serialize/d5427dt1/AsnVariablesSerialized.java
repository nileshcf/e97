...
/**
 * The class AsnVariablesSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class AsnVariablesSerialized extends Field {
  ...
  /**
   * sets parent for this AsnVariablesSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isAsnAbcodeModified() {
    ...
    localAsnAbcodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isAsnNetnameModified() {
    ...
    localAsnNetnameCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isAsnPrinsysidModified() {
    ...
    localAsnPrinsysidCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshAsnPrinsysid is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isAsnInvokingprogModified() {
    ...
    localAsnInvokingprogCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshAsnInvokingprog is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshAsnInvokingprog() {
    return (substring(
        getStringValue(), beginAsnInvokingprog, beginAsnInvokingprog + ASN_INVOKINGPROG_LEN));
  }
  ...
  public boolean isAsnProgramModified() {
    ...
    localAsnProgramCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isAsnApplidModified() {
    ...
    localAsnApplidCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isAsnSysidModified() {
    ...
    localAsnSysidCounter = sharedCounter;
    return hasModified;
  }
