...
/**
 * The class StsDsmCommonAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class StsDsmCommonAreaSerialized extends Field {
  ...
  /**
   * sets parent for this StsDsmCommonAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isStsDsmFuncCdModified() {
    ...
    localStsDsmFuncCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeStsDsmFuncCd(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginStsDsmFuncCd, 2);
    localStsDsmFuncCdCounter = shareString.getSerializedField().getModifiedCounter();
    return stsDsmFuncCd;
  }
  ...
  /**
   * refreshStsDsmFuncCd is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isStsDsmReturnCodeModified() {
    ...
    localStsDsmReturnCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeStsDsmReturnCode(char[] value) {
    ...
    stsDsmReturnCode =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginStsDsmReturnCode, 3);
    localStsDsmReturnCodeCounter = shareString.getSerializedField().getModifiedCounter();
    return stsDsmReturnCode;
  }
  ...
  /**
   * refreshStsDsmReturnCode is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isStsDsmSqlErrorMessageModified() {
    ...
    localStsDsmSqlErrorMessageCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsDsmSqlErrorMessage(char[] stsDsmSqlErrorMessage) {
    ...
    arraycopy(
        stsDsmSqlErrorMessage,
        0,
        getStringValue(),
        beginStsDsmSqlErrorMessage,
        STS_DSM_SQL_ERROR_MESSAGE_LEN);
  ...
  /**
   * refreshStsDsmSqlErrorMessage is used to refresh the latest value of a variable from the
  ...
  public char[] refreshStsDsmSqlErrorMessage() {
    return (substring(
        getStringValue(),
        beginStsDsmSqlErrorMessage,
        beginStsDsmSqlErrorMessage + STS_DSM_SQL_ERROR_MESSAGE_LEN));
  }
}
