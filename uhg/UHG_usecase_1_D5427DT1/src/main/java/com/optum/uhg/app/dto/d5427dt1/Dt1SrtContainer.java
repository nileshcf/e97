...
public class Dt1SrtContainer extends Dt1SrtContainerSerialized {
  ...
  /**
   * Update Dt1SrtFixedArea with the passed value Corresponding COBOL Variable is DT1-SRT-FIXED-AREA
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtFixedArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtFixedArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtFixedArea(
  ...
  /**
   * Update Dt1SrtFixedArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtFixedArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtFixedArea(
  ...
  /**
   * Update Dt1SrtVariableArea with the passed value Corresponding COBOL Variable is
   * DT1-SRT-VARIABLE-AREA
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtVariableArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtVariableArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtVariableArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1SrtVariableArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtVariableArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtVariableArea(
