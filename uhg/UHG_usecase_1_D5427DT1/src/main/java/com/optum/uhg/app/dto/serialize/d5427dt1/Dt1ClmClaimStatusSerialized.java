...
/**
 * The class Dt1ClmClaimStatusSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1ClmClaimStatusSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1ClmClaimStatusSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDt1ClmUnprocFlagModified() {
    ...
    localDt1ClmUnprocFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDt1ClmUnprocFlag(char[] dt1ClmUnprocFlag) {
    ...
    arraycopy(
        dt1ClmUnprocFlag, 0, getStringValue(), beginDt1ClmUnprocFlag, DT_1_CLM_UNPROC_FLAG_LEN);
  ...
  /**
   * refreshDt1ClmUnprocFlag is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1ClmUnprocFlag() {
    return (substring(
        getStringValue(), beginDt1ClmUnprocFlag, beginDt1ClmUnprocFlag + DT_1_CLM_UNPROC_FLAG_LEN));
  }
  ...
  public boolean isDt1ClmClosedFlagModified() {
    ...
    localDt1ClmClosedFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDt1ClmClosedFlag(char[] dt1ClmClosedFlag) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        dt1ClmClosedFlag, 0, getStringValue(), beginDt1ClmClosedFlag, DT_1_CLM_CLOSED_FLAG_LEN);
  ...
  /**
   * refreshDt1ClmClosedFlag is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1ClmClosedFlag() {
    return (substring(
        getStringValue(), beginDt1ClmClosedFlag, beginDt1ClmClosedFlag + DT_1_CLM_CLOSED_FLAG_LEN));
  }
  ...
  public boolean isDt1ClmPendedFlagModified() {
    ...
    localDt1ClmPendedFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDt1ClmPendedFlag(char[] dt1ClmPendedFlag) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        dt1ClmPendedFlag, 0, getStringValue(), beginDt1ClmPendedFlag, DT_1_CLM_PENDED_FLAG_LEN);
  ...
  /**
   * refreshDt1ClmPendedFlag is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1ClmPendedFlag() {
    return (substring(
        getStringValue(), beginDt1ClmPendedFlag, beginDt1ClmPendedFlag + DT_1_CLM_PENDED_FLAG_LEN));
  }
  ...
  public boolean isDt1ClmRejectedFlagModified() {
    ...
    localDt1ClmRejectedFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDt1ClmRejectedFlag(char[] dt1ClmRejectedFlag) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginDt1ClmRejectedFlag,
        DT_1_CLM_REJECTED_FLAG_LEN);
  ...
  /**
   * refreshDt1ClmRejectedFlag is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1ClmRejectedFlag() {
    return (substring(
        getStringValue(),
        beginDt1ClmRejectedFlag,
        beginDt1ClmRejectedFlag + DT_1_CLM_REJECTED_FLAG_LEN));
  }
  ...
  public boolean isDt1ClmPaidFlagModified() {
    ...
    localDt1ClmPaidFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDt1ClmPaidFlag is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1ClmPaidFlag() {
    return (substring(
        getStringValue(), beginDt1ClmPaidFlag, beginDt1ClmPaidFlag + DT_1_CLM_PAID_FLAG_LEN));
  }
}
