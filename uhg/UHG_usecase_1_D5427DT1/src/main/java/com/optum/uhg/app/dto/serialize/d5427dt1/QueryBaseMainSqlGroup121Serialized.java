...
/**
 * The class QueryBaseMainSqlGroup121Serialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class QueryBaseMainSqlGroup121Serialized extends Field {
  ...
  /**
   * sets parent for this QueryBaseMainSqlGroup121Serialized to the parent and set the serialize
