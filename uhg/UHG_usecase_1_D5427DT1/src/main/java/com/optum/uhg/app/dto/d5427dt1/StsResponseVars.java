...
public class StsResponseVars extends StsResponseVarsSerialized {
  ...
  /**
   * set variable stsRespMessageType Corresponding COBOL Variable is STS-RESP-MESSAGE-TYPE
   *
   * @param value
   */
  ...
  /**
   * Update StsRespMessageType with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespMessageType with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespMessageType(
  ...
  /**
   * Update StsRespMessageType with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespMessageType with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespMessageType(
  ...
  public boolean isStsRespMessageValid() throws CFException {
    return (compareChars(getStsRespMessageType(), stsRespMessageValid88Value1) == 0
        || compareChars(getStsRespMessageType(), stsRespMessageValid88Value2) == 0
        || compareChars(getStsRespMessageType(), stsRespMessageValid88Value3) == 0
        || compareChars(getStsRespMessageType(), stsRespMessageValid88Value4) == 0);
  }
  ...
  /**
   * set variable stsRespAdditionalInfo1 Corresponding COBOL Variable is STS-RESP-ADDITIONAL-INFO-1
   *
   * @param value
   */
  ...
  /**
   * Update StsRespAdditionalInfo1 with a char[] from an offset and length
   *
   * @param value
   */
  public void setStsRespAdditionalInfo1(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginStsRespAdditionalInfo1,
        stsRespAdditionalInfo1.length);
  }

  public void setStsRespAdditionalInfo1(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginStsRespAdditionalInfo1, stsRespAdditionalInfo1.length);
  }

  /**
   * Update StsRespAdditionalInfo1 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespAdditionalInfo1(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setStsRespAdditionalInfo1(Field source) {
    replace(
        source, 0, source.length(), beginStsRespAdditionalInfo1, STS_RESP_ADDITIONAL_INFO_1_LEN);
  }

  /**
   * Update StsRespAdditionalInfo1 with another Field from an offset and length
   *
   * @param value
   */
  public void setStsRespAdditionalInfo1(Field source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceLen,
        beginStsRespAdditionalInfo1,
        STS_RESP_ADDITIONAL_INFO_1_LEN);
  }

  /**
   * Update StsRespAdditionalInfo1 with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable stsRespAdditionalInfo2 Corresponding COBOL Variable is STS-RESP-ADDITIONAL-INFO-2
   *
   * @param value
   */
  ...
  /**
   * Update StsRespAdditionalInfo2 with a char[] from an offset and length
   *
   * @param value
   */
  public void setStsRespAdditionalInfo2(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginStsRespAdditionalInfo2,
        stsRespAdditionalInfo2.length);
  }

  public void setStsRespAdditionalInfo2(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginStsRespAdditionalInfo2, stsRespAdditionalInfo2.length);
  }

  /**
   * Update StsRespAdditionalInfo2 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespAdditionalInfo2(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setStsRespAdditionalInfo2(Field source) {
    replace(
        source, 0, source.length(), beginStsRespAdditionalInfo2, STS_RESP_ADDITIONAL_INFO_2_LEN);
  }

  /**
   * Update StsRespAdditionalInfo2 with another Field from an offset and length
   *
   * @param value
   */
  public void setStsRespAdditionalInfo2(Field source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceLen,
        beginStsRespAdditionalInfo2,
        STS_RESP_ADDITIONAL_INFO_2_LEN);
  }

  /**
   * Update StsRespAdditionalInfo2 with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable stsRespDataValue Corresponding COBOL Variable is STS-RESP-DATA-VALUE
   *
   * @param value
   */
  ...
  /**
   * Update StsRespDataValue with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespDataValue with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespDataValue(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsRespDataValue with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespDataValue with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespDataValue(
  ...
  /**
   * Update StsCicsresp with the passed value Corresponding COBOL Variable is STS-CICSRESP
   *
   * @param number
   */
  ...
  /**
   * Update StsCicsresp2 with the passed value Corresponding COBOL Variable is STS-CICSRESP2
   *
   * @param number
   */
  ...
  /**
   * Update StsEibtaskn with the passed value Corresponding COBOL Variable is STS-EIBTASKN
   *
   * @param number
   */
  ...
  /**
   * Update StsSqlcode with the passed value Corresponding COBOL Variable is STS-SQLCODE
   *
   * @param number
   */
  ...
  /**
   * set variable stsSqlstate Corresponding COBOL Variable is STS-SQLSTATE
   *
   * @param value
   */
  ...
  /**
   * Update StsSqlstate with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsSqlstate with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsSqlstate(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsSqlstate with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsSqlstate with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsSqlstate(
  ...
  /**
   * set variable stsParagraph Corresponding COBOL Variable is STS-PARAGRAPH
   *
   * @param value
   */
  ...
  /**
   * Update StsParagraph with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsParagraph with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsParagraph(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsParagraph with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsParagraph with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsParagraph(
  ...
  /**
   * initializes StsResponseVars String fields defaults to Spaces short/int/long defaults to zero
