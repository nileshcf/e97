...
/**
 * The class Sc2SortCompare2GroupSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class Sc2SortCompare2GroupSerialized extends Field {
  ...
  public boolean isSc2SortCompare2Modified() {
    ...
    localSc2SortCompare2Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSc2SortCompare2 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshSc2SortCompare2() {
    return (substring(
        getStringValue(), beginSc2SortCompare2, beginSc2SortCompare2 + SC_2_SORT_COMPARE_2_LEN));
  }
}
