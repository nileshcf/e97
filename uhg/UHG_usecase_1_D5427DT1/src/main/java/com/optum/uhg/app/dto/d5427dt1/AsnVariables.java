...
public class AsnVariables extends AsnVariablesSerialized {
  ...
  /**
   * set variable asnAbcode Corresponding COBOL Variable is ASN-ABCODE
   *
   * @param value
   */
  ...
  /**
   * Update AsnAbcode with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnAbcode with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnAbcode(
  ...
  /**
   * Update AsnAbcode with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnAbcode with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnAbcode(
  ...
  /**
   * set variable asnNetname Corresponding COBOL Variable is ASN-NETNAME
   *
   * @param value
   */
  ...
  /**
   * Update AsnNetname with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnNetname with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnNetname(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnNetname with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnNetname with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnNetname(
  ...
  /**
   * set variable asnPrinsysid Corresponding COBOL Variable is ASN-PRINSYSID
   *
   * @param value
   */
  ...
  /**
   * Update AsnPrinsysid with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnPrinsysid with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnPrinsysid(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnPrinsysid with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnPrinsysid with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnPrinsysid(
  ...
  /**
   * set variable asnInvokingprog Corresponding COBOL Variable is ASN-INVOKINGPROG
   *
   * @param value
   */
  ...
  /**
   * Update AsnInvokingprog with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnInvokingprog with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnInvokingprog(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnInvokingprog with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnInvokingprog with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnInvokingprog(
  ...
  /**
   * set variable asnProgram Corresponding COBOL Variable is ASN-PROGRAM
   *
   * @param value
   */
  ...
  /**
   * Update AsnProgram with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnProgram with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnProgram(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnProgram with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnProgram with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnProgram(
  ...
  /**
   * set variable asnApplid Corresponding COBOL Variable is ASN-APPLID
   *
   * @param value
   */
  ...
  /**
   * Update AsnApplid with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnApplid with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnApplid(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnApplid with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnApplid with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnApplid(
  ...
  /**
   * set variable asnSysid Corresponding COBOL Variable is ASN-SYSID
   *
   * @param value
   */
  ...
  /**
   * Update AsnSysid with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnSysid with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnSysid(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnSysid with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnSysid with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnSysid(
  ...
  /**
   * initializes AsnVariables String fields defaults to Spaces short/int/long defaults to zero
