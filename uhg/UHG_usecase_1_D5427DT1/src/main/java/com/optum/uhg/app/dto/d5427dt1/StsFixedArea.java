...
public class StsFixedArea extends StsFixedAreaSerialized {
  ...
  /**
   * set variable stsRespProgramName Corresponding COBOL Variable is STS-RESP-PROGRAM-NAME
   *
   * @param value
   */
  ...
  /**
   * Update StsRespProgramName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespProgramName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespProgramName(
  ...
  /**
   * Update StsRespProgramName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespProgramName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespProgramName(
  ...
  /**
   * set variable stsRespCode Corresponding COBOL Variable is STS-RESP-CODE
   *
   * @param value
   */
  ...
  /**
   * Update StsRespCode with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespCode with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespCode(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsRespCode with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsRespCode with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsRespCode(
  ...
  /**
   * Update StsResponseVars with the passed value Corresponding COBOL Variable is STS-RESPONSE-VARS
   *
   * @param value
   */
  ...
  /**
   * Update StsResponseVars with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsResponseVars with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsResponseVars(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsResponseVars with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsResponseVars with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsResponseVars(
  ...
  /**
   * Update StsDsmCommonArea with the passed value Corresponding COBOL Variable is
   * STS-DSM-COMMON-AREA
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmCommonArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmCommonArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmCommonArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmCommonArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmCommonArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmCommonArea(
  ...
  /**
   * initializes StsFixedArea String fields defaults to Spaces short/int/long defaults to zero
