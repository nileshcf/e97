...
/**
 * The class HvSpiCtgyCd2GroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvSpiCtgyCd2GroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvSpiCtgyCd2GroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvSpiCtgyCd2Modified() {
    ...
    localHvSpiCtgyCd2Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvSpiCtgyCd2 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvSpiCtgyCd2() {
    return (substring(
        getStringValue(), beginHvSpiCtgyCd2, beginHvSpiCtgyCd2 + HV_SPI_CTGY_CD_2_LEN));
  }
}
