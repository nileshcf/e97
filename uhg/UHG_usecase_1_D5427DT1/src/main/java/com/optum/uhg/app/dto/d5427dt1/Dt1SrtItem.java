...
public class Dt1SrtItem extends Dt1SrtItemSerialized {
  ...
  /**
   * Update Dt1SrtFlnCent with the passed value Corresponding COBOL Variable is DT1-SRT-FLN-CENT
   *
   * @param number
   */
  ...
  /**
   * Update Dt1SrtFln with the passed value Corresponding COBOL Variable is DT1-SRT-FLN
   *
   * @param number
   */
  ...
  /**
   * set variable dt1SrtIcn Corresponding COBOL Variable is DT1-SRT-ICN
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtIcn with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtIcn with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtIcn(
  ...
  /**
   * Update Dt1SrtIcn with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtIcn with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtIcn(
  ...
  /**
   * Update Dt1SrtDate with the passed value Corresponding COBOL Variable is DT1-SRT-DATE
   *
   * @param number
   */
  ...
  /**
   * Update Dt1SrtTime with the passed value Corresponding COBOL Variable is DT1-SRT-TIME
   *
   * @param number
   */
  ...
  /**
   * Update Dt1SrtBankCode with the passed value Corresponding COBOL Variable is DT1-SRT-BANK-CODE
   *
   * @param number
   */
  public void setDt1SrtBankCode(int number) {
    ...
    number = (number < 0 ? -number : number);
    dt1SrtBankCode =
        checkDt1SrtBankCodeMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update Dt1SrtDraft with the passed value Corresponding COBOL Variable is DT1-SRT-DRAFT
   *
   * @param number
   */
  ...
  /**
   * set variable dt1SrtPayeeCode Corresponding COBOL Variable is DT1-SRT-PAYEE-CODE
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtPayeeCode with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtPayeeCode with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtPayeeCode(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1SrtPayeeCode with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtPayeeCode with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtPayeeCode(
  ...
  /**
   * Update Dt1SrtLineSequence with the passed value Corresponding COBOL Variable is
   * DT1-SRT-LINE-SEQUENCE
   *
   * @param number
   */
  ...
  /**
   * set variable dt1SrtTranCode Corresponding COBOL Variable is DT1-SRT-TRAN-CODE
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtTranCode with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtTranCode with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtTranCode(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1SrtTranCode with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtTranCode with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtTranCode(
  ...
  /**
   * Update Dt1SrtApproverAltId with the passed value Corresponding COBOL Variable is
   * DT1-SRT-APPROVER-ALT-ID
   *
   * @param number
   */
  public void setDt1SrtApproverAltId(long number) {
    ...
    number = (number < 0 ? -number : number);
    dt1SrtApproverAltId =
        checkDt1SrtApproverAltIdMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update Dt1SrtClmItem with the passed value Corresponding COBOL Variable is DT1-SRT-CLM-ITEM
   *
   * @param number
   */
  ...
  public void setDt1SrtClmItem(int number) {
    number =
        checkDt1SrtClmItemMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update Dt1SrtSuffixCd with the passed value Corresponding COBOL Variable is DT1-SRT-SUFFIX-CD
   *
   * @param number
   */
  ...
  /**
   * Update Dt1SrtProviderId with the passed value Corresponding COBOL Variable is
   * DT1-SRT-PROVIDER-ID
   *
   * @param number
   */
  ...
  /**
   * Update Dt1SrtHeaderCt with the passed value Corresponding COBOL Variable is DT1-SRT-HEADER-CT
   *
   * @param number
   */
  ...
  /**
   * set variable dt1SrtDivNbr Corresponding COBOL Variable is DT1-SRT-DIV-NBR
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtDivNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtDivNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtDivNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1SrtDivNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtDivNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtDivNbr(
  ...
  /**
   * set variable dt1SrtClsNbr Corresponding COBOL Variable is DT1-SRT-CLS-NBR
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtClsNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtClsNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtClsNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1SrtClsNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtClsNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtClsNbr(
