...
/**
 * The class HvaClmHistArraySerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvaClmHistArraySerialized extends Field {
  ...
  public boolean isHvaSubModified() {
    ...
    localHvaSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeHvaSub(short hvaSub) {
    replaceValue( //  save the value as string
        getBinaryString(hvaSub, HVA_SUB_LEN), beginHvaSub, HVA_SUB_LEN);
  ...
  /**
   * refreshHvaSub is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isHvaSub2Modified() {
    ...
    localHvaSub2Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeHvaSub2(short hvaSub2) {
    replaceValue( //  save the value as string
        getBinaryString(hvaSub2, HVA_SUB_2_LEN), beginHvaSub2, HVA_SUB_2_LEN);
  ...
  /**
   * refreshHvaSub2 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  protected void serializeHvaPartnId(int index, short value) {
    ...
    replaceValue(
        getBinaryString(number), (beginHvaPartnId + index * HVA_PARTN_ID_LEN), HVA_PARTN_ID_LEN);
  }
  ...
  protected void serializeHvaPartnVal(int index, char[] value) {
    replaceValue(value, (beginHvaPartnVal + index * HVA_PARTN_VAL_LEN), HVA_PARTN_VAL_LEN);
  }
  ...
  protected void serializeHvaProcDt(int index, char[] value) {
    replaceValue(value, (beginHvaProcDt + index * HVA_PROC_DT_LEN), HVA_PROC_DT_LEN);
  }
  ...
  protected void serializeHvaProcTm(int index, char[] value) {
    replaceValue(value, (beginHvaProcTm + index * HVA_PROC_TM_LEN), HVA_PROC_TM_LEN);
  }
  ...
  protected void serializeHvaIcnSufxVersNbr(int index, short value) {
    ...
    replaceValue(
        ...
        (beginHvaIcnSufxVersNbr + index * HVA_ICN_SUFX_VERS_NBR_LEN),
        HVA_ICN_SUFX_VERS_NBR_LEN);
  }
  ...
  protected void serializeHvaInvnCtlNbr(int index, char[] value) {
    replaceValue(value, (beginHvaInvnCtlNbr + index * HVA_INVN_CTL_NBR_LEN), HVA_INVN_CTL_NBR_LEN);
  }
  ...
  protected void serializeHvaIcnSufxCd(int index, char[] value) {
    replaceValue(value, (beginHvaIcnSufxCd + index * HVA_ICN_SUFX_CD_LEN), HVA_ICN_SUFX_CD_LEN);
  }
  ...
  protected void serializeHvaFlnSrlNbr(int index, char[] value) {
    replaceValue(value, (beginHvaFlnSrlNbr + index * HVA_FLN_SRL_NBR_LEN), HVA_FLN_SRL_NBR_LEN);
  }
  ...
  protected void serializeHvaDftNbr(int index, char[] value) {
    replaceValue(value, (beginHvaDftNbr + index * HVA_DFT_NBR_LEN), HVA_DFT_NBR_LEN);
  }
  ...
  protected void serializeHvaFstDt(int index, char[] value) {
    replaceValue(value, (beginHvaFstDt + index * HVA_FST_DT_LEN), HVA_FST_DT_LEN);
  }
  ...
  protected void serializeHvaLstSrvcDt(int index, char[] value) {
    replaceValue(value, (beginHvaLstSrvcDt + index * HVA_LST_SRVC_DT_LEN), HVA_LST_SRVC_DT_LEN);
  }
  ...
  protected void serializeHvaProvTinsuff(int index, char[] value) {
    replaceValue(value, (beginHvaProvTinsuff + index * HVA_PROV_TINSUFF_LEN), HVA_PROV_TINSUFF_LEN);
  }
  ...
  protected void serializeHvaProvScrnNbr(int index, char[] value) {
    replaceValue(
        value, (beginHvaProvScrnNbr + index * HVA_PROV_SCRN_NBR_LEN), HVA_PROV_SCRN_NBR_LEN);
  }
  ...
  protected void serializeHvaRmrkCd(int index, char[] value) {
    replaceValue(value, (beginHvaRmrkCd + index * HVA_RMRK_CD_LEN), HVA_RMRK_CD_LEN);
  }
  ...
  protected void serializeHvaPmtSvcCd(int index, char[] value) {
    replaceValue(value, (beginHvaPmtSvcCd + index * HVA_PMT_SVC_CD_LEN), HVA_PMT_SVC_CD_LEN);
  }
  ...
  protected void serializeHvaOvrCd(int index, char[] value) {
    replaceValue(value, (beginHvaOvrCd + index * HVA_OVR_CD_LEN), HVA_OVR_CD_LEN);
  }
  ...
  protected void serializeHvaSrvcCd(int index, char[] value) {
    replaceValue(value, (beginHvaSrvcCd + index * HVA_SRVC_CD_LEN), HVA_SRVC_CD_LEN);
  }
  ...
  protected void serializeHvaPayCd(int index, char[] value) {
    replaceValue(value, (beginHvaPayCd + index * HVA_PAY_CD_LEN), HVA_PAY_CD_LEN);
  }
  ...
  protected void serializeHvaTransCd(int index, char[] value) {
    replaceValue(value, (beginHvaTransCd + index * HVA_TRANS_CD_LEN), HVA_TRANS_CD_LEN);
  }
  ...
  protected void serializeHvaFilmOfcNbr(int index, char[] value) {
    replaceValue(value, (beginHvaFilmOfcNbr + index * HVA_FILM_OFC_NBR_LEN), HVA_FILM_OFC_NBR_LEN);
  }
  ...
  protected void serializeHvaClmLvlRsnCd(int index, char[] value) {
    replaceValue(
        value, (beginHvaClmLvlRsnCd + index * HVA_CLM_LVL_RSN_CD_LEN), HVA_CLM_LVL_RSN_CD_LEN);
  }
  ...
  protected void serializeHvaAdjtrId(int index, char[] value) {
    replaceValue(value, (beginHvaAdjtrId + index * HVA_ADJTR_ID_LEN), HVA_ADJTR_ID_LEN);
  }
  ...
  protected void serializeHvaMbrPrvInd(int index, char[] value) {
    replaceValue(value, (beginHvaMbrPrvInd + index * HVA_MBR_PRV_IND_LEN), HVA_MBR_PRV_IND_LEN);
  }
  ...
  protected void serializeHvaNtfyWaivCd(int index, char[] value) {
    replaceValue(value, (beginHvaNtfyWaivCd + index * HVA_NTFY_WAIV_CD_LEN), HVA_NTFY_WAIV_CD_LEN);
  }
  ...
  protected void serializeHvaBankCd(int index, char[] value) {
    replaceValue(value, (beginHvaBankCd + index * HVA_BANK_CD_LEN), HVA_BANK_CD_LEN);
  }
  ...
  protected void serializeHvaDivNbr(int index, char[] value) {
    replaceValue(value, (beginHvaDivNbr + index * HVA_DIV_NBR_LEN), HVA_DIV_NBR_LEN);
  }
  ...
  protected void serializeHvaClsNbr(int index, char[] value) {
    replaceValue(value, (beginHvaClsNbr + index * HVA_CLS_NBR_LEN), HVA_CLS_NBR_LEN);
  }
  ...
  protected void serializeHvaDrgNbr(int index, char[] value) {
    replaceValue(value, (beginHvaDrgNbr + index * HVA_DRG_NBR_LEN), HVA_DRG_NBR_LEN);
  }
  ...
  protected void serializeHvaFaclOrProfCd(int index, char[] value) {
    replaceValue(
        value, (beginHvaFaclOrProfCd + index * HVA_FACL_OR_PROF_CD_LEN), HVA_FACL_OR_PROF_CD_LEN);
  }
  ...
  protected void serializeHvaDlgteInd(int index, char[] value) {
    replaceValue(value, (beginHvaDlgteInd + index * HVA_DLGTE_IND_LEN), HVA_DLGTE_IND_LEN);
  }
  ...
  protected void serializeHvaNdbContrId(int index, char[] value) {
    replaceValue(value, (beginHvaNdbContrId + index * HVA_NDB_CONTR_ID_LEN), HVA_NDB_CONTR_ID_LEN);
  }
  ...
  protected void serializeHvaSmbStCd(int index, char[] value) {
    replaceValue(value, (beginHvaSmbStCd + index * HVA_SMB_ST_CD_LEN), HVA_SMB_ST_CD_LEN);
  }
  ...
  protected void serializeHvaProcT1Ind(int index, char[] value) {
    replaceValue(value, (beginHvaProcT1Ind + index * HVA_PROC_T_1_IND_LEN), HVA_PROC_T_1_IND_LEN);
  }
  ...
  protected void serializeHvaAuthNbr(int index, char[] value) {
    replaceValue(value, (beginHvaAuthNbr + index * HVA_AUTH_NBR_LEN), HVA_AUTH_NBR_LEN);
  }
  ...
  protected void serializeHvaMmDedDescTxt(int index, char[] value) {
    replaceValue(
        value, (beginHvaMmDedDescTxt + index * HVA_MM_DED_DESC_TXT_LEN), HVA_MM_DED_DESC_TXT_LEN);
  }
  ...
  protected void serializeHvaParInd(int index, char[] value) {
    replaceValue(value, (beginHvaParInd + index * HVA_PAR_IND_LEN), HVA_PAR_IND_LEN);
  }
  ...
  protected void serializeHvaProvMktNbr(int index, char[] value) {
    replaceValue(value, (beginHvaProvMktNbr + index * HVA_PROV_MKT_NBR_LEN), HVA_PROV_MKT_NBR_LEN);
  }
  ...
  protected void serializeHvaPpoCd(int index, char[] value) {
    replaceValue(value, (beginHvaPpoCd + index * HVA_PPO_CD_LEN), HVA_PPO_CD_LEN);
  }
  ...
  protected void serializeHvaAuthSrcId(int index, char[] value) {
    replaceValue(value, (beginHvaAuthSrcId + index * HVA_AUTH_SRC_ID_LEN), HVA_AUTH_SRC_ID_LEN);
  }
  ...
  protected void serializeHvaAuthProcCd(int index, char[] value) {
    replaceValue(value, (beginHvaAuthProcCd + index * HVA_AUTH_PROC_CD_LEN), HVA_AUTH_PROC_CD_LEN);
  }
  ...
  protected void serializeHvaProvNm(int index, char[] value) {
    replaceValue(value, (beginHvaProvNm + index * HVA_PROV_NM_LEN), HVA_PROV_NM_LEN);
  }
  ...
  protected void serializeHvaProvEobNm(int index, char[] value) {
    replaceValue(value, (beginHvaProvEobNm + index * HVA_PROV_EOB_NM_LEN), HVA_PROV_EOB_NM_LEN);
  }
  ...
  protected void serializeHvaProvPrdctCd(int index, char[] value) {
    replaceValue(
        value, (beginHvaProvPrdctCd + index * HVA_PROV_PRDCT_CD_LEN), HVA_PROV_PRDCT_CD_LEN);
  }
  ...
  protected void serializeHvaProvMktTypCd(int index, char[] value) {
    replaceValue(
        value, (beginHvaProvMktTypCd + index * HVA_PROV_MKT_TYP_CD_LEN), HVA_PROV_MKT_TYP_CD_LEN);
  }
  ...
  protected void serializeHvaProvIpaId(int index, char[] value) {
    replaceValue(value, (beginHvaProvIpaId + index * HVA_PROV_IPA_ID_LEN), HVA_PROV_IPA_ID_LEN);
  }
  ...
  protected void serializeHvaTpsmCd(int index, char[] value) {
    replaceValue(value, (beginHvaTpsmCd + index * HVA_TPSM_CD_LEN), HVA_TPSM_CD_LEN);
  }
  ...
  protected void serializeHvaProvSpclCd(int index, char[] value) {
    replaceValue(value, (beginHvaProvSpclCd + index * HVA_PROV_SPCL_CD_LEN), HVA_PROV_SPCL_CD_LEN);
  }
  ...
  protected void serializeHvaDiagCd(int index, char[] value) {
    replaceValue(value, (beginHvaDiagCd + index * HVA_DIAG_CD_LEN), HVA_DIAG_CD_LEN);
  }
  ...
  protected void serializeHvaAuthUniqCnt(int index, int value) {
    ...
    replaceValue(
        getBinaryString(number),
        (beginHvaAuthUniqCnt + index * HVA_AUTH_UNIQ_CNT_LEN),
        HVA_AUTH_UNIQ_CNT_LEN);
  }
  ...
  protected void serializeHvaPhysMedcnMskCnt(int index, int value) {
    ...
    replaceValue(
        getBinaryString(number),
        (beginHvaPhysMedcnMskCnt + index * HVA_PHYS_MEDCN_MSK_CNT_LEN),
        HVA_PHYS_MEDCN_MSK_CNT_LEN);
  }
  ...
  protected void serializeHvaMskNullInd(int index, short value) {
    ...
    replaceValue(
        getBinaryString(number),
        (beginHvaMskNullInd + index * HVA_MSK_NULL_IND_LEN),
        HVA_MSK_NULL_IND_LEN);
  }
