...
/**
 * The class Dt1RspLegacyResponseDataSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class Dt1RspLegacyResponseDataSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1RspLegacyResponseDataSerialized to the parent and set the serialize
  ...
  public boolean isDt1RspReturnCodeModified() {
    ...
    localDt1RspReturnCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1RspReturnCode(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginDt1RspReturnCode, 2);
    localDt1RspReturnCodeCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1RspReturnCode;
  }
  ...
  /**
   * refreshDt1RspReturnCode is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isDt1RspExplanationCodeModified() {
    ...
    localDt1RspExplanationCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1RspExplanationCode(char[] value) {
    ...
    dt1RspExplanationCode =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginDt1RspExplanationCode, 3);
    localDt1RspExplanationCodeCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1RspExplanationCode;
  }
  ...
  /**
   * refreshDt1RspExplanationCode is used to refresh the latest value of a variable from the
  ...
  public int refreshDt1RspExplanationCode() throws CFException {
    try {
      ...
      throw getSoc7ABend(
          "dt1RspExplanationCode", beginDt1RspExplanationCode, DT_1_RSP_EXPLANATION_CODE_LEN);
    }
  }
  ...
  public boolean isDt1RspRespCodeModified() {
    ...
    localDt1RspRespCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1RspRespCode(char[] value) {
    ...
    dt1RspRespCode =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(4, value, false /*isSigned?*/), beginDt1RspRespCode, 4);
    localDt1RspRespCodeCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1RspRespCode;
  }
  ...
  /**
   * refreshDt1RspRespCode is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1RspSqlCodeModified() {
    ...
    localDt1RspSqlCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDt1RspSqlCode(char[] value) {
    ...
    dt1RspSqlCode =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(9, value, false /*isSigned?*/), beginDt1RspSqlCode, 9);
    localDt1RspSqlCodeCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1RspSqlCode;
  }
  ...
  /**
   * refreshDt1RspSqlCode is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isDt1RspErrSectionModified() {
    ...
    localDt1RspErrSectionCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDt1RspErrSection(char[] dt1RspErrSection) {
    ...
    arraycopy(
        dt1RspErrSection, 0, getStringValue(), beginDt1RspErrSection, DT_1_RSP_ERR_SECTION_LEN);
  ...
  /**
   * refreshDt1RspErrSection is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDt1RspErrSection() {
    return (substring(
        getStringValue(), beginDt1RspErrSection, beginDt1RspErrSection + DT_1_RSP_ERR_SECTION_LEN));
  }
}
