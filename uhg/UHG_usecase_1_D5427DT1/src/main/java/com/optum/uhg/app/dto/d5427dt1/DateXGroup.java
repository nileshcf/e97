...
public class DateXGroup extends DateXGroupSerialized {
  ...
  /**
   * set variable dateX Corresponding COBOL Variable is WS-DATE-X
   *
   * @param value
   */
  ...
  /**
   * Update DateX with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DateX with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDateX(
  ...
  /**
   * Update DateX with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DateX with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDateX(
  ...
  /**
   * Update Date9 with the passed value Corresponding COBOL Variable is WS-DATE-9
   *
   * @param number
   */
