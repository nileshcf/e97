...
/**
 * The class SqlnameSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqlnameSerialized extends Field {
  ...
  /**
   * sets parent for this SqlnameSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isSqlnamelModified() {
    ...
    localSqlnamelCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqlnamel(short sqlnamel) {
    replaceValue( //  save the value as string
        getBinaryString(sqlnamel, SQLNAMEL_LEN), beginSqlnamel, SQLNAMEL_LEN);
