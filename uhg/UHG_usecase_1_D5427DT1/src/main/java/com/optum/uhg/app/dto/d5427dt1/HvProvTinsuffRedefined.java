...
public class HvProvTinsuffRedefined extends HvProvTinsuffRedefinedSerialized {
  ...
  /**
   * set variable hvProvTin Corresponding COBOL Variable is HV-PROV-TIN
   *
   * @param value
   */
  ...
  /**
   * Update HvProvTin with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvProvTin with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvProvTin(
  ...
  /**
   * Update HvProvTin with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvProvTin with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvProvTin(
