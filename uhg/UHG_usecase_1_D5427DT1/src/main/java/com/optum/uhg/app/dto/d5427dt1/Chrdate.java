...
public class Chrdate extends ChrdateSerialized {
  ...
  /**
   * Update ChrdateLength with the passed value Corresponding COBOL Variable is CHRDATE-LENGTH
   *
   * @param number
   */
  ...
  public void setChrdateLength(int number) {
    number =
        checkChrdateLengthMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable chrdateString Corresponding COBOL Variable is CHRDATE-STRING
   *
   * @param value
   */
  ...
  /**
   * Update ChrdateString with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ChrdateString with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setChrdateString(
  ...
  /**
   * Update ChrdateString with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ChrdateString with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setChrdateString(
