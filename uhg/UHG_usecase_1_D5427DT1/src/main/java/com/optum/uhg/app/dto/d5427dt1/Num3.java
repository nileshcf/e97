...
public class Num3 extends Num3Serialized {
  ...
  /**
   * set variable num3X Corresponding COBOL Variable is WS-NUM-3-X
   *
   * @param value
   */
  ...
  /**
   * Update Num3X with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Num3X with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNum3X(
  ...
  /**
   * Update Num3X with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Num3X with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNum3X(
  ...
  /**
   * Update Num39 with the passed value Corresponding COBOL Variable is WS-NUM-3-9
   *
   * @param number
   */
