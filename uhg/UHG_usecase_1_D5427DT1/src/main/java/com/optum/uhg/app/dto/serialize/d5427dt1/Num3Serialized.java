...
/**
 * The class Num3Serialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Num3Serialized extends Field {
  ...
  public boolean isNum3XModified() {
    ...
    localNum3XCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshNum3X is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isNum39Modified() {
    ...
    localNum39Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeNum39(char[] value) {
    ...
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginNum39, 3);
    localNum39Counter = shareString.getSerializedField().getModifiedCounter();
    return num39;
  }
  ...
  /**
   * refreshNum39 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
