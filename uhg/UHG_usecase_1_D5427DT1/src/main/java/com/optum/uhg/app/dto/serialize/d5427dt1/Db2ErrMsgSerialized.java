...
/**
 * The class Db2ErrMsgSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Db2ErrMsgSerialized extends Field {
  ...
  public boolean isDb2ErrMsgLenModified() {
    ...
    localDb2ErrMsgLenCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDb2ErrMsgLen is used to refresh the latest value of a variable from the Serialized
  ...
  protected void serializeDb2ErrMsgText(int index, char[] value) {
    replaceValue(
        value, (beginDb2ErrMsgText + index * DB_2_ERR_MSG_TEXT_LEN), DB_2_ERR_MSG_TEXT_LEN);
  }
  ...
  public boolean isDb2ErrMsgTextLenModified() {
    ...
    localDb2ErrMsgTextLenCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDb2ErrMsgTextLen is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  protected void serializeISub(short iSub) {
    replaceValue( //  save the value as string
        getBinaryString(iSub, I_SUB_LEN), beginISub, I_SUB_LEN);
  ...
  /**
   * refreshISub is used to refresh the latest value of a variable from the Serialized String the
