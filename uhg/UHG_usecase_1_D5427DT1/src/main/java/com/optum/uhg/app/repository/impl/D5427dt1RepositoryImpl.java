...
public class D5427dt1RepositoryImpl implements D5427dt1Repository {
  ...
  /**
   * ***** SELECT ***** POL_NBR ***** , EE_ID ***** , DEPN_NBR ***** INTO ***** :DREF-POL-NBR *****
   * , :DREF-EE-ID ***** , :DREF-DEPN-NBR ***** FROM ADJD_CLMSF_REF ***** ***** WHERE INVN_CTL_NBR =
   * :DREF-INVN-CTL-NBR ***** FETCH FIRST 1 ROWS ONLY ***** WITH UR *****
   */
  public void selectAdjdClmsfRef(DcladjdClmsfRef dcladjdClmsfRef, Sqlca sqlca) throws Exception {
    try {
      ...
      ResultSet resultSet =
          db2Base
              .startQuery(14 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** DECLARE CSR-INIT-FIL2 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** ***** FROM
   * ADJD_CLMHST_DENORM_REF REF ***** ***** WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND
   * REF.EE_ID = :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND
   * :HV-LST-SRVC-DT >= REF.FST_DT ***** AND :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** AND
   * SUBSTR(REF.PROV_TINSUFF,2,9) = :HV-PROV-TIN ***** ***** ORDER BY REF.PROC_DT DESC ***** ,
   * REF.PROC_TM DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** ,
   * REF.ICN_SUFX_CD DESC ***** ***** FETCH FIRST 500 ROWS ONLY ***** ) ***** ***** SELECT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.PGM_ID_LST_CHAR_VAL ***** , REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** ,
   * REF.ICN_SUFX_CD ***** , REF.LN_ID ***** ***** , REF.FLN_JULIAN_DT_NBR ***** , REF.FLN_SRL_NBR
   * ***** , REF.DFT_NBR ***** , REF.FST_DT ***** , REF.LST_SRVC_DT ***** , REF.PROV_TINSUFF *****
   * ***** , REF.PROV_SCRN_NBR ***** , REF.CHRG_AMT ***** , REF.RMRK_CD ***** , REF.NC_AMT ***** ,
   * REF.PMT_SVC_CD ***** , REF.OVR_CD ***** , REF.COPAY_AMT ***** , REF.SRVC_CD ***** , REF.PAY_CD
   * ***** , REF.TRANS_CD ***** , HDR.FILM_OFC_NBR ***** , HDR.CLM_LVL_RSN_CD ***** , HDR.ADJTR_ID
   * ***** , HDR.MBR_PRV_IND ***** , HDR.NTFY_WAIV_CD ***** , HDR.BANK_CD ***** , HDR.DIV_NBR *****
   * , HDR.CLS_NBR ***** , HDR.DRG_NBR ***** , HDR.FACL_OR_PROF_CD ***** , BKE.DLGT_ENTY_CD ***** ,
   * BK2.NDB_CONTR_ID ***** , BK2.CLM_SMB_TYP_APP_CD ***** , BK2.SMB_ST_CD ***** , DLN.PROC_T1_IND
   * ***** , DLN.AUTH_NBR ***** , DLN.BASE_DED_DESC_TXT ***** , DLN.MM_DED_DESC_TXT ***** ,
   * DLN.PRS_CREAT_SRC_CD ***** , DLN.BASE_DED_AMT ***** , DLN.BASE_AMT ***** , DLN.MM_DED_AMT *****
   * , DLN.MM_AMT ***** , DLN.MC_CR_RES_AMT ***** , DLN.COB_CR_RES_AMT ***** , DLN.PAR_IND ***** ,
   * DLN.SUP_AMT ***** , DLN.PROV_MKT_NBR ***** , DLN.PPO_CD ***** , DLN.PTNT_RESP_AMT ***** ,
   * LNE.AUTH_SRC_ID ***** , LNE.AUTH_PROC_CD ***** , PRV.PROV_NM ***** , PRV.PROV_EOB_NM ***** ,
   * PRV.PROV_PRDCT_CD ***** , PRV.PROV_MKT_TYP_CD ***** , PRV.PROV_IPA_ID ***** , PRV.TPSM_CD *****
   * , PRV.PROV_SPCL_CD ***** , IFNULL( ***** (SELECT PR1.PROV_MEDCD_RECLM_IND ***** FROM
   * ADJD_CLMSF_PROV PR1 ***** WHERE REF.PARTN_ID = PR1.PARTN_ID ***** AND REF.PARTN_VAL =
   * PR1.PARTN_VAL ***** AND REF.INVN_CTL_NBR = PR1.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * PR1.ICN_SUFX_CD ***** AND REF.PROC_DT = PR1.PROC_DT ***** AND REF.PROC_TM = PR1.PROC_TM *****
   * AND PR1.PROV_MEDCD_RECLM_IND = 'Y' ***** ORDER BY LST_UPDT_DTTM DESC ***** FETCH FIRST 1 ROW
   * ONLY) ***** ,' ') ***** , IFNULL( ***** ( SELECT REL.REL_SRVC_CLM_LVL_IND ***** FROM
   * ADJD_CLMSFLN_REL_SRVCS REL ***** WHERE REF.PARTN_ID = REL.PARTN_ID ***** AND REF.PARTN_VAL =
   * REL.PARTN_VAL ***** AND REF.INVN_CTL_NBR = REL.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * REL.ICN_SUFX_CD ***** AND REF.PROC_DT = REL.PROC_DT ***** AND REF.PROC_TM = REL.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR ***** = REL.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = REL.LN_ID *****
   * FETCH FIRST 1 ROWS ONLY ) ***** ,' ') ***** , IFNULL(DIA.DIAG_CD,' ') ***** ***** ,( SELECT
   * COUNT(DISTINCT AUTH_NBR) ***** FROM ADJD_CLMHST_DENORM_LN DLN2 ***** WHERE REF.PARTN_ID =
   * DLN2.PARTN_ID ***** AND REF.PARTN_VAL = DLN2.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * DLN2.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = DLN2.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * DLN2.PROC_DT ***** AND REF.PROC_TM = DLN2.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * DLN2.ICN_SUFX_VERS_NBR ***** AND ' ' < DLN2.AUTH_NBR ) ***** ***** ,( SELECT
   * SUM(PHYS_MEDCN_MSK_CNT) ***** FROM ADJD_CLMSF_LN2 LN2 ***** WHERE REF.PARTN_ID = LN2.PARTN_ID
   * ***** AND REF.PARTN_VAL = LN2.PARTN_VAL ***** AND REF.INVN_CTL_NBR = LN2.INVN_CTL_NBR ***** AND
   * REF.ICN_SUFX_CD = LN2.ICN_SUFX_CD ***** AND REF.PROC_DT = LN2.PROC_DT ***** AND REF.PROC_TM =
   * LN2.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = LN2.ICN_SUFX_VERS_NBR) ***** ***** FROM
   * CLM_HST_TABLE HST ***** INNER JOIN ADJD_CLMHST_DENORM_REF REF ***** ON REF.PARTN_ID =
   * HST.PARTN_ID ***** AND REF.PARTN_VAL = HST.PARTN_VAL ***** AND REF.PROC_DT = HST.PROC_DT *****
   * AND REF.PROC_TM = HST.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = HST.ICN_SUFX_VERS_NBR ***** AND
   * REF.INVN_CTL_NBR = HST.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = HST.ICN_SUFX_CD ***** *****
   * ***** INNER JOIN ADJD_CLMHST_DENORM_HDR HDR ***** ON REF.PARTN_ID = HDR.PARTN_ID ***** AND
   * REF.PARTN_VAL = HDR.PARTN_VAL ***** AND REF.INVN_CTL_NBR = HDR.INVN_CTL_NBR ***** AND
   * REF.ICN_SUFX_CD = HDR.ICN_SUFX_CD ***** AND REF.PROC_DT = HDR.PROC_DT ***** AND REF.PROC_TM =
   * HDR.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = HDR.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN
   * ADJD_CLMSF_BLK_E BKE ***** ON REF.PARTN_ID = BKE.PARTN_ID ***** AND REF.PARTN_VAL =
   * BKE.PARTN_VAL ***** AND REF.INVN_CTL_NBR = BKE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * BKE.ICN_SUFX_CD ***** AND REF.PROC_DT = BKE.PROC_DT ***** AND REF.PROC_TM = BKE.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = BKE.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN ADJD_CLMSF_BLK_E2 BK2
   * ***** ON REF.PARTN_ID = BK2.PARTN_ID ***** AND REF.PARTN_VAL = BK2.PARTN_VAL ***** AND
   * REF.INVN_CTL_NBR = BK2.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = BK2.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = BK2.PROC_DT ***** AND REF.PROC_TM = BK2.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * BK2.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN ADJD_CLMHST_DENORM_LN DLN ***** ON REF.PARTN_ID =
   * DLN.PARTN_ID ***** AND REF.PARTN_VAL = DLN.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * DLN.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = DLN.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * DLN.PROC_DT ***** AND REF.PROC_TM = DLN.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * DLN.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = DLN.LN_ID ***** ***** INNER JOIN ADJD_CLMSF_PROV
   * PRV ***** ON REF.PARTN_ID = PRV.PARTN_ID ***** AND REF.PARTN_VAL = PRV.PARTN_VAL ***** AND
   * REF.INVN_CTL_NBR = PRV.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = PRV.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM = PRV.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR = PRV.PROV_SEQ_NBR ***** ***** INNER JOIN
   * ADJD_CLMSF_LN LNE ***** ON REF.PARTN_ID = LNE.PARTN_ID ***** AND REF.PARTN_VAL = LNE.PARTN_VAL
   * ***** AND REF.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = LNE.ICN_SUFX_CD *****
   * AND REF.PROC_DT = LNE.PROC_DT ***** AND REF.PROC_TM = LNE.PROC_TM ***** AND
   * REF.ICN_SUFX_VERS_NBR = LNE.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = LNE.LN_ID ***** ***** LEFT
   * OUTER JOIN ADJD_CLMSF_DIAG DIA ***** ON REF.PARTN_ID = DIA.PARTN_ID ***** AND REF.PARTN_VAL =
   * DIA.PARTN_VAL ***** AND REF.INVN_CTL_NBR = DIA.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * DIA.ICN_SUFX_CD ***** AND REF.PROC_DT = DIA.PROC_DT ***** AND REF.PROC_TM = DIA.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = DIA.ICN_SUFX_VERS_NBR ***** AND 1 = DIA.DIAG_SEQ_NBR ***** *****
   * ORDER BY REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** , REF.PGM_ID_LST_CHAR_VAL DESC ***** ,
   * REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC ***** ,
   * REF.LN_ID DESC ***** ***** OPTIMIZE FOR 600 ROWS ***** FETCH FIRST 600 ROWS ONLY ***** WITH UR
   */
  public ResultSet openCsrInitFil2D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFil2ResultSet =
          db2Base
              .startQuery(15 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
              .withSql(SQLS.SQL_352034233)
              .withInputs(
                  dcladjdClmhstDenormRef.getDderefPolNbrGroup().getDderefPolNbr(),
                  dcladjdClmhstDenormRef.getDderefEeIdGroup().getDderefEeId(),
                  dcladjdClmhstDenormRef.getDderefDepnNbrGroup().getDderefDepnNbr(),
                  hostVariables.getHvLstSrvcDtGroup().getHvLstSrvcDt(),
                  hostVariables.getHvFstDtGroup().getHvFstDt(),
                  hostVariables.getHvProvTinsuffRedefined().getHvProvTin())
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FIL2 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
   * ***** , :HVA-PROV-SCRN-NBR ***** , :HVA-CHRG-AMT ***** , :HVA-RMRK-CD ***** , :HVA-NC-AMT *****
   * , :HVA-PMT-SVC-CD ***** , :HVA-OVR-CD ***** , :HVA-COPAY-AMT ***** , :HVA-SRVC-CD ***** ,
   * :HVA-PAY-CD ***** , :HVA-TRANS-CD ***** , :HVA-FILM-OFC-NBR ***** , :HVA-CLM-LVL-RSN-CD ***** ,
   * :HVA-ADJTR-ID ***** , :HVA-MBR-PRV-IND ***** , :HVA-NTFY-WAIV-CD ***** , :HVA-BANK-CD ***** ,
   * :HVA-DIV-NBR ***** , :HVA-CLS-NBR ***** , :HVA-DRG-NBR ***** , :HVA-FACL-OR-PROF-CD ***** ,
   * :HVA-DLGTE-IND ***** , :HVA-NDB-CONTR-ID ***** , :HVA-CLM-SMB-TYP-APP-CD ***** , :HVA-SMB-ST-CD
   * ***** , :HVA-PROC-T1-IND ***** , :HVA-AUTH-NBR ***** , :HVA-BASE-DED-DESC-TXT ***** ,
   * :HVA-MM-DED-DESC-TXT ***** , :HVA-PRS-CREAT-SRC-CD ***** , :HVA-BASE-DED-AMT ***** ,
   * :HVA-BASE-AMT ***** , :HVA-MM-DED-AMT ***** , :HVA-MM-AMT ***** , :HVA-MC-CR-RES-AMT ***** ,
   * :HVA-COB-CR-RES-AMT ***** , :HVA-PAR-IND ***** , :HVA-SUP-AMT ***** , :HVA-PROV-MKT-NBR ***** ,
   * :HVA-PPO-CD ***** , :HVA-PTNT-RESP-AMT ***** , :HVA-AUTH-SRC-ID ***** , :HVA-AUTH-PROC-CD *****
   * , :HVA-PROV-NM ***** , :HVA-PROV-EOB-NM ***** , :HVA-PROV-PRDCT-CD ***** , :HVA-PROV-MKT-TYP-CD
   * ***** , :HVA-PROV-IPA-ID ***** , :HVA-TPSM-CD ***** , :HVA-PROV-SPCL-CD ***** ,
   * :HVA-PROV-MEDCD-RECLM-IND ***** , :HVA-REL-SRVC-CLM-LVL-IND ***** , :HVA-DIAG-CD ***** ,
   * :HVA-AUTH-UNIQ-CNT ***** , :HVA-PHYS-MEDCN-MSK-CNT:HVA-MSK-NULL-IND *****
   */
    ...
    try {
      ...
      while (hasResults && ftchRowCnt < work.getFetchRowsetMax()) {
        ...
        if (hasResults) {
          ...
          if (resultObj != null) {
            hvaClmHistArray.setHvaIcnSufxVersNbr(
                ftchRowCnt, (short) ((Integer) resultObj).intValue());
          } else {
            sqlca.setSqlcode(-305);
          }
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                ...
                hvaClmHistArray.setHvaChrgAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
              else if (Double.class.isInstance(resultObj))
                hvaClmHistArray.setHvaChrgAmt(
                    ftchRowCnt, new BigDecimal((Double) resultObj, MathContext.DECIMAL64));
            }
          } else {
            sqlca.setSqlcode(-305);
          }
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                ...
                hvaClmHistArray.setHvaCopayAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
              else if (Double.class.isInstance(resultObj))
                hvaClmHistArray.setHvaCopayAmt(
                    ftchRowCnt, new BigDecimal((Double) resultObj, MathContext.DECIMAL64));
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                hvaClmHistArray.setHvaBaseDedAmt(
                    ftchRowCnt, BigDecimal.valueOf((Integer) resultObj));
              else if (Float.class.isInstance(resultObj))
                hvaClmHistArray.setHvaBaseDedAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
              else if (Double.class.isInstance(resultObj))
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                ...
                hvaClmHistArray.setHvaMmDedAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
              else if (Double.class.isInstance(resultObj))
                hvaClmHistArray.setHvaMmDedAmt(
                    ftchRowCnt, new BigDecimal((Double) resultObj, MathContext.DECIMAL64));
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                hvaClmHistArray.setHvaMcCrResAmt(
                    ftchRowCnt, BigDecimal.valueOf((Integer) resultObj));
              else if (Float.class.isInstance(resultObj))
                hvaClmHistArray.setHvaMcCrResAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                hvaClmHistArray.setHvaCobCrResAmt(
                    ftchRowCnt, BigDecimal.valueOf((Integer) resultObj));
              else if (Float.class.isInstance(resultObj))
                hvaClmHistArray.setHvaCobCrResAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
          ...
          if (resultObj != null) {
            try {
              ...
              if (Integer.class.isInstance(resultObj))
                hvaClmHistArray.setHvaPtntRespAmt(
                    ftchRowCnt, BigDecimal.valueOf((Integer) resultObj));
              else if (Float.class.isInstance(resultObj))
                hvaClmHistArray.setHvaPtntRespAmt(
                    ftchRowCnt, new BigDecimal((Float) resultObj, MathContext.DECIMAL32));
          ...
          if (resultObj != null) {
            hvaClmHistArray.setHvaPhysMedcnMskCnt(ftchRowCnt, ((Integer) resultObj).intValue());
            hvaClmHistArray.setHvaMskNullInd(ftchRowCnt, 0);
            if (hvaClmHistArray.getHvaMskNullInd(ftchRowCnt) != 0)
              hvaClmHistArray.setHvaMskNullInd(ftchRowCnt, 0);
  ...
  /**
   * ***** DECLARE CSR-NEXT-FIL2 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** ***** FROM
   ...
   * REF.EE_ID = :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND
   * :HV-LST-SRVC-DT >= REF.FST_DT ***** AND :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** AND
   * SUBSTR(REF.PROV_TINSUFF,2,9) = :HV-PROV-TIN ***** ***** AND ***** ( ***** ( REF.PROC_DT =
   * :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL *****
   * = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR
   * ***** AND REF.INVN_CTL_NBR = :DDEREF-INVN-CTL-NBR ***** AND REF.ICN_SUFX_CD =
   * :DDEREF-ICN-SUFX-CD ***** AND REF.LN_ID <= :DDEREF-LN-ID ***** ) ***** OR ***** ( REF.PROC_DT =
   * :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL *****
   * = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR
   * ***** AND REF.INVN_CTL_NBR = :DDEREF-INVN-CTL-NBR ***** AND REF.ICN_SUFX_CD <
   * :DDEREF-ICN-SUFX-CD ***** ) ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND
   * REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL ***** =
   * :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR
   * ***** AND REF.INVN_CTL_NBR < :DDEREF-INVN-CTL-NBR ***** ) ***** OR ***** ( REF.PROC_DT =
   * :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL *****
   * = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** < :DDEREF-ICN-SUFX-VERS-NBR
   * ***** ) ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM
   * ***** AND REF.PGM_ID_LST_CHAR_VAL ***** < :DDEREF-PGM-ID-LST-CHAR-VAL ***** ) ***** OR ***** (
   * REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM < :DDEREF-PROC-TM ***** ) ***** OR ***** (
   * REF.PROC_DT < :DDEREF-PROC-DT ***** ) ***** ) ***** ***** ORDER BY REF.PROC_DT DESC ***** ,
   * REF.PROC_TM DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** ,
   * REF.ICN_SUFX_CD DESC ***** ***** FETCH FIRST 500 ROWS ONLY ***** ) ***** ***** SELECT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.PGM_ID_LST_CHAR_VAL ***** , REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** ,
   ...
   * ***** , REF.TRANS_CD ***** , HDR.FILM_OFC_NBR ***** , HDR.CLM_LVL_RSN_CD ***** , HDR.ADJTR_ID
   * ***** , HDR.MBR_PRV_IND ***** , HDR.NTFY_WAIV_CD ***** , HDR.BANK_CD ***** , HDR.DIV_NBR *****
   * , HDR.CLS_NBR ***** , BKE.DLGT_ENTY_CD ***** , BK2.NDB_CONTR_ID ***** , BK2.CLM_SMB_TYP_APP_CD
   * ***** , BK2.SMB_ST_CD ***** , DLN.PROC_T1_IND ***** , DLN.AUTH_NBR ***** ,
   * DLN.BASE_DED_DESC_TXT ***** , DLN.MM_DED_DESC_TXT ***** , DLN.PRS_CREAT_SRC_CD ***** ,
   * DLN.BASE_DED_AMT ***** , DLN.BASE_AMT ***** , DLN.MM_DED_AMT ***** , DLN.MM_AMT ***** ,
   * DLN.MC_CR_RES_AMT ***** , DLN.COB_CR_RES_AMT ***** , DLN.PAR_IND ***** , DLN.SUP_AMT ***** ,
   * DLN.PROV_MKT_NBR ***** , DLN.PPO_CD ***** , DLN.PTNT_RESP_AMT ***** , LNE.AUTH_SRC_ID ***** ,
   * LNE.AUTH_PROC_CD ***** , PRV.PROV_NM ***** , PRV.PROV_EOB_NM ***** , PRV.PROV_PRDCT_CD ***** ,
   * PRV.PROV_MKT_TYP_CD ***** , PRV.PROV_IPA_ID ***** , PRV.TPSM_CD ***** , PRV.PROV_SPCL_CD *****
   * , IFNULL( ***** (SELECT PR1.PROV_MEDCD_RECLM_IND ***** FROM ADJD_CLMSF_PROV PR1 ***** WHERE
   * REF.PARTN_ID = PR1.PARTN_ID ***** AND REF.PARTN_VAL = PR1.PARTN_VAL ***** AND REF.INVN_CTL_NBR
   * = PR1.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = PR1.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * PR1.PROC_DT ***** AND REF.PROC_TM = PR1.PROC_TM ***** AND PR1.PROV_MEDCD_RECLM_IND = 'Y' *****
   * ORDER BY LST_UPDT_DTTM DESC ***** FETCH FIRST 1 ROW ONLY) ***** ,' ') ***** , IFNULL( ***** (
   * SELECT REL.REL_SRVC_CLM_LVL_IND ***** FROM ADJD_CLMSFLN_REL_SRVCS REL ***** WHERE REF.PARTN_ID
   * = REL.PARTN_ID ***** AND REF.PARTN_VAL = REL.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * REL.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = REL.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * REL.PROC_DT ***** AND REF.PROC_TM = REL.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR ***** =
   * REL.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = REL.LN_ID ***** FETCH FIRST 1 ROWS ONLY ) ***** ,'
   * ') ***** , IFNULL(DIA.DIAG_CD,' ') ***** ***** ,( SELECT COUNT(DISTINCT AUTH_NBR) ***** FROM
   * ADJD_CLMHST_DENORM_LN DLN2 ***** WHERE REF.PARTN_ID = DLN2.PARTN_ID ***** AND REF.PARTN_VAL =
   * DLN2.PARTN_VAL ***** AND REF.INVN_CTL_NBR = DLN2.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * DLN2.ICN_SUFX_CD ***** AND REF.PROC_DT = DLN2.PROC_DT ***** AND REF.PROC_TM = DLN2.PROC_TM
   * ***** AND REF.ICN_SUFX_VERS_NBR = DLN2.ICN_SUFX_VERS_NBR ***** AND ' ' < DLN2.AUTH_NBR ) *****
   * ,( SELECT SUM(PHYS_MEDCN_MSK_CNT) ***** FROM ADJD_CLMSF_LN2 LN2 ***** WHERE REF.PARTN_ID =
   * LN2.PARTN_ID ***** AND REF.PARTN_VAL = LN2.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * LN2.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = LN2.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * LN2.PROC_DT ***** AND REF.PROC_TM = LN2.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * LN2.ICN_SUFX_VERS_NBR) ***** ***** FROM CLM_HST_TABLE HST ***** INNER JOIN
   * ADJD_CLMHST_DENORM_REF REF ***** ON REF.PARTN_ID = HST.PARTN_ID ***** AND REF.PARTN_VAL =
   * HST.PARTN_VAL ***** AND REF.PROC_DT = HST.PROC_DT ***** AND REF.PROC_TM = HST.PROC_TM ***** AND
   * REF.ICN_SUFX_VERS_NBR = HST.ICN_SUFX_VERS_NBR ***** AND REF.INVN_CTL_NBR = HST.INVN_CTL_NBR
   * ***** AND REF.ICN_SUFX_CD = HST.ICN_SUFX_CD ***** ***** ***** INNER JOIN ADJD_CLMHST_DENORM_HDR
   * HDR ***** ON REF.PARTN_ID = HDR.PARTN_ID ***** AND REF.PARTN_VAL = HDR.PARTN_VAL ***** AND
   * REF.INVN_CTL_NBR = HDR.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = HDR.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = HDR.PROC_DT ***** AND REF.PROC_TM = HDR.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * HDR.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN ADJD_CLMSF_BLK_E BKE ***** ON REF.PARTN_ID =
   * BKE.PARTN_ID ***** AND REF.PARTN_VAL = BKE.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * BKE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = BKE.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * BKE.PROC_DT ***** AND REF.PROC_TM = BKE.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * BKE.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN ADJD_CLMSF_BLK_E2 BK2 ***** ON REF.PARTN_ID =
   * BK2.PARTN_ID ***** AND REF.PARTN_VAL = BK2.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * BK2.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = BK2.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * BK2.PROC_DT ***** AND REF.PROC_TM = BK2.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * BK2.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN ADJD_CLMHST_DENORM_LN DLN ***** ON REF.PARTN_ID =
   * DLN.PARTN_ID ***** AND REF.PARTN_VAL = DLN.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
   * DLN.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = DLN.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * DLN.PROC_DT ***** AND REF.PROC_TM = DLN.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
  ...
  public ResultSet openCsrNextFil2D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFil2ResultSet =
          db2Base
              .startQuery(19 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
              ...
              .withInputs(
                  ...
                  dcladjdClmhstDenormRef.getDderefProcTmGroup().getDderefProcTm(),
                  dcladjdClmhstDenormRef.getDderefPgmIdLstCharValGroup().getDderefPgmIdLstCharVal(),
                  dcladjdClmhstDenormRef.getDderefIcnSufxVersNbr(),
                  dcladjdClmhstDenormRef.getDderefInvnCtlNbrGroup().getDderefInvnCtlNbr(),
                  dcladjdClmhstDenormRef.getDderefIcnSufxCdGroup().getDderefIcnSufxCd(),
                  dcladjdClmhstDenormRef.getDderefLnIdGroup().getDderefLnId(),
                  dcladjdClmhstDenormRef.getDderefProcDtGroup().getDderefProcDt(),
                  dcladjdClmhstDenormRef.getDderefProcTmGroup().getDderefProcTm(),
                  dcladjdClmhstDenormRef.getDderefPgmIdLstCharValGroup().getDderefPgmIdLstCharVal(),
                  dcladjdClmhstDenormRef.getDderefIcnSufxVersNbr(),
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FIL2 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /** ***** PREPARE DT1-DYN-QUERY ***** FROM :QUERY-TEXT-AREA */
  ...
  /**
   * ***** DECLARE CSR-INIT-FULL CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** ***** FROM
   * ADJD_CLMHST_DENORM_REF REF ***** ***** WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND
   * REF.EE_ID = :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** ORDER BY
   * REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** ,
   * REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC ***** ***** FETCH FIRST 500 ROWS ONLY *****
   * ) ***** ***** SELECT ***** REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** ,
   * REF.PROC_TM ***** , REF.PGM_ID_LST_CHAR_VAL ***** , REF.ICN_SUFX_VERS_NBR ***** ,
   * REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , REF.LN_ID ***** ***** , REF.FLN_JULIAN_DT_NBR
   * ***** , REF.FLN_SRL_NBR ***** , REF.DFT_NBR ***** , REF.FST_DT ***** , REF.LST_SRVC_DT ***** ,
   * REF.PROV_TINSUFF ***** ***** , REF.PROV_SCRN_NBR ***** , REF.CHRG_AMT ***** , REF.RMRK_CD *****
   * , REF.NC_AMT ***** , REF.PMT_SVC_CD ***** , REF.OVR_CD ***** , REF.COPAY_AMT ***** ,
   * REF.SRVC_CD ***** , REF.PAY_CD ***** , REF.TRANS_CD ***** , HDR.FILM_OFC_NBR ***** ,
   * HDR.CLM_LVL_RSN_CD ***** , HDR.ADJTR_ID ***** , HDR.MBR_PRV_IND ***** , HDR.NTFY_WAIV_CD *****
   * , HDR.BANK_CD ***** , HDR.DIV_NBR ***** , HDR.CLS_NBR ***** , HDR.DRG_NBR ***** ,
   * HDR.FACL_OR_PROF_CD ***** , BKE.DLGT_ENTY_CD ***** , BK2.NDB_CONTR_ID ***** ,
   ...
   * HST.PARTN_VAL ***** AND REF.PROC_DT = HST.PROC_DT ***** AND REF.PROC_TM = HST.PROC_TM ***** AND
   * REF.ICN_SUFX_VERS_NBR = HST.ICN_SUFX_VERS_NBR ***** AND REF.INVN_CTL_NBR = HST.INVN_CTL_NBR
   * ***** AND REF.ICN_SUFX_CD = HST.ICN_SUFX_CD ***** ***** INNER JOIN ADJD_CLMHST_DENORM_HDR HDR
   * ***** ON REF.PARTN_ID = HDR.PARTN_ID ***** AND REF.PARTN_VAL = HDR.PARTN_VAL ***** AND
   * REF.INVN_CTL_NBR = HDR.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = HDR.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = HDR.PROC_DT ***** AND REF.PROC_TM = HDR.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * HDR.ICN_SUFX_VERS_NBR ***** ***** INNER JOIN ADJD_CLMSF_BLK_E BKE ***** ON REF.PARTN_ID =
   * BKE.PARTN_ID ***** AND REF.PARTN_VAL = BKE.PARTN_VAL ***** AND REF.INVN_CTL_NBR =
  ...
  public ResultSet openCsrInitFullD5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFullResultSet =
          db2Base
              .startQuery(24 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FULL ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-INIT-FILT CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** FROM
   * ADJD_CLMHST_DENORM_REF REF ***** ***** WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND
   * REF.EE_ID = :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND
   * :HV-LST-SRVC-DT >= REF.FST_DT ***** AND :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** ***** ORDER
   * BY REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** ,
   * REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC ***** ***** FETCH FIRST 500 ROWS ONLY *****
   * ) ***** ***** SELECT ***** REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** ,
   * REF.PROC_TM ***** , REF.PGM_ID_LST_CHAR_VAL ***** , REF.ICN_SUFX_VERS_NBR ***** ,
   * REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , REF.LN_ID ***** ***** , REF.FLN_JULIAN_DT_NBR
  ...
  public ResultSet openCsrInitFiltD5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFiltResultSet =
          db2Base
              .startQuery(28 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FILT ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-NEXT-FULL CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** FROM
   * ADJD_CLMHST_DENORM_REF REF ***** ***** WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND
   * REF.EE_ID = :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND ***** (
   * ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND
   * REF.PGM_ID_LST_CHAR_VAL ***** = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR
   * ***** = :DDEREF-ICN-SUFX-VERS-NBR ***** AND REF.INVN_CTL_NBR = :DDEREF-INVN-CTL-NBR ***** AND
   * REF.ICN_SUFX_CD = :DDEREF-ICN-SUFX-CD ***** AND REF.LN_ID <= :DDEREF-LN-ID ***** ) ***** OR
   * ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND
   * REF.PGM_ID_LST_CHAR_VAL ***** = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR
   * ***** = :DDEREF-ICN-SUFX-VERS-NBR ***** AND REF.INVN_CTL_NBR = :DDEREF-INVN-CTL-NBR ***** AND
   * REF.ICN_SUFX_CD < :DDEREF-ICN-SUFX-CD ***** ) ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT
   * ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL ***** =
   * :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR
   * ***** AND REF.INVN_CTL_NBR < :DDEREF-INVN-CTL-NBR ***** ) ***** OR ***** ( REF.PROC_DT =
   * :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL *****
   * = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** < :DDEREF-ICN-SUFX-VERS-NBR
   ...
   * ***** AND REF.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = LNE.ICN_SUFX_CD *****
   * AND REF.PROC_DT = LNE.PROC_DT ***** AND REF.PROC_TM = LNE.PROC_TM ***** AND
   * REF.ICN_SUFX_VERS_NBR = LNE.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = LNE.LN_ID ***** ***** *****
   * LEFT OUTER JOIN ADJD_CLMSF_DIAG DIA ***** ON REF.PARTN_ID = DIA.PARTN_ID ***** AND
   * REF.PARTN_VAL = DIA.PARTN_VAL ***** AND REF.INVN_CTL_NBR = DIA.INVN_CTL_NBR ***** AND
   * REF.ICN_SUFX_CD = DIA.ICN_SUFX_CD ***** AND REF.PROC_DT = DIA.PROC_DT ***** AND REF.PROC_TM =
   * DIA.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = DIA.ICN_SUFX_VERS_NBR ***** AND 1 =
   * DIA.DIAG_SEQ_NBR ***** ***** ORDER BY REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** ,
   * REF.PGM_ID_LST_CHAR_VAL DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC
   * ***** , REF.ICN_SUFX_CD DESC ***** , REF.LN_ID DESC ***** ***** OPTIMIZE FOR 600 ROWS *****
   * FETCH FIRST 600 ROWS ONLY ***** WITH UR
   */
  public ResultSet openCsrNextFullD5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFullResultSet =
          db2Base
              .startQuery(32 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FULL ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-NEXT-FILT CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** ***** FROM
   ...
   * DIA.PARTN_VAL ***** AND REF.INVN_CTL_NBR = DIA.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * DIA.ICN_SUFX_CD ***** AND REF.PROC_DT = DIA.PROC_DT ***** AND REF.PROC_TM = DIA.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = DIA.ICN_SUFX_VERS_NBR ***** AND 1 = DIA.DIAG_SEQ_NBR ***** ORDER BY
   * REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** , REF.PGM_ID_LST_CHAR_VAL DESC ***** ,
   * REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC ***** ,
   * REF.LN_ID DESC ***** ***** OPTIMIZE FOR 600 ROWS ***** FETCH FIRST 600 ROWS ONLY ***** WITH UR
   */
  public ResultSet openCsrNextFiltD5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFiltResultSet =
          db2Base
              .startQuery(36 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FILT ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-INIT-FIL3 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , LNE.AUTH_SRC_ID
   * ***** , LNE.AUTH_PROC_CD ***** , PRV.PROV_NM ***** , PRV.PROV_EOB_NM ***** , PRV.PROV_PRDCT_CD
   * ***** , PRV.PROV_MKT_TYP_CD ***** , PRV.PROV_IPA_ID ***** , PRV.TPSM_CD ***** ,
   * PRV.PROV_SPCL_CD ***** ***** FROM ADJD_CLMHST_DENORM_REF REF ***** INNER JOIN ADJD_CLMSF_LN LNE
   * ***** ON REF.PARTN_ID = LNE.PARTN_ID ***** AND REF.PARTN_VAL = LNE.PARTN_VAL ***** AND
   * REF.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = LNE.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = LNE.PROC_DT ***** AND REF.PROC_TM = LNE.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * LNE.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = LNE.LN_ID ***** INNER JOIN ADJD_CLMSF_ORIGHDR ORG
   * ***** ON ORG.PARTN_ID = LNE.PARTN_ID ***** AND ORG.PARTN_VAL = LNE.PARTN_VAL ***** AND
   * ORG.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND ORG.ICN_SUFX_CD = LNE.ICN_SUFX_CD ***** AND
   * ORG.PROC_DT = LNE.PROC_DT ***** AND ORG.PROC_TM = LNE.PROC_TM ***** AND ORG.ICN_SUFX_VERS_NBR =
   * LNE.ICN_SUFX_VERS_NBR ***** AND ORG.LN_CORR_ID = LNE.ORIG_LN_CORR_ID ***** INNER JOIN
   * ADJD_CLMSF_PROV PRV ***** ON REF.PARTN_ID = PRV.PARTN_ID ***** AND REF.PARTN_VAL =
   * PRV.PARTN_VAL ***** AND REF.INVN_CTL_NBR = PRV.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * PRV.ICN_SUFX_CD ***** AND REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM = PRV.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR =
   * PRV.PROV_SEQ_NBR ***** INNER JOIN ADJD_CLMSFLN_ACCUM ACM ***** ON REF.PARTN_ID = ACM.PARTN_ID
   * ***** AND REF.PARTN_VAL = ACM.PARTN_VAL ***** AND REF.INVN_CTL_NBR = ACM.INVN_CTL_NBR ***** AND
   * REF.ICN_SUFX_CD = ACM.ICN_SUFX_CD ***** AND REF.PROC_DT = ACM.PROC_DT ***** AND REF.PROC_TM =
   * ACM.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = ACM.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID =
   * ACM.LN_ID ***** ***** WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND REF.EE_ID =
   * :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND :HV-LST-SRVC-DT >=
   * REF.FST_DT ***** AND :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** AND SUBSTR(REF.PROV_TINSUFF,2,9)
   * BETWEEN ***** :HV-PROV-TIN AND :HV-PROV-TIN1 ***** AND REF.RMRK_CD BETWEEN :HV-REMARK-CD1 AND
   * ***** :HV-REMARK-CD2 ***** ***** AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 ***** AND
   * :HV-CAUSE-CD2 ***** AND (ORG.UB92_RVNU_CD BETWEEN :HV-REV-FROM ***** AND :HV-REV-THRU) *****
   * AND ACM.LN_ACCUM_TYP_CD = 'OOP' ***** ***** ***** ORDER BY REF.PROC_DT DESC ***** , REF.PROC_TM
   * DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD
   * DESC ***** ***** FETCH FIRST 500 ROWS ONLY ***** ) ***** ***** SELECT ***** REF.PARTN_ID *****
   * , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** , REF.PGM_ID_LST_CHAR_VAL ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , REF.LN_ID *****
   * ***** , REF.FLN_JULIAN_DT_NBR ***** , REF.FLN_SRL_NBR ***** , REF.DFT_NBR ***** , REF.FST_DT
   * ***** , REF.LST_SRVC_DT ***** , REF.PROV_TINSUFF ***** ***** , REF.PROV_SCRN_NBR ***** ,
   * REF.CHRG_AMT ***** , REF.RMRK_CD ***** , REF.NC_AMT ***** , REF.PMT_SVC_CD ***** , REF.OVR_CD
   * ***** , REF.COPAY_AMT ***** , REF.SRVC_CD ***** , REF.PAY_CD ***** , REF.TRANS_CD ***** ,
   * HDR.FILM_OFC_NBR ***** , HDR.CLM_LVL_RSN_CD ***** , HDR.ADJTR_ID ***** , HDR.MBR_PRV_IND *****
   * , HDR.NTFY_WAIV_CD ***** , HDR.BANK_CD ***** , HDR.DIV_NBR ***** , HDR.CLS_NBR ***** ,
   * HDR.DRG_NBR ***** , HDR.FACL_OR_PROF_CD ***** , BKE.DLGT_ENTY_CD ***** , BK2.NDB_CONTR_ID *****
   * , BK2.CLM_SMB_TYP_APP_CD ***** , BK2.SMB_ST_CD ***** , DLN.PROC_T1_IND ***** , DLN.AUTH_NBR
   * ***** , DLN.BASE_DED_DESC_TXT ***** , DLN.MM_DED_DESC_TXT ***** , DLN.PRS_CREAT_SRC_CD ***** ,
   * DLN.BASE_DED_AMT ***** , DLN.BASE_AMT ***** , DLN.MM_DED_AMT ***** , DLN.MM_AMT ***** ,
   * DLN.MC_CR_RES_AMT ***** , DLN.COB_CR_RES_AMT ***** , DLN.PAR_IND ***** , DLN.SUP_AMT ***** ,
   * DLN.PROV_MKT_NBR ***** , DLN.PPO_CD ***** , DLN.PTNT_RESP_AMT ***** , HST.AUTH_SRC_ID ***** ,
   * HST.AUTH_PROC_CD ***** , HST.PROV_NM ***** , HST.PROV_EOB_NM ***** , HST.PROV_PRDCT_CD ***** ,
   * HST.PROV_MKT_TYP_CD ***** , HST.PROV_IPA_ID ***** , HST.TPSM_CD ***** , HST.PROV_SPCL_CD *****
   * , IFNULL( ***** (SELECT PR1.PROV_MEDCD_RECLM_IND ***** FROM ADJD_CLMSF_PROV PR1 ***** WHERE
   * REF.PARTN_ID = PR1.PARTN_ID ***** AND REF.PARTN_VAL = PR1.PARTN_VAL ***** AND REF.INVN_CTL_NBR
   * = PR1.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = PR1.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * PR1.PROC_DT ***** AND REF.PROC_TM = PR1.PROC_TM ***** AND PR1.PROV_MEDCD_RECLM_IND = 'Y' *****
   ...
   * DLN.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = DLN.ICN_SUFX_CD ***** AND REF.PROC_DT =
   * DLN.PROC_DT ***** AND REF.PROC_TM = DLN.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * DLN.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = DLN.LN_ID ***** ***** LEFT OUTER JOIN
   * ADJD_CLMSF_DIAG DIA ***** ON REF.PARTN_ID = DIA.PARTN_ID ***** AND REF.PARTN_VAL =
   * DIA.PARTN_VAL ***** AND REF.INVN_CTL_NBR = DIA.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * DIA.ICN_SUFX_CD ***** AND REF.PROC_DT = DIA.PROC_DT ***** AND REF.PROC_TM = DIA.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = DIA.ICN_SUFX_VERS_NBR ***** AND 1 = DIA.DIAG_SEQ_NBR ***** *****
   * ***** ORDER BY REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** , REF.PGM_ID_LST_CHAR_VAL DESC
   * ***** , REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC
   * ***** , REF.LN_ID DESC ***** ***** OPTIMIZE FOR 600 ROWS ***** FETCH FIRST 600 ROWS ONLY *****
   * WITH UR
   */
  public ResultSet openCsrInitFil3D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFil3ResultSet =
          db2Base
              .startQuery(40 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
              ...
              .withInputs(
                  ...
                  hostVariables.getHvFstDtGroup().getHvFstDt(),
                  hostVariables.getHvProvTinsuffRedefined().getHvProvTin(),
                  hostVariables.getHvProvTinsuff1Redefined().getHvProvTin1(),
                  hostVariables.getHvRemarkCd1(),
                  hostVariables.getHvRemarkCd2(),
                  hostVariables.getHvCauseCd1(),
                  hostVariables.getHvCauseCd2(),
                  hostVariables.getHvRevFrom(),
                  hostVariables.getHvRevThru())
              .withDataTypes(
                  Types.CHAR,
                  Types.CHAR,
                  Types.CHAR,
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FIL3 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-NEXT-FIL3 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   ...
   * ***** , LNE.AUTH_PROC_CD ***** , PRV.PROV_NM ***** , PRV.PROV_EOB_NM ***** , PRV.PROV_PRDCT_CD
   * ***** , PRV.PROV_MKT_TYP_CD ***** , PRV.PROV_IPA_ID ***** , PRV.TPSM_CD ***** ,
   * PRV.PROV_SPCL_CD ***** ***** FROM ADJD_CLMHST_DENORM_REF REF ***** ***** INNER JOIN
   * ADJD_CLMSF_LN LNE ***** ON REF.PARTN_ID = LNE.PARTN_ID ***** AND REF.PARTN_VAL = LNE.PARTN_VAL
   * ***** AND REF.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = LNE.ICN_SUFX_CD *****
   * AND REF.PROC_DT = LNE.PROC_DT ***** AND REF.PROC_TM = LNE.PROC_TM ***** AND
   * REF.ICN_SUFX_VERS_NBR = LNE.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = LNE.LN_ID ***** ***** INNER
   * JOIN ADJD_CLMSF_ORIGHDR ORG ***** ON ORG.PARTN_ID = LNE.PARTN_ID ***** AND ORG.PARTN_VAL =
   * LNE.PARTN_VAL ***** AND ORG.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND ORG.ICN_SUFX_CD =
   * LNE.ICN_SUFX_CD ***** AND ORG.PROC_DT = LNE.PROC_DT ***** AND ORG.PROC_TM = LNE.PROC_TM *****
   * AND ORG.ICN_SUFX_VERS_NBR = LNE.ICN_SUFX_VERS_NBR ***** AND ORG.LN_CORR_ID =
   * LNE.ORIG_LN_CORR_ID ***** INNER JOIN ADJD_CLMSF_PROV PRV ***** ON REF.PARTN_ID = PRV.PARTN_ID
   * ***** AND REF.PARTN_VAL = PRV.PARTN_VAL ***** AND REF.INVN_CTL_NBR = PRV.INVN_CTL_NBR ***** AND
   * REF.ICN_SUFX_CD = PRV.ICN_SUFX_CD ***** AND REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM =
   * PRV.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR
   * = PRV.PROV_SEQ_NBR ***** INNER JOIN ADJD_CLMSFLN_ACCUM ACM ***** ON REF.PARTN_ID = ACM.PARTN_ID
   * ***** AND REF.PARTN_VAL = ACM.PARTN_VAL ***** AND REF.INVN_CTL_NBR = ACM.INVN_CTL_NBR ***** AND
   * REF.ICN_SUFX_CD = ACM.ICN_SUFX_CD ***** AND REF.PROC_DT = ACM.PROC_DT ***** AND REF.PROC_TM =
   * ACM.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR = ACM.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID =
   ...
   * :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND :HV-LST-SRVC-DT >=
   * REF.FST_DT ***** AND :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** AND SUBSTR(REF.PROV_TINSUFF,2,9)
   * BETWEEN ***** :HV-PROV-TIN AND :HV-PROV-TIN1 ***** ***** AND REF.RMRK_CD BETWEEN :HV-REMARK-CD1
   * AND ***** :HV-REMARK-CD2 ***** ***** AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 *****
   * AND :HV-CAUSE-CD2 ***** AND (ORG.UB92_RVNU_CD BETWEEN :HV-REV-FROM ***** AND :HV-REV-THRU)
   * ***** AND ACM.LN_ACCUM_TYP_CD = 'OOP' ***** ***** ***** AND ***** ( ***** ( REF.PROC_DT =
   * :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL *****
   * = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR
   * ***** AND REF.INVN_CTL_NBR = :DDEREF-INVN-CTL-NBR ***** AND REF.ICN_SUFX_CD =
   * :DDEREF-ICN-SUFX-CD ***** AND REF.LN_ID <= :DDEREF-LN-ID ***** ) ***** OR ***** ( REF.PROC_DT =
   ...
   * , DLN.MM_AMT ***** , DLN.MC_CR_RES_AMT ***** , DLN.COB_CR_RES_AMT ***** , DLN.PAR_IND ***** ,
   * DLN.SUP_AMT ***** , DLN.PROV_MKT_NBR ***** , DLN.PPO_CD ***** , DLN.PTNT_RESP_AMT ***** ,
   * HST.AUTH_SRC_ID ***** , HST.AUTH_PROC_CD ***** , HST.PROV_NM ***** , HST.PROV_EOB_NM ***** ,
   * HST.PROV_PRDCT_CD ***** , HST.PROV_MKT_TYP_CD ***** , HST.PROV_IPA_ID ***** , HST.TPSM_CD *****
   * , HST.PROV_SPCL_CD ***** , IFNULL( ***** (SELECT PR1.PROV_MEDCD_RECLM_IND ***** FROM
   * ADJD_CLMSF_PROV PR1 ***** WHERE REF.PARTN_ID = PR1.PARTN_ID ***** AND REF.PARTN_VAL =
   * PR1.PARTN_VAL ***** AND REF.INVN_CTL_NBR = PR1.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * PR1.ICN_SUFX_CD ***** AND REF.PROC_DT = PR1.PROC_DT ***** AND REF.PROC_TM = PR1.PROC_TM *****
   * AND PR1.PROV_MEDCD_RECLM_IND = 'Y' ***** ORDER BY LST_UPDT_DTTM DESC ***** FETCH FIRST 1 ROW
  ...
  public ResultSet openCsrNextFil3D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFil3ResultSet =
          db2Base
              .startQuery(44 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FIL3 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-INIT-FIL4 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   ...
   * REF.INVN_CTL_NBR = LNE.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = LNE.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = LNE.PROC_DT ***** AND REF.PROC_TM = LNE.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * LNE.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = LNE.LN_ID ***** INNER JOIN ADJD_CLMSF_PROV PRV
   * ***** ON REF.PARTN_ID = PRV.PARTN_ID ***** AND REF.PARTN_VAL = PRV.PARTN_VAL ***** AND
   * REF.INVN_CTL_NBR = PRV.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = PRV.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM = PRV.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR = PRV.PROV_SEQ_NBR ***** INNER JOIN
   * ADJD_CLMSFLN_ACCUM ACM ***** ON REF.PARTN_ID = ACM.PARTN_ID ***** AND REF.PARTN_VAL =
   * ACM.PARTN_VAL ***** AND REF.INVN_CTL_NBR = ACM.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * ACM.ICN_SUFX_CD ***** AND REF.PROC_DT = ACM.PROC_DT ***** AND REF.PROC_TM = ACM.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = ACM.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = ACM.LN_ID ***** *****
   * WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND REF.EE_ID = :DDEREF-EE-ID ***** AND
   * REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND :HV-LST-SRVC-DT >= REF.FST_DT ***** AND
   * :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** AND SUBSTR(REF.PROV_TINSUFF,2,9) BETWEEN *****
   * :HV-PROV-TIN AND :HV-PROV-TIN1 ***** AND REF.RMRK_CD BETWEEN :HV-REMARK-CD1 AND *****
   * :HV-REMARK-CD2 ***** ***** AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 ***** AND
   * :HV-CAUSE-CD2 ***** AND (LNE.ORIG_PROC_CD BETWEEN :HV-CPT-FROM ***** AND :HV-CPT-THRU ***** OR
   * ***** LNE.PMT_SVC_CD BETWEEN :HV-CPT-FROM ***** AND :HV-CPT-THRU) ***** AND ACM.LN_ACCUM_TYP_CD
   * = 'OOP' ***** ***** ***** ORDER BY REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** ,
   * REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC *****
   * ***** FETCH FIRST 500 ROWS ONLY ***** ) ***** ***** SELECT ***** REF.PARTN_ID ***** ,
   * REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** , REF.PGM_ID_LST_CHAR_VAL ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , REF.LN_ID *****
   * ***** , REF.FLN_JULIAN_DT_NBR ***** , REF.FLN_SRL_NBR ***** , REF.DFT_NBR ***** , REF.FST_DT
   * ***** , REF.LST_SRVC_DT ***** , REF.PROV_TINSUFF ***** ***** , REF.PROV_SCRN_NBR ***** ,
  ...
  public ResultSet openCsrInitFil4D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFil4ResultSet =
          db2Base
              .startQuery(48 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
              ...
              .withInputs(
                  ...
                  hostVariables.getHvCauseCd1(),
                  hostVariables.getHvCauseCd2(),
                  hostVariables.getHvCptFrom(),
                  hostVariables.getHvCptThru(),
                  hostVariables.getHvCptFrom(),
                  hostVariables.getHvCptThru())
              .withDataTypes(
                  Types.CHAR,
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FIL4 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-NEXT-FIL4 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   ...
   * AND REF.PROC_DT = LNE.PROC_DT ***** AND REF.PROC_TM = LNE.PROC_TM ***** AND
   * REF.ICN_SUFX_VERS_NBR = LNE.ICN_SUFX_VERS_NBR ***** AND REF.LN_ID = LNE.LN_ID ***** ***** INNER
   * JOIN ADJD_CLMSF_PROV PRV ***** ON REF.PARTN_ID = PRV.PARTN_ID ***** AND REF.PARTN_VAL =
   * PRV.PARTN_VAL ***** AND REF.INVN_CTL_NBR = PRV.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD =
   * PRV.ICN_SUFX_CD ***** AND REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM = PRV.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR =
   * PRV.PROV_SEQ_NBR ***** INNER JOIN ADJD_CLMSFLN_ACCUM ACM ***** ON REF.PARTN_ID = ACM.PARTN_ID
   ...
   * BETWEEN ***** :HV-PROV-TIN AND :HV-PROV-TIN1 ***** ***** AND REF.RMRK_CD BETWEEN :HV-REMARK-CD1
   * AND ***** :HV-REMARK-CD2 ***** ***** AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 *****
   * AND :HV-CAUSE-CD2 ***** AND (LNE.ORIG_PROC_CD BETWEEN :HV-CPT-FROM ***** AND :HV-CPT-THRU *****
   * OR ***** LNE.PMT_SVC_CD BETWEEN :HV-CPT-FROM ***** AND :HV-CPT-THRU) ***** AND
   * ACM.LN_ACCUM_TYP_CD = 'OOP' ***** ***** ***** AND ***** ( ***** ( REF.PROC_DT = :DDEREF-PROC-DT
   * ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL ***** =
   * :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR
   * ***** AND REF.INVN_CTL_NBR = :DDEREF-INVN-CTL-NBR ***** AND REF.ICN_SUFX_CD =
   * :DDEREF-ICN-SUFX-CD ***** AND REF.LN_ID <= :DDEREF-LN-ID ***** ) ***** OR ***** ( REF.PROC_DT =
  ...
  public ResultSet openCsrNextFil4D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFil4ResultSet =
          db2Base
              .startQuery(52 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FIL4 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-INIT-FIL5 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   ...
   * PRV.ICN_SUFX_CD ***** AND REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM = PRV.PROC_TM *****
   * AND REF.ICN_SUFX_VERS_NBR = PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR =
   * PRV.PROV_SEQ_NBR ***** WHERE ***** REF.POL_NBR = :DDEREF-POL-NBR ***** AND REF.EE_ID =
   * :DDEREF-EE-ID ***** AND REF.DEPN_NBR = :DDEREF-DEPN-NBR ***** ***** AND :HV-LST-SRVC-DT >=
   * REF.FST_DT ***** AND :HV-FST-DT <= REF.LST_SRVC_DT ***** ***** AND SUBSTR(REF.PROV_TINSUFF,2,9)
   * BETWEEN ***** :HV-PROV-TIN AND :HV-PROV-TIN1 ***** AND REF.RMRK_CD BETWEEN :HV-REMARK-CD1 AND
   * ***** :HV-REMARK-CD2 ***** ***** AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 ***** AND
   ...
   * ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC ***** ***** FETCH FIRST 500 ROWS
   * ONLY ***** ) ***** ***** SELECT ***** REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT
   * ***** , REF.PROC_TM ***** , REF.PGM_ID_LST_CHAR_VAL ***** , REF.ICN_SUFX_VERS_NBR ***** ,
   * REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , REF.LN_ID ***** ***** , REF.FLN_JULIAN_DT_NBR
   * ***** , REF.FLN_SRL_NBR ***** , REF.DFT_NBR ***** , REF.FST_DT ***** , REF.LST_SRVC_DT ***** ,
   * REF.PROV_TINSUFF ***** ***** , REF.PROV_SCRN_NBR ***** , REF.CHRG_AMT ***** , REF.RMRK_CD *****
  ...
  public ResultSet openCsrInitFil5D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFil5ResultSet =
          db2Base
              .startQuery(56 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FIL5 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-NEXT-FIL5 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   ...
   * AND ***** :HV-REMARK-CD2 ***** ***** AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 *****
   * AND :HV-CAUSE-CD2 ***** AND (ORG.UB92_RVNU_CD BETWEEN :HV-REV-FROM ***** AND :HV-REV-THRU)
   * ***** AND ***** ( ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM
   * ***** AND REF.PGM_ID_LST_CHAR_VAL ***** = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND
   * REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR ***** AND REF.INVN_CTL_NBR =
   * :DDEREF-INVN-CTL-NBR ***** AND REF.ICN_SUFX_CD = :DDEREF-ICN-SUFX-CD ***** AND REF.LN_ID <=
   * :DDEREF-LN-ID ***** ) ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM =
   * :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL ***** = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND
   * REF.ICN_SUFX_VERS_NBR ***** = :DDEREF-ICN-SUFX-VERS-NBR ***** AND REF.INVN_CTL_NBR =
   * :DDEREF-INVN-CTL-NBR ***** AND REF.ICN_SUFX_CD < :DDEREF-ICN-SUFX-CD ***** ) ***** OR ***** (
   * REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND
   * REF.PGM_ID_LST_CHAR_VAL ***** = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR
   * ***** = :DDEREF-ICN-SUFX-VERS-NBR ***** AND REF.INVN_CTL_NBR < :DDEREF-INVN-CTL-NBR ***** )
   * ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND REF.PROC_TM = :DDEREF-PROC-TM *****
   * AND REF.PGM_ID_LST_CHAR_VAL ***** = :DDEREF-PGM-ID-LST-CHAR-VAL ***** AND REF.ICN_SUFX_VERS_NBR
   * ***** < :DDEREF-ICN-SUFX-VERS-NBR ***** ) ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT *****
   * AND REF.PROC_TM = :DDEREF-PROC-TM ***** AND REF.PGM_ID_LST_CHAR_VAL ***** <
   * :DDEREF-PGM-ID-LST-CHAR-VAL ***** ) ***** OR ***** ( REF.PROC_DT = :DDEREF-PROC-DT ***** AND
   * REF.PROC_TM < :DDEREF-PROC-TM ***** ) ***** OR ***** ( REF.PROC_DT < :DDEREF-PROC-DT ***** )
   * ***** ) ***** ***** ORDER BY REF.PROC_DT DESC ***** , REF.PROC_TM DESC ***** ,
   * REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** , REF.ICN_SUFX_CD DESC *****
   * ***** FETCH FIRST 500 ROWS ONLY ***** ) ***** ***** SELECT ***** REF.PARTN_ID ***** ,
   * REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** , REF.PGM_ID_LST_CHAR_VAL ***** ,
   * REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** , REF.ICN_SUFX_CD ***** , REF.LN_ID *****
  ...
  public ResultSet openCsrNextFil5D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFil5ResultSet =
          db2Base
              .startQuery(60 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FIL5 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-INIT-FIL6 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
   ...
   * REF.INVN_CTL_NBR = PRV.INVN_CTL_NBR ***** AND REF.ICN_SUFX_CD = PRV.ICN_SUFX_CD ***** AND
   * REF.PROC_DT = PRV.PROC_DT ***** AND REF.PROC_TM = PRV.PROC_TM ***** AND REF.ICN_SUFX_VERS_NBR =
   * PRV.ICN_SUFX_VERS_NBR ***** AND REF.PROV_SCRN_NBR = PRV.PROV_SEQ_NBR ***** ***** WHERE *****
   * REF.POL_NBR = :DDEREF-POL-NBR ***** AND REF.EE_ID = :DDEREF-EE-ID ***** AND REF.DEPN_NBR =
   * :DDEREF-DEPN-NBR ***** ***** AND :HV-LST-SRVC-DT >= REF.FST_DT ***** AND :HV-FST-DT <=
   * REF.LST_SRVC_DT ***** ***** AND SUBSTR(REF.PROV_TINSUFF,2,9) BETWEEN ***** :HV-PROV-TIN AND
   * :HV-PROV-TIN1 ***** AND REF.RMRK_CD BETWEEN :HV-REMARK-CD1 AND ***** :HV-REMARK-CD2 ***** *****
   * AND SUBSTR(REF.CAUS_CD,1,1) BETWEEN :HV-CAUSE-CD1 ***** AND :HV-CAUSE-CD2 ***** AND
   * (LNE.ORIG_PROC_CD BETWEEN :HV-CPT-FROM ***** AND :HV-CPT-THRU ***** OR ***** LNE.PMT_SVC_CD
   * BETWEEN :HV-CPT-FROM ***** AND :HV-CPT-THRU) ***** ***** ORDER BY REF.PROC_DT DESC ***** ,
   * REF.PROC_TM DESC ***** , REF.ICN_SUFX_VERS_NBR DESC ***** , REF.INVN_CTL_NBR DESC ***** ,
   * REF.ICN_SUFX_CD DESC ***** ***** FETCH FIRST 500 ROWS ONLY ***** ) ***** ***** SELECT *****
   * REF.PARTN_ID ***** , REF.PARTN_VAL ***** , REF.PROC_DT ***** , REF.PROC_TM ***** ,
   * REF.PGM_ID_LST_CHAR_VAL ***** , REF.ICN_SUFX_VERS_NBR ***** , REF.INVN_CTL_NBR ***** ,
  ...
  public ResultSet openCsrInitFil6D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrInitFil6ResultSet =
          db2Base
              .startQuery(64 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-INIT-FIL6 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** DECLARE CSR-NEXT-FIL6 CURSOR WITH ROWSET POSITIONING FOR ***** WITH CLM_HST_TABLE ***** (
   * ***** PARTN_ID ***** , PARTN_VAL ***** , PROC_DT ***** , PROC_TM ***** , ICN_SUFX_VERS_NBR
   * ***** , INVN_CTL_NBR ***** , ICN_SUFX_CD ***** , AUTH_SRC_ID ***** , AUTH_PROC_CD ***** ,
   * PROV_NM ***** , PROV_EOB_NM ***** , PROV_PRDCT_CD ***** , PROV_MKT_TYP_CD ***** , PROV_IPA_ID
   * ***** , TPSM_CD ***** , PROV_SPCL_CD ***** ) ***** AS ( ***** SELECT DISTINCT *****
  ...
  public ResultSet openCsrNextFil6D5427dt1(
    ...
    try {
      // OPEN CURSOR
      sqlca.setSqlcode(0);
      csrNextFil6ResultSet =
          db2Base
              .startQuery(68 /* SQL Sequence*/, CONSTANTS.LITERAL_D5427DT1)
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM CSR-NEXT-FIL6 ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
  ...
  /**
   * ***** FETCH NEXT ROWSET ***** FROM DT1-DYN-CURSOR ***** FOR :FETCH-ROWSET-MAX ROWS ***** *****
   * INTO ***** :HVA-PARTN-ID ***** , :HVA-PARTN-VAL ***** , :HVA-PROC-DT ***** , :HVA-PROC-TM *****
   * , :HVA-PGM-ID-LST-CHAR-VAL ***** , :HVA-ICN-SUFX-VERS-NBR ***** , :HVA-INVN-CTL-NBR ***** ,
   * :HVA-ICN-SUFX-CD ***** , :HVA-LN-ID ***** , :HVA-FLN-JULIAN-DT-NBR ***** , :HVA-FLN-SRL-NBR
   * ***** , :HVA-DFT-NBR ***** , :HVA-FST-DT ***** , :HVA-LST-SRVC-DT ***** , :HVA-PROV-TINSUFF
