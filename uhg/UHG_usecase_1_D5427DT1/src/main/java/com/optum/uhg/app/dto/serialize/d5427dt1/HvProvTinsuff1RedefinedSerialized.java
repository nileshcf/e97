...
/**
 * The class HvProvTinsuff1RedefinedSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvProvTinsuff1RedefinedSerialized extends Field {
  ...
  /**
   * sets parent for this HvProvTinsuff1RedefinedSerialized to the parent and set the serialize
  ...
  public boolean isHvProvTin1Modified() {
    ...
    localHvProvTin1Counter = sharedCounter;
    return hasModified;
  }
