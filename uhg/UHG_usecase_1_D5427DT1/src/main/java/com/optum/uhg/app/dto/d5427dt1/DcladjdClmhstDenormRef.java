...
public class DcladjdClmhstDenormRef extends DcladjdClmhstDenormRefSerialized {
  ...
  /**
   * Update DderefInvnCtlNbrGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-INVN-CTL-NBR-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefInvnCtlNbrGroup with a String from an offset and length
   *
   * @param value
   */
  public void setDderefInvnCtlNbrGroup(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        dderefInvnCtlNbrGroup.begin,
        dderefInvnCtlNbrGroup.length());
  }

  /**
   * Update DderefInvnCtlNbrGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefInvnCtlNbrGroup(
  ...
  public void setDderefInvnCtlNbrGroup(Field source) {
    replace(
        source, 0, source.length(), dderefInvnCtlNbrGroup.begin, dderefInvnCtlNbrGroup.length());
  }

  /**
   * Update DderefInvnCtlNbrGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefInvnCtlNbrGroup with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update DderefIcnSufxCdGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-ICN-SUFX-CD-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefIcnSufxCdGroup with a String from an offset and length
   *
   * @param value
   */
  public void setDderefIcnSufxCdGroup(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, dderefIcnSufxCdGroup.begin, dderefIcnSufxCdGroup.length());
  }

  /**
   * Update DderefIcnSufxCdGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefIcnSufxCdGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefIcnSufxCdGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefIcnSufxCdGroup with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDtGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-PROC-DT-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDtGroup with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDtGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcDtGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefProcDtGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcDtGroup with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcDtGroup(
  ...
  /**
   * Update DderefProcTmGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-PROC-TM-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcTmGroup with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcTmGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcTmGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefProcTmGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefProcTmGroup with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefProcTmGroup(
  ...
  /**
   * Update DderefIcnSufxVersNbr with the passed value Corresponding COBOL Variable is
  ...
  public void setDderefIcnSufxVersNbr(int number) {
    number =
        checkDderefIcnSufxVersNbrMaxLimit(
  ...
  /**
   * Update DderefLnIdGroup with the passed value Corresponding COBOL Variable is DDEREF-LN-ID-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefLnIdGroup with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefLnIdGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefLnIdGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefLnIdGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefLnIdGroup with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefLnIdGroup(
  ...
  /**
   * Update DderefDepnNbrGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-DEPN-NBR-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefDepnNbrGroup with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefDepnNbrGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefDepnNbrGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefDepnNbrGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefDepnNbrGroup with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefDepnNbrGroup(
  ...
  /**
   * Update DderefEeIdGroup with the passed value Corresponding COBOL Variable is DDEREF-EE-ID-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefEeIdGroup with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefEeIdGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefEeIdGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefEeIdGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefEeIdGroup with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefEeIdGroup(
  ...
  /**
   * Update DderefPgmIdLstCharValGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-PGM-ID-LST-CHAR-VAL-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefPgmIdLstCharValGroup with a String from an offset and length
   *
   * @param value
   */
  public void setDderefPgmIdLstCharValGroup(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        dderefPgmIdLstCharValGroup.begin,
        dderefPgmIdLstCharValGroup.length());
  }

  /**
   * Update DderefPgmIdLstCharValGroup with a String from an offset and length to an offset and
   * length
   *
   * @param value
   */
  public void setDderefPgmIdLstCharValGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source, sourceIndex, sourceLen, dderefPgmIdLstCharValGroup.begin + targetIndex, targetLen);
  }
  ...
  /**
   * Update DderefPgmIdLstCharValGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefPgmIdLstCharValGroup with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbrGroup with the passed value Corresponding COBOL Variable is
   * DDEREF-POL-NBR-GROUP
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbrGroup with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbrGroup with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefPolNbrGroup(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DderefPolNbrGroup with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefPolNbrGroup with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefPolNbrGroup(
