...
/**
 * The class TimeXGroupSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class TimeXGroupSerialized extends Field {
  ...
  public boolean isTimeXModified() {
    ...
    localTimeXCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshTimeX is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isTime9Modified() {
    ...
    localTime9Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeTime9(char[] value) {
    ...
    replaceValue(padNumber(6, value, false /*isSigned?*/), beginTime9, 6);
    localTime9Counter = shareString.getSerializedField().getModifiedCounter();
    return time9;
  }
  ...
  /**
   * refreshTime9 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
