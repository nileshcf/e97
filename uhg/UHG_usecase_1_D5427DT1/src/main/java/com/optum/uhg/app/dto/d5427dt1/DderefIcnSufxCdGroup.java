...
public class DderefIcnSufxCdGroup extends DderefIcnSufxCdGroupSerialized {
  ...
  /**
   * set variable dderefIcnSufxCd Corresponding COBOL Variable is DDEREF-ICN-SUFX-CD
   *
   * @param value
   */
  ...
  /**
   * Update DderefIcnSufxCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefIcnSufxCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefIcnSufxCd(
  ...
  /**
   * Update DderefIcnSufxCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefIcnSufxCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefIcnSufxCd(
