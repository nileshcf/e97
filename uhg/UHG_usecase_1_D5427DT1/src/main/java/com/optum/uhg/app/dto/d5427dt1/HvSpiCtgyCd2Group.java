...
public class HvSpiCtgyCd2Group extends HvSpiCtgyCd2GroupSerialized {
  ...
  /**
   * set variable hvSpiCtgyCd2 Corresponding COBOL Variable is HV-SPI-CTGY-CD-2
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd2 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd2 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd2(
  ...
  /**
   * Update HvSpiCtgyCd2 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd2 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd2(
