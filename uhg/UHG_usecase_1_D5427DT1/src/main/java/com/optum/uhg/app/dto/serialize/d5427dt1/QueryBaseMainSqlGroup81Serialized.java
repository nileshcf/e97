...
/**
 * The class QueryBaseMainSqlGroup81Serialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class QueryBaseMainSqlGroup81Serialized extends Field {
  ...
  /**
   * sets parent for this QueryBaseMainSqlGroup81Serialized to the parent and set the serialize
