...
/**
 * The class DcladjdClmhstDenormRefSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DcladjdClmhstDenormRefSerialized extends Field {
  ...
  public boolean isDderefIcnSufxVersNbrModified() {
    ...
    localDderefIcnSufxVersNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDderefIcnSufxVersNbr is used to refresh the latest value of a variable from the
