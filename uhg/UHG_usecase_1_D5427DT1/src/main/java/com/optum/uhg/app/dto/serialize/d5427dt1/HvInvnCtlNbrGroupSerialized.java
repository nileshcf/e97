...
/**
 * The class HvInvnCtlNbrGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvInvnCtlNbrGroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvInvnCtlNbrGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvInvnCtlNbrModified() {
    ...
    localHvInvnCtlNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvInvnCtlNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvInvnCtlNbr() {
    return (substring(
        getStringValue(), beginHvInvnCtlNbr, beginHvInvnCtlNbr + HV_INVN_CTL_NBR_LEN));
  }
}
