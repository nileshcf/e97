...
/**
 * The class DderefIcnSufxCdGroupSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DderefIcnSufxCdGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefIcnSufxCdGroupSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isDderefIcnSufxCdModified() {
    ...
    localDderefIcnSufxCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDderefIcnSufxCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDderefIcnSufxCd() {
    return (substring(
        getStringValue(), beginDderefIcnSufxCd, beginDderefIcnSufxCd + DDEREF_ICN_SUFX_CD_LEN));
  }
}
