...
public class HvLstSrvcDtGroup extends HvLstSrvcDtGroupSerialized {
  ...
  /**
   * set variable hvLstSrvcDt Corresponding COBOL Variable is HV-LST-SRVC-DT
   *
   * @param value
   */
  ...
  /**
   * Update HvLstSrvcDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvLstSrvcDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvLstSrvcDt(
  ...
  /**
   * Update HvLstSrvcDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvLstSrvcDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvLstSrvcDt(
