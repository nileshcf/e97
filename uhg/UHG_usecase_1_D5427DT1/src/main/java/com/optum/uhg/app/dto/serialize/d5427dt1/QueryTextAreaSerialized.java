...
/**
 * The class QueryTextAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class QueryTextAreaSerialized extends Field {
  ...
  public boolean isQueryTextLengModified() {
    ...
    localQueryTextLengCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshQueryTextLeng is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isQueryTextDataModified() {
    ...
    localQueryTextDataCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshQueryTextData is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshQueryTextData() {
    return (substring(
        getStringValue(), beginQueryTextData, beginQueryTextData + QUERY_TEXT_DATA_LEN));
  }
}
