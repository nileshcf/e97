...
/**
 * The class Sc1SortCompare1GroupSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class Sc1SortCompare1GroupSerialized extends Field {
  ...
  public boolean isSc1SortCompare1Modified() {
    ...
    localSc1SortCompare1Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSc1SortCompare1 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshSc1SortCompare1() {
    return (substring(
        getStringValue(), beginSc1SortCompare1, beginSc1SortCompare1 + SC_1_SORT_COMPARE_1_LEN));
  }
}
