...
/**
 * The class HvNextKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class HvNextKeySerialized extends Field {
  ...
  /**
   * sets parent for this HvNextKeySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvNextProcDtModified() {
    ...
    localHvNextProcDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvNextProcDt is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvNextProcDt() {
    return (substring(
        getStringValue(), beginHvNextProcDt, beginHvNextProcDt + HV_NEXT_PROC_DT_LEN));
  }
  ...
  public boolean isHvNextProcTmModified() {
    ...
    localHvNextProcTmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvNextProcTm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvNextProcTm() {
    return (substring(
        getStringValue(), beginHvNextProcTm, beginHvNextProcTm + HV_NEXT_PROC_TM_LEN));
  }
  ...
  public boolean isHvNextPgmIdLstCharValModified() {
    ...
    localHvNextPgmIdLstCharValCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvNextPgmIdLstCharVal is used to refresh the latest value of a variable from the
  ...
  public char[] refreshHvNextPgmIdLstCharVal() {
    return (substring(
        getStringValue(),
        beginHvNextPgmIdLstCharVal,
        beginHvNextPgmIdLstCharVal + HV_NEXT_PGM_ID_LST_CHAR_VAL_LEN));
  }
  ...
  public boolean isHvNextIcnSufxVersNbrModified() {
    ...
    localHvNextIcnSufxVersNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvNextIcnSufxVersNbr is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  ...
  public boolean isHvNextInvnCtlNbrModified() {
    ...
    localHvNextInvnCtlNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeHvNextInvnCtlNbr(char[] hvNextInvnCtlNbr) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        hvNextInvnCtlNbr, 0, getStringValue(), beginHvNextInvnCtlNbr, HV_NEXT_INVN_CTL_NBR_LEN);
  ...
  /**
   * refreshHvNextInvnCtlNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvNextInvnCtlNbr() {
    return (substring(
        getStringValue(), beginHvNextInvnCtlNbr, beginHvNextInvnCtlNbr + HV_NEXT_INVN_CTL_NBR_LEN));
  }
  ...
  public boolean isHvNextIcnSufxCdModified() {
    ...
    localHvNextIcnSufxCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvNextIcnSufxCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvNextIcnSufxCd() {
    return (substring(
        getStringValue(), beginHvNextIcnSufxCd, beginHvNextIcnSufxCd + HV_NEXT_ICN_SUFX_CD_LEN));
  }
  ...
  public boolean isHvNextLnIdModified() {
    ...
    localHvNextLnIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeHvNextLnId(short hvNextLnId) {
    replaceValue( //  save the value as string
        getBinaryString(hvNextLnId, HV_NEXT_LN_ID_LEN), beginHvNextLnId, HV_NEXT_LN_ID_LEN);
