...
/**
 * The class Dt1ClmVariableAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1ClmVariableAreaSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1ClmVariableAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
