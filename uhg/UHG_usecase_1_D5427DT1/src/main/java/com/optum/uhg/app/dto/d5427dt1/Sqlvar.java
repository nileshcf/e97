...
public class Sqlvar extends SqlvarSerialized {
  ...
  /**
   * Update Sqlvar1 with the passed value Corresponding COBOL Variable is SQLVAR1
   *
   * @param value
   */
  ...
  /**
   * Update Sqlvar1 with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlvar1 with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlvar1(
  ...
  /**
   * Update Sqlvar1 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlvar1 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlvar1(
  ...
  /**
   * Update Sqlvar2 with the passed value Corresponding COBOL Variable is SQLVAR2
   *
   * @param value
   */
  ...
  /**
   * Update Sqlvar2 with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlvar2 with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlvar2(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlvar2 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlvar2 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlvar2(
