...
public class StorageAllocVars extends StorageAllocVarsSerialized {
  ...
  /**
   * Update StorageSizeRequired with the passed value Corresponding COBOL Variable is
  ...
  /**
   * Update StorageAreaPtr with the passed value Corresponding COBOL Variable is STORAGE-AREA-PTR
   *
   * @param number
   */
