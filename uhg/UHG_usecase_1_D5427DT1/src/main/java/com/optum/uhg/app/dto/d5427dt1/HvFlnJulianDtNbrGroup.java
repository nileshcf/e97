...
public class HvFlnJulianDtNbrGroup extends HvFlnJulianDtNbrGroupSerialized {
  ...
  /**
   * set variable hvFlnJulianDtNbr Corresponding COBOL Variable is HV-FLN-JULIAN-DT-NBR
   *
   * @param value
   */
  ...
  /**
   * Update HvFlnJulianDtNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvFlnJulianDtNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvFlnJulianDtNbr(
  ...
  /**
   * Update HvFlnJulianDtNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvFlnJulianDtNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvFlnJulianDtNbr(
