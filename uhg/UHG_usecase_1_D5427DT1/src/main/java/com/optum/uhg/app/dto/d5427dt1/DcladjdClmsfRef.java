...
public class DcladjdClmsfRef extends DcladjdClmsfRefSerialized {
  ...
  /**
   * set variable drefInvnCtlNbr Corresponding COBOL Variable is DREF-INVN-CTL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update DrefInvnCtlNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefInvnCtlNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefInvnCtlNbr(
  ...
  /**
   * Update DrefInvnCtlNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefInvnCtlNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefInvnCtlNbr(
  ...
  /**
   * set variable drefPolNbr Corresponding COBOL Variable is DREF-POL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update DrefPolNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefPolNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefPolNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrefPolNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefPolNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefPolNbr(
  ...
  /**
   * set variable drefEeId Corresponding COBOL Variable is DREF-EE-ID
   *
   * @param value
   */
  ...
  /**
   * Update DrefEeId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefEeId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefEeId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrefEeId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefEeId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefEeId(
  ...
  /**
   * set variable drefDepnNbr Corresponding COBOL Variable is DREF-DEPN-NBR
   *
   * @param value
   */
  ...
  /**
   * Update DrefDepnNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefDepnNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefDepnNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrefDepnNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrefDepnNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrefDepnNbr(
