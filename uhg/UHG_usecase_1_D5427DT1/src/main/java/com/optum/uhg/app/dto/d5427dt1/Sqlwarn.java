...
public class Sqlwarn extends SqlwarnSerialized {
  ...
  /**
   * set variable sqlwarn0 Corresponding COBOL Variable is SQLWARN0
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn0 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn0 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn0(
  ...
  /**
   * Update Sqlwarn0 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn0 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn0(
  ...
  /**
   * set variable sqlwarn1 Corresponding COBOL Variable is SQLWARN1
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn1 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn1 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn1(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn1 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn1 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn1(
  ...
  /**
   * set variable sqlwarn2 Corresponding COBOL Variable is SQLWARN2
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn2 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn2 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn2(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn2 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn2 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn2(
  ...
  /**
   * set variable sqlwarn3 Corresponding COBOL Variable is SQLWARN3
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn3 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn3 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn3(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn3 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn3 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn3(
  ...
  /**
   * set variable sqlwarn4 Corresponding COBOL Variable is SQLWARN4
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn4 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn4 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn4(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn4 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn4 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn4(
  ...
  /**
   * set variable sqlwarn5 Corresponding COBOL Variable is SQLWARN5
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn5 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn5 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn5(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn5 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn5 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn5(
  ...
  /**
   * set variable sqlwarn6 Corresponding COBOL Variable is SQLWARN6
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn6 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn6 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn6(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn6 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn6 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn6(
  ...
  /**
   * set variable sqlwarn7 Corresponding COBOL Variable is SQLWARN7
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn7 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn7 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn7(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn7 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn7 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn7(
