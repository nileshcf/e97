...
public class SrpSortRequestParameters extends SrpSortRequestParametersSerialized {
  ...
  /**
   * set variable srpReturnCode Corresponding COBOL Variable is SRP-RETURN-CODE
   *
   * @param value
   */
  ...
  /**
   * Update SrpReturnCode with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SrpReturnCode with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSrpReturnCode(
  ...
  /**
   * Update SrpReturnCode with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SrpReturnCode with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSrpReturnCode(
  ...
  /**
   * Update SrpEntryCount with the passed value Corresponding COBOL Variable is SRP-ENTRY-COUNT
   *
   * @param number
   */
  ...
  /**
   * Update SrpEntryLength with the passed value Corresponding COBOL Variable is SRP-ENTRY-LENGTH
   *
   * @param number
   */
  public void setSrpEntryLength(int number) {
    srpEntryLength =
        checkSrpEntryLengthMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update SrpKeyStart with the passed value Corresponding COBOL Variable is SRP-KEY-START
   *
   * @param number
   */
  ...
  /**
   * Update SrpKeyLength with the passed value Corresponding COBOL Variable is SRP-KEY-LENGTH
   *
   * @param number
   */
  ...
  /**
   * set variable srpSequence Corresponding COBOL Variable is SRP-SEQUENCE
   *
   * @param value
   */
