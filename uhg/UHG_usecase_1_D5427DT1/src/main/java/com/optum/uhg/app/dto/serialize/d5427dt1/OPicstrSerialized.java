...
/**
 * The class OPicstrSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class OPicstrSerialized extends Field {
  ...
  public boolean isOPicstrLengthModified() {
    ...
    localOPicstrLengthCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshOPicstrLength is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isOPicstrStringModified() {
    ...
    localOPicstrStringCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshOPicstrString is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshOPicstrString() {
    return (substring(
        getStringValue(), beginOPicstrString, beginOPicstrString + O_PICSTR_STRING_LEN));
  }
}
