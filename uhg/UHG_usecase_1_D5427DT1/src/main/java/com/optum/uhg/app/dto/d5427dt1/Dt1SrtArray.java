...
public class Dt1SrtArray extends Dt1SrtArraySerialized {
  ...
  /**
   * Returns the value of dt1SrtItem Corresponding COBOL Variable is DT1-SRT-ITEM
   *
   * @return dt1SrtItem
   */
  ...
  public Dt1SrtItem getDt1SrtItem(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "dt1SrtItem - Array index exceeded max Size {}, resetting it to max allowed",
          DT_1_SRT_ITEM_SIZE);
    }
  ...
  /**
   * Update Dt1SrtItem at index with the passed value Corresponding COBOL Variable is DT1-SRT-ITEM
   *
   * @param index
   * @param value
   */
