...
/**
 * The class DderefInvnCtlNbrGroupSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DderefInvnCtlNbrGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefInvnCtlNbrGroupSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isDderefInvnCtlNbrModified() {
    ...
    localDderefInvnCtlNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDderefInvnCtlNbr(char[] dderefInvnCtlNbr) {
    ...
    arraycopy(
        dderefInvnCtlNbr, 0, getStringValue(), beginDderefInvnCtlNbr, DDEREF_INVN_CTL_NBR_LEN);
  ...
  /**
   * refreshDderefInvnCtlNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDderefInvnCtlNbr() {
    return (substring(
        getStringValue(), beginDderefInvnCtlNbr, beginDderefInvnCtlNbr + DDEREF_INVN_CTL_NBR_LEN));
  }
}
