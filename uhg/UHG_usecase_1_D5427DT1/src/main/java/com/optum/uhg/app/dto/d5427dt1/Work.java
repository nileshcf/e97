...
public class Work extends WorkSerialized {
  ...
  public Work() {
    ...
    setQueryBaseCteStart(
        " WITH  CLM_HST_TABLE ( PARTN_ID,PARTN_VAL,PROC_DT,PROC_TM,ICN_SUFX_VERS_NBR,INVN_CTL_NBR,ICN_SUFX_CD)  AS ( SELECT DISTINCT REF.PARTN_ID,REF.PARTN_VAL,REF.PROC_DT,REF.PROC_TM,REF.ICN_SUFX_VERS_NBR,REF.INVN_CTL_NBR,REF.ICN_SUFX_CD FROM ADJD_CLMHST_DENORM_REF REF WHERE REF.POL_NBR = CAST(? AS CHAR(6))  AND REF.EE_ID = CAST(? AS CHAR(10)) AND REF.DEPN_NBR = CAST(? AS CHAR(2)) "
            .toCharArray());
    setQueryBaseCteEnd(
        " ORDER BY REF.PROC_DT DESC,REF.PROC_TM DESC,REF.ICN_SUFX_VERS_NBR DESC,REF.INVN_CTL_NBR DESC,REF.ICN_SUFX_CD DESC FETCH FIRST 500 ROWS ONLY)"
            .toCharArray());
    setQueryFilterProviderTin(
        (" AND SUBSTR(REF.PROV_TINSUFF,2,9) = CAST(? AS CHAR(9)) ").toCharArray());
    setQueryFilterIcn((" AND REF.INVN_CTL_NBR = CAST(? AS CHAR(10))   ").toCharArray());
    setQueryFilterAuthStart(
        " AND( (EXISTS (SELECT 1 FROM ADJD_CLMHST_DENORM_LN DLN1 WHERE REF.PARTN_ID = DLN1.PARTN_ID AND REF.PARTN_VAL = DLN1.PARTN_VAL AND REF.INVN_CTL_NBR = DLN1.INVN_CTL_NBR AND REF.ICN_SUFX_CD = DLN1.ICN_SUFX_CD AND REF.PROC_DT = DLN1.PROC_DT AND REF.PROC_TM = DLN1.PROC_TM AND REF.ICN_SUFX_VERS_NBR = DLN1.ICN_SUFX_VERS_NBR"
            .toCharArray());
    setQueryFilterAuthEnd((" FETCH FIRST 1 ROWS ONLY))").toCharArray());
    setQueryFilterAuthBaseEnd((")").toCharArray());
    setQueryFilterDlgtStart(
        " OR (EXISTS (SELECT 1 FROM DE_AUTH_SRCH DLGT WHERE REF.PARTN_ID = DLGT.PARTN_ID AND REF.PARTN_VAL = DLGT.PARTN_VAL AND REF.INVN_CTL_NBR = DLGT.INVN_CTL_NBR AND REF.ICN_SUFX_CD = DLGT.ICN_SUFX_CD"
            .toCharArray());
  ...
  /**
   * set variable thisProgram Corresponding COBOL Variable is THIS-PROGRAM
   *
   * @param value
   */
  ...
  /**
   * set variable dt1ReqContainerName Corresponding COBOL Variable is DT1-REQ-CONTAINER-NAME
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqContainerLength with the passed value Corresponding COBOL Variable is
   * DT1-REQ-CONTAINER-LENGTH
   *
   * @param number
   */
  ...
  public void setDt1ReqContainerLength(long number) {
    number =
        checkDt1ReqContainerLengthMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable dt1RspContainerName Corresponding COBOL Variable is DT1-RSP-CONTAINER-NAME
   *
   * @param value
   */
  ...
  /**
   * Update Dt1RspContainerLength with the passed value Corresponding COBOL Variable is
   * DT1-RSP-CONTAINER-LENGTH
   *
   * @param number
   */
  ...
  public void setDt1RspContainerLength(long number) {
    number =
        checkDt1RspContainerLengthMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable dt1RspContainerLayout Corresponding COBOL Variable is DT1-RSP-CONTAINER-LAYOUT
   *
   * @param value
   */
  ...
  /**
   * set variable dt1ClmContainerName Corresponding COBOL Variable is DT1-CLM-CONTAINER-NAME
   *
   * @param value
   */
  ...
  /**
   * set variable dt1ClmContainerLayout Corresponding COBOL Variable is DT1-CLM-CONTAINER-LAYOUT
   *
   * @param value
   */
  ...
  /**
   * set variable dt1SrtContainerName Corresponding COBOL Variable is DT1-SRT-CONTAINER-NAME
   *
   * @param value
   */
  ...
  /**
   * set variable dt1SrtContainerLayout Corresponding COBOL Variable is DT1-SRT-CONTAINER-LAYOUT
   *
   * @param value
   */
  ...
  /**
   * set variable stsContainerName Corresponding COBOL Variable is STS-CONTAINER-NAME
   *
   * @param value
   */
  ...
  /**
   * Update StsContainerLength with the passed value Corresponding COBOL Variable is
   * STS-CONTAINER-LENGTH
   *
   * @param number
   */
  ...
  /**
   * set variable stsContainerLayout Corresponding COBOL Variable is STS-CONTAINER-LAYOUT
   *
   * @param value
   */
  ...
  /**
   * set variable topsIcn10 Corresponding COBOL Variable is TOPS-ICN-10
   *
   * @param value
   */
  ...
  /**
   * Test condition "0000000001" THRU "9999999999" "AA00000000" THRU "ZZ99999999" for
   * isValidIcnNumValue10()
   *
   * @return Returns true if isValidIcnNumValue10() is "0000000001" THRU "9999999999" "AA00000000"
   *     THRU "ZZ99999999"
   */
  public boolean isValidIcnNumValue10() throws CFException {
    return (isGreaterOrEqual(getTopsIcn10(), "0000000001")
            && isLessOrEqual(getTopsIcn10(), "9999999999l")
        || isGreaterOrEqual(getTopsIcn10(), "AA00000000")
            && isLessOrEqual(getTopsIcn10(), "ZZ99999999"));
  }
  ...
  /**
   * set variable defaultDate Corresponding COBOL Variable is WS-DEFAULT-DATE
   *
   * @param value
   */
  ...
  /**
   * set variable defaultDateDb2 Corresponding COBOL Variable is DEFAULT-DATE-DB2
   *
   * @param value
   */
  ...
  /**
   * set variable fmtYyyyMmDd Corresponding COBOL Variable is FMT-YYYY-MM-DD
   *
   * @param value
   */
  ...
  /**
   * set variable fmtYyddd Corresponding COBOL Variable is FMT-YYDDD
   *
   * @param value
   */
  ...
  /**
   * set variable ceedays Corresponding COBOL Variable is CEEDAYS
   *
   * @param value
   */
  ...
  /**
   * set variable ceedate Corresponding COBOL Variable is CEEDATE
   *
   * @param value
   */
  ...
  /**
   * Update MaxClaimsDefault with the passed value Corresponding COBOL Variable is
   * MAX-CLAIMS-DEFAULT
   *
   * @param number
   */
  ...
  /**
   * Update MaxClaimsRequested with the passed value Corresponding COBOL Variable is
   * MAX-CLAIMS-REQUESTED
   *
   * @param number
   */
  ...
  /**
   * Update D5427dt1MaxRows with the passed value Corresponding COBOL Variable is D5427DT1-MAX-ROWS
   *
   * @param number
   */
  ...
  /**
   * Update D5427dt1MaxClaims with the passed value Corresponding COBOL Variable is
   * D5427DT1-MAX-CLAIMS
   *
   * @param number
   */
  ...
  /**
   * Update FetchRowsetMax with the passed value Corresponding COBOL Variable is FETCH-ROWSET-MAX
   *
   * @param number
   */
  ...
  /**
   * Update FetchRowsRetrieved with the passed value Corresponding COBOL Variable is
   * FETCH-ROWS-RETRIEVED
   *
   * @param number
   */
  ...
  /**
   * Update TotalRowsRetrieved with the passed value Corresponding COBOL Variable is
  ...
  /**
   * Update NbrSrtItems with the passed value Corresponding COBOL Variable is NBR-SRT-ITEMS
   *
   * @param number
   */
  ...
  /**
   * set variable payeeCode Corresponding COBOL Variable is WS-PAYEE-CODE
   *
   * @param value
   */
  ...
  /**
   * Update HeaderCt with the passed value Corresponding COBOL Variable is WS-HEADER-CT
   *
   * @param number
   */
  ...
  /**
   * set variable recType Corresponding COBOL Variable is WS-REC-TYPE
   *
   * @param value
   */
  ...
  /**
   * set variable diffrntVerFoundSw Corresponding COBOL Variable is WS-DIFFRNT-VER-FOUND-SW
   *
   * @param value
   */
  ...
  /**
   * set variable claimSw Corresponding COBOL Variable is CLAIM-SW
   *
   * @param value
   */
  ...
  /**
   * set variable infoLineInd Corresponding COBOL Variable is INFO-LINE-IND
   *
   * @param value
   */
  ...
  /**
   * set variable clmHstEndOfFetchInd Corresponding COBOL Variable is CLM-HST-END-OF-FETCH-IND
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterInd Corresponding COBOL Variable is QUERY-FILTER-IND
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClaimKeyMax with the passed value Corresponding COBOL Variable is DT1-CLAIM-KEY-MAX
   *
   * @param number
   */
  ...
  /**
   * Update Dt1ClaimKeyCnt with the passed value Corresponding COBOL Variable is DT1-CLAIM-KEY-CNT
   *
   * @param number
   */
  ...
  /**
   * Update I with the passed value Corresponding COBOL Variable is I
   *
   * @param number
   */
  ...
  /**
   * set variable queryBaseCteStart Corresponding COBOL Variable is QUERY-BASE-CTE-START
   *
   * @param value
   */
  ...
  /**
   * set variable queryBaseCteEnd Corresponding COBOL Variable is QUERY-BASE-CTE-END
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterProviderTin Corresponding COBOL Variable is QUERY-FILTER-PROVIDER-TIN
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterIcn Corresponding COBOL Variable is QUERY-FILTER-ICN
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterAuthStart Corresponding COBOL Variable is QUERY-FILTER-AUTH-START
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterAuthEnd Corresponding COBOL Variable is QUERY-FILTER-AUTH-END
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterAuthBaseEnd Corresponding COBOL Variable is QUERY-FILTER-AUTH-BASE-END
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterDlgtStart Corresponding COBOL Variable is QUERY-FILTER-DLGT-START
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterAuthCrit6 Corresponding COBOL Variable is QUERY-FILTER-AUTH-CRIT-6
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterDlgtCrit6 Corresponding COBOL Variable is QUERY-FILTER-DLGT-CRIT-6
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiStart Corresponding COBOL Variable is QUERY-FILTER-SPI-START
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiEnd Corresponding COBOL Variable is QUERY-FILTER-SPI-END
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiPred1 Corresponding COBOL Variable is QUERY-FILTER-SPI-PRED-1
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiPred2 Corresponding COBOL Variable is QUERY-FILTER-SPI-PRED-2
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiPred3 Corresponding COBOL Variable is QUERY-FILTER-SPI-PRED-3
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiPred4 Corresponding COBOL Variable is QUERY-FILTER-SPI-PRED-4
   *
   * @param value
   */
  ...
  /**
   * set variable queryFilterSpiPred5 Corresponding COBOL Variable is QUERY-FILTER-SPI-PRED-5
   *
   * @param value
   */
