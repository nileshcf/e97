...
public class TimeXGroup extends TimeXGroupSerialized {
  ...
  /**
   * set variable timeX Corresponding COBOL Variable is WS-TIME-X
   *
   * @param value
   */
  ...
  /**
   * Update TimeX with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TimeX with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTimeX(
  ...
  /**
   * Update TimeX with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TimeX with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTimeX(
  ...
  /**
   * Update Time9 with the passed value Corresponding COBOL Variable is WS-TIME-9
   *
   * @param number
   */
