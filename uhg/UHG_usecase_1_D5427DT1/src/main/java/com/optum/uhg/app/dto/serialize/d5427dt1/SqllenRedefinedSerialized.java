...
/**
 * The class SqllenRedefinedSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class SqllenRedefinedSerialized extends Field {
  ...
  /**
   * sets parent for this SqllenRedefinedSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isSqlscaleModified() {
    ...
    localSqlscaleCounter = sharedCounter;
    return hasModified;
  }
