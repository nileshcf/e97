...
public class DderefEeIdGroup extends DderefEeIdGroupSerialized {
  ...
  /**
   * set variable dderefEeId Corresponding COBOL Variable is DDEREF-EE-ID
   *
   * @param value
   */
  ...
  /**
   * Update DderefEeId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefEeId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefEeId(
  ...
  /**
   * Update DderefEeId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DderefEeId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDderefEeId(
