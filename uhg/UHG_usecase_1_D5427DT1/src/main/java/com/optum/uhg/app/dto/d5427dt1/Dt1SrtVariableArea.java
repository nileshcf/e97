...
public class Dt1SrtVariableArea extends Dt1SrtVariableAreaSerialized {
  ...
  /**
   * Update Dt1SrtArray with the passed value Corresponding COBOL Variable is DT1-SRT-ARRAY
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtArray with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtArray with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtArray(
  ...
  /**
   * Update Dt1SrtArray with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1SrtArray with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1SrtArray(
