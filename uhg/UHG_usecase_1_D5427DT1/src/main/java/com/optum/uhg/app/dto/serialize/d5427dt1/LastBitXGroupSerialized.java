...
/**
 * The class LastBitXGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class LastBitXGroupSerialized extends Field {
  ...
  public boolean isLastBitXModified() {
    ...
    localLastBitXCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isLastBit9Modified() {
    ...
    localLastBit9Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeLastBit9(char[] value) {
    ...
    replaceValue(padNumber(1, value, false /*isSigned?*/), beginLastBit9, 1);
    localLastBit9Counter = shareString.getSerializedField().getModifiedCounter();
    return lastBit9;
  }
