...
/**
 * The class StorageAllocVarsSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class StorageAllocVarsSerialized extends Field {
  ...
  /**
   * sets parent for this StorageAllocVarsSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isStorageSizeRequiredModified() {
    ...
    localStorageSizeRequiredCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshStorageSizeRequired is used to refresh the latest value of a variable from the
  ...
  public boolean isStorageAreaPtrModified() {
    ...
    localStorageAreaPtrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshStorageAreaPtr is used to refresh the latest value of a variable from the Serialized
