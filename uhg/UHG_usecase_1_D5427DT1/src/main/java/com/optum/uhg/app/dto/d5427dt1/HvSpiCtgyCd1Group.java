...
public class HvSpiCtgyCd1Group extends HvSpiCtgyCd1GroupSerialized {
  ...
  /**
   * set variable hvSpiCtgyCd1 Corresponding COBOL Variable is HV-SPI-CTGY-CD-1
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd1 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd1 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd1(
  ...
  /**
   * Update HvSpiCtgyCd1 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd1 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd1(
