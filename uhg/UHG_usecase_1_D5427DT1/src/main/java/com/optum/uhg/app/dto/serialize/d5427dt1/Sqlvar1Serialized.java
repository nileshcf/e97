...
/**
 * The class Sqlvar1Serialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Sqlvar1Serialized extends Field {
  ...
  /**
   * sets parent for this Sqlvar1Serialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isSqltypeModified() {
    ...
    localSqltypeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqltype(short sqltype) {
    replaceValue( //  save the value as string
        getBinaryString(sqltype, SQLTYPE_LEN), beginSqltype, SQLTYPE_LEN);
  ...
  /**
   * refreshSqltype is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isSqllenModified() {
    ...
    localSqllenCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqllen(short sqllen) {
    replaceValue( //  save the value as string
        getBinaryString(sqllen, SQLLEN_LEN), beginSqllen, SQLLEN_LEN);
  ...
  /**
   * refreshSqllen is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isSqldataModified() {
    ...
    localSqldataCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqldata(int sqldata) {
    replaceValue( //  save the value as string
        getBinaryString(sqldata, SQLDATA_LEN), beginSqldata, SQLDATA_LEN);
  ...
  /**
   * refreshSqldata is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isSqlindModified() {
    ...
    localSqlindCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqlind(int sqlind) {
    replaceValue( //  save the value as string
        getBinaryString(sqlind, SQLIND_LEN), beginSqlind, SQLIND_LEN);
  ...
  /**
   * refreshSqlind is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
