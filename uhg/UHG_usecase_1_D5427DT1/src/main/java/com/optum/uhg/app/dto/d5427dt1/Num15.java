...
public class Num15 extends Num15Serialized {
  ...
  /**
   * set variable num15X Corresponding COBOL Variable is WS-NUM-15-X
   *
   * @param value
   */
  ...
  /**
   * Update Num15X with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Num15X with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNum15X(
  ...
  /**
   * Update Num15X with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Num15X with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNum15X(
  ...
  /**
   * Update Num159 with the passed value Corresponding COBOL Variable is WS-NUM-15-9
   *
   * @param number
   */
