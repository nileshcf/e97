...
public class CurrentVariables extends CurrentVariablesSerialized {
  ...
  /**
   * set variable currentChannelName Corresponding COBOL Variable is CURRENT-CHANNEL-NAME
   *
   * @param value
   */
  ...
  /**
   * Update CurrentChannelName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentChannelName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCurrentChannelName(
  ...
  /**
   * Update CurrentChannelName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentChannelName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCurrentChannelName(
  ...
  /**
   * set variable currentContainerName Corresponding COBOL Variable is CURRENT-CONTAINER-NAME
   *
   * @param value
   */
  ...
  /**
   * Update CurrentContainerName with a char[] from an offset and length
   *
   * @param value
   */
  public void setCurrentContainerName(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginCurrentContainerName, currentContainerName.length);
  }
  ...
  /**
   * Update CurrentContainerName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCurrentContainerName(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update CurrentContainerName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentContainerName with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentContainerLength with the passed value Corresponding COBOL Variable is
  ...
  public void setCurrentContainerLength(long number) {
    number =
        checkCurrentContainerLengthMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable currentContainerLayout Corresponding COBOL Variable is CURRENT-CONTAINER-LAYOUT
   *
   * @param value
   */
  ...
  /**
   * Update CurrentContainerLayout with a char[] from an offset and length
   *
   * @param value
   */
  public void setCurrentContainerLayout(char[] source, int sourceIndex) {
    replace(
        ...
        currentContainerLayout.length);
  }

  public void setCurrentContainerLayout(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginCurrentContainerLayout, currentContainerLayout.length);
  }

  /**
   * Update CurrentContainerLayout with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCurrentContainerLayout(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update CurrentContainerLayout with another Field from an offset and length
   *
   * @param value
   */
  public void setCurrentContainerLayout(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginCurrentContainerLayout, CURRENT_CONTAINER_LAYOUT_LEN);
  }

  /**
   * Update CurrentContainerLayout with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update Cicsresp with the passed value Corresponding COBOL Variable is CICSRESP
   *
   * @param number
   */
  ...
  /**
   * Update Cicsresp2 with the passed value Corresponding COBOL Variable is CICSRESP2
   *
   * @param number
   */
