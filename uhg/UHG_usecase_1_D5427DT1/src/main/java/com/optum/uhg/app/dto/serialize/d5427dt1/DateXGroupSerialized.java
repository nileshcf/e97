...
/**
 * The class DateXGroupSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class DateXGroupSerialized extends Field {
  ...
  public boolean isDateXModified() {
    ...
    localDateXCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDateX is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isDate9Modified() {
    ...
    localDate9Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDate9(char[] value) {
    ...
    replaceValue(padNumber(8, value, false /*isSigned?*/), beginDate9, 8);
    localDate9Counter = shareString.getSerializedField().getModifiedCounter();
    return date9;
  }
  ...
  /**
   * refreshDate9 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
