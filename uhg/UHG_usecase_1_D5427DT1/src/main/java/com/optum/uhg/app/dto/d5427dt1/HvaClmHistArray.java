...
public class HvaClmHistArray extends HvaClmHistArraySerialized {
  ...
  /**
   * Update HvaSub with the passed value Corresponding COBOL Variable is HVA-SUB
   *
   * @param number
   */
  ...
  /**
   * Update HvaSub2 with the passed value Corresponding COBOL Variable is HVA-SUB2
   *
   * @param number
   */
  ...
  /**
   * Returns the value of hvaPartnId Corresponding COBOL Variable is HVA-PARTN-ID
   *
   * @return hvaPartnId
   */
  ...
  public short getHvaPartnId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPartnId - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PARTN_ID_SIZE);
    }
  ...
  /**
   * Update HvaPartnId at index with the passed value Corresponding COBOL Variable is HVA-PARTN-ID
   *
   * @param index
   * @param number
   */
  ...
  /**
   * Update HvaPartnId at index with the passed value and serialize the object if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaPartnId(int index, short value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPartnId(int, String, boolean), resetting it to 0", index);
      index = 0;
    } else if (index >= HVA_PARTN_ID_SIZE) {
      index = HVA_PARTN_ID_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaPartnId - Array index exceeded max Size "
              + HVA_PARTN_ID_SIZE
  ...
  /**
   * Returns the value of hvaPartnVal Corresponding COBOL Variable is HVA-PARTN-VAL
   *
   * @return hvaPartnVal
   */
  ...
  public char[] getHvaPartnVal(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPartnVal - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PARTN_VAL_SIZE);
    }
  ...
  /**
   * Update HvaPartnVal with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PARTN-VAL
   *
   * @param index
   * @param value
  ...
  private void setHvaPartnVal(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPartnVal(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProcDt Corresponding COBOL Variable is HVA-PROC-DT
   *
   * @return hvaProcDt
   */
  ...
  public char[] getHvaProcDt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProcDt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROC_DT_SIZE);
    }
  ...
  /**
   * Update HvaProcDt with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROC-DT
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaProcTm Corresponding COBOL Variable is HVA-PROC-TM
   *
   * @return hvaProcTm
   */
  ...
  public char[] getHvaProcTm(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProcTm - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROC_TM_SIZE);
    }
  ...
  /**
   * Update HvaProcTm with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROC-TM
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaPgmIdLstCharVal Corresponding COBOL Variable is HVA-PGM-ID-LST-CHAR-VAL
   *
  ...
  public char[] getHvaPgmIdLstCharVal(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPgmIdLstCharVal - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PGM_ID_LST_CHAR_VAL_SIZE);
    }
    return getCharArray(
  ...
  /**
   * Update HvaPgmIdLstCharVal with the passed value at a given index Corresponding COBOL Variable
   * is HVA-PGM-ID-LST-CHAR-VAL
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update HvaPgmIdLstCharVal with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHvaPgmIdLstCharVal(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPgmIdLstCharVal(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaIcnSufxVersNbr Corresponding COBOL Variable is HVA-ICN-SUFX-VERS-NBR
   *
  ...
  public short getHvaIcnSufxVersNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaIcnSufxVersNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_ICN_SUFX_VERS_NBR_SIZE);
    }
    return getShort(beginHvaIcnSufxVersNbr + index * HVA_ICN_SUFX_VERS_NBR_LEN);
  }

  /**
   * Update HvaIcnSufxVersNbr at index with the passed value Corresponding COBOL Variable is
  ...
  /**
   * Update HvaIcnSufxVersNbr at index with the passed value and serialize the object if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHvaIcnSufxVersNbr(int index, short value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaIcnSufxVersNbr(int, String, boolean), resetting it to 0",
          index);
      index = 0;
    } else if (index >= HVA_ICN_SUFX_VERS_NBR_SIZE) {
      index = HVA_ICN_SUFX_VERS_NBR_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaIcnSufxVersNbr - Array index exceeded max Size "
              + HVA_ICN_SUFX_VERS_NBR_SIZE
              + ", resetting it to max allowed");
    }
    //
  ...
  /**
   * Returns the value of hvaInvnCtlNbr Corresponding COBOL Variable is HVA-INVN-CTL-NBR
   *
  ...
  public char[] getHvaInvnCtlNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaInvnCtlNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_INVN_CTL_NBR_SIZE);
    }
  ...
  /**
   * Update HvaInvnCtlNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-INVN-CTL-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaInvnCtlNbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaInvnCtlNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaInvnCtlNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaIcnSufxCd Corresponding COBOL Variable is HVA-ICN-SUFX-CD
   *
   * @return hvaIcnSufxCd
   */
  ...
  public char[] getHvaIcnSufxCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaIcnSufxCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_ICN_SUFX_CD_SIZE);
    }
  ...
  /**
   * Update HvaIcnSufxCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-ICN-SUFX-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaIcnSufxCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaIcnSufxCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaIcnSufxCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaLnId Corresponding COBOL Variable is HVA-LN-ID
   *
   * @return hvaLnId
   */
  ...
  public short getHvaLnId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaLnId - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_LN_ID_SIZE);
    }
  ...
  /**
   * Update HvaLnId at index with the passed value Corresponding COBOL Variable is HVA-LN-ID
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaLnId(int index, short value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaLnId(int, String, boolean), resetting it to 0", index);
      index = 0;
    } else if (index >= HVA_LN_ID_SIZE) {
      index = HVA_LN_ID_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaLnId - Array index exceeded max Size "
              + HVA_LN_ID_SIZE
              + ", resetting it to max allowed");
    }
    //
  ...
  /**
   * Returns the value of hvaFlnJulianDtNbr Corresponding COBOL Variable is HVA-FLN-JULIAN-DT-NBR
   *
  ...
  public char[] getHvaFlnJulianDtNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaFlnJulianDtNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_FLN_JULIAN_DT_NBR_SIZE);
    }
    return getCharArray(
        (beginHvaFlnJulianDtNbr + index * HVA_FLN_JULIAN_DT_NBR_LEN), HVA_FLN_JULIAN_DT_NBR_LEN);
  }
  ...
  /**
   * Update HvaFlnJulianDtNbr with the passed value at a given index Corresponding COBOL Variable is
  ...
  /**
   * Update HvaFlnJulianDtNbr with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHvaFlnJulianDtNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaFlnJulianDtNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaFlnSrlNbr Corresponding COBOL Variable is HVA-FLN-SRL-NBR
   *
   * @return hvaFlnSrlNbr
   */
  ...
  public char[] getHvaFlnSrlNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaFlnSrlNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_FLN_SRL_NBR_SIZE);
    }
  ...
  /**
   * Update HvaFlnSrlNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-FLN-SRL-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaFlnSrlNbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaFlnSrlNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaFlnSrlNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaDftNbr Corresponding COBOL Variable is HVA-DFT-NBR
   *
   * @return hvaDftNbr
   */
  ...
  public char[] getHvaDftNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaDftNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_DFT_NBR_SIZE);
    }
  ...
  /**
   * Update HvaDftNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-DFT-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaFstDt Corresponding COBOL Variable is HVA-FST-DT
   *
   * @return hvaFstDt
   */
  ...
  public char[] getHvaFstDt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaFstDt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_FST_DT_SIZE);
    }
  ...
  /**
   * Update HvaFstDt with the passed value at a given index Corresponding COBOL Variable is
   * HVA-FST-DT
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaLstSrvcDt Corresponding COBOL Variable is HVA-LST-SRVC-DT
   *
   * @return hvaLstSrvcDt
   */
  ...
  public char[] getHvaLstSrvcDt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaLstSrvcDt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_LST_SRVC_DT_SIZE);
    }
  ...
  /**
   * Update HvaLstSrvcDt with the passed value at a given index Corresponding COBOL Variable is
   * HVA-LST-SRVC-DT
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaLstSrvcDt with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaLstSrvcDt(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaLstSrvcDt(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvTinsuff Corresponding COBOL Variable is HVA-PROV-TINSUFF
   *
  ...
  public char[] getHvaProvTinsuff(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvTinsuff - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_TINSUFF_SIZE);
    }
  ...
  /**
   * Update HvaProvTinsuff with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-TINSUFF
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvTinsuff with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvTinsuff(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvTinsuff(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvScrnNbr Corresponding COBOL Variable is HVA-PROV-SCRN-NBR
   *
  ...
  public char[] getHvaProvScrnNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvScrnNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_SCRN_NBR_SIZE);
    }
    return getCharArray(
        (beginHvaProvScrnNbr + index * HVA_PROV_SCRN_NBR_LEN), HVA_PROV_SCRN_NBR_LEN);
  }
  ...
  /**
   * Update HvaProvScrnNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-SCRN-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvScrnNbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvScrnNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvScrnNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaChrgAmt Corresponding COBOL Variable is HVA-CHRG-AMT
   *
   * @return hvaChrgAmt
   */
  ...
  public BigDecimal getHvaChrgAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaChrgAmt - Array index exceeded max Size "
                + HVA_CHRG_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaChrgAmt + index * HVA_CHRG_AMT_LEN, HVA_CHRG_AMT_LEN, HVA_CHRG_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaChrgAmt", beginHvaChrgAmt + index * HVA_CHRG_AMT_LEN, HVA_CHRG_AMT_LEN);
    }
  }
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-CHRG-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaChrgAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaChrgAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_CHRG_AMT_SIZE) {
      index = HVA_CHRG_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaChrgAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_CHRG_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaRmrkCd Corresponding COBOL Variable is HVA-RMRK-CD
   *
   * @return hvaRmrkCd
   */
  ...
  public char[] getHvaRmrkCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaRmrkCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_RMRK_CD_SIZE);
    }
  ...
  /**
   * Update HvaRmrkCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-RMRK-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaNcAmt Corresponding COBOL Variable is HVA-NC-AMT
   *
   * @return hvaNcAmt
   */
  ...
  public BigDecimal getHvaNcAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaNcAmt - Array index exceeded max Size "
                + HVA_NC_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(beginHvaNcAmt + index * HVA_NC_AMT_LEN, HVA_NC_AMT_LEN, HVA_NC_AMT_SCALE);
    } catch (Exception ex) {
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-NC-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaNcAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      ...
      index = HVA_NC_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaNcAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_NC_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaPmtSvcCd Corresponding COBOL Variable is HVA-PMT-SVC-CD
   *
   * @return hvaPmtSvcCd
   */
  ...
  public char[] getHvaPmtSvcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPmtSvcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PMT_SVC_CD_SIZE);
    }
  ...
  /**
   * Update HvaPmtSvcCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PMT-SVC-CD
   *
   * @param index
   * @param value
  ...
  private void setHvaPmtSvcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPmtSvcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaOvrCd Corresponding COBOL Variable is HVA-OVR-CD
   *
   * @return hvaOvrCd
   */
  ...
  public char[] getHvaOvrCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaOvrCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_OVR_CD_SIZE);
    }
  ...
  /**
   * Update HvaOvrCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-OVR-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaCopayAmt Corresponding COBOL Variable is HVA-COPAY-AMT
   *
   * @return hvaCopayAmt
   */
  ...
  public BigDecimal getHvaCopayAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaCopayAmt - Array index exceeded max Size "
                + HVA_COPAY_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaCopayAmt + index * HVA_COPAY_AMT_LEN, HVA_COPAY_AMT_LEN, HVA_COPAY_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaCopayAmt", beginHvaCopayAmt + index * HVA_COPAY_AMT_LEN, HVA_COPAY_AMT_LEN);
    }
  }
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-COPAY-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaCopayAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaCopayAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_COPAY_AMT_SIZE) {
      index = HVA_COPAY_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaCopayAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_COPAY_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaSrvcCd Corresponding COBOL Variable is HVA-SRVC-CD
   *
   * @return hvaSrvcCd
   */
  ...
  public char[] getHvaSrvcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaSrvcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_SRVC_CD_SIZE);
    }
  ...
  /**
   * Update HvaSrvcCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-SRVC-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaPayCd Corresponding COBOL Variable is HVA-PAY-CD
   *
   * @return hvaPayCd
   */
  ...
  public char[] getHvaPayCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPayCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PAY_CD_SIZE);
    }
  ...
  /**
   * Update HvaPayCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PAY-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaTransCd Corresponding COBOL Variable is HVA-TRANS-CD
   *
   * @return hvaTransCd
   */
  ...
  public char[] getHvaTransCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaTransCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_TRANS_CD_SIZE);
    }
  ...
  /**
   * Update HvaTransCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-TRANS-CD
   *
   * @param index
   * @param value
  ...
  private void setHvaTransCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaTransCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaFilmOfcNbr Corresponding COBOL Variable is HVA-FILM-OFC-NBR
   *
  ...
  public char[] getHvaFilmOfcNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaFilmOfcNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_FILM_OFC_NBR_SIZE);
    }
  ...
  /**
   * Update HvaFilmOfcNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-FILM-OFC-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaFilmOfcNbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaFilmOfcNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaFilmOfcNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaClmLvlRsnCd Corresponding COBOL Variable is HVA-CLM-LVL-RSN-CD
   *
  ...
  public char[] getHvaClmLvlRsnCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaClmLvlRsnCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_CLM_LVL_RSN_CD_SIZE);
    }
    return getCharArray(
        (beginHvaClmLvlRsnCd + index * HVA_CLM_LVL_RSN_CD_LEN), HVA_CLM_LVL_RSN_CD_LEN);
  }
  ...
  /**
   * Update HvaClmLvlRsnCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-CLM-LVL-RSN-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaClmLvlRsnCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaClmLvlRsnCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaClmLvlRsnCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaAdjtrId Corresponding COBOL Variable is HVA-ADJTR-ID
   *
   * @return hvaAdjtrId
   */
  ...
  public char[] getHvaAdjtrId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaAdjtrId - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_ADJTR_ID_SIZE);
    }
  ...
  /**
   * Update HvaAdjtrId with the passed value at a given index Corresponding COBOL Variable is
   * HVA-ADJTR-ID
   *
   * @param index
   * @param value
  ...
  private void setHvaAdjtrId(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaAdjtrId(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaMbrPrvInd Corresponding COBOL Variable is HVA-MBR-PRV-IND
   *
   * @return hvaMbrPrvInd
   */
  ...
  public char[] getHvaMbrPrvInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaMbrPrvInd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_MBR_PRV_IND_SIZE);
    }
  ...
  /**
   * Update HvaMbrPrvInd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-MBR-PRV-IND
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaMbrPrvInd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaMbrPrvInd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaMbrPrvInd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaNtfyWaivCd Corresponding COBOL Variable is HVA-NTFY-WAIV-CD
   *
  ...
  public char[] getHvaNtfyWaivCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaNtfyWaivCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_NTFY_WAIV_CD_SIZE);
    }
  ...
  /**
   * Update HvaNtfyWaivCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-NTFY-WAIV-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaNtfyWaivCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaNtfyWaivCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaNtfyWaivCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaBankCd Corresponding COBOL Variable is HVA-BANK-CD
   *
   * @return hvaBankCd
   */
  ...
  public char[] getHvaBankCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaBankCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_BANK_CD_SIZE);
    }
  ...
  /**
   * Update HvaBankCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-BANK-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaDivNbr Corresponding COBOL Variable is HVA-DIV-NBR
   *
   * @return hvaDivNbr
   */
  ...
  public char[] getHvaDivNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaDivNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_DIV_NBR_SIZE);
    }
  ...
  /**
   * Update HvaDivNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-DIV-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaClsNbr Corresponding COBOL Variable is HVA-CLS-NBR
   *
   * @return hvaClsNbr
   */
  ...
  public char[] getHvaClsNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaClsNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_CLS_NBR_SIZE);
    }
  ...
  /**
   * Update HvaClsNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-CLS-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaDrgNbr Corresponding COBOL Variable is HVA-DRG-NBR
   *
   * @return hvaDrgNbr
   */
  ...
  public char[] getHvaDrgNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaDrgNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_DRG_NBR_SIZE);
    }
  ...
  /**
   * Update HvaDrgNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-DRG-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaFaclOrProfCd Corresponding COBOL Variable is HVA-FACL-OR-PROF-CD
   *
  ...
  public char[] getHvaFaclOrProfCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaFaclOrProfCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_FACL_OR_PROF_CD_SIZE);
    }
    return getCharArray(
        (beginHvaFaclOrProfCd + index * HVA_FACL_OR_PROF_CD_LEN), HVA_FACL_OR_PROF_CD_LEN);
  }
  ...
  /**
   * Update HvaFaclOrProfCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-FACL-OR-PROF-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaFaclOrProfCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaFaclOrProfCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaFaclOrProfCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaDlgteInd Corresponding COBOL Variable is HVA-DLGTE-IND
   *
   * @return hvaDlgteInd
   */
  ...
  public char[] getHvaDlgteInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaDlgteInd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_DLGTE_IND_SIZE);
    }
  ...
  /**
   * Update HvaDlgteInd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-DLGTE-IND
   *
   * @param index
   * @param value
  ...
  private void setHvaDlgteInd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaDlgteInd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaNdbContrId Corresponding COBOL Variable is HVA-NDB-CONTR-ID
   *
  ...
  public char[] getHvaNdbContrId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaNdbContrId - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_NDB_CONTR_ID_SIZE);
    }
  ...
  /**
   * Update HvaNdbContrId with the passed value at a given index Corresponding COBOL Variable is
   * HVA-NDB-CONTR-ID
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaNdbContrId with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaNdbContrId(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaNdbContrId(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaClmSmbTypAppCd Corresponding COBOL Variable is HVA-CLM-SMB-TYP-APP-CD
   *
  ...
  public char[] getHvaClmSmbTypAppCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaClmSmbTypAppCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_CLM_SMB_TYP_APP_CD_SIZE);
    }
    return getCharArray(
        (beginHvaClmSmbTypAppCd + index * HVA_CLM_SMB_TYP_APP_CD_LEN), HVA_CLM_SMB_TYP_APP_CD_LEN);
  }
  ...
  /**
   * Update HvaClmSmbTypAppCd with the passed value at a given index Corresponding COBOL Variable is
  ...
  /**
   * Update HvaClmSmbTypAppCd with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHvaClmSmbTypAppCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaClmSmbTypAppCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaSmbStCd Corresponding COBOL Variable is HVA-SMB-ST-CD
   *
   * @return hvaSmbStCd
   */
  ...
  public char[] getHvaSmbStCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaSmbStCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_SMB_ST_CD_SIZE);
    }
  ...
  /**
   * Update HvaSmbStCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-SMB-ST-CD
   *
   * @param index
   * @param value
  ...
  private void setHvaSmbStCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaSmbStCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProcT1Ind Corresponding COBOL Variable is HVA-PROC-T1-IND
   *
   * @return hvaProcT1Ind
   */
  ...
  public char[] getHvaProcT1Ind(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProcT1Ind - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROC_T_1_IND_SIZE);
    }
  ...
  /**
   * Update HvaProcT1Ind with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROC-T1-IND
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProcT1Ind with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProcT1Ind(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProcT1Ind(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaAuthNbr Corresponding COBOL Variable is HVA-AUTH-NBR
   *
   * @return hvaAuthNbr
   */
  ...
  public char[] getHvaAuthNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaAuthNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_AUTH_NBR_SIZE);
    }
  ...
  /**
   * Update HvaAuthNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-AUTH-NBR
   *
   * @param index
   * @param value
  ...
  private void setHvaAuthNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaAuthNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaBaseDedDescTxt Corresponding COBOL Variable is HVA-BASE-DED-DESC-TXT
   *
  ...
  public char[] getHvaBaseDedDescTxt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaBaseDedDescTxt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_BASE_DED_DESC_TXT_SIZE);
    }
    return getCharArray(
        (beginHvaBaseDedDescTxt + index * HVA_BASE_DED_DESC_TXT_LEN), HVA_BASE_DED_DESC_TXT_LEN);
  }
  ...
  /**
   * Update HvaBaseDedDescTxt with the passed value at a given index Corresponding COBOL Variable is
  ...
  /**
   * Update HvaBaseDedDescTxt with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHvaBaseDedDescTxt(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaBaseDedDescTxt(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaMmDedDescTxt Corresponding COBOL Variable is HVA-MM-DED-DESC-TXT
   *
  ...
  public char[] getHvaMmDedDescTxt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaMmDedDescTxt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_MM_DED_DESC_TXT_SIZE);
    }
    return getCharArray(
        (beginHvaMmDedDescTxt + index * HVA_MM_DED_DESC_TXT_LEN), HVA_MM_DED_DESC_TXT_LEN);
  }
  ...
  /**
   * Update HvaMmDedDescTxt with the passed value at a given index Corresponding COBOL Variable is
   * HVA-MM-DED-DESC-TXT
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaMmDedDescTxt with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaMmDedDescTxt(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaMmDedDescTxt(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaPrsCreatSrcCd Corresponding COBOL Variable is HVA-PRS-CREAT-SRC-CD
   *
  ...
  public char[] getHvaPrsCreatSrcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPrsCreatSrcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PRS_CREAT_SRC_CD_SIZE);
    }
    return getCharArray(
        (beginHvaPrsCreatSrcCd + index * HVA_PRS_CREAT_SRC_CD_LEN), HVA_PRS_CREAT_SRC_CD_LEN);
  }
  ...
  /**
   * Update HvaPrsCreatSrcCd with the passed value at a given index Corresponding COBOL Variable is
  ...
  /**
   * Update HvaPrsCreatSrcCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaPrsCreatSrcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPrsCreatSrcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaBaseDedAmt Corresponding COBOL Variable is HVA-BASE-DED-AMT
   *
  ...
  public BigDecimal getHvaBaseDedAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaBaseDedAmt - Array index exceeded max Size "
                + HVA_BASE_DED_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaBaseDedAmt + index * HVA_BASE_DED_AMT_LEN,
          HVA_BASE_DED_AMT_LEN,
          HVA_BASE_DED_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaBaseDedAmt", beginHvaBaseDedAmt + index * HVA_BASE_DED_AMT_LEN, HVA_BASE_DED_AMT_LEN);
    }
  }
  ...
  public boolean hvaBaseDedAmtIsNumeric(int index) {
    return decimalIsNumeric(
        beginHvaBaseDedAmt + index * HVA_BASE_DED_AMT_LEN, HVA_BASE_DED_AMT_LEN);
  }
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-BASE-DED-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaBaseDedAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaBaseDedAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_BASE_DED_AMT_SIZE) {
      index = HVA_BASE_DED_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaBaseDedAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_BASE_DED_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaBaseAmt Corresponding COBOL Variable is HVA-BASE-AMT
   *
   * @return hvaBaseAmt
   */
  ...
  public BigDecimal getHvaBaseAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaBaseAmt - Array index exceeded max Size "
                + HVA_BASE_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaBaseAmt + index * HVA_BASE_AMT_LEN, HVA_BASE_AMT_LEN, HVA_BASE_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaBaseAmt", beginHvaBaseAmt + index * HVA_BASE_AMT_LEN, HVA_BASE_AMT_LEN);
    }
  }
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-BASE-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaBaseAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaBaseAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_BASE_AMT_SIZE) {
      index = HVA_BASE_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaBaseAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_BASE_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaMmDedAmt Corresponding COBOL Variable is HVA-MM-DED-AMT
   *
   * @return hvaMmDedAmt
   */
  ...
  public BigDecimal getHvaMmDedAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaMmDedAmt - Array index exceeded max Size "
                + HVA_MM_DED_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaMmDedAmt + index * HVA_MM_DED_AMT_LEN, HVA_MM_DED_AMT_LEN, HVA_MM_DED_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaMmDedAmt", beginHvaMmDedAmt + index * HVA_MM_DED_AMT_LEN, HVA_MM_DED_AMT_LEN);
    }
  }
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-MM-DED-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaMmDedAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaMmDedAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_MM_DED_AMT_SIZE) {
      index = HVA_MM_DED_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaMmDedAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_MM_DED_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaMmAmt Corresponding COBOL Variable is HVA-MM-AMT
   *
   * @return hvaMmAmt
   */
  ...
  public BigDecimal getHvaMmAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaMmAmt - Array index exceeded max Size "
                + HVA_MM_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(beginHvaMmAmt + index * HVA_MM_AMT_LEN, HVA_MM_AMT_LEN, HVA_MM_AMT_SCALE);
    } catch (Exception ex) {
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-MM-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaMmAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      ...
      index = HVA_MM_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaMmAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_MM_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaMcCrResAmt Corresponding COBOL Variable is HVA-MC-CR-RES-AMT
   *
  ...
  public BigDecimal getHvaMcCrResAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaMcCrResAmt - Array index exceeded max Size "
                + HVA_MC_CR_RES_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaMcCrResAmt + index * HVA_MC_CR_RES_AMT_LEN,
          HVA_MC_CR_RES_AMT_LEN,
          HVA_MC_CR_RES_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaMcCrResAmt",
          beginHvaMcCrResAmt + index * HVA_MC_CR_RES_AMT_LEN,
  ...
  public boolean hvaMcCrResAmtIsNumeric(int index) {
    return decimalIsNumeric(
        beginHvaMcCrResAmt + index * HVA_MC_CR_RES_AMT_LEN, HVA_MC_CR_RES_AMT_LEN);
  }
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-MC-CR-RES-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaMcCrResAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaMcCrResAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_MC_CR_RES_AMT_SIZE) {
      index = HVA_MC_CR_RES_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaMcCrResAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_MC_CR_RES_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaCobCrResAmt Corresponding COBOL Variable is HVA-COB-CR-RES-AMT
   *
  ...
  public BigDecimal getHvaCobCrResAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaCobCrResAmt - Array index exceeded max Size "
                + HVA_COB_CR_RES_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaCobCrResAmt + index * HVA_COB_CR_RES_AMT_LEN,
          HVA_COB_CR_RES_AMT_LEN,
          HVA_COB_CR_RES_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaCobCrResAmt",
          beginHvaCobCrResAmt + index * HVA_COB_CR_RES_AMT_LEN,
  ...
  public boolean hvaCobCrResAmtIsNumeric(int index) {
    return decimalIsNumeric(
        beginHvaCobCrResAmt + index * HVA_COB_CR_RES_AMT_LEN, HVA_COB_CR_RES_AMT_LEN);
  }
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-COB-CR-RES-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaCobCrResAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaCobCrResAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_COB_CR_RES_AMT_SIZE) {
      index = HVA_COB_CR_RES_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaCobCrResAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_COB_CR_RES_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaParInd Corresponding COBOL Variable is HVA-PAR-IND
   *
   * @return hvaParInd
   */
  ...
  public char[] getHvaParInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaParInd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PAR_IND_SIZE);
    }
  ...
  /**
   * Update HvaParInd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PAR-IND
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaSupAmt Corresponding COBOL Variable is HVA-SUP-AMT
   *
   * @return hvaSupAmt
   */
  ...
  public BigDecimal getHvaSupAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaSupAmt - Array index exceeded max Size "
                + HVA_SUP_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaSupAmt + index * HVA_SUP_AMT_LEN, HVA_SUP_AMT_LEN, HVA_SUP_AMT_SCALE);
    } catch (Exception ex) {
  ...
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-SUP-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaSupAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      ...
      index = HVA_SUP_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaSupAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_SUP_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaProvMktNbr Corresponding COBOL Variable is HVA-PROV-MKT-NBR
   *
  ...
  public char[] getHvaProvMktNbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvMktNbr - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_MKT_NBR_SIZE);
    }
  ...
  /**
   * Update HvaProvMktNbr with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-MKT-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvMktNbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvMktNbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvMktNbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaPpoCd Corresponding COBOL Variable is HVA-PPO-CD
   *
   * @return hvaPpoCd
   */
  ...
  public char[] getHvaPpoCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPpoCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PPO_CD_SIZE);
    }
  ...
  /**
   * Update HvaPpoCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PPO-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaPtntRespAmt Corresponding COBOL Variable is HVA-PTNT-RESP-AMT
   *
  ...
  public BigDecimal getHvaPtntRespAmt(int index) throws CFException {
    try {
      if (index < 0) {
        ...
        logger.trace(
            "hvaPtntRespAmt - Array index exceeded max Size "
                + HVA_PTNT_RESP_AMT_SIZE
                + ", resetting it to max allowed");
      }
      return getDecimal(
          beginHvaPtntRespAmt + index * HVA_PTNT_RESP_AMT_LEN,
          HVA_PTNT_RESP_AMT_LEN,
          HVA_PTNT_RESP_AMT_SCALE);
    } catch (Exception ex) {
      throw getSoc7ABend(
          "hvaPtntRespAmt",
          beginHvaPtntRespAmt + index * HVA_PTNT_RESP_AMT_LEN,
  ...
  public boolean hvaPtntRespAmtIsNumeric(int index) {
    return decimalIsNumeric(
        beginHvaPtntRespAmt + index * HVA_PTNT_RESP_AMT_LEN, HVA_PTNT_RESP_AMT_LEN);
  }
  /**
   * Set value at the index passed Corresponding COBOL Variable is HVA-PTNT-RESP-AMT
   *
   * @param index
   * @param number
   */
  ...
  private void setHvaPtntRespAmt(int index, BigDecimal value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPtntRespAmt(int,String,boolean), reset it to 0", index);
      index = 0;
    } else if (index >= HVA_PTNT_RESP_AMT_SIZE) {
      index = HVA_PTNT_RESP_AMT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaPtntRespAmt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PTNT_RESP_AMT_SIZE);
    }
  ...
  /**
   * Returns the value of hvaAuthSrcId Corresponding COBOL Variable is HVA-AUTH-SRC-ID
   *
   * @return hvaAuthSrcId
   */
  ...
  public char[] getHvaAuthSrcId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaAuthSrcId - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_AUTH_SRC_ID_SIZE);
    }
  ...
  /**
   * Update HvaAuthSrcId with the passed value at a given index Corresponding COBOL Variable is
   * HVA-AUTH-SRC-ID
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaAuthSrcId with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaAuthSrcId(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaAuthSrcId(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaAuthProcCd Corresponding COBOL Variable is HVA-AUTH-PROC-CD
   *
  ...
  public char[] getHvaAuthProcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaAuthProcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_AUTH_PROC_CD_SIZE);
    }
  ...
  /**
   * Update HvaAuthProcCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-AUTH-PROC-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaAuthProcCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaAuthProcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaAuthProcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvNm Corresponding COBOL Variable is HVA-PROV-NM
   *
   * @return hvaProvNm
   */
  ...
  public char[] getHvaProvNm(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvNm - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_NM_SIZE);
    }
  ...
  /**
   * Update HvaProvNm with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-NM
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaProvEobNm Corresponding COBOL Variable is HVA-PROV-EOB-NM
   *
   * @return hvaProvEobNm
   */
  ...
  public char[] getHvaProvEobNm(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvEobNm - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_EOB_NM_SIZE);
    }
  ...
  /**
   * Update HvaProvEobNm with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-EOB-NM
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvEobNm with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvEobNm(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvEobNm(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvPrdctCd Corresponding COBOL Variable is HVA-PROV-PRDCT-CD
   *
  ...
  public char[] getHvaProvPrdctCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvPrdctCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_PRDCT_CD_SIZE);
    }
    return getCharArray(
        (beginHvaProvPrdctCd + index * HVA_PROV_PRDCT_CD_LEN), HVA_PROV_PRDCT_CD_LEN);
  }
  ...
  /**
   * Update HvaProvPrdctCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-PRDCT-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvPrdctCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvPrdctCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvPrdctCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvMktTypCd Corresponding COBOL Variable is HVA-PROV-MKT-TYP-CD
   *
  ...
  public char[] getHvaProvMktTypCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvMktTypCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_MKT_TYP_CD_SIZE);
    }
    return getCharArray(
        (beginHvaProvMktTypCd + index * HVA_PROV_MKT_TYP_CD_LEN), HVA_PROV_MKT_TYP_CD_LEN);
  }
  ...
  /**
   * Update HvaProvMktTypCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-MKT-TYP-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvMktTypCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvMktTypCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvMktTypCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvIpaId Corresponding COBOL Variable is HVA-PROV-IPA-ID
   *
   * @return hvaProvIpaId
   */
  ...
  public char[] getHvaProvIpaId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvIpaId - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_IPA_ID_SIZE);
    }
  ...
  /**
   * Update HvaProvIpaId with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-IPA-ID
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvIpaId with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvIpaId(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvIpaId(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaTpsmCd Corresponding COBOL Variable is HVA-TPSM-CD
   *
   * @return hvaTpsmCd
   */
  ...
  public char[] getHvaTpsmCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaTpsmCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_TPSM_CD_SIZE);
    }
  ...
  /**
   * Update HvaTpsmCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-TPSM-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaProvSpclCd Corresponding COBOL Variable is HVA-PROV-SPCL-CD
   *
  ...
  public char[] getHvaProvSpclCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvSpclCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_SPCL_CD_SIZE);
    }
  ...
  /**
   * Update HvaProvSpclCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-PROV-SPCL-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update HvaProvSpclCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvSpclCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvSpclCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaProvMedcdReclmInd Corresponding COBOL Variable is
  ...
  public char[] getHvaProvMedcdReclmInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaProvMedcdReclmInd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PROV_MEDCD_RECLM_IND_SIZE);
    }
    return getCharArray(
  ...
  /**
   * Update HvaProvMedcdReclmInd with the passed value at a given index Corresponding COBOL Variable
   * is HVA-PROV-MEDCD-RECLM-IND
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update HvaProvMedcdReclmInd with the passed value at a given index and serializes if
   * setModified is true
   *
   * @param index
   * @param value
  ...
  private void setHvaProvMedcdReclmInd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaProvMedcdReclmInd(int,String,boolean), reset it to 0",
          index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaRelSrvcClmLvlInd Corresponding COBOL Variable is
  ...
  public char[] getHvaRelSrvcClmLvlInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaRelSrvcClmLvlInd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_REL_SRVC_CLM_LVL_IND_SIZE);
    }
    return getCharArray(
  ...
  /**
   * Update HvaRelSrvcClmLvlInd with the passed value at a given index Corresponding COBOL Variable
   * is HVA-REL-SRVC-CLM-LVL-IND
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update HvaRelSrvcClmLvlInd with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHvaRelSrvcClmLvlInd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaRelSrvcClmLvlInd(int,String,boolean), reset it to 0",
          index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hvaDiagCd Corresponding COBOL Variable is HVA-DIAG-CD
   *
   * @return hvaDiagCd
   */
  ...
  public char[] getHvaDiagCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaDiagCd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_DIAG_CD_SIZE);
    }
  ...
  /**
   * Update HvaDiagCd with the passed value at a given index Corresponding COBOL Variable is
   * HVA-DIAG-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of hvaAuthUniqCnt Corresponding COBOL Variable is HVA-AUTH-UNIQ-CNT
   *
  ...
  public int getHvaAuthUniqCnt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaAuthUniqCnt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_AUTH_UNIQ_CNT_SIZE);
    }
    return getInt(beginHvaAuthUniqCnt + index * HVA_AUTH_UNIQ_CNT_LEN);
  }

  /**
   * Update HvaAuthUniqCnt at index with the passed value Corresponding COBOL Variable is
   * HVA-AUTH-UNIQ-CNT
   *
   * @param index
   * @param number
  ...
  /**
   * Update HvaAuthUniqCnt at index with the passed value and serialize the object if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaAuthUniqCnt(int index, int value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaAuthUniqCnt(int, String, boolean), resetting it to 0",
          index);
      index = 0;
    } else if (index >= HVA_AUTH_UNIQ_CNT_SIZE) {
      index = HVA_AUTH_UNIQ_CNT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaAuthUniqCnt - Array index exceeded max Size "
              + HVA_AUTH_UNIQ_CNT_SIZE
              + ", resetting it to max allowed");
    }
    //
  ...
  /**
   * Returns the value of hvaPhysMedcnMskCnt Corresponding COBOL Variable is HVA-PHYS-MEDCN-MSK-CNT
   *
  ...
  public int getHvaPhysMedcnMskCnt(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaPhysMedcnMskCnt - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_PHYS_MEDCN_MSK_CNT_SIZE);
    }
    return getInt(beginHvaPhysMedcnMskCnt + index * HVA_PHYS_MEDCN_MSK_CNT_LEN);
  }

  /**
   * Update HvaPhysMedcnMskCnt at index with the passed value Corresponding COBOL Variable is
   * HVA-PHYS-MEDCN-MSK-CNT
   *
   * @param index
   * @param number
   */
  ...
  /**
   * Update HvaPhysMedcnMskCnt at index with the passed value and serialize the object if
   * setModified is true
   *
   * @param index
   * @param value
  ...
  private void setHvaPhysMedcnMskCnt(int index, int value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaPhysMedcnMskCnt(int, String, boolean), resetting it to 0",
          index);
      index = 0;
    } else if (index >= HVA_PHYS_MEDCN_MSK_CNT_SIZE) {
      index = HVA_PHYS_MEDCN_MSK_CNT_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaPhysMedcnMskCnt - Array index exceeded max Size "
              + HVA_PHYS_MEDCN_MSK_CNT_SIZE
              + ", resetting it to max allowed");
    }
    //
  ...
  /**
   * Returns the value of hvaMskNullInd Corresponding COBOL Variable is HVA-MSK-NULL-IND
   *
  ...
  public short getHvaMskNullInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hvaMskNullInd - Array index exceeded max Size {}, resetting it to max allowed",
          HVA_MSK_NULL_IND_SIZE);
    }
    return getShort(beginHvaMskNullInd + index * HVA_MSK_NULL_IND_LEN);
  }

  /**
   * Update HvaMskNullInd at index with the passed value Corresponding COBOL Variable is
   * HVA-MSK-NULL-IND
   *
   * @param index
   * @param number
  ...
  /**
   * Update HvaMskNullInd at index with the passed value and serialize the object if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHvaMskNullInd(int index, short value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHvaMskNullInd(int, String, boolean), resetting it to 0",
          index);
      index = 0;
    } else if (index >= HVA_MSK_NULL_IND_SIZE) {
      index = HVA_MSK_NULL_IND_SIZE - 1; // can't exceed max array size
      logger.trace(
          "hvaMskNullInd - Array index exceeded max Size "
              + HVA_MSK_NULL_IND_SIZE
              + ", resetting it to max allowed");
    }
    //
