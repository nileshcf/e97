...
public class Sqlvar1 extends Sqlvar1Serialized {
  ...
  /**
   * Update Sqltype with the passed value Corresponding COBOL Variable is SQLTYPE
   *
   * @param number
   */
  ...
  /**
   * Update Sqllen with the passed value Corresponding COBOL Variable is SQLLEN
   *
   * @param number
   */
  ...
  /**
   * Update SqllenRedefined with the passed value Corresponding COBOL Variable is SQLLEN-REDEFINED
   *
   * @param value
   */
  ...
  /**
   * Update SqllenRedefined with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SqllenRedefined with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqllenRedefined(
  ...
  /**
   * Update SqllenRedefined with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SqllenRedefined with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqllenRedefined(
  ...
  /**
   * Update Sqldata with the passed value Corresponding COBOL Variable is SQLDATA
   *
   * @param number
   */
  ...
  /**
   * Update Sqlind with the passed value Corresponding COBOL Variable is SQLIND
   *
   * @param number
   */
  ...
  /**
   * Update Sqlname with the passed value Corresponding COBOL Variable is SQLNAME
   *
   * @param value
   */
  ...
  /**
   * Update Sqlname with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlname with a String from an offset and length to an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlname with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlname with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlname(
