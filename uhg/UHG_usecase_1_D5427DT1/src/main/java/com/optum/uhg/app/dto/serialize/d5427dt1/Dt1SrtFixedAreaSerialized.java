...
/**
 * The class Dt1SrtFixedAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1SrtFixedAreaSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1SrtFixedAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDt1SrtItemCntModified() {
    ...
    localDt1SrtItemCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1SrtItemCnt(char[] value) {
    ...
    replaceValue(padNumber(4, value, false /*isSigned?*/), beginDt1SrtItemCnt, 4);
    localDt1SrtItemCntCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1SrtItemCnt;
  }
  ...
  /**
   * refreshDt1SrtItemCnt is used to refresh the latest value of a variable from the Serialized
