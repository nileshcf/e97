...
/**
 * The class NextKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class NextKeySerialized extends Field {
  ...
  public boolean isNextProcDtModified() {
    ...
    localNextProcDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isNextProcTmModified() {
    ...
    localNextProcTmCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isNextPgmIdLstCharValModified() {
    ...
    localNextPgmIdLstCharValCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeNextPgmIdLstCharVal(char[] nextPgmIdLstCharVal) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginNextPgmIdLstCharVal,
        NEXT_PGM_ID_LST_CHAR_VAL_LEN);
  ...
  /**
   * refreshNextPgmIdLstCharVal is used to refresh the latest value of a variable from the
  ...
  public char[] refreshNextPgmIdLstCharVal() {
    return (substring(
        getStringValue(),
        beginNextPgmIdLstCharVal,
        beginNextPgmIdLstCharVal + NEXT_PGM_ID_LST_CHAR_VAL_LEN));
  }
  ...
  public boolean isNextIcnSufxVersNbrModified() {
    ...
    localNextIcnSufxVersNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeNextIcnSufxVersNbr(char[] value) {
    ...
    replaceValue(padNumber(4, value, false /*isSigned?*/), beginNextIcnSufxVersNbr, 4);
    localNextIcnSufxVersNbrCounter = shareString.getSerializedField().getModifiedCounter();
    return nextIcnSufxVersNbr;
  }
  ...
  /**
   * refreshNextIcnSufxVersNbr is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isNextInvnCtlNbrModified() {
    ...
    localNextInvnCtlNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshNextInvnCtlNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshNextInvnCtlNbr() {
    return (substring(
        getStringValue(), beginNextInvnCtlNbr, beginNextInvnCtlNbr + NEXT_INVN_CTL_NBR_LEN));
  }
  ...
  public boolean isNextIcnSufxCdModified() {
    ...
    localNextIcnSufxCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshNextIcnSufxCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshNextIcnSufxCd() {
    return (substring(
        getStringValue(), beginNextIcnSufxCd, beginNextIcnSufxCd + NEXT_ICN_SUFX_CD_LEN));
  }
  ...
  public boolean isNextLnIdModified() {
    ...
    localNextLnIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeNextLnId(char[] value) {
    ...
    nextLnId =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(4, value, false /*isSigned?*/), beginNextLnId, 4);
    localNextLnIdCounter = shareString.getSerializedField().getModifiedCounter();
    return nextLnId;
  }
  ...
  public boolean isNextHeaderCtModified() {
    ...
    localNextHeaderCtCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeNextHeaderCt(char[] value) {
    ...
    nextHeaderCt =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(4, value, false /*isSigned?*/), beginNextHeaderCt, 4);
    localNextHeaderCtCounter = shareString.getSerializedField().getModifiedCounter();
    return nextHeaderCt;
  }
  ...
  /**
   * refreshNextHeaderCt is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
