...
public class HvProvTinsuff1Redefined extends HvProvTinsuff1RedefinedSerialized {
  ...
  /**
   * set variable hvProvTin1 Corresponding COBOL Variable is HV-PROV-TIN1
   *
   * @param value
   */
  ...
  /**
   * Update HvProvTin1 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvProvTin1 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvProvTin1(
  ...
  /**
   * Update HvProvTin1 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvProvTin1 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvProvTin1(
