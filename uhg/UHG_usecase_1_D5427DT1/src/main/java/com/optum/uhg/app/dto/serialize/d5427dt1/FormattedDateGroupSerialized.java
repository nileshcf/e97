...
/**
 * The class FormattedDateGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FormattedDateGroupSerialized extends Field {
  ...
  public boolean isFormattedDateModified() {
    ...
    localFormattedDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFormattedDate is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFormattedDate() {
    return (substring(
        getStringValue(), beginFormattedDate, beginFormattedDate + FORMATTED_DATE_LEN));
  }
}
