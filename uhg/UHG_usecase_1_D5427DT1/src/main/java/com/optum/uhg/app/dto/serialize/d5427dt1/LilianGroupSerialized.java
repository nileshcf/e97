...
/**
 * The class LilianGroupSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class LilianGroupSerialized extends Field {
  ...
  public boolean isLilianModified() {
    ...
    localLilianCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeLilian(int lilian) {
    replaceValue( //  save the value as string
        getBinaryString(lilian, LILIAN_LEN), beginLilian, LILIAN_LEN);
  ...
  /**
   * refreshLilian is used to refresh the latest value of a variable from the Serialized String the
