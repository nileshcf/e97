...
public class OPicstr extends OPicstrSerialized {
  ...
  /**
   * Update OPicstrLength with the passed value Corresponding COBOL Variable is O-PICSTR-LENGTH
   *
   * @param number
   */
  ...
  public void setOPicstrLength(int number) {
    number =
        checkOPicstrLengthMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable oPicstrString Corresponding COBOL Variable is O-PICSTR-STRING
   *
   * @param value
   */
  ...
  /**
   * Update OPicstrString with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update OPicstrString with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setOPicstrString(
  ...
  /**
   * Update OPicstrString with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update OPicstrString with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setOPicstrString(
