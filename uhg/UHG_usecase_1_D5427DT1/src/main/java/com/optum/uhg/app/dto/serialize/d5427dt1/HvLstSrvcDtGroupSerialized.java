...
/**
 * The class HvLstSrvcDtGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvLstSrvcDtGroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvLstSrvcDtGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvLstSrvcDtModified() {
    ...
    localHvLstSrvcDtCounter = sharedCounter;
    return hasModified;
  }
