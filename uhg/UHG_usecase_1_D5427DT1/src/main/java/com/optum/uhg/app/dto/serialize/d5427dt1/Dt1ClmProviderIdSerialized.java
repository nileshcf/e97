...
/**
 * The class Dt1ClmProviderIdSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1ClmProviderIdSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1ClmProviderIdSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDt1ClmProviderPrefixModified() {
    ...
    localDt1ClmProviderPrefixCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeDt1ClmProviderPrefix(char[] value) {
    ...
    replaceValue(padNumber(1, value, false /*isSigned?*/), beginDt1ClmProviderPrefix, 1);
    localDt1ClmProviderPrefixCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1ClmProviderPrefix;
  }
  ...
  /**
   * refreshDt1ClmProviderPrefix is used to refresh the latest value of a variable from the
  ...
  public int refreshDt1ClmProviderPrefix() throws CFException {
    try {
      ...
      throw getSoc7ABend(
          "dt1ClmProviderPrefix", beginDt1ClmProviderPrefix, DT_1_CLM_PROVIDER_PREFIX_LEN);
    }
  }
  ...
  public boolean isDt1ClmProviderTinModified() {
    ...
    localDt1ClmProviderTinCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDt1ClmProviderTin(char[] value) {
    ...
    dt1ClmProviderTin =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(9, value, false /*isSigned?*/), beginDt1ClmProviderTin, 9);
    localDt1ClmProviderTinCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1ClmProviderTin;
  }
  ...
  /**
   * refreshDt1ClmProviderTin is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isDt1ClmProviderSuffixModified() {
    ...
    localDt1ClmProviderSuffixCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDt1ClmProviderSuffix(char[] value) {
    ...
    dt1ClmProviderSuffix =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(5, value, false /*isSigned?*/), beginDt1ClmProviderSuffix, 5);
    localDt1ClmProviderSuffixCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1ClmProviderSuffix;
  }
  ...
  /**
   * refreshDt1ClmProviderSuffix is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public long refreshDt1ClmProviderSuffix() throws CFException {
    try {
      ...
      throw getSoc7ABend(
          "dt1ClmProviderSuffix", beginDt1ClmProviderSuffix, DT_1_CLM_PROVIDER_SUFFIX_LEN);
    }
  }
}
