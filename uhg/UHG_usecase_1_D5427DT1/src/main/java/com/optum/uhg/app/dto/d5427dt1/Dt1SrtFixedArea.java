...
public class Dt1SrtFixedArea extends Dt1SrtFixedAreaSerialized {
  ...
  /**
   * Update Dt1SrtItemCnt with the passed value Corresponding COBOL Variable is DT1-SRT-ITEM-CNT
   *
   * @param number
   */
  ...
  /**
   * initializes Dt1SrtFixedArea String fields defaults to Spaces short/int/long defaults to zero
