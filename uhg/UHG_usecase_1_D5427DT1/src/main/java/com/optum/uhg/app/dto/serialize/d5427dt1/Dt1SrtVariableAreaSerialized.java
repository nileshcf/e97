...
/**
 * The class Dt1SrtVariableAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1SrtVariableAreaSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1SrtVariableAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
