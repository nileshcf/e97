...
public class StsDsmSqlErrorMsgArea extends StsDsmSqlErrorMsgAreaSerialized {
  ...
  /**
   * set variable stsDsmErrTblName Corresponding COBOL Variable is STS-DSM-ERR-TBL-NAME
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTblName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTblName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrTblName(
  ...
  /**
   * Update StsDsmErrTblName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTblName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrTblName(
  ...
  /**
   * set variable stsDsmErrSectnName Corresponding COBOL Variable is STS-DSM-ERR-SECTN-NAME
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrSectnName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrSectnName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrSectnName(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmErrSectnName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrSectnName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrSectnName(
  ...
  /**
   * set variable stsDsmErrPgmName Corresponding COBOL Variable is STS-DSM-ERR-PGM-NAME
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrPgmName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrPgmName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrPgmName(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmErrPgmName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrPgmName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrPgmName(
  ...
  /**
   * set variable stsDsmErrClngPgmName Corresponding COBOL Variable is STS-DSM-ERR-CLNG-PGM-NAME
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrClngPgmName with a char[] from an offset and length
   *
   * @param value
   */
  public void setStsDsmErrClngPgmName(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginStsDsmErrClngPgmName, stsDsmErrClngPgmName.length);
  }
  ...
  /**
   * Update StsDsmErrClngPgmName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrClngPgmName(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmErrClngPgmName with another Field from an offset and length
   *
   * @param value
   */
  public void setStsDsmErrClngPgmName(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginStsDsmErrClngPgmName, STS_DSM_ERR_CLNG_PGM_NAME_LEN);
  }

  /**
   * Update StsDsmErrClngPgmName with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable stsDsmErrTblAction Corresponding COBOL Variable is STS-DSM-ERR-TBL-ACTION
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTblAction with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTblAction with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrTblAction(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmErrTblAction with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTblAction with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrTblAction(
  ...
  /**
   * set variable stsDsmErrTxt Corresponding COBOL Variable is STS-DSM-ERR-TXT
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTxt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTxt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrTxt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmErrTxt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmErrTxt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmErrTxt(
  ...
  /**
   * initializes StsDsmSqlErrorMsgArea String fields defaults to Spaces short/int/long defaults to
