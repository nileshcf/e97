...
/**
 * The class HvSpiCtgyCd3GroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvSpiCtgyCd3GroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvSpiCtgyCd3GroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvSpiCtgyCd3Modified() {
    ...
    localHvSpiCtgyCd3Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvSpiCtgyCd3 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvSpiCtgyCd3() {
    return (substring(
        getStringValue(), beginHvSpiCtgyCd3, beginHvSpiCtgyCd3 + HV_SPI_CTGY_CD_3_LEN));
  }
}
