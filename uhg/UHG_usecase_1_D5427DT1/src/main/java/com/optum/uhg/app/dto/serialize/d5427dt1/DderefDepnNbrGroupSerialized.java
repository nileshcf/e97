...
/**
 * The class DderefDepnNbrGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DderefDepnNbrGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefDepnNbrGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDderefDepnNbrModified() {
    ...
    localDderefDepnNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDderefDepnNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDderefDepnNbr() {
    return (substring(
        getStringValue(), beginDderefDepnNbr, beginDderefDepnNbr + DDEREF_DEPN_NBR_LEN));
  }
}
