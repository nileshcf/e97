...
/**
 * The class DderefProcDtGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DderefProcDtGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefProcDtGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDderefProcDtModified() {
    ...
    localDderefProcDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDderefProcDt is used to refresh the latest value of a variable from the Serialized
