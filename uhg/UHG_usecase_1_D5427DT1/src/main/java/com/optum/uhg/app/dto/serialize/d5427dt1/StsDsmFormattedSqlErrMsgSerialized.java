...
/**
 * The class StsDsmFormattedSqlErrMsgSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class StsDsmFormattedSqlErrMsgSerialized extends Field {
  ...
  /**
   * sets parent for this StsDsmFormattedSqlErrMsgSerialized to the parent and set the serialize
