...
public class Dt1RequestArea extends Dt1RequestAreaSerialized {
  ...
  /**
   * set variable dt1ReqViewName Corresponding COBOL Variable is DT1-REQ-VIEW-NAME
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqViewName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqViewName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqViewName(
  ...
  /**
   * Update Dt1ReqViewName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqViewName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqViewName(
  ...
  /**
   * set variable dt1ReqViewVersionNbr Corresponding COBOL Variable is DT1-REQ-VIEW-VERSION-NBR
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqViewVersionNbr with a char[] from an offset and length
   *
   * @param value
   */
  public void setDt1ReqViewVersionNbr(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginDt1ReqViewVersionNbr, dt1ReqViewVersionNbr.length);
  }
  ...
  /**
   * Update Dt1ReqViewVersionNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqViewVersionNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqViewVersionNbr with another Field from an offset and length
   *
   * @param value
   */
  public void setDt1ReqViewVersionNbr(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDt1ReqViewVersionNbr, DT_1_REQ_VIEW_VERSION_NBR_LEN);
  }

  /**
   * Update Dt1ReqViewVersionNbr with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable dt1ReqSearchType Corresponding COBOL Variable is DT1-REQ-SEARCH-TYPE
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSearchType with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSearchType with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqSearchType(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqSearchType with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSearchType with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqSearchType(
  ...
  public boolean isDt1ReqValidRequest() throws CFException {
    return (compareChars(getDt1ReqSearchType(), dt1ReqValidRequest88Value1) == 0
        || compareChars(getDt1ReqSearchType(), dt1ReqValidRequest88Value2) == 0
        || compareChars(getDt1ReqSearchType(), dt1ReqValidRequest88Value3) == 0
        || compareChars(getDt1ReqSearchType(), dt1ReqValidRequest88Value4) == 0
        || compareChars(getDt1ReqSearchType(), dt1ReqValidRequest88Value5) == 0);
  }
  ...
  /**
   * set variable dt1ReqEmpid Corresponding COBOL Variable is DT1-REQ-EMPID
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqEmpid with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqEmpid with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqEmpid(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqEmpid with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqEmpid with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqEmpid(
  ...
  /**
   * set variable dt1ReqPolicy Corresponding COBOL Variable is DT1-REQ-POLICY
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqPolicy with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqPolicy with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqPolicy(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqPolicy with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqPolicy with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqPolicy(
  ...
  /**
   * Update Dt1ReqDepNbr with the passed value Corresponding COBOL Variable is DT1-REQ-DEP-NBR
   *
   * @param number
   */
  ...
  /**
   * set variable dt1ReqFirstName Corresponding COBOL Variable is DT1-REQ-FIRST-NAME
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFirstName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFirstName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqFirstName(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqFirstName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFirstName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqFirstName(
  ...
  /**
   * set variable dt1ReqRel Corresponding COBOL Variable is DT1-REQ-REL
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRel with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRel with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRel(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqRel with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRel with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRel(
  ...
  /**
   * set variable dt1ReqSystem Corresponding COBOL Variable is DT1-REQ-SYSTEM
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSystem with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSystem with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqSystem(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqSystem with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSystem with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqSystem(
  ...
  /**
   * Update Dt1ReqFilmOffice with the passed value Corresponding COBOL Variable is
   * DT1-REQ-FILM-OFFICE
   *
   * @param number
   */
  ...
  /**
   * Update Dt1ReqFln with the passed value Corresponding COBOL Variable is DT1-REQ-FLN
   *
   * @param number
   */
  ...
  /**
   * set variable dt1ReqIcn Corresponding COBOL Variable is DT1-REQ-ICN
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqIcn with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqIcn with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqIcn(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqIcn with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqIcn with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqIcn(
  ...
  /**
   * Update Dt1ReqFirstServiceDate with the passed value Corresponding COBOL Variable is
   * DT1-REQ-FIRST-SERVICE-DATE
   *
   * @param number
   */
  ...
  /**
   * Update Dt1ReqLastServiceDate with the passed value Corresponding COBOL Variable is
   * DT1-REQ-LAST-SERVICE-DATE
   *
   * @param number
   */
  ...
  /**
   * Update Dt1ReqProviderTin with the passed value Corresponding COBOL Variable is
   * DT1-REQ-PROVIDER-TIN
   *
   * @param number
   */
  ...
  /**
   * set variable dt1ReqFundingResp Corresponding COBOL Variable is DT1-REQ-FUNDING-RESP
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFundingResp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFundingResp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqFundingResp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqFundingResp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFundingResp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqFundingResp(
  ...
  /**
   * set variable dt1ReqAuthNbr Corresponding COBOL Variable is DT1-REQ-AUTH-NBR
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqAuthNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqAuthNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqAuthNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqAuthNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqAuthNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqAuthNbr(
  ...
  /**
   * set variable dt1ReqServiceCategory Corresponding COBOL Variable is DT1-REQ-SERVICE-CATEGORY
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqServiceCategory with a char[] from an offset and length
   *
   * @param value
   */
  public void setDt1ReqServiceCategory(char[] source, int sourceIndex) {
    replace(
        ...
        dt1ReqServiceCategory.length);
  }

  public void setDt1ReqServiceCategory(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDt1ReqServiceCategory, dt1ReqServiceCategory.length);
  }

  /**
   * Update Dt1ReqServiceCategory with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqServiceCategory(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqServiceCategory with another Field from an offset and length
   *
   * @param value
   */
  public void setDt1ReqServiceCategory(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDt1ReqServiceCategory, DT_1_REQ_SERVICE_CATEGORY_LEN);
  }

  /**
   * Update Dt1ReqServiceCategory with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Returns the value of dt1ReqSpiCategoryCd Corresponding COBOL Variable is
   * DT1-REQ-SPI-CATEGORY-CD
   *
  ...
  public char[] getDt1ReqSpiCategoryCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "dt1ReqSpiCategoryCd - Array index exceeded max Size {}, resetting it to max allowed",
          DT_1_REQ_SPI_CATEGORY_CD_SIZE);
    }
    return getCharArray(
  ...
  /**
   * Update Dt1ReqSpiCategoryCd with the passed value at a given index Corresponding COBOL Variable
   * is DT1-REQ-SPI-CATEGORY-CD
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update Dt1ReqSpiCategoryCd with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setDt1ReqSpiCategoryCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setDt1ReqSpiCategoryCd(int,String,boolean), reset it to 0",
          index);
      index = 0;
    }
  ...
  /**
   * set variable dt1ReqNextKey Corresponding COBOL Variable is DT1-REQ-NEXT-KEY
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqNextKey with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqNextKey with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqNextKey(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqNextKey with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqNextKey with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqNextKey(
  ...
  /**
   * set variable dt1ReqClmItemsRequested Corresponding COBOL Variable is
   * DT1-REQ-CLM-ITEMS-REQUESTED
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqClmItemsRequested with a char[] from an offset and length
   *
   * @param value
   */
  public void setDt1ReqClmItemsRequested(char[] source, int sourceIndex) {
    replace(
        ...
        dt1ReqClmItemsRequested.length);
  }
  ...
  /**
   * Update Dt1ReqClmItemsRequested with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqClmItemsRequested(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setDt1ReqClmItemsRequested(Field source) {
    replace(
        source, 0, source.length(), beginDt1ReqClmItemsRequested, DT_1_REQ_CLM_ITEMS_REQUESTED_LEN);
  }

  /**
   * Update Dt1ReqClmItemsRequested with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqClmItemsRequested with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable dt1ReqCptFrom Corresponding COBOL Variable is DT1-REQ-CPT-FROM
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCptFrom with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCptFrom with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqCptFrom(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqCptFrom with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCptFrom with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqCptFrom(
  ...
  /**
   * set variable dt1ReqCptThru Corresponding COBOL Variable is DT1-REQ-CPT-THRU
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCptThru with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCptThru with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqCptThru(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqCptThru with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCptThru with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqCptThru(
  ...
  /**
   * set variable dt1ReqRevFrom Corresponding COBOL Variable is DT1-REQ-REV-FROM
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRevFrom with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRevFrom with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRevFrom(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqRevFrom with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRevFrom with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRevFrom(
  ...
  /**
   * set variable dt1ReqRevThru Corresponding COBOL Variable is DT1-REQ-REV-THRU
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRevThru with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRevThru with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRevThru(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqRevThru with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRevThru with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRevThru(
  ...
  /**
   * set variable dt1ReqRemarkCd Corresponding COBOL Variable is DT1-REQ-REMARK-CD
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRemarkCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRemarkCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRemarkCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqRemarkCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqRemarkCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqRemarkCd(
  ...
  /**
   * set variable dt1ReqProvSpclCd Corresponding COBOL Variable is DT1-REQ-PROV-SPCL-CD
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqProvSpclCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqProvSpclCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqProvSpclCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqProvSpclCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqProvSpclCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqProvSpclCd(
  ...
  /**
   * set variable dt1ReqCauseCd Corresponding COBOL Variable is DT1-REQ-CAUSE-CD
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCauseCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCauseCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqCauseCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqCauseCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqCauseCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqCauseCd(
  ...
  /**
   * set variable dt1ReqAppliedToOopInd Corresponding COBOL Variable is DT1-REQ-APPLIED-TO-OOP-IND
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqAppliedToOopInd with a char[] from an offset and length
   *
   * @param value
   */
  public void setDt1ReqAppliedToOopInd(char[] source, int sourceIndex) {
    replace(
        ...
        dt1ReqAppliedToOopInd.length);
  }

  public void setDt1ReqAppliedToOopInd(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDt1ReqAppliedToOopInd, dt1ReqAppliedToOopInd.length);
  }

  /**
   * Update Dt1ReqAppliedToOopInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqAppliedToOopInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setDt1ReqAppliedToOopInd(Field source) {
    replace(
        source, 0, source.length(), beginDt1ReqAppliedToOopInd, DT_1_REQ_APPLIED_TO_OOP_IND_LEN);
  }

  /**
   * Update Dt1ReqAppliedToOopInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqAppliedToOopInd with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable dt1ReqFillerArea Corresponding COBOL Variable is DT1-REQ-FILLER-AREA
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFillerArea with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFillerArea with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqFillerArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ReqFillerArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ReqFillerArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ReqFillerArea(
