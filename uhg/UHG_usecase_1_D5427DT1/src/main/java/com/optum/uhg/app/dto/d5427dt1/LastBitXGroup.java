...
public class LastBitXGroup extends LastBitXGroupSerialized {
  ...
  /**
   * set variable lastBitX Corresponding COBOL Variable is WS-LAST-BIT-X
   *
   * @param value
   */
  ...
  /**
   * Update LastBitX with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LastBitX with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLastBitX(
  ...
  /**
   * Update LastBitX with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LastBitX with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLastBitX(
  ...
  /**
   * Update LastBit9 with the passed value Corresponding COBOL Variable is WS-LAST-BIT-9
   *
   * @param number
   */
