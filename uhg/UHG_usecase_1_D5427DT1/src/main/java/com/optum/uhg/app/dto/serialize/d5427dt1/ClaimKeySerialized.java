...
/**
 * The class ClaimKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class ClaimKeySerialized extends Field {
  ...
  public boolean isClaimKeyFlnModified() {
    ...
    localClaimKeyFlnCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isClaimKeyIcnModified() {
    ...
    localClaimKeyIcnCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isClaimKeySuffixCdModified() {
    ...
    localClaimKeySuffixCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeClaimKeySuffixCd(char[] claimKeySuffixCd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        claimKeySuffixCd, 0, getStringValue(), beginClaimKeySuffixCd, CLAIM_KEY_SUFFIX_CD_LEN);
  ...
  /**
   * refreshClaimKeySuffixCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshClaimKeySuffixCd() {
    return (substring(
        getStringValue(), beginClaimKeySuffixCd, beginClaimKeySuffixCd + CLAIM_KEY_SUFFIX_CD_LEN));
  }
  ...
  public boolean isClaimKeyProviderNoModified() {
    ...
    localClaimKeyProviderNoCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeClaimKeyProviderNo(char[] claimKeyProviderNo) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginClaimKeyProviderNo,
        CLAIM_KEY_PROVIDER_NO_LEN);
  ...
  /**
   * refreshClaimKeyProviderNo is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshClaimKeyProviderNo() {
    return (substring(
        getStringValue(),
        beginClaimKeyProviderNo,
        beginClaimKeyProviderNo + CLAIM_KEY_PROVIDER_NO_LEN));
  }
  ...
  public boolean isClaimKeyDraftNoModified() {
    ...
    localClaimKeyDraftNoCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshClaimKeyDraftNo is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshClaimKeyDraftNo() {
    return (substring(
        getStringValue(), beginClaimKeyDraftNo, beginClaimKeyDraftNo + CLAIM_KEY_DRAFT_NO_LEN));
  }
  ...
  public boolean isClaimKeyHeaderCtModified() {
    ...
    localClaimKeyHeaderCtCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeClaimKeyHeaderCt(char[] claimKeyHeaderCt) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        claimKeyHeaderCt, 0, getStringValue(), beginClaimKeyHeaderCt, CLAIM_KEY_HEADER_CT_LEN);
  ...
  /**
   * refreshClaimKeyHeaderCt is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshClaimKeyHeaderCt() {
    return (substring(
        getStringValue(), beginClaimKeyHeaderCt, beginClaimKeyHeaderCt + CLAIM_KEY_HEADER_CT_LEN));
  }
}
