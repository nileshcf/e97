...
/**
 * The class Dt1ClmFixedAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Dt1ClmFixedAreaSerialized extends Field {
  ...
  /**
   * sets parent for this Dt1ClmFixedAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDt1ClmClmContainerItemCntModified() {
    ...
    localDt1ClmClmContainerItemCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDt1ClmClmContainerItemCnt(char[] value) {
    ...
    replaceValue(padNumber(8, value, false /*isSigned?*/), beginDt1ClmClmContainerItemCnt, 8);
    localDt1ClmClmContainerItemCntCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1ClmClmContainerItemCnt;
  }
  ...
  /**
   * refreshDt1ClmClmContainerItemCnt is used to refresh the latest value of a variable from the
  ...
  public boolean isDt1ClmClmContainerItemLenModified() {
    ...
    localDt1ClmClmContainerItemLenCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeDt1ClmClmContainerItemLen(char[] value) {
    ...
    dt1ClmClmContainerItemLen =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(8, value, false /*isSigned?*/), beginDt1ClmClmContainerItemLen, 8);
    localDt1ClmClmContainerItemLenCounter = shareString.getSerializedField().getModifiedCounter();
    return dt1ClmClmContainerItemLen;
  }
  ...
  /**
   * refreshDt1ClmClmContainerItemLen is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
