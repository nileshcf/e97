...
/**
 * The class IPicstrSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class IPicstrSerialized extends Field {
  ...
  public boolean isIPicstrLengthModified() {
    ...
    localIPicstrLengthCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIPicstrLength is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isIPicstrStringModified() {
    ...
    localIPicstrStringCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIPicstrString is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshIPicstrString() {
    return (substring(
        getStringValue(), beginIPicstrString, beginIPicstrString + I_PICSTR_STRING_LEN));
  }
}
