...
/**
 * The class DderefLnIdGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DderefLnIdGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefLnIdGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDderefLnIdModified() {
    ...
    localDderefLnIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDderefLnId(short dderefLnId) {
    replaceValue( //  save the value as string
        getBinaryString(dderefLnId, DDEREF_LN_ID_LEN), beginDderefLnId, DDEREF_LN_ID_LEN);
