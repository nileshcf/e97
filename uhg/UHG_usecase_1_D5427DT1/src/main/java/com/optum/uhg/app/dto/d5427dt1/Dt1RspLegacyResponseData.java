...
public class Dt1RspLegacyResponseData extends Dt1RspLegacyResponseDataSerialized {
  ...
  /**
   * Update Dt1RspReturnCode with the passed value Corresponding COBOL Variable is
   * DT1-RSP-RETURN-CODE
   *
   * @param number
   */
  ...
  /**
   * Update Dt1RspExplanationCode with the passed value Corresponding COBOL Variable is
   * DT1-RSP-EXPLANATION-CODE
   *
   * @param number
   */
  ...
  public void setDt1RspExplanationCode(long number) {
    number =
        checkDt1RspExplanationCodeMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update Dt1RspRespCode with the passed value Corresponding COBOL Variable is DT1-RSP-RESP-CODE
   *
   * @param number
   */
  ...
  /**
   * Update Dt1RspSqlCode with the passed value Corresponding COBOL Variable is DT1-RSP-SQL-CODE
   *
   * @param number
   */
  ...
  /**
   * set variable dt1RspErrSection Corresponding COBOL Variable is DT1-RSP-ERR-SECTION
   *
   * @param value
   */
  ...
  /**
   * Update Dt1RspErrSection with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1RspErrSection with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1RspErrSection(
  ...
  /**
   * Update Dt1RspErrSection with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1RspErrSection with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1RspErrSection(
  ...
  /**
   * initializes Dt1RspLegacyResponseData String fields defaults to Spaces short/int/long defaults
