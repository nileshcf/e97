...
/**
 * The class FcSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class FcSerialized extends Field {
  ...
  /**
   * sets parent for this FcSerialized to the parent and set the serialize offset to parameter begin
   *
   * @param parent
  ...
  public boolean isConditionTokenValueModified() {
    ...
    localConditionTokenValueCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeConditionTokenValue(char[] conditionTokenValue) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginConditionTokenValue,
        CONDITION_TOKEN_VALUE_LEN);
  ...
  /**
   * refreshConditionTokenValue is used to refresh the latest value of a variable from the
  ...
  public char[] refreshConditionTokenValue() {
    return (substring(
        getStringValue(),
        beginConditionTokenValue,
        beginConditionTokenValue + CONDITION_TOKEN_VALUE_LEN));
  }
}
