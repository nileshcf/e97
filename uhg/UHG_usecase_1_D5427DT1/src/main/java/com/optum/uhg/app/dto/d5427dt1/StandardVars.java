...
public class StandardVars extends StandardVarsSerialized {
  ...
  /**
   * set variable thisViewName Corresponding COBOL Variable is THIS-VIEW-NAME
   *
   * @param value
   */
  ...
  /**
   * Update ThisViewName with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ThisViewName with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ThisViewName with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update ThisViewName with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setThisViewName(
  ...
  /**
   * set variable db2Paragraph Corresponding COBOL Variable is DB2-PARAGRAPH
   *
   * @param value
   */
  ...
  /**
   * Update Db2Paragraph with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2Paragraph with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2Paragraph(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Db2Paragraph with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2Paragraph with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2Paragraph(
  ...
  /**
   * set variable db2Resource Corresponding COBOL Variable is DB2-RESOURCE
   *
   * @param value
   */
  ...
  /**
   * Update Db2Resource with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2Resource with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2Resource(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Db2Resource with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2Resource with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2Resource(
  ...
  /**
   * set variable db2Action Corresponding COBOL Variable is DB2-ACTION
   *
   * @param value
   */
  ...
  /**
   * Update Db2Action with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2Action with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2Action(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Db2Action with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2Action with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2Action(
  ...
  /**
   * set variable dsntiar01 Corresponding COBOL Variable is DSNTIAR
   *
   * @param value
   */
  ...
  /**
   * Update Dsntiar01 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dsntiar01 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsntiar01(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dsntiar01 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dsntiar01 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsntiar01(
  ...
  /**
   * set variable callingApplication Corresponding COBOL Variable is CALLING-APPLICATION
   *
   * @param value
   */
  ...
  /**
   * Update CallingApplication with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CallingApplication with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCallingApplication(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update CallingApplication with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CallingApplication with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCallingApplication(
  ...
  /**
   * Update IDx with the passed value Corresponding COBOL Variable is I-DX
   *
   * @param number
   */
  ...
  /**
   * set variable vp776a0001 Corresponding COBOL Variable is VP776A00
   *
   * @param value
   */
  ...
  /**
   * Update Vp776a0001 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Vp776a0001 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setVp776a0001(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Vp776a0001 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Vp776a0001 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setVp776a0001(
  ...
  /**
   * Update CurrentVariables with the passed value Corresponding COBOL Variable is CURRENT-VARIABLES
   *
   * @param value
   */
  ...
  /**
   * Update CurrentVariables with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentVariables with a String from an offset and length to an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentVariables with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CurrentVariables with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCurrentVariables(
  ...
  /**
   * Update AsnVariables with the passed value Corresponding COBOL Variable is ASN-VARIABLES
   *
   * @param value
   */
  ...
  /**
   * Update AsnVariables with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnVariables with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnVariables(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update AsnVariables with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update AsnVariables with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setAsnVariables(
  ...
  /**
   * Update SysVariables with the passed value Corresponding COBOL Variable is SYS-VARIABLES
   *
   * @param value
   */
  ...
  /**
   * Update SysVariables with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysVariables with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysVariables(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SysVariables with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysVariables with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysVariables(
  ...
  /**
   * set variable ceefrst Corresponding COBOL Variable is CEEFRST
   *
   * @param value
   */
  ...
  /**
   * Update Ceefrst with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Ceefrst with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCeefrst(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Ceefrst with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Ceefrst with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCeefrst(
  ...
  /**
   * Update StorageAllocVars with the passed value Corresponding COBOL Variable is
   * STORAGE-ALLOC-VARS
   *
   * @param value
   */
  ...
  /**
   * Update StorageAllocVars with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StorageAllocVars with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStorageAllocVars(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StorageAllocVars with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StorageAllocVars with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStorageAllocVars(
  ...
  /**
   * Update Fc with the passed value Corresponding COBOL Variable is FC
   *
   * @param value
   */
  ...
  /**
   * Update Fc with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Fc with a String from an offset and length to an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Fc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Fc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
