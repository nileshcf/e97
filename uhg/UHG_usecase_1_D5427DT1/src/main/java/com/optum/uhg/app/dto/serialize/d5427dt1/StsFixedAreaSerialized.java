...
/**
 * The class StsFixedAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class StsFixedAreaSerialized extends Field {
  ...
  /**
   * sets parent for this StsFixedAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isStsRespProgramNameModified() {
    ...
    localStsRespProgramNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeStsRespProgramName(char[] stsRespProgramName) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginStsRespProgramName,
        STS_RESP_PROGRAM_NAME_LEN);
  ...
  /**
   * refreshStsRespProgramName is used to refresh the latest value of a variable from the Serialized
  ...
  public char[] refreshStsRespProgramName() {
    return (substring(
        getStringValue(),
        beginStsRespProgramName,
        beginStsRespProgramName + STS_RESP_PROGRAM_NAME_LEN));
  }
  ...
  public boolean isStsRespCodeModified() {
    ...
    localStsRespCodeCounter = sharedCounter;
    return hasModified;
  }
