...
public class HvExtrNtfyNbrGroup extends HvExtrNtfyNbrGroupSerialized {
  ...
  /**
   * set variable hvExtrNtfyNbr Corresponding COBOL Variable is HV-EXTR-NTFY-NBR
   *
   * @param value
   */
  ...
  /**
   * Update HvExtrNtfyNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvExtrNtfyNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvExtrNtfyNbr(
  ...
  /**
   * Update HvExtrNtfyNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvExtrNtfyNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvExtrNtfyNbr(
