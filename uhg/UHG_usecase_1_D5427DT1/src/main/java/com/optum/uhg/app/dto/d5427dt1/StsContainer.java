...
public class StsContainer extends StsContainerSerialized {
  ...
  /**
   * Update StsFixedArea with the passed value Corresponding COBOL Variable is STS-FIXED-AREA
   *
   * @param value
   */
  ...
  /**
   * Update StsFixedArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsFixedArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsFixedArea(
  ...
  /**
   * Update StsFixedArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsFixedArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsFixedArea(
