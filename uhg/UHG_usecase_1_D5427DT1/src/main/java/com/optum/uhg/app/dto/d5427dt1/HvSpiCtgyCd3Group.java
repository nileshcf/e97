...
public class HvSpiCtgyCd3Group extends HvSpiCtgyCd3GroupSerialized {
  ...
  /**
   * set variable hvSpiCtgyCd3 Corresponding COBOL Variable is HV-SPI-CTGY-CD-3
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd3 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd3 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd3(
  ...
  /**
   * Update HvSpiCtgyCd3 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvSpiCtgyCd3 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvSpiCtgyCd3(
