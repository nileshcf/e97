...
/**
 * The class HvSpiCtgyCd4GroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvSpiCtgyCd4GroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvSpiCtgyCd4GroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvSpiCtgyCd4Modified() {
    ...
    localHvSpiCtgyCd4Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshHvSpiCtgyCd4 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshHvSpiCtgyCd4() {
    return (substring(
        getStringValue(), beginHvSpiCtgyCd4, beginHvSpiCtgyCd4 + HV_SPI_CTGY_CD_4_LEN));
  }
}
