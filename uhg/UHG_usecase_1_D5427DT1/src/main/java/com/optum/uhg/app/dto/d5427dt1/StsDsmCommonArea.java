...
public class StsDsmCommonArea extends StsDsmCommonAreaSerialized {
  ...
  /**
   * Update StsDsmFuncCd with the passed value Corresponding COBOL Variable is STS-DSM-FUNC-CD
   *
   * @param number
   */
  ...
  /**
   * Update StsDsmReturnCode with the passed value Corresponding COBOL Variable is
   * STS-DSM-RETURN-CODE
   *
   * @param number
   */
  ...
  /**
   * Update StsDsmSqlErrorMsgArea with the passed value Corresponding COBOL Variable is
   * STS-DSM-SQL-ERROR-MSG-AREA
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmSqlErrorMsgArea with a String from an offset and length
   *
   * @param value
   */
  public void setStsDsmSqlErrorMsgArea(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        stsDsmSqlErrorMsgArea.begin,
        stsDsmSqlErrorMsgArea.length());
  }

  /**
   * Update StsDsmSqlErrorMsgArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmSqlErrorMsgArea(
  ...
  public void setStsDsmSqlErrorMsgArea(Field source) {
    replace(
        source, 0, source.length(), stsDsmSqlErrorMsgArea.begin, stsDsmSqlErrorMsgArea.length());
  }

  /**
   * Update StsDsmSqlErrorMsgArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmSqlErrorMsgArea with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable stsDsmSqlErrorMessage Corresponding COBOL Variable is STS-DSM-SQL-ERROR-MESSAGE
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmSqlErrorMessage with a char[] from an offset and length
   *
   * @param value
   */
  public void setStsDsmSqlErrorMessage(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginStsDsmSqlErrorMessage,
        stsDsmSqlErrorMessage.length);
  }

  public void setStsDsmSqlErrorMessage(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginStsDsmSqlErrorMessage, stsDsmSqlErrorMessage.length);
  }

  /**
   * Update StsDsmSqlErrorMessage with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmSqlErrorMessage(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update StsDsmSqlErrorMessage with another Field from an offset and length
   *
   * @param value
   */
  public void setStsDsmSqlErrorMessage(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginStsDsmSqlErrorMessage, STS_DSM_SQL_ERROR_MESSAGE_LEN);
  }

  /**
   * Update StsDsmSqlErrorMessage with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmFormattedSqlErrMsg with the passed value Corresponding COBOL Variable is
   * STS-DSM-FORMATTED-SQL-ERR-MSG
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmFormattedSqlErrMsg with a String from an offset and length
   *
   * @param value
   */
  public void setStsDsmFormattedSqlErrMsg(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        stsDsmFormattedSqlErrMsg.begin,
        stsDsmFormattedSqlErrMsg.length());
  }

  /**
   * Update StsDsmFormattedSqlErrMsg with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setStsDsmFormattedSqlErrMsg(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source, sourceIndex, sourceLen, stsDsmFormattedSqlErrMsg.begin + targetIndex, targetLen);
  }
  ...
  /**
   * Update StsDsmFormattedSqlErrMsg with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update StsDsmFormattedSqlErrMsg with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * initializes StsDsmCommonArea String fields defaults to Spaces short/int/long defaults to zero
