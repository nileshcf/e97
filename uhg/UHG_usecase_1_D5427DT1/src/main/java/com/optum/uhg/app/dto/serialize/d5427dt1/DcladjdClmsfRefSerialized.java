...
/**
 * The class DcladjdClmsfRefSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DcladjdClmsfRefSerialized extends Field {
  ...
  public boolean isDrefInvnCtlNbrModified() {
    ...
    localDrefInvnCtlNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDrefInvnCtlNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDrefInvnCtlNbr() {
    return (substring(
        getStringValue(), beginDrefInvnCtlNbr, beginDrefInvnCtlNbr + DREF_INVN_CTL_NBR_LEN));
  }
  ...
  public boolean isDrefPolNbrModified() {
    ...
    localDrefPolNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDrefEeIdModified() {
    ...
    localDrefEeIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDrefDepnNbrModified() {
    ...
    localDrefDepnNbrCounter = sharedCounter;
    return hasModified;
  }
