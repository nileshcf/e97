...
/**
 * The class SqldaSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqldaSerialized extends Field {
  ...
  public boolean isSqldaidModified() {
    ...
    localSqldaidCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSqldaid is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isSqldabcModified() {
    ...
    localSqldabcCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqldabc(int sqldabc) {
    replaceValue( //  save the value as string
        getBinaryString(sqldabc, SQLDABC_LEN), beginSqldabc, SQLDABC_LEN);
  ...
  /**
   * refreshSqldabc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isSqlnModified() {
    ...
    localSqlnCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqln(short sqln) {
    replaceValue( //  save the value as string
        getBinaryString(sqln, SQLN_LEN), beginSqln, SQLN_LEN);
  ...
  /**
   * refreshSqln is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isSqldModified() {
    ...
    localSqldCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqld(short sqld) {
    replaceValue( //  save the value as string
        getBinaryString(sqld, SQLD_LEN), beginSqld, SQLD_LEN);
  ...
  /**
   * refreshSqld is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
