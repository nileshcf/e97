...
/**
 * The class Dt1SrtArraySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class Dt1SrtArraySerialized extends Field {
  ...
  /**
   * sets parent for this Dt1SrtArraySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
