...
/**
 * The class DderefPgmIdLstCharValGroupSerialized is used to define offsets in order to serialize in
 * a fixed String
 *
...
public class DderefPgmIdLstCharValGroupSerialized extends Field {
  ...
  /**
   * sets parent for this DderefPgmIdLstCharValGroupSerialized to the parent and set the serialize
  ...
  public boolean isDderefPgmIdLstCharValModified() {
    ...
    localDderefPgmIdLstCharValCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDderefPgmIdLstCharVal(char[] dderefPgmIdLstCharVal) {
    ...
    arraycopy(
        dderefPgmIdLstCharVal,
        0,
        getStringValue(),
        beginDderefPgmIdLstCharVal,
        DDEREF_PGM_ID_LST_CHAR_VAL_LEN);
  ...
  /**
   * refreshDderefPgmIdLstCharVal is used to refresh the latest value of a variable from the
  ...
  public char[] refreshDderefPgmIdLstCharVal() {
    return (substring(
        getStringValue(),
        beginDderefPgmIdLstCharVal,
        beginDderefPgmIdLstCharVal + DDEREF_PGM_ID_LST_CHAR_VAL_LEN));
  }
}
