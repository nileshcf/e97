...
public class HvFlnSrlNbrGroup extends HvFlnSrlNbrGroupSerialized {
  ...
  /**
   * set variable hvFlnSrlNbr Corresponding COBOL Variable is HV-FLN-SRL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update HvFlnSrlNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvFlnSrlNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvFlnSrlNbr(
  ...
  /**
   * Update HvFlnSrlNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HvFlnSrlNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHvFlnSrlNbr(
