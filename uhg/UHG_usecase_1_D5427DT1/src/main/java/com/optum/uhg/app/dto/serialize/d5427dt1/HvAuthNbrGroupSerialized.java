...
/**
 * The class HvAuthNbrGroupSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HvAuthNbrGroupSerialized extends Field {
  ...
  /**
   * sets parent for this HvAuthNbrGroupSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHvAuthNbrModified() {
    ...
    localHvAuthNbrCounter = sharedCounter;
    return hasModified;
  }
