...
public class SysJobname extends SysJobnameSerialized {
  ...
  /**
   * set variable sysJobname14 Corresponding COBOL Variable is SYS-JOBNAME-1-4
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname14 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname14 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobname14(
  ...
  /**
   * Update SysJobname14 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname14 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobname14(
  ...
  /**
   * set variable sysJobname5 Corresponding COBOL Variable is SYS-JOBNAME-5
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname5 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname5 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobname5(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SysJobname5 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SysJobname5 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobname5(
  ...
  /**
   * set variable sysJobnameCicsJobname68 Corresponding COBOL Variable is
   * SYS-JOBNAME-CICS-JOBNAME-6-8
   *
   * @param value
   */
  ...
  /**
   * Update SysJobnameCicsJobname68 with a char[] from an offset and length
   *
   * @param value
   */
  public void setSysJobnameCicsJobname68(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginSysJobnameCicsJobname68,
        sysJobnameCicsJobname68.length);
  }
  ...
  /**
   * Update SysJobnameCicsJobname68 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSysJobnameCicsJobname68(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setSysJobnameCicsJobname68(Field source) {
    replace(
        source, 0, source.length(), beginSysJobnameCicsJobname68, SYS_JOBNAME_CICS_JOBNAME_68_LEN);
  }

  /**
   * Update SysJobnameCicsJobname68 with another Field from an offset and length
   *
   * @param value
   */
  public void setSysJobnameCicsJobname68(Field source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceLen,
        beginSysJobnameCicsJobname68,
        SYS_JOBNAME_CICS_JOBNAME_68_LEN);
  }

  /**
   * Update SysJobnameCicsJobname68 with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * initializes SysJobname String fields defaults to Spaces short/int/long defaults to zero
