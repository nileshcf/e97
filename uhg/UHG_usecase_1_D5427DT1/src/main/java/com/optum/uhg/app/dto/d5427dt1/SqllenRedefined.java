...
public class SqllenRedefined extends SqllenRedefinedSerialized {
  ...
  /**
   * set variable sqlscale Corresponding COBOL Variable is SQLSCALE
   *
   * @param value
   */
  ...
  /**
   * Update Sqlscale with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlscale with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlscale(
  ...
  /**
   * Update Sqlscale with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlscale with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlscale(
