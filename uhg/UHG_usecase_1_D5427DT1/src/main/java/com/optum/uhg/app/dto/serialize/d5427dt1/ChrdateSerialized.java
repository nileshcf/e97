...
/**
 * The class ChrdateSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class ChrdateSerialized extends Field {
  ...
  public boolean isChrdateLengthModified() {
    ...
    localChrdateLengthCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeChrdateLength(short chrdateLength) {
    replaceValue( //  save the value as string
        getBinaryString(chrdateLength, CHRDATE_LENGTH_LEN), beginChrdateLength, CHRDATE_LENGTH_LEN);
  ...
  /**
   * refreshChrdateLength is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isChrdateStringModified() {
    ...
    localChrdateStringCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshChrdateString is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshChrdateString() {
    return (substring(
        getStringValue(), beginChrdateString, beginChrdateString + CHRDATE_STRING_LEN));
  }
}
