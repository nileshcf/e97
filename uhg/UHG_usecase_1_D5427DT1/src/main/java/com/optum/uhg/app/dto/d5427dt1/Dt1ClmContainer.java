...
public class Dt1ClmContainer extends Dt1ClmContainerSerialized {
  ...
  /**
   * Update Dt1ClmFixedArea with the passed value Corresponding COBOL Variable is DT1-CLM-FIXED-AREA
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClmFixedArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClmFixedArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ClmFixedArea(
  ...
  /**
   * Update Dt1ClmFixedArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClmFixedArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ClmFixedArea(
  ...
  /**
   * Update Dt1ClmVariableArea with the passed value Corresponding COBOL Variable is
   * DT1-CLM-VARIABLE-AREA
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClmVariableArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClmVariableArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ClmVariableArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Dt1ClmVariableArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Dt1ClmVariableArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDt1ClmVariableArea(
