...
public class IPicstr extends IPicstrSerialized {
  ...
  /**
   * Update IPicstrLength with the passed value Corresponding COBOL Variable is I-PICSTR-LENGTH
   *
   * @param number
   */
  ...
  public void setIPicstrLength(int number) {
    number =
        checkIPicstrLengthMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable iPicstrString Corresponding COBOL Variable is I-PICSTR-STRING
   *
   * @param value
   */
  ...
  /**
   * Update IPicstrString with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update IPicstrString with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setIPicstrString(
  ...
  /**
   * Update IPicstrString with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update IPicstrString with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setIPicstrString(
