...
/**
 * The Callvp77 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Callvp77 callvp77 = (Callvp77) context.getBean("callvp77");
        	    callvp77.process(new GlobalExecutorCtx().getContext(Callvp77Ctx.class)); /*  Callvp77 requires no input parameters  */
