...
public class InputFile extends CFFile {
    ...
    **/
	@Value("${CALLVP77.InputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${CALLVP77.InputFileCRLFflag:no}")
