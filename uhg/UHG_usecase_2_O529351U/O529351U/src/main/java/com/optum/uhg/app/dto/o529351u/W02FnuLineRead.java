...
public class W02FnuLineRead extends W02FnuLineReadSerialized {
  ...
  public W02FnuLineRead() {
    ...
    replaceValue( // serialize and save the value
        (":READ FAILED IN ").toCharArray(), getStartOffset() + 4, 16);
    replaceValue( // serialize and save the value
        (",KEY= ").toCharArray(), getStartOffset() + 28, 6);
  }
  ...
  /**
   * set variable w02FnuTranRd Corresponding COBOL Variable is W02-FNU-TRAN-RD
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranRd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranRd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuTranRd(
  ...
  /**
   * Update W02FnuTranRd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranRd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuTranRd(
  ...
  /**
   * set variable w02FnuFileRd Corresponding COBOL Variable is W02-FNU-FILE-RD
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileRd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileRd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuFileRd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update W02FnuFileRd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileRd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuFileRd(
  ...
  /**
   * set variable w02FnuKeyRd Corresponding COBOL Variable is W02-FNU-KEY-RD
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyRd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyRd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuKeyRd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update W02FnuKeyRd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyRd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuKeyRd(
