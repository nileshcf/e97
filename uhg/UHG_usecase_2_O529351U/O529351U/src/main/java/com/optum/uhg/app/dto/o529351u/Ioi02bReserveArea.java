...
public class Ioi02bReserveArea extends Ioi02bReserveAreaSerialized {
  ...
  /**
   * Update Ioi02bWorkAreaAddr with the passed value Corresponding COBOL Variable is
   * IOI-02B-WORK-AREA-ADDR
   *
   * @param number
   */
  ...
  /**
   * Update Ioi02bWorkAreaPtr with the passed value Corresponding COBOL Variable is
   * IOI-02B-WORK-AREA-PTR
   *
   * @param number
   */
  ...
  /**
   * Update Ioi02bInterfaceAddr with the passed value Corresponding COBOL Variable is
   * IOI-02B-INTERFACE-ADDR
   *
   * @param number
   */
  ...
  /**
   * Update Ioi02bInterfacePtr with the passed value Corresponding COBOL Variable is
   * IOI-02B-INTERFACE-PTR
   *
   * @param number
   */
  ...
  /**
   * Update Ioi02bJournalAddr with the passed value Corresponding COBOL Variable is
   * IOI-02B-JOURNAL-ADDR
   *
   * @param number
   */
  ...
  /**
   * Update Ioi02bJournalPtr with the passed value Corresponding COBOL Variable is
   * IOI-02B-JOURNAL-PTR
   *
   * @param number
   */
