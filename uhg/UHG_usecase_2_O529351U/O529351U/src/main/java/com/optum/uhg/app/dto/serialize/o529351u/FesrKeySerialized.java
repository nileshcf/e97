...
/**
 * The class FesrKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class FesrKeySerialized extends Field {
  ...
  public boolean isFesrSpiNbrModified() {
    ...
    localFesrSpiNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeFesrSpiNbr(char[] value) {
    ...
    replaceValue(padNumber(7, value, true /*isSigned?*/), beginFesrSpiNbr, 7);
    localFesrSpiNbrCounter = shareString.getSerializedField().getModifiedCounter();
    return fesrSpiNbr;
  }
  ...
  public boolean isFesrToPsModified() {
    ...
    localFesrToPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFesrToSvcModified() {
    ...
    localFesrToSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFesrToCauseModified() {
    ...
    localFesrToCauseCounter = sharedCounter;
    return hasModified;
  }
