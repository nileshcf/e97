...
/**
 * The class D51uRetRulCpeFlgSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulCpeFlgSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulCpeFlgSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uCflgDrvPosModified() {
    ...
    localD51uCflgDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uCflgDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCflgDrvPos() {
    return (substring(
        getStringValue(), beginD51uCflgDrvPos, beginD51uCflgDrvPos + D_51U_CFLG_DRV_POS_LEN));
  }
  ...
  public boolean isD51uCflgDrvSvcModified() {
    ...
    localD51uCflgDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uCflgDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCflgDrvSvc() {
    return (substring(
        getStringValue(), beginD51uCflgDrvSvc, beginD51uCflgDrvSvc + D_51U_CFLG_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uCflgDrvCauModified() {
    ...
    localD51uCflgDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uCflgDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCflgDrvCau() {
    return (substring(
        getStringValue(), beginD51uCflgDrvCau, beginD51uCflgDrvCau + D_51U_CFLG_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uCflgCpeDescCdModified() {
    ...
    localD51uCflgCpeDescCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCflgCpeDescCd(char[] d51uCflgCpeDescCd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uCflgCpeDescCd, 0, getStringValue(), beginD51uCflgCpeDescCd, D_51U_CFLG_CPE_DESC_CD_LEN);
  ...
  /**
   * refreshD51uCflgCpeDescCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCflgCpeDescCd() {
    return (substring(
        getStringValue(),
        beginD51uCflgCpeDescCd,
        beginD51uCflgCpeDescCd + D_51U_CFLG_CPE_DESC_CD_LEN));
  }
}
