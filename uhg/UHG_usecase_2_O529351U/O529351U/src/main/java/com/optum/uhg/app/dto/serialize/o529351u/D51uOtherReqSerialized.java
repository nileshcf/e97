...
/**
 * The class D51uOtherReqSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uOtherReqSerialized extends Field {
  ...
  /**
   * sets parent for this D51uOtherReqSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uReqDosDateModified() {
    ...
    localD51uReqDosDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uReqDosDate is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uReqDosDate() {
    return (substring(
        getStringValue(), beginD51uReqDosDate, beginD51uReqDosDate + D_51U_REQ_DOS_DATE_LEN));
  }
}
