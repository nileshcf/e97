...
public class FeServTo extends FeServToSerialized {
  ...
  /**
   * set variable feSvc15To Corresponding COBOL Variable is FE-SVC-1-5-TO
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc15To with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc15To with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc15To(
  ...
  /**
   * Update FeSvc15To with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc15To with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc15To(
