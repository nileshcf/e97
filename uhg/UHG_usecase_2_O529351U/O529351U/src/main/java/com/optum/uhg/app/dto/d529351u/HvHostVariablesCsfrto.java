...
public class HvHostVariablesCsfrto extends HvHostVariablesCsfrtoSerialized {
  ...
  /**
   * Returns the value of hv08SvcDrvPos Corresponding COBOL Variable is HV08-SVC-DRV-POS
   *
  ...
  public char[] getHv08SvcDrvPos(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv08SvcDrvPos - Array index exceeded max Size {}, resetting it to max allowed",
          HV_08_SVC_DRV_POS_SIZE);
    }
    return getCharArray(
        (beginHv08SvcDrvPos + index * HV_08_SVC_DRV_POS_LEN), HV_08_SVC_DRV_POS_LEN);
  }
  ...
  /**
   * Update Hv08SvcDrvPos with the passed value at a given index Corresponding COBOL Variable is
   * HV08-SVC-DRV-POS
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv08SvcDrvPos with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv08SvcDrvPos(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv08SvcDrvPos(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv09SvcDrvSvc Corresponding COBOL Variable is HV09-SVC-DRV-SVC
   *
  ...
  public char[] getHv09SvcDrvSvc(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv09SvcDrvSvc - Array index exceeded max Size {}, resetting it to max allowed",
          HV_09_SVC_DRV_SVC_SIZE);
    }
    return getCharArray(
        (beginHv09SvcDrvSvc + index * HV_09_SVC_DRV_SVC_LEN), HV_09_SVC_DRV_SVC_LEN);
  }
  ...
  /**
   * Update Hv09SvcDrvSvc with the passed value at a given index Corresponding COBOL Variable is
   * HV09-SVC-DRV-SVC
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv09SvcDrvSvc with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv09SvcDrvSvc(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv09SvcDrvSvc(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv10SvcDrvCau Corresponding COBOL Variable is HV10-SVC-DRV-CAU
   *
  ...
  public char[] getHv10SvcDrvCau(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv10SvcDrvCau - Array index exceeded max Size {}, resetting it to max allowed",
          HV_10_SVC_DRV_CAU_SIZE);
    }
    return getCharArray(
        (beginHv10SvcDrvCau + index * HV_10_SVC_DRV_CAU_LEN), HV_10_SVC_DRV_CAU_LEN);
  }
  ...
  /**
   * Update Hv10SvcDrvCau with the passed value at a given index Corresponding COBOL Variable is
   * HV10-SVC-DRV-CAU
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv10SvcDrvCau with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv10SvcDrvCau(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv10SvcDrvCau(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv11ClmFrmSvcCd Corresponding COBOL Variable is HV11-CLM-FRM-SVC-CD
   *
  ...
  public char[] getHv11ClmFrmSvcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv11ClmFrmSvcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_11_CLM_FRM_SVC_CD_SIZE);
    }
    return getCharArray(
        (beginHv11ClmFrmSvcCd + index * HV_11_CLM_FRM_SVC_CD_LEN), HV_11_CLM_FRM_SVC_CD_LEN);
  }
  ...
  /**
   * Update Hv11ClmFrmSvcCd with the passed value at a given index Corresponding COBOL Variable is
   * HV11-CLM-FRM-SVC-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv11ClmFrmSvcCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv11ClmFrmSvcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv11ClmFrmSvcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv12ClmToSvcCd Corresponding COBOL Variable is HV12-CLM-TO-SVC-CD
   *
  ...
  public char[] getHv12ClmToSvcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv12ClmToSvcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_12_CLM_TO_SVC_CD_SIZE);
    }
    return getCharArray(
        (beginHv12ClmToSvcCd + index * HV_12_CLM_TO_SVC_CD_LEN), HV_12_CLM_TO_SVC_CD_LEN);
  }
  ...
  /**
   * Update Hv12ClmToSvcCd with the passed value at a given index Corresponding COBOL Variable is
   * HV12-CLM-TO-SVC-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv12ClmToSvcCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv12ClmToSvcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv12ClmToSvcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv13SvcTypCd Corresponding COBOL Variable is HV13-SVC-TYP-CD
   *
   * @return hv13SvcTypCd
   */
  ...
  public char[] getHv13SvcTypCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv13SvcTypCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_13_SVC_TYP_CD_SIZE);
    }
  ...
  /**
   * Update Hv13SvcTypCd with the passed value at a given index Corresponding COBOL Variable is
   * HV13-SVC-TYP-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv13SvcTypCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv13SvcTypCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv13SvcTypCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
