...
/**
 * The class LinkAreaM51uSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class LinkAreaM51uSerialized extends Field {
  ...
  /**
   * sets parent for this LinkAreaM51uSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isUCcmNOSvcInd51Modified() {
    ...
    localUCcmNOSvcInd51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUCcmNOSvcInd51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUCcmNOSvcInd51() {
    return (substring(
        getStringValue(), beginUCcmNOSvcInd51, beginUCcmNOSvcInd51 + U_CCM_NOSVC_IND_51_LEN));
  }
  ...
  public boolean isUSpiTblId51Modified() {
    ...
    localUSpiTblId51Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isUHcrProcessSw51Modified() {
    ...
    localUHcrProcessSw51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUHcrProcessSw51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUHcrProcessSw51() {
    return (substring(
        getStringValue(), beginUHcrProcessSw51, beginUHcrProcessSw51 + U_HCR_PROCESS_SW_51_LEN));
  }
  ...
  public boolean isUHcrSpiSw51Modified() {
    ...
    localUHcrSpiSw51Counter = sharedCounter;
    return hasModified;
  }
