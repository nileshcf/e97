...
public class UGenericTrnslGroup51 extends UGenericTrnslGroup51Serialized {
  ...
  /**
   * set variable uGenericTrnsl51 Corresponding COBOL Variable is LK-51U-GENERIC-TRNSL
   *
   * @param value
   */
  ...
  /**
   * Update UGenericTrnsl51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UGenericTrnsl51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUGenericTrnsl51(
  ...
  /**
   * Update UGenericTrnsl51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UGenericTrnsl51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUGenericTrnsl51(
