...
/**
 * The class D51uTableCountsSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uTableCountsSerialized extends Field {
  ...
  /**
   * sets parent for this D51uTableCountsSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uPlnvCntModified() {
    ...
    localD51uPlnvCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uPlnvCnt(int d51uPlnvCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uPlnvCnt, D_51U_PLNV_CNT_LEN), beginD51uPlnvCnt, D_51U_PLNV_CNT_LEN);
  ...
  public boolean isD51uSpiCntModified() {
    ...
    localD51uSpiCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uSpiCnt(int d51uSpiCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uSpiCnt, D_51U_SPI_CNT_LEN), beginD51uSpiCnt, D_51U_SPI_CNT_LEN);
  ...
  public boolean isD51uFrtoCntModified() {
    ...
    localD51uFrtoCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uFrtoCnt(int d51uFrtoCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uFrtoCnt, D_51U_FRTO_CNT_LEN), beginD51uFrtoCnt, D_51U_FRTO_CNT_LEN);
  ...
  public boolean isD51uPtypCntModified() {
    ...
    localD51uPtypCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uPtypCnt(int d51uPtypCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uPtypCnt, D_51U_PTYP_CNT_LEN), beginD51uPtypCnt, D_51U_PTYP_CNT_LEN);
  ...
  public boolean isD51uIpaCntModified() {
    ...
    localD51uIpaCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uIpaCnt(int d51uIpaCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uIpaCnt, D_51U_IPA_CNT_LEN), beginD51uIpaCnt, D_51U_IPA_CNT_LEN);
  ...
  public boolean isD51uCausCntModified() {
    ...
    localD51uCausCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausCnt(int d51uCausCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uCausCnt, D_51U_CAUS_CNT_LEN), beginD51uCausCnt, D_51U_CAUS_CNT_LEN);
  ...
  public boolean isD51uFcndCntModified() {
    ...
    localD51uFcndCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uFcndCnt(int d51uFcndCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uFcndCnt, D_51U_FCND_CNT_LEN), beginD51uFcndCnt, D_51U_FCND_CNT_LEN);
  ...
  public boolean isD51uIcdCntModified() {
    ...
    localD51uIcdCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uIcdCnt(int d51uIcdCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uIcdCnt, D_51U_ICD_CNT_LEN), beginD51uIcdCnt, D_51U_ICD_CNT_LEN);
  ...
  public boolean isD51uMoreIcdCntModified() {
    ...
    localD51uMoreIcdCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uMoreIcdCnt is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isD51uCflgCntModified() {
    ...
    localD51uCflgCntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCflgCnt(int d51uCflgCnt) {
    replaceValue( //  save the value as string
        getBinaryString(d51uCflgCnt, D_51U_CFLG_CNT_LEN), beginD51uCflgCnt, D_51U_CFLG_CNT_LEN);
