...
/**
 * The class DrstEditErrorValueTxtSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DrstEditErrorValueTxtSerialized extends Field {
  ...
  /**
   * sets parent for this DrstEditErrorValueTxtSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isDrstEditErrorValueIntModified() {
    ...
    localDrstEditErrorValueIntCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDrstEditErrorValueInt(char[] drstEditErrorValueInt) {
    ...
    arraycopy(
        drstEditErrorValueInt,
        0,
        getStringValue(),
        beginDrstEditErrorValueInt,
        DRST_EDIT_ERROR_VALUE_INT_LEN);
  ...
  /**
   * refreshDrstEditErrorValueInt is used to refresh the latest value of a variable from the
  ...
  public char[] refreshDrstEditErrorValueInt() {
    return (substring(
        getStringValue(),
        beginDrstEditErrorValueInt,
        beginDrstEditErrorValueInt + DRST_EDIT_ERROR_VALUE_INT_LEN));
  }
  ...
  public boolean isDrstEditErrorValueDecModified() {
    ...
    localDrstEditErrorValueDecCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDrstEditErrorValueDec(char[] drstEditErrorValueDec) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        drstEditErrorValueDec,
        0,
        getStringValue(),
        beginDrstEditErrorValueDec,
        DRST_EDIT_ERROR_VALUE_DEC_LEN);
  ...
  /**
   * refreshDrstEditErrorValueDec is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshDrstEditErrorValueDec() {
    return (substring(
        getStringValue(),
        beginDrstEditErrorValueDec,
        beginDrstEditErrorValueDec + DRST_EDIT_ERROR_VALUE_DEC_LEN));
  }
}
