...
/**
 * The class SavFillerSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SavFillerSerialized extends Field {
  ...
  /**
   * sets parent for this SavFillerSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
