...
/**
 * The class XrfEeDataKeySerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class XrfEeDataKeySerialized extends Field {
  ...
  /**
   * sets parent for this XrfEeDataKeySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isXrfMvdEeModified() {
    ...
    localXrfMvdEeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeXrfMvdEe(char[] value) {
    ...
    replaceValue(padNumber(1, value, false /*isSigned?*/), beginXrfMvdEe, 1);
    localXrfMvdEeCounter = shareString.getSerializedField().getModifiedCounter();
    return xrfMvdEe;
  }
  ...
  public boolean isXrfPlcyEeModified() {
    ...
    localXrfPlcyEeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isXrfDivEeModified() {
    ...
    localXrfDivEeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeXrfDivEe(short xrfDivEe) {
    replaceValue( //  save the value as string
        getBinaryString(xrfDivEe, XRF_DIV_EE_LEN), beginXrfDivEe, XRF_DIV_EE_LEN);
  ...
  public boolean isXrfClsEeModified() {
    ...
    localXrfClsEeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeXrfClsEe(short xrfClsEe) {
    replaceValue( //  save the value as string
        getBinaryString(xrfClsEe, XRF_CLS_EE_LEN), beginXrfClsEe, XRF_CLS_EE_LEN);
