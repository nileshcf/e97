...
public class W02FnuLineStartbr extends W02FnuLineStartbrSerialized {
  ...
  public W02FnuLineStartbr() {
    ...
    replaceValue( // serialize and save the value
        (":SRTBR FAILED IN ").toCharArray(), getStartOffset() + 4, 17);
    replaceValue( // serialize and save the value
  ...
  /**
   * set variable w02FnuTranStbr Corresponding COBOL Variable is W02-FNU-TRAN-STBR
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranStbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranStbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuTranStbr(
  ...
  /**
   * Update W02FnuTranStbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranStbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuTranStbr(
  ...
  /**
   * set variable w02FnuFileStbr Corresponding COBOL Variable is W02-FNU-FILE-STBR
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileStbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileStbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuFileStbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update W02FnuFileStbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileStbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuFileStbr(
  ...
  /**
   * set variable w02FnuKeyStbr Corresponding COBOL Variable is W02-FNU-KEY-STBR
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyStbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyStbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuKeyStbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update W02FnuKeyStbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyStbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuKeyStbr(
