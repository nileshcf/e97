...
public class SavProviderInfo extends SavProviderInfoSerialized {
  ...
  /**
   * set variable savHAttendingPhysicianId Corresponding COBOL Variable is
   * SAV-H-ATTENDING-PHYSICIAN-ID
   *
   * @param value
   */
  ...
  /**
   * Update SavHAttendingPhysicianId with a char[] from an offset and length
   *
   * @param value
   */
  public void setSavHAttendingPhysicianId(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginSavHAttendingPhysicianId,
        savHAttendingPhysicianId.length);
  }
  ...
  /**
   * Update SavHAttendingPhysicianId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavHAttendingPhysicianId(
  ...
  public void setSavHAttendingPhysicianId(Field source) {
    replace(
        source, 0, source.length(), beginSavHAttendingPhysicianId, SAV_HATTENDING_PHYSICIAN_ID_LEN);
  }

  /**
   * Update SavHAttendingPhysicianId with another Field from an offset and length
   *
   * @param value
   */
  public void setSavHAttendingPhysicianId(Field source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceLen,
        beginSavHAttendingPhysicianId,
        SAV_HATTENDING_PHYSICIAN_ID_LEN);
  }

  /**
   * Update SavHAttendingPhysicianId with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update SavMAttendingPhysicianId with the passed value Corresponding COBOL Variable is
   * SAV-M-ATTENDING-PHYSICIAN-ID
   *
   * @param value
   */
  ...
  /**
   * Update SavMAttendingPhysicianId with a String from an offset and length
   *
   * @param value
   */
  public void setSavMAttendingPhysicianId(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        savMAttendingPhysicianId.begin,
        savMAttendingPhysicianId.length());
  }

  /**
   * Update SavMAttendingPhysicianId with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavMAttendingPhysicianId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source, sourceIndex, sourceLen, savMAttendingPhysicianId.begin + targetIndex, targetLen);
  }
  ...
  /**
   * Update SavMAttendingPhysicianId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavMAttendingPhysicianId with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
