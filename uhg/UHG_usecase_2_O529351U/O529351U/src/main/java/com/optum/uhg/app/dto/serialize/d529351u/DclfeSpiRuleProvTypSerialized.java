...
/**
 * The class DclfeSpiRuleProvTypSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DclfeSpiRuleProvTypSerialized extends Field {
  ...
  public boolean isPtypSpiTblIdModified() {
    ...
    localPtypSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypSpiTblId() {
    return (substring(
        getStringValue(), beginPtypSpiTblId, beginPtypSpiTblId + PTYP_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isPtypStsCdModified() {
    ...
    localPtypStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPtypProvTypSeqNbrModified() {
    ...
    localPtypProvTypSeqNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypProvTypSeqNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isPtypDerivPlOfSvcCdModified() {
    ...
    localPtypDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializePtypDerivPlOfSvcCd(char[] ptypDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginPtypDerivPlOfSvcCd,
        PTYP_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshPtypDerivPlOfSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginPtypDerivPlOfSvcCd,
        beginPtypDerivPlOfSvcCd + PTYP_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isPtypDerivSvcCdModified() {
    ...
    localPtypDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypDerivSvcCd() {
    return (substring(
        getStringValue(), beginPtypDerivSvcCd, beginPtypDerivSvcCd + PTYP_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isPtypDerivCausCdModified() {
    ...
    localPtypDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypDerivCausCd() {
    return (substring(
        getStringValue(), beginPtypDerivCausCd, beginPtypDerivCausCd + PTYP_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isPtypCreatDttmModified() {
    ...
    localPtypCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypCreatDttm() {
    return (substring(
        getStringValue(), beginPtypCreatDttm, beginPtypCreatDttm + PTYP_CREAT_DTTM_LEN));
  }
  ...
  public boolean isPtypProvTypModified() {
    ...
    localPtypProvTypCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPtypPgmIdModified() {
    ...
    localPtypPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPtypLstUpdtDttmModified() {
    ...
    localPtypLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypLstUpdtDttm() {
    return (substring(
        getStringValue(), beginPtypLstUpdtDttm, beginPtypLstUpdtDttm + PTYP_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isPtypLstUpdtUserIdModified() {
    ...
    localPtypLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializePtypLstUpdtUserId(char[] ptypLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        ptypLstUpdtUserId, 0, getStringValue(), beginPtypLstUpdtUserId, PTYP_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshPtypLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPtypLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginPtypLstUpdtUserId,
        beginPtypLstUpdtUserId + PTYP_LST_UPDT_USER_ID_LEN));
  }
}
