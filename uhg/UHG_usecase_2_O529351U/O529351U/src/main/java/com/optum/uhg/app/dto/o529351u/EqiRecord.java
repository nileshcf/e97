...
public class EqiRecord extends EqiRecordSerialized {
  ...
  /**
   * Update SceRecord with the passed value Corresponding COBOL Variable is SCE-RECORD
   *
   * @param value
   */
  ...
  /**
   * Update SceRecord with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceRecord with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceRecord(
  ...
  /**
   * Update SceRecord with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceRecord with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceRecord(
