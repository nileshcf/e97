...
/**
 * The class DclfeSpiRuleCpeFlgSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DclfeSpiRuleCpeFlgSerialized extends Field {
  ...
  public boolean isCpeflSpiTblIdModified() {
    ...
    localCpeflSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCpeflSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflSpiTblId() {
    return (substring(
        getStringValue(), beginCpeflSpiTblId, beginCpeflSpiTblId + CPEFL_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isCpeflStsCdModified() {
    ...
    localCpeflStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCpeflDerivPlOfSvcCdModified() {
    ...
    localCpeflDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCpeflDerivPlOfSvcCd(char[] cpeflDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginCpeflDerivPlOfSvcCd,
        CPEFL_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshCpeflDerivPlOfSvcCd is used to refresh the latest value of a variable from the
  ...
  public char[] refreshCpeflDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginCpeflDerivPlOfSvcCd,
        beginCpeflDerivPlOfSvcCd + CPEFL_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isCpeflDerivSvcCdModified() {
    ...
    localCpeflDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCpeflDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflDerivSvcCd() {
    return (substring(
        getStringValue(), beginCpeflDerivSvcCd, beginCpeflDerivSvcCd + CPEFL_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isCpeflDerivCausCdModified() {
    ...
    localCpeflDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCpeflDerivCausCd(char[] cpeflDerivCausCd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        cpeflDerivCausCd, 0, getStringValue(), beginCpeflDerivCausCd, CPEFL_DERIV_CAUS_CD_LEN);
  ...
  /**
   * refreshCpeflDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflDerivCausCd() {
    return (substring(
        getStringValue(), beginCpeflDerivCausCd, beginCpeflDerivCausCd + CPEFL_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isCpeflCreatDttmModified() {
    ...
    localCpeflCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCpeflCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflCreatDttm() {
    return (substring(
        getStringValue(), beginCpeflCreatDttm, beginCpeflCreatDttm + CPEFL_CREAT_DTTM_LEN));
  }
  ...
  public boolean isCpeflCpeDescCdModified() {
    ...
    localCpeflCpeDescCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCpeflCpeDescCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflCpeDescCd() {
    return (substring(
        getStringValue(), beginCpeflCpeDescCd, beginCpeflCpeDescCd + CPEFL_CPE_DESC_CD_LEN));
  }
  ...
  public boolean isCpeflPgmIdModified() {
    ...
    localCpeflPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCpeflLstUpdtDttmModified() {
    ...
    localCpeflLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCpeflLstUpdtDttm(char[] cpeflLstUpdtDttm) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        cpeflLstUpdtDttm, 0, getStringValue(), beginCpeflLstUpdtDttm, CPEFL_LST_UPDT_DTTM_LEN);
  ...
  /**
   * refreshCpeflLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflLstUpdtDttm() {
    return (substring(
        getStringValue(), beginCpeflLstUpdtDttm, beginCpeflLstUpdtDttm + CPEFL_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isCpeflLstUpdtUserIdModified() {
    ...
    localCpeflLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCpeflLstUpdtUserId(char[] cpeflLstUpdtUserId) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginCpeflLstUpdtUserId,
        CPEFL_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshCpeflLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCpeflLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginCpeflLstUpdtUserId,
        beginCpeflLstUpdtUserId + CPEFL_LST_UPDT_USER_ID_LEN));
  }
}
