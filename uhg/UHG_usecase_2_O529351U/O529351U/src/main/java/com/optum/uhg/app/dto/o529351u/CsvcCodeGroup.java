...
public class CsvcCodeGroup extends CsvcCodeGroupSerialized {
  ...
  /**
   * Update CsvcCode with the passed value Corresponding COBOL Variable is CSVC-CODE
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCode(
  ...
  /**
   * Update CsvcCode with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCode(
  ...
  /**
   * Update CsvcCodeA with the passed value Corresponding COBOL Variable is CSVC-CODE-A
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCodeA with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCodeA with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCodeA(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update CsvcCodeA with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCodeA with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCodeA(
