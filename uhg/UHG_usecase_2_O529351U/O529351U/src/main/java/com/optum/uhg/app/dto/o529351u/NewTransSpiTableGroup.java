...
public class NewTransSpiTableGroup extends NewTransSpiTableGroupSerialized {
  ...
  /**
   * set variable newTransSpiTable Corresponding COBOL Variable is NEW-TRANS-SPI-TABLE
   *
   * @param value
   */
  ...
  /**
   * Update NewTransSpiTable with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NewTransSpiTable with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNewTransSpiTable(
  ...
  /**
   * Update NewTransSpiTable with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NewTransSpiTable with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNewTransSpiTable(
  ...
  /**
   * Update NewTransSpiTableR with the passed value Corresponding COBOL Variable is
   * NEW-TRANS-SPI-TABLE-R
   *
   * @param value
   */
  ...
  /**
   * Update NewTransSpiTableR with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NewTransSpiTableR with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNewTransSpiTableR(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update NewTransSpiTableR with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update NewTransSpiTableR with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setNewTransSpiTableR(
