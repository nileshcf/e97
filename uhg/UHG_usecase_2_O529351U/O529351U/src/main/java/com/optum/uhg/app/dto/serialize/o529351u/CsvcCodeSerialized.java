...
/**
 * The class CsvcCodeSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class CsvcCodeSerialized extends Field {
  ...
  /**
   * sets parent for this CsvcCodeSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isCsvcCode1st5Modified() {
    ...
    localCsvcCode1st5Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeCsvcCode1st5(char[] value) {
    ...
    replaceValue(padNumber(5, value, false /*isSigned?*/), beginCsvcCode1st5, 5);
    localCsvcCode1st5Counter = shareString.getSerializedField().getModifiedCounter();
    return csvcCode1st5;
  }
  ...
  /**
   * refreshCsvcCode1st5 is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isCsvcCodeLst1Modified() {
    ...
    localCsvcCodeLst1Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeCsvcCodeLst1(char[] value) {
    ...
    csvcCodeLst1 =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(1, value, false /*isSigned?*/), beginCsvcCodeLst1, 1);
    localCsvcCodeLst1Counter = shareString.getSerializedField().getModifiedCounter();
    return csvcCodeLst1;
  }
  ...
  /**
   * refreshCsvcCodeLst1 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
