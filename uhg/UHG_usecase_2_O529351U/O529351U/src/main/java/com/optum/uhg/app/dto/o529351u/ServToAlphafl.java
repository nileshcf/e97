...
public class ServToAlphafl extends ServToAlphaflSerialized {
  ...
  /**
   * set variable feSvc14alFr Corresponding COBOL Variable is FE-SVC-1-4AL-FR
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc14alFr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc14alFr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc14alFr(
  ...
  /**
   * Update FeSvc14alFr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc14alFr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc14alFr(
  ...
  /**
   * set variable feSvc5alFr Corresponding COBOL Variable is FE-SVC-5AL-FR
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc5alFr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc5alFr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc5alFr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FeSvc5alFr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc5alFr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc5alFr(
