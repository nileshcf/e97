...
public class SavRecTyp4Fileaid extends SavRecTyp4FileaidSerialized {
  ...
  /**
   * Update SaveRecType4Fixed with the passed value Corresponding COBOL Variable is
   * SAVE-REC-TYPE4-FIXED
   *
   * @param value
   */
  ...
  /**
   * Update SaveRecType4Fixed with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SaveRecType4Fixed with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSaveRecType4Fixed(
  ...
  /**
   * Update SaveRecType4Fixed with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SaveRecType4Fixed with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSaveRecType4Fixed(
