...
public class PpaPpoaltRecord extends PpaPpoaltRecordSerialized {
  ...
  public void setParent(Field parent, int begin) {
    ...
    for (int arrayIndex = 0; arrayIndex < PPA_PPO_ID_SIZE; arrayIndex++) {
      ppaPpoId.add(
          new PpaPpoId(this, beginPpaPpoId + arrayIndex * PpaPpoId.getPpaPpoIdFieldLength()));
    }
  }
  ...
  /**
   * Update PpaFixedPortion with the passed value Corresponding COBOL Variable is PPA-FIXED-PORTION
   *
   * @param value
   */
  ...
  /**
   * Update PpaFixedPortion with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaFixedPortion with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaFixedPortion(
  ...
  /**
   * Update PpaFixedPortion with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaFixedPortion with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaFixedPortion(
  ...
  /**
   * Returns the value of ppaPpoId Corresponding COBOL Variable is PPA-PPO-ID
   *
   * @return ppaPpoId
   */
  ...
  public PpaPpoId getPpaPpoId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "ppaPpoId - Array index exceeded max Size {}, resetting it to max allowed",
          PPA_PPO_ID_SIZE);
    }
    if (index >= ppaPpoId.size()) {
      ...
      ppaPpoId.set(
          index, new PpaPpoId(this, beginPpaPpoId + index * PpaPpoId.getPpaPpoIdFieldLength()));
    }
  ...
  /**
   * Update PpaPpoId at index with the passed value Corresponding COBOL Variable is PPA-PPO-ID
   *
   * @param index
   * @param value
   */
