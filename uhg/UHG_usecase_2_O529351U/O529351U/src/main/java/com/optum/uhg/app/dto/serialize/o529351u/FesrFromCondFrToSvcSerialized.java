...
/**
 * The class FesrFromCondFrToSvcSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class FesrFromCondFrToSvcSerialized extends Field {
  ...
  /**
   * sets parent for this FesrFromCondFrToSvcSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isFesrFromFrSvcModified() {
    ...
    localFesrFromFrSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesrFromFrSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesrFromFrSvc() {
    return (substring(
        getStringValue(), beginFesrFromFrSvc, beginFesrFromFrSvc + FESR_FROM_FR_SVC_LEN));
  }
  ...
  public boolean isFesrFromToSvcModified() {
    ...
    localFesrFromToSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesrFromToSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesrFromToSvc() {
    return (substring(
        getStringValue(), beginFesrFromToSvc, beginFesrFromToSvc + FESR_FROM_TO_SVC_LEN));
  }
  ...
  public boolean isFesrSvcIndModified() {
    ...
    localFesrSvcIndCounter = sharedCounter;
    return hasModified;
  }
