...
public class Dfhcommarea extends DfhcommareaSerialized {
  ...
  /**
   * Update XrefRecord with the passed value Corresponding COBOL Variable is XREF-RECORD
   *
   * @param value
   */
  ...
  /**
   * Update XrefRecord with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrefRecord with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrefRecord(
  ...
  /**
   * Update XrefRecord with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrefRecord with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrefRecord(
  ...
  /**
   * Update XrefCmInfo with the passed value Corresponding COBOL Variable is XREF-CM-INFO
   *
   * @param value
   */
  ...
  /**
   * Update XrefCmInfo with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrefCmInfo with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrefCmInfo(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update XrefCmInfo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrefCmInfo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrefCmInfo(
  ...
  /**
   * Update LinkAreaM51u with the passed value Corresponding COBOL Variable is LINK-AREA-M51U
   *
   * @param value
   */
  ...
  /**
   * Update LinkAreaM51u with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LinkAreaM51u with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLinkAreaM51u(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update LinkAreaM51u with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LinkAreaM51u with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLinkAreaM51u(
  ...
  /**
   * Update PpaPpoaltRecord with the passed value Corresponding COBOL Variable is PPA-PPOALT-RECORD
   *
   * @param value
   */
  ...
  /**
   * Update PpaPpoaltRecord with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaPpoaltRecord with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaPpoaltRecord(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PpaPpoaltRecord with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaPpoaltRecord with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaPpoaltRecord(
