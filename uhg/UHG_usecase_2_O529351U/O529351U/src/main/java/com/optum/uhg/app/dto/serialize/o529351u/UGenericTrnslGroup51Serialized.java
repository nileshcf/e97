...
/**
 * The class UGenericTrnslGroup51Serialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class UGenericTrnslGroup51Serialized extends Field {
  ...
  /**
   * sets parent for this UGenericTrnslGroup51Serialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isUGenericTrnsl51Modified() {
    ...
    localUGenericTrnsl51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUGenericTrnsl51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUGenericTrnsl51() {
    return (substring(
        getStringValue(), beginUGenericTrnsl51, beginUGenericTrnsl51 + U_GENERIC_TRNSL_51_LEN));
  }
}
