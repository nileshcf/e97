...
public class FeSpiAltPlanRecord extends FeSpiAltPlanRecordSerialized {
  ...
  /**
   * Update FesaKey with the passed value Corresponding COBOL Variable is FESA-KEY
   *
   * @param value
   */
  ...
  /**
   * Update FesaKey with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaKey with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaKey(
  ...
  /**
   * Update FesaKey with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaKey with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaKey(
  ...
  /**
   * Update FesaDateTimestamp with the passed value Corresponding COBOL Variable is
   * FESA-DATE-TIMESTAMP
   *
   * @param value
   */
  ...
  /**
   * Update FesaDateTimestamp with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaDateTimestamp with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaDateTimestamp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesaDateTimestamp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaDateTimestamp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaDateTimestamp(
  ...
  /**
   * Update FesaCanDt with the passed value Corresponding COBOL Variable is FESA-CAN-DT
   *
   * @param number
   */
