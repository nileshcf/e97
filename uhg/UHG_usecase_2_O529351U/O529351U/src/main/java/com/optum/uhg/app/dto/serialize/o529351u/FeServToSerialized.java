...
/**
 * The class FeServToSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class FeServToSerialized extends Field {
  ...
  /**
   * sets parent for this FeServToSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isFeSvc15ToModified() {
    ...
    localFeSvc15ToCounter = sharedCounter;
    return hasModified;
  }
