...
public class PlanDt extends PlanDtSerialized {
  ...
  /**
   * Update PlanCc with the passed value Corresponding COBOL Variable is WS-PLAN-CC
   *
   * @param number
   */
  ...
  /**
   * Update PlanYy with the passed value Corresponding COBOL Variable is WS-PLAN-YY
   *
   * @param number
   */
  ...
  /**
   * Update PlanMm with the passed value Corresponding COBOL Variable is WS-PLAN-MM
   *
   * @param number
   */
  ...
  /**
   * Update PlanDd with the passed value Corresponding COBOL Variable is WS-PLAN-DD
   *
   * @param number
   */
