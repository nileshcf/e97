...
/**
 * The class D51uNonArrayDataSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uNonArrayDataSerialized extends Field {
  ...
  /**
   * sets parent for this D51uNonArrayDataSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uReturnCodeModified() {
    ...
    localD51uReturnCodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeD51uReturnCode(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginD51uReturnCode, 2);
    localD51uReturnCodeCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uReturnCode;
  }
  ...
  /**
   * refreshD51uReturnCode is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isD51uInvReasonModified() {
    ...
    localD51uInvReasonCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeD51uInvReason(char[] value) {
    ...
    d51uInvReason =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginD51uInvReason, 3);
    localD51uInvReasonCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uInvReason;
  }
  ...
  /**
   * refreshD51uInvReason is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isD51uErrTableModified() {
    ...
    localD51uErrTableCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeD51uErrTable(char[] value) {
    ...
    d51uErrTable =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(1, value, false /*isSigned?*/), beginD51uErrTable, 1);
    localD51uErrTableCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uErrTable;
  }
  ...
  /**
   * refreshD51uErrTable is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isD51uMoreRecordsIndModified() {
    ...
    localD51uMoreRecordsIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uMoreRecordsInd(char[] d51uMoreRecordsInd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uMoreRecordsInd,
        D_51U_MORE_RECORDS_IND_LEN);
  ...
  /**
   * refreshD51uMoreRecordsInd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uMoreRecordsInd() {
    return (substring(
        getStringValue(),
        beginD51uMoreRecordsInd,
        beginD51uMoreRecordsInd + D_51U_MORE_RECORDS_IND_LEN));
  }
  ...
  public boolean isD51uMoreIcdRecordsModified() {
    ...
    localD51uMoreIcdRecordsCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uMoreIcdRecords(char[] d51uMoreIcdRecords) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uMoreIcdRecords,
        D_51U_MORE_ICD_RECORDS_LEN);
  ...
  /**
   * refreshD51uMoreIcdRecords is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uMoreIcdRecords() {
    return (substring(
        getStringValue(),
        beginD51uMoreIcdRecords,
        beginD51uMoreIcdRecords + D_51U_MORE_ICD_RECORDS_LEN));
  }
  ...
  public boolean isD51uMoreIcdSwitchModified() {
    ...
    localD51uMoreIcdSwitchCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uMoreIcdSwitch(char[] d51uMoreIcdSwitch) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uMoreIcdSwitch, 0, getStringValue(), beginD51uMoreIcdSwitch, D_51U_MORE_ICD_SWITCH_LEN);
  ...
  /**
   * refreshD51uMoreIcdSwitch is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uMoreIcdSwitch() {
    return (substring(
        getStringValue(),
        beginD51uMoreIcdSwitch,
        beginD51uMoreIcdSwitch + D_51U_MORE_ICD_SWITCH_LEN));
  }
  ...
  public boolean isD51uNbrOfEntriesModified() {
    ...
    localD51uNbrOfEntriesCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeD51uNbrOfEntries(char[] value) {
    ...
    d51uNbrOfEntries =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(6, value, false /*isSigned?*/), beginD51uNbrOfEntries, 6);
    localD51uNbrOfEntriesCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uNbrOfEntries;
  }
  ...
  /**
   * refreshD51uNbrOfEntries is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
