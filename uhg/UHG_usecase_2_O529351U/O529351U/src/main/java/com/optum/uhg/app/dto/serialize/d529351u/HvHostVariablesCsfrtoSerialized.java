...
/**
 * The class HvHostVariablesCsfrtoSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvHostVariablesCsfrtoSerialized extends Field {
  ...
  protected void serializeHv08SvcDrvPos(int index, char[] value) {
    replaceValue(
        value, (beginHv08SvcDrvPos + index * HV_08_SVC_DRV_POS_LEN), HV_08_SVC_DRV_POS_LEN);
  }
  ...
  protected void serializeHv09SvcDrvSvc(int index, char[] value) {
    replaceValue(
        value, (beginHv09SvcDrvSvc + index * HV_09_SVC_DRV_SVC_LEN), HV_09_SVC_DRV_SVC_LEN);
  }
  ...
  protected void serializeHv10SvcDrvCau(int index, char[] value) {
    replaceValue(
        value, (beginHv10SvcDrvCau + index * HV_10_SVC_DRV_CAU_LEN), HV_10_SVC_DRV_CAU_LEN);
  }
  ...
  protected void serializeHv11ClmFrmSvcCd(int index, char[] value) {
    replaceValue(
        value, (beginHv11ClmFrmSvcCd + index * HV_11_CLM_FRM_SVC_CD_LEN), HV_11_CLM_FRM_SVC_CD_LEN);
  }
  ...
  protected void serializeHv12ClmToSvcCd(int index, char[] value) {
    replaceValue(
        value, (beginHv12ClmToSvcCd + index * HV_12_CLM_TO_SVC_CD_LEN), HV_12_CLM_TO_SVC_CD_LEN);
  }
  ...
  protected void serializeHv13SvcTypCd(int index, char[] value) {
    replaceValue(value, (beginHv13SvcTypCd + index * HV_13_SVC_TYP_CD_LEN), HV_13_SVC_TYP_CD_LEN);
  }
