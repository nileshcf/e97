...
public class CetCicsErrorTable extends CetCicsErrorTableSerialized {
  ...
  /**
   * set variable cetEibrcd Corresponding COBOL Variable is CET-EIBRCD
   *
   * @param value
   */
  ...
  /**
   * Update CetEibrcd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetEibrcd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCetEibrcd(
  ...
  /**
   * Update CetEibrcd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetEibrcd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCetEibrcd(
