...
/**
 * The class D51uRetRuleProvTypSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRuleProvTypSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRuleProvTypSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uPtypDrvPosModified() {
    ...
    localD51uPtypDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uPtypDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uPtypDrvPos() {
    return (substring(
        getStringValue(), beginD51uPtypDrvPos, beginD51uPtypDrvPos + D_51U_PTYP_DRV_POS_LEN));
  }
  ...
  public boolean isD51uPtypDrvSvcModified() {
    ...
    localD51uPtypDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uPtypDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uPtypDrvSvc() {
    return (substring(
        getStringValue(), beginD51uPtypDrvSvc, beginD51uPtypDrvSvc + D_51U_PTYP_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uPtypDrvCauModified() {
    ...
    localD51uPtypDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uPtypDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uPtypDrvCau() {
    return (substring(
        getStringValue(), beginD51uPtypDrvCau, beginD51uPtypDrvCau + D_51U_PTYP_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uPtypProvTypModified() {
    ...
    localD51uPtypProvTypCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uPtypProvTyp is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uPtypProvTyp() {
    return (substring(
        getStringValue(), beginD51uPtypProvTyp, beginD51uPtypProvTyp + D_51U_PTYP_PROV_TYP_LEN));
  }
}
