...
/**
 * The class D51uRetRuleFrCondPosSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class D51uRetRuleFrCondPosSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRuleFrCondPosSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isD51uFcndDrvPosModified() {
    ...
    localD51uFcndDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uFcndDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uFcndDrvPos() {
    return (substring(
        getStringValue(), beginD51uFcndDrvPos, beginD51uFcndDrvPos + D_51U_FCND_DRV_POS_LEN));
  }
  ...
  public boolean isD51uFcndDrvSvcModified() {
    ...
    localD51uFcndDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uFcndDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uFcndDrvSvc() {
    return (substring(
        getStringValue(), beginD51uFcndDrvSvc, beginD51uFcndDrvSvc + D_51U_FCND_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uFcndDrvCauModified() {
    ...
    localD51uFcndDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uFcndDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uFcndDrvCau() {
    return (substring(
        getStringValue(), beginD51uFcndDrvCau, beginD51uFcndDrvCau + D_51U_FCND_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uFcndFromCondPosModified() {
    ...
    localD51uFcndFromCondPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uFcndFromCondPos(char[] d51uFcndFromCondPos) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uFcndFromCondPos,
        D_51U_FCND_FROM_COND_POS_LEN);
  ...
  /**
   * refreshD51uFcndFromCondPos is used to refresh the latest value of a variable from the
  ...
  public char[] refreshD51uFcndFromCondPos() {
    return (substring(
        getStringValue(),
        beginD51uFcndFromCondPos,
        beginD51uFcndFromCondPos + D_51U_FCND_FROM_COND_POS_LEN));
  }
}
