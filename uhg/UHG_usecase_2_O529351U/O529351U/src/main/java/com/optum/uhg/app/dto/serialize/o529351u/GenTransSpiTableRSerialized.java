...
/**
 * The class GenTransSpiTableRSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class GenTransSpiTableRSerialized extends Field {
  ...
  /**
   * sets parent for this GenTransSpiTableRSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
