...
/**
 * The class HvHostVariablesCombcrSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvHostVariablesCombcrSerialized extends Field {
  ...
  protected void serializeHv2aRecTypCd(int index, char[] value) {
    replaceValue(value, (beginHv2aRecTypCd + index * HV_2A_REC_TYP_CD_LEN), HV_2A_REC_TYP_CD_LEN);
  }
  ...
  protected void serializeHv2cDerivSvcCd(int index, char[] value) {
    replaceValue(
        value, (beginHv2cDerivSvcCd + index * HV_2C_DERIV_SVC_CD_LEN), HV_2C_DERIV_SVC_CD_LEN);
  }
  ...
  protected void serializeHv2dDerivCausCd(int index, char[] value) {
    replaceValue(
        value, (beginHv2dDerivCausCd + index * HV_2D_DERIV_CAUS_CD_LEN), HV_2D_DERIV_CAUS_CD_LEN);
  }
  ...
  protected void serializeHv2eClmCaus1Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2eClmCaus1Cd + index * HV_2E_CLM_CAUS_1_CD_LEN), HV_2E_CLM_CAUS_1_CD_LEN);
  }
  ...
  protected void serializeHv2fClmCaus2Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2fClmCaus2Cd + index * HV_2F_CLM_CAUS_2_CD_LEN), HV_2F_CLM_CAUS_2_CD_LEN);
  }
  ...
  protected void serializeHv2gClmCaus3Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2gClmCaus3Cd + index * HV_2G_CLM_CAUS_3_CD_LEN), HV_2G_CLM_CAUS_3_CD_LEN);
  }
  ...
  protected void serializeHv2hClmCaus4Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2hClmCaus4Cd + index * HV_2H_CLM_CAUS_4_CD_LEN), HV_2H_CLM_CAUS_4_CD_LEN);
  }
  ...
  protected void serializeHv2iClmCaus5Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2iClmCaus5Cd + index * HV_2I_CLM_CAUS_5_CD_LEN), HV_2I_CLM_CAUS_5_CD_LEN);
  }
  ...
  protected void serializeHv2jClmCaus6Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2jClmCaus6Cd + index * HV_2J_CLM_CAUS_6_CD_LEN), HV_2J_CLM_CAUS_6_CD_LEN);
  }
  ...
  protected void serializeHv2kClmCaus7Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2kClmCaus7Cd + index * HV_2K_CLM_CAUS_7_CD_LEN), HV_2K_CLM_CAUS_7_CD_LEN);
  }
  ...
  protected void serializeHv2lClmCaus8Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2lClmCaus8Cd + index * HV_2L_CLM_CAUS_8_CD_LEN), HV_2L_CLM_CAUS_8_CD_LEN);
  }
  ...
  protected void serializeHv2mClmIpa1Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2mClmIpa1Cd + index * HV_2M_CLM_IPA_1_CD_LEN), HV_2M_CLM_IPA_1_CD_LEN);
  }
  ...
  protected void serializeHv2nClmIpa2Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2nClmIpa2Cd + index * HV_2N_CLM_IPA_2_CD_LEN), HV_2N_CLM_IPA_2_CD_LEN);
  }
  ...
  protected void serializeHv2oClmIpa3Cd(int index, char[] value) {
    replaceValue(
        value, (beginHv2oClmIpa3Cd + index * HV_2O_CLM_IPA_3_CD_LEN), HV_2O_CLM_IPA_3_CD_LEN);
  }
  ...
  protected void serializeHv2pProvTyp(int index, char[] value) {
    replaceValue(value, (beginHv2pProvTyp + index * HV_2P_PROV_TYP_LEN), HV_2P_PROV_TYP_LEN);
  }
  ...
  protected void serializeHv2qFromCondPos(int index, char[] value) {
    replaceValue(
        value, (beginHv2qFromCondPos + index * HV_2Q_FROM_COND_POS_LEN), HV_2Q_FROM_COND_POS_LEN);
  }
  ...
  protected void serializeHv2rGrpTbl1Nbr(int index, char[] value) {
    replaceValue(
        value, (beginHv2rGrpTbl1Nbr + index * HV_2R_GRP_TBL_1_NBR_LEN), HV_2R_GRP_TBL_1_NBR_LEN);
  }
  ...
  protected void serializeHv2sGrpTbl2Nbr(int index, char[] value) {
    replaceValue(
        value, (beginHv2sGrpTbl2Nbr + index * HV_2S_GRP_TBL_2_NBR_LEN), HV_2S_GRP_TBL_2_NBR_LEN);
  }
  ...
  protected void serializeHv2tGrpTbl3Nbr(int index, char[] value) {
    replaceValue(
        value, (beginHv2tGrpTbl3Nbr + index * HV_2T_GRP_TBL_3_NBR_LEN), HV_2T_GRP_TBL_3_NBR_LEN);
  }
  ...
  protected void serializeHv2uCpeDescCd(int index, char[] value) {
    replaceValue(
        value, (beginHv2uCpeDescCd + index * HV_2U_CPE_DESC_CD_LEN), HV_2U_CPE_DESC_CD_LEN);
  }
