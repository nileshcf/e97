...
public class D51uRetData extends D51uRetDataSerialized {
  ...
  /**
   * Returns the value of d51uReturnData Corresponding COBOL Variable is D51U-RETURN-DATA
   *
  ...
  public D51uReturnData getD51uReturnData(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uReturnData - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RETURN_DATA_SIZE);
    }
    if (index >= d51uReturnData.size()) {
      ...
      d51uReturnData.set(
          index,
          new D51uReturnData(
              this, beginD51uReturnData + index * D51uReturnData.getD51uReturnDataFieldLength()));
    }
  ...
  /**
   * Update D51uReturnData at index with the passed value Corresponding COBOL Variable is
   * D51U-RETURN-DATA
   *
   * @param index
   * @param value
