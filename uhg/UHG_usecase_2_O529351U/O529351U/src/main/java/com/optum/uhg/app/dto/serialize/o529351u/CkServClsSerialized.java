...
/**
 * The class CkServClsSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class CkServClsSerialized extends Field {
  ...
  /**
   * sets parent for this CkServClsSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isCls15Modified() {
    ...
    localCls15Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeCls15(char[] value) {
    ...
    replaceValue(padNumber(5, value, false /*isSigned?*/), beginCls15, 5);
    localCls15Counter = shareString.getSerializedField().getModifiedCounter();
    return cls15;
  }
  ...
  /**
   * refreshCls15 is used to refresh the latest value of a variable from the Serialized String the
