...
public class HvHostVariablesSvcmain extends HvHostVariablesSvcmainSerialized {
  ...
  /**
   * Returns the value of hv04KeyDrvPos Corresponding COBOL Variable is HV04-KEY-DRV-POS
   *
  ...
  public char[] getHv04KeyDrvPos(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv04KeyDrvPos - Array index exceeded max Size {}, resetting it to max allowed",
          HV_04_KEY_DRV_POS_SIZE);
    }
    return getCharArray(
        (beginHv04KeyDrvPos + index * HV_04_KEY_DRV_POS_LEN), HV_04_KEY_DRV_POS_LEN);
  }
  ...
  /**
   * Update Hv04KeyDrvPos with the passed value at a given index Corresponding COBOL Variable is
   * HV04-KEY-DRV-POS
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv04KeyDrvPos with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv04KeyDrvPos(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv04KeyDrvPos(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv05KeyDrvSvc Corresponding COBOL Variable is HV05-KEY-DRV-SVC
   *
  ...
  public char[] getHv05KeyDrvSvc(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv05KeyDrvSvc - Array index exceeded max Size {}, resetting it to max allowed",
          HV_05_KEY_DRV_SVC_SIZE);
    }
    return getCharArray(
        (beginHv05KeyDrvSvc + index * HV_05_KEY_DRV_SVC_LEN), HV_05_KEY_DRV_SVC_LEN);
  }
  ...
  /**
   * Update Hv05KeyDrvSvc with the passed value at a given index Corresponding COBOL Variable is
   * HV05-KEY-DRV-SVC
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv05KeyDrvSvc with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv05KeyDrvSvc(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv05KeyDrvSvc(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv06KeyDrvCau Corresponding COBOL Variable is HV06-KEY-DRV-CAU
   *
  ...
  public char[] getHv06KeyDrvCau(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv06KeyDrvCau - Array index exceeded max Size {}, resetting it to max allowed",
          HV_06_KEY_DRV_CAU_SIZE);
    }
    return getCharArray(
        (beginHv06KeyDrvCau + index * HV_06_KEY_DRV_CAU_LEN), HV_06_KEY_DRV_CAU_LEN);
  }
  ...
  /**
   * Update Hv06KeyDrvCau with the passed value at a given index Corresponding COBOL Variable is
   * HV06-KEY-DRV-CAU
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv06KeyDrvCau with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv06KeyDrvCau(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv06KeyDrvCau(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv07RuleSw Corresponding COBOL Variable is HV07-RULE-SW
   *
   * @return hv07RuleSw
   */
  ...
  public char[] getHv07RuleSw(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv07RuleSw - Array index exceeded max Size {}, resetting it to max allowed",
          HV_07_RULE_SW_SIZE);
    }
  ...
  /**
   * Update Hv07RuleSw with the passed value at a given index Corresponding COBOL Variable is
   * HV07-RULE-SW
   *
   * @param index
   * @param value
  ...
  private void setHv07RuleSw(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv07RuleSw(int,String,boolean), reset it to 0", index);
      index = 0;
    }
