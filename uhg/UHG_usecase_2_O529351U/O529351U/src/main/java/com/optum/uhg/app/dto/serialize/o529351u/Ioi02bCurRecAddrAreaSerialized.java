...
/**
 * The class Ioi02bCurRecAddrAreaSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class Ioi02bCurRecAddrAreaSerialized extends Field {
  ...
  /**
   * sets parent for this Ioi02bCurRecAddrAreaSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isIoi02bRelRecNumModified() {
    ...
    localIoi02bRelRecNumCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bRelRecNum is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isIoi02bRelBlkNumModified() {
    ...
    localIoi02bRelBlkNumCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bRelBlkNum is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
