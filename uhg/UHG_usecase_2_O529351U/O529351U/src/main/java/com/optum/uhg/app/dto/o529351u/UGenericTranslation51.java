...
public class UGenericTranslation51 extends UGenericTranslation51Serialized {
  ...
  /**
   * Returns the value of uGenericTrnslGroup51 Corresponding COBOL Variable is
   * LK-51U-GENERIC-TRNSL-GROUP
   *
  ...
  public UGenericTrnslGroup51 getUGenericTrnslGroup51(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "uGenericTrnslGroup51 - Array index exceeded max Size {}, resetting it to max allowed",
          U_GENERIC_TRNSL_GROUP_51_SIZE);
    }
    if (index >= uGenericTrnslGroup51.size()) {
      ...
      uGenericTrnslGroup51.set(
          index,
          new UGenericTrnslGroup51(
              this,
              beginUGenericTrnslGroup51
                  + index * UGenericTrnslGroup51.getUGenericTrnslGroup51FieldLength()));
    }
  ...
  /**
   * Update UGenericTrnslGroup51 at index with the passed value Corresponding COBOL Variable is
   * LK-51U-GENERIC-TRNSL-GROUP
   *
   * @param index
   * @param value
