...
/**
 * The class HoldTransData2Serialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class HoldTransData2Serialized extends Field {
  ...
  /**
   * sets parent for this HoldTransData2Serialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFcndPsModified() {
    ...
    localFcndPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndPs is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isFcndSvcModified() {
    ...
    localFcndSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isFcndCauseCdModified() {
    ...
    localFcndCauseCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFrtoPsModified() {
    ...
    localFrtoPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoPs is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isFrtoSvcModified() {
    ...
    localFrtoSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isFrtoCauseCdModified() {
    ...
    localFrtoCauseCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPtypPsModified() {
    ...
    localPtypPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypPs is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPtypSvcModified() {
    ...
    localPtypSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPtypSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPtypCauseCdModified() {
    ...
    localPtypCauseCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isRicdPsModified() {
    ...
    localRicdPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdPs is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isRicdSvcModified() {
    ...
    localRicdSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isRicdCauseCdModified() {
    ...
    localRicdCauseCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCausPsModified() {
    ...
    localCausPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausPs is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isCausSvcModified() {
    ...
    localCausSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isCausCauseCdModified() {
    ...
    localCausCauseCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isRipaPsModified() {
    ...
    localRipaPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaPs is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isRipaSvcModified() {
    ...
    localRipaSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isRipaCauseCdModified() {
    ...
    localRipaCauseCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCflgPsModified() {
    ...
    localCflgPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCflgPs is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isCflgSvcModified() {
    ...
    localCflgSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCflgSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isCflgCauseCdModified() {
    ...
    localCflgCauseCdCounter = sharedCounter;
    return hasModified;
  }
