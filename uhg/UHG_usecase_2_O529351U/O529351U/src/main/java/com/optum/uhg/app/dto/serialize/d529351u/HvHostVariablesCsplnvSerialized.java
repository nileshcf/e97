...
/**
 * The class HvHostVariablesCsplnvSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvHostVariablesCsplnvSerialized extends Field {
  ...
  protected void serializeHv01SpiTblId(int index, char[] value) {
    replaceValue(value, (beginHv01SpiTblId + index * HV_01_SPI_TBL_ID_LEN), HV_01_SPI_TBL_ID_LEN);
  }
  ...
  protected void serializeHv0aPriDiagInd(int index, char[] value) {
    replaceValue(
        value, (beginHv0aPriDiagInd + index * HV_0A_PRI_DIAG_IND_LEN), HV_0A_PRI_DIAG_IND_LEN);
  }
