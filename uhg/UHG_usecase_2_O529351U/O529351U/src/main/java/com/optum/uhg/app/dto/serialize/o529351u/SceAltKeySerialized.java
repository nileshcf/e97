...
/**
 * The class SceAltKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SceAltKeySerialized extends Field {
  ...
  /**
   * sets parent for this SceAltKeySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isSceAltModifierModified() {
    ...
    localSceAltModifierCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSceAltModifier is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshSceAltModifier() {
    return (substring(
        getStringValue(), beginSceAltModifier, beginSceAltModifier + SCE_ALT_MODIFIER_LEN));
  }
  ...
  public boolean isSceAltToHcpcsModified() {
    ...
    localSceAltToHcpcsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSceAltToHcpcs is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshSceAltToHcpcs() {
    return (substring(
        getStringValue(), beginSceAltToHcpcs, beginSceAltToHcpcs + SCE_ALT_TO_HCPCS_LEN));
  }
  ...
  public boolean isSceAltCancDateModified() {
    ...
    localSceAltCancDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean sceAltCancDateIsNumeric() {
    return decimalIsNumeric(
        beginSceAltCancDate,
        SCE_ALT_CANC_DATE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshSceAltCancDate is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
