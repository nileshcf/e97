...
public class W02FnuLineReadnext extends W02FnuLineReadnextSerialized {
  ...
  public W02FnuLineReadnext() {
    ...
    replaceValue( // serialize and save the value
        (":RDNXT FAILED IN ").toCharArray(), getStartOffset() + 4, 17);
    replaceValue( // serialize and save the value
        (",KEY= ").toCharArray(), getStartOffset() + 29, 6);
  }
  ...
  /**
   * set variable w02FnuTranRdnxt Corresponding COBOL Variable is W02-FNU-TRAN-RDNXT
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranRdnxt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranRdnxt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuTranRdnxt(
  ...
  /**
   * Update W02FnuTranRdnxt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuTranRdnxt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuTranRdnxt(
  ...
  /**
   * set variable w02FnuFileRdnxt Corresponding COBOL Variable is W02-FNU-FILE-RDNXT
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileRdnxt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileRdnxt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuFileRdnxt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update W02FnuFileRdnxt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuFileRdnxt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuFileRdnxt(
  ...
  /**
   * set variable w02FnuKeyRdnxt Corresponding COBOL Variable is W02-FNU-KEY-RDNXT
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyRdnxt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyRdnxt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuKeyRdnxt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update W02FnuKeyRdnxt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update W02FnuKeyRdnxt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setW02FnuKeyRdnxt(
