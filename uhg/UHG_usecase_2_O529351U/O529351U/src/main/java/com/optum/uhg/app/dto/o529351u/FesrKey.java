...
public class FesrKey extends FesrKeySerialized {
  ...
  /**
   * Update FesrSpiNbr with the passed value Corresponding COBOL Variable is WS-FESR-SPI-NBR
   *
   * @param number
   */
  ...
  /**
   * set variable fesrToPs Corresponding COBOL Variable is WS-FESR-TO-PS
   *
   * @param value
   */
  ...
  /**
   * Update FesrToPs with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrToPs with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrToPs(
  ...
  /**
   * Update FesrToPs with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrToPs with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrToPs(
  ...
  /**
   * set variable fesrToSvc Corresponding COBOL Variable is WS-FESR-TO-SVC
   *
   * @param value
   */
  ...
  /**
   * Update FesrToSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrToSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrToSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesrToSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrToSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrToSvc(
  ...
  /**
   * set variable fesrToCause Corresponding COBOL Variable is WS-FESR-TO-CAUSE
   *
   * @param value
   */
  ...
  /**
   * Update FesrToCause with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrToCause with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrToCause(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesrToCause with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrToCause with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrToCause(
