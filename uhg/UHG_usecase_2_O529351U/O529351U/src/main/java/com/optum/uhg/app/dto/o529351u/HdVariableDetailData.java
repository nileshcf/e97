...
public class HdVariableDetailData extends HdVariableDetailDataSerialized {
  ...
  /**
   * Update HdPmtiProvX with the passed value Corresponding COBOL Variable is HD-PMTI-PROV-X
   *
   * @param value
   */
  ...
  /**
   * Update HdPmtiProvX with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HdPmtiProvX with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHdPmtiProvX(
  ...
  /**
   * Update HdPmtiProvX with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HdPmtiProvX with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHdPmtiProvX(
  ...
  /**
   * Update HdPmtiTin with the passed value Corresponding COBOL Variable is HD-PMTI-TIN
   *
   * @param number
   */
