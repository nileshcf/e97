...
public class D51uRetRuleKeys extends D51uRetRuleKeysSerialized {
  ...
  /**
   * set variable d51uRetDrvPos Corresponding COBOL Variable is D51U-RET-DRV-POS
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDrvPos(
  ...
  /**
   * Update D51uRetDrvPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDrvPos(
  ...
  /**
   * set variable d51uRetDrvSvc Corresponding COBOL Variable is D51U-RET-DRV-SVC
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDrvSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetDrvSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDrvSvc(
  ...
  /**
   * set variable d51uRetDrvCau Corresponding COBOL Variable is D51U-RET-DRV-CAU
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvCau with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvCau with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDrvCau(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetDrvCau with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDrvCau with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDrvCau(
  ...
  /**
   * set variable d51uRetRuleSw Corresponding COBOL Variable is D51U-RET-RULE-SW
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRuleSw with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRuleSw with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRuleSw(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRuleSw with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRuleSw with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRuleSw(
  ...
  /**
   * initializes D51uRetRuleKeys String fields defaults to Spaces short/int/long defaults to zero
