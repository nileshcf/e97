...
/**
 * The class D51uRetRuleIcdSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRuleIcdSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRuleIcdSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uRicdDrvPosModified() {
    ...
    localD51uRicdDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRicdDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRicdDrvPos() {
    return (substring(
        getStringValue(), beginD51uRicdDrvPos, beginD51uRicdDrvPos + D_51U_RICD_DRV_POS_LEN));
  }
  ...
  public boolean isD51uRicdDrvSvcModified() {
    ...
    localD51uRicdDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRicdDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRicdDrvSvc() {
    return (substring(
        getStringValue(), beginD51uRicdDrvSvc, beginD51uRicdDrvSvc + D_51U_RICD_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uRicdDrvCauModified() {
    ...
    localD51uRicdDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRicdDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRicdDrvCau() {
    return (substring(
        getStringValue(), beginD51uRicdDrvCau, beginD51uRicdDrvCau + D_51U_RICD_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uRicdClmIcdIndModified() {
    ...
    localD51uRicdClmIcdIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRicdClmIcdInd(char[] d51uRicdClmIcdInd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uRicdClmIcdInd, 0, getStringValue(), beginD51uRicdClmIcdInd, D_51U_RICD_CLM_ICD_IND_LEN);
  ...
  /**
   * refreshD51uRicdClmIcdInd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRicdClmIcdInd() {
    return (substring(
        getStringValue(),
        beginD51uRicdClmIcdInd,
        beginD51uRicdClmIcdInd + D_51U_RICD_CLM_ICD_IND_LEN));
  }
  ...
  public boolean isD51uRicdClmIcdFromCdModified() {
    ...
    localD51uRicdClmIcdFromCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRicdClmIcdFromCd(char[] d51uRicdClmIcdFromCd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uRicdClmIcdFromCd,
        0,
        getStringValue(),
        beginD51uRicdClmIcdFromCd,
        D_51U_RICD_CLM_ICD_FROM_CD_LEN);
  ...
  /**
   * refreshD51uRicdClmIcdFromCd is used to refresh the latest value of a variable from the
  ...
  public char[] refreshD51uRicdClmIcdFromCd() {
    return (substring(
        getStringValue(),
        beginD51uRicdClmIcdFromCd,
        beginD51uRicdClmIcdFromCd + D_51U_RICD_CLM_ICD_FROM_CD_LEN));
  }
  ...
  public boolean isD51uRicdClmIcdToCdModified() {
    ...
    localD51uRicdClmIcdToCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRicdClmIcdToCd(char[] d51uRicdClmIcdToCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uRicdClmIcdToCd,
        D_51U_RICD_CLM_ICD_TO_CD_LEN);
  ...
  /**
   * refreshD51uRicdClmIcdToCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRicdClmIcdToCd() {
    return (substring(
        getStringValue(),
        beginD51uRicdClmIcdToCd,
        beginD51uRicdClmIcdToCd + D_51U_RICD_CLM_ICD_TO_CD_LEN));
  }
}
