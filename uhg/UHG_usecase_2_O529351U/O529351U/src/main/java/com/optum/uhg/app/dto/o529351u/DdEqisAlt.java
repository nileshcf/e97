...
public class DdEqisAlt extends DdEqisAltSerialized {
  ...
  /**
   * set variable eqiAltId Corresponding COBOL Variable is WS-EQI-ALT-ID
   *
   * @param value
   */
  ...
  /**
   * Update EqiAltId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update EqiAltId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setEqiAltId(
  ...
  /**
   * Update EqiAltId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update EqiAltId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setEqiAltId(
  ...
  /**
   * set variable eqiAltFillerWs Corresponding COBOL Variable is WS-EQI-ALT-FILLER
   *
   * @param value
   */
  ...
  /**
   * Update EqiAltFillerWs with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update EqiAltFillerWs with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setEqiAltFillerWs(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update EqiAltFillerWs with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update EqiAltFillerWs with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setEqiAltFillerWs(
