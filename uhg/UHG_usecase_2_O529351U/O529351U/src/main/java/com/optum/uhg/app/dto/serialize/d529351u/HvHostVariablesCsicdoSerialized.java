...
/**
 * The class HvHostVariablesCsicdoSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvHostVariablesCsicdoSerialized extends Field {
  ...
  protected void serializeHv3aIcdDrvPos(int index, char[] value) {
    replaceValue(
        value, (beginHv3aIcdDrvPos + index * HV_3A_ICD_DRV_POS_LEN), HV_3A_ICD_DRV_POS_LEN);
  }
  ...
  protected void serializeHv3bIcdDrvSvc(int index, char[] value) {
    replaceValue(
        value, (beginHv3bIcdDrvSvc + index * HV_3B_ICD_DRV_SVC_LEN), HV_3B_ICD_DRV_SVC_LEN);
  }
  ...
  protected void serializeHv3cIcdDrvCau(int index, char[] value) {
    replaceValue(
        value, (beginHv3cIcdDrvCau + index * HV_3C_ICD_DRV_CAU_LEN), HV_3C_ICD_DRV_CAU_LEN);
  }
  ...
  protected void serializeHv3dIcdTypCd(int index, char[] value) {
    replaceValue(value, (beginHv3dIcdTypCd + index * HV_3D_ICD_TYP_CD_LEN), HV_3D_ICD_TYP_CD_LEN);
  }
  ...
  protected void serializeHv3eClmFrmIcdCd(int index, char[] value) {
    replaceValue(
        value, (beginHv3eClmFrmIcdCd + index * HV_3E_CLM_FRM_ICD_CD_LEN), HV_3E_CLM_FRM_ICD_CD_LEN);
  }
  ...
  protected void serializeHv3fClmToIcdCd(int index, char[] value) {
    replaceValue(
        value, (beginHv3fClmToIcdCd + index * HV_3F_CLM_TO_ICD_CD_LEN), HV_3F_CLM_TO_ICD_CD_LEN);
  }
