...
public class FesrFromCondPs extends FesrFromCondPsSerialized {
  ...
  /**
   * set variable fesrFromPs Corresponding COBOL Variable is FESR-FROM-PS
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromPs with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromPs with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromPs(
  ...
  /**
   * Update FesrFromPs with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromPs with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromPs(
