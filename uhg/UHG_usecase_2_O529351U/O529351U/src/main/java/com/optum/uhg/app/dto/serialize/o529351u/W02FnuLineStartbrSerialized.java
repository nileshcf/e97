...
/**
 * The class W02FnuLineStartbrSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class W02FnuLineStartbrSerialized extends Field {
  ...
  public boolean isW02FnuTranStbrModified() {
    ...
    localW02FnuTranStbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02FnuTranStbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02FnuTranStbr() {
    return (substring(
        getStringValue(), beginW02FnuTranStbr, beginW02FnuTranStbr + W_02_FNU_TRAN_STBR_LEN));
  }
  ...
  public boolean isW02FnuFileStbrModified() {
    ...
    localW02FnuFileStbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02FnuFileStbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02FnuFileStbr() {
    return (substring(
        getStringValue(), beginW02FnuFileStbr, beginW02FnuFileStbr + W_02_FNU_FILE_STBR_LEN));
  }
  ...
  public boolean isW02FnuKeyStbrModified() {
    ...
    localW02FnuKeyStbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02FnuKeyStbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02FnuKeyStbr() {
    return (substring(
        getStringValue(), beginW02FnuKeyStbr, beginW02FnuKeyStbr + W_02_FNU_KEY_STBR_LEN));
  }
}
