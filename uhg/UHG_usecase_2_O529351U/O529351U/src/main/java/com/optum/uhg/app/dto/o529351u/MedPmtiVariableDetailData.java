...
public class MedPmtiVariableDetailData extends MedPmtiVariableDetailDataSerialized {
  ...
  /**
   * Update MedPmtiProvX with the passed value Corresponding COBOL Variable is MED-PMTI-PROV-X
   *
   * @param value
   */
  ...
  /**
   * Update MedPmtiProvX with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update MedPmtiProvX with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setMedPmtiProvX(
  ...
  /**
   * Update MedPmtiProvX with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update MedPmtiProvX with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setMedPmtiProvX(
  ...
  /**
   * Update MedPmtiProvTin with the passed value Corresponding COBOL Variable is MED-PMTI-PROV-TIN
   *
   * @param number
   */
  ...
  /**
   * Update MedPmtiSpecPayeeX with the passed value Corresponding COBOL Variable is
   * MED-PMTI-SPEC-PAYEE-X
   *
   * @param value
   */
  ...
  /**
   * Update MedPmtiSpecPayeeX with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update MedPmtiSpecPayeeX with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setMedPmtiSpecPayeeX(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update MedPmtiSpecPayeeX with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update MedPmtiSpecPayeeX with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setMedPmtiSpecPayeeX(
  ...
  /**
   * Update MedPmtiSpecPayeeTin with the passed value Corresponding COBOL Variable is
   * MED-PMTI-SPEC-PAYEE-TIN
   *
   * @param number
   */
