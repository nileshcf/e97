...
public class WorkArea extends WorkAreaSerialized {
  ...
  /**
   * Update NullSpiVerNbr with the passed value Corresponding COBOL Variable is WS-NULL-SPI-VER-NBR
   *
   * @param number
   */
  ...
  public void setNullSpiVerNbr(int number) {
    number =
        checkNullSpiVerNbrMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable commonRulesSpi Corresponding COBOL Variable is WS-COMMON-RULES-SPI
   *
   * @param value
   */
  ...
  /**
   * Update CommonRulesSpi with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CommonRulesSpi with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCommonRulesSpi(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update CommonRulesSpi with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CommonRulesSpi with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCommonRulesSpi(
  ...
  /**
   * set variable db2ReqDosDate Corresponding COBOL Variable is WS-DB2-REQ-DOS-DATE
   *
   * @param value
   */
  ...
  /**
   * Update Db2ReqDosDate with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2ReqDosDate with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2ReqDosDate(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Db2ReqDosDate with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2ReqDosDate with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2ReqDosDate(
  ...
  /**
   * Update Db2ReqDosDateRedefined with the passed value Corresponding COBOL Variable is
   * WS-DB2-REQ-DOS-DATE-REDEFINED
   *
   * @param value
   */
  ...
  /**
   * Update Db2ReqDosDateRedefined with a String from an offset and length
   *
   * @param value
   */
  public void setDb2ReqDosDateRedefined(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        db2ReqDosDateRedefined.begin,
        db2ReqDosDateRedefined.length());
  }

  /**
   * Update Db2ReqDosDateRedefined with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDb2ReqDosDateRedefined(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setDb2ReqDosDateRedefined(Field source) {
    replace(
        source, 0, source.length(), db2ReqDosDateRedefined.begin, db2ReqDosDateRedefined.length());
  }

  /**
   * Update Db2ReqDosDateRedefined with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Db2ReqDosDateRedefined with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
