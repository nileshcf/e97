...
/**
 * The class FesrDateTimestampSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FesrDateTimestampSerialized extends Field {
  ...
  /**
   * sets parent for this FesrDateTimestampSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesrDatestampModified() {
    ...
    localFesrDatestampCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesrDatestampIsNumeric() {
    return decimalIsNumeric(
        beginFesrDatestamp,
        FESR_DATESTAMP_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesrDatestamp is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isFesrTimestampModified() {
    ...
    localFesrTimestampCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesrTimestampIsNumeric() {
    return decimalIsNumeric(
        beginFesrTimestamp,
        FESR_TIMESTAMP_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesrTimestamp is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
