...
/**
 * The class UOutLineData51Serialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class UOutLineData51Serialized extends Field {
  ...
  /**
   * sets parent for this UOutLineData51Serialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isUOutLinePos51Modified() {
    ...
    localUOutLinePos51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUOutLinePos51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUOutLinePos51() {
    return (substring(
        getStringValue(), beginUOutLinePos51, beginUOutLinePos51 + U_OUT_LINE_POS_51_LEN));
  }
  ...
  public boolean isUOutLineServiceCode51Modified() {
    ...
    localUOutLineServiceCode51Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeUOutLineServiceCode51(char[] uOutLineServiceCode51) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        uOutLineServiceCode51,
        0,
        getStringValue(),
        beginUOutLineServiceCode51,
        U_OUT_LINE_SERVICE_CODE_51_LEN);
  ...
  /**
   * refreshUOutLineServiceCode51 is used to refresh the latest value of a variable from the
  ...
  public char[] refreshUOutLineServiceCode51() {
    return (substring(
        getStringValue(),
        beginUOutLineServiceCode51,
        beginUOutLineServiceCode51 + U_OUT_LINE_SERVICE_CODE_51_LEN));
  }
  ...
  public boolean isUOutLineDosDate51Modified() {
    ...
    localUOutLineDosDate51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uOutLineDosDate51IsNumeric() {
    return decimalIsNumeric(
        beginUOutLineDosDate51,
        U_OUT_LINE_DOS_DATE_51_LEN); // check Packed Decimal field to see if it contains valid
                                     // Number
  }
  ...
  /**
   * refreshUOutLineDosDate51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isUOutLineChargeAmt51Modified() {
    ...
    localUOutLineChargeAmt51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uOutLineChargeAmt51IsNumeric() {
    return decimalIsNumeric(
        beginUOutLineChargeAmt51,
        U_OUT_LINE_CHARGE_AMT_51_LEN); // check Packed Decimal field to see if it contains valid
                                       // Number
  }
  /**
  ...
  protected void serializeUOutLineChargeAmt51(BigDecimal uOutLineChargeAmt51) {
    putDecimal(
        beginUOutLineChargeAmt51,
        uOutLineChargeAmt51,
        U_OUT_LINE_CHARGE_AMT_51_LEN,
        U_OUT_LINE_CHARGE_AMT_51_SCALE,
        true);
  ...
  /**
   * refreshUOutLineChargeAmt51 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public BigDecimal refreshUOutLineChargeAmt51() throws CFException {
    try {
      return (getDecimal(
          beginUOutLineChargeAmt51, U_OUT_LINE_CHARGE_AMT_51_LEN, U_OUT_LINE_CHARGE_AMT_51_SCALE));
    } catch (Exception ex) {
      throw getSoc7ABend(
          "uOutLineChargeAmt51", beginUOutLineChargeAmt51, U_OUT_LINE_CHARGE_AMT_51_LEN);
    }
  }
  ...
  public boolean isUOutLineNotcovAmt51Modified() {
    ...
    localUOutLineNotcovAmt51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uOutLineNotcovAmt51IsNumeric() {
    return decimalIsNumeric(
        beginUOutLineNotcovAmt51,
        U_OUT_LINE_NOTCOV_AMT_51_LEN); // check Packed Decimal field to see if it contains valid
                                       // Number
  }
  /**
   * This method returns packed Decimal String in the mainframe format
  ...
  protected void serializeUOutLineNotcovAmt51(BigDecimal uOutLineNotcovAmt51) {
    putDecimal(
        beginUOutLineNotcovAmt51,
        uOutLineNotcovAmt51,
        U_OUT_LINE_NOTCOV_AMT_51_LEN,
        U_OUT_LINE_NOTCOV_AMT_51_SCALE,
        true);
  ...
  /**
   * refreshUOutLineNotcovAmt51 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public BigDecimal refreshUOutLineNotcovAmt51() throws CFException {
    try {
      return (getDecimal(
          beginUOutLineNotcovAmt51, U_OUT_LINE_NOTCOV_AMT_51_LEN, U_OUT_LINE_NOTCOV_AMT_51_SCALE));
    } catch (Exception ex) {
      throw getSoc7ABend(
          "uOutLineNotcovAmt51", beginUOutLineNotcovAmt51, U_OUT_LINE_NOTCOV_AMT_51_LEN);
    }
  }
  ...
  public boolean isUOutLineRemarkCd51Modified() {
    ...
    localUOutLineRemarkCd51Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeUOutLineRemarkCd51(char[] uOutLineRemarkCd51) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginUOutLineRemarkCd51,
        U_OUT_LINE_REMARK_CD_51_LEN);
  ...
  /**
   * refreshUOutLineRemarkCd51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUOutLineRemarkCd51() {
    return (substring(
        getStringValue(),
        beginUOutLineRemarkCd51,
        beginUOutLineRemarkCd51 + U_OUT_LINE_REMARK_CD_51_LEN));
  }
  ...
  public boolean isUOutLinePlanVar51Modified() {
    ...
    localUOutLinePlanVar51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUOutLinePlanVar51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isUOutLineCauseCd51Modified() {
    ...
    localUOutLineCauseCd51Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeUOutLineCauseCd51(char[] uOutLineCauseCd51) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        uOutLineCauseCd51, 0, getStringValue(), beginUOutLineCauseCd51, U_OUT_LINE_CAUSE_CD_51_LEN);
  ...
  /**
   * refreshUOutLineCauseCd51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUOutLineCauseCd51() {
    return (substring(
        getStringValue(),
        beginUOutLineCauseCd51,
        beginUOutLineCauseCd51 + U_OUT_LINE_CAUSE_CD_51_LEN));
  }
  ...
  public boolean isUOutLineAppUnits51Modified() {
    ...
    localUOutLineAppUnits51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uOutLineAppUnits51IsNumeric() {
    return decimalIsNumeric(
        beginUOutLineAppUnits51,
        U_OUT_LINE_APP_UNITS_51_LEN); // check Packed Decimal field to see if it contains valid
                                      // Number
  }
  ...
  /**
   * refreshUOutLineAppUnits51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public int refreshUOutLineAppUnits51() throws CFException {
    try {
      ...
      throw getSoc7ABend(
          "uOutLineAppUnits51", beginUOutLineAppUnits51, U_OUT_LINE_APP_UNITS_51_LEN);
    }
  }
  ...
  public boolean isUOutSpiTblId51Modified() {
    ...
    localUOutSpiTblId51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUOutSpiTblId51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUOutSpiTblId51() {
    return (substring(
        getStringValue(), beginUOutSpiTblId51, beginUOutSpiTblId51 + U_OUT_SPI_TBL_ID_51_LEN));
  }
  ...
  public boolean isUOutPosTierCd51Modified() {
    ...
    localUOutPosTierCd51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshUOutPosTierCd51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUOutPosTierCd51() {
    return (substring(
        getStringValue(), beginUOutPosTierCd51, beginUOutPosTierCd51 + U_OUT_POS_TIER_CD_51_LEN));
  }
  ...
  public boolean isUOutDiagElgInd51Modified() {
    ...
    localUOutDiagElgInd51Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeUOutDiagElgInd51(char[] uOutDiagElgInd51) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        uOutDiagElgInd51, 0, getStringValue(), beginUOutDiagElgInd51, U_OUT_DIAG_ELG_IND_51_LEN);
  ...
  /**
   * refreshUOutDiagElgInd51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshUOutDiagElgInd51() {
    return (substring(
        getStringValue(),
        beginUOutDiagElgInd51,
        beginUOutDiagElgInd51 + U_OUT_DIAG_ELG_IND_51_LEN));
  }
}
