...
/**
 * The class CetCicsErrorTableGroupSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class CetCicsErrorTableGroupSerialized extends Field {
  ...
  public boolean isCetCicsErrorTableRedefined02Modified() {
    ...
    localCetCicsErrorTableRedefined02Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCetCicsErrorTableRedefined02(char[] cetCicsErrorTableRedefined02) {
    ...
    arraycopy(
        cetCicsErrorTableRedefined02,
        0,
        getStringValue(),
        beginCetCicsErrorTableRedefined02,
        CET_CICS_ERROR_TABLE_REDEFINED_02_LEN);
    localCetCicsErrorTableRedefined02Counter =
        shareString.getSerializedField().getModifiedCounter();
  }
  ...
  /**
   * refreshCetCicsErrorTableRedefined02 is used to refresh the latest value of a variable from the
  ...
  public char[] refreshCetCicsErrorTableRedefined02() {
    return (substring(
        getStringValue(),
        beginCetCicsErrorTableRedefined02,
        beginCetCicsErrorTableRedefined02 + CET_CICS_ERROR_TABLE_REDEFINED_02_LEN));
  }
}
