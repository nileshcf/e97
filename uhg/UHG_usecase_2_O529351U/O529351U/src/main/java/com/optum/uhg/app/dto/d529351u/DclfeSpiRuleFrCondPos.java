...
public class DclfeSpiRuleFrCondPos extends DclfeSpiRuleFrCondPosSerialized {
  ...
  /**
   * set variable fcndSpiTblId Corresponding COBOL Variable is FCND-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update FcndSpiTblId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndSpiTblId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndSpiTblId(
  ...
  /**
   * Update FcndSpiTblId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndSpiTblId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndSpiTblId(
  ...
  /**
   * set variable fcndStsCd Corresponding COBOL Variable is FCND-STS-CD
   *
   * @param value
   */
  ...
  /**
   * Update FcndStsCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndStsCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndStsCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndStsCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndStsCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndStsCd(
  ...
  /**
   * set variable fcndDerivPlOfSvcCd Corresponding COBOL Variable is FCND-DERIV-PL-OF-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivPlOfSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivPlOfSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndDerivPlOfSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndDerivPlOfSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivPlOfSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndDerivPlOfSvcCd(
  ...
  /**
   * set variable fcndDerivSvcCd Corresponding COBOL Variable is FCND-DERIV-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndDerivSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndDerivSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndDerivSvcCd(
  ...
  /**
   * set variable fcndDerivCausCd Corresponding COBOL Variable is FCND-DERIV-CAUS-CD
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivCausCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivCausCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndDerivCausCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndDerivCausCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndDerivCausCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndDerivCausCd(
  ...
  /**
   * set variable fcndCreatDttm Corresponding COBOL Variable is FCND-CREAT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update FcndCreatDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndCreatDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndCreatDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndCreatDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndCreatDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndCreatDttm(
  ...
  /**
   * Update FcndFromCondPosSeqNbr with the passed value Corresponding COBOL Variable is
   * FCND-FROM-COND-POS-SEQ-NBR
   *
   * @param number
   */
  ...
  public void setFcndFromCondPosSeqNbr(int number) {
    number =
        checkFcndFromCondPosSeqNbrMaxLimit(
  ...
  /**
   * set variable fcndFromCondPos Corresponding COBOL Variable is FCND-FROM-COND-POS
   *
   * @param value
   */
  ...
  /**
   * Update FcndFromCondPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndFromCondPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndFromCondPos(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndFromCondPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndFromCondPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndFromCondPos(
  ...
  /**
   * set variable fcndPgmId Corresponding COBOL Variable is FCND-PGM-ID
   *
   * @param value
   */
  ...
  /**
   * Update FcndPgmId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndPgmId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndPgmId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndPgmId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndPgmId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndPgmId(
  ...
  /**
   * set variable fcndLstUpdtDttm Corresponding COBOL Variable is FCND-LST-UPDT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update FcndLstUpdtDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndLstUpdtDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndLstUpdtDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndLstUpdtDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndLstUpdtDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndLstUpdtDttm(
  ...
  /**
   * set variable fcndLstUpdtUserId Corresponding COBOL Variable is FCND-LST-UPDT-USER-ID
   *
   * @param value
   */
  ...
  /**
   * Update FcndLstUpdtUserId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndLstUpdtUserId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndLstUpdtUserId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FcndLstUpdtUserId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FcndLstUpdtUserId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFcndLstUpdtUserId(
  ...
  /**
   * initializes DclfeSpiRuleFrCondPos String fields defaults to Spaces short/int/long defaults to
