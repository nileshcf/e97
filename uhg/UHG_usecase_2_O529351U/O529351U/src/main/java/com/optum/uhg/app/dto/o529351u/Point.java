...
public class Point extends PointSerialized {
  ...
  /**
   * Update Point1 with the passed value Corresponding COBOL Variable is WS-POINT-1
   *
   * @param number
   */
  ...
  /**
   * Update Point2 with the passed value Corresponding COBOL Variable is WS-POINT-2
   *
   * @param number
   */
  ...
  /**
   * Update Point3 with the passed value Corresponding COBOL Variable is WS-POINT-3
   *
   * @param number
   */
  ...
  /**
   * Update Point4 with the passed value Corresponding COBOL Variable is WS-POINT-4
   *
   * @param number
   */
