...
/**
 * The class D51uKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class D51uKeySerialized extends Field {
  ...
  /**
   * sets parent for this D51uKeySerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isD51uKeyFeSpiModified() {
    ...
    localD51uKeyFeSpiCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uKeyFeSpi is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uKeyFeSpi() {
    return (substring(
        getStringValue(), beginD51uKeyFeSpi, beginD51uKeyFeSpi + D_51U_KEY_FE_SPI_LEN));
  }
  ...
  public boolean isD51uKeyStatusModified() {
    ...
    localD51uKeyStatusCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uKeyStatus is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uKeyStatus() {
    return (substring(
        getStringValue(), beginD51uKeyStatus, beginD51uKeyStatus + D_51U_KEY_STATUS_LEN));
  }
  ...
  public boolean isD51uKeyPolicyModified() {
    ...
    localD51uKeyPolicyCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uKeyPolicy is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uKeyPolicy() {
    return (substring(
        getStringValue(), beginD51uKeyPolicy, beginD51uKeyPolicy + D_51U_KEY_POLICY_LEN));
  }
  ...
  public boolean isD51uKeyPlanModified() {
    ...
    localD51uKeyPlanCounter = sharedCounter;
    return hasModified;
  }
