...
public class D51uRetRulFrCondPos extends D51uRetRulFrCondPosSerialized {
  ...
  /**
   * Returns the value of d51uRetRuleFrCondPos Corresponding COBOL Variable is
   * D51U-RET-RULE-FR-COND-POS
   *
  ...
  public D51uRetRuleFrCondPos getD51uRetRuleFrCondPos(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRuleFrCondPos - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RULE_FR_COND_POS_SIZE);
    }
    if (index >= d51uRetRuleFrCondPos.size()) {
      ...
      d51uRetRuleFrCondPos.set(
          index,
          new D51uRetRuleFrCondPos(
              this,
              beginD51uRetRuleFrCondPos
                  + index * D51uRetRuleFrCondPos.getD51uRetRuleFrCondPosFieldLength()));
    }
  ...
  /**
   * Update D51uRetRuleFrCondPos at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RULE-FR-COND-POS
   *
   * @param index
   * @param value
