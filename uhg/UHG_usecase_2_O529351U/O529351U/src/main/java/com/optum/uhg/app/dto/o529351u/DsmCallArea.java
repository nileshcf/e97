...
public class DsmCallArea extends DsmCallAreaSerialized {
  ...
  public DsmCallArea() {
    ...
    replaceValue( // serialize and save the value
        ("VYDSMARA - STARTS HERE  ").toCharArray(), getStartOffset() + 0, 24);
  }
  ...
  /**
   * Update DsmCommonArea with the passed value Corresponding COBOL Variable is DSM-COMMON-AREA
   *
   * @param value
   */
  ...
  /**
   * Update DsmCommonArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmCommonArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmCommonArea(
  ...
  /**
   * Update DsmCommonArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmCommonArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmCommonArea(
  ...
  /**
   * Update DsmLogArea with the passed value Corresponding COBOL Variable is DSM-LOG-AREA
   *
   * @param value
   */
  ...
  /**
   * initializes DsmCallArea String fields defaults to Spaces short/int/long defaults to zero
