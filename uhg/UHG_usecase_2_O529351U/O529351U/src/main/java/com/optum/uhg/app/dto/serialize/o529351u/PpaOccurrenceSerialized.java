...
/**
 * The class PpaOccurrenceSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class PpaOccurrenceSerialized extends Field {
  ...
  /**
   * sets parent for this PpaOccurrenceSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isPpaProductModified() {
    ...
    localPpaProductCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPpaMarketTypeModified() {
    ...
    localPpaMarketTypeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean ppaMarketTypeIsNumeric() {
    return decimalIsNumeric(
        beginPpaMarketType,
        PPA_MARKET_TYPE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaMarketType is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isPpaMarketModified() {
    ...
    localPpaMarketCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean ppaMarketIsNumeric() {
    return decimalIsNumeric(
        beginPpaMarket,
        PPA_MARKET_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isPpaIpaModified() {
    ...
    localPpaIpaCounter = sharedCounter;
    return hasModified;
  }

  public boolean ppaIpaIsNumeric() {
    return decimalIsNumeric(
        beginPpaIpa, PPA_IPA_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaIpa is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isPpaGrpTabNoModified() {
    ...
    localPpaGrpTabNoCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPpaContractArrangeModified() {
    ...
    localPpaContractArrangeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializePpaContractArrange(char[] ppaContractArrange) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        ppaContractArrange, 0, getStringValue(), beginPpaContractArrange, PPA_CONTRACT_ARRANGE_LEN);
  ...
  /**
   * refreshPpaContractArrange is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPpaContractArrange() {
    return (substring(
        getStringValue(),
        beginPpaContractArrange,
        beginPpaContractArrange + PPA_CONTRACT_ARRANGE_LEN));
  }
  ...
  public boolean isPpaFirstEffDateModified() {
    ...
    localPpaFirstEffDateCounter = sharedCounter;
    return hasModified;
  }

  public boolean ppaFirstEffDateIsNumeric() {
    return decimalIsNumeric(
        beginPpaFirstEffDate,
        PPA_FIRST_EFF_DATE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaFirstEffDate is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isPpaLastCanDateModified() {
    ...
    localPpaLastCanDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean ppaLastCanDateIsNumeric() {
    return decimalIsNumeric(
        beginPpaLastCanDate,
        PPA_LAST_CAN_DATE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaLastCanDate is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isPpaFacContrModified() {
    ...
    localPpaFacContrCounter = sharedCounter;
    return hasModified;
  }
