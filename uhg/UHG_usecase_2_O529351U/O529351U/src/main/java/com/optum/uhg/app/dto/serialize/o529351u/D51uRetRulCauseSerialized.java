...
/**
 * The class D51uRetRulCauseSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulCauseSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulCauseSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uCausDrvPosModified() {
    ...
    localD51uCausDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uCausDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausDrvPos() {
    return (substring(
        getStringValue(), beginD51uCausDrvPos, beginD51uCausDrvPos + D_51U_CAUS_DRV_POS_LEN));
  }
  ...
  public boolean isD51uCausDrvSvcModified() {
    ...
    localD51uCausDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uCausDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausDrvSvc() {
    return (substring(
        getStringValue(), beginD51uCausDrvSvc, beginD51uCausDrvSvc + D_51U_CAUS_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uCausDrvCauModified() {
    ...
    localD51uCausDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uCausDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausDrvCau() {
    return (substring(
        getStringValue(), beginD51uCausDrvCau, beginD51uCausDrvCau + D_51U_CAUS_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd1Modified() {
    ...
    localD51uCausClmCauseCd1Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd1(char[] d51uCausClmCauseCd1) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd1,
        D_51U_CAUS_CLM_CAUSE_CD_1_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd1 is used to refresh the latest value of a variable from the
  ...
  public char[] refreshD51uCausClmCauseCd1() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd1,
        beginD51uCausClmCauseCd1 + D_51U_CAUS_CLM_CAUSE_CD_1_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd2Modified() {
    ...
    localD51uCausClmCauseCd2Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd2(char[] d51uCausClmCauseCd2) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd2,
        D_51U_CAUS_CLM_CAUSE_CD_2_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd2 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd2() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd2,
        beginD51uCausClmCauseCd2 + D_51U_CAUS_CLM_CAUSE_CD_2_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd3Modified() {
    ...
    localD51uCausClmCauseCd3Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd3(char[] d51uCausClmCauseCd3) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd3,
        D_51U_CAUS_CLM_CAUSE_CD_3_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd3 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd3() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd3,
        beginD51uCausClmCauseCd3 + D_51U_CAUS_CLM_CAUSE_CD_3_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd4Modified() {
    ...
    localD51uCausClmCauseCd4Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd4(char[] d51uCausClmCauseCd4) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd4,
        D_51U_CAUS_CLM_CAUSE_CD_4_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd4 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd4() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd4,
        beginD51uCausClmCauseCd4 + D_51U_CAUS_CLM_CAUSE_CD_4_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd5Modified() {
    ...
    localD51uCausClmCauseCd5Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd5(char[] d51uCausClmCauseCd5) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd5,
        D_51U_CAUS_CLM_CAUSE_CD_5_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd5 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd5() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd5,
        beginD51uCausClmCauseCd5 + D_51U_CAUS_CLM_CAUSE_CD_5_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd6Modified() {
    ...
    localD51uCausClmCauseCd6Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd6(char[] d51uCausClmCauseCd6) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd6,
        D_51U_CAUS_CLM_CAUSE_CD_6_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd6 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd6() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd6,
        beginD51uCausClmCauseCd6 + D_51U_CAUS_CLM_CAUSE_CD_6_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd7Modified() {
    ...
    localD51uCausClmCauseCd7Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd7(char[] d51uCausClmCauseCd7) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd7,
        D_51U_CAUS_CLM_CAUSE_CD_7_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd7 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd7() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd7,
        beginD51uCausClmCauseCd7 + D_51U_CAUS_CLM_CAUSE_CD_7_LEN));
  }
  ...
  public boolean isD51uCausClmCauseCd8Modified() {
    ...
    localD51uCausClmCauseCd8Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uCausClmCauseCd8(char[] d51uCausClmCauseCd8) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uCausClmCauseCd8,
        D_51U_CAUS_CLM_CAUSE_CD_8_LEN);
  ...
  /**
   * refreshD51uCausClmCauseCd8 is used to refresh the latest value of a variable from the
   * Serialized String the most common reason to serialize an Object as a string in to write to a
   * file. There can be several other reasons for serialization as well
   */
  public char[] refreshD51uCausClmCauseCd8() {
    return (substring(
        getStringValue(),
        beginD51uCausClmCauseCd8,
        beginD51uCausClmCauseCd8 + D_51U_CAUS_CLM_CAUSE_CD_8_LEN));
  }
}
