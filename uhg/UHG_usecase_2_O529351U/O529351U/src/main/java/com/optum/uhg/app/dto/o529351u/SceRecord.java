...
public class SceRecord extends SceRecordSerialized {
  ...
  /**
   * Update SceKey with the passed value Corresponding COBOL Variable is SCE-KEY
   *
   * @param value
   */
  ...
  /**
   * Update SceKey with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceKey with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceKey(
  ...
  /**
   * Update SceKey with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceKey with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceKey(
  ...
  /**
   * Update SceAltKey with the passed value Corresponding COBOL Variable is SCE-ALT-KEY
   *
   * @param value
   */
  ...
  /**
   * Update SceAltKey with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceAltKey with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceAltKey(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SceAltKey with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceAltKey with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceAltKey(
  ...
  /**
   * set variable sceFromHcpcsCpt Corresponding COBOL Variable is SCE-FROM-HCPCS-CPT
   *
   * @param value
   */
  ...
  /**
   * Update SceFromHcpcsCpt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceFromHcpcsCpt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceFromHcpcsCpt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SceFromHcpcsCpt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SceFromHcpcsCpt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSceFromHcpcsCpt(
