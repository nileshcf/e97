...
public class DsmRecDetailsArea extends DsmRecDetailsAreaSerialized {
  ...
  /**
   * set variable dsmRecIcn Corresponding COBOL Variable is DSM-REC-ICN
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecIcn with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecIcn with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecIcn(
  ...
  /**
   * Update DsmRecIcn with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecIcn with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecIcn(
  ...
  /**
   * set variable dsmRecIcnSufxCd Corresponding COBOL Variable is DSM-REC-ICN-SUFX-CD
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecIcnSufxCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecIcnSufxCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecIcnSufxCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DsmRecIcnSufxCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecIcnSufxCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecIcnSufxCd(
  ...
  /**
   * Update DsmRecVersNbr with the passed value Corresponding COBOL Variable is DSM-REC-VERS-NBR
   *
   * @param number
   */
  ...
  /**
   * set variable dsmRecProcDate Corresponding COBOL Variable is DSM-REC-PROC-DATE
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecProcDate with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecProcDate with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecProcDate(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DsmRecProcDate with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecProcDate with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecProcDate(
  ...
  /**
   * set variable dsmRecProcTime Corresponding COBOL Variable is DSM-REC-PROC-TIME
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecProcTime with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecProcTime with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecProcTime(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DsmRecProcTime with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DsmRecProcTime with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDsmRecProcTime(
  ...
  /**
   * initializes DsmRecDetailsArea String fields defaults to Spaces short/int/long defaults to zero
