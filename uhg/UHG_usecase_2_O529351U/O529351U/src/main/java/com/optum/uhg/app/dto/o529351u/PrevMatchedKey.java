...
public class PrevMatchedKey extends PrevMatchedKeySerialized {
  ...
  /**
   * set variable prevPs Corresponding COBOL Variable is WS-PREV-PS
   *
   * @param value
   */
  ...
  /**
   * Update PrevPs with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PrevPs with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPrevPs(
  ...
  /**
   * Update PrevPs with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PrevPs with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPrevPs(
  ...
  /**
   * set variable prevSvc Corresponding COBOL Variable is WS-PREV-SVC
   *
   * @param value
   */
  ...
  /**
   * Update PrevSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PrevSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPrevSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PrevSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PrevSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPrevSvc(
  ...
  /**
   * set variable prevCauseCd Corresponding COBOL Variable is WS-PREV-CAUSE-CD
   *
   * @param value
   */
  ...
  /**
   * Update PrevCauseCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PrevCauseCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPrevCauseCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PrevCauseCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PrevCauseCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPrevCauseCd(
