...
public class WorkSerialized extends Field {
  ...
  public boolean isW02AbsoluteTimeModified() {
    ...
    localW02AbsoluteTimeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDdSpirulesModified() {
    ...
    localDdSpirulesCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDdPlanvaraModified() {
    ...
    localDdPlanvaraCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFirstTimeThruModified() {
    ...
    localFirstTimeThruCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlanVarFoundSwModified() {
    ...
    localPlanVarFoundSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPosTierFoundSwModified() {
    ...
    localPosTierFoundSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isNewPlanVarFoundSwModified() {
    ...
    localNewPlanVarFoundSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isEndOfPlanAltModified() {
    ...
    localEndOfPlanAltCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isEndOfSpiRuleModified() {
    ...
    localEndOfSpiRuleCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isTopsCnvSvcModified() {
    ...
    localTopsCnvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isNbrEqualModified() {
    ...
    localNbrEqualCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSearchCompleteModified() {
    ...
    localSearchCompleteCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFromPsFoundModified() {
    ...
    localFromPsFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFromSvcFoundModified() {
    ...
    localFromSvcFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFromPrvFoundModified() {
    ...
    localFromPrvFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFromIcd9FoundModified() {
    ...
    localFromIcd9FoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFromCauseFoundModified() {
    ...
    localFromCauseFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isUseDiagnosisSwModified() {
    ...
    localUseDiagnosisSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isIpaCodeFoundModified() {
    ...
    localIpaCodeFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCpeFlgFoundModified() {
    ...
    localCpeFlgFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isIpaAndGtnFoundModified() {
    ...
    localIpaAndGtnFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isGtnLoadedModified() {
    ...
    localGtnLoadedCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSameTableModified() {
    ...
    localSameTableCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isKeyCompleteModified() {
    ...
    localKeyCompleteCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isWithMmiSw2010Modified() {
    ...
    localWithMmiSw2010Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isMmiFoundSwModified() {
    ...
    localMmiFoundSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPrimDiagFoundModified() {
    ...
    localPrimDiagFoundCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isD529351uDb2DsmModified() {
    ...
    localD529351uDb2DsmCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isNewSpiSwModified() {
    ...
    localNewSpiSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPrimeSpiSwModified() {
    ...
    localPrimeSpiSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isMedSvcNbrModified() {
    ...
    localMedSvcNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isMedSvcModified() {
    ...
    localMedSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFeSpiEnableIndModified() {
    ...
    localFeSpiEnableIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFePrimeSpiEnableIndModified() {
    ...
    localFePrimeSpiEnableIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isKeySubModified() {
    ...
    localKeySubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isGenSubModified() {
    ...
    localGenSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isNewSubModified() {
    ...
    localNewSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPsSubModified() {
    ...
    localPsSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSvcSubModified() {
    ...
    localSvcSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPvSubModified() {
    ...
    localPvSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isIcd9SubModified() {
    ...
    localIcd9SubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCauseSubModified() {
    ...
    localCauseSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isIpaSubModified() {
    ...
    localIpaSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCflgSubModified() {
    ...
    localCflgSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSub01Modified() {
    ...
    localSub01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDiagSubModified() {
    ...
    localDiagSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isDSubModified() {
    ...
    localDSubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isISubModified() {
    ...
    localISubCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSavHpriceCountModified() {
    ...
    localSavHpriceCountCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSavNbrOfOccurances2Modified() {
    ...
    localSavNbrOfOccurances2Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSavMpriceCountModified() {
    ...
    localSavMpriceCountCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSavNbrOfOccurances3Modified() {
    ...
    localSavNbrOfOccurances3Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSazgrpNumGrpModified() {
    ...
    localSazgrpNumGrpCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean sazgrpNumGrpIsNumeric() {
    return decimalIsNumeric(
        beginSazgrpNumGrp,
        SAZGRP_NUM_GRP_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshSazgrpNumGrp is used to refresh the latest value of a variable from the Serialized
  ...
  protected void serializeSazgrpGroups(int index, char[] value) {
    replaceValue(value, (beginSazgrpGroups + index * SAZGRP_GROUPS_LEN), SAZGRP_GROUPS_LEN);
  }
  ...
  public boolean isFunctionFlagModified() {
    ...
    localFunctionFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isIllogicalCondModified() {
    ...
    localIllogicalCondCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isLsEqiRecordModified() {
    ...
    localLsEqiRecordCounter = sharedCounter;
    return hasModified;
  }
