...
public class D51uRetRulKeys extends D51uRetRulKeysSerialized {
  ...
  /**
   * Returns the value of d51uRetRuleKeys Corresponding COBOL Variable is D51U-RET-RULE-KEYS
   *
  ...
  public D51uRetRuleKeys getD51uRetRuleKeys(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRuleKeys - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RULE_KEYS_SIZE);
    }
    if (index >= d51uRetRuleKeys.size()) {
      ...
      d51uRetRuleKeys.set(
          ...
          new D51uRetRuleKeys(
              this,
              beginD51uRetRuleKeys + index * D51uRetRuleKeys.getD51uRetRuleKeysFieldLength()));
    }
  ...
  /**
   * Update D51uRetRuleKeys at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RULE-KEYS
   *
   * @param index
   * @param value
