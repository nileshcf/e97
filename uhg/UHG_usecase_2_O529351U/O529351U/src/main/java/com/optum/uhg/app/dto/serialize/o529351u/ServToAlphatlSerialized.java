...
/**
 * The class ServToAlphatlSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class ServToAlphatlSerialized extends Field {
  ...
  /**
   * sets parent for this ServToAlphatlSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFeSvc14alToModified() {
    ...
    localFeSvc14alToCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFeSvc5alToModified() {
    ...
    localFeSvc5alToCounter = sharedCounter;
    return hasModified;
  }
