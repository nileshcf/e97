...
/**
 * The class UGenericTranslation51Serialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class UGenericTranslation51Serialized extends Field {
  ...
  /**
   * sets parent for this UGenericTranslation51Serialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
