...
/**
 * The class D51uRetRulIcdSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulIcdSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulIcdSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
