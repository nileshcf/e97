...
/**
 * The class D51uRetRulFrCondPosSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class D51uRetRulFrCondPosSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulFrCondPosSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
