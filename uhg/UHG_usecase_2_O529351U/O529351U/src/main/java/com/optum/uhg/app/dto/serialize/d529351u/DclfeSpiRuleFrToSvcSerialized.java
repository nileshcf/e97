...
/**
 * The class DclfeSpiRuleFrToSvcSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DclfeSpiRuleFrToSvcSerialized extends Field {
  ...
  public boolean isFrtoSpiTblIdModified() {
    ...
    localFrtoSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoSpiTblId() {
    return (substring(
        getStringValue(), beginFrtoSpiTblId, beginFrtoSpiTblId + FRTO_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isFrtoStsCdModified() {
    ...
    localFrtoStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFrtoDerivPlOfSvcCdModified() {
    ...
    localFrtoDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeFrtoDerivPlOfSvcCd(char[] frtoDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginFrtoDerivPlOfSvcCd,
        FRTO_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshFrtoDerivPlOfSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginFrtoDerivPlOfSvcCd,
        beginFrtoDerivPlOfSvcCd + FRTO_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isFrtoDerivSvcCdModified() {
    ...
    localFrtoDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoDerivSvcCd() {
    return (substring(
        getStringValue(), beginFrtoDerivSvcCd, beginFrtoDerivSvcCd + FRTO_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isFrtoDerivCausCdModified() {
    ...
    localFrtoDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoDerivCausCd() {
    return (substring(
        getStringValue(), beginFrtoDerivCausCd, beginFrtoDerivCausCd + FRTO_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isFrtoCreatDttmModified() {
    ...
    localFrtoCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoCreatDttm() {
    return (substring(
        getStringValue(), beginFrtoCreatDttm, beginFrtoCreatDttm + FRTO_CREAT_DTTM_LEN));
  }
  ...
  public boolean isFrtoFromToSvcSeqNbrModified() {
    ...
    localFrtoFromToSvcSeqNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoFromToSvcSeqNbr is used to refresh the latest value of a variable from the
  ...
  public boolean isFrtoClmFrmSvcCdModified() {
    ...
    localFrtoClmFrmSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoClmFrmSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoClmFrmSvcCd() {
    return (substring(
        getStringValue(), beginFrtoClmFrmSvcCd, beginFrtoClmFrmSvcCd + FRTO_CLM_FRM_SVC_CD_LEN));
  }
  ...
  public boolean isFrtoClmToSvcCdModified() {
    ...
    localFrtoClmToSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoClmToSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoClmToSvcCd() {
    return (substring(
        getStringValue(), beginFrtoClmToSvcCd, beginFrtoClmToSvcCd + FRTO_CLM_TO_SVC_CD_LEN));
  }
  ...
  public boolean isFrtoSvcTypCdModified() {
    ...
    localFrtoSvcTypCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoSvcTypCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoSvcTypCd() {
    return (substring(
        getStringValue(), beginFrtoSvcTypCd, beginFrtoSvcTypCd + FRTO_SVC_TYP_CD_LEN));
  }
  ...
  public boolean isFrtoPgmIdModified() {
    ...
    localFrtoPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFrtoLstUpdtDttmModified() {
    ...
    localFrtoLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFrtoLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoLstUpdtDttm() {
    return (substring(
        getStringValue(), beginFrtoLstUpdtDttm, beginFrtoLstUpdtDttm + FRTO_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isFrtoLstUpdtUserIdModified() {
    ...
    localFrtoLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeFrtoLstUpdtUserId(char[] frtoLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        frtoLstUpdtUserId, 0, getStringValue(), beginFrtoLstUpdtUserId, FRTO_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshFrtoLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFrtoLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginFrtoLstUpdtUserId,
        beginFrtoLstUpdtUserId + FRTO_LST_UPDT_USER_ID_LEN));
  }
  ...
  public boolean isFrtoHipaaCdModified() {
    ...
    localFrtoHipaaCdCounter = sharedCounter;
    return hasModified;
  }
