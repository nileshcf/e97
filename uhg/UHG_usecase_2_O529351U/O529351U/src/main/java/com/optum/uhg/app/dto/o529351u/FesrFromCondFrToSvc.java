...
public class FesrFromCondFrToSvc extends FesrFromCondFrToSvcSerialized {
  ...
  /**
   * set variable fesrFromFrSvc Corresponding COBOL Variable is FESR-FROM-FR-SVC
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromFrSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromFrSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromFrSvc(
  ...
  /**
   * Update FesrFromFrSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromFrSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromFrSvc(
  ...
  /**
   * set variable fesrFromToSvc Corresponding COBOL Variable is FESR-FROM-TO-SVC
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromToSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromToSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromToSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesrFromToSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromToSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromToSvc(
  ...
  /**
   * set variable fesrSvcInd Corresponding COBOL Variable is FESR-SVC-IND
   *
   * @param value
   */
  ...
  /**
   * Update FesrSvcInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrSvcInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrSvcInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesrSvcInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrSvcInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrSvcInd(
