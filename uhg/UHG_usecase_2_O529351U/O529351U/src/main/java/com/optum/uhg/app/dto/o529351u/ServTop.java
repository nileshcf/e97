...
public class ServTop extends ServTopSerialized {
  ...
  /**
   * set variable svc15 Corresponding COBOL Variable is SVC-1-5
   *
   * @param value
   */
  ...
  /**
   * Update Svc15 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc15 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc15(
  ...
  /**
   * Update Svc15 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc15 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc15(
  ...
  /**
   * set variable svc6 Corresponding COBOL Variable is SVC-6
   *
   * @param value
   */
  ...
  /**
   * Update Svc6 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc6 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc6(
  ...
  /**
   * Update Svc6 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc6 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc6(
