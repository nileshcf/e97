...
/**
 * The class D51uRetRulFrToSvcSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulFrToSvcSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulFrToSvcSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
