...
/**
 * The class D51uRetRulIpaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulIpaSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulIpaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
