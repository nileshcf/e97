...
public class PpaPpoId extends PpaPpoIdSerialized {
  ...
  /**
   * Update PpaOccurrence with the passed value Corresponding COBOL Variable is PPA-OCCURRENCE
   *
   * @param value
   */
  ...
  /**
   * Update PpaOccurrence with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaOccurrence with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaOccurrence(
  ...
  /**
   * Update PpaOccurrence with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaOccurrence with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaOccurrence(
