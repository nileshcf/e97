...
/**
 * The class DsmSqlErrorMsgAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DsmSqlErrorMsgAreaSerialized extends Field {
  ...
  /**
   * sets parent for this DsmSqlErrorMsgAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isDsmErrTblNameModified() {
    ...
    localDsmErrTblNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDsmErrTblName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDsmErrTblName() {
    return (substring(
        getStringValue(), beginDsmErrTblName, beginDsmErrTblName + DSM_ERR_TBL_NAME_LEN));
  }
  ...
  public boolean isDsmErrSectnNameModified() {
    ...
    localDsmErrSectnNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDsmErrSectnName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDsmErrSectnName() {
    return (substring(
        getStringValue(), beginDsmErrSectnName, beginDsmErrSectnName + DSM_ERR_SECTN_NAME_LEN));
  }
  ...
  public boolean isDsmErrPgmNameModified() {
    ...
    localDsmErrPgmNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDsmErrPgmName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDsmErrPgmName() {
    return (substring(
        getStringValue(), beginDsmErrPgmName, beginDsmErrPgmName + DSM_ERR_PGM_NAME_LEN));
  }
  ...
  public boolean isDsmErrClngPgmNameModified() {
    ...
    localDsmErrClngPgmNameCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDsmErrClngPgmName(char[] dsmErrClngPgmName) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        dsmErrClngPgmName, 0, getStringValue(), beginDsmErrClngPgmName, DSM_ERR_CLNG_PGM_NAME_LEN);
  ...
  /**
   * refreshDsmErrClngPgmName is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDsmErrClngPgmName() {
    return (substring(
        getStringValue(),
        beginDsmErrClngPgmName,
        beginDsmErrClngPgmName + DSM_ERR_CLNG_PGM_NAME_LEN));
  }
  ...
  public boolean isDsmErrTblActionModified() {
    ...
    localDsmErrTblActionCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDsmErrTblAction is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDsmErrTblAction() {
    return (substring(
        getStringValue(), beginDsmErrTblAction, beginDsmErrTblAction + DSM_ERR_TBL_ACTION_LEN));
  }
  ...
  public boolean isDsmErrTxtModified() {
    ...
    localDsmErrTxtCounter = sharedCounter;
    return hasModified;
  }
