...
public class Vyspi51uCallArea extends Vyspi51uCallAreaSerialized {
  ...
  public Vyspi51uCallArea() {
    ...
    replaceValue( // serialize and save the value
        ("VYSPI51U - STARTS HERE  ").toCharArray(), getStartOffset() + 0, 24);
  }
  ...
  /**
   * Update D51uRequestFields with the passed value Corresponding COBOL Variable is
   * D51U-REQUEST-FIELDS
   *
   * @param value
   */
  ...
  /**
   * Update D51uRequestFields with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRequestFields with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRequestFields(
  ...
  /**
   * Update D51uRequestFields with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRequestFields with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRequestFields(
  ...
  /**
   * Update D51uReturnArea with the passed value Corresponding COBOL Variable is D51U-RETURN-AREA
   *
   * @param value
   */
  ...
  /**
   * Update D51uReturnArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uReturnArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uReturnArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uReturnArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uReturnArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uReturnArea(
