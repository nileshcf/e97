...
public class HvHostVariablesCsicdo extends HvHostVariablesCsicdoSerialized {
  ...
  /**
   * Returns the value of hv3aIcdDrvPos Corresponding COBOL Variable is HV3A-ICD-DRV-POS
   *
  ...
  public char[] getHv3aIcdDrvPos(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv3aIcdDrvPos - Array index exceeded max Size {}, resetting it to max allowed",
          HV_3A_ICD_DRV_POS_SIZE);
    }
    return getCharArray(
        (beginHv3aIcdDrvPos + index * HV_3A_ICD_DRV_POS_LEN), HV_3A_ICD_DRV_POS_LEN);
  }
  ...
  /**
   * Update Hv3aIcdDrvPos with the passed value at a given index Corresponding COBOL Variable is
   * HV3A-ICD-DRV-POS
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv3aIcdDrvPos with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv3aIcdDrvPos(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv3aIcdDrvPos(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv3bIcdDrvSvc Corresponding COBOL Variable is HV3B-ICD-DRV-SVC
   *
  ...
  public char[] getHv3bIcdDrvSvc(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv3bIcdDrvSvc - Array index exceeded max Size {}, resetting it to max allowed",
          HV_3B_ICD_DRV_SVC_SIZE);
    }
    return getCharArray(
        (beginHv3bIcdDrvSvc + index * HV_3B_ICD_DRV_SVC_LEN), HV_3B_ICD_DRV_SVC_LEN);
  }
  ...
  /**
   * Update Hv3bIcdDrvSvc with the passed value at a given index Corresponding COBOL Variable is
   * HV3B-ICD-DRV-SVC
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv3bIcdDrvSvc with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv3bIcdDrvSvc(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv3bIcdDrvSvc(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv3cIcdDrvCau Corresponding COBOL Variable is HV3C-ICD-DRV-CAU
   *
  ...
  public char[] getHv3cIcdDrvCau(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv3cIcdDrvCau - Array index exceeded max Size {}, resetting it to max allowed",
          HV_3C_ICD_DRV_CAU_SIZE);
    }
    return getCharArray(
        (beginHv3cIcdDrvCau + index * HV_3C_ICD_DRV_CAU_LEN), HV_3C_ICD_DRV_CAU_LEN);
  }
  ...
  /**
   * Update Hv3cIcdDrvCau with the passed value at a given index Corresponding COBOL Variable is
   * HV3C-ICD-DRV-CAU
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv3cIcdDrvCau with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv3cIcdDrvCau(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv3cIcdDrvCau(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv3dIcdTypCd Corresponding COBOL Variable is HV3D-ICD-TYP-CD
   *
   * @return hv3dIcdTypCd
   */
  ...
  public char[] getHv3dIcdTypCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv3dIcdTypCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_3D_ICD_TYP_CD_SIZE);
    }
  ...
  /**
   * Update Hv3dIcdTypCd with the passed value at a given index Corresponding COBOL Variable is
   * HV3D-ICD-TYP-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv3dIcdTypCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv3dIcdTypCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv3dIcdTypCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv3eClmFrmIcdCd Corresponding COBOL Variable is HV3E-CLM-FRM-ICD-CD
   *
  ...
  public char[] getHv3eClmFrmIcdCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv3eClmFrmIcdCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_3E_CLM_FRM_ICD_CD_SIZE);
    }
    return getCharArray(
        (beginHv3eClmFrmIcdCd + index * HV_3E_CLM_FRM_ICD_CD_LEN), HV_3E_CLM_FRM_ICD_CD_LEN);
  }
  ...
  /**
   * Update Hv3eClmFrmIcdCd with the passed value at a given index Corresponding COBOL Variable is
   * HV3E-CLM-FRM-ICD-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv3eClmFrmIcdCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv3eClmFrmIcdCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv3eClmFrmIcdCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv3fClmToIcdCd Corresponding COBOL Variable is HV3F-CLM-TO-ICD-CD
   *
  ...
  public char[] getHv3fClmToIcdCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv3fClmToIcdCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_3F_CLM_TO_ICD_CD_SIZE);
    }
    return getCharArray(
        (beginHv3fClmToIcdCd + index * HV_3F_CLM_TO_ICD_CD_LEN), HV_3F_CLM_TO_ICD_CD_LEN);
  }
  ...
  /**
   * Update Hv3fClmToIcdCd with the passed value at a given index Corresponding COBOL Variable is
   * HV3F-CLM-TO-ICD-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv3fClmToIcdCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv3fClmToIcdCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv3fClmToIcdCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
