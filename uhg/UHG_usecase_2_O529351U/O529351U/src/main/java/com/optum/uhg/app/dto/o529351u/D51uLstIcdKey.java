...
public class D51uLstIcdKey extends D51uLstIcdKeySerialized {
  ...
  /**
   * set variable d51uLstClmIcdInd Corresponding COBOL Variable is D51U-LST-CLM-ICD-IND
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdInd(
  ...
  /**
   * Update D51uLstClmIcdInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdInd(
  ...
  /**
   * set variable d51uLstClmIcdPos Corresponding COBOL Variable is D51U-LST-CLM-ICD-POS
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdPos(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uLstClmIcdPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdPos(
  ...
  /**
   * set variable d51uLstClmIcdSvc Corresponding COBOL Variable is D51U-LST-CLM-ICD-SVC
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uLstClmIcdSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdSvc(
  ...
  /**
   * set variable d51uLstClmIcdCau Corresponding COBOL Variable is D51U-LST-CLM-ICD-CAU
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdCau with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdCau with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdCau(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uLstClmIcdCau with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uLstClmIcdCau with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uLstClmIcdCau(
  ...
  /**
   * initializes D51uLstIcdKey String fields defaults to Spaces short/int/long defaults to zero
