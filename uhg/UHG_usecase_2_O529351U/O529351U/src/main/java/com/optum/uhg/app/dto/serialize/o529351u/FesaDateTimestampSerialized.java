...
/**
 * The class FesaDateTimestampSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FesaDateTimestampSerialized extends Field {
  ...
  /**
   * sets parent for this FesaDateTimestampSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesaDatestampModified() {
    ...
    localFesaDatestampCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaDatestampIsNumeric() {
    return decimalIsNumeric(
        beginFesaDatestamp,
        FESA_DATESTAMP_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesaDatestamp is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isFesaTimestampModified() {
    ...
    localFesaTimestampCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaTimestampIsNumeric() {
    return decimalIsNumeric(
        beginFesaTimestamp,
        FESA_TIMESTAMP_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesaTimestamp is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
