...
public class FesaKey extends FesaKeySerialized {
  ...
  /**
   * set variable fesaPolicy Corresponding COBOL Variable is FESA-POLICY
   *
   * @param value
   */
  ...
  /**
   * Update FesaPolicy with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaPolicy with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaPolicy(
  ...
  /**
   * Update FesaPolicy with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaPolicy with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaPolicy(
  ...
  /**
   * Update FesaPlanVar with the passed value Corresponding COBOL Variable is FESA-PLAN-VAR
   *
   * @param number
   */
  ...
  /**
   * Update FesaEffDate with the passed value Corresponding COBOL Variable is FESA-EFF-DATE
   *
   * @param number
   */
  ...
  /**
   * Update FesaSpiNbr with the passed value Corresponding COBOL Variable is FESA-SPI-NBR
   *
   * @param number
   */
