...
/**
 * The class MedPmtiVariableDetailDataSerialized is used to define offsets in order to serialize in
 * a fixed String
 *
...
public class MedPmtiVariableDetailDataSerialized extends Field {
  ...
  /**
   * sets parent for this MedPmtiVariableDetailDataSerialized to the parent and set the serialize
  ...
  public boolean isMedPmtiProvTinModified() {
    ...
    localMedPmtiProvTinCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeMedPmtiProvTin(char[] value) {
    ...
    replaceValue(padNumber(15, value, false /*isSigned?*/), beginMedPmtiProvTin, 15);
    localMedPmtiProvTinCounter = shareString.getSerializedField().getModifiedCounter();
    return medPmtiProvTin;
  }
  ...
  /**
   * refreshMedPmtiProvTin is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isMedPmtiSpecPayeeTinModified() {
    ...
    localMedPmtiSpecPayeeTinCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeMedPmtiSpecPayeeTin(char[] value) {
    ...
    medPmtiSpecPayeeTin =
        convertString2Number(
            value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(15, value, false /*isSigned?*/), beginMedPmtiSpecPayeeTin, 15);
    localMedPmtiSpecPayeeTinCounter = shareString.getSerializedField().getModifiedCounter();
    return medPmtiSpecPayeeTin;
  }
  ...
  /**
   * refreshMedPmtiSpecPayeeTin is used to refresh the latest value of a variable from the
  ...
  public long refreshMedPmtiSpecPayeeTin() throws CFException {
    try {
      ...
      throw getSoc7ABend(
          "medPmtiSpecPayeeTin", beginMedPmtiSpecPayeeTin, MED_PMTI_SPEC_PAYEE_TIN_LEN);
    }
  }
}
