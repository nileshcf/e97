...
/**
 * The class D51uRetRulProvTypSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulProvTypSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulProvTypSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
