...
/**
 * The class SaveRecType4FixedSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class SaveRecType4FixedSerialized extends Field {
  ...
  /**
   * sets parent for this SaveRecType4FixedSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
