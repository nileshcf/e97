...
public class D51uTestValues extends D51uTestValuesSerialized {
  ...
  /**
   * set variable d51uTestCaus Corresponding COBOL Variable is D51U-TEST-CAUS
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestCaus with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestCaus with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestCaus(
  ...
  /**
   * Update D51uTestCaus with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestCaus with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestCaus(
  ...
  /**
   * set variable d51uTestProvTyp Corresponding COBOL Variable is D51U-TEST-PROV-TYP
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestProvTyp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestProvTyp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestProvTyp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uTestProvTyp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestProvTyp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestProvTyp(
  ...
  /**
   * set variable d51uTestPos Corresponding COBOL Variable is D51U-TEST-POS
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestPos(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uTestPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestPos(
  ...
  /**
   * set variable d51uTestSvcCd Corresponding COBOL Variable is D51U-TEST-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uTestSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestSvcCd(
  ...
  /**
   * Update D51uTestDiagArea with the passed value Corresponding COBOL Variable is
   * D51U-TEST-DIAG-AREA
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestDiagArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestDiagArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestDiagArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uTestDiagArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestDiagArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestDiagArea(
  ...
  /**
   * set variable d51uTestCpeDescCd Corresponding COBOL Variable is D51U-TEST-CPE-DESC-CD
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestCpeDescCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestCpeDescCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestCpeDescCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uTestCpeDescCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uTestCpeDescCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uTestCpeDescCd(
  ...
  /**
   * initializes D51uTestValues String fields defaults to Spaces short/int/long defaults to zero
