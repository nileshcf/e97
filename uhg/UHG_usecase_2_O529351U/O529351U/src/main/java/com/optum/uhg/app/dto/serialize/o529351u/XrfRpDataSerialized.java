...
/**
 * The class XrfRpDataSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class XrfRpDataSerialized extends Field {
  ...
  /**
   * sets parent for this XrfRpDataSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isXrfPlcyRpModified() {
    ...
    localXrfPlcyRpCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isXrfDivRpModified() {
    ...
    localXrfDivRpCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeXrfDivRp(short xrfDivRp) {
    replaceValue( //  save the value as string
        getBinaryString(xrfDivRp, XRF_DIV_RP_LEN), beginXrfDivRp, XRF_DIV_RP_LEN);
  ...
  public boolean isXrfClsRpModified() {
    ...
    localXrfClsRpCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeXrfClsRp(short xrfClsRp) {
    replaceValue( //  save the value as string
        getBinaryString(xrfClsRp, XRF_CLS_RP_LEN), beginXrfClsRp, XRF_CLS_RP_LEN);
  ...
  public boolean isXrfSuffRpModified() {
    ...
    localXrfSuffRpCounter = sharedCounter;
    return hasModified;
  }
