...
/**
 * The class TestVariablesSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class TestVariablesSerialized extends Field {
  ...
  public boolean isTestCausModified() {
    ...
    localTestCausCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isTestProvTypModified() {
    ...
    localTestProvTypCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isTestPosModified() {
    ...
    localTestPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshTestPos is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isTestSvcCdModified() {
    ...
    localTestSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isTestCpeDescCdModified() {
    ...
    localTestCpeDescCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshTestCpeDescCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshTestCpeDescCd() {
    return (substring(
        getStringValue(), beginTestCpeDescCd, beginTestCpeDescCd + TEST_CPE_DESC_CD_LEN));
  }
}
