...
/**
 * The class PlanEffDtSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class PlanEffDtSerialized extends Field {
  ...
  /**
   * sets parent for this PlanEffDtSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isPlanEffCcModified() {
    ...
    localPlanEffCcCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanEffCc(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanEffCc, 2);
    localPlanEffCcCounter = shareString.getSerializedField().getModifiedCounter();
    return planEffCc;
  }
  ...
  public boolean isPlanEffYyModified() {
    ...
    localPlanEffYyCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanEffYy(char[] value) {
    ...
    planEffYy =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanEffYy, 2);
    localPlanEffYyCounter = shareString.getSerializedField().getModifiedCounter();
    return planEffYy;
  }
