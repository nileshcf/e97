...
public class XrfRpData extends XrfRpDataSerialized {
  ...
  /**
   * set variable xrfPlcyRp Corresponding COBOL Variable is XRF-PLCY-RP
   *
   * @param value
   */
  ...
  /**
   * Update XrfPlcyRp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfPlcyRp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfPlcyRp(
  ...
  /**
   * Update XrfPlcyRp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfPlcyRp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfPlcyRp(
  ...
  /**
   * Update XrfDivRp with the passed value Corresponding COBOL Variable is XRF-DIV-RP
   *
   * @param number
   */
  ...
  /**
   * Update XrfClsRp with the passed value Corresponding COBOL Variable is XRF-CLS-RP
   *
   * @param number
   */
  ...
  /**
   * set variable xrfSuffRp Corresponding COBOL Variable is XRF-SUFF-RP
   *
   * @param value
   */
  ...
  /**
   * Update XrfSuffRp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfSuffRp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfSuffRp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update XrfSuffRp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfSuffRp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfSuffRp(
