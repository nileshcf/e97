...
/**
 * The class DclfeSpiRuleFrCondPosSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DclfeSpiRuleFrCondPosSerialized extends Field {
  ...
  public boolean isFcndSpiTblIdModified() {
    ...
    localFcndSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndSpiTblId() {
    return (substring(
        getStringValue(), beginFcndSpiTblId, beginFcndSpiTblId + FCND_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isFcndStsCdModified() {
    ...
    localFcndStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFcndDerivPlOfSvcCdModified() {
    ...
    localFcndDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeFcndDerivPlOfSvcCd(char[] fcndDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginFcndDerivPlOfSvcCd,
        FCND_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshFcndDerivPlOfSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginFcndDerivPlOfSvcCd,
        beginFcndDerivPlOfSvcCd + FCND_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isFcndDerivSvcCdModified() {
    ...
    localFcndDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndDerivSvcCd() {
    return (substring(
        getStringValue(), beginFcndDerivSvcCd, beginFcndDerivSvcCd + FCND_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isFcndDerivCausCdModified() {
    ...
    localFcndDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndDerivCausCd() {
    return (substring(
        getStringValue(), beginFcndDerivCausCd, beginFcndDerivCausCd + FCND_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isFcndCreatDttmModified() {
    ...
    localFcndCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndCreatDttm() {
    return (substring(
        getStringValue(), beginFcndCreatDttm, beginFcndCreatDttm + FCND_CREAT_DTTM_LEN));
  }
  ...
  public boolean isFcndFromCondPosSeqNbrModified() {
    ...
    localFcndFromCondPosSeqNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndFromCondPosSeqNbr is used to refresh the latest value of a variable from the
  ...
  public boolean isFcndFromCondPosModified() {
    ...
    localFcndFromCondPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndFromCondPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndFromCondPos() {
    return (substring(
        getStringValue(), beginFcndFromCondPos, beginFcndFromCondPos + FCND_FROM_COND_POS_LEN));
  }
  ...
  public boolean isFcndPgmIdModified() {
    ...
    localFcndPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFcndLstUpdtDttmModified() {
    ...
    localFcndLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFcndLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndLstUpdtDttm() {
    return (substring(
        getStringValue(), beginFcndLstUpdtDttm, beginFcndLstUpdtDttm + FCND_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isFcndLstUpdtUserIdModified() {
    ...
    localFcndLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeFcndLstUpdtUserId(char[] fcndLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        fcndLstUpdtUserId, 0, getStringValue(), beginFcndLstUpdtUserId, FCND_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshFcndLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFcndLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginFcndLstUpdtUserId,
        beginFcndLstUpdtUserId + FCND_LST_UPDT_USER_ID_LEN));
  }
}
