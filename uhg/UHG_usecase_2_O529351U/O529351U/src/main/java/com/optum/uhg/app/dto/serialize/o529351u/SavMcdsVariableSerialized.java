...
/**
 * The class SavMcdsVariableSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class SavMcdsVariableSerialized extends Field {
  ...
  /**
   * sets parent for this SavMcdsVariableSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
