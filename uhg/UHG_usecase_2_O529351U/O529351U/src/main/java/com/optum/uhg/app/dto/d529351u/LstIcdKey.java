...
public class LstIcdKey extends LstIcdKeySerialized {
  ...
  /**
   * set variable lstClmIcdInd Corresponding COBOL Variable is WS-LST-CLM-ICD-IND
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdInd(
  ...
  /**
   * Update LstClmIcdInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdInd(
  ...
  /**
   * set variable lstClmIcdPos Corresponding COBOL Variable is WS-LST-CLM-ICD-POS
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdPos(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update LstClmIcdPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdPos(
  ...
  /**
   * set variable lstClmIcdSvc Corresponding COBOL Variable is WS-LST-CLM-ICD-SVC
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update LstClmIcdSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdSvc(
  ...
  /**
   * set variable lstClmIcdCau Corresponding COBOL Variable is WS-LST-CLM-ICD-CAU
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdCau with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdCau with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdCau(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update LstClmIcdCau with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update LstClmIcdCau with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setLstClmIcdCau(
  ...
  /**
   * initializes LstIcdKey String fields defaults to Spaces short/int/long defaults to zero
