...
public class DrstReturnArea extends DrstReturnAreaSerialized {
  ...
  /**
   * Update DrstReturnCode with the passed value Corresponding COBOL Variable is DRST-RETURN-CODE
   *
   * @param number
   */
  ...
  /**
   * set variable drstEditErrorField Corresponding COBOL Variable is DRST-EDIT-ERROR-FIELD
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorField with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorField with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorField(
  ...
  /**
   * Update DrstEditErrorField with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorField with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorField(
  ...
  /**
   * Update DrstEditErrorValueTxt with the passed value Corresponding COBOL Variable is
   * DRST-EDIT-ERROR-VALUE-TXT
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorValueTxt with a String from an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueTxt(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        drstEditErrorValueTxt.begin,
        drstEditErrorValueTxt.length());
  }

  /**
   * Update DrstEditErrorValueTxt with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueTxt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  public void setDrstEditErrorValueTxt(Field source) {
    replace(
        source, 0, source.length(), drstEditErrorValueTxt.begin, drstEditErrorValueTxt.length());
  }

  /**
   * Update DrstEditErrorValueTxt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorValueTxt with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
