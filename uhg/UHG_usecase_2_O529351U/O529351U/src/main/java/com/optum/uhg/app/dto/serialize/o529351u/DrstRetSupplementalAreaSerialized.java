...
/**
 * The class DrstRetSupplementalAreaSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DrstRetSupplementalAreaSerialized extends Field {
  ...
  /**
   * sets parent for this DrstRetSupplementalAreaSerialized to the parent and set the serialize
