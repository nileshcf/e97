...
/**
 * The class PpaPpoaltRecordSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class PpaPpoaltRecordSerialized extends Field {
  ...
  /**
   * sets parent for this PpaPpoaltRecordSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
