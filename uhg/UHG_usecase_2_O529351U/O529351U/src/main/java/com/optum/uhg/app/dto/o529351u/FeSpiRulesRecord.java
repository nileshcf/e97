...
public class FeSpiRulesRecord extends FeSpiRulesRecordSerialized {
  ...
  public FeSpiRulesRecord() {
    ...
    for (int arrayIndex = 0; arrayIndex < FESR_FROM_COND_PS_SIZE; arrayIndex++) {
      fesrFromCondPs.add(
          new FesrFromCondPs(
              this,
              beginFesrFromCondPs + arrayIndex * FesrFromCondPs.getFesrFromCondPsFieldLength()));
    }
    for (int arrayIndex = 0; arrayIndex < FESR_FROM_COND_FR_TO_SVC_SIZE; arrayIndex++) {
      fesrFromCondFrToSvc.add(
          new FesrFromCondFrToSvc(
              this,
              beginFesrFromCondFrToSvc
    ...
    for (int arrayIndex = 0; arrayIndex < FESR_FROM_COND_PRV_TYP_SIZE; arrayIndex++) {
      fesrFromCondPrvTyp.add(
          new FesrFromCondPrvTyp(
              this,
              beginFesrFromCondPrvTyp
    ...
    for (int arrayIndex = 0; arrayIndex < FESR_FROM_COND_FR_TO_ICD_9_SIZE; arrayIndex++) {
      fesrFromCondFrToIcd9.add(
          new FesrFromCondFrToIcd9(
              this,
              beginFesrFromCondFrToIcd9
    ...
    for (int arrayIndex = 0; arrayIndex < FESR_FROM_COND_CAUSE_SIZE; arrayIndex++) {
      fesrFromCondCause.add(
          new FesrFromCondCause(
              this,
              beginFesrFromCondCause
    ...
    for (int arrayIndex = 0; arrayIndex < FESR_IPA_CODE_SIZE; arrayIndex++) {
      fesrIpaCode.add(
          new FesrIpaCode(
              this, beginFesrIpaCode + arrayIndex * FesrIpaCode.getFesrIpaCodeFieldLength()));
    }
    /*  end of offset */
  }
  ...
  /**
   * Update FesrKey01 with the passed value Corresponding COBOL Variable is FESR-KEY
   *
   * @param value
   */
  ...
  /**
   * Update FesrKey01 with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrKey01 with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrKey01(
  ...
  /**
   * Update FesrKey01 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrKey01 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrKey01(
  ...
  /**
   * Update FesrDateTimestamp with the passed value Corresponding COBOL Variable is
   * FESR-DATE-TIMESTAMP
   *
   * @param value
   */
  ...
  /**
   * Update FesrDateTimestamp with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrDateTimestamp with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrDateTimestamp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesrDateTimestamp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrDateTimestamp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrDateTimestamp(
  ...
  /**
   * Update FesrUpdateId with the passed value Corresponding COBOL Variable is FESR-UPDATE-ID
   *
   * @param number
   */
  ...
  /**
   * Returns the value of fesrFromCondPs Corresponding COBOL Variable is FESR-FROM-COND-PS
   *
  ...
  public FesrFromCondPs getFesrFromCondPs(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "fesrFromCondPs - Array index exceeded max Size {}, resetting it to max allowed",
          FESR_FROM_COND_PS_SIZE);
    }
    if (index >= fesrFromCondPs.size()) {
      ...
      fesrFromCondPs.set(
          index,
          new FesrFromCondPs(
              this, beginFesrFromCondPs + index * FesrFromCondPs.getFesrFromCondPsFieldLength()));
    }
  ...
  /**
   * Update FesrFromCondPs at index with the passed value Corresponding COBOL Variable is
   * FESR-FROM-COND-PS
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of fesrFromCondFrToSvc Corresponding COBOL Variable is
   * FESR-FROM-COND-FR-TO-SVC
   *
  ...
  public FesrFromCondFrToSvc getFesrFromCondFrToSvc(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "fesrFromCondFrToSvc - Array index exceeded max Size {}, resetting it to max allowed",
          FESR_FROM_COND_FR_TO_SVC_SIZE);
    }
    if (index >= fesrFromCondFrToSvc.size()) {
      ...
      fesrFromCondFrToSvc.set(
          index,
          new FesrFromCondFrToSvc(
              this,
              beginFesrFromCondFrToSvc
                  + index * FesrFromCondFrToSvc.getFesrFromCondFrToSvcFieldLength()));
    }
  ...
  /**
   * Update FesrFromCondFrToSvc at index with the passed value Corresponding COBOL Variable is
   * FESR-FROM-COND-FR-TO-SVC
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of fesrFromCondPrvTyp Corresponding COBOL Variable is FESR-FROM-COND-PRV-TYP
   *
  ...
  public FesrFromCondPrvTyp getFesrFromCondPrvTyp(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "fesrFromCondPrvTyp - Array index exceeded max Size {}, resetting it to max allowed",
          FESR_FROM_COND_PRV_TYP_SIZE);
    }
    if (index >= fesrFromCondPrvTyp.size()) {
      ...
      fesrFromCondPrvTyp.set(
          index,
          new FesrFromCondPrvTyp(
              this,
              beginFesrFromCondPrvTyp
                  + index * FesrFromCondPrvTyp.getFesrFromCondPrvTypFieldLength()));
    }
  ...
  /**
   * Update FesrFromCondPrvTyp at index with the passed value Corresponding COBOL Variable is
   * FESR-FROM-COND-PRV-TYP
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Returns the value of fesrFromCondFrToIcd9 Corresponding COBOL Variable is
   * FESR-FROM-COND-FR-TO-ICD9
   *
  ...
  public FesrFromCondFrToIcd9 getFesrFromCondFrToIcd9(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "fesrFromCondFrToIcd9 - Array index exceeded max Size {}, resetting it to max allowed",
          FESR_FROM_COND_FR_TO_ICD_9_SIZE);
    }
    if (index >= fesrFromCondFrToIcd9.size()) {
      ...
      fesrFromCondFrToIcd9.set(
          index,
          new FesrFromCondFrToIcd9(
              this,
              beginFesrFromCondFrToIcd9
                  + index * FesrFromCondFrToIcd9.getFesrFromCondFrToIcd9FieldLength()));
    }
  ...
  /**
   * Update FesrFromCondFrToIcd9 at index with the passed value Corresponding COBOL Variable is
   * FESR-FROM-COND-FR-TO-ICD9
   *
   * @param index
   * @param value
  ...
  /**
   * Returns the value of fesrFromCondCause Corresponding COBOL Variable is FESR-FROM-COND-CAUSE
   *
  ...
  public FesrFromCondCause getFesrFromCondCause(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "fesrFromCondCause - Array index exceeded max Size {}, resetting it to max allowed",
          FESR_FROM_COND_CAUSE_SIZE);
    }
    if (index >= fesrFromCondCause.size()) {
      ...
      fesrFromCondCause.set(
          index,
          new FesrFromCondCause(
              this,
              beginFesrFromCondCause
                  + index * FesrFromCondCause.getFesrFromCondCauseFieldLength()));
    }
  ...
  /**
   * Update FesrFromCondCause at index with the passed value Corresponding COBOL Variable is
   * FESR-FROM-COND-CAUSE
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Returns the value of fesrIpaCode Corresponding COBOL Variable is FESR-IPA-CODE
   *
   * @return fesrIpaCode
   */
  ...
  public FesrIpaCode getFesrIpaCode(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "fesrIpaCode - Array index exceeded max Size {}, resetting it to max allowed",
          FESR_IPA_CODE_SIZE);
    }
    if (index >= fesrIpaCode.size()) {
      ...
      fesrIpaCode.set(
          index,
          new FesrIpaCode(
              this, beginFesrIpaCode + index * FesrIpaCode.getFesrIpaCodeFieldLength()));
    }
  ...
  /**
   * Update FesrIpaCode at index with the passed value Corresponding COBOL Variable is FESR-IPA-CODE
   *
   * @param index
   * @param value
   */
