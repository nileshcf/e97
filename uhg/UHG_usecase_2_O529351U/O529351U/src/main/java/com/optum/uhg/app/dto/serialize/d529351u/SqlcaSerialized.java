...
/**
 * The class SqlcaSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqlcaSerialized extends Field {
  ...
  public boolean isSqlcaidModified() {
    ...
    localSqlcaidCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSqlcaid is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isSqlcabcModified() {
    ...
    localSqlcabcCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqlcabc(int sqlcabc) {
    replaceValue( //  save the value as string
        getBinaryString(sqlcabc, SQLCABC_LEN), beginSqlcabc, SQLCABC_LEN);
  ...
  /**
   * refreshSqlcabc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isSqlcodeModified() {
    ...
    localSqlcodeCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqlcode(int sqlcode) {
    replaceValue( //  save the value as string
        getBinaryString(sqlcode, SQLCODE_LEN), beginSqlcode, SQLCODE_LEN);
  ...
  /**
   * refreshSqlcode is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isSqlerrpModified() {
    ...
    localSqlerrpCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSqlerrp is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
