...
/**
 * The class DrstRestartDataAreaSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DrstRestartDataAreaSerialized extends Field {
  ...
  public boolean isDrstRetLbmsub90AreaModified() {
    ...
    localDrstRetLbmsub90AreaCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeDrstRetLbmsub90Area(char[] drstRetLbmsub90Area) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginDrstRetLbmsub90Area,
        DRST_RET_LBMSUB_90_AREA_LEN);
  ...
  /**
   * refreshDrstRetLbmsub90Area is used to refresh the latest value of a variable from the
  ...
  public char[] refreshDrstRetLbmsub90Area() {
    return (substring(
        getStringValue(),
        beginDrstRetLbmsub90Area,
        beginDrstRetLbmsub90Area + DRST_RET_LBMSUB_90_AREA_LEN));
  }
}
