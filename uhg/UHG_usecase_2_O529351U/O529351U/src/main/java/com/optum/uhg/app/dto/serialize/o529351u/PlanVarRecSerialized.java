...
/**
 * The class PlanVarRecSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class PlanVarRecSerialized extends Field {
  ...
  /**
   * sets parent for this PlanVarRecSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesaPolicy01Modified() {
    ...
    localFesaPolicy01Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesaPolicy01 is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isFesaPlanVar01Modified() {
    ...
    localFesaPlanVar01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaPlanVar01IsNumeric() {
    return decimalIsNumeric(
        beginFesaPlanVar01,
        FESA_PLAN_VAR_01_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesaPlanVar01 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isFesaEffDate01Modified() {
    ...
    localFesaEffDate01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaEffDate01IsNumeric() {
    return decimalIsNumeric(
        beginFesaEffDate01,
        FESA_EFF_DATE_01_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesaEffDate01 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isFesaSpiNbr01Modified() {
    ...
    localFesaSpiNbr01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaSpiNbr01IsNumeric() {
    return decimalIsNumeric(
        beginFesaSpiNbr01,
        FESA_SPI_NBR_01_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesaSpiNbr01 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isFesaPosTierCdModified() {
    ...
    localFesaPosTierCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesaPosTierCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesaPosTierCd() {
    return (substring(
        getStringValue(), beginFesaPosTierCd, beginFesaPosTierCd + FESA_POS_TIER_CD_LEN));
  }
  ...
  public boolean isFesaSpiPriDiagIndModified() {
    ...
    localFesaSpiPriDiagIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeFesaSpiPriDiagInd(char[] fesaSpiPriDiagInd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        fesaSpiPriDiagInd, 0, getStringValue(), beginFesaSpiPriDiagInd, FESA_SPI_PRI_DIAG_IND_LEN);
  ...
  /**
   * refreshFesaSpiPriDiagInd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesaSpiPriDiagInd() {
    return (substring(
        getStringValue(),
        beginFesaSpiPriDiagInd,
        beginFesaSpiPriDiagInd + FESA_SPI_PRI_DIAG_IND_LEN));
  }
  ...
  public boolean isFesaSpiDiagElgIndModified() {
    ...
    localFesaSpiDiagElgIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeFesaSpiDiagElgInd(char[] fesaSpiDiagElgInd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        fesaSpiDiagElgInd, 0, getStringValue(), beginFesaSpiDiagElgInd, FESA_SPI_DIAG_ELG_IND_LEN);
  ...
  /**
   * refreshFesaSpiDiagElgInd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesaSpiDiagElgInd() {
    return (substring(
        getStringValue(),
        beginFesaSpiDiagElgInd,
        beginFesaSpiDiagElgInd + FESA_SPI_DIAG_ELG_IND_LEN));
  }
}
