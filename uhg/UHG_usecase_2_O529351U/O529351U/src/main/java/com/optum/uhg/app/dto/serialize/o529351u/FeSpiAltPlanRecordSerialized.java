...
/**
 * The class FeSpiAltPlanRecordSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FeSpiAltPlanRecordSerialized extends Field {
  ...
  public boolean isFesaCanDtModified() {
    ...
    localFesaCanDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaCanDtIsNumeric() {
    return decimalIsNumeric(
        beginFesaCanDt,
        FESA_CAN_DT_LEN); // check Packed Decimal field to see if it contains valid Number
  }
