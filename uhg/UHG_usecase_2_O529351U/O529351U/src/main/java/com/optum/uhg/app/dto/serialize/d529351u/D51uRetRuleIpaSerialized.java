...
/**
 * The class D51uRetRuleIpaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRuleIpaSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRuleIpaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uRipaSpiTblIdModified() {
    ...
    localD51uRipaSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRipaSpiTblId(char[] d51uRipaSpiTblId) {
    ...
    arraycopy(
        d51uRipaSpiTblId, 0, getStringValue(), beginD51uRipaSpiTblId, D_51U_RIPA_SPI_TBL_ID_LEN);
  ...
  /**
   * refreshD51uRipaSpiTblId is used to refresh the latest value of a variable from the Serialized
  ...
  public char[] refreshD51uRipaSpiTblId() {
    return (substring(
        getStringValue(),
        beginD51uRipaSpiTblId,
        beginD51uRipaSpiTblId + D_51U_RIPA_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isD51uRipaDrvPosModified() {
    ...
    localD51uRipaDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRipaDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRipaDrvPos() {
    return (substring(
        getStringValue(), beginD51uRipaDrvPos, beginD51uRipaDrvPos + D_51U_RIPA_DRV_POS_LEN));
  }
  ...
  public boolean isD51uRipaDrvSvcModified() {
    ...
    localD51uRipaDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRipaDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRipaDrvSvc() {
    return (substring(
        getStringValue(), beginD51uRipaDrvSvc, beginD51uRipaDrvSvc + D_51U_RIPA_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uRipaDrvCauModified() {
    ...
    localD51uRipaDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRipaDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRipaDrvCau() {
    return (substring(
        getStringValue(), beginD51uRipaDrvCau, beginD51uRipaDrvCau + D_51U_RIPA_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uRipaClmIpa1CdModified() {
    ...
    localD51uRipaClmIpa1CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeD51uRipaClmIpa1Cd(char[] value) {
    ...
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginD51uRipaClmIpa1Cd, 3);
    localD51uRipaClmIpa1CdCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uRipaClmIpa1Cd;
  }
  ...
  /**
   * refreshD51uRipaClmIpa1Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isD51uRipaClmIpa2CdModified() {
    ...
    localD51uRipaClmIpa2CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeD51uRipaClmIpa2Cd(char[] value) {
    ...
    d51uRipaClmIpa2Cd =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginD51uRipaClmIpa2Cd, 3);
    localD51uRipaClmIpa2CdCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uRipaClmIpa2Cd;
  }
  ...
  /**
   * refreshD51uRipaClmIpa2Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isD51uRipaClmIpa3CdModified() {
    ...
    localD51uRipaClmIpa3CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeD51uRipaClmIpa3Cd(char[] value) {
    ...
    d51uRipaClmIpa3Cd =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginD51uRipaClmIpa3Cd, 3);
    localD51uRipaClmIpa3CdCounter = shareString.getSerializedField().getModifiedCounter();
    return d51uRipaClmIpa3Cd;
  }
  ...
  /**
   * refreshD51uRipaClmIpa3Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isD51uRipaGrpTbl1NbrModified() {
    ...
    localD51uRipaGrpTbl1NbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRipaGrpTbl1Nbr(char[] d51uRipaGrpTbl1Nbr) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uRipaGrpTbl1Nbr,
        D_51U_RIPA_GRP_TBL_1_NBR_LEN);
  ...
  /**
   * refreshD51uRipaGrpTbl1Nbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRipaGrpTbl1Nbr() {
    return (substring(
        getStringValue(),
        beginD51uRipaGrpTbl1Nbr,
        beginD51uRipaGrpTbl1Nbr + D_51U_RIPA_GRP_TBL_1_NBR_LEN));
  }
  ...
  public boolean isD51uRipaGrpTbl2NbrModified() {
    ...
    localD51uRipaGrpTbl2NbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRipaGrpTbl2Nbr(char[] d51uRipaGrpTbl2Nbr) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uRipaGrpTbl2Nbr,
        D_51U_RIPA_GRP_TBL_2_NBR_LEN);
  ...
  /**
   * refreshD51uRipaGrpTbl2Nbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRipaGrpTbl2Nbr() {
    return (substring(
        getStringValue(),
        beginD51uRipaGrpTbl2Nbr,
        beginD51uRipaGrpTbl2Nbr + D_51U_RIPA_GRP_TBL_2_NBR_LEN));
  }
  ...
  public boolean isD51uRipaGrpTbl3NbrModified() {
    ...
    localD51uRipaGrpTbl3NbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uRipaGrpTbl3Nbr(char[] d51uRipaGrpTbl3Nbr) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginD51uRipaGrpTbl3Nbr,
        D_51U_RIPA_GRP_TBL_3_NBR_LEN);
  ...
  /**
   * refreshD51uRipaGrpTbl3Nbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRipaGrpTbl3Nbr() {
    return (substring(
        getStringValue(),
        beginD51uRipaGrpTbl3Nbr,
        beginD51uRipaGrpTbl3Nbr + D_51U_RIPA_GRP_TBL_3_NBR_LEN));
  }
}
