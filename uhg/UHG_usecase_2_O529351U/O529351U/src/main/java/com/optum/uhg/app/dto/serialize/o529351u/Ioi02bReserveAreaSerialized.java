...
/**
 * The class Ioi02bReserveAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Ioi02bReserveAreaSerialized extends Field {
  ...
  /**
   * sets parent for this Ioi02bReserveAreaSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isIoi02bWorkAreaAddrModified() {
    ...
    localIoi02bWorkAreaAddrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bWorkAreaAddr is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isIoi02bWorkAreaPtrModified() {
    ...
    localIoi02bWorkAreaPtrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bWorkAreaPtr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isIoi02bInterfaceAddrModified() {
    ...
    localIoi02bInterfaceAddrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bInterfaceAddr is used to refresh the latest value of a variable from the
  ...
  public boolean isIoi02bInterfacePtrModified() {
    ...
    localIoi02bInterfacePtrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bInterfacePtr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isIoi02bJournalAddrModified() {
    ...
    localIoi02bJournalAddrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bJournalAddr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isIoi02bJournalPtrModified() {
    ...
    localIoi02bJournalPtrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bJournalPtr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
