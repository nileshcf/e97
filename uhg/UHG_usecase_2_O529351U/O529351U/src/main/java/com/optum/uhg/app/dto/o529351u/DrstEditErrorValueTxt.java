...
public class DrstEditErrorValueTxt extends DrstEditErrorValueTxtSerialized {
  ...
  /**
   * set variable drstEditErrorValueInt Corresponding COBOL Variable is DRST-EDIT-ERROR-VALUE-INT
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorValueInt with a char[] from an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueInt(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginDrstEditErrorValueInt,
        drstEditErrorValueInt.length);
  }

  public void setDrstEditErrorValueInt(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDrstEditErrorValueInt, drstEditErrorValueInt.length);
  }

  /**
   * Update DrstEditErrorValueInt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueInt(
  ...
  /**
   * Update DrstEditErrorValueInt with another Field from an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueInt(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDrstEditErrorValueInt, DRST_EDIT_ERROR_VALUE_INT_LEN);
  }

  /**
   * Update DrstEditErrorValueInt with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable drstEditErrorValueDec Corresponding COBOL Variable is DRST-EDIT-ERROR-VALUE-DEC
   *
   * @param value
   */
  ...
  /**
   * Update DrstEditErrorValueDec with a char[] from an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueDec(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginDrstEditErrorValueDec,
        drstEditErrorValueDec.length);
  }

  public void setDrstEditErrorValueDec(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDrstEditErrorValueDec, drstEditErrorValueDec.length);
  }

  /**
   * Update DrstEditErrorValueDec with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueDec(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrstEditErrorValueDec with another Field from an offset and length
   *
   * @param value
   */
  public void setDrstEditErrorValueDec(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginDrstEditErrorValueDec, DRST_EDIT_ERROR_VALUE_DEC_LEN);
  }

  /**
   * Update DrstEditErrorValueDec with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
