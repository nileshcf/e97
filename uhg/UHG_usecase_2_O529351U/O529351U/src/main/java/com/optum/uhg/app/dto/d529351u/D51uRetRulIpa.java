...
public class D51uRetRulIpa extends D51uRetRulIpaSerialized {
  ...
  /**
   * Returns the value of d51uRetRuleIpa Corresponding COBOL Variable is D51U-RET-RULE-IPA
   *
  ...
  public D51uRetRuleIpa getD51uRetRuleIpa(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRuleIpa - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RULE_IPA_SIZE);
    }
    if (index >= d51uRetRuleIpa.size()) {
      ...
      d51uRetRuleIpa.set(
          index,
          new D51uRetRuleIpa(
              this, beginD51uRetRuleIpa + index * D51uRetRuleIpa.getD51uRetRuleIpaFieldLength()));
    }
  ...
  /**
   * Update D51uRetRuleIpa at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RULE-IPA
   *
   * @param index
   * @param value
