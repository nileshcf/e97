...
public class HvHostVariablesCombcr extends HvHostVariablesCombcrSerialized {
  ...
  /**
   * Returns the value of hv2aRecTypCd Corresponding COBOL Variable is HV2A-REC-TYP-CD
   *
   * @return hv2aRecTypCd
   */
  ...
  public char[] getHv2aRecTypCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2aRecTypCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2A_REC_TYP_CD_SIZE);
    }
  ...
  /**
   * Update Hv2aRecTypCd with the passed value at a given index Corresponding COBOL Variable is
   * HV2A-REC-TYP-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2aRecTypCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2aRecTypCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2aRecTypCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2bDerivPlOfSvcCd Corresponding COBOL Variable is HV2B-DERIV-PL-OF-SVC-CD
   *
  ...
  public char[] getHv2bDerivPlOfSvcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2bDerivPlOfSvcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2B_DERIV_PL_OF_SVC_CD_SIZE);
    }
    return getCharArray(
  ...
  /**
   * Update Hv2bDerivPlOfSvcCd with the passed value at a given index Corresponding COBOL Variable
   * is HV2B-DERIV-PL-OF-SVC-CD
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update Hv2bDerivPlOfSvcCd with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHv2bDerivPlOfSvcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2bDerivPlOfSvcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2cDerivSvcCd Corresponding COBOL Variable is HV2C-DERIV-SVC-CD
   *
  ...
  public char[] getHv2cDerivSvcCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2cDerivSvcCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2C_DERIV_SVC_CD_SIZE);
    }
    return getCharArray(
        (beginHv2cDerivSvcCd + index * HV_2C_DERIV_SVC_CD_LEN), HV_2C_DERIV_SVC_CD_LEN);
  }
  ...
  /**
   * Update Hv2cDerivSvcCd with the passed value at a given index Corresponding COBOL Variable is
   * HV2C-DERIV-SVC-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2cDerivSvcCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2cDerivSvcCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2cDerivSvcCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2dDerivCausCd Corresponding COBOL Variable is HV2D-DERIV-CAUS-CD
   *
  ...
  public char[] getHv2dDerivCausCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2dDerivCausCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2D_DERIV_CAUS_CD_SIZE);
    }
    return getCharArray(
        (beginHv2dDerivCausCd + index * HV_2D_DERIV_CAUS_CD_LEN), HV_2D_DERIV_CAUS_CD_LEN);
  }
  ...
  /**
   * Update Hv2dDerivCausCd with the passed value at a given index Corresponding COBOL Variable is
   * HV2D-DERIV-CAUS-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2dDerivCausCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2dDerivCausCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2dDerivCausCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2eClmCaus1Cd Corresponding COBOL Variable is HV2E-CLM-CAUS-1-CD
   *
  ...
  public char[] getHv2eClmCaus1Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2eClmCaus1Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2E_CLM_CAUS_1_CD_SIZE);
    }
    return getCharArray(
        (beginHv2eClmCaus1Cd + index * HV_2E_CLM_CAUS_1_CD_LEN), HV_2E_CLM_CAUS_1_CD_LEN);
  }
  ...
  /**
   * Update Hv2eClmCaus1Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2E-CLM-CAUS-1-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2eClmCaus1Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2eClmCaus1Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2eClmCaus1Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2fClmCaus2Cd Corresponding COBOL Variable is HV2F-CLM-CAUS-2-CD
   *
  ...
  public char[] getHv2fClmCaus2Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2fClmCaus2Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2F_CLM_CAUS_2_CD_SIZE);
    }
    return getCharArray(
        (beginHv2fClmCaus2Cd + index * HV_2F_CLM_CAUS_2_CD_LEN), HV_2F_CLM_CAUS_2_CD_LEN);
  }
  ...
  /**
   * Update Hv2fClmCaus2Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2F-CLM-CAUS-2-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2fClmCaus2Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2fClmCaus2Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2fClmCaus2Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2gClmCaus3Cd Corresponding COBOL Variable is HV2G-CLM-CAUS-3-CD
   *
  ...
  public char[] getHv2gClmCaus3Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2gClmCaus3Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2G_CLM_CAUS_3_CD_SIZE);
    }
    return getCharArray(
        (beginHv2gClmCaus3Cd + index * HV_2G_CLM_CAUS_3_CD_LEN), HV_2G_CLM_CAUS_3_CD_LEN);
  }
  ...
  /**
   * Update Hv2gClmCaus3Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2G-CLM-CAUS-3-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2gClmCaus3Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2gClmCaus3Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2gClmCaus3Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2hClmCaus4Cd Corresponding COBOL Variable is HV2H-CLM-CAUS-4-CD
   *
  ...
  public char[] getHv2hClmCaus4Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2hClmCaus4Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2H_CLM_CAUS_4_CD_SIZE);
    }
    return getCharArray(
        (beginHv2hClmCaus4Cd + index * HV_2H_CLM_CAUS_4_CD_LEN), HV_2H_CLM_CAUS_4_CD_LEN);
  }
  ...
  /**
   * Update Hv2hClmCaus4Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2H-CLM-CAUS-4-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2hClmCaus4Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2hClmCaus4Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2hClmCaus4Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2iClmCaus5Cd Corresponding COBOL Variable is HV2I-CLM-CAUS-5-CD
   *
  ...
  public char[] getHv2iClmCaus5Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2iClmCaus5Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2I_CLM_CAUS_5_CD_SIZE);
    }
    return getCharArray(
        (beginHv2iClmCaus5Cd + index * HV_2I_CLM_CAUS_5_CD_LEN), HV_2I_CLM_CAUS_5_CD_LEN);
  }
  ...
  /**
   * Update Hv2iClmCaus5Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2I-CLM-CAUS-5-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2iClmCaus5Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2iClmCaus5Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2iClmCaus5Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2jClmCaus6Cd Corresponding COBOL Variable is HV2J-CLM-CAUS-6-CD
   *
  ...
  public char[] getHv2jClmCaus6Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2jClmCaus6Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2J_CLM_CAUS_6_CD_SIZE);
    }
    return getCharArray(
        (beginHv2jClmCaus6Cd + index * HV_2J_CLM_CAUS_6_CD_LEN), HV_2J_CLM_CAUS_6_CD_LEN);
  }
  ...
  /**
   * Update Hv2jClmCaus6Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2J-CLM-CAUS-6-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2jClmCaus6Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2jClmCaus6Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2jClmCaus6Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2kClmCaus7Cd Corresponding COBOL Variable is HV2K-CLM-CAUS-7-CD
   *
  ...
  public char[] getHv2kClmCaus7Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2kClmCaus7Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2K_CLM_CAUS_7_CD_SIZE);
    }
    return getCharArray(
        (beginHv2kClmCaus7Cd + index * HV_2K_CLM_CAUS_7_CD_LEN), HV_2K_CLM_CAUS_7_CD_LEN);
  }
  ...
  /**
   * Update Hv2kClmCaus7Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2K-CLM-CAUS-7-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2kClmCaus7Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2kClmCaus7Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2kClmCaus7Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2lClmCaus8Cd Corresponding COBOL Variable is HV2L-CLM-CAUS-8-CD
   *
  ...
  public char[] getHv2lClmCaus8Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2lClmCaus8Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2L_CLM_CAUS_8_CD_SIZE);
    }
    return getCharArray(
        (beginHv2lClmCaus8Cd + index * HV_2L_CLM_CAUS_8_CD_LEN), HV_2L_CLM_CAUS_8_CD_LEN);
  }
  ...
  /**
   * Update Hv2lClmCaus8Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2L-CLM-CAUS-8-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2lClmCaus8Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2lClmCaus8Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2lClmCaus8Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2mClmIpa1Cd Corresponding COBOL Variable is HV2M-CLM-IPA-1-CD
   *
  ...
  public char[] getHv2mClmIpa1Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2mClmIpa1Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2M_CLM_IPA_1_CD_SIZE);
    }
    return getCharArray(
        (beginHv2mClmIpa1Cd + index * HV_2M_CLM_IPA_1_CD_LEN), HV_2M_CLM_IPA_1_CD_LEN);
  }
  ...
  /**
   * Update Hv2mClmIpa1Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2M-CLM-IPA-1-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2mClmIpa1Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2mClmIpa1Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2mClmIpa1Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2nClmIpa2Cd Corresponding COBOL Variable is HV2N-CLM-IPA-2-CD
   *
  ...
  public char[] getHv2nClmIpa2Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2nClmIpa2Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2N_CLM_IPA_2_CD_SIZE);
    }
    return getCharArray(
        (beginHv2nClmIpa2Cd + index * HV_2N_CLM_IPA_2_CD_LEN), HV_2N_CLM_IPA_2_CD_LEN);
  }
  ...
  /**
   * Update Hv2nClmIpa2Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2N-CLM-IPA-2-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2nClmIpa2Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2nClmIpa2Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2nClmIpa2Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2oClmIpa3Cd Corresponding COBOL Variable is HV2O-CLM-IPA-3-CD
   *
  ...
  public char[] getHv2oClmIpa3Cd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2oClmIpa3Cd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2O_CLM_IPA_3_CD_SIZE);
    }
    return getCharArray(
        (beginHv2oClmIpa3Cd + index * HV_2O_CLM_IPA_3_CD_LEN), HV_2O_CLM_IPA_3_CD_LEN);
  }
  ...
  /**
   * Update Hv2oClmIpa3Cd with the passed value at a given index Corresponding COBOL Variable is
   * HV2O-CLM-IPA-3-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2oClmIpa3Cd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2oClmIpa3Cd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2oClmIpa3Cd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2pProvTyp Corresponding COBOL Variable is HV2P-PROV-TYP
   *
   * @return hv2pProvTyp
   */
  ...
  public char[] getHv2pProvTyp(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2pProvTyp - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2P_PROV_TYP_SIZE);
    }
  ...
  /**
   * Update Hv2pProvTyp with the passed value at a given index Corresponding COBOL Variable is
   * HV2P-PROV-TYP
   *
   * @param index
   * @param value
  ...
  private void setHv2pProvTyp(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2pProvTyp(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2qFromCondPos Corresponding COBOL Variable is HV2Q-FROM-COND-POS
   *
  ...
  public char[] getHv2qFromCondPos(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2qFromCondPos - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2Q_FROM_COND_POS_SIZE);
    }
    return getCharArray(
        (beginHv2qFromCondPos + index * HV_2Q_FROM_COND_POS_LEN), HV_2Q_FROM_COND_POS_LEN);
  }
  ...
  /**
   * Update Hv2qFromCondPos with the passed value at a given index Corresponding COBOL Variable is
   * HV2Q-FROM-COND-POS
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2qFromCondPos with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2qFromCondPos(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2qFromCondPos(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2rGrpTbl1Nbr Corresponding COBOL Variable is HV2R-GRP-TBL-1-NBR
   *
  ...
  public char[] getHv2rGrpTbl1Nbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2rGrpTbl1Nbr - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2R_GRP_TBL_1_NBR_SIZE);
    }
    return getCharArray(
        (beginHv2rGrpTbl1Nbr + index * HV_2R_GRP_TBL_1_NBR_LEN), HV_2R_GRP_TBL_1_NBR_LEN);
  }
  ...
  /**
   * Update Hv2rGrpTbl1Nbr with the passed value at a given index Corresponding COBOL Variable is
   * HV2R-GRP-TBL-1-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2rGrpTbl1Nbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2rGrpTbl1Nbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2rGrpTbl1Nbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2sGrpTbl2Nbr Corresponding COBOL Variable is HV2S-GRP-TBL-2-NBR
   *
  ...
  public char[] getHv2sGrpTbl2Nbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2sGrpTbl2Nbr - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2S_GRP_TBL_2_NBR_SIZE);
    }
    return getCharArray(
        (beginHv2sGrpTbl2Nbr + index * HV_2S_GRP_TBL_2_NBR_LEN), HV_2S_GRP_TBL_2_NBR_LEN);
  }
  ...
  /**
   * Update Hv2sGrpTbl2Nbr with the passed value at a given index Corresponding COBOL Variable is
   * HV2S-GRP-TBL-2-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2sGrpTbl2Nbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2sGrpTbl2Nbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2sGrpTbl2Nbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2tGrpTbl3Nbr Corresponding COBOL Variable is HV2T-GRP-TBL-3-NBR
   *
  ...
  public char[] getHv2tGrpTbl3Nbr(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2tGrpTbl3Nbr - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2T_GRP_TBL_3_NBR_SIZE);
    }
    return getCharArray(
        (beginHv2tGrpTbl3Nbr + index * HV_2T_GRP_TBL_3_NBR_LEN), HV_2T_GRP_TBL_3_NBR_LEN);
  }
  ...
  /**
   * Update Hv2tGrpTbl3Nbr with the passed value at a given index Corresponding COBOL Variable is
   * HV2T-GRP-TBL-3-NBR
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2tGrpTbl3Nbr with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2tGrpTbl3Nbr(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2tGrpTbl3Nbr(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv2uCpeDescCd Corresponding COBOL Variable is HV2U-CPE-DESC-CD
   *
  ...
  public char[] getHv2uCpeDescCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv2uCpeDescCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_2U_CPE_DESC_CD_SIZE);
    }
    return getCharArray(
        (beginHv2uCpeDescCd + index * HV_2U_CPE_DESC_CD_LEN), HV_2U_CPE_DESC_CD_LEN);
  }
  ...
  /**
   * Update Hv2uCpeDescCd with the passed value at a given index Corresponding COBOL Variable is
   * HV2U-CPE-DESC-CD
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv2uCpeDescCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv2uCpeDescCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv2uCpeDescCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
