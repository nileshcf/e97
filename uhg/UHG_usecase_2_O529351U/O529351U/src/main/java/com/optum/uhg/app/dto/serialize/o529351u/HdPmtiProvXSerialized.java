...
/**
 * The class HdPmtiProvXSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class HdPmtiProvXSerialized extends Field {
  ...
  /**
   * sets parent for this HdPmtiProvXSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isHdPmtiProvSufModified() {
    ...
    localHdPmtiProvSufCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeHdPmtiProvSuf(char[] value) {
    ...
    replaceValue(padNumber(5, value, false /*isSigned?*/), beginHdPmtiProvSuf, 5);
    localHdPmtiProvSufCounter = shareString.getSerializedField().getModifiedCounter();
    return hdPmtiProvSuf;
  }
  ...
  /**
   * refreshHdPmtiProvSuf is used to refresh the latest value of a variable from the Serialized
