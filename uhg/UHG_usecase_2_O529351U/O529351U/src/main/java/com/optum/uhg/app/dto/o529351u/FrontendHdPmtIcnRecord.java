...
public class FrontendHdPmtIcnRecord extends FrontendHdPmtIcnRecordSerialized {
  ...
  /**
   * Update HdVariableDetailData with the passed value Corresponding COBOL Variable is
   * HD-VARIABLE-DETAIL-DATA
   *
   * @param value
   */
  ...
  /**
   * Update HdVariableDetailData with a String from an offset and length
   *
   * @param value
   */
  public void setHdVariableDetailData(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, hdVariableDetailData.begin, hdVariableDetailData.length());
  }

  /**
   * Update HdVariableDetailData with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHdVariableDetailData(
  ...
  /**
   * Update HdVariableDetailData with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HdVariableDetailData with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
