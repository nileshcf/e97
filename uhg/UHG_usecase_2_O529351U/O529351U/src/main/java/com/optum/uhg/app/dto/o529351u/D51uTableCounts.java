...
public class D51uTableCounts extends D51uTableCountsSerialized {
  ...
  /**
   * Update D51uPlnvCnt with the passed value Corresponding COBOL Variable is D51U-PLNV-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uSpiCnt with the passed value Corresponding COBOL Variable is D51U-SPI-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uFrtoCnt with the passed value Corresponding COBOL Variable is D51U-FRTO-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uPtypCnt with the passed value Corresponding COBOL Variable is D51U-PTYP-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uIpaCnt with the passed value Corresponding COBOL Variable is D51U-IPA-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uCausCnt with the passed value Corresponding COBOL Variable is D51U-CAUS-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uFcndCnt with the passed value Corresponding COBOL Variable is D51U-FCND-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uIcdCnt with the passed value Corresponding COBOL Variable is D51U-ICD-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uMoreIcdCnt with the passed value Corresponding COBOL Variable is D51U-MORE-ICD-CNT
   *
   * @param number
   */
  ...
  /**
   * Update D51uCflgCnt with the passed value Corresponding COBOL Variable is D51U-CFLG-CNT
   *
   * @param number
   */
