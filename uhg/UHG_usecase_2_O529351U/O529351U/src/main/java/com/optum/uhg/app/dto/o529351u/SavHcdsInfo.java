...
public class SavHcdsInfo extends SavHcdsInfoSerialized {
  ...
  /**
   * set variable savCfeUb92VendorType Corresponding COBOL Variable is SAV-CFE-UB92-VENDOR-TYPE
   *
   * @param value
   */
  ...
  /**
   * Update SavCfeUb92VendorType with a char[] from an offset and length
   *
   * @param value
   */
  public void setSavCfeUb92VendorType(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginSavCfeUb92VendorType, savCfeUb92VendorType.length);
  }
  ...
  /**
   * Update SavCfeUb92VendorType with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavCfeUb92VendorType(
  ...
  /**
   * Update SavCfeUb92VendorType with another Field from an offset and length
   *
   * @param value
   */
  public void setSavCfeUb92VendorType(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginSavCfeUb92VendorType, SAV_CFE_UB_92_VENDOR_TYPE_LEN);
  }

  /**
   * Update SavCfeUb92VendorType with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
