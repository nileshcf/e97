...
public class CsvcCode extends CsvcCodeSerialized {
  ...
  /**
   * Update CsvcCode1st5 with the passed value Corresponding COBOL Variable is CSVC-CODE-1ST-5
   *
   * @param number
   */
  ...
  /**
   * Update CsvcCodeLst1 with the passed value Corresponding COBOL Variable is CSVC-CODE-LST-1
   *
   * @param number
   */
