...
public class ServAlphaf extends ServAlphafSerialized {
  ...
  /**
   * set variable svc1af Corresponding COBOL Variable is SVC-1AF
   *
   * @param value
   */
  ...
  /**
   * Update Svc1af with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc1af with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc1af(
  ...
  /**
   * Update Svc1af with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc1af with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc1af(
  ...
  /**
   * set variable svc25af Corresponding COBOL Variable is SVC-2-5AF
   *
   * @param value
   */
  ...
  /**
   * Update Svc25af with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc25af with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc25af(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Svc25af with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc25af with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc25af(
