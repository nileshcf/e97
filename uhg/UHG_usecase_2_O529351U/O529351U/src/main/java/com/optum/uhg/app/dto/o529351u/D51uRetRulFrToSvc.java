...
public class D51uRetRulFrToSvc extends D51uRetRulFrToSvcSerialized {
  ...
  /**
   * Returns the value of d51uRetRuleFromtoSvc Corresponding COBOL Variable is
   * D51U-RET-RULE-FROMTO-SVC
   *
  ...
  public D51uRetRuleFromtoSvc getD51uRetRuleFromtoSvc(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRuleFromtoSvc - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RULE_FROMTO_SVC_SIZE);
    }
    if (index >= d51uRetRuleFromtoSvc.size()) {
      ...
      d51uRetRuleFromtoSvc.set(
          index,
          new D51uRetRuleFromtoSvc(
              this,
              beginD51uRetRuleFromtoSvc
                  + index * D51uRetRuleFromtoSvc.getD51uRetRuleFromtoSvcFieldLength()));
    }
  ...
  /**
   * Update D51uRetRuleFromtoSvc at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RULE-FROMTO-SVC
   *
   * @param index
   * @param value
