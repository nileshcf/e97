...
public class SavProviderArea extends SavProviderAreaSerialized {
  ...
  /**
   * Update SavProviderTinNumber with the passed value Corresponding COBOL Variable is
   * SAV-PROVIDER-TIN-NUMBER
   *
   * @param number
   */
  ...
  /**
   * Update SavProviderTinNumber15 with the passed value Corresponding COBOL Variable is
   * SAV-PROVIDER-TIN-NUMBER-15
   *
   * @param value
   */
  ...
  /**
   * Update SavProviderTinNumber15 with a String from an offset and length
   *
   * @param value
   */
  public void setSavProviderTinNumber15(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        savProviderTinNumber15.begin,
        savProviderTinNumber15.length());
  }

  /**
   * Update SavProviderTinNumber15 with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavProviderTinNumber15(
  ...
  public void setSavProviderTinNumber15(Field source) {
    replace(
        source, 0, source.length(), savProviderTinNumber15.begin, savProviderTinNumber15.length());
  }

  /**
   * Update SavProviderTinNumber15 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavProviderTinNumber15 with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
