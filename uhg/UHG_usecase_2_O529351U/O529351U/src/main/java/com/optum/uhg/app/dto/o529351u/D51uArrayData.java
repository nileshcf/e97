...
public class D51uArrayData extends D51uArrayDataSerialized {
  ...
  /**
   * Update D51uRetData with the passed value Corresponding COBOL Variable is D51U-RET-DATA
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetData with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetData with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetData(
  ...
  /**
   * Update D51uRetData with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetData with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetData(
  ...
  /**
   * Update D51uRetRulKeys with the passed value Corresponding COBOL Variable is D51U-RET-RUL-KEYS
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulKeys with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulKeys with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulKeys(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulKeys with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulKeys with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulKeys(
  ...
  /**
   * Update D51uRetRulFrToSvc with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-FR-TO-SVC
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulFrToSvc with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulFrToSvc with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulFrToSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulFrToSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulFrToSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulFrToSvc(
  ...
  /**
   * Update D51uRetRulProvTyp with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-PROV-TYP
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulProvTyp with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulProvTyp with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulProvTyp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulProvTyp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulProvTyp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulProvTyp(
  ...
  /**
   * Update D51uRetRulIpa with the passed value Corresponding COBOL Variable is D51U-RET-RUL-IPA
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulIpa with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulIpa with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulIpa(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulIpa with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulIpa with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulIpa(
  ...
  /**
   * Update D51uRetRulCauseData with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-CAUSE-DATA
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulCauseData with a String from an offset and length
   *
   * @param value
   */
  public void setD51uRetRulCauseData(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, d51uRetRulCauseData.begin, d51uRetRulCauseData.length());
  }

  /**
   * Update D51uRetRulCauseData with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulCauseData(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulCauseData with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulCauseData with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulCauseData(
  ...
  /**
   * Update D51uRetRulFrCondPos with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-FR-COND-POS
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulFrCondPos with a String from an offset and length
   *
   * @param value
   */
  public void setD51uRetRulFrCondPos(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, d51uRetRulFrCondPos.begin, d51uRetRulFrCondPos.length());
  }

  /**
   * Update D51uRetRulFrCondPos with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulFrCondPos(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulFrCondPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulFrCondPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulFrCondPos(
  ...
  /**
   * Update D51uRetRulIcd with the passed value Corresponding COBOL Variable is D51U-RET-RUL-ICD
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulIcd with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulIcd with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulIcd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulIcd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulIcd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulIcd(
  ...
  /**
   * Update D51uRetRulCpeFlgData with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-CPE-FLG-DATA
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulCpeFlgData with a String from an offset and length
   *
   * @param value
   */
  public void setD51uRetRulCpeFlgData(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, d51uRetRulCpeFlgData.begin, d51uRetRulCpeFlgData.length());
  }

  /**
   * Update D51uRetRulCpeFlgData with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetRulCpeFlgData(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetRulCpeFlgData with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetRulCpeFlgData with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
