...
/**
 * The class PrevMatchedKeySerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class PrevMatchedKeySerialized extends Field {
  ...
  /**
   * sets parent for this PrevMatchedKeySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isPrevPsModified() {
    ...
    localPrevPsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPrevPs is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isPrevSvcModified() {
    ...
    localPrevSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPrevSvc is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPrevCauseCdModified() {
    ...
    localPrevCauseCdCounter = sharedCounter;
    return hasModified;
  }
