...
public class CetCicsErrorTableGroup extends CetCicsErrorTableGroupSerialized {
  ...
  private CetCicsErrorTableRedefined01 cetCicsErrorTableRedefined01 =
      new CetCicsErrorTableRedefined01();

  private char[] cetCicsErrorTableRedefined02 = Field.fillLowValue(6);
  private CetCicsErrorTableRedefined03 cetCicsErrorTableRedefined03 =
      new CetCicsErrorTableRedefined03();
  ...
  /**
   * Update CetCicsErrorTable with the passed value Corresponding COBOL Variable is
   * CET-CICS-ERROR-TABLE
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTable with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTable with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCetCicsErrorTable(
  ...
  /**
   * Update CetCicsErrorTable with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTable with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCetCicsErrorTable(
  ...
  /**
   * Update CetCicsErrorTableRedefined01 with the passed value Corresponding COBOL Variable is
   * CET-CICS-ERROR-TABLE-REDEFINED
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined01 with a String from an offset and length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined01(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        cetCicsErrorTableRedefined01.begin,
        cetCicsErrorTableRedefined01.length());
  }

  /**
   * Update CetCicsErrorTableRedefined01 with a String from an offset and length to an offset and
   * length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined01(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source,
        sourceIndex,
        sourceLen,
        cetCicsErrorTableRedefined01.begin + targetIndex,
        targetLen);
  }
  ...
  /**
   * Update CetCicsErrorTableRedefined01 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined01 with another Field from an offset and length to an offset
   * and length
   *
   * @param value
   */
  ...
  /**
   * set variable cetCicsErrorTableRedefined02 Corresponding COBOL Variable is
   * CET-CICS-ERROR-TABLE-REDEFINED
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined02 with a char[] from an offset and length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined02(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginCetCicsErrorTableRedefined02,
        cetCicsErrorTableRedefined02.length);
  }
  ...
  /**
   * Update CetCicsErrorTableRedefined02 with a char[] from an offset and length to an offset and
   * length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined02(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source, sourceIndex, sourceLen, beginCetCicsErrorTableRedefined02 + targetIndex, targetLen);
  }
  ...
  public void setCetCicsErrorTableRedefined02(Field source) {
    replace(
        ...
        source.length(),
        beginCetCicsErrorTableRedefined02,
        CET_CICS_ERROR_TABLE_REDEFINED_02_LEN);
  }

  /**
   * Update CetCicsErrorTableRedefined02 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined02 with another Field from an offset and length to an offset
   * and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined03 with the passed value Corresponding COBOL Variable is
   * CET-CICS-ERROR-TABLE-REDEFINED
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined03 with a String from an offset and length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined03(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        cetCicsErrorTableRedefined03.begin,
        cetCicsErrorTableRedefined03.length());
  }

  /**
   * Update CetCicsErrorTableRedefined03 with a String from an offset and length to an offset and
   * length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined03(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source,
        sourceIndex,
        sourceLen,
        cetCicsErrorTableRedefined03.begin + targetIndex,
        targetLen);
  }
  ...
  /**
   * Update CetCicsErrorTableRedefined03 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined03 with another Field from an offset and length to an offset
   * and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined with the passed value Corresponding COBOL Variable is
   * CET-CICS-ERROR-TABLE-REDEFINED
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined with a String from an offset and length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        cetCicsErrorTableRedefined.begin,
        cetCicsErrorTableRedefined.length());
  }

  /**
   * Update CetCicsErrorTableRedefined with a String from an offset and length to an offset and
   * length
   *
   * @param value
   */
  public void setCetCicsErrorTableRedefined(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(
        source, sourceIndex, sourceLen, cetCicsErrorTableRedefined.begin + targetIndex, targetLen);
  }
  ...
  /**
   * Update CetCicsErrorTableRedefined with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetCicsErrorTableRedefined with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
