...
public class D51uRetRulCpeFlgData extends D51uRetRulCpeFlgDataSerialized {
  ...
  /**
   * Returns the value of d51uRetRulCpeFlg Corresponding COBOL Variable is D51U-RET-RUL-CPE-FLG
   *
  ...
  public D51uRetRulCpeFlg getD51uRetRulCpeFlg(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRulCpeFlg - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RUL_CPE_FLG_SIZE);
    }
    if (index >= d51uRetRulCpeFlg.size()) {
      ...
      d51uRetRulCpeFlg.set(
          index,
          new D51uRetRulCpeFlg(
              this,
              beginD51uRetRulCpeFlg + index * D51uRetRulCpeFlg.getD51uRetRulCpeFlgFieldLength()));
    }
  ...
  /**
   * Update D51uRetRulCpeFlg at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-CPE-FLG
   *
   * @param index
   * @param value
   */
