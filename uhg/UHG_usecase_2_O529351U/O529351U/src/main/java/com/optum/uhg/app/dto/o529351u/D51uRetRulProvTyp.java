...
public class D51uRetRulProvTyp extends D51uRetRulProvTypSerialized {
  ...
  /**
   * Returns the value of d51uRetRuleProvTyp Corresponding COBOL Variable is D51U-RET-RULE-PROV-TYP
   *
  ...
  public D51uRetRuleProvTyp getD51uRetRuleProvTyp(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRuleProvTyp - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RULE_PROV_TYP_SIZE);
    }
    if (index >= d51uRetRuleProvTyp.size()) {
      ...
      d51uRetRuleProvTyp.set(
          index,
          new D51uRetRuleProvTyp(
              this,
              beginD51uRetRuleProvTyp
                  + index * D51uRetRuleProvTyp.getD51uRetRuleProvTypFieldLength()));
    }
  ...
  /**
   * Update D51uRetRuleProvTyp at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RULE-PROV-TYP
   *
   * @param index
   * @param value
   */
