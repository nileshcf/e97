...
public class TestVariables extends TestVariablesSerialized {
  ...
  /**
   * set variable testCaus Corresponding COBOL Variable is TEST-CAUS
   *
   * @param value
   */
  ...
  /**
   * Update TestCaus with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestCaus with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestCaus(
  ...
  /**
   * Update TestCaus with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestCaus with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestCaus(
  ...
  /**
   * set variable testProvTyp Corresponding COBOL Variable is TEST-PROV-TYP
   *
   * @param value
   */
  ...
  /**
   * Update TestProvTyp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestProvTyp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestProvTyp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update TestProvTyp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestProvTyp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestProvTyp(
  ...
  /**
   * set variable testPos Corresponding COBOL Variable is TEST-POS
   *
   * @param value
   */
  ...
  /**
   * Update TestPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestPos(
  ...
  /**
   * set variable testSvcCd Corresponding COBOL Variable is TEST-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update TestSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update TestSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestSvcCd(
  ...
  /**
   * Update TestDiagArea with the passed value Corresponding COBOL Variable is TEST-DIAG-AREA
   *
   * @param value
   */
  ...
  /**
   * Update TestDiagArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestDiagArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestDiagArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update TestDiagArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestDiagArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestDiagArea(
  ...
  /**
   * set variable testCpeDescCd Corresponding COBOL Variable is TEST-CPE-DESC-CD
   *
   * @param value
   */
  ...
  /**
   * Update TestCpeDescCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestCpeDescCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestCpeDescCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update TestCpeDescCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update TestCpeDescCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setTestCpeDescCd(
