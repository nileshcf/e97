...
/**
 * The class SavRecTyp1FixedSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class SavRecTyp1FixedSerialized extends Field {
  ...
  /**
   * sets parent for this SavRecTyp1FixedSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isSavNbrClminfModified() {
    ...
    localSavNbrClminfCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSavNbrClminf(short savNbrClminf) {
    replaceValue( //  save the value as string
        getBinaryString(savNbrClminf, SAV_NBR_CLMINF_LEN), beginSavNbrClminf, SAV_NBR_CLMINF_LEN);
  ...
  /**
   * refreshSavNbrClminf is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isSavNbrHistModified() {
    ...
    localSavNbrHistCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSavNbrHist(short savNbrHist) {
    replaceValue( //  save the value as string
        getBinaryString(savNbrHist, SAV_NBR_HIST_LEN), beginSavNbrHist, SAV_NBR_HIST_LEN);
  ...
  public boolean isSavNbrOfLinesModified() {
    ...
    localSavNbrOfLinesCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSavNbrOfLines is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isSavNbrRec4Modified() {
    ...
    localSavNbrRec4Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSavNbrRec4(short savNbrRec4) {
    replaceValue( //  save the value as string
        getBinaryString(savNbrRec4, SAV_NBR_REC_4_LEN), beginSavNbrRec4, SAV_NBR_REC_4_LEN);
  ...
  public boolean isSavNbrRec4InsModified() {
    ...
    localSavNbrRec4InsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSavNbrRec4Ins is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
