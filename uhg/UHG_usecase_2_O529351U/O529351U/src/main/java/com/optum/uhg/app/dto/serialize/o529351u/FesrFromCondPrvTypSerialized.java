...
/**
 * The class FesrFromCondPrvTypSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FesrFromCondPrvTypSerialized extends Field {
  ...
  /**
   * sets parent for this FesrFromCondPrvTypSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesrFromPrvTypModified() {
    ...
    localFesrFromPrvTypCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesrFromPrvTyp is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesrFromPrvTyp() {
    return (substring(
        getStringValue(), beginFesrFromPrvTyp, beginFesrFromPrvTyp + FESR_FROM_PRV_TYP_LEN));
  }
}
