...
public class ServToAlphatl extends ServToAlphatlSerialized {
  ...
  /**
   * set variable feSvc14alTo Corresponding COBOL Variable is FE-SVC-1-4AL-TO
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc14alTo with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc14alTo with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc14alTo(
  ...
  /**
   * Update FeSvc14alTo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc14alTo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc14alTo(
  ...
  /**
   * set variable feSvc5alTo Corresponding COBOL Variable is FE-SVC-5AL-TO
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc5alTo with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc5alTo with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc5alTo(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FeSvc5alTo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc5alTo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc5alTo(
