...
/**
 * The class ServToAlphaflSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class ServToAlphaflSerialized extends Field {
  ...
  /**
   * sets parent for this ServToAlphaflSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFeSvc14alFrModified() {
    ...
    localFeSvc14alFrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFeSvc5alFrModified() {
    ...
    localFeSvc5alFrCounter = sharedCounter;
    return hasModified;
  }
