...
public class ServAlphal extends ServAlphalSerialized {
  ...
  /**
   * set variable svc14al Corresponding COBOL Variable is SVC-1-4AL
   *
   * @param value
   */
  ...
  /**
   * Update Svc14al with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc14al with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc14al(
  ...
  /**
   * Update Svc14al with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc14al with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc14al(
  ...
  /**
   * set variable svc5al Corresponding COBOL Variable is SVC-5AL
   *
   * @param value
   */
  ...
  /**
   * Update Svc5al with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc5al with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc5al(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Svc5al with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Svc5al with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSvc5al(
