...
public class FesrFromCondCause extends FesrFromCondCauseSerialized {
  ...
  /**
   * set variable fesrFromCauseCd Corresponding COBOL Variable is FESR-FROM-CAUSE-CD
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromCauseCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromCauseCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromCauseCd(
  ...
  /**
   * Update FesrFromCauseCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromCauseCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromCauseCd(
