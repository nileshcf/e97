...
public class ServToAlphaff extends ServToAlphaffSerialized {
  ...
  /**
   * set variable feSvc1afFr Corresponding COBOL Variable is FE-SVC-1AF-FR
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc1afFr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc1afFr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc1afFr(
  ...
  /**
   * Update FeSvc1afFr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc1afFr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc1afFr(
  ...
  /**
   * set variable feSvc25afFr Corresponding COBOL Variable is FE-SVC-2-5AF-FR
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc25afFr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc25afFr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc25afFr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FeSvc25afFr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc25afFr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc25afFr(
