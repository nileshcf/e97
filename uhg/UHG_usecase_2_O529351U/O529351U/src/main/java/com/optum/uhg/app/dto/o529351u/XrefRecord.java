...
public class XrefRecord extends XrefRecordSerialized {
  ...
  /**
   * Update XrfEeDataKey with the passed value Corresponding COBOL Variable is XRF-EE-DATA-KEY
   *
   * @param value
   */
  ...
  /**
   * Update XrfEeDataKey with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfEeDataKey with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfEeDataKey(
  ...
  /**
   * Update XrfEeDataKey with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfEeDataKey with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfEeDataKey(
  ...
  /**
   * Update XrfAdjstrNum with the passed value Corresponding COBOL Variable is XRF-ADJSTR-NUM
   *
   * @param number
   */
  ...
  /**
   * Returns the value of xrfCmData Corresponding COBOL Variable is XRF-CM-DATA
   *
   * @return xrfCmData
   */
  ...
  public char[] getXrfCmData(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "xrfCmData - Array index exceeded max Size {}, resetting it to max allowed",
          XRF_CM_DATA_SIZE);
    }
  ...
  /**
   * Update XrfCmData with the passed value at a given index Corresponding COBOL Variable is
   * XRF-CM-DATA
   *
   * @param index
   * @param value
  ...
  /**
   * Update XrfBankAcctEe with the passed value Corresponding COBOL Variable is XRF-BANK-ACCT-EE
   *
   * @param number
   */
  ...
  public void setXrfBankAcctEe(int number) {
    number =
        checkXrfBankAcctEeMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable xrfRegionIndEe Corresponding COBOL Variable is XRF-REGION-IND-EE
   *
   * @param value
   */
  ...
  /**
   * Update XrfRegionIndEe with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfRegionIndEe with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfRegionIndEe(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update XrfRegionIndEe with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfRegionIndEe with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfRegionIndEe(
  ...
  /**
   * Returns the value of xrfPrsInd Corresponding COBOL Variable is XRF-PRS-IND
   *
   * @return xrfPrsInd
   */
  ...
  public char[] getXrfPrsInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "xrfPrsInd - Array index exceeded max Size {}, resetting it to max allowed",
          XRF_PRS_IND_SIZE);
    }
  ...
  /**
   * Update XrfPrsInd with the passed value at a given index Corresponding COBOL Variable is
   * XRF-PRS-IND
   *
   * @param index
   * @param value
  ...
  /**
   * Update XrfUpdLog with the passed value Corresponding COBOL Variable is XRF-UPD-LOG
   *
   * @param value
   */
  ...
  /**
   * Update XrfUpdLog with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfUpdLog with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfUpdLog(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update XrfUpdLog with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfUpdLog with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfUpdLog(
  ...
  /**
   * Update XrfPortDate with the passed value Corresponding COBOL Variable is XRF-PORT-DATE
   *
   * @param number
   */
  ...
  /**
   * set variable xrfLcaInd Corresponding COBOL Variable is XRF-LCA-IND
   *
   * @param value
   */
  ...
  /**
   * Update XrfLcaInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfLcaInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfLcaInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update XrfLcaInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfLcaInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfLcaInd(
  ...
  /**
   * set variable xrfSourceSysInd Corresponding COBOL Variable is XRF-SOURCE-SYS-IND
   *
   * @param value
   */
  ...
  /**
   * Update XrfSourceSysInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfSourceSysInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfSourceSysInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update XrfSourceSysInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfSourceSysInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfSourceSysInd(
