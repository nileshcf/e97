...
/**
 * The class FesaKeySerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class FesaKeySerialized extends Field {
  ...
  /**
   * sets parent for this FesaKeySerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isFesaPolicyModified() {
    ...
    localFesaPolicyCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFesaPlanVarModified() {
    ...
    localFesaPlanVarCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaPlanVarIsNumeric() {
    return decimalIsNumeric(
        beginFesaPlanVar,
        FESA_PLAN_VAR_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isFesaEffDateModified() {
    ...
    localFesaEffDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaEffDateIsNumeric() {
    return decimalIsNumeric(
        beginFesaEffDate,
        FESA_EFF_DATE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  public boolean isFesaSpiNbrModified() {
    ...
    localFesaSpiNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesaSpiNbrIsNumeric() {
    return decimalIsNumeric(
        beginFesaSpiNbr,
        FESA_SPI_NBR_LEN); // check Packed Decimal field to see if it contains valid Number
  }
