...
public class D51uErrorTrace extends D51uErrorTraceSerialized {
  ...
  /**
   * set variable d51uSqlOrRespCd Corresponding COBOL Variable is D51U-SQL-OR-RESP-CD
   *
   * @param value
   */
  ...
  /**
   * Update D51uSqlOrRespCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uSqlOrRespCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uSqlOrRespCd(
  ...
  /**
   * Update D51uSqlOrRespCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uSqlOrRespCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uSqlOrRespCd(
  ...
  /**
   * set variable d51uDebugTracer Corresponding COBOL Variable is D51U-DEBUG-TRACER
   *
   * @param value
   */
  ...
  /**
   * Update D51uDebugTracer with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uDebugTracer with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uDebugTracer(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uDebugTracer with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uDebugTracer with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uDebugTracer(
  ...
  /**
   * set variable d51uParagraphNum Corresponding COBOL Variable is D51U-PARAGRAPH-NUM
   *
   * @param value
   */
  ...
  /**
   * Update D51uParagraphNum with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uParagraphNum with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uParagraphNum(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uParagraphNum with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uParagraphNum with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uParagraphNum(
