...
public class CetCicsErrorTableRedefined01 extends CetCicsErrorTableRedefined01Serialized {
  ...
  /**
   * set variable cetEibrcdByte3 Corresponding COBOL Variable is CET-EIBRCD-BYTE3
   *
   * @param value
   */
  ...
  /**
   * Update CetEibrcdByte3 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetEibrcdByte3 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCetEibrcdByte3(
  ...
  /**
   * Update CetEibrcdByte3 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CetEibrcdByte3 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCetEibrcdByte3(
