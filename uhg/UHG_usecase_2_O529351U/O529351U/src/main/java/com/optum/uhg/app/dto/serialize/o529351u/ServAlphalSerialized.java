...
/**
 * The class ServAlphalSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class ServAlphalSerialized extends Field {
  ...
  /**
   * sets parent for this ServAlphalSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isSvc14alModified() {
    ...
    localSvc14alCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSvc14al is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isSvc5alModified() {
    ...
    localSvc5alCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSvc5al is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
