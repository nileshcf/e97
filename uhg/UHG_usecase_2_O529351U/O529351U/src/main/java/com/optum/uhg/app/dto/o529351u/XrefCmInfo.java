...
public class XrefCmInfo extends XrefCmInfoSerialized {
  ...
  /**
   * Update XrfCmInfo with the passed value Corresponding COBOL Variable is XRF-CM-INFO
   *
   * @param value
   */
  ...
  /**
   * Update XrfCmInfo with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfCmInfo with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfCmInfo(
  ...
  /**
   * Update XrfCmInfo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update XrfCmInfo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setXrfCmInfo(
