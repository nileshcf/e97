...
/**
 * The class DclfeSpiRuleIcdSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DclfeSpiRuleIcdSerialized extends Field {
  ...
  public boolean isRicdSpiTblIdModified() {
    ...
    localRicdSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdSpiTblId() {
    return (substring(
        getStringValue(), beginRicdSpiTblId, beginRicdSpiTblId + RICD_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isRicdStsCdModified() {
    ...
    localRicdStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isRicdClmIcdSeqNbrModified() {
    ...
    localRicdClmIcdSeqNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdClmIcdSeqNbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isRicdDerivPlOfSvcCdModified() {
    ...
    localRicdDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeRicdDerivPlOfSvcCd(char[] ricdDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginRicdDerivPlOfSvcCd,
        RICD_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshRicdDerivPlOfSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginRicdDerivPlOfSvcCd,
        beginRicdDerivPlOfSvcCd + RICD_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isRicdDerivSvcCdModified() {
    ...
    localRicdDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdDerivSvcCd() {
    return (substring(
        getStringValue(), beginRicdDerivSvcCd, beginRicdDerivSvcCd + RICD_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isRicdDerivCausCdModified() {
    ...
    localRicdDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdDerivCausCd() {
    return (substring(
        getStringValue(), beginRicdDerivCausCd, beginRicdDerivCausCd + RICD_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isRicdCreatDttmModified() {
    ...
    localRicdCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdCreatDttm() {
    return (substring(
        getStringValue(), beginRicdCreatDttm, beginRicdCreatDttm + RICD_CREAT_DTTM_LEN));
  }
  ...
  public boolean isRicdClmIcdIndModified() {
    ...
    localRicdClmIcdIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdClmIcdInd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdClmIcdInd() {
    return (substring(
        getStringValue(), beginRicdClmIcdInd, beginRicdClmIcdInd + RICD_CLM_ICD_IND_LEN));
  }
  ...
  public boolean isRicdClmIcdFromCdModified() {
    ...
    localRicdClmIcdFromCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeRicdClmIcdFromCd(char[] ricdClmIcdFromCd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        ricdClmIcdFromCd, 0, getStringValue(), beginRicdClmIcdFromCd, RICD_CLM_ICD_FROM_CD_LEN);
  ...
  /**
   * refreshRicdClmIcdFromCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdClmIcdFromCd() {
    return (substring(
        getStringValue(), beginRicdClmIcdFromCd, beginRicdClmIcdFromCd + RICD_CLM_ICD_FROM_CD_LEN));
  }
  ...
  public boolean isRicdClmIcdToCdModified() {
    ...
    localRicdClmIcdToCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdClmIcdToCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdClmIcdToCd() {
    return (substring(
        getStringValue(), beginRicdClmIcdToCd, beginRicdClmIcdToCd + RICD_CLM_ICD_TO_CD_LEN));
  }
  ...
  public boolean isRicdPgmIdModified() {
    ...
    localRicdPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isRicdLstUpdtDttmModified() {
    ...
    localRicdLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRicdLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdLstUpdtDttm() {
    return (substring(
        getStringValue(), beginRicdLstUpdtDttm, beginRicdLstUpdtDttm + RICD_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isRicdLstUpdtUserIdModified() {
    ...
    localRicdLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeRicdLstUpdtUserId(char[] ricdLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        ricdLstUpdtUserId, 0, getStringValue(), beginRicdLstUpdtUserId, RICD_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshRicdLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRicdLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginRicdLstUpdtUserId,
        beginRicdLstUpdtUserId + RICD_LST_UPDT_USER_ID_LEN));
  }
}
