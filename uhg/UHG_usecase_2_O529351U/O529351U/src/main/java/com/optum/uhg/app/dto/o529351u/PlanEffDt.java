...
public class PlanEffDt extends PlanEffDtSerialized {
  ...
  /**
   * Update PlanEffCc with the passed value Corresponding COBOL Variable is WS-PLAN-EFF-CC
   *
   * @param number
   */
  ...
  /**
   * Update PlanEffYy with the passed value Corresponding COBOL Variable is WS-PLAN-EFF-YY
   *
   * @param number
   */
