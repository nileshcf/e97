...
public class UOutLineData51 extends UOutLineData51Serialized {
  ...
  /**
   * set variable uOutLinePos51 Corresponding COBOL Variable is LK-51U-OUT-LINE-POS
   *
   * @param value
   */
  ...
  /**
   * Update UOutLinePos51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLinePos51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLinePos51(
  ...
  /**
   * Update UOutLinePos51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLinePos51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLinePos51(
  ...
  /**
   * set variable uOutLineServiceCode51 Corresponding COBOL Variable is LK-51U-OUT-LINE-SERVICE-CODE
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineServiceCode51 with a char[] from an offset and length
   *
   * @param value
   */
  public void setUOutLineServiceCode51(char[] source, int sourceIndex) {
    replace(
        ...
        sourceIndex,
        source.length,
        beginUOutLineServiceCode51,
        uOutLineServiceCode51.length);
  }

  public void setUOutLineServiceCode51(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginUOutLineServiceCode51, uOutLineServiceCode51.length);
  }

  /**
   * Update UOutLineServiceCode51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLineServiceCode51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UOutLineServiceCode51 with another Field from an offset and length
   *
   * @param value
   */
  public void setUOutLineServiceCode51(Field source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, beginUOutLineServiceCode51, U_OUT_LINE_SERVICE_CODE_51_LEN);
  }

  /**
   * Update UOutLineServiceCode51 with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineDosDate51 with the passed value Corresponding COBOL Variable is
   * LK-51U-OUT-LINE-DOS-DATE
   *
   * @param number
   */
  public void setUOutLineDosDate51(int number) {
    uOutLineDosDate51 =
        checkUOutLineDosDate51MaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update UOutLineChargeAmt51 with the passed number Corresponding COBOL Variable is
   * LK-51U-OUT-LINE-CHARGE-AMT
   *
   * @param number
   */
  ...
  /**
   * Update UOutLineNotcovAmt51 with the passed number Corresponding COBOL Variable is
   * LK-51U-OUT-LINE-NOTCOV-AMT
   *
   * @param number
   */
  ...
  /**
   * set variable uOutLineRemarkCd51 Corresponding COBOL Variable is LK-51U-OUT-LINE-REMARK-CD
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineRemarkCd51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineRemarkCd51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLineRemarkCd51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UOutLineRemarkCd51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineRemarkCd51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLineRemarkCd51(
  ...
  /**
   * Update UOutLinePlanVar51 with the passed value Corresponding COBOL Variable is
   * LK-51U-OUT-LINE-PLAN-VAR
   *
   * @param number
   */
  ...
  public void setUOutLinePlanVar51(int number) {
    number =
        checkUOutLinePlanVar51MaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable uOutLineCauseCd51 Corresponding COBOL Variable is LK-51U-OUT-LINE-CAUSE-CD
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineCauseCd51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineCauseCd51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLineCauseCd51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UOutLineCauseCd51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutLineCauseCd51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutLineCauseCd51(
  ...
  /**
   * Update UOutLineAppUnits51 with the passed value Corresponding COBOL Variable is
  ...
  public void setUOutLineAppUnits51(int number) {
    uOutLineAppUnits51 =
        checkUOutLineAppUnits51MaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable uOutSpiTblId51 Corresponding COBOL Variable is LK-51U-OUT-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update UOutSpiTblId51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutSpiTblId51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutSpiTblId51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UOutSpiTblId51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutSpiTblId51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutSpiTblId51(
  ...
  /**
   * set variable uOutPosTierCd51 Corresponding COBOL Variable is LK-51U-OUT-POS-TIER-CD
   *
   * @param value
   */
  ...
  /**
   * Update UOutPosTierCd51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutPosTierCd51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutPosTierCd51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UOutPosTierCd51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutPosTierCd51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutPosTierCd51(
  ...
  /**
   * set variable uOutDiagElgInd51 Corresponding COBOL Variable is LK-51U-OUT-DIAG-ELG-IND
   *
   * @param value
   */
  ...
  /**
   * Update UOutDiagElgInd51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutDiagElgInd51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutDiagElgInd51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UOutDiagElgInd51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UOutDiagElgInd51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUOutDiagElgInd51(
