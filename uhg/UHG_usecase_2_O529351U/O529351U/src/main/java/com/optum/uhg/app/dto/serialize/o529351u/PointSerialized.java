...
/**
 * The class PointSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class PointSerialized extends Field {
  ...
  /**
   * sets parent for this PointSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isPoint1Modified() {
    ...
    localPoint1Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePoint1(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPoint1, 2);
    localPoint1Counter = shareString.getSerializedField().getModifiedCounter();
    return point1;
  }
  ...
  /**
   * refreshPoint1 is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isPoint2Modified() {
    ...
    localPoint2Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePoint2(char[] value) {
    ...
    point2 =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPoint2, 2);
    localPoint2Counter = shareString.getSerializedField().getModifiedCounter();
    return point2;
  }
  ...
  /**
   * refreshPoint2 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPoint3Modified() {
    ...
    localPoint3Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePoint3(char[] value) {
    ...
    point3 =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPoint3, 2);
    localPoint3Counter = shareString.getSerializedField().getModifiedCounter();
    return point3;
  }
  ...
  /**
   * refreshPoint3 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPoint4Modified() {
    ...
    localPoint4Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePoint4(char[] value) {
    ...
    point4 =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPoint4, 2);
    localPoint4Counter = shareString.getSerializedField().getModifiedCounter();
    return point4;
  }
  ...
  /**
   * refreshPoint4 is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
