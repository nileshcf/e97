...
/**
 * The class FesrIpaCodeSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class FesrIpaCodeSerialized extends Field {
  ...
  /**
   * sets parent for this FesrIpaCodeSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesrIpaCdModified() {
    ...
    localFesrIpaCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializeFesrIpaCd(char[] value) {
    ...
    replaceValue(padNumber(3, value, false /*isSigned?*/), beginFesrIpaCd, 3);
    localFesrIpaCdCounter = shareString.getSerializedField().getModifiedCounter();
    return fesrIpaCd;
  }
