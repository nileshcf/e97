...
/**
 * The class PlanVarInputLinesSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class PlanVarInputLinesSerialized extends Field {
  ...
  /**
   * sets parent for this PlanVarInputLinesSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
