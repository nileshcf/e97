...
public class XrfUpdLog extends XrfUpdLogSerialized {
  ...
  /**
   * Update XrfUpdDate with the passed value Corresponding COBOL Variable is XRF-UPD-DATE
   *
   * @param number
   */
  ...
  /**
   * Update XrfUpdTime with the passed value Corresponding COBOL Variable is XRF-UPD-TIME
   *
   * @param number
   */
