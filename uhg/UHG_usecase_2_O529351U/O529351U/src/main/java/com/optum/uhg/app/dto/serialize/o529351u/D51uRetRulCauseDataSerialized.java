...
/**
 * The class D51uRetRulCauseDataSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class D51uRetRulCauseDataSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulCauseDataSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
