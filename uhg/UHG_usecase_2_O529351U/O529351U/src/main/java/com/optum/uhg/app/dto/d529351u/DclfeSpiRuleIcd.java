...
public class DclfeSpiRuleIcd extends DclfeSpiRuleIcdSerialized {
  ...
  /**
   * set variable ricdSpiTblId Corresponding COBOL Variable is RICD-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update RicdSpiTblId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdSpiTblId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdSpiTblId(
  ...
  /**
   * Update RicdSpiTblId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdSpiTblId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdSpiTblId(
  ...
  /**
   * set variable ricdStsCd Corresponding COBOL Variable is RICD-STS-CD
   *
   * @param value
   */
  ...
  /**
   * Update RicdStsCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdStsCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdStsCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdStsCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdStsCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdStsCd(
  ...
  /**
   * Update RicdClmIcdSeqNbr with the passed value Corresponding COBOL Variable is
   * RICD-CLM-ICD-SEQ-NBR
   *
   * @param number
   */
  ...
  public void setRicdClmIcdSeqNbr(int number) {
    number =
        checkRicdClmIcdSeqNbrMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable ricdDerivPlOfSvcCd Corresponding COBOL Variable is RICD-DERIV-PL-OF-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivPlOfSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivPlOfSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdDerivPlOfSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdDerivPlOfSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivPlOfSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdDerivPlOfSvcCd(
  ...
  /**
   * set variable ricdDerivSvcCd Corresponding COBOL Variable is RICD-DERIV-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdDerivSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdDerivSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdDerivSvcCd(
  ...
  /**
   * set variable ricdDerivCausCd Corresponding COBOL Variable is RICD-DERIV-CAUS-CD
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivCausCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivCausCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdDerivCausCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdDerivCausCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdDerivCausCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdDerivCausCd(
  ...
  /**
   * set variable ricdCreatDttm Corresponding COBOL Variable is RICD-CREAT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update RicdCreatDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdCreatDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdCreatDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdCreatDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdCreatDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdCreatDttm(
  ...
  /**
   * set variable ricdClmIcdInd Corresponding COBOL Variable is RICD-CLM-ICD-IND
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdClmIcdInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdClmIcdInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdClmIcdInd(
  ...
  /**
   * set variable ricdClmIcdFromCd Corresponding COBOL Variable is RICD-CLM-ICD-FROM-CD
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdFromCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdFromCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdClmIcdFromCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdClmIcdFromCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdFromCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdClmIcdFromCd(
  ...
  /**
   * set variable ricdClmIcdToCd Corresponding COBOL Variable is RICD-CLM-ICD-TO-CD
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdToCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdToCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdClmIcdToCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdClmIcdToCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdClmIcdToCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdClmIcdToCd(
  ...
  /**
   * set variable ricdPgmId Corresponding COBOL Variable is RICD-PGM-ID
   *
   * @param value
   */
  ...
  /**
   * Update RicdPgmId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdPgmId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdPgmId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdPgmId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdPgmId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdPgmId(
  ...
  /**
   * set variable ricdLstUpdtDttm Corresponding COBOL Variable is RICD-LST-UPDT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update RicdLstUpdtDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdLstUpdtDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdLstUpdtDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdLstUpdtDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdLstUpdtDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdLstUpdtDttm(
  ...
  /**
   * set variable ricdLstUpdtUserId Corresponding COBOL Variable is RICD-LST-UPDT-USER-ID
   *
   * @param value
   */
  ...
  /**
   * Update RicdLstUpdtUserId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdLstUpdtUserId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdLstUpdtUserId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update RicdLstUpdtUserId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update RicdLstUpdtUserId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setRicdLstUpdtUserId(
  ...
  /**
   * initializes DclfeSpiRuleIcd String fields defaults to Spaces short/int/long defaults to zero
