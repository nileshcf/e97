...
public class FesrFromCondPrvTyp extends FesrFromCondPrvTypSerialized {
  ...
  /**
   * set variable fesrFromPrvTyp Corresponding COBOL Variable is FESR-FROM-PRV-TYP
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromPrvTyp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromPrvTyp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromPrvTyp(
  ...
  /**
   * Update FesrFromPrvTyp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesrFromPrvTyp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesrFromPrvTyp(
