...
public class PlanVarRec extends PlanVarRecSerialized {
  ...
  /**
   * set variable fesaPolicy01 Corresponding COBOL Variable is WS-FESA-POLICY
   *
   * @param value
   */
  ...
  /**
   * Update FesaPolicy01 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaPolicy01 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaPolicy01(
  ...
  /**
   * Update FesaPolicy01 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaPolicy01 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaPolicy01(
  ...
  /**
   * Update FesaPlanVar01 with the passed value Corresponding COBOL Variable is WS-FESA-PLAN-VAR
   *
   * @param number
   */
  ...
  /**
   * Update FesaEffDate01 with the passed value Corresponding COBOL Variable is WS-FESA-EFF-DATE
   *
   * @param number
   */
  ...
  /**
   * Update FesaSpiNbr01 with the passed value Corresponding COBOL Variable is WS-FESA-SPI-NBR
   *
   * @param number
   */
  ...
  /**
   * set variable fesaPosTierCd Corresponding COBOL Variable is WS-FESA-POS-TIER-CD
   *
   * @param value
   */
  ...
  /**
   * Update FesaPosTierCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaPosTierCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaPosTierCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesaPosTierCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaPosTierCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaPosTierCd(
  ...
  /**
   * set variable fesaSpiPriDiagInd Corresponding COBOL Variable is WS-FESA-SPI-PRI-DIAG-IND
   *
   * @param value
   */
  ...
  /**
   * Update FesaSpiPriDiagInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaSpiPriDiagInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaSpiPriDiagInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesaSpiPriDiagInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaSpiPriDiagInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaSpiPriDiagInd(
  ...
  /**
   * set variable fesaSpiDiagElgInd Corresponding COBOL Variable is WS-FESA-SPI-DIAG-ELG-IND
   *
   * @param value
   */
  ...
  /**
   * Update FesaSpiDiagElgInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaSpiDiagElgInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaSpiDiagElgInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FesaSpiDiagElgInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FesaSpiDiagElgInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFesaSpiDiagElgInd(
