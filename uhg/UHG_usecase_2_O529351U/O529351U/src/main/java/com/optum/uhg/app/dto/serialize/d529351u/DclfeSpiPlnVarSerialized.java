...
/**
 * The class DclfeSpiPlnVarSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DclfeSpiPlnVarSerialized extends Field {
  ...
  public boolean isPlnvSpiTblIdModified() {
    ...
    localPlnvSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPlnvSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPlnvSpiTblId() {
    return (substring(
        getStringValue(), beginPlnvSpiTblId, beginPlnvSpiTblId + PLNV_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isPlnvStsCdModified() {
    ...
    localPlnvStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlnvPolNbrModified() {
    ...
    localPlnvPolNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlnvPlnNbrModified() {
    ...
    localPlnvPlnNbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlnvEffDtModified() {
    ...
    localPlnvEffDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlnvCreatDttmModified() {
    ...
    localPlnvCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPlnvCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPlnvCreatDttm() {
    return (substring(
        getStringValue(), beginPlnvCreatDttm, beginPlnvCreatDttm + PLNV_CREAT_DTTM_LEN));
  }
  ...
  public boolean isPlnvCancDtModified() {
    ...
    localPlnvCancDtCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlnvPgmIdModified() {
    ...
    localPlnvPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isPlnvLstUpdtDttmModified() {
    ...
    localPlnvLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshPlnvLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPlnvLstUpdtDttm() {
    return (substring(
        getStringValue(), beginPlnvLstUpdtDttm, beginPlnvLstUpdtDttm + PLNV_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isPlnvLstUpdtUserIdModified() {
    ...
    localPlnvLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializePlnvLstUpdtUserId(char[] plnvLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        plnvLstUpdtUserId, 0, getStringValue(), beginPlnvLstUpdtUserId, PLNV_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshPlnvLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshPlnvLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginPlnvLstUpdtUserId,
        beginPlnvLstUpdtUserId + PLNV_LST_UPDT_USER_ID_LEN));
  }
}
