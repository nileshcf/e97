...
/**
 * The class FesrFromCondFrToIcd9Serialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class FesrFromCondFrToIcd9Serialized extends Field {
  ...
  /**
   * sets parent for this FesrFromCondFrToIcd9Serialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isFesrFromFrIcd9Modified() {
    ...
    localFesrFromFrIcd9Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesrFromFrIcd9 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesrFromFrIcd9() {
    return (substring(
        getStringValue(), beginFesrFromFrIcd9, beginFesrFromFrIcd9 + FESR_FROM_FR_ICD_9_LEN));
  }
  ...
  public boolean isFesrFromToIcd9Modified() {
    ...
    localFesrFromToIcd9Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesrFromToIcd9 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesrFromToIcd9() {
    return (substring(
        getStringValue(), beginFesrFromToIcd9, beginFesrFromToIcd9 + FESR_FROM_TO_ICD_9_LEN));
  }
}
