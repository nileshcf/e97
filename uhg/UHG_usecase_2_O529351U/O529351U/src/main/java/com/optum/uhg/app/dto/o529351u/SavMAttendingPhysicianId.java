...
public class SavMAttendingPhysicianId extends SavMAttendingPhysicianIdSerialized {
  ...
  /**
   * set variable savDrNmFst Corresponding COBOL Variable is SAV-DR-NM-FST
   *
   * @param value
   */
  ...
  /**
   * Update SavDrNmFst with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavDrNmFst with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavDrNmFst(
  ...
  /**
   * Update SavDrNmFst with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavDrNmFst with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavDrNmFst(
