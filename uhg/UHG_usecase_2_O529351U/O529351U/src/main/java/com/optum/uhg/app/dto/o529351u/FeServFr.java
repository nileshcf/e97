...
public class FeServFr extends FeServFrSerialized {
  ...
  /**
   * set variable feSvc15Fr Corresponding COBOL Variable is FE-SVC-1-5-FR
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc15Fr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc15Fr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc15Fr(
  ...
  /**
   * Update FeSvc15Fr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc15Fr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc15Fr(
  ...
  /**
   * set variable feSvc6Fr Corresponding COBOL Variable is FE-SVC-6-FR
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc6Fr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc6Fr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc6Fr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FeSvc6Fr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FeSvc6Fr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFeSvc6Fr(
