...
/**
 * The class PlanCanDtSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class PlanCanDtSerialized extends Field {
  ...
  /**
   * sets parent for this PlanCanDtSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isPlanCanCcModified() {
    ...
    localPlanCanCcCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanCanCc(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanCanCc, 2);
    localPlanCanCcCounter = shareString.getSerializedField().getModifiedCounter();
    return planCanCc;
  }
  ...
  public boolean isPlanCanYyModified() {
    ...
    localPlanCanYyCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanCanYy(char[] value) {
    ...
    planCanYy =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanCanYy, 2);
    localPlanCanYyCounter = shareString.getSerializedField().getModifiedCounter();
    return planCanYy;
  }
