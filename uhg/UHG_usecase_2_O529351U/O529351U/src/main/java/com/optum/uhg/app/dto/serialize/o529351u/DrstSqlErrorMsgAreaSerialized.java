...
/**
 * The class DrstSqlErrorMsgAreaSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DrstSqlErrorMsgAreaSerialized extends Field {
  ...
  /**
   * sets parent for this DrstSqlErrorMsgAreaSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isDrstErrTxtModified() {
    ...
    localDrstErrTxtCounter = sharedCounter;
    return hasModified;
  }
