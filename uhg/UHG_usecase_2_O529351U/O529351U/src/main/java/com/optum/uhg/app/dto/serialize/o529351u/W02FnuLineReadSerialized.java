...
/**
 * The class W02FnuLineReadSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class W02FnuLineReadSerialized extends Field {
  ...
  public boolean isW02FnuTranRdModified() {
    ...
    localW02FnuTranRdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02FnuTranRd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02FnuTranRd() {
    return (substring(
        getStringValue(), beginW02FnuTranRd, beginW02FnuTranRd + W_02_FNU_TRAN_RD_LEN));
  }
  ...
  public boolean isW02FnuFileRdModified() {
    ...
    localW02FnuFileRdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02FnuFileRd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02FnuFileRd() {
    return (substring(
        getStringValue(), beginW02FnuFileRd, beginW02FnuFileRd + W_02_FNU_FILE_RD_LEN));
  }
  ...
  public boolean isW02FnuKeyRdModified() {
    ...
    localW02FnuKeyRdCounter = sharedCounter;
    return hasModified;
  }
