...
/**
 * The class ULineData51Serialized is used to define offsets in order to serialize in a fixed String
 *
...
public class ULineData51Serialized extends Field {
  ...
  /**
   * sets parent for this ULineData51Serialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isULinePos51Modified() {
    ...
    localULinePos51Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isULineServiceCode51Modified() {
    ...
    localULineServiceCode51Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeULineServiceCode51(char[] uLineServiceCode51) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginULineServiceCode51,
        U_LINE_SERVICE_CODE_51_LEN);
  ...
  /**
   * refreshULineServiceCode51 is used to refresh the latest value of a variable from the Serialized
  ...
  public char[] refreshULineServiceCode51() {
    return (substring(
        getStringValue(),
        beginULineServiceCode51,
        beginULineServiceCode51 + U_LINE_SERVICE_CODE_51_LEN));
  }
  ...
  public boolean isULineDosDate51Modified() {
    ...
    localULineDosDate51Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean uLineDosDate51IsNumeric() {
    return decimalIsNumeric(
        beginULineDosDate51,
        U_LINE_DOS_DATE_51_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshULineDosDate51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isULineChargeAmt51Modified() {
    ...
    localULineChargeAmt51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uLineChargeAmt51IsNumeric() {
    return decimalIsNumeric(
        beginULineChargeAmt51,
        U_LINE_CHARGE_AMT_51_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  /**
  ...
  protected void serializeULineChargeAmt51(BigDecimal uLineChargeAmt51) {
    putDecimal(
        beginULineChargeAmt51,
        uLineChargeAmt51,
        U_LINE_CHARGE_AMT_51_LEN,
        U_LINE_CHARGE_AMT_51_SCALE,
        true);
  ...
  /**
   * refreshULineChargeAmt51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public BigDecimal refreshULineChargeAmt51() throws CFException {
    try {
      return (getDecimal(
          beginULineChargeAmt51, U_LINE_CHARGE_AMT_51_LEN, U_LINE_CHARGE_AMT_51_SCALE));
    } catch (Exception ex) {
  ...
  public boolean isULineNotcovAmt51Modified() {
    ...
    localULineNotcovAmt51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uLineNotcovAmt51IsNumeric() {
    return decimalIsNumeric(
        beginULineNotcovAmt51,
        U_LINE_NOTCOV_AMT_51_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  /**
   * This method returns packed Decimal String in the mainframe format
   *
  ...
  protected void serializeULineNotcovAmt51(BigDecimal uLineNotcovAmt51) {
    putDecimal(
        beginULineNotcovAmt51,
        uLineNotcovAmt51,
        U_LINE_NOTCOV_AMT_51_LEN,
        U_LINE_NOTCOV_AMT_51_SCALE,
        true);
  ...
  /**
   * refreshULineNotcovAmt51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public BigDecimal refreshULineNotcovAmt51() throws CFException {
    try {
      return (getDecimal(
          beginULineNotcovAmt51, U_LINE_NOTCOV_AMT_51_LEN, U_LINE_NOTCOV_AMT_51_SCALE));
    } catch (Exception ex) {
  ...
  public boolean isULineRemarkCd51Modified() {
    ...
    localULineRemarkCd51Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshULineRemarkCd51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshULineRemarkCd51() {
    return (substring(
        getStringValue(), beginULineRemarkCd51, beginULineRemarkCd51 + U_LINE_REMARK_CD_51_LEN));
  }
  ...
  public boolean isULineAppUnits51Modified() {
    ...
    localULineAppUnits51Counter = sharedCounter;
    return hasModified;
  }

  public boolean uLineAppUnits51IsNumeric() {
    return decimalIsNumeric(
        beginULineAppUnits51,
        U_LINE_APP_UNITS_51_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshULineAppUnits51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isULineDiagPointer51Modified() {
    ...
    localULineDiagPointer51Counter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeULineDiagPointer51(char[] uLineDiagPointer51) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginULineDiagPointer51,
        U_LINE_DIAG_POINTER_51_LEN);
  ...
  /**
   * refreshULineDiagPointer51 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshULineDiagPointer51() {
    return (substring(
        getStringValue(),
        beginULineDiagPointer51,
        beginULineDiagPointer51 + U_LINE_DIAG_POINTER_51_LEN));
  }
}
