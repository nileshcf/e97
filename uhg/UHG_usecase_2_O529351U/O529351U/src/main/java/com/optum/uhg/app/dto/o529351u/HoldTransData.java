...
public class HoldTransData extends HoldTransDataSerialized {
  ...
  /**
   * set variable holdPs Corresponding COBOL Variable is WS-HOLD-PS
   *
   * @param value
   */
  ...
  /**
   * Update HoldPs with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldPs with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldPs(
  ...
  /**
   * Update HoldPs with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldPs with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldPs(
  ...
  /**
   * set variable holdSvc Corresponding COBOL Variable is WS-HOLD-SVC
   *
   * @param value
   */
  ...
  /**
   * Update HoldSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HoldSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldSvc(
  ...
  /**
   * set variable holdCauseCd Corresponding COBOL Variable is WS-HOLD-CAUSE-CD
   *
   * @param value
   */
  ...
  /**
   * Update HoldCauseCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldCauseCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldCauseCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HoldCauseCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldCauseCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldCauseCd(
  ...
  /**
   * set variable holdSpiTblId Corresponding COBOL Variable is WS-HOLD-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update HoldSpiTblId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldSpiTblId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldSpiTblId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HoldSpiTblId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldSpiTblId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldSpiTblId(
  ...
  /**
   * set variable hold1SpiTblId Corresponding COBOL Variable is WS-HOLD1-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update Hold1SpiTblId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Hold1SpiTblId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHold1SpiTblId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Hold1SpiTblId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Hold1SpiTblId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHold1SpiTblId(
  ...
  /**
   * set variable holdPosTierCd Corresponding COBOL Variable is WS-HOLD-POS-TIER-CD
   *
   * @param value
   */
  ...
  /**
   * Update HoldPosTierCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldPosTierCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldPosTierCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HoldPosTierCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldPosTierCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldPosTierCd(
  ...
  /**
   * set variable holdDiagElgInd Corresponding COBOL Variable is WS-HOLD-DIAG-ELG-IND
   *
   * @param value
   */
  ...
  /**
   * Update HoldDiagElgInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldDiagElgInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldDiagElgInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update HoldDiagElgInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update HoldDiagElgInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setHoldDiagElgInd(
