...
public class LsSaveRec1Clminf extends LsSaveRec1ClminfSerialized {
  ...
  public LsSaveRec1Clminf() {
    ...
    for (int arrayIndex = 0; arrayIndex < SAV_PROVIDER_AREA_SIZE; arrayIndex++) {
      savProviderArea.add(
          new SavProviderArea(
              this,
              beginSavProviderArea + arrayIndex * SavProviderArea.getSavProviderAreaFieldLength()));
    }
  ...
  /**
   * Returns the value of savProviderArea Corresponding COBOL Variable is SAV-PROVIDER-AREA
   *
  ...
  public SavProviderArea getSavProviderArea(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "savProviderArea - Array index exceeded max Size {}, resetting it to max allowed",
          SAV_PROVIDER_AREA_SIZE);
    }
    if (index >= savProviderArea.size()) {
      ...
      savProviderArea.set(
          ...
          new SavProviderArea(
              this,
              beginSavProviderArea + index * SavProviderArea.getSavProviderAreaFieldLength()));
    }
  ...
  /**
   * Update SavProviderArea at index with the passed value Corresponding COBOL Variable is
   * SAV-PROVIDER-AREA
   *
   * @param index
   * @param value
  ...
  /**
   * Update SavDiagnosisCodePoa with the passed value Corresponding COBOL Variable is
   * SAV-DIAGNOSIS-CODE-POA
   *
   * @param value
   */
  ...
  /**
   * Update SavDiagnosisCodePoa with a String from an offset and length
   *
   * @param value
   */
  public void setSavDiagnosisCodePoa(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, savDiagnosisCodePoa.begin, savDiagnosisCodePoa.length());
  }

  /**
   * Update SavDiagnosisCodePoa with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavDiagnosisCodePoa(
  ...
  /**
   * Update SavDiagnosisCodePoa with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavDiagnosisCodePoa with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavDiagnosisCodePoa(
  ...
  /**
   * set variable savDiagCodePoa Corresponding COBOL Variable is SAV-DIAG-CODE-POA
   *
   * @param value
   */
  ...
  /**
   * Update SavDiagCodePoa with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavDiagCodePoa with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavDiagCodePoa(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SavDiagCodePoa with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavDiagCodePoa with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavDiagCodePoa(
  ...
  /**
   * Update SavInputProcId with the passed value Corresponding COBOL Variable is SAV-INPUT-PROC-ID
   *
   * @param value
   */
  ...
  /**
   * Update SavInputProcId with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavInputProcId with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavInputProcId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SavInputProcId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavInputProcId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavInputProcId(
  ...
  /**
   * Update SavInputProcIdNum with the passed value Corresponding COBOL Variable is
   * SAV-INPUT-PROC-ID-NUM
   *
   * @param number
   */
  ...
  /**
   * set variable savOncologyInd Corresponding COBOL Variable is SAV-ONCOLOGY-IND
   *
   * @param value
   */
  ...
  /**
   * Update SavOncologyInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavOncologyInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavOncologyInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SavOncologyInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavOncologyInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavOncologyInd(
  ...
  /**
   * set variable savReferingNpi Corresponding COBOL Variable is SAV-REFERING-NPI
   *
   * @param value
   */
  ...
  /**
   * Update SavReferingNpi with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavReferingNpi with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavReferingNpi(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SavReferingNpi with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavReferingNpi with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavReferingNpi(
  ...
  /**
   * set variable savAttendingNpi Corresponding COBOL Variable is SAV-ATTENDING-NPI
   *
   * @param value
   */
  ...
  /**
   * Update SavAttendingNpi with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavAttendingNpi with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavAttendingNpi(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SavAttendingNpi with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavAttendingNpi with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavAttendingNpi(
