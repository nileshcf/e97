...
public class Sqlca extends SqlcaSerialized {
  ...
  /**
   * set variable sqlcaid Corresponding COBOL Variable is SQLCAID
   *
   * @param value
   */
  ...
  /**
   * Update Sqlcaid with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlcaid with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlcaid(
  ...
  /**
   * Update Sqlcaid with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlcaid with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlcaid(
  ...
  /**
   * Update Sqlcabc with the passed value Corresponding COBOL Variable is SQLCABC
   *
   * @param number
   */
  ...
  /**
   * Update Sqlcode with the passed value Corresponding COBOL Variable is SQLCODE
   *
   * @param number
   */
  ...
  /**
   * Update Sqlerrm with the passed value Corresponding COBOL Variable is SQLERRM
   *
   * @param value
   */
  ...
  /**
   * Update Sqlerrm with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlerrm with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlerrm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlerrm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlerrm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlerrm(
  ...
  /**
   * set variable sqlerrp Corresponding COBOL Variable is SQLERRP
   *
   * @param value
   */
  ...
  /**
   * Update Sqlerrp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlerrp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlerrp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlerrp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlerrp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlerrp(
  ...
  /**
   * Returns the value of sqlerrd Corresponding COBOL Variable is SQLERRD
   *
   * @return sqlerrd
   */
  ...
  public int getSqlerrd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "sqlerrd - Array index exceeded max Size {}, resetting it to max allowed", SQLERRD_SIZE);
    }
    return getInt(beginSqlerrd + index * SQLERRD_LEN);
  }

  /**
   * Update Sqlerrd at index with the passed value Corresponding COBOL Variable is SQLERRD
   *
   * @param index
   * @param number
   */
  ...
  private void setSqlerrd(int index, int value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setSqlerrd(int, String, boolean), resetting it to 0", index);
      index = 0;
    } else if (index >= SQLERRD_SIZE) {
      index = SQLERRD_SIZE - 1; // can't exceed max array size
      logger.trace(
          "sqlerrd - Array index exceeded max Size "
              + SQLERRD_SIZE
  ...
  /**
   * Update Sqlwarn with the passed value Corresponding COBOL Variable is SQLWARN
   *
   * @param value
   */
  ...
  /**
   * Update Sqlext with the passed value Corresponding COBOL Variable is SQLEXT
   *
   * @param value
   */
  ...
  /**
   * Update Sqlext with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlext with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlext(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlext with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlext with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlext(
