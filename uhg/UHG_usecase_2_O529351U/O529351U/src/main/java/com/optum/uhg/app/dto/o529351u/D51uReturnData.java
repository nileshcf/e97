...
public class D51uReturnData extends D51uReturnDataSerialized {
  ...
  /**
   * set variable d51uRetFeSpi Corresponding COBOL Variable is D51U-RET-FE-SPI
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetFeSpi with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetFeSpi with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetFeSpi(
  ...
  /**
   * Update D51uRetFeSpi with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetFeSpi with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetFeSpi(
  ...
  /**
   * set variable d51uRetPolicy Corresponding COBOL Variable is D51U-RET-POLICY
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPolicy with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPolicy with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetPolicy(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetPolicy with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPolicy with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetPolicy(
  ...
  /**
   * Update D51uRetPlan with the passed value Corresponding COBOL Variable is D51U-RET-PLAN
   *
   * @param number
   */
  ...
  /**
   * set variable d51uRetEffDt Corresponding COBOL Variable is D51U-RET-EFF-DT
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetEffDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetEffDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetEffDt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetEffDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetEffDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetEffDt(
  ...
  /**
   * set variable d51uRetCanDt Corresponding COBOL Variable is D51U-RET-CAN-DT
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetCanDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetCanDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetCanDt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetCanDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetCanDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetCanDt(
  ...
  /**
   * set variable d51uRetStatus Corresponding COBOL Variable is D51U-RET-STATUS
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetStatus with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetStatus with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetStatus(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetStatus with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetStatus with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetStatus(
  ...
  /**
   * set variable d51uRetPosTierCd Corresponding COBOL Variable is D51U-RET-POS-TIER-CD
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPosTierCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPosTierCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetPosTierCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetPosTierCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPosTierCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetPosTierCd(
  ...
  /**
   * set variable d51uRetPriDiagInd Corresponding COBOL Variable is D51U-RET-PRI-DIAG-IND
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPriDiagInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPriDiagInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetPriDiagInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetPriDiagInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetPriDiagInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetPriDiagInd(
  ...
  /**
   * set variable d51uRetDiagElgInd Corresponding COBOL Variable is D51U-RET-DIAG-ELG-IND
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDiagElgInd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDiagElgInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDiagElgInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uRetDiagElgInd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uRetDiagElgInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uRetDiagElgInd(
