...
public class M51uFlags extends M51uFlagsSerialized {
  ...
  /**
   * set variable m51uFunctionFlag Corresponding COBOL Variable is M51U-FUNCTION-FLAG
   *
   * @param value
   */
  ...
  /**
   * Update M51uFunctionFlag with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uFunctionFlag with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uFunctionFlag(
  ...
  /**
   * Update M51uFunctionFlag with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uFunctionFlag with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uFunctionFlag(
  ...
  /**
   * set variable m51uIllogicalCondSw Corresponding COBOL Variable is M51U-ILLOGICAL-COND-SW
   *
   * @param value
   */
  ...
  /**
   * Update M51uIllogicalCondSw with a char[] from an offset and length
   *
   * @param value
   */
  public void setM51uIllogicalCondSw(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginM51uIllogicalCondSw, m51uIllogicalCondSw.length);
  }
  ...
  /**
   * Update M51uIllogicalCondSw with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uIllogicalCondSw(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update M51uIllogicalCondSw with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uIllogicalCondSw with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uIllogicalCondSw(
