...
/**
 * The class D51uRetRulKeysSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRulKeysSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRulKeysSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
