...
/**
 * The class SavProviderTinNumber15Serialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class SavProviderTinNumber15Serialized extends Field {
  ...
  /**
   * sets parent for this SavProviderTinNumber15Serialized to the parent and set the serialize
  ...
  public boolean isSavProviderSuffixModified() {
    ...
    localSavProviderSuffixCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeSavProviderSuffix(char[] value) {
    ...
    replaceValue(padNumber(5, value, false /*isSigned?*/), beginSavProviderSuffix, 5);
    localSavProviderSuffixCounter = shareString.getSerializedField().getModifiedCounter();
    return savProviderSuffix;
  }
  ...
  /**
   * refreshSavProviderSuffix is used to refresh the latest value of a variable from the Serialized
