...
public class DclfeSpiRuleFrToSvc extends DclfeSpiRuleFrToSvcSerialized {
  ...
  /**
   * set variable frtoSpiTblId Corresponding COBOL Variable is FRTO-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update FrtoSpiTblId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoSpiTblId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoSpiTblId(
  ...
  /**
   * Update FrtoSpiTblId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoSpiTblId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoSpiTblId(
  ...
  /**
   * set variable frtoStsCd Corresponding COBOL Variable is FRTO-STS-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoStsCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoStsCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoStsCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoStsCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoStsCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoStsCd(
  ...
  /**
   * set variable frtoDerivPlOfSvcCd Corresponding COBOL Variable is FRTO-DERIV-PL-OF-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivPlOfSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivPlOfSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoDerivPlOfSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoDerivPlOfSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivPlOfSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoDerivPlOfSvcCd(
  ...
  /**
   * set variable frtoDerivSvcCd Corresponding COBOL Variable is FRTO-DERIV-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoDerivSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoDerivSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoDerivSvcCd(
  ...
  /**
   * set variable frtoDerivCausCd Corresponding COBOL Variable is FRTO-DERIV-CAUS-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivCausCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivCausCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoDerivCausCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoDerivCausCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoDerivCausCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoDerivCausCd(
  ...
  /**
   * set variable frtoCreatDttm Corresponding COBOL Variable is FRTO-CREAT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update FrtoCreatDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoCreatDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoCreatDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoCreatDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoCreatDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoCreatDttm(
  ...
  /**
   * Update FrtoFromToSvcSeqNbr with the passed value Corresponding COBOL Variable is
   * FRTO-FROM-TO-SVC-SEQ-NBR
   *
   * @param number
   */
  ...
  public void setFrtoFromToSvcSeqNbr(int number) {
    number =
        checkFrtoFromToSvcSeqNbrMaxLimit(
  ...
  /**
   * set variable frtoClmFrmSvcCd Corresponding COBOL Variable is FRTO-CLM-FRM-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoClmFrmSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoClmFrmSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoClmFrmSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoClmFrmSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoClmFrmSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoClmFrmSvcCd(
  ...
  /**
   * set variable frtoClmToSvcCd Corresponding COBOL Variable is FRTO-CLM-TO-SVC-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoClmToSvcCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoClmToSvcCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoClmToSvcCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoClmToSvcCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoClmToSvcCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoClmToSvcCd(
  ...
  /**
   * set variable frtoSvcTypCd Corresponding COBOL Variable is FRTO-SVC-TYP-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoSvcTypCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoSvcTypCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoSvcTypCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoSvcTypCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoSvcTypCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoSvcTypCd(
  ...
  /**
   * set variable frtoPgmId Corresponding COBOL Variable is FRTO-PGM-ID
   *
   * @param value
   */
  ...
  /**
   * Update FrtoPgmId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoPgmId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoPgmId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoPgmId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoPgmId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoPgmId(
  ...
  /**
   * set variable frtoLstUpdtDttm Corresponding COBOL Variable is FRTO-LST-UPDT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update FrtoLstUpdtDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoLstUpdtDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoLstUpdtDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoLstUpdtDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoLstUpdtDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoLstUpdtDttm(
  ...
  /**
   * set variable frtoLstUpdtUserId Corresponding COBOL Variable is FRTO-LST-UPDT-USER-ID
   *
   * @param value
   */
  ...
  /**
   * Update FrtoLstUpdtUserId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoLstUpdtUserId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoLstUpdtUserId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoLstUpdtUserId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoLstUpdtUserId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoLstUpdtUserId(
  ...
  /**
   * set variable frtoHipaaCd Corresponding COBOL Variable is FRTO-HIPAA-CD
   *
   * @param value
   */
  ...
  /**
   * Update FrtoHipaaCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoHipaaCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoHipaaCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update FrtoHipaaCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update FrtoHipaaCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setFrtoHipaaCd(
  ...
  /**
   * initializes DclfeSpiRuleFrToSvc String fields defaults to Spaces short/int/long defaults to
