...
/**
 * The class ServAlphafSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class ServAlphafSerialized extends Field {
  ...
  /**
   * sets parent for this ServAlphafSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isSvc1afModified() {
    ...
    localSvc1afCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSvc1af is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isSvc25afModified() {
    ...
    localSvc25afCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshSvc25af is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
