...
public class D51uRetRuleProvTyp extends D51uRetRuleProvTypSerialized {
  ...
  /**
   * set variable d51uPtypDrvPos Corresponding COBOL Variable is D51U-PTYP-DRV-POS
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvPos with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvPos with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypDrvPos(
  ...
  /**
   * Update D51uPtypDrvPos with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvPos with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypDrvPos(
  ...
  /**
   * set variable d51uPtypDrvSvc Corresponding COBOL Variable is D51U-PTYP-DRV-SVC
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvSvc with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvSvc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypDrvSvc(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uPtypDrvSvc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvSvc with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypDrvSvc(
  ...
  /**
   * set variable d51uPtypDrvCau Corresponding COBOL Variable is D51U-PTYP-DRV-CAU
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvCau with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvCau with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypDrvCau(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uPtypDrvCau with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypDrvCau with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypDrvCau(
  ...
  /**
   * set variable d51uPtypProvTyp Corresponding COBOL Variable is D51U-PTYP-PROV-TYP
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypProvTyp with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypProvTyp with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypProvTyp(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uPtypProvTyp with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uPtypProvTyp with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uPtypProvTyp(
