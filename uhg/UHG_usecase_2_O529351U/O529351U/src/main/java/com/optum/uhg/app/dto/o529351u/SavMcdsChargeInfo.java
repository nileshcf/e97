...
public class SavMcdsChargeInfo extends SavMcdsChargeInfoSerialized {
  ...
  /**
   * set variable savNatDrugCd Corresponding COBOL Variable is SAV-NAT-DRUG-CD
   *
   * @param value
   */
  ...
  /**
   * Update SavNatDrugCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavNatDrugCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavNatDrugCd(
  ...
  /**
   * Update SavNatDrugCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavNatDrugCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavNatDrugCd(
  ...
  /**
   * Update SavFiller with the passed value Corresponding COBOL Variable is SAV-FILLER
   *
   * @param value
   */
  ...
  /**
   * Update SavFiller with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavFiller with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavFiller(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update SavFiller with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavFiller with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavFiller(
