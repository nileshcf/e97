...
public class CsvcCodeA extends CsvcCodeASerialized {
  ...
  /**
   * set variable csvcCode15A Corresponding COBOL Variable is CSVC-CODE-1-5-A
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode15A with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode15A with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCode15A(
  ...
  /**
   * Update CsvcCode15A with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode15A with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCode15A(
  ...
  /**
   * set variable csvcCode6A Corresponding COBOL Variable is CSVC-CODE-6-A
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode6A with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode6A with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCode6A(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update CsvcCode6A with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update CsvcCode6A with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCsvcCode6A(
