...
public class D51uOtherReq extends D51uOtherReqSerialized {
  ...
  /**
   * set variable d51uReqDosDate Corresponding COBOL Variable is D51U-REQ-DOS-DATE
   *
   * @param value
   */
  ...
  /**
   * Update D51uReqDosDate with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uReqDosDate with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uReqDosDate(
  ...
  /**
   * Update D51uReqDosDate with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uReqDosDate with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uReqDosDate(
  ...
  /**
   * initializes D51uOtherReq String fields defaults to Spaces short/int/long defaults to zero
