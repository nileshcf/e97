...
public class D51uReturnArea extends D51uReturnAreaSerialized {
  ...
  /**
   * Update D51uNonArrayData with the passed value Corresponding COBOL Variable is
   * D51U-NON-ARRAY-DATA
   *
   * @param value
   */
  ...
  /**
   * Update D51uNonArrayData with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uNonArrayData with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uNonArrayData(
  ...
  /**
   * Update D51uNonArrayData with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uNonArrayData with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uNonArrayData(
  ...
  /**
   * Update D51uArrayData with the passed value Corresponding COBOL Variable is D51U-ARRAY-DATA
   *
   * @param value
   */
  ...
  /**
   * Update D51uArrayData with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uArrayData with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uArrayData(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update D51uArrayData with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update D51uArrayData with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setD51uArrayData(
