...
/**
 * The class DclfeSpiRuleIpaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DclfeSpiRuleIpaSerialized extends Field {
  ...
  public boolean isRipaSpiTblIdModified() {
    ...
    localRipaSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaSpiTblId() {
    return (substring(
        getStringValue(), beginRipaSpiTblId, beginRipaSpiTblId + RIPA_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isRipaStsCdModified() {
    ...
    localRipaStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isRipaDerivPlOfSvcCdModified() {
    ...
    localRipaDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeRipaDerivPlOfSvcCd(char[] ripaDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginRipaDerivPlOfSvcCd,
        RIPA_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshRipaDerivPlOfSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginRipaDerivPlOfSvcCd,
        beginRipaDerivPlOfSvcCd + RIPA_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isRipaDerivSvcCdModified() {
    ...
    localRipaDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaDerivSvcCd() {
    return (substring(
        getStringValue(), beginRipaDerivSvcCd, beginRipaDerivSvcCd + RIPA_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isRipaDerivCausCdModified() {
    ...
    localRipaDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaDerivCausCd() {
    return (substring(
        getStringValue(), beginRipaDerivCausCd, beginRipaDerivCausCd + RIPA_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isRipaCreatDttmModified() {
    ...
    localRipaCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaCreatDttm() {
    return (substring(
        getStringValue(), beginRipaCreatDttm, beginRipaCreatDttm + RIPA_CREAT_DTTM_LEN));
  }
  ...
  public boolean isRipaClmIpa1CdModified() {
    ...
    localRipaClmIpa1CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaClmIpa1Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaClmIpa1Cd() {
    return (substring(
        getStringValue(), beginRipaClmIpa1Cd, beginRipaClmIpa1Cd + RIPA_CLM_IPA_1_CD_LEN));
  }
  ...
  public boolean isRipaClmIpa2CdModified() {
    ...
    localRipaClmIpa2CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaClmIpa2Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaClmIpa2Cd() {
    return (substring(
        getStringValue(), beginRipaClmIpa2Cd, beginRipaClmIpa2Cd + RIPA_CLM_IPA_2_CD_LEN));
  }
  ...
  public boolean isRipaClmIpa3CdModified() {
    ...
    localRipaClmIpa3CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaClmIpa3Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaClmIpa3Cd() {
    return (substring(
        getStringValue(), beginRipaClmIpa3Cd, beginRipaClmIpa3Cd + RIPA_CLM_IPA_3_CD_LEN));
  }
  ...
  public boolean isRipaPgmIdModified() {
    ...
    localRipaPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isRipaLstUpdtDttmModified() {
    ...
    localRipaLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaLstUpdtDttm() {
    return (substring(
        getStringValue(), beginRipaLstUpdtDttm, beginRipaLstUpdtDttm + RIPA_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isRipaLstUpdtUserIdModified() {
    ...
    localRipaLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeRipaLstUpdtUserId(char[] ripaLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        ripaLstUpdtUserId, 0, getStringValue(), beginRipaLstUpdtUserId, RIPA_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshRipaLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginRipaLstUpdtUserId,
        beginRipaLstUpdtUserId + RIPA_LST_UPDT_USER_ID_LEN));
  }
  ...
  public boolean isRipaGrpTbl1NbrModified() {
    ...
    localRipaGrpTbl1NbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaGrpTbl1Nbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaGrpTbl1Nbr() {
    return (substring(
        getStringValue(), beginRipaGrpTbl1Nbr, beginRipaGrpTbl1Nbr + RIPA_GRP_TBL_1_NBR_LEN));
  }
  ...
  public boolean isRipaGrpTbl2NbrModified() {
    ...
    localRipaGrpTbl2NbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaGrpTbl2Nbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaGrpTbl2Nbr() {
    return (substring(
        getStringValue(), beginRipaGrpTbl2Nbr, beginRipaGrpTbl2Nbr + RIPA_GRP_TBL_2_NBR_LEN));
  }
  ...
  public boolean isRipaGrpTbl3NbrModified() {
    ...
    localRipaGrpTbl3NbrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshRipaGrpTbl3Nbr is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshRipaGrpTbl3Nbr() {
    return (substring(
        getStringValue(), beginRipaGrpTbl3Nbr, beginRipaGrpTbl3Nbr + RIPA_GRP_TBL_3_NBR_LEN));
  }
}
