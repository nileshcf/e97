...
/**
 * The class D51uArrayDataSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uArrayDataSerialized extends Field {
  ...
  /**
   * sets parent for this D51uArrayDataSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
