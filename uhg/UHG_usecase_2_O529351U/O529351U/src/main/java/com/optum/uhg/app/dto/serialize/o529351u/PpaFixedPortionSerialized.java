...
/**
 * The class PpaFixedPortionSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class PpaFixedPortionSerialized extends Field {
  ...
  /**
   * sets parent for this PpaFixedPortionSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isPpaLastUpdDateModified() {
    ...
    localPpaLastUpdDateCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean ppaLastUpdDateIsNumeric() {
    return decimalIsNumeric(
        beginPpaLastUpdDate,
        PPA_LAST_UPD_DATE_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaLastUpdDate is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isPpaLastUpdTimeModified() {
    ...
    localPpaLastUpdTimeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean ppaLastUpdTimeIsNumeric() {
    return decimalIsNumeric(
        beginPpaLastUpdTime,
        PPA_LAST_UPD_TIME_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaLastUpdTime is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  ...
  public boolean isPpaPpoIdCountModified() {
    ...
    localPpaPpoIdCountCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean ppaPpoIdCountIsNumeric() {
    return decimalIsNumeric(
        beginPpaPpoIdCount,
        PPA_PPO_ID_COUNT_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshPpaPpoIdCount is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
