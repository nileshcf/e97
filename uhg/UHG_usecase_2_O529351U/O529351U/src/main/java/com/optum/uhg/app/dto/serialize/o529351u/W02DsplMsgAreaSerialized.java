...
/**
 * The class W02DsplMsgAreaSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class W02DsplMsgAreaSerialized extends Field {
  ...
  public boolean isW02MqTimeModified() {
    ...
    localW02MqTimeCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isW02DsplErrIndModified() {
    ...
    localW02DsplErrIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02DsplErrInd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02DsplErrInd() {
    return (substring(
        getStringValue(), beginW02DsplErrInd, beginW02DsplErrInd + W_02_DSPL_ERR_IND_LEN));
  }
  ...
  public boolean isW02DsplMsgModified() {
    ...
    localW02DsplMsgCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isW02RespCdModified() {
    ...
    localW02RespCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected long serializeW02RespCd(char[] value) {
    ...
    replaceValue(padNumber(8, value, false /*isSigned?*/), beginW02RespCd, 8);
    localW02RespCdCounter = shareString.getSerializedField().getModifiedCounter();
    return w02RespCd;
  }
  ...
  public boolean isW02AbendingProgModified() {
    ...
    localW02AbendingProgCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshW02AbendingProg is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshW02AbendingProg() {
    return (substring(
        getStringValue(), beginW02AbendingProg, beginW02AbendingProg + W_02_ABENDING_PROG_LEN));
  }
  ...
  public boolean isW02MainProgModified() {
    ...
    localW02MainProgCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isW02FnuIcnModified() {
    ...
    localW02FnuIcnCounter = sharedCounter;
    return hasModified;
  }
