...
public class Ioi02bCurRecAddrArea extends Ioi02bCurRecAddrAreaSerialized {
  ...
  /**
   * Update Ioi02bRelRecNum with the passed value Corresponding COBOL Variable is
   * IOI-02B-REL-REC-NUM
   *
   * @param number
   */
  ...
  /**
   * Update Ioi02bRelBlkNum with the passed value Corresponding COBOL Variable is
   * IOI-02B-REL-BLK-NUM
   *
   * @param number
   */
