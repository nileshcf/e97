...
public class DrstSqlErrorMsgArea extends DrstSqlErrorMsgAreaSerialized {
  ...
  /**
   * set variable drstErrTxt Corresponding COBOL Variable is DRST-ERR-TXT
   *
   * @param value
   */
  ...
  /**
   * Update DrstErrTxt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstErrTxt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstErrTxt(
  ...
  /**
   * Update DrstErrTxt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstErrTxt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstErrTxt(
