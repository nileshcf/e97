...
public class SavRecTyp3Fileaid extends SavRecTyp3FileaidSerialized {
  ...
  /**
   * Update SavMcdsVariable with the passed value Corresponding COBOL Variable is SAV-MCDS-VARIABLE
   *
   * @param value
   */
  ...
  /**
   * Update SavMcdsVariable with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavMcdsVariable with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavMcdsVariable(
  ...
  /**
   * Update SavMcdsVariable with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavMcdsVariable with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavMcdsVariable(
