...
/**
 * The class NewTransSpiTableRSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class NewTransSpiTableRSerialized extends Field {
  ...
  /**
   * sets parent for this NewTransSpiTableRSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
