...
/**
 * The class FesrKey01Serialized is used to define offsets in order to serialize in a fixed String
 *
...
public class FesrKey01Serialized extends Field {
  ...
  /**
   * sets parent for this FesrKey01Serialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesrSpiNbr01Modified() {
    ...
    localFesrSpiNbr01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesrSpiNbr01IsNumeric() {
    return decimalIsNumeric(
        beginFesrSpiNbr01,
        FESR_SPI_NBR_01_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesrSpiNbr01 is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isFesrToPs01Modified() {
    ...
    localFesrToPs01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFesrToSvc01Modified() {
    ...
    localFesrToSvc01Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFesrToCause01Modified() {
    ...
    localFesrToCause01Counter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshFesrToCause01 is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshFesrToCause01() {
    return (substring(
        getStringValue(), beginFesrToCause01, beginFesrToCause01 + FESR_TO_CAUSE_01_LEN));
  }
}
