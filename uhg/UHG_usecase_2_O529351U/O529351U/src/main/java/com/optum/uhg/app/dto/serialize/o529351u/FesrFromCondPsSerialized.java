...
/**
 * The class FesrFromCondPsSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FesrFromCondPsSerialized extends Field {
  ...
  /**
   * sets parent for this FesrFromCondPsSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFesrFromPsModified() {
    ...
    localFesrFromPsCounter = sharedCounter;
    return hasModified;
  }
