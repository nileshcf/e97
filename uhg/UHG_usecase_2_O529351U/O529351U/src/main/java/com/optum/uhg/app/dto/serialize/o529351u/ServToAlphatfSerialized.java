...
/**
 * The class ServToAlphatfSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class ServToAlphatfSerialized extends Field {
  ...
  /**
   * sets parent for this ServToAlphatfSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFeSvc1afToModified() {
    ...
    localFeSvc1afToCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFeSvc25afToModified() {
    ...
    localFeSvc25afToCounter = sharedCounter;
    return hasModified;
  }
