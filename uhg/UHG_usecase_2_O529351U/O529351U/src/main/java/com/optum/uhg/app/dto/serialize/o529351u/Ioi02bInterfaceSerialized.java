...
/**
 * The class Ioi02bInterfaceSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class Ioi02bInterfaceSerialized extends Field {
  ...
  public boolean isIoi02bPassedRecAddrModified() {
    ...
    localIoi02bPassedRecAddrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bPassedRecAddr is used to refresh the latest value of a variable from the
  ...
  public boolean isIoi02bPassedRecPtrModified() {
    ...
    localIoi02bPassedRecPtrCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshIoi02bPassedRecPtr is used to refresh the latest value of a variable from the Serialized
  ...
  public boolean isIoi02bErrorModified() {
    ...
    localIoi02bErrorCounter = sharedCounter;
    return hasModified;
  }
