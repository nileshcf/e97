...
/**
 * The class PlanDtSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class PlanDtSerialized extends Field {
  ...
  /**
   * sets parent for this PlanDtSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isPlanCcModified() {
    ...
    localPlanCcCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanCc(char[] value) {
    ...
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanCc, 2);
    localPlanCcCounter = shareString.getSerializedField().getModifiedCounter();
    return planCc;
  }
  ...
  /**
   * refreshPlanCc is used to refresh the latest value of a variable from the Serialized String the
  ...
  public boolean isPlanYyModified() {
    ...
    localPlanYyCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanYy(char[] value) {
    ...
    planYy =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanYy, 2);
    localPlanYyCounter = shareString.getSerializedField().getModifiedCounter();
    return planYy;
  }
  ...
  /**
   * refreshPlanYy is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPlanMmModified() {
    ...
    localPlanMmCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanMm(char[] value) {
    ...
    planMm =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanMm, 2);
    localPlanMmCounter = shareString.getSerializedField().getModifiedCounter();
    return planMm;
  }
  ...
  /**
   * refreshPlanMm is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
  ...
  public boolean isPlanDdModified() {
    ...
    localPlanDdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected int serializePlanDd(char[] value) {
    ...
    planDd =
        (int)
            convertString2Number(
                value, false /*isSigned?*/, true /*signTrailing?*/, false /*storeSignSeparate?*/);
    replaceValue(padNumber(2, value, false /*isSigned?*/), beginPlanDd, 2);
    localPlanDdCounter = shareString.getSerializedField().getModifiedCounter();
    return planDd;
  }
  ...
  /**
   * refreshPlanDd is used to refresh the latest value of a variable from the Serialized String the
   * most common reason to serialize an Object as a string in to write to a file. There can be
   * several other reasons for serialization as well
   */
