...
/**
 * The class D51uRetRuleKeysSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uRetRuleKeysSerialized extends Field {
  ...
  /**
   * sets parent for this D51uRetRuleKeysSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uRetDrvPosModified() {
    ...
    localD51uRetDrvPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRetDrvPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRetDrvPos() {
    return (substring(
        getStringValue(), beginD51uRetDrvPos, beginD51uRetDrvPos + D_51U_RET_DRV_POS_LEN));
  }
  ...
  public boolean isD51uRetDrvSvcModified() {
    ...
    localD51uRetDrvSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRetDrvSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRetDrvSvc() {
    return (substring(
        getStringValue(), beginD51uRetDrvSvc, beginD51uRetDrvSvc + D_51U_RET_DRV_SVC_LEN));
  }
  ...
  public boolean isD51uRetDrvCauModified() {
    ...
    localD51uRetDrvCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRetDrvCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRetDrvCau() {
    return (substring(
        getStringValue(), beginD51uRetDrvCau, beginD51uRetDrvCau + D_51U_RET_DRV_CAU_LEN));
  }
  ...
  public boolean isD51uRetRuleSwModified() {
    ...
    localD51uRetRuleSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uRetRuleSw is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uRetRuleSw() {
    return (substring(
        getStringValue(), beginD51uRetRuleSw, beginD51uRetRuleSw + D_51U_RET_RULE_SW_LEN));
  }
}
