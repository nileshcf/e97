...
public class SavMcdsInfo extends SavMcdsInfoSerialized {
  ...
  /**
   * set variable savMedcFailedDedpdAlloc Corresponding COBOL Variable is
   * SAV-MEDC-FAILED-DEDPD-ALLOC
   *
   * @param value
   */
  ...
  /**
   * Update SavMedcFailedDedpdAlloc with a char[] from an offset and length
   *
   * @param value
   */
  public void setSavMedcFailedDedpdAlloc(char[] source, int sourceIndex) {
    replace(
        ...
        savMedcFailedDedpdAlloc.length);
  }
  ...
  /**
   * Update SavMedcFailedDedpdAlloc with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavMedcFailedDedpdAlloc(
  ...
  public void setSavMedcFailedDedpdAlloc(Field source) {
    replace(
        source, 0, source.length(), beginSavMedcFailedDedpdAlloc, SAV_MEDC_FAILED_DEDPD_ALLOC_LEN);
  }

  /**
   * Update SavMedcFailedDedpdAlloc with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavMedcFailedDedpdAlloc with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
