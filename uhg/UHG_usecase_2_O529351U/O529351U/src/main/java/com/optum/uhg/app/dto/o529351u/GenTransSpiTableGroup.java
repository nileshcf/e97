...
public class GenTransSpiTableGroup extends GenTransSpiTableGroupSerialized {
  ...
  /**
   * set variable genTransSpiTable Corresponding COBOL Variable is GEN-TRANS-SPI-TABLE
   *
   * @param value
   */
  ...
  /**
   * Update GenTransSpiTable with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update GenTransSpiTable with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setGenTransSpiTable(
  ...
  /**
   * Update GenTransSpiTable with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update GenTransSpiTable with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setGenTransSpiTable(
  ...
  /**
   * Update GenTransSpiTableR with the passed value Corresponding COBOL Variable is
   * GEN-TRANS-SPI-TABLE-R
   *
   * @param value
   */
  ...
  /**
   * Update GenTransSpiTableR with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update GenTransSpiTableR with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setGenTransSpiTableR(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update GenTransSpiTableR with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update GenTransSpiTableR with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setGenTransSpiTableR(
