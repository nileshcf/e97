...
public class FesaDateTimestamp extends FesaDateTimestampSerialized {
  ...
  /**
   * Update FesaDatestamp with the passed value Corresponding COBOL Variable is FESA-DATESTAMP
   *
   * @param number
   */
  ...
  /**
   * Update FesaTimestamp with the passed value Corresponding COBOL Variable is FESA-TIMESTAMP
   *
   * @param number
   */
