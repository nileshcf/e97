...
public class DrstCicsErrorMsgArea extends DrstCicsErrorMsgAreaSerialized {
  ...
  /**
   * set variable drstCicsFiller Corresponding COBOL Variable is DRST-CICS-FILLER
   *
   * @param value
   */
  ...
  /**
   * Update DrstCicsFiller with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstCicsFiller with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstCicsFiller(
  ...
  /**
   * Update DrstCicsFiller with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstCicsFiller with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstCicsFiller(
