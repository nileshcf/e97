...
public class PlanCanDt extends PlanCanDtSerialized {
  ...
  /**
   * Update PlanCanCc with the passed value Corresponding COBOL Variable is WS-PLAN-CAN-CC
   *
   * @param number
   */
  ...
  /**
   * Update PlanCanYy with the passed value Corresponding COBOL Variable is WS-PLAN-CAN-YY
   *
   * @param number
   */
