...
public class DrstRestartDataArea extends DrstRestartDataAreaSerialized {
  ...
  /**
   * Update DrstReturnArea with the passed value Corresponding COBOL Variable is DRST-RETURN-AREA
   *
   * @param value
   */
  ...
  /**
   * Update DrstReturnArea with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstReturnArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstReturnArea(
  ...
  /**
   * Update DrstReturnArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstReturnArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstReturnArea(
  ...
  /**
   * Update DrstSqlErrorMsgArea with the passed value Corresponding COBOL Variable is
   * DRST-SQL-ERROR-MSG-AREA
   *
   * @param value
   */
  ...
  /**
   * Update DrstSqlErrorMsgArea with a String from an offset and length
   *
   * @param value
   */
  public void setDrstSqlErrorMsgArea(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, drstSqlErrorMsgArea.begin, drstSqlErrorMsgArea.length());
  }

  /**
   * Update DrstSqlErrorMsgArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstSqlErrorMsgArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrstSqlErrorMsgArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstSqlErrorMsgArea with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstSqlErrorMsgArea(
  ...
  /**
   * Update DrstCicsErrorMsgArea with the passed value Corresponding COBOL Variable is
   * DRST-CICS-ERROR-MSG-AREA
   *
   * @param value
   */
  ...
  /**
   * Update DrstCicsErrorMsgArea with a String from an offset and length
   *
   * @param value
   */
  public void setDrstCicsErrorMsgArea(char[] source, int sourceIndex, int sourceLen) {
    replace(
        source, sourceIndex, sourceLen, drstCicsErrorMsgArea.begin, drstCicsErrorMsgArea.length());
  }

  /**
   * Update DrstCicsErrorMsgArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstCicsErrorMsgArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrstCicsErrorMsgArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstCicsErrorMsgArea with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * Update DrstRetSupplementalArea with the passed value Corresponding COBOL Variable is
   * DRST-RET-SUPPLEMENTAL-AREA
   *
   * @param value
   */
  ...
  /**
   * Update DrstRetSupplementalArea with a String from an offset and length
   *
   * @param value
   */
  public void setDrstRetSupplementalArea(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        drstRetSupplementalArea.begin,
        drstRetSupplementalArea.length());
  }

  /**
   * Update DrstRetSupplementalArea with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstRetSupplementalArea(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrstRetSupplementalArea with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstRetSupplementalArea with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable drstRetLbmsub90Area Corresponding COBOL Variable is DRST-RET-LBMSUB90-AREA
   *
   * @param value
   */
  ...
  /**
   * Update DrstRetLbmsub90Area with a char[] from an offset and length
   *
   * @param value
   */
  public void setDrstRetLbmsub90Area(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginDrstRetLbmsub90Area, drstRetLbmsub90Area.length);
  }
  ...
  /**
   * Update DrstRetLbmsub90Area with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstRetLbmsub90Area(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update DrstRetLbmsub90Area with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update DrstRetLbmsub90Area with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setDrstRetLbmsub90Area(
