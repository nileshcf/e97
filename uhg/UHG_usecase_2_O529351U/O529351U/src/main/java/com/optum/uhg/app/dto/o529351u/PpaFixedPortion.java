...
public class PpaFixedPortion extends PpaFixedPortionSerialized {
  ...
  /**
   * Update PpaKey with the passed value Corresponding COBOL Variable is PPA-KEY
   *
   * @param value
   */
  ...
  /**
   * Update PpaKey with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaKey with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaKey(
  ...
  /**
   * Update PpaKey with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaKey with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaKey(
  ...
  /**
   * Update PpaLastUpdDate with the passed value Corresponding COBOL Variable is PPA-LAST-UPD-DATE
   *
   * @param number
   */
  public void setPpaLastUpdDate(int number) {
    ppaLastUpdDate =
        checkPpaLastUpdDateMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update PpaLastUpdTime with the passed value Corresponding COBOL Variable is PPA-LAST-UPD-TIME
   *
   * @param number
   */
  public void setPpaLastUpdTime(int number) {
    ppaLastUpdTime =
        checkPpaLastUpdTimeMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update PpaPpoIdCount with the passed value Corresponding COBOL Variable is PPA-PPO-ID-COUNT
   *
   * @param number
   */
  ...
  public void setPpaPpoIdCount(int number) {
    number =
        checkPpaPpoIdCountMaxLimit((short) number); // Truncate if value is beyond +/- Max range
