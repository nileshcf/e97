...
/**
 * The class DdEqisAltSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class DdEqisAltSerialized extends Field {
  ...
  public boolean isEqiAltIdModified() {
    ...
    localEqiAltIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isEqiAltFillerWsModified() {
    ...
    localEqiAltFillerWsCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshEqiAltFillerWs is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshEqiAltFillerWs() {
    return (substring(
        getStringValue(), beginEqiAltFillerWs, beginEqiAltFillerWs + EQI_ALT_FILLER_WS_LEN));
  }
}
