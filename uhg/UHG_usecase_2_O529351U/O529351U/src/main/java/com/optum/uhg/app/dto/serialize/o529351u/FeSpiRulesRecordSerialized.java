...
/**
 * The class FeSpiRulesRecordSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class FeSpiRulesRecordSerialized extends Field {
  ...
  public boolean isFesrUpdateIdModified() {
    ...
    localFesrUpdateIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean fesrUpdateIdIsNumeric() {
    return decimalIsNumeric(
        beginFesrUpdateId,
        FESR_UPDATE_ID_LEN); // check Packed Decimal field to see if it contains valid Number
  }
  ...
  /**
   * refreshFesrUpdateId is used to refresh the latest value of a variable from the Serialized
