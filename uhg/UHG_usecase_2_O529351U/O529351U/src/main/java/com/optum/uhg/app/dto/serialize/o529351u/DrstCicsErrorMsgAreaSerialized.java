...
/**
 * The class DrstCicsErrorMsgAreaSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class DrstCicsErrorMsgAreaSerialized extends Field {
  ...
  /**
   * sets parent for this DrstCicsErrorMsgAreaSerialized to the parent and set the serialize offset
   * to parameter begin
   *
   * @param parent
  ...
  public boolean isDrstCicsFillerModified() {
    ...
    localDrstCicsFillerCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshDrstCicsFiller is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshDrstCicsFiller() {
    return (substring(
        getStringValue(), beginDrstCicsFiller, beginDrstCicsFiller + DRST_CICS_FILLER_LEN));
  }
}
