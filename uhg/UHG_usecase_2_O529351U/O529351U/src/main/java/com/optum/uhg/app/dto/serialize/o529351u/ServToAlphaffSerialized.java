...
/**
 * The class ServToAlphaffSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class ServToAlphaffSerialized extends Field {
  ...
  /**
   * sets parent for this ServToAlphaffSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isFeSvc1afFrModified() {
    ...
    localFeSvc1afFrCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isFeSvc25afFrModified() {
    ...
    localFeSvc25afFrCounter = sharedCounter;
    return hasModified;
  }
