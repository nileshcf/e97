...
public class DclfeSpiPlnVar extends DclfeSpiPlnVarSerialized {
  ...
  /**
   * set variable plnvSpiTblId Corresponding COBOL Variable is PLNV-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update PlnvSpiTblId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvSpiTblId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvSpiTblId(
  ...
  /**
   * Update PlnvSpiTblId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvSpiTblId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvSpiTblId(
  ...
  /**
   * set variable plnvStsCd Corresponding COBOL Variable is PLNV-STS-CD
   *
   * @param value
   */
  ...
  /**
   * Update PlnvStsCd with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvStsCd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvStsCd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvStsCd with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvStsCd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvStsCd(
  ...
  /**
   * set variable plnvPolNbr Corresponding COBOL Variable is PLNV-POL-NBR
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPolNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPolNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvPolNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvPolNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPolNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvPolNbr(
  ...
  /**
   * set variable plnvPlnNbr Corresponding COBOL Variable is PLNV-PLN-NBR
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPlnNbr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPlnNbr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvPlnNbr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvPlnNbr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPlnNbr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvPlnNbr(
  ...
  /**
   * set variable plnvEffDt Corresponding COBOL Variable is PLNV-EFF-DT
   *
   * @param value
   */
  ...
  /**
   * Update PlnvEffDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvEffDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvEffDt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvEffDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvEffDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvEffDt(
  ...
  /**
   * set variable plnvCreatDttm Corresponding COBOL Variable is PLNV-CREAT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update PlnvCreatDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvCreatDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvCreatDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvCreatDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvCreatDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvCreatDttm(
  ...
  /**
   * set variable plnvCancDt Corresponding COBOL Variable is PLNV-CANC-DT
   *
   * @param value
   */
  ...
  /**
   * Update PlnvCancDt with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvCancDt with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvCancDt(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvCancDt with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvCancDt with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvCancDt(
  ...
  /**
   * set variable plnvPgmId Corresponding COBOL Variable is PLNV-PGM-ID
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPgmId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPgmId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvPgmId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvPgmId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvPgmId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvPgmId(
  ...
  /**
   * set variable plnvLstUpdtDttm Corresponding COBOL Variable is PLNV-LST-UPDT-DTTM
   *
   * @param value
   */
  ...
  /**
   * Update PlnvLstUpdtDttm with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvLstUpdtDttm with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvLstUpdtDttm(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvLstUpdtDttm with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvLstUpdtDttm with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvLstUpdtDttm(
  ...
  /**
   * set variable plnvLstUpdtUserId Corresponding COBOL Variable is PLNV-LST-UPDT-USER-ID
   *
   * @param value
   */
  ...
  /**
   * Update PlnvLstUpdtUserId with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvLstUpdtUserId with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvLstUpdtUserId(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PlnvLstUpdtUserId with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PlnvLstUpdtUserId with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPlnvLstUpdtUserId(
  ...
  /**
   * initializes DclfeSpiPlnVar String fields defaults to Spaces short/int/long defaults to zero
