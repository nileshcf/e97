...
import com.optum.uhg.app.dto.d529351u.D529351uCtx;
import com.optum.uhg.app.dto.d529351u.D529351uCtx.*;
import com.optum.uhg.app.dto.d529351u.DsmCallArea;
import com.optum.uhg.app.dto.d529351u.Vyspi51uCallArea;
import com.optum.uhg.app.repository.D529351uRepository;
...
public class D529351uImpl extends CommonProcess implements D529351u {
  ...
  @Override
  public int setParameter(D529351uCtx programCtx, String dsmCallArea, String vyspi51uCallArea)
      throws Exception {
    if (dsmCallArea != null)
      programCtx
          .getDsmCallArea()
    ...
    if (vyspi51uCallArea != null)
      programCtx
          .getVyspi51uCallArea()
          .setString(
              com.cloudframe.app.data.Field.getParm(vyspi51uCallArea),
              new String(CONSTANTS.EBCDIC_ENCODING));
    setInitDone(false);
    process(programCtx);
   ...
   *
   * <p>- dsmFuncCd01 COBOL Name: DSM-FUNC-CD - d51uKeyFeSpi COBOL Name: D51U-KEY-FE-SPI -
   * d51uKeyPolicy COBOL Name: D51U-KEY-POLICY - d51uKeyPlan COBOL Name: D51U-KEY-PLAN -
   * d51uKeyStatus COBOL Name: D51U-KEY-STATUS
   *
   * <p>Output :
   *
   * <p>- sqlcode_Ws COBOL Name: WS-SQLCODE - dclfeSpiPlnVar COBOL Name: DCLFE-SPI-PLN-VAR -
   * dclfeSpiRuleFrCondPos COBOL Name: DCLFE-SPI-RULE-FR-COND-POS - dclfeSpiRuleFrToSvc COBOL Name:
   * DCLFE-SPI-RULE-FR-TO-SVC - dclfeSpiRuleProvTyp COBOL Name: DCLFE-SPI-RULE-PROV-TYP -
   * dclfeSpiRuleIcd COBOL Name: DCLFE-SPI-RULE-ICD - dclfeSpiRuleCaus COBOL Name:
   * DCLFE-SPI-RULE-CAUS - dclfeSpiRuleIpa COBOL Name: DCLFE-SPI-RULE-IPA - dclfeSpiRuleCpeFlg COBOL
   * Name: DCLFE-SPI-RULE-CPE-FLG - d51uNbrOfEntries COBOL Name: D51U-NBR-OF-ENTRIES - lstIcdKey
   * COBOL Name: WS-LST-ICD-KEY - dsmFuncCd COBOL Name: WS-DSM-FUNC-CD - dsmFuncCd01 COBOL Name:
   * DSM-FUNC-CD - causSpiTblId COBOL Name: CAUS-SPI-TBL-ID - fcndSpiTblId COBOL Name:
   * FCND-SPI-TBL-ID - frtoSpiTblId COBOL Name: FRTO-SPI-TBL-ID - ptypSpiTblId COBOL Name:
   * PTYP-SPI-TBL-ID - ricdSpiTblId COBOL Name: RICD-SPI-TBL-ID - ripaSpiTblId COBOL Name:
   * RIPA-SPI-TBL-ID - cpeflSpiTblId COBOL Name: CPEFL-SPI-TBL-ID - d51uKeyFeSpi COBOL Name:
   * D51U-KEY-FE-SPI - plnvPolNbr COBOL Name: PLNV-POL-NBR - d51uKeyPolicy COBOL Name:
   * D51U-KEY-POLICY - plnvPlnNbr COBOL Name: PLNV-PLN-NBR - d51uKeyPlan COBOL Name: D51U-KEY-PLAN -
   * plnvStsCd COBOL Name: PLNV-STS-CD - causStsCd COBOL Name: CAUS-STS-CD - fcndStsCd COBOL Name:
   * FCND-STS-CD - frtoStsCd COBOL Name: FRTO-STS-CD - ptypStsCd COBOL Name: PTYP-STS-CD - ricdStsCd
   * COBOL Name: RICD-STS-CD - ripaStsCd COBOL Name: RIPA-STS-CD - cpeflStsCd COBOL Name:
   * CPEFL-STS-CD - d51uKeyStatus COBOL Name: D51U-KEY-STATUS - frtoSub COBOL Name: FRTO-SUB -
   * ptypSub COBOL Name: PTYP-SUB - icdSub COBOL Name: ICD-SUB - fcndSub COBOL Name: FCND-SUB -
   * causSub COBOL Name: CAUS-SUB - ipaSub COBOL Name: IPA-SUB - cflgSub COBOL Name: CFLG-SUB
   *
   * @throws CFException
   */
  @Override
  public InitializeOutCtx initialize(InitializeInCtx methodIn) throws Exception {
    ...
    //  cobolCode::INITIALIZE DCLFE-SPI-PLN-VAR DCLFE-SPI-RULE-FR-COND-POS DCLFE-SPI-RULE-FR-TO-SVC
    // DCLFE-SPI-RULE-PROV-TYP DCLFE-SPI-RULE-ICD DCLFE-SPI-RULE-CAUS DCLFE-SPI-RULE-IPA
    // DCLFE-SPI-RULE-CPE-FLG
    ...
    //  cobolCode::MOVE D51U-KEY-FE-SPI TO CAUS-SPI-TBL-ID FCND-SPI-TBL-ID FRTO-SPI-TBL-ID
    // PTYP-SPI-TBL-ID RICD-SPI-TBL-ID RIPA-SPI-TBL-ID CPEFL-SPI-TBL-ID
    ...
    //  cobolCode::MOVE D51U-KEY-STATUS TO PLNV-STS-CD CAUS-STS-CD FCND-STS-CD FRTO-STS-CD
    // PTYP-STS-CD RICD-STS-CD RIPA-STS-CD CPEFL-STS-CD
  ...
  /**
   * processing This method is derived from COBOL Paragraph - 2000-PROCESSING SECTION COBOL
   * Cyclomatic complexity - 7 Input :
   *
   * <p>- dsmFuncCd COBOL Name: WS-DSM-FUNC-CD - sub COBOL Name: WS-SUB - dsmFuncCd01 COBOL Name:
   * DSM-FUNC-CD
   *
   * <p>Output :
   *
   * <p>- sub COBOL Name: WS-SUB - d51uRetRuleKeys COBOL Name: D51U-RET-RULE-KEYS -
   * d51uMoreIcdRecords COBOL Name: D51U-MORE-ICD-RECORDS - dsmEditErrorField COBOL Name:
   * DSM-EDIT-ERROR-FIELD - dsmEditErrorValueInt COBOL Name: DSM-EDIT-ERROR-VALUE-INT - dsmFuncCd01
   * COBOL Name: DSM-FUNC-CD - dsmErrSectnName COBOL Name: DSM-ERR-SECTN-NAME - dsmErrPgmName COBOL
   * Name: DSM-ERR-PGM-NAME - d51uInvReason COBOL Name: D51U-INV-REASON
   *
   * @throws CFException
   */
  @Override
  public ProcessingOutCtx processing(ProcessingInCtx methodIn) throws Exception {
    ...
    if (methodIn.isFuncCd1()) {
      ...
      methodOut.setDsmEditErrorValueInt(
          CFUtil.cobolNumberFormatter(
              CONSTANTS.FORMAT_467480023,
              String.valueOf(methodOut.getDsmFuncCd01()).toCharArray()));
  ...
  /**
   * processFuncCd1 This method is derived from COBOL Paragraph - 2100-PROCESS-FUNC-CD-1 SECTION
   * COBOL Cyclomatic complexity - 3 Input :
   *
   * <p>- d51uReqDosDate COBOL Name: D51U-REQ-DOS-DATE
   *
   * <p>Output :
   *
   * <p>- fetchEnd COBOL Name: WS-FETCH-END - planFoundSw COBOL Name: PLAN-FOUND-SW - csSub COBOL
   * Name: CS-SUB - planMatch COBOL Name: WS-PLAN-MATCH - planEffDate COBOL Name: WS-PLAN-EFF-DATE -
   * planCanDate COBOL Name: WS-PLAN-CAN-DATE - db2DosYyyy COBOL Name: WS-DB2-DOS-YYYY -
   * d51uReqDosDate COBOL Name: D51U-REQ-DOS-DATE - db2DosMm COBOL Name: WS-DB2-DOS-MM - db2DosDd
   * COBOL Name: WS-DB2-DOS-DD - db2Dash1 COBOL Name: WS-DB2-DASH1 - db2Dash2 COBOL Name:
   * WS-DB2-DASH2
   *
   * @throws CFException
   */
  ...
  public ProcessFuncCd1OutCtx processFuncCd1(ProcessFuncCd1InCtx methodIn) throws Exception {
    ...
    methodIn
        .getWorkArea()
        .replace(
            methodIn.getVyspi51uCallArea() /*parent*/,
            54 /*fromOffset - (db2DosYyyy) */,
            4 /*fromLen*/,
            17 /*toOffset - (d51uReqDosDate) */,
            4 /*toLen*/);
    ...
    methodIn
        ...
        .replace(
            methodIn.getVyspi51uCallArea() /*parent*/,
            54 + 5 - 1 /*fromOffset - (db2DosMm) */,
            2 /*fromLen*/,
            22 /*toOffset - (d51uReqDosDate) */,
            2 /*toLen*/);
    ...
    methodIn
        ...
        .replace(
            methodIn.getVyspi51uCallArea() /*parent*/,
            54 + 7 - 1 /*fromOffset - (db2DosDd) */,
            2 /*fromLen*/,
            25 /*toOffset - (d51uReqDosDate) */,
            2 /*toLen*/);
    //  cobolCode::IF WS-DB2-DOS-MM = '99' OR '00' THEN
    //  LITERAL_00 = '00'
    if (compareChars(methodOut.getDb2DosMm(), CONSTANTS.LITERAL_99) == 0
        || compareChars(methodOut.getDb2DosMm(), CONSTANTS.LITERAL_00) == 0) {
      //  LITERAL_12 = '12'
  ...
  /**
   * openCsplnvCursor This method is derived from COBOL Paragraph - 2150-OPEN-CSPLNV-CURSOR SECTION
   * COBOL Cyclomatic complexity - 6 Input :
   *
   * <p>- fetchEnd COBOL Name: WS-FETCH-END - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- csSub COBOL Name: CS-SUB - dsmReturnCode COBOL Name: DSM-RETURN-CODE - d51uReturnCode
   * COBOL Name: D51U-RETURN-CODE - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   * - d51uInvReason COBOL Name: D51U-INV-REASON - d51uSqlOrRespCd COBOL Name: D51U-SQL-OR-RESP-CD -
   * d51uDebugTracer COBOL Name: D51U-DEBUG-TRACER - d51uParagraphNum COBOL Name: D51U-PARAGRAPH-NUM
   *
   * @throws CFException
   */
  @Override
  public OpenCsplnvCursorOutCtx openCsplnvCursor(OpenCsplnvCursorInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT A.SPI_TBL_ID , B.POS_TIER_TYP_CD , B.PRI_DIAG_IND , B.MJR_DIAG_ELIG_IND
    // FROM FE_SPI_PLN_VAR A INNER JOIN FE_SPI_DESC_HDR B ON B.SPI_TBL_ID = A.SPI_TBL_ID AND
    // B.SPI_STS_CD = 'A' AND B.STS_CD = 'A' WHERE A.POL_NBR = ? AND A.PLN_NBR = ? AND A.EFF_DT <= ?
    // AND A.CANC_DT >= ? AND A.STS_CD = 'A' ORDER BY A.SPI_TBL_ID ASC , A.EFF_DT DESC FOR FETCH
    // ONLY
    programCtx.setCsplnvResultSet(
        d529351uRepository.openCsplnvD529351u(
            methodIn.getDclfeSpiPlnVar(), methodIn.getWorkArea(), programCtx.getSqlca()));
    ...
    switch (methodOut.getSqlcode()) {
      ...
      default:
        ...
        methodOut.setD51uSqlOrRespCd(
            CFUtil.cobolNumberFormatter(
                CONSTANTS.FORMAT_431311340,
                String.valueOf(methodOut.getSqlcode_Ws()).toCharArray()));
  ...
  /**
   * fetchCsplnv This method is derived from COBOL Paragraph - 2180-FETCH-CSPLNV SECTION COBOL
   * Cyclomatic complexity - 11 Input :
   *
   * <p>- sqlerrd COBOL Name: SQLERRD - csSub COBOL Name: CS-SUB - planMatch COBOL Name:
   * WS-PLAN-MATCH - hv01SpiTblId COBOL Name: HV01-SPI-TBL-ID - hv14PosTierTypCd COBOL Name:
   * HV14-POS-TIER-TYP-CD - hv0aPriDiagInd COBOL Name: HV0A-PRI-DIAG-IND - hv15MjrDiagEligInd COBOL
   * Name: HV15-MJR-DIAG-ELIG-IND - plnvPolNbr COBOL Name: PLNV-POL-NBR - plnvPlnNbr COBOL Name:
   * PLNV-PLN-NBR - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsnnrows COBOL Name: DSNNROWS - planFoundSw COBOL Name: PLAN-FOUND-SW - hv01Index COBOL
   * Name: HV01-INDEX - hv14Index COBOL Name: HV14-INDEX - hv0aIndex COBOL Name: HV0A-INDEX -
   * hv15Index COBOL Name: HV15-INDEX - csSub COBOL Name: CS-SUB - planMatch COBOL Name:
   * WS-PLAN-MATCH - d51uRetFeSpi COBOL Name: D51U-RET-FE-SPI - hv01SpiTblId COBOL Name:
   * HV01-SPI-TBL-ID - d51uRetPosTierCd COBOL Name: D51U-RET-POS-TIER-CD - hv14PosTierTypCd COBOL
   * Name: HV14-POS-TIER-TYP-CD - d51uRetPriDiagInd COBOL Name: D51U-RET-PRI-DIAG-IND -
   * hv0aPriDiagInd COBOL Name: HV0A-PRI-DIAG-IND - d51uRetDiagElgInd COBOL Name:
   * D51U-RET-DIAG-ELG-IND - hv15MjrDiagEligInd COBOL Name: HV15-MJR-DIAG-ELIG-IND - d51uRetStatus
   * COBOL Name: D51U-RET-STATUS - d51uRetPolicy COBOL Name: D51U-RET-POLICY - plnvPolNbr COBOL
   * Name: PLNV-POL-NBR - d51uRetPlan COBOL Name: D51U-RET-PLAN - plnvPlnNbr COBOL Name:
   * PLNV-PLN-NBR - d51uNbrOfEntries COBOL Name: D51U-NBR-OF-ENTRIES - fetchEnd COBOL Name:
   * WS-FETCH-END - d51uPlnvCnt COBOL Name: D51U-PLNV-CNT - sqlcode_Ws COBOL Name: WS-SQLCODE -
  ...
  public FetchCsplnvOutCtx fetchCsplnv(FetchCsplnvInCtx methodIn) throws Exception {
    ...
    d529351uRepository.fetchCsplnvD529351u(
        programCtx.getCsplnvResultSet(),
        methodOut.getHvHostVariablesCsplnv(),
        programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        ...
        for (int index1 = 0; index1 < methodIn.getSqlerrd(2); index1++) {
          ...
          if ((methodOut.getCsSub() <= 9999)) {
            ...
            methodOut.setD51uRetFeSpi(
                methodOut.getCsSub() - 1, methodOut.getHv01SpiTblId(methodOut.getHv01Index() - 1));
            //  cobolCode::MOVE HV14-POS-TIER-TYP-CD ( HV14-INDEX ) TO D51U-RET-POS-TIER-CD ( CS-SUB
            // )
            methodOut.setD51uRetPosTierCd(
                methodOut.getCsSub() - 1,
                methodOut.getHv14PosTierTypCd(methodOut.getHv14Index() - 1));
            //  cobolCode::MOVE HV0A-PRI-DIAG-IND ( HV0A-INDEX ) TO D51U-RET-PRI-DIAG-IND ( CS-SUB )
            methodOut.setD51uRetPriDiagInd(
                methodOut.getCsSub() - 1,
                methodOut.getHv0aPriDiagInd(methodOut.getHv0aIndex() - 1));
            //  cobolCode::MOVE HV15-MJR-DIAG-ELIG-IND ( HV15-INDEX ) TO D51U-RET-DIAG-ELG-IND (
            // CS-SUB )
            methodOut.setD51uRetDiagElgInd(
                methodOut.getCsSub() - 1,
                methodOut.getHv15MjrDiagEligInd(methodOut.getHv15Index() - 1));
            ...
            methodOut.setD51uRetPlan(
                methodOut.getCsSub() - 1, padLeftZeros(4, methodOut.getPlnvPlnNbr(), false));
          }
  ...
  /**
   * closeCsr This method is derived from COBOL Paragraph - 2185-CLOSE-CSR SECTION COBOL Cyclomatic
   * complexity - 4 Input :
   *
   ...
   * <p>Output :
   *
   * <p>- closeCsrInd COBOL Name: CLOSE-CSR-IND - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL
   * Name: SQLCODE - d51uReturnCode COBOL Name: D51U-RETURN-CODE - d51uInvReason COBOL Name:
   * D51U-INV-REASON - d51uSqlOrRespCd COBOL Name: D51U-SQL-OR-RESP-CD - d51uDebugTracer COBOL Name:
   * D51U-DEBUG-TRACER - d51uParagraphNum COBOL Name: D51U-PARAGRAPH-NUM
   *
   * @throws CFException
   */
  @Override
  ...
  /**
   * processFuncCd2 This method is derived from COBOL Paragraph - 2200-PROCESS-FUNC-CD-2 SECTION
  ...
  public void processFuncCd2(D529351uCtx programCtx) throws Exception {
    ...
    processFuncCd2Split0(
        programCtx.getProcessFuncCd2Split0InCtx()); /*2200-PROCESS-FUNC-CD-2-SPLIT0*/
    //  cobolCode::PERFORM 2200-PROCESS-FUNC-CD-2-SPLIT1
    processFuncCd2Split1(
        programCtx.getProcessFuncCd2Split1InCtx()); /*2200-PROCESS-FUNC-CD-2-SPLIT1*/
  }
  /**
   * processFuncCd2Split0 This method is derived from COBOL Paragraph -
   * 2200-PROCESS-FUNC-CD-2-SPLIT0 COBOL Cyclomatic complexity - 1 Input :
   *
   * <p>- d51uTestCaus COBOL Name: D51U-TEST-CAUS - d51uTestProvTyp COBOL Name: D51U-TEST-PROV-TYP -
   * d51uTestPos COBOL Name: D51U-TEST-POS - d51uTestSvcCd COBOL Name: D51U-TEST-SVC-CD -
   * d51uTestDiag01 COBOL Name: D51U-TEST-DIAG-01 - d51uTestDiag02 COBOL Name: D51U-TEST-DIAG-02 -
   * d51uTestDiag03 COBOL Name: D51U-TEST-DIAG-03 - d51uTestDiag04 COBOL Name: D51U-TEST-DIAG-04 -
   * d51uTestDiag05 COBOL Name: D51U-TEST-DIAG-05 - d51uTestDiag06 COBOL Name: D51U-TEST-DIAG-06 -
   * d51uTestDiag07 COBOL Name: D51U-TEST-DIAG-07 - d51uTestDiag08 COBOL Name: D51U-TEST-DIAG-08 -
   * d51uTestDiag09 COBOL Name: D51U-TEST-DIAG-09 - d51uTestDiag10 COBOL Name: D51U-TEST-DIAG-10 -
   * d51uTestDiag11 COBOL Name: D51U-TEST-DIAG-11 - d51uTestDiag12 COBOL Name: D51U-TEST-DIAG-12 -
   * d51uTestDiag13 COBOL Name: D51U-TEST-DIAG-13 - d51uTestDiag14 COBOL Name: D51U-TEST-DIAG-14 -
   * d51uTestDiag15 COBOL Name: D51U-TEST-DIAG-15 - d51uTestDiag16 COBOL Name: D51U-TEST-DIAG-16 -
   * d51uTestDiag17 COBOL Name: D51U-TEST-DIAG-17 - d51uTestDiag18 COBOL Name: D51U-TEST-DIAG-18 -
   * d51uTestDiag19 COBOL Name: D51U-TEST-DIAG-19 - d51uTestDiag20 COBOL Name: D51U-TEST-DIAG-20 -
   * d51uTestDiag21 COBOL Name: D51U-TEST-DIAG-21 - d51uTestDiag22 COBOL Name: D51U-TEST-DIAG-22 -
   * d51uTestDiag23 COBOL Name: D51U-TEST-DIAG-23 - d51uTestDiag24 COBOL Name: D51U-TEST-DIAG-24 -
   * d51uTestDiag25 COBOL Name: D51U-TEST-DIAG-25 - d51uTestCpeDescCd COBOL Name:
   * D51U-TEST-CPE-DESC-CD
   *
   * <p>Output :
   *
   * <p>- fetchEndMain COBOL Name: WS-FETCH-END-MAIN - closeCsrInd COBOL Name: CLOSE-CSR-IND -
   * testCaus COBOL Name: TEST-CAUS - d51uTestCaus COBOL Name: D51U-TEST-CAUS - testProvTyp COBOL
   * Name: TEST-PROV-TYP - d51uTestProvTyp COBOL Name: D51U-TEST-PROV-TYP - testPos COBOL Name:
   * TEST-POS - d51uTestPos COBOL Name: D51U-TEST-POS - testSvcCd COBOL Name: TEST-SVC-CD -
   * d51uTestSvcCd COBOL Name: D51U-TEST-SVC-CD - testDiag01 COBOL Name: TEST-DIAG-01 -
   * d51uTestDiag01 COBOL Name: D51U-TEST-DIAG-01 - testDiag02 COBOL Name: TEST-DIAG-02 -
   * d51uTestDiag02 COBOL Name: D51U-TEST-DIAG-02 - testDiag03 COBOL Name: TEST-DIAG-03 -
   * d51uTestDiag03 COBOL Name: D51U-TEST-DIAG-03 - testDiag04 COBOL Name: TEST-DIAG-04 -
   * d51uTestDiag04 COBOL Name: D51U-TEST-DIAG-04 - testDiag05 COBOL Name: TEST-DIAG-05 -
   * d51uTestDiag05 COBOL Name: D51U-TEST-DIAG-05 - testDiag06 COBOL Name: TEST-DIAG-06 -
   * d51uTestDiag06 COBOL Name: D51U-TEST-DIAG-06 - testDiag07 COBOL Name: TEST-DIAG-07 -
   * d51uTestDiag07 COBOL Name: D51U-TEST-DIAG-07 - testDiag08 COBOL Name: TEST-DIAG-08 -
   * d51uTestDiag08 COBOL Name: D51U-TEST-DIAG-08 - testDiag09 COBOL Name: TEST-DIAG-09 -
   * d51uTestDiag09 COBOL Name: D51U-TEST-DIAG-09 - testDiag10 COBOL Name: TEST-DIAG-10 -
   * d51uTestDiag10 COBOL Name: D51U-TEST-DIAG-10 - testDiag11 COBOL Name: TEST-DIAG-11 -
   * d51uTestDiag11 COBOL Name: D51U-TEST-DIAG-11 - testDiag12 COBOL Name: TEST-DIAG-12 -
   * d51uTestDiag12 COBOL Name: D51U-TEST-DIAG-12 - testDiag13 COBOL Name: TEST-DIAG-13 -
   * d51uTestDiag13 COBOL Name: D51U-TEST-DIAG-13 - testDiag14 COBOL Name: TEST-DIAG-14 -
   * d51uTestDiag14 COBOL Name: D51U-TEST-DIAG-14 - testDiag15 COBOL Name: TEST-DIAG-15 -
   * d51uTestDiag15 COBOL Name: D51U-TEST-DIAG-15 - testDiag16 COBOL Name: TEST-DIAG-16 -
   * d51uTestDiag16 COBOL Name: D51U-TEST-DIAG-16 - testDiag17 COBOL Name: TEST-DIAG-17 -
   * d51uTestDiag17 COBOL Name: D51U-TEST-DIAG-17 - testDiag18 COBOL Name: TEST-DIAG-18 -
   * d51uTestDiag18 COBOL Name: D51U-TEST-DIAG-18 - testDiag19 COBOL Name: TEST-DIAG-19 -
   * d51uTestDiag19 COBOL Name: D51U-TEST-DIAG-19 - testDiag20 COBOL Name: TEST-DIAG-20 -
   * d51uTestDiag20 COBOL Name: D51U-TEST-DIAG-20 - testDiag21 COBOL Name: TEST-DIAG-21 -
   * d51uTestDiag21 COBOL Name: D51U-TEST-DIAG-21 - testDiag22 COBOL Name: TEST-DIAG-22 -
   * d51uTestDiag22 COBOL Name: D51U-TEST-DIAG-22 - testDiag23 COBOL Name: TEST-DIAG-23 -
   * d51uTestDiag23 COBOL Name: D51U-TEST-DIAG-23 - testDiag24 COBOL Name: TEST-DIAG-24 -
   * d51uTestDiag24 COBOL Name: D51U-TEST-DIAG-24 - testDiag25 COBOL Name: TEST-DIAG-25 -
   * d51uTestDiag25 COBOL Name: D51U-TEST-DIAG-25 - testCpeDescCd COBOL Name: TEST-CPE-DESC-CD -
   * d51uTestCpeDescCd COBOL Name: D51U-TEST-CPE-DESC-CD - causSub COBOL Name: CAUS-SUB -
   * d51uCausCnt COBOL Name: D51U-CAUS-CNT - causFoundSw COBOL Name: CAUS-FOUND-SW - ipaSub COBOL
   * Name: IPA-SUB - d51uIpaCnt COBOL Name: D51U-IPA-CNT - ipaFoundSw COBOL Name: IPA-FOUND-SW -
   * ptypSub COBOL Name: PTYP-SUB - d51uPtypCnt COBOL Name: D51U-PTYP-CNT - provFoundSw COBOL Name:
   * PROV-FOUND-SW - fcndSub COBOL Name: FCND-SUB - d51uFcndCnt COBOL Name: D51U-FCND-CNT -
   * posFoundSw COBOL Name: POS-FOUND-SW - cflgSub COBOL Name: CFLG-SUB - d51uCflgCnt COBOL Name:
   * D51U-CFLG-CNT - cflgFoundSw COBOL Name: CFLG-FOUND-SW - fetchEndComb COBOL Name:
   * WS-FETCH-END-COMB
   *
   * @throws CFException
   */
  ...
  /**
   * processFuncCd2Split1 This method is derived from COBOL Paragraph -
   * 2200-PROCESS-FUNC-CD-2-SPLIT1 COBOL Cyclomatic complexity - 1 Input :
   *
   * <p>- d51uLstClmIcdInd COBOL Name: D51U-LST-CLM-ICD-IND
   *
   * <p>Output :
   *
   * <p>- frtoSub COBOL Name: FRTO-SUB - d51uFrtoCnt COBOL Name: D51U-FRTO-CNT - svcFoundSw COBOL
   * Name: SVC-FOUND-SW - fetchEndFrto COBOL Name: WS-FETCH-END-FRTO - closeCsrInd COBOL Name:
   * CLOSE-CSR-IND - icdSub COBOL Name: ICD-SUB - d51uIcdCnt COBOL Name: D51U-ICD-CNT - icdFoundSw
   * COBOL Name: ICD-FOUND-SW - lstClmIcdInd COBOL Name: WS-LST-CLM-ICD-IND - d51uLstClmIcdInd COBOL
   * Name: D51U-LST-CLM-ICD-IND - fetchEndIcd COBOL Name: WS-FETCH-END-ICD
   *
   * @throws CFException
   */
  @Override
  public ProcessFuncCd2Split1OutCtx processFuncCd2Split1(ProcessFuncCd2Split1InCtx methodIn)
    ...
    openCsicdCursor3200(
        programCtx.getOpenCsicdCursor3200InCtx()); /*3200-OPEN-CSICD-CURSOR SECTION*/
    ;

    return methodOut;
  }
  /**
   * openCsfrtoCursor This method is derived from COBOL Paragraph - 2250-OPEN-CSFRTO-CURSOR SECTION
   * COBOL Cyclomatic complexity - 5 Input :
   *
   * <p>- fetchEndFrto COBOL Name: WS-FETCH-END-FRTO - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsmReturnCode COBOL Name: DSM-RETURN-CODE - d51uReturnCode COBOL Name: D51U-RETURN-CODE -
   * sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE - d51uInvReason COBOL Name:
   * D51U-INV-REASON - d51uSqlOrRespCd COBOL Name: D51U-SQL-OR-RESP-CD - d51uDebugTracer COBOL Name:
   * D51U-DEBUG-TRACER - d51uParagraphNum COBOL Name: D51U-PARAGRAPH-NUM
   *
   * @throws CFException
  ...
  public OpenCsfrtoCursorOutCtx openCsfrtoCursor(OpenCsfrtoCursorInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , CLM_FRM_SVC_CD ,
    // CLM_TO_SVC_CD , SVC_TYP_CD FROM FE_SPI_RULE_FR_TO_SVC WHERE SPI_TBL_ID = ? AND STS_CD = 'A'
    // FOR FETCH ONLY
    programCtx.setCsfrtoResultSet(
        d529351uRepository.openCsfrtoD529351u(
            methodIn.getDclfeSpiRuleFrToSvc(), programCtx.getSqlca()));
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
  ...
  /**
   * fetchCsfrto This method is derived from COBOL Paragraph - 2280-FETCH-CSFRTO SECTION COBOL
   * Cyclomatic complexity - 11 Input :
   *
   * <p>- sqlerrd COBOL Name: SQLERRD - frtoSub COBOL Name: FRTO-SUB - hv08SvcDrvPos COBOL Name:
   * HV08-SVC-DRV-POS - hv09SvcDrvSvc COBOL Name: HV09-SVC-DRV-SVC - hv10SvcDrvCau COBOL Name:
   * HV10-SVC-DRV-CAU - hv11ClmFrmSvcCd COBOL Name: HV11-CLM-FRM-SVC-CD - hv12ClmToSvcCd COBOL Name:
   * HV12-CLM-TO-SVC-CD - hv13SvcTypCd COBOL Name: HV13-SVC-TYP-CD - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsnnrows COBOL Name: DSNNROWS - hv08Index COBOL Name: HV08-INDEX - hv09Index COBOL Name:
   * HV09-INDEX - hv10Index COBOL Name: HV10-INDEX - hv11Index COBOL Name: HV11-INDEX - hv12Index
   * COBOL Name: HV12-INDEX - hv13Index COBOL Name: HV13-INDEX - frtoSub COBOL Name: FRTO-SUB -
   * d51uFrtoDrvPos COBOL Name: D51U-FRTO-DRV-POS - hv08SvcDrvPos COBOL Name: HV08-SVC-DRV-POS -
   * d51uFrtoDrvSvc COBOL Name: D51U-FRTO-DRV-SVC - hv09SvcDrvSvc COBOL Name: HV09-SVC-DRV-SVC -
   * d51uFrtoDrvCau COBOL Name: D51U-FRTO-DRV-CAU - hv10SvcDrvCau COBOL Name: HV10-SVC-DRV-CAU -
   * d51uFrtoClmFrmSvcCd COBOL Name: D51U-FRTO-CLM-FRM-SVC-CD - hv11ClmFrmSvcCd COBOL Name:
   * HV11-CLM-FRM-SVC-CD - d51uFrtoClmToSvcCd COBOL Name: D51U-FRTO-CLM-TO-SVC-CD - hv12ClmToSvcCd
   * COBOL Name: HV12-CLM-TO-SVC-CD - d51uFrtoSvcTypCd COBOL Name: D51U-FRTO-SVC-TYP-CD -
   * hv13SvcTypCd COBOL Name: HV13-SVC-TYP-CD - svcFoundSw COBOL Name: SVC-FOUND-SW - fetchEndFrto
   * COBOL Name: WS-FETCH-END-FRTO - d51uFrtoCnt COBOL Name: D51U-FRTO-CNT - sqlcode_Ws COBOL Name:
   * WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  @Override
  public FetchCsfrtoOutCtx fetchCsfrto(FetchCsfrtoInCtx methodIn) throws Exception {
    ...
    d529351uRepository.fetchCsfrtoD529351u(
        programCtx.getCsfrtoResultSet(),
        methodOut.getHvHostVariablesCsfrto(),
        programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        ...
        for (int index1 = 0; index1 < methodIn.getSqlerrd(2); index1++) {
          ...
          if ((methodOut.getFrtoSub() < 9999)) {
            ...
            methodOut.setD51uFrtoDrvPos(
                methodOut.getFrtoSub() - 1,
                methodOut.getHv08SvcDrvPos(methodOut.getHv08Index() - 1));

            // *              Move frto-deriv-svc-cd
            //  cobolCode::MOVE HV09-SVC-DRV-SVC ( HV09-INDEX ) TO D51U-FRTO-DRV-SVC ( FRTO-SUB )
            methodOut.setD51uFrtoDrvSvc(
                methodOut.getFrtoSub() - 1,
                methodOut.getHv09SvcDrvSvc(methodOut.getHv09Index() - 1));

            // *              Move frto-deriv-caus-cd
            //  cobolCode::MOVE HV10-SVC-DRV-CAU ( HV10-INDEX ) TO D51U-FRTO-DRV-CAU ( FRTO-SUB )
            methodOut.setD51uFrtoDrvCau(
                methodOut.getFrtoSub() - 1,
                methodOut.getHv10SvcDrvCau(methodOut.getHv10Index() - 1));
            //  cobolCode::MOVE HV11-CLM-FRM-SVC-CD ( HV11-INDEX ) TO D51U-FRTO-CLM-FRM-SVC-CD (
            // FRTO-SUB )
            methodOut.setD51uFrtoClmFrmSvcCd(
                methodOut.getFrtoSub() - 1,
                methodOut.getHv11ClmFrmSvcCd(methodOut.getHv11Index() - 1));
            //  cobolCode::MOVE HV12-CLM-TO-SVC-CD ( HV12-INDEX ) TO D51U-FRTO-CLM-TO-SVC-CD (
            // FRTO-SUB )
            methodOut.setD51uFrtoClmToSvcCd(
                methodOut.getFrtoSub() - 1,
                methodOut.getHv12ClmToSvcCd(methodOut.getHv12Index() - 1));
            //  cobolCode::MOVE HV13-SVC-TYP-CD ( HV13-INDEX ) TO D51U-FRTO-SVC-TYP-CD ( FRTO-SUB )
            methodOut.setD51uFrtoSvcTypCd(
                methodOut.getFrtoSub() - 1,
                methodOut.getHv13SvcTypCd(methodOut.getHv13Index() - 1));
          }
  ...
  /**
   * closeCsr2285 This method is derived from COBOL Paragraph - 2285-CLOSE-CSR SECTION COBOL
  ...
  /**
   * openCsptypCursor This method is derived from COBOL Paragraph - 2350-OPEN-CSPTYP-CURSOR SECTION
   * COBOL Cyclomatic complexity - 6 Input :
   *
   * <p>- fetchEndPtyp COBOL Name: WS-FETCH-END-PTYP - ptypSub COBOL Name: PTYP-SUB - sqlcode COBOL
   * Name: SQLCODE
   *
   * <p>Output :
   *
  ...
  public OpenCsptypCursorOutCtx openCsptypCursor(OpenCsptypCursorInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT PROV_TYP FROM FE_SPI_RULE_PROV_TYP WHERE SPI_TBL_ID = ? AND STS_CD = 'A'
    // AND DERIV_PL_OF_SVC_CD = ? AND DERIV_SVC_CD = ? AND DERIV_CAUS_CD = ? FOR FETCH ONLY
    programCtx.setCsptypResultSet(
        d529351uRepository.openCsptypD529351u(
            methodIn.getDclfeSpiRuleProvTyp(), programCtx.getSqlca()));
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        //  cobolCode::PERFORM 2380-FETCH-CSPTYP THRU 2380-EXIT UNTIL END-OF-FETCH-PTYP OR PTYP-SUB
        // > +99
  ...
  /**
   * fetchCsptyp This method is derived from COBOL Paragraph - 2380-FETCH-CSPTYP SECTION COBOL
   * Cyclomatic complexity - 7 Input :
   *
   * <p>- ptypSub COBOL Name: PTYP-SUB - ptypDerivPlOfSvcCd COBOL Name: PTYP-DERIV-PL-OF-SVC-CD -
   * ptypDerivSvcCd COBOL Name: PTYP-DERIV-SVC-CD - ptypDerivCausCd COBOL Name: PTYP-DERIV-CAUS-CD -
   * ptypProvTyp COBOL Name: PTYP-PROV-TYP - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- ptypSub COBOL Name: PTYP-SUB - d51uPtypDrvPos COBOL Name: D51U-PTYP-DRV-POS -
   * ptypDerivPlOfSvcCd COBOL Name: PTYP-DERIV-PL-OF-SVC-CD - d51uPtypDrvSvc COBOL Name:
   * D51U-PTYP-DRV-SVC - ptypDerivSvcCd COBOL Name: PTYP-DERIV-SVC-CD - d51uPtypDrvCau COBOL Name:
   * D51U-PTYP-DRV-CAU - ptypDerivCausCd COBOL Name: PTYP-DERIV-CAUS-CD - d51uPtypProvTyp COBOL
   * Name: D51U-PTYP-PROV-TYP - ptypProvTyp COBOL Name: PTYP-PROV-TYP - provFoundSw COBOL Name:
   * PROV-FOUND-SW - fetchEndPtyp COBOL Name: WS-FETCH-END-PTYP - d51uPtypCnt COBOL Name:
   * D51U-PTYP-CNT - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  @Override
  public FetchCsptypOutCtx fetchCsptyp(FetchCsptypInCtx methodIn) throws Exception {
    ...
    d529351uRepository.fetchCsptypD529351u(
        programCtx.getCsptypResultSet(), methodOut.getDclfeSpiRuleProvTyp(), programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
  ...
  /**
   * closeCsr2385 This method is derived from COBOL Paragraph - 2385-CLOSE-CSR SECTION COBOL
   * Cyclomatic complexity - 4 Input :
   *
   * <p>- sqlcode COBOL Name: SQLCODE
   *
  ...
  /**
   * openCsicdCursor This method is derived from COBOL Paragraph - 2450-OPEN-CSICD-CURSOR SECTION
  ...
  public OpenCsicdCursorOutCtx openCsicdCursor(OpenCsicdCursorInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , CLM_ICD_IND ,
    // CLM_ICD_FROM_CD , CLM_ICD_TO_CD FROM FE_SPI_RULE_ICD WHERE SPI_TBL_ID = ? AND STS_CD = 'A'
    // AND DERIV_PL_OF_SVC_CD = ? AND DERIV_SVC_CD = ? AND DERIV_CAUS_CD = ? AND CLM_ICD_IND = ? AND
    // ( ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD
    // >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND
    // CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD
    // <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR (
    // CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >=
    // ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND
    // CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD
    // <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR (
    ...
    // CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >=
    // ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND
    // CLM_ICD_TO_CD >= ? ) OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? ) ORDER BY CLM_ICD_FROM_CD , CLM_ICD_TO_CD FOR
    // FETCH ONLY
    programCtx.setCsicdResultSet(
        d529351uRepository.openCsicdD529351u(
            methodIn.getDclfeSpiRuleIcd(),
            methodIn.getTestVariables(),
            methodIn.getLstIcdKey(),
            programCtx.getSqlca()));
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
  ...
  /**
   * fetchCsicd This method is derived from COBOL Paragraph - 2480-FETCH-CSICD SECTION COBOL
   * Cyclomatic complexity - 11 Input :
   *
   * <p>- sqlerrd COBOL Name: SQLERRD - icdSub COBOL Name: ICD-SUB - hv3aIcdDrvPos COBOL Name:
   * HV3A-ICD-DRV-POS - hv3bIcdDrvSvc COBOL Name: HV3B-ICD-DRV-SVC - hv3cIcdDrvCau COBOL Name:
   * HV3C-ICD-DRV-CAU - hv3dIcdTypCd COBOL Name: HV3D-ICD-TYP-CD - hv3eClmFrmIcdCd COBOL Name:
   * HV3E-CLM-FRM-ICD-CD - hv3fClmToIcdCd COBOL Name: HV3F-CLM-TO-ICD-CD - sqlcode COBOL Name:
   * SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsnnrows COBOL Name: DSNNROWS - hv3aIndex COBOL Name: HV3A-INDEX - hv3bIndex COBOL Name:
   * HV3B-INDEX - hv3cIndex COBOL Name: HV3C-INDEX - hv3dIndex COBOL Name: HV3D-INDEX - hv3eIndex
   * COBOL Name: HV3E-INDEX - hv3fIndex COBOL Name: HV3F-INDEX - icdSub COBOL Name: ICD-SUB -
   * d51uRicdDrvPos COBOL Name: D51U-RICD-DRV-POS - hv3aIcdDrvPos COBOL Name: HV3A-ICD-DRV-POS -
   * d51uRicdDrvSvc COBOL Name: D51U-RICD-DRV-SVC - hv3bIcdDrvSvc COBOL Name: HV3B-ICD-DRV-SVC -
   * d51uRicdDrvCau COBOL Name: D51U-RICD-DRV-CAU - hv3cIcdDrvCau COBOL Name: HV3C-ICD-DRV-CAU -
   * d51uRicdClmIcdInd COBOL Name: D51U-RICD-CLM-ICD-IND - hv3dIcdTypCd COBOL Name: HV3D-ICD-TYP-CD
   * - d51uRicdClmIcdFromCd COBOL Name: D51U-RICD-CLM-ICD-FROM-CD - hv3eClmFrmIcdCd COBOL Name:
   * HV3E-CLM-FRM-ICD-CD - d51uRicdClmIcdToCd COBOL Name: D51U-RICD-CLM-ICD-TO-CD - hv3fClmToIcdCd
   * COBOL Name: HV3F-CLM-TO-ICD-CD - moreIcdFoundSw COBOL Name: MORE-ICD-FOUND-SW - d51uMoreIcdCnt
   * COBOL Name: D51U-MORE-ICD-CNT - fetchEndIcd COBOL Name: WS-FETCH-END-ICD - icdFoundSw COBOL
   * Name: ICD-FOUND-SW - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  @Override
  public FetchCsicdOutCtx fetchCsicd(FetchCsicdInCtx methodIn) throws Exception {
    ...
    d529351uRepository.fetchCsicdD529351u(
        programCtx.getCsicdResultSet(),
        methodOut.getHvHostVariablesCsicdo(),
        programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        ...
        for (int index1 = 0; index1 < methodIn.getSqlerrd(2); index1++) {
          ...
          if ((methodOut.getIcdSub() < 9999)) {
            ...
            methodOut.setD51uRicdDrvPos(
                methodOut.getIcdSub() - 1,
                methodOut.getHv3aIcdDrvPos(methodOut.getHv3aIndex() - 1));

            // **         Move ricd-deriv-svc-cd        to
            //  cobolCode::MOVE HV3B-ICD-DRV-SVC ( HV3B-INDEX ) TO D51U-RICD-DRV-SVC ( ICD-SUB )
            methodOut.setD51uRicdDrvSvc(
                methodOut.getIcdSub() - 1,
                methodOut.getHv3bIcdDrvSvc(methodOut.getHv3bIndex() - 1));

            // **         Move ricd-deriv-caus-cd       to
            //  cobolCode::MOVE HV3C-ICD-DRV-CAU ( HV3C-INDEX ) TO D51U-RICD-DRV-CAU ( ICD-SUB )
            methodOut.setD51uRicdDrvCau(
                methodOut.getIcdSub() - 1,
                methodOut.getHv3cIcdDrvCau(methodOut.getHv3cIndex() - 1));

            // **         Move ricd-clm-icd-ind         to
            //  cobolCode::MOVE HV3D-ICD-TYP-CD ( HV3D-INDEX ) TO D51U-RICD-CLM-ICD-IND ( ICD-SUB )
            methodOut.setD51uRicdClmIcdInd(
                methodOut.getIcdSub() - 1, methodOut.getHv3dIcdTypCd(methodOut.getHv3dIndex() - 1));

            // **         Move ricd-clm-icd-from-cd  to
            //  cobolCode::MOVE HV3E-CLM-FRM-ICD-CD ( HV3E-INDEX ) TO D51U-RICD-CLM-ICD-FROM-CD (
            // ICD-SUB )
            methodOut.setD51uRicdClmIcdFromCd(
                methodOut.getIcdSub() - 1,
                methodOut.getHv3eClmFrmIcdCd(methodOut.getHv3eIndex() - 1));

            // **         Move ricd-clm-icd-to-cd  to
            //  cobolCode::MOVE HV3F-CLM-TO-ICD-CD ( HV3F-INDEX ) TO D51U-RICD-CLM-ICD-TO-CD (
            // ICD-SUB )
            methodOut.setD51uRicdClmIcdToCd(
                methodOut.getIcdSub() - 1,
                methodOut.getHv3fClmToIcdCd(methodOut.getHv3fIndex() - 1));
          }
  ...
  /**
   * closeCsr2485 This method is derived from COBOL Paragraph - 2485-CLOSE-CSR SECTION COBOL
   * Cyclomatic complexity - 4 Input :
   *
   * <p>- sqlcode COBOL Name: SQLCODE
   *
  ...
  /**
   * openCsfcndCursor This method is derived from COBOL Paragraph - 2550-OPEN-CSFCND-CURSOR SECTION
   * COBOL Cyclomatic complexity - 6 Input :
   *
   * <p>- fetchEndFcnd COBOL Name: WS-FETCH-END-FCND - fcndSub COBOL Name: FCND-SUB - sqlcode COBOL
   * Name: SQLCODE
   *
   * <p>Output :
   *
  ...
  public OpenCsfcndCursorOutCtx openCsfcndCursor(OpenCsfcndCursorInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT FROM_COND_POS FROM FE_SPI_RULE_FR_COND_POS WHERE SPI_TBL_ID = ? AND STS_CD
    // = 'A' AND DERIV_PL_OF_SVC_CD = ? AND DERIV_SVC_CD = ? AND DERIV_CAUS_CD = ? FOR FETCH ONLY
    programCtx.setCsfcndResultSet(
        d529351uRepository.openCsfcndD529351u(
            programCtx.getSqlca(), methodIn.getDclfeSpiRuleFrCondPos()));
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        //  cobolCode::PERFORM 2580-FETCH-CSFCND THRU 2580-EXIT UNTIL END-OF-FETCH-FCND OR FCND-SUB
        // > +99
  ...
  /**
   * fetchCsfcnd This method is derived from COBOL Paragraph - 2580-FETCH-CSFCND SECTION COBOL
   * Cyclomatic complexity - 6 Input :
   *
   * <p>- fcndSub COBOL Name: FCND-SUB - fcndDerivPlOfSvcCd COBOL Name: FCND-DERIV-PL-OF-SVC-CD -
   * fcndDerivSvcCd COBOL Name: FCND-DERIV-SVC-CD - fcndDerivCausCd COBOL Name: FCND-DERIV-CAUS-CD -
   * fcndFromCondPos COBOL Name: FCND-FROM-COND-POS - csSub COBOL Name: CS-SUB - sqlcode COBOL Name:
   * SQLCODE
   *
   * <p>Output :
   *
   * <p>- fcndSub COBOL Name: FCND-SUB - d51uFcndDrvPos COBOL Name: D51U-FCND-DRV-POS -
   * fcndDerivPlOfSvcCd COBOL Name: FCND-DERIV-PL-OF-SVC-CD - d51uFcndDrvSvc COBOL Name:
   * D51U-FCND-DRV-SVC - fcndDerivSvcCd COBOL Name: FCND-DERIV-SVC-CD - d51uFcndDrvCau COBOL Name:
   * D51U-FCND-DRV-CAU - fcndDerivCausCd COBOL Name: FCND-DERIV-CAUS-CD - d51uFcndFromCondPos COBOL
   * Name: D51U-FCND-FROM-COND-POS - fcndFromCondPos COBOL Name: FCND-FROM-COND-POS - posFoundSw
   * COBOL Name: POS-FOUND-SW - fetchEndFcnd COBOL Name: WS-FETCH-END-FCND - d51uFcndCnt COBOL Name:
   * D51U-FCND-CNT - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  @Override
  public FetchCsfcndOutCtx fetchCsfcnd(FetchCsfcndInCtx methodIn) throws Exception {
    ...
    d529351uRepository.fetchCsfcndD529351u(
        programCtx.getCsfcndResultSet(),
        programCtx.getSqlca(),
        methodOut.getDclfeSpiRuleFrCondPos());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        ...
        methodOut.setD51uFcndFromCondPos(
            methodOut.getFcndSub() - 1,
            pad(3, methodOut.getFcndFromCondPos(), SPACE_CHAR, RIGHT_PAD));
  ...
  /**
   * closeCsr2585 This method is derived from COBOL Paragraph - 2585-CLOSE-CSR SECTION COBOL
   * Cyclomatic complexity - 4 Input :
   *
   * <p>- sqlcode COBOL Name: SQLCODE
   *
  ...
  /**
   * selectCauseTable This method is derived from COBOL Paragraph - 2650-SELECT-CAUSE-TABLE SECTION
   * COBOL Cyclomatic complexity - 5 Input :
   *
   * <p>- causSub COBOL Name: CAUS-SUB - causDerivPlOfSvcCd COBOL Name: CAUS-DERIV-PL-OF-SVC-CD -
   * causDerivSvcCd COBOL Name: CAUS-DERIV-SVC-CD - causDerivCausCd COBOL Name: CAUS-DERIV-CAUS-CD -
   * causClmCaus1Cd COBOL Name: CAUS-CLM-CAUS-1-CD - causClmCaus2Cd COBOL Name: CAUS-CLM-CAUS-2-CD -
   * causClmCaus3Cd COBOL Name: CAUS-CLM-CAUS-3-CD - causClmCaus4Cd COBOL Name: CAUS-CLM-CAUS-4-CD -
   * causClmCaus5Cd COBOL Name: CAUS-CLM-CAUS-5-CD - causClmCaus6Cd COBOL Name: CAUS-CLM-CAUS-6-CD -
   * causClmCaus7Cd COBOL Name: CAUS-CLM-CAUS-7-CD - causClmCaus8Cd COBOL Name: CAUS-CLM-CAUS-8-CD -
   * sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- causSub COBOL Name: CAUS-SUB - d51uCausCnt COBOL Name: D51U-CAUS-CNT - d51uCausDrvPos
   * COBOL Name: D51U-CAUS-DRV-POS - causDerivPlOfSvcCd COBOL Name: CAUS-DERIV-PL-OF-SVC-CD -
   * d51uCausDrvSvc COBOL Name: D51U-CAUS-DRV-SVC - causDerivSvcCd COBOL Name: CAUS-DERIV-SVC-CD -
   * d51uCausDrvCau COBOL Name: D51U-CAUS-DRV-CAU - causDerivCausCd COBOL Name: CAUS-DERIV-CAUS-CD -
   * d51uCausClmCauseCd1 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-1 - causClmCaus1Cd COBOL Name:
   * CAUS-CLM-CAUS-1-CD - d51uCausClmCauseCd2 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-2 - causClmCaus2Cd
   * COBOL Name: CAUS-CLM-CAUS-2-CD - d51uCausClmCauseCd3 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-3 -
   * causClmCaus3Cd COBOL Name: CAUS-CLM-CAUS-3-CD - d51uCausClmCauseCd4 COBOL Name:
   * D51U-CAUS-CLM-CAUSE-CD-4 - causClmCaus4Cd COBOL Name: CAUS-CLM-CAUS-4-CD - d51uCausClmCauseCd5
   * COBOL Name: D51U-CAUS-CLM-CAUSE-CD-5 - causClmCaus5Cd COBOL Name: CAUS-CLM-CAUS-5-CD -
   * d51uCausClmCauseCd6 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-6 - causClmCaus6Cd COBOL Name:
   * CAUS-CLM-CAUS-6-CD - d51uCausClmCauseCd7 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-7 - causClmCaus7Cd
   * COBOL Name: CAUS-CLM-CAUS-7-CD - d51uCausClmCauseCd8 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-8 -
   * causClmCaus8Cd COBOL Name: CAUS-CLM-CAUS-8-CD - causFoundSw COBOL Name: CAUS-FOUND-SW -
   * sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE - d51uReturnCode COBOL Name:
   * D51U-RETURN-CODE - d51uInvReason COBOL Name: D51U-INV-REASON - d51uSqlOrRespCd COBOL Name:
   * D51U-SQL-OR-RESP-CD - d51uDebugTracer COBOL Name: D51U-DEBUG-TRACER - d51uParagraphNum COBOL
   * Name: D51U-PARAGRAPH-NUM
   *
   * @throws CFException
   */
  @Override
  public SelectCauseTableOutCtx selectCauseTable(SelectCauseTableInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT CLM_CAUS_1_CD , CLM_CAUS_2_CD , CLM_CAUS_3_CD , CLM_CAUS_4_CD ,
    // CLM_CAUS_5_CD , CLM_CAUS_6_CD , CLM_CAUS_7_CD , CLM_CAUS_8_CD FROM FE_SPI_RULE_CAUS WHERE
    // SPI_TBL_ID = ? AND STS_CD = 'A' AND DERIV_PL_OF_SVC_CD = ? AND DERIV_SVC_CD = ? AND
    // DERIV_CAUS_CD = ? FETCH FIRST 1 ROW ONLY
  ...
  /**
   * selectIpaTable This method is derived from COBOL Paragraph - 2750-SELECT-IPA-TABLE SECTION
   * COBOL Cyclomatic complexity - 11 Input :
   *
   * <p>- ipaSub COBOL Name: IPA-SUB - ripaClmIpa1Cd COBOL Name: RIPA-CLM-IPA-1-CD - d51uIpaCnt
   * COBOL Name: D51U-IPA-CNT - ripaClmIpa2Cd COBOL Name: RIPA-CLM-IPA-2-CD - ripaClmIpa3Cd COBOL
   * Name: RIPA-CLM-IPA-3-CD - ripaSpiTblId COBOL Name: RIPA-SPI-TBL-ID - ripaDerivPlOfSvcCd COBOL
   * Name: RIPA-DERIV-PL-OF-SVC-CD - ripaDerivSvcCd COBOL Name: RIPA-DERIV-SVC-CD - ripaDerivCausCd
   * COBOL Name: RIPA-DERIV-CAUS-CD - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- ipaSub COBOL Name: IPA-SUB - d51uRipaClmIpa1Cd COBOL Name: D51U-RIPA-CLM-IPA-1-CD -
   * d51uIpaCnt COBOL Name: D51U-IPA-CNT - ripaClmIpa1Cd COBOL Name: RIPA-CLM-IPA-1-CD -
   * d51uRipaClmIpa2Cd COBOL Name: D51U-RIPA-CLM-IPA-2-CD - ripaClmIpa2Cd COBOL Name:
   * RIPA-CLM-IPA-2-CD - d51uRipaClmIpa3Cd COBOL Name: D51U-RIPA-CLM-IPA-3-CD - ripaClmIpa3Cd COBOL
   * Name: RIPA-CLM-IPA-3-CD - d51uRipaSpiTblId COBOL Name: D51U-RIPA-SPI-TBL-ID - ripaSpiTblId
   * COBOL Name: RIPA-SPI-TBL-ID - d51uRipaDrvPos COBOL Name: D51U-RIPA-DRV-POS - ripaDerivPlOfSvcCd
   * COBOL Name: RIPA-DERIV-PL-OF-SVC-CD - d51uRipaDrvSvc COBOL Name: D51U-RIPA-DRV-SVC -
   * ripaDerivSvcCd COBOL Name: RIPA-DERIV-SVC-CD - d51uRipaDrvCau COBOL Name: D51U-RIPA-DRV-CAU -
   * ripaDerivCausCd COBOL Name: RIPA-DERIV-CAUS-CD - ipaFoundSw COBOL Name: IPA-FOUND-SW -
   * sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE - d51uReturnCode COBOL Name:
   * D51U-RETURN-CODE - d51uInvReason COBOL Name: D51U-INV-REASON - d51uSqlOrRespCd COBOL Name:
   * D51U-SQL-OR-RESP-CD - d51uDebugTracer COBOL Name: D51U-DEBUG-TRACER - d51uParagraphNum COBOL
   * Name: D51U-PARAGRAPH-NUM
  ...
  public SelectIpaTableOutCtx selectIpaTable(SelectIpaTableInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT CLM_IPA_1_CD , CLM_IPA_2_CD , CLM_IPA_3_CD FROM FE_SPI_RULE_IPA WHERE
    // SPI_TBL_ID = ? AND STS_CD = 'A' AND DERIV_PL_OF_SVC_CD = ? AND DERIV_SVC_CD = ? AND
    // DERIV_CAUS_CD = ? FETCH FIRST 1 ROW ONLY
    ...
    switch (methodOut.getSqlcode()) {
      case 0:
        ...
        if ((allSpaces(methodOut.getRipaClmIpa1Cd()))
            || (checkLowValue(methodOut.getRipaClmIpa1Cd()))) {
        ...
        //  cobolCode::ELSE
          ...
          methodOut.setD51uRipaClmIpa1Cd(
              methodOut.getIpaSub() - 1, padLeftZeros(3, methodOut.getRipaClmIpa1Cd(), false));
        }
        //  cobolCode::IF RIPA-CLM-IPA-2-CD = SPACES OR LOW-VALUES
        if ((allSpaces(methodOut.getRipaClmIpa2Cd()))
            || (checkLowValue(methodOut.getRipaClmIpa2Cd()))) {
        ...
        //  cobolCode::ELSE
          ...
          methodOut.setD51uRipaClmIpa2Cd(
              methodOut.getIpaSub() - 1, padLeftZeros(3, methodOut.getRipaClmIpa2Cd(), false));
        }
        //  cobolCode::IF RIPA-CLM-IPA-3-CD = SPACES OR LOW-VALUES
        if ((allSpaces(methodOut.getRipaClmIpa3Cd()))
            || (checkLowValue(methodOut.getRipaClmIpa3Cd()))) {
        ...
        //  cobolCode::ELSE
          ...
          methodOut.setD51uRipaClmIpa3Cd(
              methodOut.getIpaSub() - 1, padLeftZeros(3, methodOut.getRipaClmIpa3Cd(), false));
        }
  ...
  /**
   * openSvcMainCsr This method is derived from COBOL Paragraph - 2218-OPEN-SVC-MAIN-CSR SECTION
   * COBOL Cyclomatic complexity - 7 Input :
   *
   * <p>- fetchEndMain COBOL Name: WS-FETCH-END-MAIN - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- mainCtr COBOL Name: WS-MAIN-CTR - dsmLogArea COBOL Name: DSM-LOG-AREA - dsmReturnCode
   * COBOL Name: DSM-RETURN-CODE - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE -
   * dsmErrTblName COBOL Name: DSM-ERR-TBL-NAME - dsmErrTblAction COBOL Name: DSM-ERR-TBL-ACTION -
  ...
  public OpenSvcMainCsrOutCtx openSvcMainCsr(OpenSvcMainCsrInCtx methodIn) throws Exception {
    ...
    //  cobolCode::SELECT DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , POS_IND || SVC_IND ||
    // PROV_IND || CAUS_IND || IPA_IND || GTN_IND || ICD_IND || CPE_DESC_IND FROM FE_SPI_DENORM
    // WHERE SPI_TBL_ID = ? FOR FETCH ONLY WITH UR
    programCtx.setSvcMainCsrResultSet(
        d529351uRepository.openSvcMainCsrD529351u(
            methodIn.getDclfeSpiRuleFrToSvc(), programCtx.getSqlca()));
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        ...
        //  cobolCode::PERFORM 2318-FETCH-SVC-MAIN-CSR THRU 2318-EXIT UNTIL END-OF-FETCH-MAIN OR
        // WS-MAIN-CTR > +99
  ...
  /**
   * fetchSvcMainCsr This method is derived from COBOL Paragraph - 2318-FETCH-SVC-MAIN-CSR SECTION
   * COBOL Cyclomatic complexity - 8 Input :
   *
   * <p>- sqlerrd COBOL Name: SQLERRD - sqlcode COBOL Name: SQLCODE - closeCsrInd COBOL Name:
   * CLOSE-CSR-IND
   *
   * <p>Output :
   *
   * <p>- dsnnrows COBOL Name: DSNNROWS - hv04Index COBOL Name: HV04-INDEX - hv05Index COBOL Name:
   * HV05-INDEX - hv06Index COBOL Name: HV06-INDEX - hv07Index COBOL Name: HV07-INDEX - fetchEndMain
   * COBOL Name: WS-FETCH-END-MAIN - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   * - dsmLogArea COBOL Name: DSM-LOG-AREA - d51uReturnCode COBOL Name: D51U-RETURN-CODE -
   * d51uInvReason COBOL Name: D51U-INV-REASON - dsmReturnCode COBOL Name: DSM-RETURN-CODE -
   * dsmErrTblName COBOL Name: DSM-ERR-TBL-NAME - dsmErrTblAction COBOL Name: DSM-ERR-TBL-ACTION -
   * dsmErrSectnName COBOL Name: DSM-ERR-SECTN-NAME - dsmErrPgmName COBOL Name: DSM-ERR-PGM-NAME -
  ...
  public FetchSvcMainCsrOutCtx fetchSvcMainCsr(FetchSvcMainCsrInCtx methodIn) throws Exception {
    ...
    d529351uRepository.fetchSvcMainCsrD529351u(
        programCtx.getSvcMainCsrResultSet(),
        programCtx.getSqlca(),
        methodOut.getHvHostVariablesSvcmain());
  ...
  /**
   * moveSvcMainCsr This method is derived from COBOL Paragraph - 2418-MOVE-SVC-MAIN-CSR SECTION
   * COBOL Cyclomatic complexity - 1 Input : None
   *
   * <p>Output : None
   *
  ...
  /**
   * moveSvcKeyCsr This method is derived from COBOL Paragraph - 2618-MOVE-SVC-KEY-CSR SECTION COBOL
   * Cyclomatic complexity - 2 Input :
   *
   * <p>- mainCtr COBOL Name: WS-MAIN-CTR - hv04KeyDrvPos COBOL Name: HV04-KEY-DRV-POS -
   * hv05KeyDrvSvc COBOL Name: HV05-KEY-DRV-SVC - hv06KeyDrvCau COBOL Name: HV06-KEY-DRV-CAU -
   * hv07RuleSw COBOL Name: HV07-RULE-SW
   *
   * <p>Output :
   *
   * <p>- mainCtr COBOL Name: WS-MAIN-CTR - d51uRetDrvPos COBOL Name: D51U-RET-DRV-POS -
   * hv04KeyDrvPos COBOL Name: HV04-KEY-DRV-POS - d51uRetDrvSvc COBOL Name: D51U-RET-DRV-SVC -
   * hv05KeyDrvSvc COBOL Name: HV05-KEY-DRV-SVC - d51uRetDrvCau COBOL Name: D51U-RET-DRV-CAU -
   * hv06KeyDrvCau COBOL Name: HV06-KEY-DRV-CAU - d51uRetRuleSw COBOL Name: D51U-RET-RULE-SW -
   * hv07RuleSw COBOL Name: HV07-RULE-SW
   *
   * @throws CFException
   */
  ...
  public MoveSvcKeyCsrOutCtx moveSvcKeyCsr(MoveSvcKeyCsrInCtx methodIn) throws Exception {
    ...
    if ((methodOut.getMainCtr() < 99)) {
      ...
      methodOut.setD51uRetDrvPos(
          methodOut.getMainCtr() - 1, methodOut.getHv04KeyDrvPos(methodIn.getHv04Index() - 1));
      //  cobolCode::MOVE HV05-KEY-DRV-SVC ( HV05-INDEX ) TO D51U-RET-DRV-SVC ( WS-MAIN-CTR )
      methodOut.setD51uRetDrvSvc(
          methodOut.getMainCtr() - 1, methodOut.getHv05KeyDrvSvc(methodIn.getHv05Index() - 1));
      //  cobolCode::MOVE HV06-KEY-DRV-CAU ( HV06-INDEX ) TO D51U-RET-DRV-CAU ( WS-MAIN-CTR )
      methodOut.setD51uRetDrvCau(
          methodOut.getMainCtr() - 1, methodOut.getHv06KeyDrvCau(methodIn.getHv06Index() - 1));
      //  cobolCode::MOVE HV07-RULE-SW ( HV07-INDEX ) TO D51U-RET-RULE-SW ( WS-MAIN-CTR )
      methodOut.setD51uRetRuleSw(
          methodOut.getMainCtr() - 1, methodOut.getHv07RuleSw(methodIn.getHv07Index() - 1));
    }

    return methodOut;
  }
  /**
   * closeSvcMainCsr This method is derived from COBOL Paragraph - 2518-CLOSE-SVC-MAIN-CSR SECTION
   * COBOL Cyclomatic complexity - 5 Input :
   *
   ...
   * <p>Output :
   *
   * <p>- closeCsrInd COBOL Name: CLOSE-CSR-IND - dsmLogArea COBOL Name: DSM-LOG-AREA -
   * dsmReturnCode COBOL Name: DSM-RETURN-CODE - dsmErrTblName COBOL Name: DSM-ERR-TBL-NAME -
   * dsmErrTblAction COBOL Name: DSM-ERR-TBL-ACTION - dsmErrSectnName COBOL Name: DSM-ERR-SECTN-NAME
   * - dsmErrPgmName COBOL Name: DSM-ERR-PGM-NAME - dsmSqlcode COBOL Name: DSM-SQLCODE - sqlcode
   * COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  ...
  public CloseSvcMainCsrOutCtx closeSvcMainCsr(CloseSvcMainCsrInCtx methodIn) throws Exception {
    ...
    d529351uRepository.closeSvcMainCsrD529351u(
        programCtx.getSvcMainCsrResultSet(), programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        //  cobolCode::SET CLOSE-CSR-OK TO TRUE
  ...
  /**
   * openCombCursor This method is derived from COBOL Paragraph - 2351-OPEN-COMB-CURSOR SECTION
   * COBOL Cyclomatic complexity - 5 Input :
   *
   * <p>- fetchEndComb COBOL Name: WS-FETCH-END-COMB - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsmReturnCode COBOL Name: DSM-RETURN-CODE - d51uReturnCode COBOL Name: D51U-RETURN-CODE -
  ...
  public OpenCombCursorOutCtx openCombCursor(OpenCombCursorInCtx methodIn) throws Exception {
    ...
    //  cobolCode::DECLARE COMB_CUR CURSOR WITH ROWSET POSITIONING FOR SELECT '1' REC_TYP_CD ,
    // DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , CLM_CAUS_1_CD , CLM_CAUS_2_CD ,
    // CLM_CAUS_3_CD , CLM_CAUS_4_CD , CLM_CAUS_5_CD , CLM_CAUS_6_CD , CLM_CAUS_7_CD , CLM_CAUS_8_CD
    // , CHAR ( SPACE ( 3 ) ) CLM_IPA_1_CD , CHAR ( SPACE ( 3 ) ) CLM_IPA_2_CD , CHAR ( SPACE ( 3 )
    // ) CLM_IPA_3_CD , CHAR ( SPACE ( 2 ) ) PROV_TYP , CHAR ( SPACE ( 2 ) ) FROM_COND_POS , CHAR (
    // SPACE ( 4 ) ) GRP_TBL_1_NBR , CHAR ( SPACE ( 4 ) ) GRP_TBL_2_NBR , CHAR ( SPACE ( 4 ) )
    // GRP_TBL_3_NBR , CHAR ( SPACE ( 4 ) ) CPE_DESC_CD FROM FE_SPI_RULE_CAUS WHERE SPI_TBL_ID = ?
    // AND STS_CD = 'A' AND ( CLM_CAUS_1_CD = ? OR CLM_CAUS_2_CD = ? OR CLM_CAUS_3_CD = ? OR
    // CLM_CAUS_4_CD = ? OR CLM_CAUS_5_CD = ? OR CLM_CAUS_6_CD = ? OR CLM_CAUS_7_CD = ? OR
    // CLM_CAUS_8_CD = ? ) UNION ALL SELECT '2' REC_TYP_CD , DERIV_PL_OF_SVC_CD , DERIV_SVC_CD ,
    // DERIV_CAUS_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_1_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_2_CD ,
    // CHAR ( SPACE ( 1 ) ) CLM_CAUS_3_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_4_CD , CHAR ( SPACE ( 1 )
    // ) CLM_CAUS_5_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_6_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_7_CD ,
    // CHAR ( SPACE ( 1 ) ) CLM_CAUS_8_CD , CLM_IPA_1_CD , CLM_IPA_2_CD , CLM_IPA_3_CD , CHAR (
    // SPACE ( 2 ) ) PROV_TYP , CHAR ( SPACE ( 2 ) ) FROM_COND_POS , GRP_TBL_1_NBR , GRP_TBL_2_NBR ,
    // GRP_TBL_3_NBR , CHAR ( SPACE ( 4 ) ) CPE_DESC_CD FROM FE_SPI_RULE_IPA WHERE SPI_TBL_ID = ?
    // AND STS_CD = 'A' UNION ALL SELECT '3' REC_TYP_CD , DERIV_PL_OF_SVC_CD , DERIV_SVC_CD ,
    // DERIV_CAUS_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_1_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_2_CD ,
    // CHAR ( SPACE ( 1 ) ) CLM_CAUS_3_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_4_CD , CHAR ( SPACE ( 1 )
    // ) CLM_CAUS_5_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_6_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_7_CD ,
    // CHAR ( SPACE ( 1 ) ) CLM_CAUS_8_CD , CHAR ( SPACE ( 3 ) ) CLM_IPA_1_CD , CHAR ( SPACE ( 3 ) )
    // CLM_IPA_2_CD , CHAR ( SPACE ( 3 ) ) CLM_IPA_3_CD , PROV_TYP , CHAR ( SPACE ( 2 ) )
    // FROM_COND_POS , CHAR ( SPACE ( 4 ) ) GRP_TBL_1_NBR , CHAR ( SPACE ( 4 ) ) GRP_TBL_2_NBR ,
    // CHAR ( SPACE ( 4 ) ) GRP_TBL_3_NBR , CHAR ( SPACE ( 4 ) ) CPE_DESC_CD FROM
    // FE_SPI_RULE_PROV_TYP WHERE SPI_TBL_ID = ? AND STS_CD = 'A' AND PROV_TYP = ? UNION ALL SELECT
    // '4' REC_TYP_CD , DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , CHAR ( SPACE ( 1 ) )
    // CLM_CAUS_1_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_2_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_3_CD ,
    // CHAR ( SPACE ( 1 ) ) CLM_CAUS_4_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_5_CD , CHAR ( SPACE ( 1 )
    // ) CLM_CAUS_6_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_7_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_8_CD ,
    // CHAR ( SPACE ( 3 ) ) CLM_IPA_1_CD , CHAR ( SPACE ( 3 ) ) CLM_IPA_2_CD , CHAR ( SPACE ( 3 ) )
    // CLM_IPA_3_CD , CHAR ( SPACE ( 2 ) ) PROV_TYP , FROM_COND_POS , CHAR ( SPACE ( 4 ) )
    // GRP_TBL_1_NBR , CHAR ( SPACE ( 4 ) ) GRP_TBL_2_NBR , CHAR ( SPACE ( 4 ) ) GRP_TBL_3_NBR ,
    // CHAR ( SPACE ( 4 ) ) CPE_DESC_CD FROM FE_SPI_RULE_FR_COND_POS WHERE SPI_TBL_ID = ? AND STS_CD
    // = 'A' AND FROM_COND_POS = ? UNION ALL SELECT '5' REC_TYP_CD , DERIV_PL_OF_SVC_CD ,
    // DERIV_SVC_CD , DERIV_CAUS_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_1_CD , CHAR ( SPACE ( 1 ) )
    // CLM_CAUS_2_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_3_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_4_CD ,
    // CHAR ( SPACE ( 1 ) ) CLM_CAUS_5_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_6_CD , CHAR ( SPACE ( 1 )
    // ) CLM_CAUS_7_CD , CHAR ( SPACE ( 1 ) ) CLM_CAUS_8_CD , CHAR ( SPACE ( 3 ) ) CLM_IPA_1_CD ,
    // CHAR ( SPACE ( 3 ) ) CLM_IPA_2_CD , CHAR ( SPACE ( 3 ) ) CLM_IPA_3_CD , CHAR ( SPACE ( 2 ) )
    // PROV_TYP , CHAR ( SPACE ( 2 ) ) FROM_COND_POS , CHAR ( SPACE ( 4 ) ) GRP_TBL_1_NBR , CHAR (
    // SPACE ( 4 ) ) GRP_TBL_2_NBR , CHAR ( SPACE ( 4 ) ) GRP_TBL_3_NBR , CPE_DESC_CD FROM
    // FE_SPI_RULE_CPE_FLG WHERE SPI_TBL_ID = ? AND STS_CD = 'A' AND CPE_DESC_CD = ? FOR FETCH ONLY
    programCtx.setCombCurResultSet(
        d529351uRepository.openCombCurD529351u(
            methodIn.getDclfeSpiRuleCpeFlg(),
            methodIn.getTestVariables(),
            methodIn.getDclfeSpiRuleIpa(),
            methodIn.getDclfeSpiRuleCaus(),
            methodIn.getDclfeSpiRuleProvTyp(),
            programCtx.getSqlca(),
            methodIn.getDclfeSpiRuleFrCondPos()));
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
  ...
  /**
   * fetchComb This method is derived from COBOL Paragraph - 2352-FETCH-COMB SECTION COBOL
   * Cyclomatic complexity - 17 Input :
   *
   * <p>- sqlerrd COBOL Name: SQLERRD - hv2aRecTypCd COBOL Name: HV2A-REC-TYP-CD - sqlcode COBOL
   * Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsnnrows COBOL Name: DSNNROWS - hv2bIndex COBOL Name: HV2B-INDEX - hv2cIndex COBOL Name:
   * HV2C-INDEX - hv2dIndex COBOL Name: HV2D-INDEX - hv2eIndex COBOL Name: HV2E-INDEX - hv2fIndex
   * COBOL Name: HV2F-INDEX - hv2gIndex COBOL Name: HV2G-INDEX - hv2hIndex COBOL Name: HV2H-INDEX -
   * hv2iIndex COBOL Name: HV2I-INDEX - hv2jIndex COBOL Name: HV2J-INDEX - hv2kIndex COBOL Name:
   * HV2K-INDEX - hv2lIndex COBOL Name: HV2L-INDEX - hv2mIndex COBOL Name: HV2M-INDEX - hv2nIndex
   * COBOL Name: HV2N-INDEX - hv2oIndex COBOL Name: HV2O-INDEX - hv2pIndex COBOL Name: HV2P-INDEX -
   * hv2qIndex COBOL Name: HV2Q-INDEX - hv2aIndex COBOL Name: HV2A-INDEX - hv2rIndex COBOL Name:
   * HV2R-INDEX - hv2sIndex COBOL Name: HV2S-INDEX - hv2tIndex COBOL Name: HV2T-INDEX - hv2uIndex
   * COBOL Name: HV2U-INDEX - fetchEndComb COBOL Name: WS-FETCH-END-COMB - sqlcode_Ws COBOL Name:
   * WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  ...
  public FetchCombOutCtx fetchComb(FetchCombInCtx methodIn) throws Exception {
    ...
    // ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?
    d529351uRepository.fetchCombCurD529351u(
        programCtx.getCombCurResultSet(),
        methodOut.getHvHostVariablesCombcr(),
        programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
            ...
            //  cobolCode::ELSE
              ...
              //  cobolCode::ELSE
                ...
                if (methodIn.getHv2aRecTypCd(methodOut.getHv2aIndex() - 1)[0] == '5') {
                  ...
                  moveCflgTable(
                      programCtx.getMoveCflgTableInCtx()); /*2657-MOVE-CFLG-TABLE SECTION*/
                }
              }
            }
          }
  ...
  /**
   * closeCombCsr This method is derived from COBOL Paragraph - 2353-CLOSE-COMB-CSR SECTION COBOL
   * Cyclomatic complexity - 4 Input :
   *
   * <p>- sqlcode COBOL Name: SQLCODE
   *
  ...
  public CloseCombCsrOutCtx closeCombCsr(CloseCombCsrInCtx methodIn) throws Exception {
    ...
    d529351uRepository.closeCombCurD529351u(
        programCtx.getCombCurResultSet(), programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        //  cobolCode::SET CLOSE-CSR-OK TO TRUE
  ...
  /**
   * moveCauseTable This method is derived from COBOL Paragraph - 2653-MOVE-CAUSE-TABLE SECTION
   * COBOL Cyclomatic complexity - 2 Input :
   *
   * <p>- causSub COBOL Name: CAUS-SUB - hv2bDerivPlOfSvcCd COBOL Name: HV2B-DERIV-PL-OF-SVC-CD -
   * hv2cDerivSvcCd COBOL Name: HV2C-DERIV-SVC-CD - hv2dDerivCausCd COBOL Name: HV2D-DERIV-CAUS-CD -
   * hv2eClmCaus1Cd COBOL Name: HV2E-CLM-CAUS-1-CD - hv2fClmCaus2Cd COBOL Name: HV2F-CLM-CAUS-2-CD -
   * hv2gClmCaus3Cd COBOL Name: HV2G-CLM-CAUS-3-CD - hv2hClmCaus4Cd COBOL Name: HV2H-CLM-CAUS-4-CD -
   * hv2iClmCaus5Cd COBOL Name: HV2I-CLM-CAUS-5-CD - hv2jClmCaus6Cd COBOL Name: HV2J-CLM-CAUS-6-CD -
   * hv2kClmCaus7Cd COBOL Name: HV2K-CLM-CAUS-7-CD - hv2lClmCaus8Cd COBOL Name: HV2L-CLM-CAUS-8-CD
   *
   * <p>Output :
   *
   * <p>- causSub COBOL Name: CAUS-SUB - d51uCausCnt COBOL Name: D51U-CAUS-CNT - causFoundSw COBOL
   * Name: CAUS-FOUND-SW - d51uCausDrvPos COBOL Name: D51U-CAUS-DRV-POS - hv2bDerivPlOfSvcCd COBOL
   * Name: HV2B-DERIV-PL-OF-SVC-CD - d51uCausDrvSvc COBOL Name: D51U-CAUS-DRV-SVC - hv2cDerivSvcCd
   * COBOL Name: HV2C-DERIV-SVC-CD - d51uCausDrvCau COBOL Name: D51U-CAUS-DRV-CAU - hv2dDerivCausCd
   * COBOL Name: HV2D-DERIV-CAUS-CD - d51uCausClmCauseCd1 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-1 -
   * hv2eClmCaus1Cd COBOL Name: HV2E-CLM-CAUS-1-CD - d51uCausClmCauseCd2 COBOL Name:
   * D51U-CAUS-CLM-CAUSE-CD-2 - hv2fClmCaus2Cd COBOL Name: HV2F-CLM-CAUS-2-CD - d51uCausClmCauseCd3
   * COBOL Name: D51U-CAUS-CLM-CAUSE-CD-3 - hv2gClmCaus3Cd COBOL Name: HV2G-CLM-CAUS-3-CD -
   * d51uCausClmCauseCd4 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-4 - hv2hClmCaus4Cd COBOL Name:
   * HV2H-CLM-CAUS-4-CD - d51uCausClmCauseCd5 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-5 - hv2iClmCaus5Cd
   * COBOL Name: HV2I-CLM-CAUS-5-CD - d51uCausClmCauseCd6 COBOL Name: D51U-CAUS-CLM-CAUSE-CD-6 -
   * hv2jClmCaus6Cd COBOL Name: HV2J-CLM-CAUS-6-CD - d51uCausClmCauseCd7 COBOL Name:
   * D51U-CAUS-CLM-CAUSE-CD-7 - hv2kClmCaus7Cd COBOL Name: HV2K-CLM-CAUS-7-CD - d51uCausClmCauseCd8
   * COBOL Name: D51U-CAUS-CLM-CAUSE-CD-8 - hv2lClmCaus8Cd COBOL Name: HV2L-CLM-CAUS-8-CD
   *
   * @throws CFException
   */
  @Override
  public MoveCauseTableOutCtx moveCauseTable(MoveCauseTableInCtx methodIn) throws Exception {
    ...
    if ((methodOut.getCausSub() < 99)) {
      ...
      methodOut.setD51uCausDrvPos(
          methodOut.getCausSub() - 1, methodOut.getHv2bDerivPlOfSvcCd(methodIn.getHv2bIndex() - 1));
      //  cobolCode::MOVE HV2C-DERIV-SVC-CD ( HV2C-INDEX ) TO D51U-CAUS-DRV-SVC ( CAUS-SUB )
      methodOut.setD51uCausDrvSvc(
          methodOut.getCausSub() - 1, methodOut.getHv2cDerivSvcCd(methodIn.getHv2cIndex() - 1));
      //  cobolCode::MOVE HV2D-DERIV-CAUS-CD ( HV2D-INDEX ) TO D51U-CAUS-DRV-CAU ( CAUS-SUB )
      methodOut.setD51uCausDrvCau(
          methodOut.getCausSub() - 1, methodOut.getHv2dDerivCausCd(methodIn.getHv2dIndex() - 1));
      //  cobolCode::MOVE HV2E-CLM-CAUS-1-CD ( HV2E-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-1 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd1(
          methodOut.getCausSub() - 1, methodOut.getHv2eClmCaus1Cd(methodIn.getHv2eIndex() - 1));
      //  cobolCode::MOVE HV2F-CLM-CAUS-2-CD ( HV2F-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-2 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd2(
          methodOut.getCausSub() - 1, methodOut.getHv2fClmCaus2Cd(methodIn.getHv2fIndex() - 1));
      //  cobolCode::MOVE HV2G-CLM-CAUS-3-CD ( HV2G-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-3 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd3(
          methodOut.getCausSub() - 1, methodOut.getHv2gClmCaus3Cd(methodIn.getHv2gIndex() - 1));
      //  cobolCode::MOVE HV2H-CLM-CAUS-4-CD ( HV2H-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-4 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd4(
          methodOut.getCausSub() - 1, methodOut.getHv2hClmCaus4Cd(methodIn.getHv2hIndex() - 1));
      //  cobolCode::MOVE HV2I-CLM-CAUS-5-CD ( HV2I-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-5 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd5(
          methodOut.getCausSub() - 1, methodOut.getHv2iClmCaus5Cd(methodIn.getHv2iIndex() - 1));
      //  cobolCode::MOVE HV2J-CLM-CAUS-6-CD ( HV2J-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-6 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd6(
          methodOut.getCausSub() - 1, methodOut.getHv2jClmCaus6Cd(methodIn.getHv2jIndex() - 1));
      //  cobolCode::MOVE HV2K-CLM-CAUS-7-CD ( HV2K-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-7 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd7(
          methodOut.getCausSub() - 1, methodOut.getHv2kClmCaus7Cd(methodIn.getHv2kIndex() - 1));
      //  cobolCode::MOVE HV2L-CLM-CAUS-8-CD ( HV2L-INDEX ) TO D51U-CAUS-CLM-CAUSE-CD-8 ( CAUS-SUB )
      methodOut.setD51uCausClmCauseCd8(
          methodOut.getCausSub() - 1, methodOut.getHv2lClmCaus8Cd(methodIn.getHv2lIndex() - 1));
    }

    return methodOut;
  }
  /**
   * moveIpaTable This method is derived from COBOL Paragraph - 2654-MOVE-IPA-TABLE SECTION COBOL
   * Cyclomatic complexity - 20 Input :
   *
   * <p>- ipaSub COBOL Name: IPA-SUB - ripaSpiTblId COBOL Name: RIPA-SPI-TBL-ID - hv2bDerivPlOfSvcCd
   * COBOL Name: HV2B-DERIV-PL-OF-SVC-CD - hv2cDerivSvcCd COBOL Name: HV2C-DERIV-SVC-CD -
   * hv2dDerivCausCd COBOL Name: HV2D-DERIV-CAUS-CD - hv2mClmIpa1Cd COBOL Name: HV2M-CLM-IPA-1-CD -
   * hv2mIndex COBOL Name: HV2M-INDEX - d51uIpaCnt COBOL Name: D51U-IPA-CNT - hv2nClmIpa2Cd COBOL
   * Name: HV2N-CLM-IPA-2-CD - hv2nIndex COBOL Name: HV2N-INDEX - hv2oClmIpa3Cd COBOL Name:
   * HV2O-CLM-IPA-3-CD - hv2oIndex COBOL Name: HV2O-INDEX - hv2rGrpTbl1Nbr COBOL Name:
   * HV2R-GRP-TBL-1-NBR - hv2rIndex COBOL Name: HV2R-INDEX - hv2sGrpTbl2Nbr COBOL Name:
   * HV2S-GRP-TBL-2-NBR - hv2sIndex COBOL Name: HV2S-INDEX - hv2tGrpTbl3Nbr COBOL Name:
   * HV2T-GRP-TBL-3-NBR - hv2tIndex COBOL Name: HV2T-INDEX
   *
   * <p>Output :
   *
   * <p>- ipaSub COBOL Name: IPA-SUB - ipaFoundSw COBOL Name: IPA-FOUND-SW - d51uRipaSpiTblId COBOL
   * Name: D51U-RIPA-SPI-TBL-ID - ripaSpiTblId COBOL Name: RIPA-SPI-TBL-ID - d51uRipaDrvPos COBOL
   * Name: D51U-RIPA-DRV-POS - hv2bDerivPlOfSvcCd COBOL Name: HV2B-DERIV-PL-OF-SVC-CD -
   * d51uRipaDrvSvc COBOL Name: D51U-RIPA-DRV-SVC - hv2cDerivSvcCd COBOL Name: HV2C-DERIV-SVC-CD -
   * d51uRipaDrvCau COBOL Name: D51U-RIPA-DRV-CAU - hv2dDerivCausCd COBOL Name: HV2D-DERIV-CAUS-CD -
   * d51uRipaClmIpa1Cd COBOL Name: D51U-RIPA-CLM-IPA-1-CD - d51uIpaCnt COBOL Name: D51U-IPA-CNT -
   * hv2mClmIpa1Cd COBOL Name: HV2M-CLM-IPA-1-CD - d51uRipaClmIpa2Cd COBOL Name:
   * D51U-RIPA-CLM-IPA-2-CD - hv2nClmIpa2Cd COBOL Name: HV2N-CLM-IPA-2-CD - d51uRipaClmIpa3Cd COBOL
   * Name: D51U-RIPA-CLM-IPA-3-CD - hv2oClmIpa3Cd COBOL Name: HV2O-CLM-IPA-3-CD - d51uRipaGrpTbl1Nbr
   * COBOL Name: D51U-RIPA-GRP-TBL-1-NBR - hv2rGrpTbl1Nbr COBOL Name: HV2R-GRP-TBL-1-NBR -
   * d51uRipaGrpTbl2Nbr COBOL Name: D51U-RIPA-GRP-TBL-2-NBR - hv2sGrpTbl2Nbr COBOL Name:
   * HV2S-GRP-TBL-2-NBR - d51uRipaGrpTbl3Nbr COBOL Name: D51U-RIPA-GRP-TBL-3-NBR - hv2tGrpTbl3Nbr
   * COBOL Name: HV2T-GRP-TBL-3-NBR
   *
   * @throws CFException
   */
  @Override
  public MoveIpaTableOutCtx moveIpaTable(MoveIpaTableInCtx methodIn) throws Exception {
    ...
    if ((methodOut.getIpaSub() < 99)) {
      ...
      methodOut.setD51uRipaDrvPos(
          methodOut.getIpaSub() - 1, methodOut.getHv2bDerivPlOfSvcCd(methodIn.getHv2bIndex() - 1));
      //  cobolCode::MOVE HV2C-DERIV-SVC-CD ( HV2C-INDEX ) TO D51U-RIPA-DRV-SVC ( IPA-SUB )
      methodOut.setD51uRipaDrvSvc(
          methodOut.getIpaSub() - 1, methodOut.getHv2cDerivSvcCd(methodIn.getHv2cIndex() - 1));
      //  cobolCode::MOVE HV2D-DERIV-CAUS-CD ( HV2D-INDEX ) TO D51U-RIPA-DRV-CAU ( IPA-SUB )
      methodOut.setD51uRipaDrvCau(
          methodOut.getIpaSub() - 1, methodOut.getHv2dDerivCausCd(methodIn.getHv2dIndex() - 1));
      //  cobolCode::IF HV2M-CLM-IPA-1-CD ( HV2M-INDEX ) = SPACES OR LOW-VALUES OR HIGH-VALUES
      if ((allSpaces(methodOut.getHv2mClmIpa1Cd(methodIn.getHv2mIndex() - 1)))
          || (checkLowValue(methodOut.getHv2mClmIpa1Cd(methodIn.getHv2mIndex() - 1)))
          || (isHighValue(methodOut.getHv2mClmIpa1Cd(methodIn.getHv2mIndex() - 1)))) {
        //  cobolCode::MOVE ZEROES TO D51U-RIPA-CLM-IPA-1-CD ( IPA-SUB )
        methodOut.setD51uRipaClmIpa1Cd(methodOut.getIpaSub() - 1, 0);
      }
      //  cobolCode::ELSE
        ...
        methodOut.setD51uRipaClmIpa1Cd(
            methodOut.getIpaSub() - 1,
            CFUtil.getInt(methodOut.getHv2mClmIpa1Cd(methodIn.getHv2mIndex() - 1)));
      }
      //  cobolCode::IF HV2N-CLM-IPA-2-CD ( HV2N-INDEX ) = SPACES OR LOW-VALUES OR HIGH-VALUES
      if ((allSpaces(methodOut.getHv2nClmIpa2Cd(methodIn.getHv2nIndex() - 1)))
          || (checkLowValue(methodOut.getHv2nClmIpa2Cd(methodIn.getHv2nIndex() - 1)))
          || (isHighValue(methodOut.getHv2nClmIpa2Cd(methodIn.getHv2nIndex() - 1)))) {
        //  cobolCode::MOVE ZEROES TO D51U-RIPA-CLM-IPA-2-CD ( IPA-SUB )
        methodOut.setD51uRipaClmIpa2Cd(methodOut.getIpaSub() - 1, 0);
      }
      //  cobolCode::ELSE
        ...
        methodOut.setD51uRipaClmIpa2Cd(
            methodOut.getIpaSub() - 1,
            CFUtil.getInt(methodOut.getHv2nClmIpa2Cd(methodIn.getHv2nIndex() - 1)));
      }
      //  cobolCode::IF HV2O-CLM-IPA-3-CD ( HV2O-INDEX ) = SPACES OR LOW-VALUES OR HIGH-VALUES
      if ((allSpaces(methodOut.getHv2oClmIpa3Cd(methodIn.getHv2oIndex() - 1)))
          || (checkLowValue(methodOut.getHv2oClmIpa3Cd(methodIn.getHv2oIndex() - 1)))
          || (isHighValue(methodOut.getHv2oClmIpa3Cd(methodIn.getHv2oIndex() - 1)))) {
        //  cobolCode::MOVE ZEROES TO D51U-RIPA-CLM-IPA-3-CD ( IPA-SUB )
        methodOut.setD51uRipaClmIpa3Cd(methodOut.getIpaSub() - 1, 0);
      }
      //  cobolCode::ELSE
        ...
        methodOut.setD51uRipaClmIpa3Cd(
            methodOut.getIpaSub() - 1,
            CFUtil.getInt(methodOut.getHv2oClmIpa3Cd(methodIn.getHv2oIndex() - 1)));
      }
      //  cobolCode::IF HV2R-GRP-TBL-1-NBR ( HV2R-INDEX ) = SPACES OR LOW-VALUES OR HIGH-VALUES
      if ((allSpaces(methodOut.getHv2rGrpTbl1Nbr(methodIn.getHv2rIndex() - 1)))
          || (checkLowValue(methodOut.getHv2rGrpTbl1Nbr(methodIn.getHv2rIndex() - 1)))
          || (isHighValue(methodOut.getHv2rGrpTbl1Nbr(methodIn.getHv2rIndex() - 1)))) {
      ...
      //  cobolCode::ELSE
        ...
        methodOut.setD51uRipaGrpTbl1Nbr(
            methodOut.getIpaSub() - 1, methodOut.getHv2rGrpTbl1Nbr(methodIn.getHv2rIndex() - 1));
      }
      //  cobolCode::IF HV2S-GRP-TBL-2-NBR ( HV2S-INDEX ) = SPACES OR LOW-VALUES OR HIGH-VALUES
      if ((allSpaces(methodOut.getHv2sGrpTbl2Nbr(methodIn.getHv2sIndex() - 1)))
          || (checkLowValue(methodOut.getHv2sGrpTbl2Nbr(methodIn.getHv2sIndex() - 1)))
          || (isHighValue(methodOut.getHv2sGrpTbl2Nbr(methodIn.getHv2sIndex() - 1)))) {
      ...
      //  cobolCode::ELSE
        ...
        methodOut.setD51uRipaGrpTbl2Nbr(
            methodOut.getIpaSub() - 1, methodOut.getHv2sGrpTbl2Nbr(methodIn.getHv2sIndex() - 1));
      }
      //  cobolCode::IF HV2T-GRP-TBL-3-NBR ( HV2T-INDEX ) = SPACES OR LOW-VALUES OR HIGH-VALUES
      if ((allSpaces(methodOut.getHv2tGrpTbl3Nbr(methodIn.getHv2tIndex() - 1)))
          || (checkLowValue(methodOut.getHv2tGrpTbl3Nbr(methodIn.getHv2tIndex() - 1)))
          || (isHighValue(methodOut.getHv2tGrpTbl3Nbr(methodIn.getHv2tIndex() - 1)))) {
      ...
      //  cobolCode::ELSE
        ...
        methodOut.setD51uRipaGrpTbl3Nbr(
            methodOut.getIpaSub() - 1, methodOut.getHv2tGrpTbl3Nbr(methodIn.getHv2tIndex() - 1));
      }
    }
  ...
  /**
   * moveCsptyp This method is derived from COBOL Paragraph - 2655-MOVE-CSPTYP SECTION COBOL
   * Cyclomatic complexity - 2 Input :
   *
   * <p>- ptypSub COBOL Name: PTYP-SUB - hv2bDerivPlOfSvcCd COBOL Name: HV2B-DERIV-PL-OF-SVC-CD -
   * hv2cDerivSvcCd COBOL Name: HV2C-DERIV-SVC-CD - hv2dDerivCausCd COBOL Name: HV2D-DERIV-CAUS-CD -
   * hv2pProvTyp COBOL Name: HV2P-PROV-TYP
   *
   * <p>Output :
   *
   * <p>- ptypSub COBOL Name: PTYP-SUB - provFoundSw COBOL Name: PROV-FOUND-SW - d51uPtypCnt COBOL
   * Name: D51U-PTYP-CNT - d51uPtypDrvPos COBOL Name: D51U-PTYP-DRV-POS - hv2bDerivPlOfSvcCd COBOL
   * Name: HV2B-DERIV-PL-OF-SVC-CD - d51uPtypDrvSvc COBOL Name: D51U-PTYP-DRV-SVC - hv2cDerivSvcCd
   * COBOL Name: HV2C-DERIV-SVC-CD - d51uPtypDrvCau COBOL Name: D51U-PTYP-DRV-CAU - hv2dDerivCausCd
   * COBOL Name: HV2D-DERIV-CAUS-CD - d51uPtypProvTyp COBOL Name: D51U-PTYP-PROV-TYP - hv2pProvTyp
   * COBOL Name: HV2P-PROV-TYP
   *
   * @throws CFException
   */
  @Override
  public MoveCsptypOutCtx moveCsptyp(MoveCsptypInCtx methodIn) throws Exception {
    ...
    if ((methodOut.getPtypSub() < 99)) {
      ...
      methodOut.setD51uPtypDrvPos(
          methodOut.getPtypSub() - 1, methodOut.getHv2bDerivPlOfSvcCd(methodIn.getHv2bIndex() - 1));
      //  cobolCode::MOVE HV2C-DERIV-SVC-CD ( HV2C-INDEX ) TO D51U-PTYP-DRV-SVC ( PTYP-SUB )
      methodOut.setD51uPtypDrvSvc(
          methodOut.getPtypSub() - 1, methodOut.getHv2cDerivSvcCd(methodIn.getHv2cIndex() - 1));
      //  cobolCode::MOVE HV2D-DERIV-CAUS-CD ( HV2D-INDEX ) TO D51U-PTYP-DRV-CAU ( PTYP-SUB )
      methodOut.setD51uPtypDrvCau(
          methodOut.getPtypSub() - 1, methodOut.getHv2dDerivCausCd(methodIn.getHv2dIndex() - 1));
      //  cobolCode::MOVE HV2P-PROV-TYP ( HV2P-INDEX ) TO D51U-PTYP-PROV-TYP ( PTYP-SUB )
      methodOut.setD51uPtypProvTyp(
          methodOut.getPtypSub() - 1, methodOut.getHv2pProvTyp(methodIn.getHv2pIndex() - 1));
    }

    return methodOut;
  }
  /**
   * moveCsfcnd This method is derived from COBOL Paragraph - 2656-MOVE-CSFCND SECTION COBOL
   * Cyclomatic complexity - 2 Input :
   *
   * <p>- fcndSub COBOL Name: FCND-SUB - hv2bDerivPlOfSvcCd COBOL Name: HV2B-DERIV-PL-OF-SVC-CD -
   * hv2cDerivSvcCd COBOL Name: HV2C-DERIV-SVC-CD - hv2dDerivCausCd COBOL Name: HV2D-DERIV-CAUS-CD -
   * hv2qFromCondPos COBOL Name: HV2Q-FROM-COND-POS
   *
   * <p>Output :
   *
   * <p>- fcndSub COBOL Name: FCND-SUB - posFoundSw COBOL Name: POS-FOUND-SW - d51uFcndCnt COBOL
   * Name: D51U-FCND-CNT - d51uFcndDrvPos COBOL Name: D51U-FCND-DRV-POS - hv2bDerivPlOfSvcCd COBOL
   * Name: HV2B-DERIV-PL-OF-SVC-CD - d51uFcndDrvSvc COBOL Name: D51U-FCND-DRV-SVC - hv2cDerivSvcCd
   * COBOL Name: HV2C-DERIV-SVC-CD - d51uFcndDrvCau COBOL Name: D51U-FCND-DRV-CAU - hv2dDerivCausCd
   * COBOL Name: HV2D-DERIV-CAUS-CD - d51uFcndFromCondPos COBOL Name: D51U-FCND-FROM-COND-POS -
   * hv2qFromCondPos COBOL Name: HV2Q-FROM-COND-POS
   *
   * @throws CFException
   */
  ...
  public MoveCsfcndOutCtx moveCsfcnd(MoveCsfcndInCtx methodIn) throws Exception {
    ...
    if ((methodOut.getFcndSub() < 99)) {
      ...
      methodOut.setD51uFcndDrvPos(
          methodOut.getFcndSub() - 1, methodOut.getHv2bDerivPlOfSvcCd(methodIn.getHv2bIndex() - 1));
      //  cobolCode::MOVE HV2C-DERIV-SVC-CD ( HV2C-INDEX ) TO D51U-FCND-DRV-SVC ( FCND-SUB )
      methodOut.setD51uFcndDrvSvc(
          methodOut.getFcndSub() - 1, methodOut.getHv2cDerivSvcCd(methodIn.getHv2cIndex() - 1));
      //  cobolCode::MOVE HV2D-DERIV-CAUS-CD ( HV2D-INDEX ) TO D51U-FCND-DRV-CAU ( FCND-SUB )
      methodOut.setD51uFcndDrvCau(
          methodOut.getFcndSub() - 1, methodOut.getHv2dDerivCausCd(methodIn.getHv2dIndex() - 1));
      //  cobolCode::MOVE HV2Q-FROM-COND-POS ( HV2Q-INDEX ) TO D51U-FCND-FROM-COND-POS ( FCND-SUB )
      methodOut.setD51uFcndFromCondPos(
          methodOut.getFcndSub() - 1,
          pad(3, methodOut.getHv2qFromCondPos(methodIn.getHv2qIndex() - 1), SPACE_CHAR, RIGHT_PAD));
    }

    return methodOut;
  }
  /**
   * moveCflgTable This method is derived from COBOL Paragraph - 2657-MOVE-CFLG-TABLE SECTION COBOL
   * Cyclomatic complexity - 2 Input :
   *
   * <p>- cflgSub COBOL Name: CFLG-SUB - hv2bDerivPlOfSvcCd COBOL Name: HV2B-DERIV-PL-OF-SVC-CD -
   * hv2cDerivSvcCd COBOL Name: HV2C-DERIV-SVC-CD - hv2dDerivCausCd COBOL Name: HV2D-DERIV-CAUS-CD -
   * hv2uCpeDescCd COBOL Name: HV2U-CPE-DESC-CD
   *
   * <p>Output :
   *
   * <p>- cflgSub COBOL Name: CFLG-SUB - d51uCflgCnt COBOL Name: D51U-CFLG-CNT - cflgFoundSw COBOL
   * Name: CFLG-FOUND-SW - d51uCflgDrvPos COBOL Name: D51U-CFLG-DRV-POS - hv2bDerivPlOfSvcCd COBOL
   * Name: HV2B-DERIV-PL-OF-SVC-CD - d51uCflgDrvSvc COBOL Name: D51U-CFLG-DRV-SVC - hv2cDerivSvcCd
   * COBOL Name: HV2C-DERIV-SVC-CD - d51uCflgDrvCau COBOL Name: D51U-CFLG-DRV-CAU - hv2dDerivCausCd
   * COBOL Name: HV2D-DERIV-CAUS-CD - d51uCflgCpeDescCd COBOL Name: D51U-CFLG-CPE-DESC-CD -
   * hv2uCpeDescCd COBOL Name: HV2U-CPE-DESC-CD
   *
   * @throws CFException
   */
  ...
  public MoveCflgTableOutCtx moveCflgTable(MoveCflgTableInCtx methodIn) throws Exception {
    ...
    if ((methodOut.getCflgSub() < 99)) {
      ...
      methodOut.setD51uCflgDrvPos(
          methodOut.getCflgSub() - 1, methodOut.getHv2bDerivPlOfSvcCd(methodIn.getHv2bIndex() - 1));
      //  cobolCode::MOVE HV2C-DERIV-SVC-CD ( HV2C-INDEX ) TO D51U-CFLG-DRV-SVC ( CFLG-SUB )
      methodOut.setD51uCflgDrvSvc(
          methodOut.getCflgSub() - 1, methodOut.getHv2cDerivSvcCd(methodIn.getHv2cIndex() - 1));
      //  cobolCode::MOVE HV2D-DERIV-CAUS-CD ( HV2D-INDEX ) TO D51U-CFLG-DRV-CAU ( CFLG-SUB )
      methodOut.setD51uCflgDrvCau(
          methodOut.getCflgSub() - 1, methodOut.getHv2dDerivCausCd(methodIn.getHv2dIndex() - 1));
      //  cobolCode::MOVE HV2U-CPE-DESC-CD ( HV2U-INDEX ) TO D51U-CFLG-CPE-DESC-CD ( CFLG-SUB )
      methodOut.setD51uCflgCpeDescCd(
          methodOut.getCflgSub() - 1, methodOut.getHv2uCpeDescCd(methodIn.getHv2uIndex() - 1));
    }

    return methodOut;
  }
  /**
   * processFuncCd3 This method is derived from COBOL Paragraph - 3100-PROCESS-FUNC-CD-3 SECTION
   * COBOL Cyclomatic complexity - 4 Input :
   *
   * <p>- sub COBOL Name: WS-SUB - d51uMoreIcdSwitch COBOL Name: D51U-MORE-ICD-SWITCH - d51uKeyFeSpi
   * COBOL Name: D51U-KEY-FE-SPI - d51uLstClmIcdPos COBOL Name: D51U-LST-CLM-ICD-POS -
   * d51uLstClmIcdSvc COBOL Name: D51U-LST-CLM-ICD-SVC - d51uLstClmIcdCau COBOL Name:
   * D51U-LST-CLM-ICD-CAU - d51uLstClmIcdInd COBOL Name: D51U-LST-CLM-ICD-IND
   *
   * <p>Output :
   *
   * <p>- sub COBOL Name: WS-SUB - d51uRetRuleIcd COBOL Name: D51U-RET-RULE-ICD - icdSub COBOL Name:
   * ICD-SUB - d51uMoreIcdCnt COBOL Name: D51U-MORE-ICD-CNT - moreIcdFoundSw COBOL Name:
   * MORE-ICD-FOUND-SW - fetchEndIcd COBOL Name: WS-FETCH-END-ICD - closeCsrInd COBOL Name:
   * CLOSE-CSR-IND - ricdSpiTblId COBOL Name: RICD-SPI-TBL-ID - d51uKeyFeSpi COBOL Name:
   * D51U-KEY-FE-SPI - lstClmIcdPos COBOL Name: WS-LST-CLM-ICD-POS - ricdDerivPlOfSvcCd COBOL Name:
   * RICD-DERIV-PL-OF-SVC-CD - d51uLstClmIcdPos COBOL Name: D51U-LST-CLM-ICD-POS - lstClmIcdSvc
   * COBOL Name: WS-LST-CLM-ICD-SVC - ricdDerivSvcCd COBOL Name: RICD-DERIV-SVC-CD -
   * d51uLstClmIcdSvc COBOL Name: D51U-LST-CLM-ICD-SVC - lstClmIcdCau COBOL Name: WS-LST-CLM-ICD-CAU
   * - ricdDerivCausCd COBOL Name: RICD-DERIV-CAUS-CD - d51uLstClmIcdCau COBOL Name:
   * D51U-LST-CLM-ICD-CAU - lstClmIcdInd COBOL Name: WS-LST-CLM-ICD-IND - d51uLstClmIcdInd COBOL
   * Name: D51U-LST-CLM-ICD-IND
   *
   * @throws CFException
   */
  @Override
  ...
  /**
   * openCsicdCursor3200 This method is derived from COBOL Paragraph - 3200-OPEN-CSICD-CURSOR
   * SECTION COBOL Cyclomatic complexity - 5 Input :
   *
   * <p>- fetchEndIcd COBOL Name: WS-FETCH-END-ICD - sqlcode COBOL Name: SQLCODE
   *
   * <p>Output :
   *
   * <p>- dsmReturnCode COBOL Name: DSM-RETURN-CODE - d51uReturnCode COBOL Name: D51U-RETURN-CODE -
  ...
  public OpenCsicdCursor3200OutCtx openCsicdCursor3200(OpenCsicdCursor3200InCtx methodIn)
    ...
    //  cobolCode::SELECT DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , CLM_ICD_IND ,
    // CLM_ICD_FROM_CD , CLM_ICD_TO_CD FROM FE_SPI_RULE_ICD WHERE ( SPI_TBL_ID = ? AND STS_CD = 'A'
    // AND CLM_ICD_IND = ? ) AND ( ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR (
    // CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >=
    // ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND
    // CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD
    // <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR (
    ...
    // <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR (
    // CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >=
    // ? ) OR ( CLM_ICD_FROM_CD <= ? AND CLM_ICD_TO_CD >= ? ) OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR
    // CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? OR CLM_ICD_FROM_CD = ? )
    // ORDER BY DERIV_PL_OF_SVC_CD , DERIV_SVC_CD , DERIV_CAUS_CD , CLM_ICD_FROM_CD , CLM_ICD_TO_CD
    // FOR FETCH ONLY
    programCtx.setCsicdFirst9999SpiResultSet(
        d529351uRepository.openCsicdFirst9999SpiD529351u(
            methodIn.getDclfeSpiRuleIcd(),
            methodIn.getTestVariables(),
            methodIn.getLstIcdKey(),
            programCtx.getSqlca()));
  ...
  /**
   * fetchCsicd3250 This method is derived from COBOL Paragraph - 3250-FETCH-CSICD SECTION COBOL
   * Cyclomatic complexity - 11 Input :
   *
   * <p>- sqlerrd COBOL Name: SQLERRD - icdSub COBOL Name: ICD-SUB - hv3aIcdDrvPos COBOL Name:
   * HV3A-ICD-DRV-POS - hv3bIcdDrvSvc COBOL Name: HV3B-ICD-DRV-SVC - hv3cIcdDrvCau COBOL Name:
   ...
   * - d51uRicdClmIcdFromCd COBOL Name: D51U-RICD-CLM-ICD-FROM-CD - hv3eClmFrmIcdCd COBOL Name:
   * HV3E-CLM-FRM-ICD-CD - d51uRicdClmIcdToCd COBOL Name: D51U-RICD-CLM-ICD-TO-CD - hv3fClmToIcdCd
   * COBOL Name: HV3F-CLM-TO-ICD-CD - icdFoundSw COBOL Name: ICD-FOUND-SW - d51uIcdCnt COBOL Name:
   * D51U-ICD-CNT - fetchEndIcd COBOL Name: WS-FETCH-END-ICD - d51uMoreIcdRecords COBOL Name:
   * D51U-MORE-ICD-RECORDS - sqlcode_Ws COBOL Name: WS-SQLCODE - sqlcode COBOL Name: SQLCODE
   *
   * @throws CFException
   */
  @Override
  public FetchCsicd3250OutCtx fetchCsicd3250(FetchCsicd3250InCtx methodIn) throws Exception {
    ...
    // , ?
    d529351uRepository.fetchCsicdFirst9999SpiD529351u(
        programCtx.getCsicdFirst9999SpiResultSet(),
        methodOut.getHvHostVariablesCsicdo(),
        programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
  ...
  /**
   * closeCsr3260 This method is derived from COBOL Paragraph - 3260-CLOSE-CSR SECTION COBOL
   * Cyclomatic complexity - 4 Input :
   *
   * <p>- sqlcode COBOL Name: SQLCODE
   *
  ...
  public CloseCsr3260OutCtx closeCsr3260(CloseCsr3260InCtx methodIn) throws Exception {
    ...
    d529351uRepository.closeCsicdFirst9999SpiD529351u(
        programCtx.getCsicdFirst9999SpiResultSet(), programCtx.getSqlca());
    //  cobolCode::EVALUATE SQLCODE
    switch (methodOut.getSqlcode()) {
      case 0:
        //  cobolCode::SET CLOSE-CSR-OK TO TRUE
  ...
  public int call(ProgramContext ctx, Object[] params) throws Exception {
    ...
    if (len > 1 && params[1] != null) programCtx.getVyspi51uCallArea().set((Field) params[1]);
