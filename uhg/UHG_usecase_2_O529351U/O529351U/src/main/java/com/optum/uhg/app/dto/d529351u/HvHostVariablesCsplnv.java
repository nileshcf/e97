...
public class HvHostVariablesCsplnv extends HvHostVariablesCsplnvSerialized {
  ...
  /**
   * Returns the value of hv01SpiTblId Corresponding COBOL Variable is HV01-SPI-TBL-ID
   *
   * @return hv01SpiTblId
   */
  ...
  public char[] getHv01SpiTblId(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv01SpiTblId - Array index exceeded max Size {}, resetting it to max allowed",
          HV_01_SPI_TBL_ID_SIZE);
    }
  ...
  /**
   * Update Hv01SpiTblId with the passed value at a given index Corresponding COBOL Variable is
   * HV01-SPI-TBL-ID
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv01SpiTblId with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv01SpiTblId(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv01SpiTblId(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv0aPriDiagInd Corresponding COBOL Variable is HV0A-PRI-DIAG-IND
   *
  ...
  public char[] getHv0aPriDiagInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv0aPriDiagInd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_0A_PRI_DIAG_IND_SIZE);
    }
    return getCharArray(
        (beginHv0aPriDiagInd + index * HV_0A_PRI_DIAG_IND_LEN), HV_0A_PRI_DIAG_IND_LEN);
  }
  ...
  /**
   * Update Hv0aPriDiagInd with the passed value at a given index Corresponding COBOL Variable is
   * HV0A-PRI-DIAG-IND
   *
   * @param index
   * @param value
  ...
  /**
   * Update Hv0aPriDiagInd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv0aPriDiagInd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv0aPriDiagInd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv14PosTierTypCd Corresponding COBOL Variable is HV14-POS-TIER-TYP-CD
   *
  ...
  public char[] getHv14PosTierTypCd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv14PosTierTypCd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_14_POS_TIER_TYP_CD_SIZE);
    }
    return getCharArray(
        (beginHv14PosTierTypCd + index * HV_14_POS_TIER_TYP_CD_LEN), HV_14_POS_TIER_TYP_CD_LEN);
  }
  ...
  /**
   * Update Hv14PosTierTypCd with the passed value at a given index Corresponding COBOL Variable is
  ...
  /**
   * Update Hv14PosTierTypCd with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setHv14PosTierTypCd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv14PosTierTypCd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Returns the value of hv15MjrDiagEligInd Corresponding COBOL Variable is HV15-MJR-DIAG-ELIG-IND
   *
  ...
  public char[] getHv15MjrDiagEligInd(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "hv15MjrDiagEligInd - Array index exceeded max Size {}, resetting it to max allowed",
          HV_15_MJR_DIAG_ELIG_IND_SIZE);
    }
    return getCharArray(
  ...
  /**
   * Update Hv15MjrDiagEligInd with the passed value at a given index Corresponding COBOL Variable
   * is HV15-MJR-DIAG-ELIG-IND
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update Hv15MjrDiagEligInd with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setHv15MjrDiagEligInd(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setHv15MjrDiagEligInd(int,String,boolean), reset it to 0", index);
      index = 0;
    }
