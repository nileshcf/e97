...
/**
 * The class D51uTestValuesSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uTestValuesSerialized extends Field {
  ...
  /**
   * sets parent for this D51uTestValuesSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uTestCausModified() {
    ...
    localD51uTestCausCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uTestCaus is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uTestCaus() {
    return (substring(
        getStringValue(), beginD51uTestCaus, beginD51uTestCaus + D_51U_TEST_CAUS_LEN));
  }
  ...
  public boolean isD51uTestProvTypModified() {
    ...
    localD51uTestProvTypCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uTestProvTyp is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uTestProvTyp() {
    return (substring(
        getStringValue(), beginD51uTestProvTyp, beginD51uTestProvTyp + D_51U_TEST_PROV_TYP_LEN));
  }
  ...
  public boolean isD51uTestPosModified() {
    ...
    localD51uTestPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isD51uTestSvcCdModified() {
    ...
    localD51uTestSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uTestSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uTestSvcCd() {
    return (substring(
        getStringValue(), beginD51uTestSvcCd, beginD51uTestSvcCd + D_51U_TEST_SVC_CD_LEN));
  }
  ...
  public boolean isD51uTestCpeDescCdModified() {
    ...
    localD51uTestCpeDescCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uTestCpeDescCd(char[] d51uTestCpeDescCd) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uTestCpeDescCd, 0, getStringValue(), beginD51uTestCpeDescCd, D_51U_TEST_CPE_DESC_CD_LEN);
  ...
  /**
   * refreshD51uTestCpeDescCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uTestCpeDescCd() {
    return (substring(
        getStringValue(),
        beginD51uTestCpeDescCd,
        beginD51uTestCpeDescCd + D_51U_TEST_CPE_DESC_CD_LEN));
  }
}
