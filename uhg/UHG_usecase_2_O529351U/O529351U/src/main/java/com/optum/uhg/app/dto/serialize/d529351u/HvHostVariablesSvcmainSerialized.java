...
/**
 * The class HvHostVariablesSvcmainSerialized is used to define offsets in order to serialize in a
 * fixed String
 *
...
public class HvHostVariablesSvcmainSerialized extends Field {
  ...
  protected void serializeHv04KeyDrvPos(int index, char[] value) {
    replaceValue(
        value, (beginHv04KeyDrvPos + index * HV_04_KEY_DRV_POS_LEN), HV_04_KEY_DRV_POS_LEN);
  }
  ...
  protected void serializeHv05KeyDrvSvc(int index, char[] value) {
    replaceValue(
        value, (beginHv05KeyDrvSvc + index * HV_05_KEY_DRV_SVC_LEN), HV_05_KEY_DRV_SVC_LEN);
  }
  ...
  protected void serializeHv06KeyDrvCau(int index, char[] value) {
    replaceValue(
        value, (beginHv06KeyDrvCau + index * HV_06_KEY_DRV_CAU_LEN), HV_06_KEY_DRV_CAU_LEN);
  }
  ...
  protected void serializeHv07RuleSw(int index, char[] value) {
    replaceValue(value, (beginHv07RuleSw + index * HV_07_RULE_SW_LEN), HV_07_RULE_SW_LEN);
  }
