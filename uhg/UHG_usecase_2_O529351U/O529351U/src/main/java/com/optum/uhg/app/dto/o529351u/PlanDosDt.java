...
public class PlanDosDt extends PlanDosDtSerialized {
  ...
  /**
   * Update PlanDosMm with the passed value Corresponding COBOL Variable is WS-PLAN-DOS-MM
   *
   * @param number
   */
  ...
  /**
   * Update PlanDosDd with the passed value Corresponding COBOL Variable is WS-PLAN-DOS-DD
   *
   * @param number
   */
  ...
  /**
   * Update PlanDosYy with the passed value Corresponding COBOL Variable is WS-PLAN-DOS-YY
   *
   * @param number
   */
