...
public class D51uRetRulCauseData extends D51uRetRulCauseDataSerialized {
  ...
  /**
   * Returns the value of d51uRetRulCause Corresponding COBOL Variable is D51U-RET-RUL-CAUSE
   *
  ...
  public D51uRetRulCause getD51uRetRulCause(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "d51uRetRulCause - Array index exceeded max Size {}, resetting it to max allowed",
          D_51U_RET_RUL_CAUSE_SIZE);
    }
    if (index >= d51uRetRulCause.size()) {
      ...
      d51uRetRulCause.set(
          ...
          new D51uRetRulCause(
              this,
              beginD51uRetRulCause + index * D51uRetRulCause.getD51uRetRulCauseFieldLength()));
    }
  ...
  /**
   * Update D51uRetRulCause at index with the passed value Corresponding COBOL Variable is
   * D51U-RET-RUL-CAUSE
   *
   * @param index
   * @param value
