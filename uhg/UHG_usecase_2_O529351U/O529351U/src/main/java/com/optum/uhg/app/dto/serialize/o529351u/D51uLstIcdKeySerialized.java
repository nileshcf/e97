...
/**
 * The class D51uLstIcdKeySerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uLstIcdKeySerialized extends Field {
  ...
  /**
   * sets parent for this D51uLstIcdKeySerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uLstClmIcdIndModified() {
    ...
    localD51uLstClmIcdIndCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uLstClmIcdInd(char[] d51uLstClmIcdInd) {
    ...
    arraycopy(
        d51uLstClmIcdInd, 0, getStringValue(), beginD51uLstClmIcdInd, D_51U_LST_CLM_ICD_IND_LEN);
  ...
  /**
   * refreshD51uLstClmIcdInd is used to refresh the latest value of a variable from the Serialized
  ...
  public char[] refreshD51uLstClmIcdInd() {
    return (substring(
        getStringValue(),
        beginD51uLstClmIcdInd,
        beginD51uLstClmIcdInd + D_51U_LST_CLM_ICD_IND_LEN));
  }
  ...
  public boolean isD51uLstClmIcdPosModified() {
    ...
    localD51uLstClmIcdPosCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uLstClmIcdPos(char[] d51uLstClmIcdPos) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uLstClmIcdPos, 0, getStringValue(), beginD51uLstClmIcdPos, D_51U_LST_CLM_ICD_POS_LEN);
  ...
  /**
   * refreshD51uLstClmIcdPos is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uLstClmIcdPos() {
    return (substring(
        getStringValue(),
        beginD51uLstClmIcdPos,
        beginD51uLstClmIcdPos + D_51U_LST_CLM_ICD_POS_LEN));
  }
  ...
  public boolean isD51uLstClmIcdSvcModified() {
    ...
    localD51uLstClmIcdSvcCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uLstClmIcdSvc(char[] d51uLstClmIcdSvc) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uLstClmIcdSvc, 0, getStringValue(), beginD51uLstClmIcdSvc, D_51U_LST_CLM_ICD_SVC_LEN);
  ...
  /**
   * refreshD51uLstClmIcdSvc is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uLstClmIcdSvc() {
    return (substring(
        getStringValue(),
        beginD51uLstClmIcdSvc,
        beginD51uLstClmIcdSvc + D_51U_LST_CLM_ICD_SVC_LEN));
  }
  ...
  public boolean isD51uLstClmIcdCauModified() {
    ...
    localD51uLstClmIcdCauCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uLstClmIcdCau(char[] d51uLstClmIcdCau) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uLstClmIcdCau, 0, getStringValue(), beginD51uLstClmIcdCau, D_51U_LST_CLM_ICD_CAU_LEN);
  ...
  /**
   * refreshD51uLstClmIcdCau is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uLstClmIcdCau() {
    return (substring(
        getStringValue(),
        beginD51uLstClmIcdCau,
        beginD51uLstClmIcdCau + D_51U_LST_CLM_ICD_CAU_LEN));
  }
}
