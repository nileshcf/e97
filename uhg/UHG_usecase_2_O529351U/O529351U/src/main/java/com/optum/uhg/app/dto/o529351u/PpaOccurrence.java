...
public class PpaOccurrence extends PpaOccurrenceSerialized {
  ...
  /**
   * set variable ppaProduct Corresponding COBOL Variable is PPA-PRODUCT
   *
   * @param value
   */
  ...
  /**
   * Update PpaProduct with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaProduct with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaProduct(
  ...
  /**
   * Update PpaProduct with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaProduct with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaProduct(
  ...
  /**
   * Update PpaMarketType with the passed value Corresponding COBOL Variable is PPA-MARKET-TYPE
   *
   * @param number
   */
  ...
  public void setPpaMarketType(int number) {
    number =
        checkPpaMarketTypeMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update PpaMarket with the passed value Corresponding COBOL Variable is PPA-MARKET
   *
   * @param number
   */
  ...
  /**
   * Update PpaIpa with the passed value Corresponding COBOL Variable is PPA-IPA
   *
   * @param number
   */
  ...
  /**
   * set variable ppaGrpTabNo Corresponding COBOL Variable is PPA-GRP-TAB-NO
   *
   * @param value
   */
  ...
  /**
   * Update PpaGrpTabNo with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaGrpTabNo with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaGrpTabNo(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PpaGrpTabNo with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaGrpTabNo with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaGrpTabNo(
  ...
  /**
   * set variable ppaContractArrange Corresponding COBOL Variable is PPA-CONTRACT-ARRANGE
   *
   * @param value
   */
  ...
  /**
   * Update PpaContractArrange with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaContractArrange with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaContractArrange(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PpaContractArrange with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaContractArrange with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaContractArrange(
  ...
  /**
   * Update PpaFirstEffDate with the passed value Corresponding COBOL Variable is PPA-FIRST-EFF-DATE
   *
   * @param number
   */
  public void setPpaFirstEffDate(int number) {
    ppaFirstEffDate =
        checkPpaFirstEffDateMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update PpaLastCanDate with the passed value Corresponding COBOL Variable is PPA-LAST-CAN-DATE
   *
   * @param number
   */
  public void setPpaLastCanDate(int number) {
    ppaLastCanDate =
        checkPpaLastCanDateMaxLimit(number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * set variable ppaFacContr Corresponding COBOL Variable is PPA-FAC-CONTR
   *
   * @param value
   */
  ...
  /**
   * Update PpaFacContr with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaFacContr with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaFacContr(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update PpaFacContr with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update PpaFacContr with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setPpaFacContr(
