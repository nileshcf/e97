...
public class Work extends WorkSerialized {
  ...
  /**
   * Update W02AbsoluteTime with the passed value Corresponding COBOL Variable is W02-ABSOLUTE-TIME
   *
   * @param number
   */
  ...
  /**
   * set variable ddSpirules Corresponding COBOL Variable is DD-SPIRULES
   *
   * @param value
   */
  ...
  /**
   * set variable ddPlanvara Corresponding COBOL Variable is DD-PLANVARA
   *
   * @param value
   */
  ...
  /**
   * set variable firstTimeThru Corresponding COBOL Variable is WS-FIRST-TIME-THRU
   *
   * @param value
   */
  ...
  /**
   * set variable planVarFoundSw Corresponding COBOL Variable is WS-PLAN-VAR-FOUND-SW
   *
   * @param value
   */
  ...
  /**
   * set variable posTierFoundSw Corresponding COBOL Variable is WS-POS-TIER-FOUND-SW
   *
   * @param value
   */
  ...
  /**
   * set variable newPlanVarFoundSw Corresponding COBOL Variable is WS-NEW-PLAN-VAR-FOUND-SW
   *
   * @param value
   */
  ...
  /**
   * set variable endOfPlanAlt Corresponding COBOL Variable is WS-END-OF-PLAN-ALT
   *
   * @param value
   */
  ...
  /**
   * set variable endOfSpiRule Corresponding COBOL Variable is WS-END-OF-SPI-RULE
   *
   * @param value
   */
  ...
  /**
   * set variable topsCnvSvc Corresponding COBOL Variable is WS-TOPS-CNV-SVC
   *
   * @param value
   */
  ...
  /**
   * set variable nbrEqual Corresponding COBOL Variable is WS-NBR-EQUAL
   *
   * @param value
   */
  ...
  /**
   * set variable searchComplete Corresponding COBOL Variable is WS-SEARCH-COMPLETE
   *
   * @param value
   */
  ...
  /**
   * set variable fromPsFound Corresponding COBOL Variable is WS-FROM-PS-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable fromSvcFound Corresponding COBOL Variable is WS-FROM-SVC-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable fromPrvFound Corresponding COBOL Variable is WS-FROM-PRV-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable fromIcd9Found Corresponding COBOL Variable is WS-FROM-ICD9-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable fromCauseFound Corresponding COBOL Variable is WS-FROM-CAUSE-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable useDiagnosisSw Corresponding COBOL Variable is USE-DIAGNOSIS-SW
   *
   * @param value
   */
  ...
  /**
   * set variable ipaCodeFound Corresponding COBOL Variable is WS-IPA-CODE-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable cpeFlgFound Corresponding COBOL Variable is WS-CPE-FLG-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable ipaAndGtnFound Corresponding COBOL Variable is WS-IPA-AND-GTN-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable gtnLoaded Corresponding COBOL Variable is WS-GTN-LOADED
   *
   * @param value
   */
  ...
  /**
   * set variable sameTable Corresponding COBOL Variable is WS-SAME-TABLE
   *
   * @param value
   */
  ...
  /**
   * set variable keyComplete Corresponding COBOL Variable is WS-KEY-COMPLETE
   *
   * @param value
   */
  ...
  /**
   * set variable withMmiSw2010 Corresponding COBOL Variable is WS-2010-WITH-MMI-SW
   *
   * @param value
   */
  ...
  /**
   * set variable mmiFoundSw Corresponding COBOL Variable is WS-MMI-FOUND-SW
   *
   * @param value
   */
  ...
  /**
   * set variable primDiagFound Corresponding COBOL Variable is WS-PRIM-DIAG-FOUND
   *
   * @param value
   */
  ...
  /**
   * set variable d529351uDb2Dsm Corresponding COBOL Variable is WS-D529351U-DB2-DSM
   *
   * @param value
   */
  ...
  /**
   * set variable newSpiSw Corresponding COBOL Variable is WS-NEW-SPI-SW
   *
   * @param value
   */
  ...
  /**
   * set variable primeSpiSw Corresponding COBOL Variable is WS-PRIME-SPI-SW
   *
   * @param value
   */
  ...
  /**
   * Update MedSvcNbr with the passed value Corresponding COBOL Variable is MED-SVC-NBR
   *
   * @param number
   */
  ...
  /**
   * set variable medSvc Corresponding COBOL Variable is MED-SVC
   *
   * @param value
   */
  ...
  /**
   * set variable feSpiEnableInd Corresponding COBOL Variable is FE-SPI-ENABLE-IND
   *
   * @param value
   */
  ...
  /**
   * set variable fePrimeSpiEnableInd Corresponding COBOL Variable is FE-PRIME-SPI-ENABLE-IND
   *
   * @param value
   */
  ...
  /**
   * Update KeySub with the passed value Corresponding COBOL Variable is KEY-SUB
   *
   * @param number
   */
  ...
  /**
   * Update PosSub with the passed value Corresponding COBOL Variable is WS-POS-SUB
   *
   * @param number
   */
  ...
  /**
   * Update GenSub with the passed value Corresponding COBOL Variable is WS-GEN-SUB
   *
   * @param number
   */
  ...
  /**
   * Update NewSub with the passed value Corresponding COBOL Variable is WS-NEW-SUB
   *
   * @param number
   */
  ...
  /**
   * Update PsSub with the passed value Corresponding COBOL Variable is PS-SUB
   *
   * @param number
   */
  ...
  /**
   * Update SvcSub with the passed value Corresponding COBOL Variable is SVC-SUB
   *
   * @param number
   */
  ...
  /**
   * Update PvSub with the passed value Corresponding COBOL Variable is PV-SUB
   *
   * @param number
   */
  ...
  /**
   * Update Icd9Sub with the passed value Corresponding COBOL Variable is ICD9-SUB
   *
   * @param number
   */
  ...
  /**
   * Update CauseSub with the passed value Corresponding COBOL Variable is CAUSE-SUB
   *
   * @param number
   */
  ...
  /**
   * Update Sub01 with the passed value Corresponding COBOL Variable is LK-SUB
   *
   * @param number
   */
  ...
  /**
   * Update DiagSub with the passed value Corresponding COBOL Variable is WS-DIAG-SUB
   *
   * @param number
   */
  ...
  /**
   * Update S1 with the passed value Corresponding COBOL Variable is S1
   *
   * @param number
   */
  ...
  /**
   * Update DSub with the passed value Corresponding COBOL Variable is D-SUB
   *
   * @param number
   */
  ...
  /**
   * Update S2 with the passed value Corresponding COBOL Variable is S2
   *
   * @param number
   */
  ...
  /**
   * Update SavHpriceCount with the passed value Corresponding COBOL Variable is SAV-HPRICE-COUNT
   *
   * @param number
   */
  ...
  public void setSavHpriceCount(int number) {
    number =
        checkSavHpriceCountMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update SavNbrOfOccurances2 with the passed value Corresponding COBOL Variable is
   * SAV-NBR-OF-OCCURANCES-2
   *
   * @param number
   */
  ...
  public void setSavNbrOfOccurances2(int number) {
    number =
        checkSavNbrOfOccurances2MaxLimit(
  ...
  /**
   * Returns the value of savHcdsChargeInfo Corresponding COBOL Variable is SAV-HCDS-CHARGE-INFO
   *
  ...
  public char[] getSavHcdsChargeInfo(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "savHcdsChargeInfo - Array index exceeded max Size {}, resetting it to max allowed",
          SAV_HCDS_CHARGE_INFO_SIZE);
    }
    return getCharArray(
        (beginSavHcdsChargeInfo + index * SAV_HCDS_CHARGE_INFO_LEN), SAV_HCDS_CHARGE_INFO_LEN);
  }
  ...
  /**
   * Update SavHcdsChargeInfo with the passed value at a given index Corresponding COBOL Variable is
   * SAV-HCDS-CHARGE-INFO
   *
   * @param index
   * @param value
   */
  ...
  /**
   * Update SavHcdsChargeInfo with the passed value at a given index and serializes if setModified
   * is true
   *
   * @param index
   * @param value
  ...
  private void setSavHcdsChargeInfo(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setSavHcdsChargeInfo(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * Update SavMpriceCount with the passed value Corresponding COBOL Variable is SAV-MPRICE-COUNT
   *
   * @param number
   */
  ...
  public void setSavMpriceCount(int number) {
    number =
        checkSavMpriceCountMaxLimit((short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update SavNbrOfOccurances3 with the passed value Corresponding COBOL Variable is
   * SAV-NBR-OF-OCCURANCES-3
   *
   * @param number
   */
  ...
  public void setSavNbrOfOccurances3(int number) {
    number =
        checkSavNbrOfOccurances3MaxLimit(
            (short) number); // Truncate if value is beyond +/- Max range
  ...
  /**
   * Update SazgrpNumGrp with the passed value Corresponding COBOL Variable is SAZGRP-NUM-GRP
   *
   * @param number
   */
  ...
  /**
   * Returns the value of sazgrpGroups Corresponding COBOL Variable is SAZGRP-GROUPS
   *
   * @return sazgrpGroups
   */
  ...
  public char[] getSazgrpGroups(int index) {
    if (index < 0) {
      ...
      logger.trace(
          "sazgrpGroups - Array index exceeded max Size {}, resetting it to max allowed",
          SAZGRP_GROUPS_SIZE);
    }
  ...
  /**
   * Update SazgrpGroups with the passed value at a given index Corresponding COBOL Variable is
   * SAZGRP-GROUPS
   *
   * @param index
   * @param value
  ...
  /**
   * Update SazgrpGroups with the passed value at a given index and serializes if setModified is
   * true
   *
   * @param index
   * @param value
  ...
  private void setSazgrpGroups(int index, char[] value, boolean setModified) {
    if (index < 0) {
      logger.trace(
          "Array index was {} for setSazgrpGroups(int,String,boolean), reset it to 0", index);
      index = 0;
    }
  ...
  /**
   * set variable functionFlag Corresponding COBOL Variable is LK-FUNCTION-FLAG
   *
   * @param value
   */
  ...
  /**
   * set variable illogicalCond Corresponding COBOL Variable is LK-ILLOGICAL-COND
   *
   * @param value
   */
  ...
  /**
   * set variable lsEqiRecord Corresponding COBOL Variable is LS-EQI-RECORD
   *
   * @param value
   */
