...
/**
 * The class M51uFlagsSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class M51uFlagsSerialized extends Field {
  ...
  /**
   * sets parent for this M51uFlagsSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isM51uFunctionFlagModified() {
    ...
    localM51uFunctionFlagCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeM51uFunctionFlag(char[] m51uFunctionFlag) {
    ...
    arraycopy(
        m51uFunctionFlag, 0, getStringValue(), beginM51uFunctionFlag, M_51U_FUNCTION_FLAG_LEN);
  ...
  /**
   * refreshM51uFunctionFlag is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshM51uFunctionFlag() {
    return (substring(
        getStringValue(), beginM51uFunctionFlag, beginM51uFunctionFlag + M_51U_FUNCTION_FLAG_LEN));
  }
  ...
  public boolean isM51uIllogicalCondSwModified() {
    ...
    localM51uIllogicalCondSwCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeM51uIllogicalCondSw(char[] m51uIllogicalCondSw) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginM51uIllogicalCondSw,
        M_51U_ILLOGICAL_COND_SW_LEN);
  ...
  /**
   * refreshM51uIllogicalCondSw is used to refresh the latest value of a variable from the
  ...
  public char[] refreshM51uIllogicalCondSw() {
    return (substring(
        getStringValue(),
        beginM51uIllogicalCondSw,
        beginM51uIllogicalCondSw + M_51U_ILLOGICAL_COND_SW_LEN));
  }
}
