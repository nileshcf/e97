...
/**
 * The class D51uErrorTraceSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class D51uErrorTraceSerialized extends Field {
  ...
  /**
   * sets parent for this D51uErrorTraceSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
  ...
  public boolean isD51uSqlOrRespCdModified() {
    ...
    localD51uSqlOrRespCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uSqlOrRespCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uSqlOrRespCd() {
    return (substring(
        getStringValue(), beginD51uSqlOrRespCd, beginD51uSqlOrRespCd + D_51U_SQL_OR_RESP_CD_LEN));
  }
  ...
  public boolean isD51uDebugTracerModified() {
    ...
    localD51uDebugTracerCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshD51uDebugTracer is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uDebugTracer() {
    return (substring(
        getStringValue(), beginD51uDebugTracer, beginD51uDebugTracer + D_51U_DEBUG_TRACER_LEN));
  }
  ...
  public boolean isD51uParagraphNumModified() {
    ...
    localD51uParagraphNumCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeD51uParagraphNum(char[] d51uParagraphNum) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        d51uParagraphNum, 0, getStringValue(), beginD51uParagraphNum, D_51U_PARAGRAPH_NUM_LEN);
  ...
  /**
   * refreshD51uParagraphNum is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshD51uParagraphNum() {
    return (substring(
        getStringValue(), beginD51uParagraphNum, beginD51uParagraphNum + D_51U_PARAGRAPH_NUM_LEN));
  }
}
