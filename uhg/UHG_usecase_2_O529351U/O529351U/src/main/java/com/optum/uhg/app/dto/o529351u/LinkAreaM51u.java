...
public class LinkAreaM51u extends LinkAreaM51uSerialized {
  ...
  /**
   * Update M51uFlags with the passed value Corresponding COBOL Variable is M51U-FLAGS
   *
   * @param value
   */
  ...
  /**
   * Update M51uFlags with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uFlags with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uFlags(
  ...
  /**
   * Update M51uFlags with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uFlags with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uFlags(
  ...
  /**
   * Update M51uLinkage with the passed value Corresponding COBOL Variable is M51U-LINKAGE
   *
   * @param value
   */
  ...
  /**
   * Update M51uLinkage with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uLinkage with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uLinkage(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update M51uLinkage with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update M51uLinkage with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setM51uLinkage(
  ...
  /**
   * Update UGenericTranslation51 with the passed value Corresponding COBOL Variable is
   * LK-51U-GENERIC-TRANSLATION
   *
   * @param value
   */
  ...
  /**
   * Update UGenericTranslation51 with a String from an offset and length
   *
   * @param value
   */
  public void setUGenericTranslation51(char[] source, int sourceIndex, int sourceLen) {
    replace(
        ...
        sourceIndex,
        sourceLen,
        uGenericTranslation51.begin,
        uGenericTranslation51.length());
  }

  /**
   * Update UGenericTranslation51 with a String from an offset and length to an offset and length
   *
   * @param value
   */
  ...
  public void setUGenericTranslation51(Field source) {
    replace(
        source, 0, source.length(), uGenericTranslation51.begin, uGenericTranslation51.length());
  }

  /**
   * Update UGenericTranslation51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UGenericTranslation51 with another Field from an offset and length to an offset and
   * length
   *
   * @param value
   */
  ...
  /**
   * set variable uCcmNOSvcInd51 Corresponding COBOL Variable is LK-51U-CCM-N-O-SVC-IND
   *
   * @param value
   */
  ...
  /**
   * Update UCcmNOSvcInd51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UCcmNOSvcInd51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUCcmNOSvcInd51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UCcmNOSvcInd51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UCcmNOSvcInd51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUCcmNOSvcInd51(
  ...
  /**
   * set variable uSpiTblId51 Corresponding COBOL Variable is LK-51U-SPI-TBL-ID
   *
   * @param value
   */
  ...
  /**
   * Update USpiTblId51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update USpiTblId51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUSpiTblId51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update USpiTblId51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update USpiTblId51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUSpiTblId51(
  ...
  /**
   * set variable uHcrProcessSw51 Corresponding COBOL Variable is LK-51U-HCR-PROCESS-SW
   *
   * @param value
   */
  ...
  /**
   * Update UHcrProcessSw51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UHcrProcessSw51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUHcrProcessSw51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UHcrProcessSw51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UHcrProcessSw51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUHcrProcessSw51(
  ...
  /**
   * set variable uHcrSpiSw51 Corresponding COBOL Variable is LK-51U-HCR-SPI-SW
   *
   * @param value
   */
  ...
  /**
   * Update UHcrSpiSw51 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UHcrSpiSw51 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUHcrSpiSw51(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update UHcrSpiSw51 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update UHcrSpiSw51 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setUHcrSpiSw51(
