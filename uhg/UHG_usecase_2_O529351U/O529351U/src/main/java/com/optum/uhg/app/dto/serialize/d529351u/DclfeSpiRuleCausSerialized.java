...
/**
 * The class DclfeSpiRuleCausSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class DclfeSpiRuleCausSerialized extends Field {
  ...
  public boolean isCausSpiTblIdModified() {
    ...
    localCausSpiTblIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausSpiTblId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausSpiTblId() {
    return (substring(
        getStringValue(), beginCausSpiTblId, beginCausSpiTblId + CAUS_SPI_TBL_ID_LEN));
  }
  ...
  public boolean isCausStsCdModified() {
    ...
    localCausStsCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCausDerivPlOfSvcCdModified() {
    ...
    localCausDerivPlOfSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCausDerivPlOfSvcCd(char[] causDerivPlOfSvcCd) {
    ...
    arraycopy(
        ...
        0,
        getStringValue(),
        beginCausDerivPlOfSvcCd,
        CAUS_DERIV_PL_OF_SVC_CD_LEN);
  ...
  /**
   * refreshCausDerivPlOfSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausDerivPlOfSvcCd() {
    return (substring(
        getStringValue(),
        beginCausDerivPlOfSvcCd,
        beginCausDerivPlOfSvcCd + CAUS_DERIV_PL_OF_SVC_CD_LEN));
  }
  ...
  public boolean isCausDerivSvcCdModified() {
    ...
    localCausDerivSvcCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausDerivSvcCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausDerivSvcCd() {
    return (substring(
        getStringValue(), beginCausDerivSvcCd, beginCausDerivSvcCd + CAUS_DERIV_SVC_CD_LEN));
  }
  ...
  public boolean isCausDerivCausCdModified() {
    ...
    localCausDerivCausCdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausDerivCausCd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausDerivCausCd() {
    return (substring(
        getStringValue(), beginCausDerivCausCd, beginCausDerivCausCd + CAUS_DERIV_CAUS_CD_LEN));
  }
  ...
  public boolean isCausCreatDttmModified() {
    ...
    localCausCreatDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausCreatDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausCreatDttm() {
    return (substring(
        getStringValue(), beginCausCreatDttm, beginCausCreatDttm + CAUS_CREAT_DTTM_LEN));
  }
  ...
  public boolean isCausClmCaus1CdModified() {
    ...
    localCausClmCaus1CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus1Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus1Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus1Cd, beginCausClmCaus1Cd + CAUS_CLM_CAUS_1_CD_LEN));
  }
  ...
  public boolean isCausClmCaus2CdModified() {
    ...
    localCausClmCaus2CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus2Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus2Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus2Cd, beginCausClmCaus2Cd + CAUS_CLM_CAUS_2_CD_LEN));
  }
  ...
  public boolean isCausClmCaus3CdModified() {
    ...
    localCausClmCaus3CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus3Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus3Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus3Cd, beginCausClmCaus3Cd + CAUS_CLM_CAUS_3_CD_LEN));
  }
  ...
  public boolean isCausClmCaus4CdModified() {
    ...
    localCausClmCaus4CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus4Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus4Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus4Cd, beginCausClmCaus4Cd + CAUS_CLM_CAUS_4_CD_LEN));
  }
  ...
  public boolean isCausClmCaus5CdModified() {
    ...
    localCausClmCaus5CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus5Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus5Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus5Cd, beginCausClmCaus5Cd + CAUS_CLM_CAUS_5_CD_LEN));
  }
  ...
  public boolean isCausClmCaus6CdModified() {
    ...
    localCausClmCaus6CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus6Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus6Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus6Cd, beginCausClmCaus6Cd + CAUS_CLM_CAUS_6_CD_LEN));
  }
  ...
  public boolean isCausClmCaus7CdModified() {
    ...
    localCausClmCaus7CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus7Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus7Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus7Cd, beginCausClmCaus7Cd + CAUS_CLM_CAUS_7_CD_LEN));
  }
  ...
  public boolean isCausClmCaus8CdModified() {
    ...
    localCausClmCaus8CdCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausClmCaus8Cd is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausClmCaus8Cd() {
    return (substring(
        getStringValue(), beginCausClmCaus8Cd, beginCausClmCaus8Cd + CAUS_CLM_CAUS_8_CD_LEN));
  }
  ...
  public boolean isCausPgmIdModified() {
    ...
    localCausPgmIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCausLstUpdtDttmModified() {
    ...
    localCausLstUpdtDttmCounter = sharedCounter;
    return hasModified;
  }
  ...
  /**
   * refreshCausLstUpdtDttm is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausLstUpdtDttm() {
    return (substring(
        getStringValue(), beginCausLstUpdtDttm, beginCausLstUpdtDttm + CAUS_LST_UPDT_DTTM_LEN));
  }
  ...
  public boolean isCausLstUpdtUserIdModified() {
    ...
    localCausLstUpdtUserIdCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeCausLstUpdtUserId(char[] causLstUpdtUserId) {
    shareString.getSerializedField().incrementCounter();
    arraycopy(
        causLstUpdtUserId, 0, getStringValue(), beginCausLstUpdtUserId, CAUS_LST_UPDT_USER_ID_LEN);
  ...
  /**
   * refreshCausLstUpdtUserId is used to refresh the latest value of a variable from the Serialized
   * String the most common reason to serialize an Object as a string in to write to a file. There
   * can be several other reasons for serialization as well
   */
  public char[] refreshCausLstUpdtUserId() {
    return (substring(
        getStringValue(),
        beginCausLstUpdtUserId,
        beginCausLstUpdtUserId + CAUS_LST_UPDT_USER_ID_LEN));
  }
}
