...
/**
 * The class SavInputProcIdSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class SavInputProcIdSerialized extends Field {
  ...
  /**
   * sets parent for this SavInputProcIdSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
