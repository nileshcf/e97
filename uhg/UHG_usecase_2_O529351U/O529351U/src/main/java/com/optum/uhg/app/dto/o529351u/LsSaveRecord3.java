...
public class LsSaveRecord3 extends LsSaveRecord3Serialized {
  ...
  /**
   * Update SavRecTyp3Fileaid with the passed value Corresponding COBOL Variable is
   * SAV-REC-TYP3-FILEAID
   *
   * @param value
   */
  ...
  /**
   * Update SavRecTyp3Fileaid with a String from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavRecTyp3Fileaid with a String from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavRecTyp3Fileaid(
  ...
  /**
   * Update SavRecTyp3Fileaid with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update SavRecTyp3Fileaid with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSavRecTyp3Fileaid(
