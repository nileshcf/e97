...
/**
 * The class SavRecTyp3FileaidSerialized is used to define offsets in order to serialize in a fixed
 * String
 *
...
public class SavRecTyp3FileaidSerialized extends Field {
  ...
  /**
   * sets parent for this SavRecTyp3FileaidSerialized to the parent and set the serialize offset to
   * parameter begin
   *
   * @param parent
