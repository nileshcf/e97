...
/**
 * The class CsvcProcSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class CsvcProcSerialized extends Field {
  ...
  public boolean isCsvcP1st5Modified() {
    ...
    localCsvcP1st5Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCsvcPLst1Modified() {
    ...
    localCsvcPLst1Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isCsvcPLst1AModified() {
    ...
    localCsvcPLst1ACounter = sharedCounter;
    return hasModified;
  }
