...
public class DsmEditErrorValueTxt extends DsmEditErrorValueTxtSerialized {
  ...
  /**
   * initializes DsmEditErrorValueTxt String fields defaults to Spaces short/int/long defaults to
   * zero BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setDsmEditErrorValueInt(
        CFUtil.cobolNumberFormatter(CONSTANTS.FORMAT_467480023, "0".toCharArray()));
  }
