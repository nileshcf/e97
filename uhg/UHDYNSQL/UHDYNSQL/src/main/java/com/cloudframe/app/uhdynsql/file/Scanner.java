package com.cloudframe.app.uhdynsql.file;
...
@Component("uhdynsql_scanner")
public class Scanner extends CFFile {


	private Logger logger = LoggerFactory.getLogger(Scanner.class);
	
	@Value("${UHDYNSQL.Scanner:SYSIN}")
	private String fileName;	

	@Value("${UHDYNSQL.ScannerCharSet:cp1047}")
	private String charSet;
	
	@Value("${UHDYNSQL.ScannerCRLFflag:no}")
