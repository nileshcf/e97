...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public Gdghfix336sStep001Sort oldnewStep001Sort() {
    	return new Gdghfix336sStep001Sort();
    }
    
    @Bean
    @JobScope
    protected Step Gdghfix336sStep001Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Gdghfix336sStep001Sort",jobRepository).tasklet(oldnewStep001Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step001Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step001Executor")
             ...
             .to(Gdghfix336sStep001Sort(jobRepository, transactionManager))
