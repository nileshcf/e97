...
@Component("gdgpgm2_sys001MipSpecrtOld")
public class Sys001MipSpecrtOld extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001MipSpecrtOld.class);
	
	@Value("${GDGPGM2.Sys001MipSpecrtOld:SYS001}")
    ...
    **/
	@Value("${GDGPGM2.Sys001MipSpecrtOldCharSet:cp1047}")
	private String charSet;
	
	@Value("${GDGPGM2.Sys001MipSpecrtOldCRLFflag:no}")
	private String crlfFlag;

	public String getSys001MipSpecrtOldCharSet() {
		return charSet;
	}
	
	public String getSys001MipSpecrtOldCrlfFlag() {
		return crlfFlag;
	}

	public Sys001MipSpecrtOld()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001MipSpecrtOld Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
