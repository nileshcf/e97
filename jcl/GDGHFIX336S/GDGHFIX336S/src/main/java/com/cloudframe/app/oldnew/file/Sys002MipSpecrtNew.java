package com.cloudframe.app.oldnew.file;
...
import com.cloudframe.app.oldnew.file.records.*;

@Component("oldnew_sys002MipSpecrtNew")
public class Sys002MipSpecrtNew extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys002MipSpecrtNew.class);
	
	@Value("${OLDNEW.Sys002MipSpecrtNew:SYS002}")
    ...
    **/
	@Value("${OLDNEW.Sys002MipSpecrtNewCharSet:cp1047}")
	private String charSet;
	
	@Value("${OLDNEW.Sys002MipSpecrtNewCRLFflag:no}")
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys002MipSpecrtNew Write: {}",e.getMessage() ); 		}
	}
