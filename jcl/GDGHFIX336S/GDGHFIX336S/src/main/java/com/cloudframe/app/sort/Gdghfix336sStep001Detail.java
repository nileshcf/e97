...
@Component("batch_gdghfix336sstep001")
@JobScope
public class Gdghfix336sStep001Detail {

	private List<Gdghfix336sStep001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Gdghfix336sStep001Keys> sortComp = null;
	 ...
	 */
	public List<Gdghfix336sStep001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Gdghfix336sStep001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Gdghfix336sStep001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Gdghfix336sStep001Keys> sortComp) {
