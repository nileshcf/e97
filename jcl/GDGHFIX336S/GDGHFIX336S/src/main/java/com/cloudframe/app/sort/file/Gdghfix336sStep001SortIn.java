  ...
  @Component("Gdghfix336sStep001SortIn")
  @JobScope
  public class Gdghfix336sStep001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Gdghfix336sStep001SortIn.class);
  	@Value("${Gdghfix336sStep001SortIn:CLOUDFRM.SF.P3GX.PRSF2130.SORT.IN}")
  	...
  	@Value("#{'${Gdghfix336sStep001SortInRecordType:${Gdghfix336sStep001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Gdghfix336sStep001SortInRecordLen:${Gdghfix336sStep001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Gdghfix336sStep001SortIn Read: {}",e.getMessage()); 
  		}
  	}
