package com.cloudframe.app.gdgpgm2.file;
...
import com.cloudframe.app.gdgpgm2.file.records.*;

@Component("gdgpgm2_sys202T0027aFileOut")
public class Sys202T0027aFileOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys202T0027aFileOut.class);
	
	@Value("${GDGPGM2.Sys202T0027aFileOut:SYS202}")
    ...
    **/
	@Value("${GDGPGM2.Sys202T0027aFileOutCharSet:cp1047}")
	private String charSet;
	
	@Value("${GDGPGM2.Sys202T0027aFileOutCRLFflag:no}")
	private String crlfFlag;

	public String getSys202T0027aFileOutCharSet() {
		return charSet;
	}
	
	public String getSys202T0027aFileOutCrlfFlag() {
		return crlfFlag;
	}

	public Sys202T0027aFileOut()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys202T0027aFileOut Write: {}",e.getMessage() ); 		}
	}
