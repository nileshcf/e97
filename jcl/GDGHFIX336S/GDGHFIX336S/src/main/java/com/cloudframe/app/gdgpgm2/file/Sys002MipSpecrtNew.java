...
@Component("gdgpgm2_sys002MipSpecrtNew")
public class Sys002MipSpecrtNew extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys002MipSpecrtNew.class);
	
	@Value("${GDGPGM2.Sys002MipSpecrtNew:SYS002}")
    ...
    **/
	@Value("${GDGPGM2.Sys002MipSpecrtNewCharSet:cp1047}")
	private String charSet;
	
	@Value("${GDGPGM2.Sys002MipSpecrtNewCRLFflag:no}")
	private String crlfFlag;

	public String getSys002MipSpecrtNewCharSet() {
		return charSet;
	}
	
	public String getSys002MipSpecrtNewCrlfFlag() {
		return crlfFlag;
	}

	public Sys002MipSpecrtNew()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys002MipSpecrtNew Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
