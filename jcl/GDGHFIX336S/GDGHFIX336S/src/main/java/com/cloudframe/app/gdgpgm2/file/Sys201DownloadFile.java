...
@Component("gdgpgm2_sys201DownloadFile")
public class Sys201DownloadFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201DownloadFile.class);
	
	@Value("${GDGPGM2.Sys201DownloadFile:SYS201}")
    ...
    **/
	@Value("${GDGPGM2.Sys201DownloadFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${GDGPGM2.Sys201DownloadFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys201DownloadFileCharSet() {
		return charSet;
	}
	
	public String getSys201DownloadFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys201DownloadFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201DownloadFile Write: {}",e.getMessage() ); 		}
	}
