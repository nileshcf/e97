  ...
  @Component("Gdghfix336sStep001SortOut")
  @JobScope
  public class Gdghfix336sStep001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Gdghfix336sStep001SortOut.class);
  	@Value("${Gdghfix336sStep001SortOut:CLOUDFRM.SF.P3GX.PRSF2130.REBATE(+1)}")
      ...
      @Value("#{'${Gdghfix336sStep001SortOutRecordType:${Gdghfix336sStep001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Gdghfix336sStep001SortOutRecordLen:${Gdghfix336sStep001SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Gdghfix336sStep001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
