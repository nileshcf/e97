...
import com.cloudframe.app.sort.Gdghfix336sStep001Detail;
import org.springframework.beans.factory.annotation.Value;
public class Gdghfix336sStep001Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(Gdghfix336sStep001Sort.class);
