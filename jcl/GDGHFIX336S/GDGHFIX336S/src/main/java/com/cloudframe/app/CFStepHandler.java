...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP001 = "step001";
    private static final String STEP002 = "step002";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step001":  /* setting the disp position for file(s) info for this step(STEP001). */
                         SpringContextHandler.setFileDispPosition("Gdghfix336sStep001SortIn","Gdghfix336sStep001SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Gdghfix336sStep001SortOut","Gdghfix336sStep001SortOut.DISP");
            break;
            case "step002":
 		    	   		SpringContextHandler.handleDispPostion("STEP002.IEBGENER.Sysut1","STEP002.IEBGENER.Sysut1.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP002.IEBGENER.Sysut2","STEP002.IEBGENER.Sysut2.DISP");
            break;
            case "step010":  /* setting the appropriate file(s) info for this step(STEP010). */
 		    	   		SpringContextHandler.setFileDispPosition("oldnew_sys001MipSpecrtOld", "OLDNEW.Sys001MipSpecrtOld.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("oldnew_sys002MipSpecrtNew", "OLDNEW.Sys002MipSpecrtNew.DISP");
            break;
            case "step020":  /* setting the appropriate file(s) info for this step(STEP020). */
 		    	   		SpringContextHandler.setFileDispPosition("gdgpgm2_sys001MipSpecrtOld", "GDGPGM2.Sys001MipSpecrtOld.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("gdgpgm2_sys002MipSpecrtNew", "GDGPGM2.Sys002MipSpecrtNew.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : GDGHFIX336S ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : GDGHFIX336S ENDED -  ABEND={}", abendCode);
      } 
