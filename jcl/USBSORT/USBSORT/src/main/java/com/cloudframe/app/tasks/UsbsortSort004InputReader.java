...
public class UsbsortSort004InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(UsbsortSort004InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<UsbsortSort004Keys> sortRecKeys = sortDetail.getSortRecKeys();
		UsbsortSort004Keys relKey = new UsbsortSort004Keys();
