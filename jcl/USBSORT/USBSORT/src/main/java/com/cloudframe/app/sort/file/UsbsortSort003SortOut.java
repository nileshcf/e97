  ...
  @Component("UsbsortSort003SortOut")
  @JobScope
  public class UsbsortSort003SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbsortSort003SortOut.class);
  	@Value("${UsbsortSort003SortOut:CLOUDFRM.USB.SORT.OUT003}")
      ...
      @Value("#{'${UsbsortSort003SortOutRecordType:${UsbsortSort003SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbsortSort003SortOutRecordLen:${UsbsortSort003SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbsortSort003SortOut Write: {}",e.getMessage()); 		
  		}
  	}
