  ...
  @Component("UsbsortSort004SortOut")
  @JobScope
  public class UsbsortSort004SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbsortSort004SortOut.class);
  	@Value("${UsbsortSort004SortOut:CLOUDFRM.VLSCMP.SORT.OUT34}")
      ...
      @Value("#{'${UsbsortSort004SortOutRecordType:${UsbsortSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbsortSort004SortOutRecordLen:${UsbsortSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbsortSort004SortOut Write: {}",e.getMessage()); 		
  		}
  	}
