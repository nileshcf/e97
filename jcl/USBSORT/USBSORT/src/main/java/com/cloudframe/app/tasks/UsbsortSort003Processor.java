...
public class UsbsortSort003Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(UsbsortSort003Processor.class);
