  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort002":  /* setting the disp position for file(s) info for this step(SORT002). */
                         SpringContextHandler.setFileDispPosition("UsbsortSort002SortIn","UsbsortSort002SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("UsbsortSort002SortOut","UsbsortSort002SortOut.DISP");
            break;
            case "sort003":  /* setting the disp position for file(s) info for this step(SORT003). */
                         SpringContextHandler.setFileDispPosition("UsbsortSort003SortIn","UsbsortSort003SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("UsbsortSort003SortOut","UsbsortSort003SortOut.DISP");
            break;
            case "sort004":  /* setting the disp position for file(s) info for this step(SORT004). */
                         SpringContextHandler.setFileDispPosition("UsbsortSort004SortIn","UsbsortSort004SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("UsbsortSort004SortOut","UsbsortSort004SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : USBSORT ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : USBSORT ENDED -  ABEND={}", abendCode);
      } 
