  ...
  @Component("UsbsortSort003SortIn")
  @JobScope
  public class UsbsortSort003SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbsortSort003SortIn.class);
  	@Value("${UsbsortSort003SortIn:CLOUDFRM.USB.SORT.IN003}")
  	...
  	@Value("#{'${UsbsortSort003SortInRecordType:${UsbsortSort003SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${UsbsortSort003SortInRecordLen:${UsbsortSort003SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during UsbsortSort003SortIn Read: {}",e.getMessage()); 
  		}
  	}
