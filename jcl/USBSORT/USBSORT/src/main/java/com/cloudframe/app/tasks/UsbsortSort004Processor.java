...
public class UsbsortSort004Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(UsbsortSort004Processor.class);
