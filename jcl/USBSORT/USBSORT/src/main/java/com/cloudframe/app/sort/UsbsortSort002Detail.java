...
@Component("batch_usbsortsort002")
@JobScope
public class UsbsortSort002Detail {

	private List<UsbsortSort002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbsortSort002Keys> sortComp = null;
	 ...
	 */
	public List<UsbsortSort002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbsortSort002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbsortSort002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbsortSort002Keys> sortComp) {
