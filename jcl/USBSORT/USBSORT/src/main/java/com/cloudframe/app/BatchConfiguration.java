...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public UsbsortSort002Sort usbsortSort002Sort() {
    	return new UsbsortSort002Sort();
    }
    
    @Bean
    @JobScope
    protected Step UsbsortSort002Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("UsbsortSort002Sort",jobRepository).tasklet(usbsortSort002Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort002Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort002Executor")
             ...
             .to(UsbsortSort002Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public UsbsortSort003Sort usbsortSort003Sort() {
    	return new UsbsortSort003Sort();
    }
    
    @Bean
    @JobScope
    protected Step UsbsortSort003Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("UsbsortSort003Sort",jobRepository).tasklet(usbsortSort003Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort003Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort003Executor")
             ...
             .to(UsbsortSort003Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public UsbsortSort004Sort usbsortSort004Sort() {
    	return new UsbsortSort004Sort();
    }
    
    @Bean
    @JobScope
    protected Step UsbsortSort004Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("UsbsortSort004Sort",jobRepository).tasklet(usbsortSort004Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort004Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort004Executor")
             ...
             .to(UsbsortSort004Sort(jobRepository, transactionManager))
