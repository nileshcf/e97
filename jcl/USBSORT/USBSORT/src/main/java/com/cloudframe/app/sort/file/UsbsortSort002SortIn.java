  ...
  @Component("UsbsortSort002SortIn")
  @JobScope
  public class UsbsortSort002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbsortSort002SortIn.class);
  	@Value("${UsbsortSort002SortIn:CLOUDFRM.EPAM.SORT.IN002}")
  	...
  	@Value("#{'${UsbsortSort002SortInRecordType:${UsbsortSort002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${UsbsortSort002SortInRecordLen:${UsbsortSort002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during UsbsortSort002SortIn Read: {}",e.getMessage()); 
  		}
  	}
