...
public class UsbsortSort004OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(UsbsortSort004OutputWriter.class);
	@Autowired
	...
	List<UsbsortSort004Keys> sortRecKeys = null;
...
logger.info("STEPNAME: USBSORTSORT004 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	private byte[] getSortedRecord(int index) {
		try {
			UsbsortSort004Keys k = sortRecKeys.get(index);
