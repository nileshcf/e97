...
import com.cloudframe.app.sort.file.records.UsbsortSort004Keys;
import com.cloudframe.app.data.Field;

@Component("batch_usbsortsort004")
@JobScope
public class UsbsortSort004Detail {

	private List<UsbsortSort004Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbsortSort004Keys> sortComp = null;
	 ...
	 */
	public List<UsbsortSort004Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbsortSort004Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbsortSort004Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbsortSort004Keys> sortComp) {
