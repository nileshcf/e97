  ...
  @Component("UsbsortSort002SortOut")
  @JobScope
  public class UsbsortSort002SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbsortSort002SortOut.class);
  	@Value("${UsbsortSort002SortOut:CLOUDFRM.EPAM.SORT.OUT002}")
      ...
      @Value("#{'${UsbsortSort002SortOutRecordType:${UsbsortSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbsortSort002SortOutRecordLen:${UsbsortSort002SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 29;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbsortSort002SortOut Write: {}",e.getMessage()); 		
  		}
  	}
