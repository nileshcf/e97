...
@Component("batch_usbsortsort003")
@JobScope
public class UsbsortSort003Detail {

	private List<UsbsortSort003Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbsortSort003Keys> sortComp = null;
	 ...
	 */
	public List<UsbsortSort003Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbsortSort003Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbsortSort003Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbsortSort003Keys> sortComp) {
