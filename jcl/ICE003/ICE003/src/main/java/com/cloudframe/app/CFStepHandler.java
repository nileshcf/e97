...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String P050_01 = "p050_01";
    private static final String P050_02 = "p050_02";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "p050_01":  /* setting the disp position for file(s) info for this step(P050_01). */
                         SpringContextHandler.setFileDispPosition("Ice003P050_01SortIn","Ice003P050_01SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Ice003P050_01SortOut","Ice003P050_01SortOut.DISP");
            break;
            case "p050_02":  /* setting the disp position for file(s) info for this step(P050_02). */
                         SpringContextHandler.setFileDispPosition("Ice003P050_02SortIn","Ice003P050_02SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Ice003P050_02SortOut","Ice003P050_02SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : ICE003 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : ICE003 ENDED -  ABEND={}", abendCode);
      } 
