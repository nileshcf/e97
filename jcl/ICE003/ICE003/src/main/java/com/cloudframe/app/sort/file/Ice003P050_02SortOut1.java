  ...
  @Component("Ice003P050_02SortOut1")
  @JobScope
  public class Ice003P050_02SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice003P050_02SortOut1.class);
  	@Value("${Ice003P050_02SortOut[1]:P050.ICE003.SYSOUT}")
      ...
      @Value("#{'${Ice003P050_02SortOut1RecordType:${Ice003P050_02SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice003P050_02SortOut1RecordLen:${Ice003P050_02SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice003P050_02SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
