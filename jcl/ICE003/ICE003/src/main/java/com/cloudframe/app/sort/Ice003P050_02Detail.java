...
@Component("batch_ice003p050_02")
@JobScope
public class Ice003P050_02Detail {

	private List<Ice003P050_02Keys> sortRecKeys = null;
	private List<Ice003P050_02Keys> xSumRecKeys = null;	
	private Set<Ice003P050_02Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice003P050_02Keys> sortComp = null;
	 ...
	 */
	public List<Ice003P050_02Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice003P050_02Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<Ice003P050_02Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<Ice003P050_02Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<Ice003P050_02Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice003P050_02Keys> sortComp) {
	...
	public List<Ice003P050_02Keys> getxSumRecKeys() {
	  return xSumRecKeys;
    }
	
	public void setxSumRecKeys(List<Ice003P050_02Keys> xSumRecKeys) {
		this.xSumRecKeys = xSumRecKeys;
	}
