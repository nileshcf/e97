  ...
  @Component("Ice003P050_02SortIn")
  @JobScope
  public class Ice003P050_02SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice003P050_02SortIn.class);
  	@Value("${Ice003P050_02SortIn:Y900.P.TM.WRK.SORT2(+1)}")
  	...
  	@Value("#{'${Ice003P050_02SortInRecordType:${Ice003P050_02SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice003P050_02SortInRecordLen:${Ice003P050_02SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice003P050_02SortIn Read: {}",e.getMessage()); 
  		}
  	}
