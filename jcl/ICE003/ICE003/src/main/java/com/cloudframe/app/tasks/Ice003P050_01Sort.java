...
import java.io.File;
import com.cloudframe.app.sort.file.Ice003P050_01SortIn;
import com.cloudframe.app.sort.file.Ice003P050_01SortOut;
...
public class Ice003P050_01Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice003P050_01Sort.class);
	@Autowired
	...
	@Autowired
	@Qualifier("Ice003P050_01SortOut")
	Ice003P050_01SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice003P050_01SortIn")
	Ice003P050_01SortIn sortIn;
	...
	List<Ice003P050_01Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p050_01");
...
logger.info("STEPNAME: ICE003P050_01 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Ice003P050_01Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		...
		Ice003P050_01Keys relKey = new Ice003P050_01Keys();
