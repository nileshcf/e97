...
public class BatchConfiguration {
   ...
   private static final String ICETOOL = "ICETOOL";
    ...
    @Bean
    @JobScope
    public Ice003P050_01InputReader ice003P050_01InputReader() {
    	return new Ice003P050_01InputReader();
    }
    
    @Bean
    @JobScope
    public Ice003P050_01Processor ice003P050_01Processor() {
    	return new Ice003P050_01Processor();
    }
    
    @Bean
    @JobScope
    public Ice003P050_01OutputWriter ice003P050_01OutputWriter() {
    	return new Ice003P050_01OutputWriter();
    }
    
    @Bean
    @JobScope
    protected Step readIce003P050_01SortInput(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("readIce003P050_01SortInput",jobRepository).tasklet(ice003P050_01InputReader(), transactionManager).build();  
    }
    
    @Bean
    @JobScope
    protected Step processIce003P050_01Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("sortIce003P050_01Process",jobRepository).tasklet(ice003P050_01Processor(), transactionManager).build();  
    }
    
    @Bean
    @JobScope
    protected Step writeIce003P050_01SortOutput(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("writeIce003P050_01SortOutput",jobRepository).tasklet(ice003P050_01OutputWriter(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow p050_01Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("p050_01Executor")
             ...
             .to(readIce003P050_01SortInput(jobRepository, transactionManager))
             .next(processIce003P050_01Sort(jobRepository, transactionManager))
             .next(writeIce003P050_01SortOutput(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Ice003P050_02InputReader ice003P050_02InputReader() {
    	return new Ice003P050_02InputReader();
    }
    
    @Bean
    @JobScope
    public Ice003P050_02Processor ice003P050_02Processor() {
    	return new Ice003P050_02Processor();
    }
    
    @Bean
    @JobScope
    public Ice003P050_02OutputWriter ice003P050_02OutputWriter() {
    	return new Ice003P050_02OutputWriter();
    }
    
    @Bean
    @JobScope
    protected Step readIce003P050_02SortInput(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("readIce003P050_02SortInput",jobRepository).tasklet(ice003P050_02InputReader(), transactionManager).build();  
    }
    
    @Bean
    @JobScope
    protected Step processIce003P050_02Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("sortIce003P050_02Process",jobRepository).tasklet(ice003P050_02Processor(), transactionManager).build();  
    }
    
    @Bean
    @JobScope
    protected Step writeIce003P050_02SortOutput(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("writeIce003P050_02SortOutput",jobRepository).tasklet(ice003P050_02OutputWriter(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow p050_02Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("p050_02Executor")
             ...
             .to(readIce003P050_02SortInput(jobRepository, transactionManager))
             .next(processIce003P050_02Sort(jobRepository, transactionManager))
             .next(writeIce003P050_02SortOutput(jobRepository, transactionManager))
