  ...
  @Component("Ice003P050_01SortIn")
  @JobScope
  public class Ice003P050_01SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice003P050_01SortIn.class);
  	@Value("${Ice003P050_01SortIn:Y900.P.TM.WRK.EXTRACT(+0)}")
  	...
  	@Value("#{'${Ice003P050_01SortInRecordType:${Ice003P050_01SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice003P050_01SortInRecordLen:${Ice003P050_01SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice003P050_01SortIn Read: {}",e.getMessage()); 
  		}
  	}
