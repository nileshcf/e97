...
@Component("batch_ice003p050_01")
@JobScope
public class Ice003P050_01Detail {

	private List<Ice003P050_01Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice003P050_01Keys> sortComp = null;
	 ...
	 */
	public List<Ice003P050_01Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice003P050_01Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice003P050_01Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice003P050_01Keys> sortComp) {
