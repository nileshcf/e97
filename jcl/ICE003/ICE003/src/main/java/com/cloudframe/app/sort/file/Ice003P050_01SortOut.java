  ...
  @Component("Ice003P050_01SortOut")
  @JobScope
  public class Ice003P050_01SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice003P050_01SortOut.class);
  	@Value("${Ice003P050_01SortOut:Y900.P.TM.WRK.SORT2(+1)}")
      ...
      @Value("#{'${Ice003P050_01SortOutRecordType:${Ice003P050_01SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice003P050_01SortOutRecordLen:${Ice003P050_01SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice003P050_01SortOut Write: {}",e.getMessage()); 		
  		}
  	}
