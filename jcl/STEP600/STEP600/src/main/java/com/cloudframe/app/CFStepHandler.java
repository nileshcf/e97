...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP0600 = "step0600";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step0600":  /* setting the disp position for file(s) info for this step(STEP0600). */
                         SpringContextHandler.setFileDispPosition("Step600Step0600SortIn0","Step600Step0600SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Step600Step0600SortIn1","Step600Step0600SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Step600Step0600SortOut","Step600Step0600SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : STEP600 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : STEP600 ENDED -  ABEND={}", abendCode);
      } 
