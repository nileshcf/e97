...
import com.cloudframe.app.sort.file.records.Step600Step0600JoinKeys;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.data.Field;

@Component("batch_step600step0600")
@JobScope
public class Step600Step0600Detail {

	private List<Step600Step0600Keys> sortRecKeys = null;
	private List<Step600Step0600JoinKeys> joinRecKey1 = null;
	private List<Step600Step0600JoinKeys> joinRecKey2 = null;
	private Comparator<Step600Step0600JoinKeys> joinkeyComp = null;
	...
	private Comparator<Step600Step0600Keys> sortComp = null;
	 ...
	 */
	public List<Step600Step0600JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<Step600Step0600JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<Step600Step0600JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<Step600Step0600JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<Step600Step0600JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<Step600Step0600JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<Step600Step0600Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Step600Step0600Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Step600Step0600Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Step600Step0600Keys> sortComp) {
