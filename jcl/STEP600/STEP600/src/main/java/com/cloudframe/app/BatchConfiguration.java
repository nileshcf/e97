...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public Step600Step0600Sort step600Step0600Sort() {
    	return new Step600Step0600Sort();
    }
    
    @Bean
    @JobScope
    protected Step Step600Step0600Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Step600Step0600Sort",jobRepository).tasklet(step600Step0600Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step0600Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step0600Executor")
             ...
             .to(Step600Step0600Sort(jobRepository, transactionManager))
