  ...
  @Component("Step600Step0600SortOut")
  @JobScope
  public class Step600Step0600SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Step600Step0600SortOut.class);
  	@Value("${Step600Step0600SortOut:FILE1.DTLFILE.MOCK.OUTPUT1}")
      ...
      @Value("#{'${Step600Step0600SortOutRecordType:${Step600Step0600SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Step600Step0600SortOutRecordLen:${Step600Step0600SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Step600Step0600SortOut Write: {}",e.getMessage()); 		
  		}
  	}
