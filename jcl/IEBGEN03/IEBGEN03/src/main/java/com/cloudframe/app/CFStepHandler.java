...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step003":
 		    	   		SpringContextHandler.handleDispPostion("STEP003.IEBGENER.Sysut1","STEP003.IEBGENER.Sysut1.DISP");
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : IEBGEN03 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : IEBGEN03 ENDED -  ABEND={}", abendCode);
      } 
