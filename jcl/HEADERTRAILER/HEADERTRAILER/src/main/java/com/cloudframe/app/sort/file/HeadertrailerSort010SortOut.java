  ...
  @Component("HeadertrailerSort010SortOut")
  @JobScope
  public class HeadertrailerSort010SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(HeadertrailerSort010SortOut.class);
  	@Value("${HeadertrailerSort010SortOut:CLOUDFRM.MC.GCMS.SORT.OUT}")
      ...
      @Value("#{'${HeadertrailerSort010SortOutRecordType:${HeadertrailerSort010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${HeadertrailerSort010SortOutRecordLen:${HeadertrailerSort010SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 5000;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during HeadertrailerSort010SortOut Write: {}",e.getMessage()); 		
  		}
  	}
