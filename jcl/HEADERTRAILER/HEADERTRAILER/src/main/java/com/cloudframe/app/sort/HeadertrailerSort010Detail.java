...
@Component("batch_headertrailersort010")
@JobScope
public class HeadertrailerSort010Detail {

	private List<HeadertrailerSort010Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<HeadertrailerSort010Keys> sortComp = null;
	 ...
	 */
	public List<HeadertrailerSort010Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<HeadertrailerSort010Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<HeadertrailerSort010Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<HeadertrailerSort010Keys> sortComp) {
