...
public class HeadertrailerSort010InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(HeadertrailerSort010InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<HeadertrailerSort010Keys> sortRecKeys = sortDetail.getSortRecKeys();
		HeadertrailerSort010Keys relKey = new HeadertrailerSort010Keys();
