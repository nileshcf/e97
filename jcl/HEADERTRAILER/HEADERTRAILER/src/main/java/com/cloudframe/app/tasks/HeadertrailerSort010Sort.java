...
import com.cloudframe.app.sort.HeadertrailerSort010Detail;
import org.springframework.beans.factory.annotation.Value;
public class HeadertrailerSort010Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(HeadertrailerSort010Sort.class);
