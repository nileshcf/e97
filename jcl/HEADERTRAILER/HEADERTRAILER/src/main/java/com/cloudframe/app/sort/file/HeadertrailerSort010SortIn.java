  ...
  @Component("HeadertrailerSort010SortIn")
  @JobScope
  public class HeadertrailerSort010SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(HeadertrailerSort010SortIn.class);
  	@Value("${HeadertrailerSort010SortIn:CLOUDFRM.MC.GCMS.SORT.IN}")
  	...
  	@Value("#{'${HeadertrailerSort010SortInRecordType:${HeadertrailerSort010SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${HeadertrailerSort010SortInRecordLen:${HeadertrailerSort010SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during HeadertrailerSort010SortIn Read: {}",e.getMessage()); 
  		}
  	}
