  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort010":  /* setting the disp position for file(s) info for this step(SORT010). */
                         SpringContextHandler.setFileDispPosition("HeadertrailerSort010SortIn","HeadertrailerSort010SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("HeadertrailerSort010SortOut","HeadertrailerSort010SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : HEADERTRAILER ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : HEADERTRAILER ENDED -  ABEND={}", abendCode);
      } 
