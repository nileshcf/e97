...
public class HeadertrailerSort010Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(HeadertrailerSort010Processor.class);
