  ...
  @Component("Sup1447Step015SortOut")
  @JobScope
  public class Sup1447Step015SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sup1447Step015SortOut.class);
  	@Value("${Sup1447Step015SortOut:STEP015.SUP1447.SYSOUT}")
      ...
      @Value("#{'${Sup1447Step015SortOutRecordType:${Sup1447Step015SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sup1447Step015SortOutRecordLen:${Sup1447Step015SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sup1447Step015SortOut Write: {}",e.getMessage()); 		
  		}
  	}
