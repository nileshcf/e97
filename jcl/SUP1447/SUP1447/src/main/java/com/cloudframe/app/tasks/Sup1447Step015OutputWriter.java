...
import com.cloudframe.app.sort.file.Sup1447Step015SortOut;
...
public class Sup1447Step015OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Sup1447Step015OutputWriter.class);
	@Autowired
	...
	@Autowired
	@Qualifier("Sup1447Step015SortOut")
	Sup1447Step015SortOut sortOut;
	...
	List<Sup1447Step015Keys> sortRecKeys = null;
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("step015");
		return RepeatStatus.FINISHED;
	}

	@Override
	public ExitStatus afterStep(StepExecution stepExecution) {
logger.info("STEPNAME: SUP1447STEP015 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Sup1447Step015Keys k = sortRecKeys.get(index);
           if (isWriteInTempFile()) {
