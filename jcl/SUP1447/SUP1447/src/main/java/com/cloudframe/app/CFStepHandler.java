...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP015 = "step015";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step015":  /* setting the disp position for file(s) info for this step(STEP015). */
                         SpringContextHandler.setFileDispPosition("Sup1447Step015SortIn0","Sup1447Step015SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sup1447Step015SortIn1","Sup1447Step015SortIn[1].DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SUP1447 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SUP1447 ENDED -  ABEND={}", abendCode);
      } 
