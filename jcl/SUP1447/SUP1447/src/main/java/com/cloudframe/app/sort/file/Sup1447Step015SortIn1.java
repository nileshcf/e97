  ...
  @Component("Sup1447Step015SortIn1")
  @JobScope
  public class Sup1447Step015SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sup1447Step015SortIn1.class);
  	@Value("${Sup1447Step015SortIn[1]:DTF.SI.P2BX.BULK.TYPES.TRNSPRT.UNMATCH}")
  	...
  	@Value("#{'${Sup1447Step015SortIn1RecordType:${Sup1447Step015SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sup1447Step015SortIn1RecordLen:${Sup1447Step015SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sup1447Step015SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
