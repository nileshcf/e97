...
import com.cloudframe.app.sort.Sup1447Step015Detail;
import org.springframework.beans.factory.annotation.Value;
public class Sup1447Step015Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(Sup1447Step015Sort.class);
