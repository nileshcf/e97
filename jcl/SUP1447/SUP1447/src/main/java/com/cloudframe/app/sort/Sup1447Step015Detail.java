...
@Component("batch_sup1447step015")
@JobScope
public class Sup1447Step015Detail {

	private List<Sup1447Step015Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Sup1447Step015Keys> sortComp = null;
	 ...
	 */
	public List<Sup1447Step015Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Sup1447Step015Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Sup1447Step015Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Sup1447Step015Keys> sortComp) {
