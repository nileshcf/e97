  ...
  @Component("Sup1447Step015SortIn0")
  @JobScope
  public class Sup1447Step015SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sup1447Step015SortIn0.class);
  	@Value("${Sup1447Step015SortIn[0]:DTF.SI.P2BX.BULK.TYPES.TRNSPRT.MATCH}")
  	...
  	@Value("#{'${Sup1447Step015SortIn0RecordType:${Sup1447Step015SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sup1447Step015SortIn0RecordLen:${Sup1447Step015SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sup1447Step015SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
