  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step001":  /* setting the disp position for file(s) info for this step(STEP001). */
                         SpringContextHandler.setFileDispPosition("Gdghfix336Step001SortIn","Gdghfix336Step001SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Gdghfix336Step001SortOut","Gdghfix336Step001SortOut.DISP");
            break;
            case "step002":
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : GDGHFIX336 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : GDGHFIX336 ENDED -  ABEND={}", abendCode);
      } 
