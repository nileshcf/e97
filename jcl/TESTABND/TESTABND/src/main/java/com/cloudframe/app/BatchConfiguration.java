...
public class BatchConfiguration {
    ...
    public Step step1(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Retcode2)cfStepHandler.initAndGetProcessBean(STEP1_STEP,RETCODE2_BEAN)).setParameter(new GlobalExecutorCtx().getContext("RETCODE2"), cfStepHandler.getParm(step1Retcode2Parm));
...
cfStepHandler.setAbendCode(cfe);
    ...
    public Step abend1(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Cfabcall)cfStepHandler.initAndGetProcessBean(ABEND1_STEP,CFABCALL_BEAN)).setParameter(new GlobalExecutorCtx().getContext("CFABCALL"), cfStepHandler.getParm(abend1CfabcallParm));
 } catch (CFException cfe) { 
 if (cfe.isTerminated()) {
 rc = cfe.getCode();
  } else {
...
cfStepHandler.setAbendCode(cfe);
    ...
    public Step step2(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Retcode2)cfStepHandler.initAndGetProcessBean(STEP2_STEP,RETCODE2_BEAN)).setParameter(new GlobalExecutorCtx().getContext("RETCODE2"), cfStepHandler.getParm(step2Retcode2Parm));
 } catch (CFException cfe) { 
 if (cfe.isTerminated()) {
 rc = cfe.getCode();
  } else {
...
cfStepHandler.setAbendCode(cfe);
    ...
    public Step step3(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Retcode2)cfStepHandler.initAndGetProcessBean(STEP3_STEP,RETCODE2_BEAN)).setParameter(new GlobalExecutorCtx().getContext("RETCODE2"), cfStepHandler.getParm(step3Retcode2Parm));
 } catch (CFException cfe) { 
 if (cfe.isTerminated()) {
 rc = cfe.getCode();
  } else {
...
cfStepHandler.setAbendCode(cfe);
    ...
    public Step step4095(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Retcode2)cfStepHandler.initAndGetProcessBean(STEP4095_STEP,RETCODE2_BEAN)).setParameter(new GlobalExecutorCtx().getContext("RETCODE2"), cfStepHandler.getParm(step4095Retcode2Parm));
 } catch (CFException cfe) { 
 if (cfe.isTerminated()) {
 rc = cfe.getCode();
  } else {
...
cfStepHandler.setAbendCode(cfe);
    ...
    public Step step8(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Retcode2)cfStepHandler.initAndGetProcessBean(STEP8_STEP,RETCODE2_BEAN)).setParameter(new GlobalExecutorCtx().getContext("RETCODE2"), cfStepHandler.getParm(step8Retcode2Parm));
 } catch (CFException cfe) { 
 if (cfe.isTerminated()) {
 rc = cfe.getCode();
  } else {
