...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String ABEND1 = "abend1";
    private static final String STEP2 = "step2";
    private static final String STEP3 = "step3";
    private static final String STEP4095 = "step4095";
...
*/
    public boolean stepDecider(String stepName) {
	      ...
	      switch (stepName) {
	          ...
	          break;
	          case STEP2:
	              canExecute = abendList.isEmpty() && deciderForStep2();
	          break;
	          case STEP3:
	              canExecute = deciderForStep3();
	          break;
	          case STEP4095:
	              canExecute = abendList.isEmpty() && deciderForStep4095();
	          break;
	          case STEP4:
	              canExecute = abendList.isEmpty() && deciderForStep4();
	          break;
	          case STEP5:
	              canExecute = abendList.isEmpty() && deciderForStep5();
	          break;
	          case STEP6:
	              canExecute = abendList.isEmpty() && deciderForStep6();
	          break;
	          case STEP8:
	              canExecute = deciderForStep8();
	          break;
	          default:
	              canExecute = false;
	          break;
...
return canExecute;
    ...
    private boolean deciderForStep2() {
        return ( CFUtil.validateStepRc(stepMap, STEP1, 01, Cond.EQ) ) /*COND CODE*/ ;
    }
    
    private boolean deciderForStep3() {
        return true  /*COND CODE*/ ;
    }
    
    private boolean deciderForStep4095() {
        return (( CFUtil.validateStepRc(stepMap, STEP1, 01, Cond.EQ) ) && ( CFUtil.validateStepRc(stepMap, STEP2, 02, Cond.EQ) )) /*COND CODE*/ ;
    }
    
    private boolean deciderForStep4() {
        return ( CFUtil.validateStepRc(stepMap, STEP1, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, ABEND1, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP2, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP3, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP4095, 03, Cond.LE) ) /*COND CODE*/ ;
    }
    
    private boolean deciderForStep5() {
        return ( CFUtil.validateStepRc(stepMap, STEP1, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, ABEND1, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP2, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP3, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP4095, 03, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP4, 03, Cond.LE) ) /*COND CODE*/ ;
    }
    
    private boolean deciderForStep6() {
        return ( CFUtil.validateStepRc(stepMap, STEP1, 05, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, ABEND1, 05, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP2, 05, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP3, 05, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP4095, 05, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP4, 05, Cond.LE)  &&  CFUtil.validateStepRc(stepMap, STEP5, 05, Cond.LE) ) /*COND CODE*/ ;
    }
    
    private boolean deciderForStep8() {
        return (abendList.contains("step1") || abendList.contains("abend1") || abendList.contains("step2") || abendList.contains("step3") || abendList.contains("step4095") || abendList.contains("step4") || abendList.contains("step5") || abendList.contains("step6") || abendList.contains("step7")) /*COND CODE*/ ;
    }
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : TESTABND ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : TESTABND ENDED -  ABEND={}", abendCode);
      } 
