  ...
  @Component("Icet020MergeSortOut")
  @JobScope
  public class Icet020MergeSortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Icet020MergeSortOut.class);
  	@Value("${Icet020MergeSortOut:CLOUDFRM.MC.SORT.OUT020}")
      ...
      @Value("#{'${Icet020MergeSortOutRecordType:${Icet020MergeSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Icet020MergeSortOutRecordLen:${Icet020MergeSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Icet020MergeSortOut Write: {}",e.getMessage()); 		
  		}
  	}
