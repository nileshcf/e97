...
@Component("batch_icet020merge")
@JobScope
public class Icet020MergeDetail {

	private List<Icet020MergeKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Icet020MergeKeys> sortComp = null;
	 ...
	 */
	public List<Icet020MergeKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Icet020MergeKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Icet020MergeKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Icet020MergeKeys> sortComp) {
