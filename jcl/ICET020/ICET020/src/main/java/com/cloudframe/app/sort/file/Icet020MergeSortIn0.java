  ...
  @Component("Icet020MergeSortIn0")
  @JobScope
  public class Icet020MergeSortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Icet020MergeSortIn0.class);
  	@Value("${Icet020MergeSortIn[0]:CLOUDFRM.MC.SORT.IN0201}")
  	...
  	@Value("#{'${Icet020MergeSortIn0RecordType:${Icet020MergeSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Icet020MergeSortIn0RecordLen:${Icet020MergeSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Icet020MergeSortIn0 Read: {}",e.getMessage()); 
  		}
  	}
