...
public class Icet020MergeProcessor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Icet020MergeProcessor.class);
