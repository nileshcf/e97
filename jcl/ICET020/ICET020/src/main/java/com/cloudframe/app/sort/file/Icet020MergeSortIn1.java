  ...
  @Component("Icet020MergeSortIn1")
  @JobScope
  public class Icet020MergeSortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Icet020MergeSortIn1.class);
  	@Value("${Icet020MergeSortIn[1]:CLOUDFRM.MC.SORT.IN0202}")
  	...
  	@Value("#{'${Icet020MergeSortIn1RecordType:${Icet020MergeSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Icet020MergeSortIn1RecordLen:${Icet020MergeSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Icet020MergeSortIn1 Read: {}",e.getMessage()); 
  		}
  	}
