...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "merge":  /* setting the disp position for file(s) info for this step(MERGE). */
                         SpringContextHandler.setFileDispPosition("Icet020MergeSortIn0","Icet020MergeSortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Icet020MergeSortIn1","Icet020MergeSortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Icet020MergeSortIn2","Icet020MergeSortIn[2].DISP");
                         SpringContextHandler.setFileDispPosition("Icet020MergeSortOut","Icet020MergeSortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : ICET020 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : ICET020 ENDED -  ABEND={}", abendCode);
      } 
