...
public class BatchConfiguration {
   ...
   private static final String ICETOOL = "ICETOOL";
    ...
    @Bean
    @JobScope
    public Icet020MergeSort icet020MergeSort() {
    	return new Icet020MergeSort();
    }
    
    @Bean
    @JobScope
    protected Step Icet020MergeSort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Icet020MergeSort",jobRepository).tasklet(icet020MergeSort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mergeExecutor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mergeExecutor")
             ...
             .to(Icet020MergeSort(jobRepository, transactionManager))
