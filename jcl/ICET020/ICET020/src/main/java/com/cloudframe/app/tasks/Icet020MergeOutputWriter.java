...
public class Icet020MergeOutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Icet020MergeOutputWriter.class);
	@Autowired
