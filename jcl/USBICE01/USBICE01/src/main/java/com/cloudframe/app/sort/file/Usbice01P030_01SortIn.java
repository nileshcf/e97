  ...
  @Component("Usbice01P030_01SortIn")
  @JobScope
  public class Usbice01P030_01SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Usbice01P030_01SortIn.class);
  	@Value("${Usbice01P030_01SortIn:CLOUDFRM.USB.NCR.DSNAMES}")
  	...
  	@Value("#{'${Usbice01P030_01SortInRecordType:${Usbice01P030_01SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Usbice01P030_01SortInRecordLen:${Usbice01P030_01SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Usbice01P030_01SortIn Read: {}",e.getMessage()); 
  		}
  	}
