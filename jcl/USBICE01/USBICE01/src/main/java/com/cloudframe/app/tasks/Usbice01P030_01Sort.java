...
import com.cloudframe.app.sort.Usbice01P030_01Detail;
import org.springframework.beans.factory.annotation.Value;
public class Usbice01P030_01Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(Usbice01P030_01Sort.class);
