...
public class BatchConfiguration {
   ...
   private static final String ICETOOL = "ICETOOL";
    ...
    @Bean
    @JobScope
    public Usbice01P030_01Sort usbice01P030_01Sort() {
    	return new Usbice01P030_01Sort();
    }
    
    @Bean
    @JobScope
    protected Step Usbice01P030_01Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Usbice01P030_01Sort",jobRepository).tasklet(usbice01P030_01Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow p030_01Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("p030_01Executor")
             ...
             .to(Usbice01P030_01Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Usbice01P030_02Sort usbice01P030_02Sort() {
    	return new Usbice01P030_02Sort();
    }
    
    @Bean
    @JobScope
    protected Step Usbice01P030_02Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Usbice01P030_02Sort",jobRepository).tasklet(usbice01P030_02Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow p030_02Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("p030_02Executor")
             ...
             .to(Usbice01P030_02Sort(jobRepository, transactionManager))
