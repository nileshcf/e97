  ...
  @Component("Usbice01P030_02SortIn")
  @JobScope
  public class Usbice01P030_02SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Usbice01P030_02SortIn.class);
  	@Value("${Usbice01P030_02SortIn:CLOUDFRM.USB.NCR.NONVSAM}")
  	...
  	@Value("#{'${Usbice01P030_02SortInRecordType:${Usbice01P030_02SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Usbice01P030_02SortInRecordLen:${Usbice01P030_02SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Usbice01P030_02SortIn Read: {}",e.getMessage()); 
  		}
  	}
