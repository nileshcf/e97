...
@Component("batch_usbice01p030_01")
@JobScope
public class Usbice01P030_01Detail {

	private List<Usbice01P030_01Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Usbice01P030_01Keys> sortComp = null;
	 ...
	 */
	public List<Usbice01P030_01Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Usbice01P030_01Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Usbice01P030_01Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Usbice01P030_01Keys> sortComp) {
