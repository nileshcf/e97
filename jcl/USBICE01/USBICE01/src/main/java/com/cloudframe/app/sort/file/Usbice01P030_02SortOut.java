  ...
  @Component("Usbice01P030_02SortOut")
  @JobScope
  public class Usbice01P030_02SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Usbice01P030_02SortOut.class);
  	@Value("${Usbice01P030_02SortOut:CLOUDFRM.USB.NCR.COPYPARM}")
      ...
      @Value("#{'${Usbice01P030_02SortOutRecordType:${Usbice01P030_02SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Usbice01P030_02SortOutRecordLen:${Usbice01P030_02SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Usbice01P030_02SortOut Write: {}",e.getMessage()); 		
  		}
  	}
