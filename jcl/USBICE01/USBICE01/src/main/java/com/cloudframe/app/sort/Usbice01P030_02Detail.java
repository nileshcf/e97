...
@Component("batch_usbice01p030_02")
@JobScope
public class Usbice01P030_02Detail {

	private List<Usbice01P030_02Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Usbice01P030_02Keys> sortComp = null;
	 ...
	 */
	public List<Usbice01P030_02Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Usbice01P030_02Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Usbice01P030_02Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Usbice01P030_02Keys> sortComp) {
