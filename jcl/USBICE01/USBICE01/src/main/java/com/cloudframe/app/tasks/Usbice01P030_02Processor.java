...
public class Usbice01P030_02Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Usbice01P030_02Processor.class);
