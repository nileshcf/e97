...
public class Usbice01P030_01Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Usbice01P030_01Processor.class);
