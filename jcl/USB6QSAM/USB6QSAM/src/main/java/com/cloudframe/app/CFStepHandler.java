...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step01":
 		    	   		SpringContextHandler.handleDispPostion("STEP01.IDCAMS.Indd1","STEP01.IDCAMS.Indd1.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP01.IDCAMS.Outdd1","STEP01.IDCAMS.Outdd1.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP01.IDCAMS.Indd2","STEP01.IDCAMS.Indd2.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP01.IDCAMS.Outdd2","STEP01.IDCAMS.Outdd2.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP01.IDCAMS.Indd3","STEP01.IDCAMS.Indd3.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP01.IDCAMS.Outdd3","STEP01.IDCAMS.Outdd3.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : USB6QSAM ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : USB6QSAM ENDED -  ABEND={}", abendCode);
      } 
