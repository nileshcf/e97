  ...
  @Component("TranSort007SortIn")
  @JobScope
  public class TranSort007SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort007SortIn.class);
  	@Value("${TranSort007SortIn:CLOUDFRM.MC.MDS.BATCH.SORT.IN02}")
  	...
  	@Value("#{'${TranSort007SortInRecordType:${TranSort007SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort007SortInRecordLen:${TranSort007SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during TranSort007SortIn Read: {}",e.getMessage()); 
  		}
  	}
