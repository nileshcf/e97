...
@Component("batch_transort005")
@JobScope
public class TranSort005Detail {

	private List<TranSort005Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<TranSort005Keys> sortComp = null;
	 ...
	 */
	public List<TranSort005Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort005Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort005Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort005Keys> sortComp) {
