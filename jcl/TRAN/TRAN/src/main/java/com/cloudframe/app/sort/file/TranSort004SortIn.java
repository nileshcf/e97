  ...
  @Component("TranSort004SortIn")
  @JobScope
  public class TranSort004SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort004SortIn.class);
  	@Value("${TranSort004SortIn:CLOUDFRM.MC.MDS.BATCH.SORT.IN02}")
  	...
  	@Value("#{'${TranSort004SortInRecordType:${TranSort004SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort004SortInRecordLen:${TranSort004SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during TranSort004SortIn Read: {}",e.getMessage()); 
  		}
  	}
