...
@Component("batch_transort003")
@JobScope
public class TranSort003Detail {

	private List<TranSort003Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<TranSort003Keys> sortComp = null;
	 ...
	 */
	public List<TranSort003Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort003Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort003Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort003Keys> sortComp) {
