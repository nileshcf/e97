...
public class TranSort002InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(TranSort002InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<TranSort002Keys> sortRecKeys = sortDetail.getSortRecKeys();
		TranSort002Keys relKey = new TranSort002Keys();
