...
@Component("batch_transort007")
@JobScope
public class TranSort007Detail {

	private List<TranSort007Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<TranSort007Keys> sortComp = null;
	 ...
	 */
	public List<TranSort007Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort007Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort007Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort007Keys> sortComp) {
