...
@Component("batch_transort001")
@JobScope
public class TranSort001Detail {

	private List<TranSort001Keys> sortRecKeys = null;
	private List<TranSort001JoinKeys> joinRecKey1 = null;
	private List<TranSort001JoinKeys> joinRecKey2 = null;
	private Comparator<TranSort001JoinKeys> joinkeyComp = null;
	...
	private Comparator<TranSort001Keys> sortComp = null;
	 ...
	 */
	public List<TranSort001JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<TranSort001JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<TranSort001JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<TranSort001JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<TranSort001JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<TranSort001JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<TranSort001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort001Keys> sortComp) {
