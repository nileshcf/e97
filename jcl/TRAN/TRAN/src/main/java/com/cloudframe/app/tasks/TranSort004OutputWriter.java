...
public class TranSort004OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(TranSort004OutputWriter.class);
	@Autowired
	...
	List<TranSort004Keys> sortRecKeys = null;
...
logger.info("STEPNAME: TRANSORT004 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	private byte[] getSortedRecord(int index) {
		try {
			TranSort004Keys k = sortRecKeys.get(index);
