...
public class TranSort006InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(TranSort006InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<TranSort006Keys> sortRecKeys = sortDetail.getSortRecKeys();
		TranSort006Keys relKey = new TranSort006Keys();
