  ...
  @Component("TranSort007SortOut")
  @JobScope
  public class TranSort007SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort007SortOut.class);
  	@Value("${TranSort007SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT07}")
      ...
      @Value("#{'${TranSort007SortOutRecordType:${TranSort007SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort007SortOutRecordLen:${TranSort007SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort007SortOut Write: {}",e.getMessage()); 		
  		}
  	}
