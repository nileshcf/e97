  ...
  @Component("TranSort003SortIn")
  @JobScope
  public class TranSort003SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort003SortIn.class);
  	@Value("${TranSort003SortIn:CLOUDFRM.MC.MDS.BATCH.SORT.IN02}")
  	...
  	@Value("#{'${TranSort003SortInRecordType:${TranSort003SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort003SortInRecordLen:${TranSort003SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during TranSort003SortIn Read: {}",e.getMessage()); 
  		}
  	}
