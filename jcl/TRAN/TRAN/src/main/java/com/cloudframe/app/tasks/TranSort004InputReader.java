...
public class TranSort004InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(TranSort004InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<TranSort004Keys> sortRecKeys = sortDetail.getSortRecKeys();
		TranSort004Keys relKey = new TranSort004Keys();
