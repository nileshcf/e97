  ...
  @Component("TranSort002SortIn")
  @JobScope
  public class TranSort002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort002SortIn.class);
  	@Value("${TranSort002SortIn:CLOUDFRM.MC.MDS.BATCH.SORT.IN02}")
  	...
  	@Value("#{'${TranSort002SortInRecordType:${TranSort002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort002SortInRecordLen:${TranSort002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during TranSort002SortIn Read: {}",e.getMessage()); 
  		}
  	}
