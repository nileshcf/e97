  ...
  @Component("TranSort001SortOut")
  @JobScope
  public class TranSort001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort001SortOut.class);
  	@Value("${TranSort001SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT01}")
      ...
      @Value("#{'${TranSort001SortOutRecordType:${TranSort001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort001SortOutRecordLen:${TranSort001SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
