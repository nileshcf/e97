  ...
  @Component("TranSort006SortIn")
  @JobScope
  public class TranSort006SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort006SortIn.class);
  	@Value("${TranSort006SortIn:CLOUDFRM.MC.MDS.BATCH.SORT.IN02}")
  	...
  	@Value("#{'${TranSort006SortInRecordType:${TranSort006SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort006SortInRecordLen:${TranSort006SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during TranSort006SortIn Read: {}",e.getMessage()); 
  		}
  	}
