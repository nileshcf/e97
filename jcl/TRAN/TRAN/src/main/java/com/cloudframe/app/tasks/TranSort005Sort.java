...
import com.cloudframe.app.sort.TranSort005Detail;
import org.springframework.beans.factory.annotation.Value;
public class TranSort005Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(TranSort005Sort.class);
