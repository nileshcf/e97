  ...
  @Component("TranSort001SortIn1")
  @JobScope
  public class TranSort001SortIn1 extends CFFile {
  	@Value("${TranSort001SortIn[1]:CLOUDFRM.MC.MDS.BATCH.SORT.IN0012}")
  	...
  	@Value("#{'${TranSort001SortIn1RecordType:${TranSort001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort001SortIn1RecordLen:${TranSort001SortInRecordLen:80}}'}")
