  ...
  @Component("TranSort002SortOut")
  @JobScope
  public class TranSort002SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort002SortOut.class);
  	@Value("${TranSort002SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT02}")
      ...
      @Value("#{'${TranSort002SortOutRecordType:${TranSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort002SortOutRecordLen:${TranSort002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort002SortOut Write: {}",e.getMessage()); 		
  		}
  	}
