  ...
  @Component("TranSort006SortOut")
  @JobScope
  public class TranSort006SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort006SortOut.class);
  	@Value("${TranSort006SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT06}")
      ...
      @Value("#{'${TranSort006SortOutRecordType:${TranSort006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort006SortOutRecordLen:${TranSort006SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort006SortOut Write: {}",e.getMessage()); 		
  		}
  	}
