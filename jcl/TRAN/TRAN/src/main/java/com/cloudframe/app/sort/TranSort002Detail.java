...
@Component("batch_transort002")
@JobScope
public class TranSort002Detail {

	private List<TranSort002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<TranSort002Keys> sortComp = null;
	 ...
	 */
	public List<TranSort002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort002Keys> sortComp) {
