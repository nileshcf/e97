  ...
  @Component("TranSort001SortIn0")
  @JobScope
  public class TranSort001SortIn0 extends CFFile {
  	@Value("${TranSort001SortIn[0]:CLOUDFRM.MC.MDS.BATCH.SORT.IN0011}")
  	...
  	@Value("#{'${TranSort001SortIn0RecordType:${TranSort001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort001SortIn0RecordLen:${TranSort001SortInRecordLen:80}}'}")
