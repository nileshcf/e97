...
import com.cloudframe.app.sort.TranSort006Detail;
import org.springframework.beans.factory.annotation.Value;
public class TranSort006Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(TranSort006Sort.class);
...
public void afterPropertiesSet() throws Exception {
	...
	final byte[] outrecwhenBytes00 = convertChar2EbcdicBytes("A".toCharArray());
