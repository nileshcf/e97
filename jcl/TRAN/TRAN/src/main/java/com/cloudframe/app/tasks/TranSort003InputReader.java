...
public class TranSort003InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(TranSort003InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<TranSort003Keys> sortRecKeys = sortDetail.getSortRecKeys();
		TranSort003Keys relKey = new TranSort003Keys();
