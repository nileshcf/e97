  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort001":  /* setting the disp position for file(s) info for this step(SORT001). */
                         SpringContextHandler.setFileDispPosition("TranSort001SortIn0","TranSort001SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("TranSort001SortIn1","TranSort001SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("TranSort001SortOut","TranSort001SortOut.DISP");
            break;
            case "sort002":  /* setting the disp position for file(s) info for this step(SORT002). */
                         SpringContextHandler.setFileDispPosition("TranSort002SortIn","TranSort002SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("TranSort002SortOut","TranSort002SortOut.DISP");
            break;
            case "sort003":  /* setting the disp position for file(s) info for this step(SORT003). */
                         SpringContextHandler.setFileDispPosition("TranSort003SortIn","TranSort003SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("TranSort003SortOut","TranSort003SortOut.DISP");
            break;
            case "sort004":  /* setting the disp position for file(s) info for this step(SORT004). */
                         SpringContextHandler.setFileDispPosition("TranSort004SortIn","TranSort004SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("TranSort004SortOut","TranSort004SortOut.DISP");
            break;
            case "sort005":  /* setting the disp position for file(s) info for this step(SORT005). */
                         SpringContextHandler.setFileDispPosition("TranSort005SortIn","TranSort005SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("TranSort005SortOut","TranSort005SortOut.DISP");
            break;
            case "sort006":  /* setting the disp position for file(s) info for this step(SORT006). */
                         SpringContextHandler.setFileDispPosition("TranSort006SortIn","TranSort006SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("TranSort006SortOut","TranSort006SortOut.DISP");
            break;
            case "sort007":  /* setting the disp position for file(s) info for this step(SORT007). */
                         SpringContextHandler.setFileDispPosition("TranSort007SortIn","TranSort007SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("TranSort007SortOut","TranSort007SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : TRAN ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : TRAN ENDED -  ABEND={}", abendCode);
      } 
