...
@Component("batch_transort006")
@JobScope
public class TranSort006Detail {

	private List<TranSort006Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<TranSort006Keys> sortComp = null;
	 ...
	 */
	public List<TranSort006Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort006Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort006Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort006Keys> sortComp) {
