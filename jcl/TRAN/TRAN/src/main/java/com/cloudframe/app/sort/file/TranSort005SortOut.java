  ...
  @Component("TranSort005SortOut")
  @JobScope
  public class TranSort005SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort005SortOut.class);
  	@Value("${TranSort005SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT05}")
      ...
      @Value("#{'${TranSort005SortOutRecordType:${TranSort005SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort005SortOutRecordLen:${TranSort005SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort005SortOut Write: {}",e.getMessage()); 		
  		}
  	}
