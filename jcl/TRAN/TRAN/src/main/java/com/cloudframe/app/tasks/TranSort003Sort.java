...
import com.cloudframe.app.sort.TranSort003Detail;
import org.springframework.beans.factory.annotation.Value;
public class TranSort003Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(TranSort003Sort.class);
