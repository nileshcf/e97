  ...
  @Component("TranSort004SortOut")
  @JobScope
  public class TranSort004SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort004SortOut.class);
  	@Value("${TranSort004SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT04}")
      ...
      @Value("#{'${TranSort004SortOutRecordType:${TranSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort004SortOutRecordLen:${TranSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort004SortOut Write: {}",e.getMessage()); 		
  		}
  	}
