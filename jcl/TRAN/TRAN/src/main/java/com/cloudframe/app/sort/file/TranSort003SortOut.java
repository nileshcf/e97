  ...
  @Component("TranSort003SortOut")
  @JobScope
  public class TranSort003SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort003SortOut.class);
  	@Value("${TranSort003SortOut:CLOUDFRM.MC.MDS.BATCH.SORT.OUT03}")
      ...
      @Value("#{'${TranSort003SortOutRecordType:${TranSort003SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${TranSort003SortOutRecordLen:${TranSort003SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during TranSort003SortOut Write: {}",e.getMessage()); 		
  		}
  	}
