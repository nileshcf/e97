...
public class TranSort005InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(TranSort005InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<TranSort005Keys> sortRecKeys = sortDetail.getSortRecKeys();
		TranSort005Keys relKey = new TranSort005Keys();
