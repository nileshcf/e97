  ...
  @Component("TranSort005SortIn")
  @JobScope
  public class TranSort005SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(TranSort005SortIn.class);
  	@Value("${TranSort005SortIn:CLOUDFRM.MC.MDS.BATCH.SORT.IN02}")
  	...
  	@Value("#{'${TranSort005SortInRecordType:${TranSort005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${TranSort005SortInRecordLen:${TranSort005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during TranSort005SortIn Read: {}",e.getMessage()); 
  		}
  	}
