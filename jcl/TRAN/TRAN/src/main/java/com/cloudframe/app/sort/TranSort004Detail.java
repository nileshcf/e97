...
import com.cloudframe.app.sort.file.records.TranSort004Keys;
import com.cloudframe.app.data.Field;

@Component("batch_transort004")
@JobScope
public class TranSort004Detail {

	private List<TranSort004Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<TranSort004Keys> sortComp = null;
	 ...
	 */
	public List<TranSort004Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<TranSort004Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<TranSort004Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<TranSort004Keys> sortComp) {
