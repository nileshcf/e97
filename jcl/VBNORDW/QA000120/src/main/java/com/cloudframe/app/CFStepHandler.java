...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String WRITEVB = "writevb";
    private static final String READVB = "readvb";
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "delete":  /* setting the disp position for file(s) info for this step(DELETE). */
 		    	   		...
 		    	   		SpringContextHandler.handleDispPostion("DELETE.IEFBR14.Outdd","DELETE.IEFBR14.Outdd.DISP");
            break;
            case "writevb":  /* setting the appropriate file(s) info for this step(WRITEVB). */
 		    	   		SpringContextHandler.setFileName("iovb32k_inFile", "WRITEVB.IOVB32K.InFile");
 		    	   		SpringContextHandler.setFileName("iovb32k_outFile", "WRITEVB.IOVB32K.OutFile");
 		    	   		SpringContextHandler.setFileDispPosition("iovb32k_outFile", "WRITEVB.IOVB32K.OutFile.DISP");
            break;
            case "readvb":  /* setting the appropriate file(s) info for this step(READVB). */
 		    	   		SpringContextHandler.setFileName("iovb32k_inFile", "READVB.IOVB32K.InFile");
 		    	   		SpringContextHandler.setFileDispPosition("iovb32k_inFile", "READVB.IOVB32K.InFile.DISP");
 		    	   		SpringContextHandler.setFileName("iovb32k_outFile", "READVB.IOVB32K.OutFile");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : QA000120 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : QA000120 ENDED -  ABEND={}", abendCode);
      } 
