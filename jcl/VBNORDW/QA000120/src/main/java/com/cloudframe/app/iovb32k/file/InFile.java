package com.cloudframe.app.iovb32k.file;
...
import com.cloudframe.app.iovb32k.file.records.*;

@Component("iovb32k_inFile")
public class InFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(InFile.class);
	
	@Value("${IOVB32K.InFile:INDD}")
    ...
    **/
	@Value("${IOVB32K.InFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IOVB32K.InFileCRLFflag:no}")
	private String crlfFlag;

	public String getInFileCharSet() {
		return charSet;
	}
	
	public String getInFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during InFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
