...
@Component("iovb32k_outFile")
public class OutFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(OutFile.class);
	
	@Value("${IOVB32K.OutFile:OUTDD}")
    ...
    **/
	@Value("${IOVB32K.OutFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IOVB32K.OutFileCRLFflag:no}")
	...
	public String getOutFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during OutFile Write: {}",e.getMessage() ); 		}
	}
