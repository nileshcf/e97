  ...
  @Component("Sort037Step020SortOut0")
  @JobScope
  public class Sort037Step020SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort037Step020SortOut0.class);
  	@Value("${Sort037Step020SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0371}")
      ...
      @Value("#{'${Sort037Step020SortOut0RecordType:${Sort037Step020SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sort037Step020SortOut0RecordLen:${Sort037Step020SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sort037Step020SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
