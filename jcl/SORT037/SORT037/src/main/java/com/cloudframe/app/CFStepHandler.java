  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step020":  /* setting the disp position for file(s) info for this step(STEP020). */
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortIn0","Sort037Step020SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortIn1","Sort037Step020SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortIn2","Sort037Step020SortIn[2].DISP");
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortIn3","Sort037Step020SortIn[3].DISP");
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortIn4","Sort037Step020SortIn[4].DISP");
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortOut0","Sort037Step020SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort037Step020SortOut1","Sort037Step020SortOut[1].DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORT037 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORT037 ENDED -  ABEND={}", abendCode);
      } 
