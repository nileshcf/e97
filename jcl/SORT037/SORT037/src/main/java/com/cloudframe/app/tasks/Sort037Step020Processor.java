...
public class Sort037Step020Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Sort037Step020Processor.class);
