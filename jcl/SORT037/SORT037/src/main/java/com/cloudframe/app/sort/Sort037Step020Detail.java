...
@Component("batch_sort037step020")
@JobScope
public class Sort037Step020Detail {

	private List<Sort037Step020Keys> sortRecKeys = null;
	private List<Sort037Step020JoinKeys> joinRecKey1 = null;
	private List<Sort037Step020JoinKeys> joinRecKey2 = null;
	private Comparator<Sort037Step020JoinKeys> joinkeyComp = null;
	...
	private Comparator<Sort037Step020Keys> sortComp = null;
	 ...
	 */
	public List<Sort037Step020JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<Sort037Step020JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<Sort037Step020JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<Sort037Step020JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<Sort037Step020JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<Sort037Step020JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<Sort037Step020Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Sort037Step020Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Sort037Step020Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Sort037Step020Keys> sortComp) {
