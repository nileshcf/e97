...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step001":
 		    	   		SpringContextHandler.handleDispPostion("STEP001.ICEGENER.Sysut2","STEP001.ICEGENER.Sysut2.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP001.ICEGENER.Sysut3","STEP001.ICEGENER.Sysut3.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP001.ICEGENER.Sysut4","STEP001.ICEGENER.Sysut4.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP001.ICEGENER.Sysut5","STEP001.ICEGENER.Sysut5.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : ICEGENER ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : ICEGENER ENDED -  ABEND={}", abendCode);
      } 
