  ...
  @Component("Icet050MergeSortOut1")
  @JobScope
  public class Icet050MergeSortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Icet050MergeSortOut1.class);
  	@Value("${Icet050MergeSortOut[1]:CLOUDFRM.MC.SORT.OUT050B}")
      ...
      @Value("#{'${Icet050MergeSortOut1RecordType:${Icet050MergeSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Icet050MergeSortOut1RecordLen:${Icet050MergeSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Icet050MergeSortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
