  ...
  @Component("Icet050MergeSortIn1")
  @JobScope
  public class Icet050MergeSortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Icet050MergeSortIn1.class);
  	@Value("${Icet050MergeSortIn[1]:CLOUDFRM.MC.SORT.IN0202}")
  	...
  	@Value("#{'${Icet050MergeSortIn1RecordType:${Icet050MergeSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Icet050MergeSortIn1RecordLen:${Icet050MergeSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Icet050MergeSortIn1 Read: {}",e.getMessage()); 
  		}
  	}
