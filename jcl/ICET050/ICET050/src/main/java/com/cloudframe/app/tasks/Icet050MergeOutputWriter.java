...
public class Icet050MergeOutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Icet050MergeOutputWriter.class);
	@Autowired
