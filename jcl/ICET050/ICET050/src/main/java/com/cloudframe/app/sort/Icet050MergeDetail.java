...
@Component("batch_icet050merge")
@JobScope
public class Icet050MergeDetail {

	private List<Icet050MergeKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Icet050MergeKeys> sortComp = null;
	 ...
	 */
	public List<Icet050MergeKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Icet050MergeKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Icet050MergeKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Icet050MergeKeys> sortComp) {
