...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String P030 = "p030";
    private static final String P0301 = "p0301";
    private static final String P040 = "p040";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "p030":  /* setting the disp position for file(s) info for this step(P030). */
                         SpringContextHandler.setFileDispPosition("UsbiceP030SortIn","UsbiceP030SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("UsbiceP030SortOut","UsbiceP030SortOut.DISP");
            break;
            case "p0301":  /* setting the disp position for file(s) info for this step(P0301). */
                         SpringContextHandler.setFileDispPosition("UsbiceP0301SortIn","UsbiceP0301SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("UsbiceP0301SortOut","UsbiceP0301SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : USBICE ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : USBICE ENDED -  ABEND={}", abendCode);
      } 
