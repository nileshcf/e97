  ...
  @Component("UsbiceP030SortOut")
  @JobScope
  public class UsbiceP030SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbiceP030SortOut.class);
  	@Value("${UsbiceP030SortOut:UDEV34.CLOUDFRM.USB.NCR.NONVSAM}")
      ...
      @Value("#{'${UsbiceP030SortOutRecordType:${UsbiceP030SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbiceP030SortOutRecordLen:${UsbiceP030SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbiceP030SortOut Write: {}",e.getMessage()); 		
  		}
  	}
