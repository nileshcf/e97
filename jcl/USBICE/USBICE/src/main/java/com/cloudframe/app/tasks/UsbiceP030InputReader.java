...
public class UsbiceP030InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(UsbiceP030InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<UsbiceP030Keys> sortRecKeys = sortDetail.getSortRecKeys();
		UsbiceP030Keys relKey = new UsbiceP030Keys();
