  ...
  @Component("UsbiceP0301SortIn")
  @JobScope
  public class UsbiceP0301SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbiceP0301SortIn.class);
  	@Value("${UsbiceP0301SortIn:UDEV34.CLOUDFRM.USB.NCR.COPY}")
  	...
  	@Value("#{'${UsbiceP0301SortInRecordType:${UsbiceP0301SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${UsbiceP0301SortInRecordLen:${UsbiceP0301SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during UsbiceP0301SortIn Read: {}",e.getMessage()); 
  		}
  	}
