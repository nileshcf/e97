...
import com.cloudframe.app.sort.UsbiceP030Detail;
import org.springframework.beans.factory.annotation.Value;
public class UsbiceP030Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(UsbiceP030Sort.class);
