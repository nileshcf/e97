...
@Component("batch_usbicep0301")
@JobScope
public class UsbiceP0301Detail {

	private List<UsbiceP0301Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbiceP0301Keys> sortComp = null;
	 ...
	 */
	public List<UsbiceP0301Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbiceP0301Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbiceP0301Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbiceP0301Keys> sortComp) {
