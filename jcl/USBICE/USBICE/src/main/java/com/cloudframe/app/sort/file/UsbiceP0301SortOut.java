  ...
  @Component("UsbiceP0301SortOut")
  @JobScope
  public class UsbiceP0301SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbiceP0301SortOut.class);
  	@Value("${UsbiceP0301SortOut:UDEV34.CLOUDFRM.USB.NCR.COPYPARM}")
      ...
      @Value("#{'${UsbiceP0301SortOutRecordType:${UsbiceP0301SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbiceP0301SortOutRecordLen:${UsbiceP0301SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbiceP0301SortOut Write: {}",e.getMessage()); 		
  		}
  	}
