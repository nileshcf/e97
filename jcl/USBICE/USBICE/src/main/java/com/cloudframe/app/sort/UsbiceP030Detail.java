...
@Component("batch_usbicep030")
@JobScope
public class UsbiceP030Detail {

	private List<UsbiceP030Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbiceP030Keys> sortComp = null;
	 ...
	 */
	public List<UsbiceP030Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbiceP030Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbiceP030Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbiceP030Keys> sortComp) {
