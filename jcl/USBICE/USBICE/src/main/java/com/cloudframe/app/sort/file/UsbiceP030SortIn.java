  ...
  @Component("UsbiceP030SortIn")
  @JobScope
  public class UsbiceP030SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbiceP030SortIn.class);
  	@Value("${UsbiceP030SortIn:UDEV34.CLOUDFRM.USB.NCR.DSNAMES}")
  	...
  	@Value("#{'${UsbiceP030SortInRecordType:${UsbiceP030SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${UsbiceP030SortInRecordLen:${UsbiceP030SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during UsbiceP030SortIn Read: {}",e.getMessage()); 
  		}
  	}
