...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String DEFCL = "defcl";
    private static final String VSAMINIT = "vsaminit";
    private static final String PRINT01 = "print01";
    private static final String VSAMDEL = "vsamdel";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "vsaminit":
 		    	   		SpringContextHandler.handleDispPostion("VSAMINIT.IDCAMS.Indd","VSAMINIT.IDCAMS.Indd.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : IDCPRN9A ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : IDCPRN9A ENDED -  ABEND={}", abendCode);
      } 
