...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String DELVSAM = "delvsam";
    private static final String DEFVSAM = "defvsam";
    private static final String REPVSAM = "repvsam";
    private static final String VSAMOUT = "vsamout";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "repvsam":
 		    	   		SpringContextHandler.handleDispPostion("REPVSAM.IDCAMS.Filein1","REPVSAM.IDCAMS.Filein1.DISP");
            break;
            case "vsamout":
 		    	   		SpringContextHandler.handleDispPostion("VSAMOUT.IDCAMS.Fileout1","VSAMOUT.IDCAMS.Fileout1.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : DELVSAM1 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : DELVSAM1 ENDED -  ABEND={}", abendCode);
      } 
