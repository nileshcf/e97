...
return canExecute;
    ...
    private boolean deciderForStep4() {
        return (getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) == 2  || getRcForStep(STEP3_STEP10) != null && getRcForStep(STEP3_STEP10) == 3 ) /* 1 */  /*IF COND*/ ;
    }
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : IFTESTA ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : IFTESTA ENDED -  ABEND={}", abendCode);
      } 
