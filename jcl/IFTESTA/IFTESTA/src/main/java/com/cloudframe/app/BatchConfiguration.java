...
public class BatchConfiguration {
    ...
    private static final String JOBNAME = "IFTESTA";
    ...
    public Step step10(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Retcode2)cfStepHandler.initAndGetProcessBean(STEP10_STEP,RETCODE2_BEAN)).setParameter( cfStepHandler.getParm(step10Retcode2Parm));
...
cfStepHandler.setAbendCode(cfe);
    ...
    @Value("${STEP2_STEP10.RETCODE2.inputValue:'00022'}")
