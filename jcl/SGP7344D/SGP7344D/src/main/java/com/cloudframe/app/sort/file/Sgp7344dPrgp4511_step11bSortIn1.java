  ...
  @Component("Sgp7344dPrgp4511_step11bSortIn1")
  @JobScope
  public class Sgp7344dPrgp4511_step11bSortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sgp7344dPrgp4511_step11bSortIn1.class);
  	@Value("${Sgp7344dPrgp4511_step11bSortIn[1]:DTF.GP.P2BX.TNR0.EXTRACT.INTERM}")
  	...
  	@Value("#{'${Sgp7344dPrgp4511_step11bSortIn1RecordType:${Sgp7344dPrgp4511_step11bSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sgp7344dPrgp4511_step11bSortIn1RecordLen:${Sgp7344dPrgp4511_step11bSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sgp7344dPrgp4511_step11bSortIn1 Read: {}",e.getMessage()); 
  		}
  	}
