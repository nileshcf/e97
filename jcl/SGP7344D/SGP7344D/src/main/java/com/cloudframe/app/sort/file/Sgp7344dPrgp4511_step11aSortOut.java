  ...
  @Component("Sgp7344dPrgp4511_step11aSortOut")
  @JobScope
  public class Sgp7344dPrgp4511_step11aSortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sgp7344dPrgp4511_step11aSortOut.class);
  	@Value("${Sgp7344dPrgp4511_step11aSortOut:DTF.GP.P2BX.TGPAUKD.AKF.UNPAIRED}")
      ...
      @Value("#{'${Sgp7344dPrgp4511_step11aSortOutRecordType:${Sgp7344dPrgp4511_step11aSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sgp7344dPrgp4511_step11aSortOutRecordLen:${Sgp7344dPrgp4511_step11aSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sgp7344dPrgp4511_step11aSortOut Write: {}",e.getMessage()); 		
  		}
  	}
