...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String PRGP4511_STEP11A = "prgp4511_step11a";
    private static final String PRGP4511_STEP11B = "prgp4511_step11b";
...
*/
    public boolean stepDecider(String stepName) {
	      ...
	      switch (stepName) {
	          case PRGP4511_STEP11A:
	              canExecute = (true);
	          break;
	          case PRGP4511_STEP11B:
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "prgp4511_step11a":  /* setting the disp position for file(s) info for this step(PRGP4511_STEP11A). */
                         SpringContextHandler.setFileDispPosition("Sgp7344dPrgp4511_step11aSortIn0","Sgp7344dPrgp4511_step11aSortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sgp7344dPrgp4511_step11aSortIn1","Sgp7344dPrgp4511_step11aSortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Sgp7344dPrgp4511_step11aSortOut","Sgp7344dPrgp4511_step11aSortOut.DISP");
            break;
            case "prgp4511_step11b":  /* setting the disp position for file(s) info for this step(PRGP4511_STEP11B). */
                         SpringContextHandler.setFileDispPosition("Sgp7344dPrgp4511_step11bSortIn0","Sgp7344dPrgp4511_step11bSortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sgp7344dPrgp4511_step11bSortIn1","Sgp7344dPrgp4511_step11bSortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Sgp7344dPrgp4511_step11bSortOut","Sgp7344dPrgp4511_step11bSortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SGP7344D ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SGP7344D ENDED -  ABEND={}", abendCode);
      } 
