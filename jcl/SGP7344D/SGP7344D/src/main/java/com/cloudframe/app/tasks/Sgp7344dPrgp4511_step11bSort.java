...
public class Sgp7344dPrgp4511_step11bSort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Sgp7344dPrgp4511_step11bSort.class);
	@Autowired
