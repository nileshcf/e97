...
public class Sgp7344dPrgp4511_step11aOutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Sgp7344dPrgp4511_step11aOutputWriter.class);
	@Autowired
	...
	final byte[] fillBytes01 = convertChar2EbcdicBytes(CFUtil.fillSpaces(69));
...
copyRecordBytes(fillBytes01,buildRec,0,59,69);
