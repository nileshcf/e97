  ...
  @Component("McsfsortSort016SortIn1")
  @JobScope
  public class McsfsortSort016SortIn1 extends CFFile {
  	@Value("${McsfsortSort016SortIn[1]:CLOUDFRM.MC.SORT.S016JNF2}")
  	...
  	@Value("#{'${McsfsortSort016SortIn1RecordType:${McsfsortSort016SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort016SortIn1RecordLen:${McsfsortSort016SortInRecordLen:80}}'}")
