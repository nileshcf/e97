...
public class McsfsortSort011Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort011Sort.class);
	@Autowired
...
logger.info("STEPNAME: MCSFSORTSORT011 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<McsfsortSort011Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		McsfsortSort011Keys relKey = new McsfsortSort011Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McsfsortSort011Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McsfsortSort011Keys> sortComp = sortDetail.getSortComp();
