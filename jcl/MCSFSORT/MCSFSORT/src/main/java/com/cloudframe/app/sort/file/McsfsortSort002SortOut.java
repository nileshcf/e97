  ...
  @Component("McsfsortSort002SortOut")
  @JobScope
  public class McsfsortSort002SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort002SortOut.class);
  	@Value("${McsfsortSort002SortOut:CLOUDFRM.MC.SORT.OUT002}")
      ...
      @Value("#{'${McsfsortSort002SortOutRecordType:${McsfsortSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort002SortOutRecordLen:${McsfsortSort002SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 30000;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort002SortOut Write: {}",e.getMessage()); 		
  		}
  	}
