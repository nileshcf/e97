  ...
  @Component("McsfsortSort016SortOut2")
  @JobScope
  public class McsfsortSort016SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort016SortOut2.class);
  	@Value("${McsfsortSort016SortOut[2]:CLOUDFRM.MC.SORT.OUT016.SORTUN02}")
      ...
      @Value("#{'${McsfsortSort016SortOut2RecordType:${McsfsortSort016SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort016SortOut2RecordLen:${McsfsortSort016SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort016SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
