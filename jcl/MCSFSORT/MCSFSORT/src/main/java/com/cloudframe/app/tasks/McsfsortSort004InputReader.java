...
public class McsfsortSort004InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort004InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort004Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort004Keys relKey = new McsfsortSort004Keys();
