  ...
  @Component("McsfsortSort003SortIn")
  @JobScope
  public class McsfsortSort003SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort003SortIn.class);
  	@Value("${McsfsortSort003SortIn:CLOUDFRM.MC.SORT.IN003}")
  	...
  	@Value("#{'${McsfsortSort003SortInRecordType:${McsfsortSort003SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort003SortInRecordLen:${McsfsortSort003SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort003SortIn Read: {}",e.getMessage()); 
  		}
  	}
