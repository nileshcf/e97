  ...
  @Component("McsfsortSort004SortOut4")
  @JobScope
  public class McsfsortSort004SortOut4 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort004SortOut4.class);
  	@Value("${McsfsortSort004SortOut[4]:CLOUDFRM.MC.SORT.OUT0045}")
      ...
      @Value("#{'${McsfsortSort004SortOut4RecordType:${McsfsortSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort004SortOut4RecordLen:${McsfsortSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort004SortOut4 Write: {}",e.getMessage()); 		
  		}
  	}
