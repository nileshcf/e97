  ...
  @Component("McsfsortSort012SortOut2")
  @JobScope
  public class McsfsortSort012SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort012SortOut2.class);
  	@Value("${McsfsortSort012SortOut[2]:CLOUDFRM.MC.SORT.OUT0123}")
      ...
      @Value("#{'${McsfsortSort012SortOut2RecordType:${McsfsortSort012SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort012SortOut2RecordLen:${McsfsortSort012SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort012SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
