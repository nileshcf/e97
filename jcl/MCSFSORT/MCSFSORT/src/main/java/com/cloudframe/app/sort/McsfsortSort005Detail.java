...
@Component("batch_mcsfsortsort005")
@JobScope
public class McsfsortSort005Detail {

	private List<McsfsortSort005Keys> sortRecKeys = null;
	private Set<McsfsortSort005Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort005Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort005Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort005Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<McsfsortSort005Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<McsfsortSort005Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort005Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort005Keys> sortComp) {
