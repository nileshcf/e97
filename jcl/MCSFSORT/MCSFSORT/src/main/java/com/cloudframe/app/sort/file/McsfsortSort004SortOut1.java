  ...
  @Component("McsfsortSort004SortOut1")
  @JobScope
  public class McsfsortSort004SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort004SortOut1.class);
  	@Value("${McsfsortSort004SortOut[1]:CLOUDFRM.MC.SORT.OUT0042}")
      ...
      @Value("#{'${McsfsortSort004SortOut1RecordType:${McsfsortSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort004SortOut1RecordLen:${McsfsortSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort004SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
