  ...
  @Component("McsfsortSort017SortOut")
  @JobScope
  public class McsfsortSort017SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort017SortOut.class);
  	@Value("${McsfsortSort017SortOut:CLOUDFRM.MC.SORT.OUT017}")
      ...
      @Value("#{'${McsfsortSort017SortOutRecordType:${McsfsortSort017SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort017SortOutRecordLen:${McsfsortSort017SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort017SortOut Write: {}",e.getMessage()); 		
  		}
  	}
