...
public class McsfsortSort012InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort012InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort012Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort012Keys relKey = new McsfsortSort012Keys();
