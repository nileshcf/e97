...
@Component("batch_mcsfsortsort013")
@JobScope
public class McsfsortSort013Detail {

	private List<McsfsortSort013Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort013Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort013Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort013Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort013Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort013Keys> sortComp) {
