...
public class McsfsortSort001Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort001Sort.class);
	@Autowired
...
logger.info("STEPNAME: MCSFSORTSORT001 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort001Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort001Keys relKey = new McsfsortSort001Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McsfsortSort001Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(McsfsortSort001Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McsfsortSort001Keys> sortComp = sortDetail.getSortComp();
