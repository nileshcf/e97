...
@Component("batch_mcsfsortsort002")
@JobScope
public class McsfsortSort002Detail {

	private List<McsfsortSort002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort002Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort002Keys> sortComp) {
