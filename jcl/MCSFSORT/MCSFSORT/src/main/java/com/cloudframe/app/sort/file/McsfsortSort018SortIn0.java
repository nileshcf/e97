  ...
  @Component("McsfsortSort018SortIn0")
  @JobScope
  public class McsfsortSort018SortIn0 extends CFFile {
  	@Value("${McsfsortSort018SortIn[0]:CLOUDFRM.MC.SORT.S018JNF1}")
  	...
  	@Value("#{'${McsfsortSort018SortIn0RecordType:${McsfsortSort018SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort018SortIn0RecordLen:${McsfsortSort018SortInRecordLen:80}}'}")
