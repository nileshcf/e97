  ...
  @Component("McsfsortSort001SortIn")
  @JobScope
  public class McsfsortSort001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort001SortIn.class);
  	@Value("${McsfsortSort001SortIn:CLOUDFRM.MC.SORT.IN001}")
  	...
  	@Value("#{'${McsfsortSort001SortInRecordType:${McsfsortSort001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort001SortInRecordLen:${McsfsortSort001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort001SortIn Read: {}",e.getMessage()); 
  		}
  	}
