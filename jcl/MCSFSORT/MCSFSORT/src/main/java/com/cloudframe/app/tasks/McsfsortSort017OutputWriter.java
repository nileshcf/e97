...
public class McsfsortSort017OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(McsfsortSort017OutputWriter.class);
	@Autowired
