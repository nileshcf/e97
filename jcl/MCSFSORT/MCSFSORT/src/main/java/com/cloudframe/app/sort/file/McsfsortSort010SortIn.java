  ...
  @Component("McsfsortSort010SortIn")
  @JobScope
  public class McsfsortSort010SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort010SortIn.class);
  	@Value("${McsfsortSort010SortIn:CLOUDFRM.MC.SORT.IN010}")
  	...
  	@Value("#{'${McsfsortSort010SortInRecordType:${McsfsortSort010SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort010SortInRecordLen:${McsfsortSort010SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort010SortIn Read: {}",e.getMessage()); 
  		}
  	}
