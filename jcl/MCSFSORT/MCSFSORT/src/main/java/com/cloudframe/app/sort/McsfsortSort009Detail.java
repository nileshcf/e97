...
@Component("batch_mcsfsortsort009")
@JobScope
public class McsfsortSort009Detail {

	private List<McsfsortSort009Keys> sortRecKeys = null;
	private Set<McsfsortSort009Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort009Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort009Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort009Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<McsfsortSort009Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<McsfsortSort009Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort009Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort009Keys> sortComp) {
