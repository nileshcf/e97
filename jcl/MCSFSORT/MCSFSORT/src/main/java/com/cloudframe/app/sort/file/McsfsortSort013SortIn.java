  ...
  @Component("McsfsortSort013SortIn")
  @JobScope
  public class McsfsortSort013SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort013SortIn.class);
  	@Value("${McsfsortSort013SortIn:CLOUDFRM.MC.SORT.IN013}")
  	...
  	@Value("#{'${McsfsortSort013SortInRecordType:${McsfsortSort013SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort013SortInRecordLen:${McsfsortSort013SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort013SortIn Read: {}",e.getMessage()); 
  		}
  	}
