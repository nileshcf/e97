  ...
  @Component("McsfsortSort004SortOut3")
  @JobScope
  public class McsfsortSort004SortOut3 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort004SortOut3.class);
  	@Value("${McsfsortSort004SortOut[3]:CLOUDFRM.MC.SORT.OUT0044}")
      ...
      @Value("#{'${McsfsortSort004SortOut3RecordType:${McsfsortSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort004SortOut3RecordLen:${McsfsortSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort004SortOut3 Write: {}",e.getMessage()); 		
  		}
  	}
