  ...
  @Component("McsfsortSort018SortOut")
  @JobScope
  public class McsfsortSort018SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort018SortOut.class);
  	@Value("${McsfsortSort018SortOut:CLOUDFRM.MC.SORT.OUT018}")
      ...
      @Value("#{'${McsfsortSort018SortOutRecordType:${McsfsortSort018SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort018SortOutRecordLen:${McsfsortSort018SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort018SortOut Write: {}",e.getMessage()); 		
  		}
  	}
