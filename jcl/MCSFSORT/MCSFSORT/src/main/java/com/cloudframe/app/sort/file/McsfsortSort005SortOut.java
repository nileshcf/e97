  ...
  @Component("McsfsortSort005SortOut")
  @JobScope
  public class McsfsortSort005SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort005SortOut.class);
  	@Value("${McsfsortSort005SortOut:CLOUDFRM.MC.SORT.OUT005}")
      ...
      @Value("#{'${McsfsortSort005SortOutRecordType:${McsfsortSort005SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort005SortOutRecordLen:${McsfsortSort005SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 32756;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort005SortOut Write: {}",e.getMessage()); 		
  		}
  	}
