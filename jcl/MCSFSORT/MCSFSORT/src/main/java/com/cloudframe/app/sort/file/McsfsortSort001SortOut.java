  ...
  @Component("McsfsortSort001SortOut")
  @JobScope
  public class McsfsortSort001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort001SortOut.class);
  	@Value("${McsfsortSort001SortOut:CLOUDFRM.MC.SORT.OUT001}")
      ...
      @Value("#{'${McsfsortSort001SortOutRecordType:${McsfsortSort001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort001SortOutRecordLen:${McsfsortSort001SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 32748;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
