...
@Component("batch_mcsfsortsort011")
@JobScope
public class McsfsortSort011Detail {

	private List<McsfsortSort011Keys> sortRecKeys = null;
	private Set<McsfsortSort011Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort011Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort011Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort011Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<McsfsortSort011Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<McsfsortSort011Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort011Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort011Keys> sortComp) {
