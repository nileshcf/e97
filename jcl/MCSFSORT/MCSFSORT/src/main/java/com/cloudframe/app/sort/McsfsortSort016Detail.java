...
@Component("batch_mcsfsortsort016")
@JobScope
public class McsfsortSort016Detail {

	private List<McsfsortSort016Keys> sortRecKeys = null;
	private List<McsfsortSort016JoinKeys> joinRecKey1 = null;
	private List<McsfsortSort016JoinKeys> joinRecKey2 = null;
	private Comparator<McsfsortSort016JoinKeys> joinkeyComp = null;
	...
	private Comparator<McsfsortSort016Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort016JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McsfsortSort016JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McsfsortSort016JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McsfsortSort016JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McsfsortSort016JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McsfsortSort016JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McsfsortSort016Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort016Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort016Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort016Keys> sortComp) {
