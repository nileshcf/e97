...
import com.cloudframe.app.sort.file.McsfsortSort009SortIn;
...
import com.cloudframe.app.sort.McsfsortSort009Detail;
...
import com.cloudframe.app.sort.file.McsfsortSort009SortOut;
import org.springframework.beans.factory.annotation.Autowired;
import java.io.FileNotFoundException;
import com.cloudframe.app.sort.file.McsfsortSort009SortIn;
import org.springframework.batch.core.StepExecutionListener;
import com.cloudframe.app.sort.file.records.McsfsortSort009Keys;
import org.springframework.batch.core.StepExecution;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class McsfsortSort009Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort009Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcsfsortsort009")
	McsfsortSort009Detail sortDetail;
	
	@Autowired
	@Qualifier("McsfsortSort009SortOut")
	McsfsortSort009SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McsfsortSort009SortIn")
	McsfsortSort009SortIn sortIn;
	...
	List<McsfsortSort009Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
    ...
    int recCounter = 0;
	static final int KEY_POS0 = 15;
	static final int KEY_POS1 = 74;
	static final int KEY_LEN0 = 8;
	static final int KEY_LEN1 = 4;
	@Override
...
logger.info("STEPNAME: MCSFSORTSORT009 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			McsfsortSort009Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<McsfsortSort009Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		McsfsortSort009Keys relKey = new McsfsortSort009Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McsfsortSort009Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(McsfsortSort009Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McsfsortSort009Keys> sortComp = sortDetail.getSortComp();
