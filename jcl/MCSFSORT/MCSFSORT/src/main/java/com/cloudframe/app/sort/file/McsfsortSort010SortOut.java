  ...
  @Component("McsfsortSort010SortOut")
  @JobScope
  public class McsfsortSort010SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort010SortOut.class);
  	@Value("${McsfsortSort010SortOut:CLOUDFRM.MC.SORT.OUT0101}")
      ...
      @Value("#{'${McsfsortSort010SortOutRecordType:${McsfsortSort010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort010SortOutRecordLen:${McsfsortSort010SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort010SortOut Write: {}",e.getMessage()); 		
  		}
  	}
