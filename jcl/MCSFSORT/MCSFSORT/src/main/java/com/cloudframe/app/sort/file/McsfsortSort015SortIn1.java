  ...
  @Component("McsfsortSort015SortIn1")
  @JobScope
  public class McsfsortSort015SortIn1 extends CFFile {
  	@Value("${McsfsortSort015SortIn[1]:CLOUDFRM.MC.SORT.S015JNF2}")
  	...
  	@Value("#{'${McsfsortSort015SortIn1RecordType:${McsfsortSort015SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort015SortIn1RecordLen:${McsfsortSort015SortInRecordLen:80}}'}")
