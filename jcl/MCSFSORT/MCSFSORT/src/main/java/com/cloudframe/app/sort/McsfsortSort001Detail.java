...
@Component("batch_mcsfsortsort001")
@JobScope
public class McsfsortSort001Detail {

	private List<McsfsortSort001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort001Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort001Keys> sortComp) {
