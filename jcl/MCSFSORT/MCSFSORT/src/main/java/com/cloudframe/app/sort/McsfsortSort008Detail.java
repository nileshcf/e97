...
import com.cloudframe.app.sort.file.records.McsfsortSort008JoinKeys;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.data.Field;

@Component("batch_mcsfsortsort008")
@JobScope
public class McsfsortSort008Detail {

	private List<McsfsortSort008Keys> sortRecKeys = null;
	private List<McsfsortSort008JoinKeys> joinRecKey1 = null;
	private List<McsfsortSort008JoinKeys> joinRecKey2 = null;
	private Comparator<McsfsortSort008JoinKeys> joinkeyComp = null;
	...
	private Comparator<McsfsortSort008Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort008JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McsfsortSort008JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McsfsortSort008JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McsfsortSort008JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McsfsortSort008JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McsfsortSort008JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McsfsortSort008Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort008Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort008Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort008Keys> sortComp) {
