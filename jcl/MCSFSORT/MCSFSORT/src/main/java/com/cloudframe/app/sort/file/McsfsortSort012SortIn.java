  ...
  @Component("McsfsortSort012SortIn")
  @JobScope
  public class McsfsortSort012SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort012SortIn.class);
  	@Value("${McsfsortSort012SortIn:CLOUDFRM.MC.SORT.IN012}")
  	...
  	@Value("#{'${McsfsortSort012SortInRecordType:${McsfsortSort012SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort012SortInRecordLen:${McsfsortSort012SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort012SortIn Read: {}",e.getMessage()); 
  		}
  	}
