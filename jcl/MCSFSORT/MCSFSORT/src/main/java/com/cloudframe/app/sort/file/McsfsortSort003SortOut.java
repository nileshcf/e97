  ...
  @Component("McsfsortSort003SortOut")
  @JobScope
  public class McsfsortSort003SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort003SortOut.class);
  	@Value("${McsfsortSort003SortOut:CLOUDFRM.MC.SORT.OUT003}")
      ...
      @Value("#{'${McsfsortSort003SortOutRecordType:${McsfsortSort003SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort003SortOutRecordLen:${McsfsortSort003SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort003SortOut Write: {}",e.getMessage()); 		
  		}
  	}
