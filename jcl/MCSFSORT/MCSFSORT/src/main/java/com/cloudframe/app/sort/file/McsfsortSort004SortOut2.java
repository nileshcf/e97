  ...
  @Component("McsfsortSort004SortOut2")
  @JobScope
  public class McsfsortSort004SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort004SortOut2.class);
  	@Value("${McsfsortSort004SortOut[2]:CLOUDFRM.MC.SORT.OUT0043}")
      ...
      @Value("#{'${McsfsortSort004SortOut2RecordType:${McsfsortSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort004SortOut2RecordLen:${McsfsortSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort004SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
