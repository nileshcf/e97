  ...
  @Component("McsfsortSort008SortIn0")
  @JobScope
  public class McsfsortSort008SortIn0 extends CFFile {
  	@Value("${McsfsortSort008SortIn[0]:CLOUDFRM.MC.SORT.SORTJNF1}")
  	...
  	@Value("#{'${McsfsortSort008SortIn0RecordType:${McsfsortSort008SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort008SortIn0RecordLen:${McsfsortSort008SortInRecordLen:80}}'}")
