  ...
  @Component("McsfsortSort016SortIn0")
  @JobScope
  public class McsfsortSort016SortIn0 extends CFFile {
  	@Value("${McsfsortSort016SortIn[0]:CLOUDFRM.MC.SORT.S016JNF1}")
  	...
  	@Value("#{'${McsfsortSort016SortIn0RecordType:${McsfsortSort016SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort016SortIn0RecordLen:${McsfsortSort016SortInRecordLen:80}}'}")
