  ...
  @Component("McsfsortSort009SortIn")
  @JobScope
  public class McsfsortSort009SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort009SortIn.class);
  	@Value("${McsfsortSort009SortIn:CLOUDFRM.MC.SORT.IN009}")
  	...
  	@Value("#{'${McsfsortSort009SortInRecordType:${McsfsortSort009SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort009SortInRecordLen:${McsfsortSort009SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort009SortIn Read: {}",e.getMessage()); 
  		}
  	}
