  ...
  @Component("McsfsortSort016SortOut0")
  @JobScope
  public class McsfsortSort016SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort016SortOut0.class);
  	@Value("${McsfsortSort016SortOut[0]:CLOUDFRM.MC.SORT.OUT016.SORTMTCH}")
      ...
      @Value("#{'${McsfsortSort016SortOut0RecordType:${McsfsortSort016SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort016SortOut0RecordLen:${McsfsortSort016SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort016SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
