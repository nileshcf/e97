...
import com.cloudframe.app.sort.file.records.McsfsortSort015JoinKeys;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.data.Field;

@Component("batch_mcsfsortsort015")
@JobScope
public class McsfsortSort015Detail {

	private List<McsfsortSort015Keys> sortRecKeys = null;
	private List<McsfsortSort015JoinKeys> joinRecKey1 = null;
	private List<McsfsortSort015JoinKeys> joinRecKey2 = null;
	private Comparator<McsfsortSort015JoinKeys> joinkeyComp = null;
	...
	private Comparator<McsfsortSort015Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort015JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McsfsortSort015JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McsfsortSort015JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McsfsortSort015JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McsfsortSort015JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McsfsortSort015JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McsfsortSort015Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort015Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort015Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort015Keys> sortComp) {
