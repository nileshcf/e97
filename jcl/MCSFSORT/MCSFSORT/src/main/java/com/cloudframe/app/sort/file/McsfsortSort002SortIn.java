  ...
  @Component("McsfsortSort002SortIn")
  @JobScope
  public class McsfsortSort002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort002SortIn.class);
  	@Value("${McsfsortSort002SortIn:CLOUDFRM.MC.SORT.IN002}")
  	...
  	@Value("#{'${McsfsortSort002SortInRecordType:${McsfsortSort002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort002SortInRecordLen:${McsfsortSort002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort002SortIn Read: {}",e.getMessage()); 
  		}
  	}
