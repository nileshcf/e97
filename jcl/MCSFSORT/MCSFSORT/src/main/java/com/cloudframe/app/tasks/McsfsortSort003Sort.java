...
import com.cloudframe.app.sort.file.McsfsortSort003SortOut;
import com.cloudframe.app.sort.file.McsfsortSort003SortIn;
...
import com.cloudframe.app.sort.file.records.McsfsortSort003Keys;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.process.BaseProcess;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import org.springframework.beans.factory.annotation.Autowired;
import com.cloudframe.app.sort.McsfsortSort003Detail;
...
public class McsfsortSort003Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort003Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcsfsortsort003")
	McsfsortSort003Detail sortDetail;
	
	@Autowired
	@Qualifier("McsfsortSort003SortOut")
	McsfsortSort003SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McsfsortSort003SortIn")
	McsfsortSort003SortIn sortIn;
	...
	List<McsfsortSort003Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: MCSFSORTSORT003 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			McsfsortSort003Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort003Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort003Keys relKey = new McsfsortSort003Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McsfsortSort003Keys.getKeyBinary1Comparator(true/*isAscending*/)               
                   .thenComparing(McsfsortSort003Keys.getKeyBinary2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McsfsortSort003Keys> sortComp = sortDetail.getSortComp();
