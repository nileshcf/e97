  ...
  @Component("McsfsortSort004SortIn")
  @JobScope
  public class McsfsortSort004SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort004SortIn.class);
  	@Value("${McsfsortSort004SortIn:CLOUDFRM.MC.SORT.IN004}")
  	...
  	@Value("#{'${McsfsortSort004SortInRecordType:${McsfsortSort004SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort004SortInRecordLen:${McsfsortSort004SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort004SortIn Read: {}",e.getMessage()); 
  		}
  	}
