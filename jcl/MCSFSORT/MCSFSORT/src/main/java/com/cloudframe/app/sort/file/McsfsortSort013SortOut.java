  ...
  @Component("McsfsortSort013SortOut")
  @JobScope
  public class McsfsortSort013SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort013SortOut.class);
  	@Value("${McsfsortSort013SortOut:CLOUDFRM.MC.SORT.OUT013}")
      ...
      @Value("#{'${McsfsortSort013SortOutRecordType:${McsfsortSort013SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort013SortOutRecordLen:${McsfsortSort013SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort013SortOut Write: {}",e.getMessage()); 		
  		}
  	}
