...
import com.cloudframe.app.sort.file.McsfsortSort018SortIn0;
import java.io.File;
import com.cloudframe.app.utility.CFUtil;
import java.util.stream.Collectors;
import com.cloudframe.app.data.Field;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.sort.file.McsfsortSort018SortIn1;
...
import com.cloudframe.app.sort.file.McsfsortSort018SortOut;
...
import com.cloudframe.app.sort.McsfsortSort018Detail;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
import com.cloudframe.app.sort.strategy.SortPathStrategy;
public class McsfsortSort018Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort018Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcsfsortsort018")
	McsfsortSort018Detail sortDetail;
	
	@Autowired
	@Qualifier("McsfsortSort018SortOut")
	McsfsortSort018SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McsfsortSort018SortIn0")
	McsfsortSort018SortIn0 sortIn0;
	
	@Autowired
	@Qualifier("McsfsortSort018SortIn1")
	McsfsortSort018SortIn1 sortIn1;
	...
	List<McsfsortSort018Keys> sortRecKeys = null;
...
logger.info("STEPNAME: MCSFSORTSORT018 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			McsfsortSort018Keys k = sortRecKeys.get(index);
           if (isWriteInTempFile()) {
...
private void processJoinKeys2() throws Exception {	
	...
	public void processReformat() throws Exception {
       ...
       List<InMemoryKeySortKeyObject> joinRecKeys2 =  sortDetail.getJn2RecKeys().stream()
    	...
    	for (int i=0; i<joinRecKeys2.size(); i++) {
		...
		logger.info("STEPNAME: SORT018 Joinkey Formatter execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), reformatCount);
		clearMemMapFiles();
    ...
    public void reformatbeforeStep() {
     ...
     public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) { 
		List<McsfsortSort018Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort018Keys relKey = new McsfsortSort018Keys();
