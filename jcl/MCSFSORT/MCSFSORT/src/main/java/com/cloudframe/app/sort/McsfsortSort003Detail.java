...
@Component("batch_mcsfsortsort003")
@JobScope
public class McsfsortSort003Detail {

	private List<McsfsortSort003Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort003Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort003Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort003Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort003Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort003Keys> sortComp) {
