  ...
  @Component("McsfsortSort006SortIn")
  @JobScope
  public class McsfsortSort006SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort006SortIn.class);
  	@Value("${McsfsortSort006SortIn:CLOUDFRM.MC.SORT.IN006}")
  	...
  	@Value("#{'${McsfsortSort006SortInRecordType:${McsfsortSort006SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort006SortInRecordLen:${McsfsortSort006SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort006SortIn Read: {}",e.getMessage()); 
  		}
  	}
