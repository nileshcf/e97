  ...
  @Component("McsfsortSort016SortOut1")
  @JobScope
  public class McsfsortSort016SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort016SortOut1.class);
  	@Value("${McsfsortSort016SortOut[1]:CLOUDFRM.MC.SORT.OUT016.SORTUN01}")
      ...
      @Value("#{'${McsfsortSort016SortOut1RecordType:${McsfsortSort016SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort016SortOut1RecordLen:${McsfsortSort016SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort016SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
