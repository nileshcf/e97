  ...
  @Component("McsfsortSort012SortOut1")
  @JobScope
  public class McsfsortSort012SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort012SortOut1.class);
  	@Value("${McsfsortSort012SortOut[1]:CLOUDFRM.MC.SORT.OUT0122}")
      ...
      @Value("#{'${McsfsortSort012SortOut1RecordType:${McsfsortSort012SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort012SortOut1RecordLen:${McsfsortSort012SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort012SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
