  ...
  @Component("McsfsortSort009SortOut")
  @JobScope
  public class McsfsortSort009SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort009SortOut.class);
  	@Value("${McsfsortSort009SortOut:CLOUDFRM.MC.SORT.OUT009}")
      ...
      @Value("#{'${McsfsortSort009SortOutRecordType:${McsfsortSort009SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort009SortOutRecordLen:${McsfsortSort009SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort009SortOut Write: {}",e.getMessage()); 		
  		}
  	}
