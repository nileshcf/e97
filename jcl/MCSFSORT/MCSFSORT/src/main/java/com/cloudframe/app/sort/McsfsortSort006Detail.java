...
@Component("batch_mcsfsortsort006")
@JobScope
public class McsfsortSort006Detail {

	private List<McsfsortSort006Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort006Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort006Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort006Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort006Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort006Keys> sortComp) {
