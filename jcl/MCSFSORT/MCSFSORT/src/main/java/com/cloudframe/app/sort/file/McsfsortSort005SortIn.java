  ...
  @Component("McsfsortSort005SortIn")
  @JobScope
  public class McsfsortSort005SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort005SortIn.class);
  	@Value("${McsfsortSort005SortIn:CLOUDFRM.MC.SORT.IN005}")
  	...
  	@Value("#{'${McsfsortSort005SortInRecordType:${McsfsortSort005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort005SortInRecordLen:${McsfsortSort005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort005SortIn Read: {}",e.getMessage()); 
  		}
  	}
