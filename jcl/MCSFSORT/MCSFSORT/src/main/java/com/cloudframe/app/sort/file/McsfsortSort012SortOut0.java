  ...
  @Component("McsfsortSort012SortOut0")
  @JobScope
  public class McsfsortSort012SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort012SortOut0.class);
  	@Value("${McsfsortSort012SortOut[0]:CLOUDFRM.MC.SORT.OUT0121}")
      ...
      @Value("#{'${McsfsortSort012SortOut0RecordType:${McsfsortSort012SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort012SortOut0RecordLen:${McsfsortSort012SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort012SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
