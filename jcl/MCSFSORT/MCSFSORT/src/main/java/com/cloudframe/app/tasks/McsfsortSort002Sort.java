...
import com.cloudframe.app.sort.file.records.McsfsortSort002Keys;
import org.springframework.batch.core.ExitStatus;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import com.cloudframe.app.sort.file.McsfsortSort002SortOut;
...
import com.cloudframe.app.sort.McsfsortSort002Detail;
import org.springframework.batch.repeat.RepeatStatus;
import com.cloudframe.app.sort.file.McsfsortSort002SortIn;
import com.cloudframe.app.sort.file.McsfsortSort002SortIn;
...
public class McsfsortSort002Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort002Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcsfsortsort002")
	McsfsortSort002Detail sortDetail;
	
	@Autowired
	@Qualifier("McsfsortSort002SortOut")
	McsfsortSort002SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McsfsortSort002SortIn")
	McsfsortSort002SortIn sortIn;
	...
	List<McsfsortSort002Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: MCSFSORTSORT002 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			McsfsortSort002Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort002Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort002Keys relKey = new McsfsortSort002Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McsfsortSort002Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(McsfsortSort002Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McsfsortSort002Keys> sortComp = sortDetail.getSortComp();
