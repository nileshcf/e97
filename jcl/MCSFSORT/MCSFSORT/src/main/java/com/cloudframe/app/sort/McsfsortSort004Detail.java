...
@Component("batch_mcsfsortsort004")
@JobScope
public class McsfsortSort004Detail {

	private List<McsfsortSort004Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort004Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort004Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort004Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort004Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort004Keys> sortComp) {
