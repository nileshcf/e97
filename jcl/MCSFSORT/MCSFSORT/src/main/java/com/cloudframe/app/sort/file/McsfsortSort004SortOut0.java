  ...
  @Component("McsfsortSort004SortOut0")
  @JobScope
  public class McsfsortSort004SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort004SortOut0.class);
  	@Value("${McsfsortSort004SortOut[0]:CLOUDFRM.MC.SORT.OUT0041}")
      ...
      @Value("#{'${McsfsortSort004SortOut0RecordType:${McsfsortSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort004SortOut0RecordLen:${McsfsortSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort004SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
