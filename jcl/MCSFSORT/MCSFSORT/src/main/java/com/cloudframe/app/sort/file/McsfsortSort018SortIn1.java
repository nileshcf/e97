  ...
  @Component("McsfsortSort018SortIn1")
  @JobScope
  public class McsfsortSort018SortIn1 extends CFFile {
  	@Value("${McsfsortSort018SortIn[1]:CLOUDFRM.MC.SORT.S018JNF2}")
  	...
  	@Value("#{'${McsfsortSort018SortIn1RecordType:${McsfsortSort018SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort018SortIn1RecordLen:${McsfsortSort018SortInRecordLen:80}}'}")
