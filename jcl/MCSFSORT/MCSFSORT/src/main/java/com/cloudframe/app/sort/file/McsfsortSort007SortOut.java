  ...
  @Component("McsfsortSort007SortOut")
  @JobScope
  public class McsfsortSort007SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort007SortOut.class);
  	@Value("${McsfsortSort007SortOut:CLOUDFRM.MC.SORT.OUT007}")
      ...
      @Value("#{'${McsfsortSort007SortOutRecordType:${McsfsortSort007SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort007SortOutRecordLen:${McsfsortSort007SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort007SortOut Write: {}",e.getMessage()); 		
  		}
  	}
