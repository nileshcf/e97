...
@Component("batch_mcsfsortsort012")
@JobScope
public class McsfsortSort012Detail {

	private List<McsfsortSort012Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort012Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort012Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort012Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort012Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort012Keys> sortComp) {
