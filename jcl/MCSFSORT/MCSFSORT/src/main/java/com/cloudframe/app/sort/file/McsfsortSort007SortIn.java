  ...
  @Component("McsfsortSort007SortIn")
  @JobScope
  public class McsfsortSort007SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort007SortIn.class);
  	@Value("${McsfsortSort007SortIn:CLOUDFRM.MC.SORT.IN007}")
  	...
  	@Value("#{'${McsfsortSort007SortInRecordType:${McsfsortSort007SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort007SortInRecordLen:${McsfsortSort007SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort007SortIn Read: {}",e.getMessage()); 
  		}
  	}
