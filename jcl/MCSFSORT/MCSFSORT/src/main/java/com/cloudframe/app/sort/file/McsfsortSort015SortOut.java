  ...
  @Component("McsfsortSort015SortOut")
  @JobScope
  public class McsfsortSort015SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort015SortOut.class);
  	@Value("${McsfsortSort015SortOut:CLOUDFRM.MC.SORT.OUT015}")
      ...
      @Value("#{'${McsfsortSort015SortOutRecordType:${McsfsortSort015SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort015SortOutRecordLen:${McsfsortSort015SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort015SortOut Write: {}",e.getMessage()); 		
  		}
  	}
