  ...
  @Component("McsfsortSort008SortOut")
  @JobScope
  public class McsfsortSort008SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort008SortOut.class);
  	@Value("${McsfsortSort008SortOut:CLOUDFRM.MC.SORT.OUT008}")
      ...
      @Value("#{'${McsfsortSort008SortOutRecordType:${McsfsortSort008SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort008SortOutRecordLen:${McsfsortSort008SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 180;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort008SortOut Write: {}",e.getMessage()); 		
  		}
  	}
