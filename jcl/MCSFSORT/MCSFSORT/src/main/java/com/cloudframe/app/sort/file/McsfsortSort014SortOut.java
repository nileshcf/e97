  ...
  @Component("McsfsortSort014SortOut")
  @JobScope
  public class McsfsortSort014SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort014SortOut.class);
  	@Value("${McsfsortSort014SortOut:CLOUDFRM.MC.SORT.OUT014}")
      ...
      @Value("#{'${McsfsortSort014SortOutRecordType:${McsfsortSort014SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort014SortOutRecordLen:${McsfsortSort014SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort014SortOut Write: {}",e.getMessage()); 		
  		}
  	}
