  ...
  @Component("McsfsortSort006SortOut")
  @JobScope
  public class McsfsortSort006SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort006SortOut.class);
  	@Value("${McsfsortSort006SortOut:CLOUDFRM.MC.SORT.OUT006}")
      ...
      @Value("#{'${McsfsortSort006SortOutRecordType:${McsfsortSort006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort006SortOutRecordLen:${McsfsortSort006SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 900;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort006SortOut Write: {}",e.getMessage()); 		
  		}
  	}
