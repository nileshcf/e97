...
@Component("batch_mcsfsortsort007")
@JobScope
public class McsfsortSort007Detail {

	private List<McsfsortSort007Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort007Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort007Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort007Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort007Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort007Keys> sortComp) {
