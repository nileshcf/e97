  ...
  @Component("McsfsortSort011SortOut")
  @JobScope
  public class McsfsortSort011SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort011SortOut.class);
  	@Value("${McsfsortSort011SortOut:CLOUDFRM.MC.SORT.OUT011}")
      ...
      @Value("#{'${McsfsortSort011SortOutRecordType:${McsfsortSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McsfsortSort011SortOutRecordLen:${McsfsortSort011SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 2000;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McsfsortSort011SortOut Write: {}",e.getMessage()); 		
  		}
  	}
