  ...
  @Component("McsfsortSort015SortIn0")
  @JobScope
  public class McsfsortSort015SortIn0 extends CFFile {
  	@Value("${McsfsortSort015SortIn[0]:CLOUDFRM.MC.SORT.S015JNF1}")
  	...
  	@Value("#{'${McsfsortSort015SortIn0RecordType:${McsfsortSort015SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort015SortIn0RecordLen:${McsfsortSort015SortInRecordLen:80}}'}")
