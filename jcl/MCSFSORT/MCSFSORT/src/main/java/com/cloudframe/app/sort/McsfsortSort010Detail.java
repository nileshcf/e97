...
@Component("batch_mcsfsortsort010")
@JobScope
public class McsfsortSort010Detail {

	private List<McsfsortSort010Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort010Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort010Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort010Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort010Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort010Keys> sortComp) {
