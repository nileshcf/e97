...
public class McsfsortSort013InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort013InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
    ...
    int recCounter = 0;
	static final int KEY_POS0 = 8;
	static final int KEY_POS1 = 11;
	static final int KEY_LEN0 = 3;
	static final int KEY_LEN1 = 6;
     byte[] filter1 = convertChar2EbcdicBytes("1000".toCharArray());
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort013Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort013Keys relKey = new McsfsortSort013Keys();
    ...
    protected void addSortRecordBytes(byte[] record){ 
	   if(((Field.compareBytes(record,filter1,80,0,4,4) > 0))) {
