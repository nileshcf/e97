...
import com.cloudframe.app.sort.file.records.McsfsortSort017JoinKeys;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.data.Field;

@Component("batch_mcsfsortsort017")
@JobScope
public class McsfsortSort017Detail {

	private List<McsfsortSort017Keys> sortRecKeys = null;
	private List<McsfsortSort017JoinKeys> joinRecKey1 = null;
	private List<McsfsortSort017JoinKeys> joinRecKey2 = null;
	private Comparator<McsfsortSort017JoinKeys> joinkeyComp = null;
	...
	private Comparator<McsfsortSort017Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort017JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McsfsortSort017JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McsfsortSort017JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McsfsortSort017JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McsfsortSort017JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McsfsortSort017JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McsfsortSort017Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort017Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort017Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort017Keys> sortComp) {
