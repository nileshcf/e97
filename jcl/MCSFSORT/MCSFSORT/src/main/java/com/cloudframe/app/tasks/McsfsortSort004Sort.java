...
import com.cloudframe.app.sort.McsfsortSort004Detail;
import org.springframework.beans.factory.annotation.Value;
public class McsfsortSort004Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(McsfsortSort004Sort.class);
