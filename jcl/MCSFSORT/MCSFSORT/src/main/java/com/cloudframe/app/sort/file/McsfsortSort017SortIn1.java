  ...
  @Component("McsfsortSort017SortIn1")
  @JobScope
  public class McsfsortSort017SortIn1 extends CFFile {
  	@Value("${McsfsortSort017SortIn[1]:CLOUDFRM.MC.SORT.S017JNF2}")
  	...
  	@Value("#{'${McsfsortSort017SortIn1RecordType:${McsfsortSort017SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort017SortIn1RecordLen:${McsfsortSort017SortInRecordLen:80}}'}")
