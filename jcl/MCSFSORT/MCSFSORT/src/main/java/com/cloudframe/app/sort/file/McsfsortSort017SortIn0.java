  ...
  @Component("McsfsortSort017SortIn0")
  @JobScope
  public class McsfsortSort017SortIn0 extends CFFile {
  	@Value("${McsfsortSort017SortIn[0]:CLOUDFRM.MC.SORT.S017JNF1}")
  	...
  	@Value("#{'${McsfsortSort017SortIn0RecordType:${McsfsortSort017SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort017SortIn0RecordLen:${McsfsortSort017SortInRecordLen:80}}'}")
