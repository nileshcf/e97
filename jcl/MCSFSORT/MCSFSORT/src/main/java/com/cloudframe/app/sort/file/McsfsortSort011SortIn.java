  ...
  @Component("McsfsortSort011SortIn")
  @JobScope
  public class McsfsortSort011SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McsfsortSort011SortIn.class);
  	@Value("${McsfsortSort011SortIn:CLOUDFRM.MC.SORT.IN011}")
  	...
  	@Value("#{'${McsfsortSort011SortInRecordType:${McsfsortSort011SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McsfsortSort011SortInRecordLen:${McsfsortSort011SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McsfsortSort011SortIn Read: {}",e.getMessage()); 
  		}
  	}
