...
@Component("batch_mcsfsortsort014")
@JobScope
public class McsfsortSort014Detail {

	private List<McsfsortSort014Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McsfsortSort014Keys> sortComp = null;
	 ...
	 */
	public List<McsfsortSort014Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McsfsortSort014Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McsfsortSort014Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McsfsortSort014Keys> sortComp) {
