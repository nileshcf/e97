...
import com.cloudframe.app.sort.file.McsfsortSort007SortIn;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.process.BaseProcess;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import com.cloudframe.app.sort.file.McsfsortSort007SortOut;
import org.springframework.beans.factory.annotation.Autowired;
import java.io.FileNotFoundException;
import java.util.Arrays; 
import org.springframework.batch.core.StepExecutionListener;
import com.cloudframe.app.sort.McsfsortSort007Detail;
import org.springframework.batch.core.StepExecution;
import com.cloudframe.app.sort.file.records.McsfsortSort007Keys;
...
public class McsfsortSort007Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McsfsortSort007Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcsfsortsort007")
	McsfsortSort007Detail sortDetail;
	
	@Autowired
	@Qualifier("McsfsortSort007SortOut")
	McsfsortSort007SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McsfsortSort007SortIn")
	McsfsortSort007SortIn sortIn;
	...
	List<McsfsortSort007Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: MCSFSORTSORT007 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			McsfsortSort007Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McsfsortSort007Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McsfsortSort007Keys relKey = new McsfsortSort007Keys();
    ...
    protected void addSortRecordBytes(byte[] record){ 
	   if(((Field.compareByte(record[15],(byte)8) == 0))) {
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McsfsortSort007Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McsfsortSort007Keys> sortComp = sortDetail.getSortComp();
