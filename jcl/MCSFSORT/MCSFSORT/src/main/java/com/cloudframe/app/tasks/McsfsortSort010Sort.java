...
import com.cloudframe.app.sort.McsfsortSort010Detail;
import org.springframework.beans.factory.annotation.Value;
public class McsfsortSort010Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(McsfsortSort010Sort.class);
