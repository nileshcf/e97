...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step001":
 		    	   		SpringContextHandler.handleDispPostion("STEP001.IEBGENER.Sysut2","STEP001.IEBGENER.Sysut2.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP001.IEBGENER.Sysut3","STEP001.IEBGENER.Sysut3.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP001.IEBGENER.Sysut4","STEP001.IEBGENER.Sysut4.DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP001.IEBGENER.Sysut5","STEP001.IEBGENER.Sysut5.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : IEBGEN01 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : IEBGEN01 ENDED -  ABEND={}", abendCode);
      } 
