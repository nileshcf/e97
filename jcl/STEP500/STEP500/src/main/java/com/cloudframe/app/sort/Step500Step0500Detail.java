...
@Component("batch_step500step0500")
@JobScope
public class Step500Step0500Detail {

	private List<Step500Step0500Keys> sortRecKeys = null;
	private List<Step500Step0500JoinKeys> joinRecKey1 = null;
	private List<Step500Step0500JoinKeys> joinRecKey2 = null;
	private Comparator<Step500Step0500JoinKeys> joinkeyComp = null;
	...
	private Comparator<Step500Step0500Keys> sortComp = null;
	 ...
	 */
	public List<Step500Step0500JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<Step500Step0500JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<Step500Step0500JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<Step500Step0500JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<Step500Step0500JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<Step500Step0500JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<Step500Step0500Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Step500Step0500Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Step500Step0500Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Step500Step0500Keys> sortComp) {
