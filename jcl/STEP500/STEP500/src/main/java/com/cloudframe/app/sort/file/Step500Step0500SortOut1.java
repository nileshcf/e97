  ...
  @Component("Step500Step0500SortOut1")
  @JobScope
  public class Step500Step0500SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Step500Step0500SortOut1.class);
  	@Value("${Step500Step0500SortOut[1]:FILE2.SECFILE.MOCK.OUTPUT}")
      ...
      @Value("#{'${Step500Step0500SortOut1RecordType:${Step500Step0500SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Step500Step0500SortOut1RecordLen:${Step500Step0500SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Step500Step0500SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
