...
public class Step500Step0500JoinkeyFormatter extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(Step500Step0500JoinkeyFormatter.class);
	...
	public ExitStatus afterStep(StepExecution stepExecution) {
		logger.info("STEPNAME: STEP500STEP0500 Joinkey Formatter execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), reformatCount);
	    clearMemoryMapFile();
