...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public Step500Step0500Sort step500Step0500Sort() {
    	return new Step500Step0500Sort();
    }
    
    @Bean
    @JobScope
    protected Step Step500Step0500Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Step500Step0500Sort",jobRepository).tasklet(step500Step0500Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step0500Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step0500Executor")
             ...
             .to(Step500Step0500Sort(jobRepository, transactionManager))
