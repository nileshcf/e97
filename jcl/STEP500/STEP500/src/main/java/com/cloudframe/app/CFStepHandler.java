...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP0500 = "step0500";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step0500":  /* setting the disp position for file(s) info for this step(STEP0500). */
                         SpringContextHandler.setFileDispPosition("Step500Step0500SortIn0","Step500Step0500SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Step500Step0500SortIn1","Step500Step0500SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Step500Step0500SortOut0","Step500Step0500SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("Step500Step0500SortOut1","Step500Step0500SortOut[1].DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : STEP500 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : STEP500 ENDED -  ABEND={}", abendCode);
      } 
