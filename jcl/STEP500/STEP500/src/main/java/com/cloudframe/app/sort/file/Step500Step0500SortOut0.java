  ...
  @Component("Step500Step0500SortOut0")
  @JobScope
  public class Step500Step0500SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Step500Step0500SortOut0.class);
  	@Value("${Step500Step0500SortOut[0]:FILE1.DTLFILE.MOCK.OUTPUT}")
      ...
      @Value("#{'${Step500Step0500SortOut0RecordType:${Step500Step0500SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Step500Step0500SortOut0RecordLen:${Step500Step0500SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Step500Step0500SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
