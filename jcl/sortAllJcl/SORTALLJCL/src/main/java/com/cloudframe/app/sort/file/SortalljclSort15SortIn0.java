  ...
  @Component("SortalljclSort15SortIn0")
  @JobScope
  public class SortalljclSort15SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort15SortIn0.class);
  	@Value("${SortalljclSort15SortIn[0]:CLOUDFRM.JPM.SORT.INPUT151}")
  	...
  	@Value("#{'${SortalljclSort15SortIn0RecordType:${SortalljclSort15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort15SortIn0RecordLen:${SortalljclSort15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort15SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
