...
@Component("batch_sortalljclsort10")
@JobScope
public class SortalljclSort10Detail {

	private List<SortalljclSort10Keys> sortRecKeys = null;
	private Set<SortalljclSort10Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort10Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort10Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort10Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort10Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort10Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort10Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort10Keys> sortComp) {
