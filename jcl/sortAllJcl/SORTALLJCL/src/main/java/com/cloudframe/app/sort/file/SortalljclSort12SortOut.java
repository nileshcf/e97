  ...
  @Component("SortalljclSort12SortOut")
  @JobScope
  public class SortalljclSort12SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort12SortOut.class);
  	@Value("${SortalljclSort12SortOut:CLOUDFRM.JPM.SORT.OUTPUT12}")
      ...
      @Value("#{'${SortalljclSort12SortOutRecordType:${SortalljclSort12SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort12SortOutRecordLen:${SortalljclSort12SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort12SortOut Write: {}",e.getMessage()); 		
  		}
  	}
