  ...
  @Component("SortalljclSort9SortOut")
  @JobScope
  public class SortalljclSort9SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort9SortOut.class);
  	@Value("${SortalljclSort9SortOut:CLOUDFRM.JPM.SORT.OUTPUT9}")
      ...
      @Value("#{'${SortalljclSort9SortOutRecordType:${SortalljclSort9SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort9SortOutRecordLen:${SortalljclSort9SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 8;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort9SortOut Write: {}",e.getMessage()); 		
  		}
  	}
