...
public class SortalljclSort20Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SortalljclSort20Processor.class);
