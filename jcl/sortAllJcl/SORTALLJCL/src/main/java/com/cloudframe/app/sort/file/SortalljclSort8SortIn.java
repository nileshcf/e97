  ...
  @Component("SortalljclSort8SortIn")
  @JobScope
  public class SortalljclSort8SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort8SortIn.class);
  	@Value("${SortalljclSort8SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort8SortInRecordType:${SortalljclSort8SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort8SortInRecordLen:${SortalljclSort8SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort8SortIn Read: {}",e.getMessage()); 
  		}
  	}
