...
import java.io.File;
import com.cloudframe.app.sort.file.records.SortalljclSort1Keys;
...
import com.cloudframe.app.sort.file.SortalljclSort1SortIn;
import java.io.RandomAccessFile;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.process.BaseProcess;
import com.cloudframe.app.sort.SortalljclSort1Detail;
import com.cloudframe.app.sort.file.SortalljclSort1SortOut;
...
public class SortalljclSort1Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort1Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort1")
	SortalljclSort1Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort1SortOut")
	SortalljclSort1SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort1SortIn")
	SortalljclSort1SortIn sortIn;
	...
	List<SortalljclSort1Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort1");
...
logger.info("STEPNAME: SORTALLJCLSORT1 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort1Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort1Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort1Keys relKey = new SortalljclSort1Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort1Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SortalljclSort1Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort1Keys> sortComp = sortDetail.getSortComp();
