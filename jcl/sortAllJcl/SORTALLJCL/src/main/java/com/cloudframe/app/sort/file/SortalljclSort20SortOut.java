  ...
  @Component("SortalljclSort20SortOut")
  @JobScope
  public class SortalljclSort20SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort20SortOut.class);
  	@Value("${SortalljclSort20SortOut:CLOUDFRM.JPM.SORT.OUTPUT20}")
      ...
      @Value("#{'${SortalljclSort20SortOutRecordType:${SortalljclSort20SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort20SortOutRecordLen:${SortalljclSort20SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort20SortOut Write: {}",e.getMessage()); 		
  		}
  	}
