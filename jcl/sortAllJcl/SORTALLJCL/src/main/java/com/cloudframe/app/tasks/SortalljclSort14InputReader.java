...
public class SortalljclSort14InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort14InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SortalljclSort14Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SortalljclSort14Keys relKey = new SortalljclSort14Keys();
