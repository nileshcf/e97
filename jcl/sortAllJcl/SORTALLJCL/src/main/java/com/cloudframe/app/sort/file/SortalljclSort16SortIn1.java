  ...
  @Component("SortalljclSort16SortIn1")
  @JobScope
  public class SortalljclSort16SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort16SortIn1.class);
  	@Value("${SortalljclSort16SortIn[1]:CLOUDFRM.JPM.SORT.INPUT162}")
  	...
  	@Value("#{'${SortalljclSort16SortIn1RecordType:${SortalljclSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort16SortIn1RecordLen:${SortalljclSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort16SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
