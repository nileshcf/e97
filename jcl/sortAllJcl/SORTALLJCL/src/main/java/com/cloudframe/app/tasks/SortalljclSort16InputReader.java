...
public class SortalljclSort16InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort16InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SortalljclSort16Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SortalljclSort16Keys relKey = new SortalljclSort16Keys();
