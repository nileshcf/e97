...
@Component("batch_sortalljclsort15")
@JobScope
public class SortalljclSort15Detail {

	private List<SortalljclSort15Keys> sortRecKeys = null;
	private Set<SortalljclSort15Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort15Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort15Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort15Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort15Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort15Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort15Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort15Keys> sortComp) {
