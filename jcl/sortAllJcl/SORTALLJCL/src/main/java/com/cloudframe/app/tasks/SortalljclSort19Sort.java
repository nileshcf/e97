...
import com.cloudframe.app.sort.file.records.SortalljclSort19Keys;
import com.cloudframe.app.sort.file.SortalljclSort19SortIn;
...
import com.cloudframe.app.sort.file.SortalljclSort19SortOut;
...
import com.cloudframe.app.sort.SortalljclSort19Detail;
...
public class SortalljclSort19Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort19Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort19")
	SortalljclSort19Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort19SortOut")
	SortalljclSort19SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort19SortIn")
	SortalljclSort19SortIn sortIn;
	...
	List<SortalljclSort19Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort19");
...
logger.info("STEPNAME: SORTALLJCLSORT19 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort19Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort19Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort19Keys relKey = new SortalljclSort19Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort19Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SortalljclSort19Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort19Keys> sortComp = sortDetail.getSortComp();
