...
import com.cloudframe.app.sort.file.SortalljclSort18SortIn;
...
import com.cloudframe.app.sort.file.records.SortalljclSort18Keys;
import com.cloudframe.app.sort.file.SortalljclSort18SortOut;
...
import com.cloudframe.app.sort.SortalljclSort18Detail;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SortalljclSort18Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort18Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort18")
	SortalljclSort18Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort18SortOut")
	SortalljclSort18SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort18SortIn")
	SortalljclSort18SortIn sortIn;
	...
	List<SortalljclSort18Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort18");
...
logger.info("STEPNAME: SORTALLJCLSORT18 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort18Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort18Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort18Keys relKey = new SortalljclSort18Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort18Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort18Keys> sortComp = sortDetail.getSortComp();
