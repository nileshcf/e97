...
import com.cloudframe.app.sort.SortalljclSort16Detail;
import org.springframework.beans.factory.annotation.Value;
public class SortalljclSort16Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(SortalljclSort16Sort.class);
