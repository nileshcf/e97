  ...
  @Component("SortalljclSort2SortOut")
  @JobScope
  public class SortalljclSort2SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort2SortOut.class);
  	@Value("${SortalljclSort2SortOut:CLOUDFRM.JPM.SORT.OUTPUT2}")
      ...
      @Value("#{'${SortalljclSort2SortOutRecordType:${SortalljclSort2SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort2SortOutRecordLen:${SortalljclSort2SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort2SortOut Write: {}",e.getMessage()); 		
  		}
  	}
