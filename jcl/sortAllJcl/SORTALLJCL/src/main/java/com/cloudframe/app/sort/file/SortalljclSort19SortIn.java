  ...
  @Component("SortalljclSort19SortIn")
  @JobScope
  public class SortalljclSort19SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort19SortIn.class);
  	@Value("${SortalljclSort19SortIn:CLOUDFRM.JPM.SORT.INPUT19}")
  	...
  	@Value("#{'${SortalljclSort19SortInRecordType:${SortalljclSort19SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort19SortInRecordLen:${SortalljclSort19SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort19SortIn Read: {}",e.getMessage()); 
  		}
  	}
