...
@Component("batch_sortalljclsort1")
@JobScope
public class SortalljclSort1Detail {

	private List<SortalljclSort1Keys> sortRecKeys = null;
	private Set<SortalljclSort1Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort1Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort1Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort1Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort1Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort1Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort1Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort1Keys> sortComp) {
