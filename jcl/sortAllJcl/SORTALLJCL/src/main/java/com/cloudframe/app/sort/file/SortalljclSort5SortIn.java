  ...
  @Component("SortalljclSort5SortIn")
  @JobScope
  public class SortalljclSort5SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort5SortIn.class);
  	@Value("${SortalljclSort5SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort5SortInRecordType:${SortalljclSort5SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort5SortInRecordLen:${SortalljclSort5SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort5SortIn Read: {}",e.getMessage()); 
  		}
  	}
