  ...
  @Component("SortalljclSort16SortOut")
  @JobScope
  public class SortalljclSort16SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort16SortOut.class);
  	@Value("${SortalljclSort16SortOut:CLOUDFRM.JPM.SORT.OUTPUT16}")
      ...
      @Value("#{'${SortalljclSort16SortOutRecordType:${SortalljclSort16SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort16SortOutRecordLen:${SortalljclSort16SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort16SortOut Write: {}",e.getMessage()); 		
  		}
  	}
