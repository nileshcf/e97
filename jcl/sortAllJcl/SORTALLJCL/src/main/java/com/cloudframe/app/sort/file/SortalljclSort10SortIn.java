  ...
  @Component("SortalljclSort10SortIn")
  @JobScope
  public class SortalljclSort10SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort10SortIn.class);
  	@Value("${SortalljclSort10SortIn:CLOUDFRM.JPM.SORT.INPUT10}")
  	...
  	@Value("#{'${SortalljclSort10SortInRecordType:${SortalljclSort10SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort10SortInRecordLen:${SortalljclSort10SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort10SortIn Read: {}",e.getMessage()); 
  		}
  	}
