...
@Component("batch_sortalljclsort4")
@JobScope
public class SortalljclSort4Detail {

	private List<SortalljclSort4Keys> sortRecKeys = null;
	private Set<SortalljclSort4Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort4Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort4Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort4Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort4Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort4Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort4Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort4Keys> sortComp) {
