...
@Component("batch_sortalljclsort9")
@JobScope
public class SortalljclSort9Detail {

	private List<SortalljclSort9Keys> sortRecKeys = null;
	private Set<SortalljclSort9Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort9Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort9Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort9Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort9Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort9Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort9Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort9Keys> sortComp) {
