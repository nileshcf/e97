...
@Component("batch_sortalljclsort11")
@JobScope
public class SortalljclSort11Detail {

	private List<SortalljclSort11Keys> sortRecKeys = null;
	private Set<SortalljclSort11Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort11Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort11Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort11Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort11Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort11Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort11Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort11Keys> sortComp) {
