  ...
  @Component("SortalljclSort11SortIn")
  @JobScope
  public class SortalljclSort11SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort11SortIn.class);
  	@Value("${SortalljclSort11SortIn:CLOUDFRM.JPM.SORT.INPUT11}")
  	...
  	@Value("#{'${SortalljclSort11SortInRecordType:${SortalljclSort11SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort11SortInRecordLen:${SortalljclSort11SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort11SortIn Read: {}",e.getMessage()); 
  		}
  	}
