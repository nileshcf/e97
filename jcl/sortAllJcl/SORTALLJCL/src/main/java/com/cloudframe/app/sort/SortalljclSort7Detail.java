...
@Component("batch_sortalljclsort7")
@JobScope
public class SortalljclSort7Detail {

	private List<SortalljclSort7Keys> sortRecKeys = null;
	private Set<SortalljclSort7Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort7Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort7Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort7Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort7Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort7Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort7Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort7Keys> sortComp) {
