  ...
  @Component("SortalljclSort1SortIn")
  @JobScope
  public class SortalljclSort1SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort1SortIn.class);
  	@Value("${SortalljclSort1SortIn:CLOUDFRM.JPM.SORT.INPUT1}")
  	...
  	@Value("#{'${SortalljclSort1SortInRecordType:${SortalljclSort1SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort1SortInRecordLen:${SortalljclSort1SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort1SortIn Read: {}",e.getMessage()); 
  		}
  	}
