  ...
  @Component("SortalljclSort12SortIn")
  @JobScope
  public class SortalljclSort12SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort12SortIn.class);
  	@Value("${SortalljclSort12SortIn:CLOUDFRM.JPM.SORT.INPUT12}")
  	...
  	@Value("#{'${SortalljclSort12SortInRecordType:${SortalljclSort12SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort12SortInRecordLen:${SortalljclSort12SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort12SortIn Read: {}",e.getMessage()); 
  		}
  	}
