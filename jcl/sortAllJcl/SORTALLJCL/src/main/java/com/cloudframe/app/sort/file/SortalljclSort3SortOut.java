  ...
  @Component("SortalljclSort3SortOut")
  @JobScope
  public class SortalljclSort3SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort3SortOut.class);
  	@Value("${SortalljclSort3SortOut:CLOUDFRM.JPM.SORT.OUTPUT3}")
      ...
      @Value("#{'${SortalljclSort3SortOutRecordType:${SortalljclSort3SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort3SortOutRecordLen:${SortalljclSort3SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort3SortOut Write: {}",e.getMessage()); 		
  		}
  	}
