  ...
  @Component("SortalljclSort7SortOut")
  @JobScope
  public class SortalljclSort7SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort7SortOut.class);
  	@Value("${SortalljclSort7SortOut:CLOUDFRM.JPM.SORT.OUTPUT7}")
      ...
      @Value("#{'${SortalljclSort7SortOutRecordType:${SortalljclSort7SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort7SortOutRecordLen:${SortalljclSort7SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort7SortOut Write: {}",e.getMessage()); 		
  		}
  	}
