  ...
  @Component("SortalljclSort2SortIn")
  @JobScope
  public class SortalljclSort2SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort2SortIn.class);
  	@Value("${SortalljclSort2SortIn:CLOUDFRM.JPM.SORT.INPUT2}")
  	...
  	@Value("#{'${SortalljclSort2SortInRecordType:${SortalljclSort2SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort2SortInRecordLen:${SortalljclSort2SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort2SortIn Read: {}",e.getMessage()); 
  		}
  	}
