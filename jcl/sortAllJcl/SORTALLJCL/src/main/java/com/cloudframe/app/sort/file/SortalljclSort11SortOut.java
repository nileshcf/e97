  ...
  @Component("SortalljclSort11SortOut")
  @JobScope
  public class SortalljclSort11SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort11SortOut.class);
  	@Value("${SortalljclSort11SortOut:CLOUDFRM.JPM.SORT.OUTPUT11}")
      ...
      @Value("#{'${SortalljclSort11SortOutRecordType:${SortalljclSort11SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort11SortOutRecordLen:${SortalljclSort11SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort11SortOut Write: {}",e.getMessage()); 		
  		}
  	}
