  ...
  @Component("SortalljclSort6SortOut")
  @JobScope
  public class SortalljclSort6SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort6SortOut.class);
  	@Value("${SortalljclSort6SortOut:CLOUDFRM.JPM.SORT.OUTPUT6}")
      ...
      @Value("#{'${SortalljclSort6SortOutRecordType:${SortalljclSort6SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort6SortOutRecordLen:${SortalljclSort6SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 9;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort6SortOut Write: {}",e.getMessage()); 		
  		}
  	}
