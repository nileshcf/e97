...
@Component("batch_sortalljclsort12")
@JobScope
public class SortalljclSort12Detail {

	private List<SortalljclSort12Keys> sortRecKeys = null;
	private Set<SortalljclSort12Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort12Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort12Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort12Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort12Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort12Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort12Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort12Keys> sortComp) {
