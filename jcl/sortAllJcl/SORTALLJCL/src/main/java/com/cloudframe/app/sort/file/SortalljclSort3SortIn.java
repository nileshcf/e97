  ...
  @Component("SortalljclSort3SortIn")
  @JobScope
  public class SortalljclSort3SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort3SortIn.class);
  	@Value("${SortalljclSort3SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort3SortInRecordType:${SortalljclSort3SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort3SortInRecordLen:${SortalljclSort3SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort3SortIn Read: {}",e.getMessage()); 
  		}
  	}
