  ...
  @Component("SortalljclSort8SortOut")
  @JobScope
  public class SortalljclSort8SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort8SortOut.class);
  	@Value("${SortalljclSort8SortOut:CLOUDFRM.JPM.SORT.OUTPUT8}")
      ...
      @Value("#{'${SortalljclSort8SortOutRecordType:${SortalljclSort8SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort8SortOutRecordLen:${SortalljclSort8SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 12;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort8SortOut Write: {}",e.getMessage()); 		
  		}
  	}
