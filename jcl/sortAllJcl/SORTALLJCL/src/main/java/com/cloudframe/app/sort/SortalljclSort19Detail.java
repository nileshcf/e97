...
@Component("batch_sortalljclsort19")
@JobScope
public class SortalljclSort19Detail {

	private List<SortalljclSort19Keys> sortRecKeys = null;
	private Set<SortalljclSort19Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort19Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort19Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort19Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort19Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort19Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort19Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort19Keys> sortComp) {
