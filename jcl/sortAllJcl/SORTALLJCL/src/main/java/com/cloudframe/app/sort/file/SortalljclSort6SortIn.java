  ...
  @Component("SortalljclSort6SortIn")
  @JobScope
  public class SortalljclSort6SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort6SortIn.class);
  	@Value("${SortalljclSort6SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort6SortInRecordType:${SortalljclSort6SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort6SortInRecordLen:${SortalljclSort6SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort6SortIn Read: {}",e.getMessage()); 
  		}
  	}
