...
@Component("batch_sortalljclsort18")
@JobScope
public class SortalljclSort18Detail {

	private List<SortalljclSort18Keys> sortRecKeys = null;
	private Set<SortalljclSort18Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort18Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort18Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort18Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort18Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort18Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort18Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort18Keys> sortComp) {
