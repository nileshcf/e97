...
public class SortalljclSort7OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SortalljclSort7OutputWriter.class);
	@Autowired
