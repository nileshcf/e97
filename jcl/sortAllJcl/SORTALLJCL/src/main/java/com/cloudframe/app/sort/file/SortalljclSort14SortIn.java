  ...
  @Component("SortalljclSort14SortIn")
  @JobScope
  public class SortalljclSort14SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort14SortIn.class);
  	@Value("${SortalljclSort14SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort14SortInRecordType:${SortalljclSort14SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort14SortInRecordLen:${SortalljclSort14SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort14SortIn Read: {}",e.getMessage()); 
  		}
  	}
