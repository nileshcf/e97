  ...
  @Component("SortalljclSort16SortIn0")
  @JobScope
  public class SortalljclSort16SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort16SortIn0.class);
  	@Value("${SortalljclSort16SortIn[0]:CLOUDFRM.JPM.SORT.INPUT161}")
  	...
  	@Value("#{'${SortalljclSort16SortIn0RecordType:${SortalljclSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort16SortIn0RecordLen:${SortalljclSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort16SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
