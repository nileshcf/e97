...
import java.io.File;
import com.cloudframe.app.sort.file.SortalljclSort11SortIn;
import java.util.HashSet;
import java.util.stream.Collectors;
import com.cloudframe.app.data.Field;
import com.cloudframe.app.sort.file.records.SortalljclSort11Keys;
import com.cloudframe.app.sort.file.SortalljclSort11SortIn;
...
import com.cloudframe.app.sort.file.SortalljclSort11SortOut;
import org.springframework.batch.core.StepExecution;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.sort.SortalljclSort11Detail;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SortalljclSort11Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort11Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort11")
	SortalljclSort11Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort11SortOut")
	SortalljclSort11SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort11SortIn")
	SortalljclSort11SortIn sortIn;
	...
	List<SortalljclSort11Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort11");
...
logger.info("STEPNAME: SORTALLJCLSORT11 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort11Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort11Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort11Keys relKey = new SortalljclSort11Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort11Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort11Keys> sortComp = sortDetail.getSortComp();
