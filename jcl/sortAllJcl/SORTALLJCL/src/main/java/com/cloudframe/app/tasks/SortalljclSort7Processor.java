...
public class SortalljclSort7Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SortalljclSort7Processor.class);
