  ...
  @Component("SortalljclSort20SortIn")
  @JobScope
  public class SortalljclSort20SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort20SortIn.class);
  	@Value("${SortalljclSort20SortIn:CLOUDFRM.JPM.SORT.INPUT20}")
  	...
  	@Value("#{'${SortalljclSort20SortInRecordType:${SortalljclSort20SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort20SortInRecordLen:${SortalljclSort20SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort20SortIn Read: {}",e.getMessage()); 
  		}
  	}
