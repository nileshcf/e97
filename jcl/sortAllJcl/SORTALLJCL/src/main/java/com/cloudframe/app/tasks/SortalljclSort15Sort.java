...
import com.cloudframe.app.sort.file.SortalljclSort15SortIn0;
import com.cloudframe.app.sort.SortalljclSort15Detail;
import java.util.Set;
import org.springframework.batch.core.ExitStatus;
import com.cloudframe.app.sort.file.SortalljclSort15SortIn1;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import java.util.HashSet;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.records.SortalljclSort15Keys;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import com.cloudframe.app.sort.file.SortalljclSort15SortOut;
...
public class SortalljclSort15Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort15Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort15")
	SortalljclSort15Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort15SortOut")
	SortalljclSort15SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort15SortIn0")
	SortalljclSort15SortIn0 sortIn0;
	
	@Autowired
	@Qualifier("SortalljclSort15SortIn1")
	SortalljclSort15SortIn1 sortIn1;
	...
	List<SortalljclSort15Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort15");
...
logger.info("STEPNAME: SORTALLJCLSORT15 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort15Keys k = sortRecKeys.get(index);
           if (isWriteInTempFile()) {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort15Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort15Keys relKey = new SortalljclSort15Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort15Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SortalljclSort15Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort15Keys> sortComp = sortDetail.getSortComp();
