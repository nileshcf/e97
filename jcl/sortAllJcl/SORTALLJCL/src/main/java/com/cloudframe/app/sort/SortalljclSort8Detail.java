...
@Component("batch_sortalljclsort8")
@JobScope
public class SortalljclSort8Detail {

	private List<SortalljclSort8Keys> sortRecKeys = null;
	private Set<SortalljclSort8Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort8Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort8Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort8Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort8Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort8Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort8Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort8Keys> sortComp) {
