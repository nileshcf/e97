...
import com.cloudframe.app.sort.SortalljclSort8Detail;
...
import com.cloudframe.app.sort.file.records.SortalljclSort8Keys;

import com.cloudframe.app.sort.file.SortalljclSort8SortIn;
...
import com.cloudframe.app.sort.file.SortalljclSort8SortOut;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SortalljclSort8Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort8Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort8")
	SortalljclSort8Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort8SortOut")
	SortalljclSort8SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort8SortIn")
	SortalljclSort8SortIn sortIn;
	...
	List<SortalljclSort8Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SORTALLJCLSORT8 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort8Keys k = sortRecKeys.get(index);
...
copyRecordBytes(repBytes, recBytes, OUTREC_POS2,OUTREC_DES_POS2,OUTREC_LEN2);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort8Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort8Keys relKey = new SortalljclSort8Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort8Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort8Keys> sortComp = sortDetail.getSortComp();
