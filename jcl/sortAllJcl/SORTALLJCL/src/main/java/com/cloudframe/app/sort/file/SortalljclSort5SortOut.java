  ...
  @Component("SortalljclSort5SortOut")
  @JobScope
  public class SortalljclSort5SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort5SortOut.class);
  	@Value("${SortalljclSort5SortOut:CLOUDFRM.JPM.SORT.OUTPUT5}")
      ...
      @Value("#{'${SortalljclSort5SortOutRecordType:${SortalljclSort5SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort5SortOutRecordLen:${SortalljclSort5SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort5SortOut Write: {}",e.getMessage()); 		
  		}
  	}
