  ...
  @Component("SortalljclSort10SortOut")
  @JobScope
  public class SortalljclSort10SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort10SortOut.class);
  	@Value("${SortalljclSort10SortOut:CLOUDFRM.JPM.SORT.OUTPUT10}")
      ...
      @Value("#{'${SortalljclSort10SortOutRecordType:${SortalljclSort10SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort10SortOutRecordLen:${SortalljclSort10SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort10SortOut Write: {}",e.getMessage()); 		
  		}
  	}
