...
import com.cloudframe.app.sort.file.SortalljclSort9SortIn;
import java.util.Set;
import org.springframework.batch.core.ExitStatus;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import com.cloudframe.app.sort.SortalljclSort9Detail;
import java.util.HashSet;
import java.util.stream.Collectors;
import com.cloudframe.app.data.Field;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;
import com.cloudframe.app.sort.file.SortalljclSort9SortOut;
import com.cloudframe.app.sort.file.records.SortalljclSort9Keys;
...
public class SortalljclSort9Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort9Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort9")
	SortalljclSort9Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort9SortOut")
	SortalljclSort9SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort9SortIn")
	SortalljclSort9SortIn sortIn;
	...
	List<SortalljclSort9Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SORTALLJCLSORT9 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort9Keys k = sortRecKeys.get(index);
...
copyRecordBytes(repBytes, recBytes, OUTREC_POS2,OUTREC_DES_POS2,OUTREC_LEN2);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SortalljclSort9Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SortalljclSort9Keys relKey = new SortalljclSort9Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort9Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort9Keys> sortComp = sortDetail.getSortComp();
