  ...
  @Component("SortalljclSort16SortIn2")
  @JobScope
  public class SortalljclSort16SortIn2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort16SortIn2.class);
  	@Value("${SortalljclSort16SortIn[2]:CLOUDFRM.JPM.SORT.INPUT163}")
  	...
  	@Value("#{'${SortalljclSort16SortIn2RecordType:${SortalljclSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort16SortIn2RecordLen:${SortalljclSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort16SortIn2 Read: {}",e.getMessage()); 
  		}
  	}
