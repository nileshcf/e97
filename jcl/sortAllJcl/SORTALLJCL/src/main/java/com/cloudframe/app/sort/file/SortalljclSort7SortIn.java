  ...
  @Component("SortalljclSort7SortIn")
  @JobScope
  public class SortalljclSort7SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort7SortIn.class);
  	@Value("${SortalljclSort7SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort7SortInRecordType:${SortalljclSort7SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort7SortInRecordLen:${SortalljclSort7SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort7SortIn Read: {}",e.getMessage()); 
  		}
  	}
