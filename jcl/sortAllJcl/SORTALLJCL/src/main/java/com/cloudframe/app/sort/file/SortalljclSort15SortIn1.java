  ...
  @Component("SortalljclSort15SortIn1")
  @JobScope
  public class SortalljclSort15SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort15SortIn1.class);
  	@Value("${SortalljclSort15SortIn[1]:CLOUDFRM.JPM.SORT.INPUT152}")
  	...
  	@Value("#{'${SortalljclSort15SortIn1RecordType:${SortalljclSort15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort15SortIn1RecordLen:${SortalljclSort15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort15SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
