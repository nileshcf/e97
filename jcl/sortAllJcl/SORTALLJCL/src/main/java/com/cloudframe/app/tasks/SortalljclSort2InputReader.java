...
public class SortalljclSort2InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort2InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SortalljclSort2Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SortalljclSort2Keys relKey = new SortalljclSort2Keys();
