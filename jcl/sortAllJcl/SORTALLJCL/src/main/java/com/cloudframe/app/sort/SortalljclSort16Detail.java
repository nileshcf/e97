...
@Component("batch_sortalljclsort16")
@JobScope
public class SortalljclSort16Detail {

	private List<SortalljclSort16Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort16Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort16Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort16Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort16Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort16Keys> sortComp) {
