  ...
  @Component("SortalljclSort15SortOut")
  @JobScope
  public class SortalljclSort15SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort15SortOut.class);
  	@Value("${SortalljclSort15SortOut:CLOUDFRM.JPM.SORT.OUTPUT15}")
      ...
      @Value("#{'${SortalljclSort15SortOutRecordType:${SortalljclSort15SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort15SortOutRecordLen:${SortalljclSort15SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort15SortOut Write: {}",e.getMessage()); 		
  		}
  	}
