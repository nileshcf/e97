  ...
  @Component("SortalljclSort19SortOut")
  @JobScope
  public class SortalljclSort19SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort19SortOut.class);
  	@Value("${SortalljclSort19SortOut:CLOUDFRM.JPM.SORT.OUTPUT19}")
      ...
      @Value("#{'${SortalljclSort19SortOutRecordType:${SortalljclSort19SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort19SortOutRecordLen:${SortalljclSort19SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort19SortOut Write: {}",e.getMessage()); 		
  		}
  	}
