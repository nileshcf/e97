  ...
  @Component("SortalljclSort14SortOut")
  @JobScope
  public class SortalljclSort14SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort14SortOut.class);
  	@Value("${SortalljclSort14SortOut:CLOUDFRM.JPM.SORT.OUTPUT14}")
      ...
      @Value("#{'${SortalljclSort14SortOutRecordType:${SortalljclSort14SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort14SortOutRecordLen:${SortalljclSort14SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort14SortOut Write: {}",e.getMessage()); 		
  		}
  	}
