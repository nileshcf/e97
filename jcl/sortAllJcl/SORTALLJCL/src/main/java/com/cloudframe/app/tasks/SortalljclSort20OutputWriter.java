...
public class SortalljclSort20OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SortalljclSort20OutputWriter.class);
	@Autowired
