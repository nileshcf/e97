...
import com.cloudframe.app.sort.file.SortalljclSort3SortIn;
import com.cloudframe.app.sort.file.records.SortalljclSort3Keys;
...
import com.cloudframe.app.sort.file.SortalljclSort3SortOut;
import java.util.ArrayList;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import com.cloudframe.app.sort.SortalljclSort3Detail;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SortalljclSort3Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort3Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_sortalljclsort3")
	SortalljclSort3Detail sortDetail;
	
	@Autowired
	@Qualifier("SortalljclSort3SortOut")
	SortalljclSort3SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort3SortIn")
	SortalljclSort3SortIn sortIn;
	...
	List<SortalljclSort3Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort3");
...
logger.info("STEPNAME: SORTALLJCLSORT3 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort3Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SortalljclSort3Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SortalljclSort3Keys relKey = new SortalljclSort3Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SortalljclSort3Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SortalljclSort3Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SortalljclSort3Keys> sortComp = sortDetail.getSortComp();
