  ...
  @Component("SortalljclSort4SortIn")
  @JobScope
  public class SortalljclSort4SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort4SortIn.class);
  	@Value("${SortalljclSort4SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SortalljclSort4SortInRecordType:${SortalljclSort4SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort4SortInRecordLen:${SortalljclSort4SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort4SortIn Read: {}",e.getMessage()); 
  		}
  	}
