  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort1":  /* setting the disp position for file(s) info for this step(SORT1). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort1SortIn","SortalljclSort1SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort1SortOut","SortalljclSort1SortOut.DISP");
            break;
            case "sort2":  /* setting the disp position for file(s) info for this step(SORT2). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort2SortIn","SortalljclSort2SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort2SortOut","SortalljclSort2SortOut.DISP");
            break;
            case "sort3":  /* setting the disp position for file(s) info for this step(SORT3). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort3SortIn","SortalljclSort3SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort3SortOut","SortalljclSort3SortOut.DISP");
            break;
            case "sort4":  /* setting the disp position for file(s) info for this step(SORT4). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort4SortIn","SortalljclSort4SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort4SortOut","SortalljclSort4SortOut.DISP");
            break;
            case "sort5":  /* setting the disp position for file(s) info for this step(SORT5). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort5SortIn","SortalljclSort5SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort5SortOut","SortalljclSort5SortOut.DISP");
            break;
            case "sort6":  /* setting the disp position for file(s) info for this step(SORT6). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort6SortIn","SortalljclSort6SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort6SortOut","SortalljclSort6SortOut.DISP");
            break;
            case "sort7":  /* setting the disp position for file(s) info for this step(SORT7). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort7SortIn","SortalljclSort7SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort7SortOut","SortalljclSort7SortOut.DISP");
            break;
            case "sort8":  /* setting the disp position for file(s) info for this step(SORT8). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort8SortIn","SortalljclSort8SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort8SortOut","SortalljclSort8SortOut.DISP");
            break;
            case "sort9":  /* setting the disp position for file(s) info for this step(SORT9). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort9SortIn","SortalljclSort9SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort9SortOut","SortalljclSort9SortOut.DISP");
            break;
            case "sort10":  /* setting the disp position for file(s) info for this step(SORT10). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort10SortIn","SortalljclSort10SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort10SortOut","SortalljclSort10SortOut.DISP");
            break;
            case "sort11":  /* setting the disp position for file(s) info for this step(SORT11). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort11SortIn","SortalljclSort11SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort11SortOut","SortalljclSort11SortOut.DISP");
            break;
            case "sort12":  /* setting the disp position for file(s) info for this step(SORT12). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort12SortIn","SortalljclSort12SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort12SortOut","SortalljclSort12SortOut.DISP");
            break;
            case "sort13":  /* setting the disp position for file(s) info for this step(SORT13). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort13SortIn","SortalljclSort13SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort13SortOut","SortalljclSort13SortOut.DISP");
            break;
            case "sort14":  /* setting the disp position for file(s) info for this step(SORT14). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort14SortIn","SortalljclSort14SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort14SortOut","SortalljclSort14SortOut.DISP");
            break;
            case "sort15":  /* setting the disp position for file(s) info for this step(SORT15). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort15SortIn0","SortalljclSort15SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort15SortIn1","SortalljclSort15SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort15SortOut","SortalljclSort15SortOut.DISP");
            break;
            case "sort16":  /* setting the disp position for file(s) info for this step(SORT16). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort16SortIn0","SortalljclSort16SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort16SortIn1","SortalljclSort16SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort16SortIn2","SortalljclSort16SortIn[2].DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort16SortOut","SortalljclSort16SortOut.DISP");
            break;
            case "sort18":  /* setting the disp position for file(s) info for this step(SORT18). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort18SortIn","SortalljclSort18SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort18SortOut","SortalljclSort18SortOut.DISP");
            break;
            case "sort19":  /* setting the disp position for file(s) info for this step(SORT19). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort19SortIn","SortalljclSort19SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort19SortOut","SortalljclSort19SortOut.DISP");
            break;
            case "sort20":  /* setting the disp position for file(s) info for this step(SORT20). */
                         SpringContextHandler.setFileDispPosition("SortalljclSort20SortIn","SortalljclSort20SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortalljclSort20SortOut","SortalljclSort20SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORTALLJCL ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORTALLJCL ENDED -  ABEND={}", abendCode);
      } 
