...
@Component("batch_sortalljclsort6")
@JobScope
public class SortalljclSort6Detail {

	private List<SortalljclSort6Keys> sortRecKeys = null;
	private Set<SortalljclSort6Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort6Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort6Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort6Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort6Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort6Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort6Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort6Keys> sortComp) {
