...
@Component("batch_sortalljclsort13")
@JobScope
public class SortalljclSort13Detail {

	private List<SortalljclSort13Keys> sortRecKeys = null;
	private Set<SortalljclSort13Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort13Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort13Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort13Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort13Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort13Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort13Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort13Keys> sortComp) {
