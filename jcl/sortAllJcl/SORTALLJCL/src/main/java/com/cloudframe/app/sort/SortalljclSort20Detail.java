...
@Component("batch_sortalljclsort20")
@JobScope
public class SortalljclSort20Detail {

	private List<SortalljclSort20Keys> sortRecKeys = null;
	private Set<SortalljclSort20Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort20Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort20Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort20Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SortalljclSort20Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SortalljclSort20Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort20Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort20Keys> sortComp) {
