  ...
  @Component("SortalljclSort13SortOut")
  @JobScope
  public class SortalljclSort13SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort13SortOut.class);
  	@Value("${SortalljclSort13SortOut:CLOUDFRM.JPM.SORT.OUTPUT13}")
      ...
      @Value("#{'${SortalljclSort13SortOutRecordType:${SortalljclSort13SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort13SortOutRecordLen:${SortalljclSort13SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort13SortOut Write: {}",e.getMessage()); 		
  		}
  	}
