  ...
  @Component("SortalljclSort13SortIn")
  @JobScope
  public class SortalljclSort13SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort13SortIn.class);
  	@Value("${SortalljclSort13SortIn:CLOUDFRM.JPM.SORT.INPUT13}")
  	...
  	@Value("#{'${SortalljclSort13SortInRecordType:${SortalljclSort13SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort13SortInRecordLen:${SortalljclSort13SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort13SortIn Read: {}",e.getMessage()); 
  		}
  	}
