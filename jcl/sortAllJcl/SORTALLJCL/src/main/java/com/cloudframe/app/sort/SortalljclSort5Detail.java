...
@Component("batch_sortalljclsort5")
@JobScope
public class SortalljclSort5Detail {

	private List<SortalljclSort5Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort5Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort5Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort5Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort5Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort5Keys> sortComp) {
