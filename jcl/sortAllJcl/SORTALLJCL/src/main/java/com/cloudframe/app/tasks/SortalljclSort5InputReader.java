...
public class SortalljclSort5InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort5InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SortalljclSort5Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SortalljclSort5Keys relKey = new SortalljclSort5Keys();
