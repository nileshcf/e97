  ...
  @Component("SortalljclSort18SortOut")
  @JobScope
  public class SortalljclSort18SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort18SortOut.class);
  	@Value("${SortalljclSort18SortOut:CLOUDFRM.JPM.SORT.OUTPUT18}")
      ...
      @Value("#{'${SortalljclSort18SortOutRecordType:${SortalljclSort18SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort18SortOutRecordLen:${SortalljclSort18SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 11;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort18SortOut Write: {}",e.getMessage()); 		
  		}
  	}
