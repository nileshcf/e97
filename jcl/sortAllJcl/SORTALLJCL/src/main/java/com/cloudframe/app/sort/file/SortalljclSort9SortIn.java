  ...
  @Component("SortalljclSort9SortIn")
  @JobScope
  public class SortalljclSort9SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort9SortIn.class);
  	@Value("${SortalljclSort9SortIn:CLOUDFRM.JPM.SORT.INPUT9}")
  	...
  	@Value("#{'${SortalljclSort9SortInRecordType:${SortalljclSort9SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortalljclSort9SortInRecordLen:${SortalljclSort9SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortalljclSort9SortIn Read: {}",e.getMessage()); 
  		}
  	}
