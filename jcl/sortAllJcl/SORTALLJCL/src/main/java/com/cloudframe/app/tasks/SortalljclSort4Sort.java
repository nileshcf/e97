...
import com.cloudframe.app.sort.file.SortalljclSort4SortOut;
...
import com.cloudframe.app.sort.file.SortalljclSort4SortIn;
...
public class SortalljclSort4Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortalljclSort4Sort.class);
	@Autowired
	...
	@Autowired
	@Qualifier("SortalljclSort4SortOut")
	SortalljclSort4SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SortalljclSort4SortIn")
	SortalljclSort4SortIn sortIn;
...
logger.info("STEPNAME: SORTALLJCLSORT4 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SortalljclSort4Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		...
		SortalljclSort4Keys relKey = new SortalljclSort4Keys();
