...
@Component("batch_sortalljclsort3")
@JobScope
public class SortalljclSort3Detail {

	private List<SortalljclSort3Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort3Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort3Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort3Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort3Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort3Keys> sortComp) {
