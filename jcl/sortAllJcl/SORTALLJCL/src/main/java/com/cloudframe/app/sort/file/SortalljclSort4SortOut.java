  ...
  @Component("SortalljclSort4SortOut")
  @JobScope
  public class SortalljclSort4SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortalljclSort4SortOut.class);
  	@Value("${SortalljclSort4SortOut:CLOUDFRM.JPM.SORT.OUTPUT4}")
      ...
      @Value("#{'${SortalljclSort4SortOutRecordType:${SortalljclSort4SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortalljclSort4SortOutRecordLen:${SortalljclSort4SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortalljclSort4SortOut Write: {}",e.getMessage()); 		
  		}
  	}
