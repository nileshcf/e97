...
@Component("batch_sortalljclsort14")
@JobScope
public class SortalljclSort14Detail {

	private List<SortalljclSort14Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortalljclSort14Keys> sortComp = null;
	 ...
	 */
	public List<SortalljclSort14Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortalljclSort14Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SortalljclSort14Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortalljclSort14Keys> sortComp) {
