package com.cloudframe.app.abprog7;
...
@Context
public class Abprog7Ctx implements ProgramContext, Cloneable {
    ...
    public Abprog7Ctx clone() {
        Abprog7Ctx cloneObj = new Abprog7Ctx();
 ...
 */
     ...
     Work work = Abprog7Ctx.this.getWork();
   ...
   public void setPgmName(char[] value) throws CFException {
      work.setPgmName(value);
        ...
        public Abprog7Ctx getAbprog7Ctx() {
            return Abprog7Ctx.this;
        }
