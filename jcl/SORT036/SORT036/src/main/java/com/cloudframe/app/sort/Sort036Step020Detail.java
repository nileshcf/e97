...
@Component("batch_sort036step020")
@JobScope
public class Sort036Step020Detail {

	private List<Sort036Step020Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Sort036Step020Keys> sortComp = null;
	 ...
	 */
	public List<Sort036Step020Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Sort036Step020Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Sort036Step020Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Sort036Step020Keys> sortComp) {
