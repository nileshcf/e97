  ...
  @Component("Sort036Step020SortIn")
  @JobScope
  public class Sort036Step020SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort036Step020SortIn.class);
  	@Value("${Sort036Step020SortIn:CLOUDFRM.MC.GCMS.SORT.IN036}")
  	...
  	@Value("#{'${Sort036Step020SortInRecordType:${Sort036Step020SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sort036Step020SortInRecordLen:${Sort036Step020SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sort036Step020SortIn Read: {}",e.getMessage()); 
  		}
  	}
