  ...
  @Component("Sort036Step020SortOut")
  @JobScope
  public class Sort036Step020SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort036Step020SortOut.class);
  	@Value("${Sort036Step020SortOut:CLOUDFRM.MC.GCMS.SORT.OUT036}")
      ...
      @Value("#{'${Sort036Step020SortOutRecordType:${Sort036Step020SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sort036Step020SortOutRecordLen:${Sort036Step020SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sort036Step020SortOut Write: {}",e.getMessage()); 		
  		}
  	}
