...
public class Sort036Step020InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Sort036Step020InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Sort036Step020Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Sort036Step020Keys relKey = new Sort036Step020Keys();
