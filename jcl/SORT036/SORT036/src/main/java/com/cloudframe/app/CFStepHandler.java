  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step020":  /* setting the disp position for file(s) info for this step(STEP020). */
                         SpringContextHandler.setFileDispPosition("Sort036Step020SortIn","Sort036Step020SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Sort036Step020SortOut","Sort036Step020SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORT036 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORT036 ENDED -  ABEND={}", abendCode);
      } 
