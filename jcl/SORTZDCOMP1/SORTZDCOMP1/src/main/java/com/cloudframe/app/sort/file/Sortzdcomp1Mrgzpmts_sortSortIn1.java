  ...
  @Component("Sortzdcomp1Mrgzpmts_sortSortIn1")
  @JobScope
  public class Sortzdcomp1Mrgzpmts_sortSortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sortzdcomp1Mrgzpmts_sortSortIn1.class);
  	@Value("${Sortzdcomp1Mrgzpmts_sortSortIn[1]:CLOUDFRM.SLCO.VAST6397.VB595.ZBBPMTS}")
  	...
  	@Value("#{'${Sortzdcomp1Mrgzpmts_sortSortIn1RecordType:${Sortzdcomp1Mrgzpmts_sortSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sortzdcomp1Mrgzpmts_sortSortIn1RecordLen:${Sortzdcomp1Mrgzpmts_sortSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sortzdcomp1Mrgzpmts_sortSortIn1 Read: {}",e.getMessage()); 
  		}
  	}
