...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String MRGZPMTS_SORT = "mrgzpmts_sort";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "mrgzpmts_sort":  /* setting the disp position for file(s) info for this step(MRGZPMTS_SORT). */
                         SpringContextHandler.setFileDispPosition("Sortzdcomp1Mrgzpmts_sortSortIn0","Sortzdcomp1Mrgzpmts_sortSortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sortzdcomp1Mrgzpmts_sortSortIn1","Sortzdcomp1Mrgzpmts_sortSortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Sortzdcomp1Mrgzpmts_sortSortOut","Sortzdcomp1Mrgzpmts_sortSortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORTZDCOMP1 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORTZDCOMP1 ENDED -  ABEND={}", abendCode);
      } 
