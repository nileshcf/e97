...
@Component("batch_sortzdcomp1mrgzpmts_sort")
@JobScope
public class Sortzdcomp1Mrgzpmts_sortDetail {

	private List<Sortzdcomp1Mrgzpmts_sortKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Sortzdcomp1Mrgzpmts_sortKeys> sortComp = null;
	 ...
	 */
	public List<Sortzdcomp1Mrgzpmts_sortKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Sortzdcomp1Mrgzpmts_sortKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Sortzdcomp1Mrgzpmts_sortKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Sortzdcomp1Mrgzpmts_sortKeys> sortComp) {
