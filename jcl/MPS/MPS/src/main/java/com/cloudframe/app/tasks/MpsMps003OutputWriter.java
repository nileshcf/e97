...
public class MpsMps003OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(MpsMps003OutputWriter.class);
	@Autowired
	...
	List<MpsMps003Keys> sortRecKeys = null;
...
logger.info("STEPNAME: MPSMPS003 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	private byte[] getSortedRecord(int index) {
		try {
			MpsMps003Keys k = sortRecKeys.get(index);
