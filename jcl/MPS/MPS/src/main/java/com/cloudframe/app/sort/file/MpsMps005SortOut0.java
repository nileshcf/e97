  ...
  @Component("MpsMps005SortOut0")
  @JobScope
  public class MpsMps005SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps005SortOut0.class);
  	@Value("${MpsMps005SortOut[0]:CLOUDFRM.MC.MPS.SORT.OUT051}")
      ...
      @Value("#{'${MpsMps005SortOut0RecordType:${MpsMps005SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps005SortOut0RecordLen:${MpsMps005SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps005SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
