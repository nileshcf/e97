...
@Component("batch_mpsstep020_2")
@JobScope
public class MpsStep020_2Detail {

	private List<MpsStep020_2Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsStep020_2Keys> sortComp = null;
	 ...
	 */
	public List<MpsStep020_2Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsStep020_2Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsStep020_2Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsStep020_2Keys> sortComp) {
