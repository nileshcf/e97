...
@Component("batch_mpsmps001")
@JobScope
public class MpsMps001Detail {

	private List<MpsMps001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsMps001Keys> sortComp = null;
	 ...
	 */
	public List<MpsMps001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsMps001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsMps001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsMps001Keys> sortComp) {
