...
@Component("batch_mpsmps004")
@JobScope
public class MpsMps004Detail {

	private List<MpsMps004Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsMps004Keys> sortComp = null;
	 ...
	 */
	public List<MpsMps004Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsMps004Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsMps004Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsMps004Keys> sortComp) {
