  ...
  @Component("MpsStep020_2SortIn")
  @JobScope
  public class MpsStep020_2SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep020_2SortIn.class);
  	@Value("${MpsStep020_2SortIn:CLOUDFRM.MC.MPS.SORT.IN118220}")
  	...
  	@Value("#{'${MpsStep020_2SortInRecordType:${MpsStep020_2SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsStep020_2SortInRecordLen:${MpsStep020_2SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsStep020_2SortIn Read: {}",e.getMessage()); 
  		}
  	}
