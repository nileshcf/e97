  ...
  @Component("MpsMps006SortOut2")
  @JobScope
  public class MpsMps006SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps006SortOut2.class);
  	@Value("${MpsMps006SortOut[2]:CLOUDFRM.MC.MPS.SORT.OUT063}")
      ...
      @Value("#{'${MpsMps006SortOut2RecordType:${MpsMps006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps006SortOut2RecordLen:${MpsMps006SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps006SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
