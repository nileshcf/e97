...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public MpsMps001Sort mpsMps001Sort() {
    	return new MpsMps001Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsMps001Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsMps001Sort",jobRepository).tasklet(mpsMps001Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mps001Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mps001Executor")
             ...
             .to(MpsMps001Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsStep020Sort mpsStep020Sort() {
    	return new MpsStep020Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsStep020Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsStep020Sort",jobRepository).tasklet(mpsStep020Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step020Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step020Executor")
             ...
             .to(MpsStep020Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsMps002Sort mpsMps002Sort() {
    	return new MpsMps002Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsMps002Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsMps002Sort",jobRepository).tasklet(mpsMps002Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mps002Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mps002Executor")
             ...
             .to(MpsMps002Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsMps003Sort mpsMps003Sort() {
    	return new MpsMps003Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsMps003Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsMps003Sort",jobRepository).tasklet(mpsMps003Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mps003Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mps003Executor")
             ...
             .to(MpsMps003Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsMps004Sort mpsMps004Sort() {
    	return new MpsMps004Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsMps004Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsMps004Sort",jobRepository).tasklet(mpsMps004Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mps004Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mps004Executor")
             ...
             .to(MpsMps004Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsMps005Sort mpsMps005Sort() {
    	return new MpsMps005Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsMps005Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsMps005Sort",jobRepository).tasklet(mpsMps005Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mps005Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mps005Executor")
             ...
             .to(MpsMps005Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsMps006Sort mpsMps006Sort() {
    	return new MpsMps006Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsMps006Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsMps006Sort",jobRepository).tasklet(mpsMps006Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow mps006Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("mps006Executor")
             ...
             .to(MpsMps006Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsStep020_2Sort mpsStep020_2Sort() {
    	return new MpsStep020_2Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsStep020_2Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsStep020_2Sort",jobRepository).tasklet(mpsStep020_2Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step020_2Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step020_2Executor")
             ...
             .to(MpsStep020_2Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public MpsStep040Sort mpsStep040Sort() {
    	return new MpsStep040Sort();
    }
    
    @Bean
    @JobScope
    protected Step MpsStep040Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("MpsStep040Sort",jobRepository).tasklet(mpsStep040Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step040Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step040Executor")
             ...
             .to(MpsStep040Sort(jobRepository, transactionManager))
