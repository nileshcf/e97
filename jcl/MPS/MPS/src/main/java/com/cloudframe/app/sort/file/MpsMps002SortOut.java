  ...
  @Component("MpsMps002SortOut")
  @JobScope
  public class MpsMps002SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps002SortOut.class);
  	@Value("${MpsMps002SortOut:CLOUDFRM.MC.MPS.SORT.OUT002}")
      ...
      @Value("#{'${MpsMps002SortOutRecordType:${MpsMps002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps002SortOutRecordLen:${MpsMps002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps002SortOut Write: {}",e.getMessage()); 		
  		}
  	}
