  ...
  @Component("MpsMps006SortOut1")
  @JobScope
  public class MpsMps006SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps006SortOut1.class);
  	@Value("${MpsMps006SortOut[1]:CLOUDFRM.MC.MPS.SORT.OUT062}")
      ...
      @Value("#{'${MpsMps006SortOut1RecordType:${MpsMps006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps006SortOut1RecordLen:${MpsMps006SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps006SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
