  ...
  @Component("MpsMps003SortIn")
  @JobScope
  public class MpsMps003SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps003SortIn.class);
  	@Value("${MpsMps003SortIn:CLOUDFRM.MC.MPS.SORT.IN003}")
  	...
  	@Value("#{'${MpsMps003SortInRecordType:${MpsMps003SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps003SortInRecordLen:${MpsMps003SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps003SortIn Read: {}",e.getMessage()); 
  		}
  	}
