...
public class MpsStep040InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(MpsStep040InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<MpsStep040Keys> sortRecKeys = sortDetail.getSortRecKeys();
		MpsStep040Keys relKey = new MpsStep040Keys();
