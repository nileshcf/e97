...
public class MpsStep020InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(MpsStep020InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<MpsStep020Keys> sortRecKeys = sortDetail.getSortRecKeys();
		MpsStep020Keys relKey = new MpsStep020Keys();
