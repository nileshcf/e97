...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String MPS001 = "mps001";
    private static final String STEP020 = "step020";
    private static final String MPS002 = "mps002";
    private static final String MPS003 = "mps003";
    private static final String MPS004 = "mps004";
    private static final String MPS005 = "mps005";
    private static final String MPS006 = "mps006";
    private static final String STEP020_2 = "step020_2";
    private static final String STEP040 = "step040";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "mps001":  /* setting the disp position for file(s) info for this step(MPS001). */
                         SpringContextHandler.setFileDispPosition("MpsMps001SortIn","MpsMps001SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps001SortOut","MpsMps001SortOut.DISP");
            break;
            case "step020":  /* setting the disp position for file(s) info for this step(STEP020). */
                         SpringContextHandler.setFileDispPosition("MpsStep020SortIn","MpsStep020SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsStep020SortOut","MpsStep020SortOut.DISP");
            break;
            case "mps002":  /* setting the disp position for file(s) info for this step(MPS002). */
                         SpringContextHandler.setFileDispPosition("MpsMps002SortIn","MpsMps002SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps002SortOut","MpsMps002SortOut.DISP");
            break;
            case "mps003":  /* setting the disp position for file(s) info for this step(MPS003). */
                         SpringContextHandler.setFileDispPosition("MpsMps003SortIn","MpsMps003SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps003SortOut","MpsMps003SortOut.DISP");
            break;
            case "mps004":  /* setting the disp position for file(s) info for this step(MPS004). */
                         SpringContextHandler.setFileDispPosition("MpsMps004SortIn","MpsMps004SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps004SortOut0","MpsMps004SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps004SortOut1","MpsMps004SortOut[1].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps004SortOut2","MpsMps004SortOut[2].DISP");
            break;
            case "mps005":  /* setting the disp position for file(s) info for this step(MPS005). */
                         SpringContextHandler.setFileDispPosition("MpsMps005SortIn0","MpsMps005SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps005SortIn1","MpsMps005SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps005SortIn2","MpsMps005SortIn[2].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps005SortOut0","MpsMps005SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps005SortOut1","MpsMps005SortOut[1].DISP");
            break;
            case "mps006":  /* setting the disp position for file(s) info for this step(MPS006). */
                         SpringContextHandler.setFileDispPosition("MpsMps006SortIn","MpsMps006SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps006SortOut0","MpsMps006SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps006SortOut1","MpsMps006SortOut[1].DISP");
                         SpringContextHandler.setFileDispPosition("MpsMps006SortOut2","MpsMps006SortOut[2].DISP");
            break;
            case "step020_2":  /* setting the disp position for file(s) info for this step(STEP020_2). */
                         SpringContextHandler.setFileDispPosition("MpsStep020_2SortIn","MpsStep020_2SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("MpsStep020_2SortOut","MpsStep020_2SortOut.DISP");
            break;
            case "step040":  /* setting the disp position for file(s) info for this step(STEP040). */
                         SpringContextHandler.setFileDispPosition("MpsStep040SortIn0","MpsStep040SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("MpsStep040SortIn1","MpsStep040SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("MpsStep040SortOut","MpsStep040SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : MPS ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : MPS ENDED -  ABEND={}", abendCode);
      } 
