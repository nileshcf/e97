...
@Component("batch_mpsstep020")
@JobScope
public class MpsStep020Detail {

	private List<MpsStep020Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsStep020Keys> sortComp = null;
	 ...
	 */
	public List<MpsStep020Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsStep020Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsStep020Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsStep020Keys> sortComp) {
