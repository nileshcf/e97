  ...
  @Component("MpsMps004SortOut0")
  @JobScope
  public class MpsMps004SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps004SortOut0.class);
  	@Value("${MpsMps004SortOut[0]:CLOUDFRM.MC.MPS.SORT.OUT0041}")
      ...
      @Value("#{'${MpsMps004SortOut0RecordType:${MpsMps004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps004SortOut0RecordLen:${MpsMps004SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 38;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps004SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
