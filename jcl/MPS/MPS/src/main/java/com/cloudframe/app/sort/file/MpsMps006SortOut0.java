  ...
  @Component("MpsMps006SortOut0")
  @JobScope
  public class MpsMps006SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps006SortOut0.class);
  	@Value("${MpsMps006SortOut[0]:CLOUDFRM.MC.MPS.SORT.OUT061}")
      ...
      @Value("#{'${MpsMps006SortOut0RecordType:${MpsMps006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps006SortOut0RecordLen:${MpsMps006SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps006SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
