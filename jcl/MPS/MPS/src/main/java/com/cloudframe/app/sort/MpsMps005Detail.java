...
@Component("batch_mpsmps005")
@JobScope
public class MpsMps005Detail {

	private List<MpsMps005Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsMps005Keys> sortComp = null;
	 ...
	 */
	public List<MpsMps005Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsMps005Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsMps005Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsMps005Keys> sortComp) {
