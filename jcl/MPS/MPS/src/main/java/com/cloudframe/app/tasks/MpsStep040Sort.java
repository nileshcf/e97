...
import com.cloudframe.app.sort.MpsStep040Detail;
import org.springframework.beans.factory.annotation.Value;
public class MpsStep040Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(MpsStep040Sort.class);
