  ...
  @Component("MpsMps002SortIn")
  @JobScope
  public class MpsMps002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps002SortIn.class);
  	@Value("${MpsMps002SortIn:CLOUDFRM.MC.MPS.SORT.IN002}")
  	...
  	@Value("#{'${MpsMps002SortInRecordType:${MpsMps002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps002SortInRecordLen:${MpsMps002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps002SortIn Read: {}",e.getMessage()); 
  		}
  	}
