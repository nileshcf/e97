...
import com.cloudframe.app.sort.MpsStep020Detail;
import org.springframework.beans.factory.annotation.Value;
public class MpsStep020Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(MpsStep020Sort.class);
