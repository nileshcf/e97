...
public class MpsStep020_2InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(MpsStep020_2InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<MpsStep020_2Keys> sortRecKeys = sortDetail.getSortRecKeys();
		MpsStep020_2Keys relKey = new MpsStep020_2Keys();
