...
public class MpsMps001InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(MpsMps001InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<MpsMps001Keys> sortRecKeys = sortDetail.getSortRecKeys();
		MpsMps001Keys relKey = new MpsMps001Keys();
