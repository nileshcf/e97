  ...
  @Component("MpsStep020SortIn")
  @JobScope
  public class MpsStep020SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep020SortIn.class);
  	@Value("${MpsStep020SortIn:CLOUDFRM.MC.MPS.SORT.IN001}")
  	...
  	@Value("#{'${MpsStep020SortInRecordType:${MpsStep020SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsStep020SortInRecordLen:${MpsStep020SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsStep020SortIn Read: {}",e.getMessage()); 
  		}
  	}
