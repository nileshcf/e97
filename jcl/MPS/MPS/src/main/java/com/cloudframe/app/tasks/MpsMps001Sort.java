...
import com.cloudframe.app.sort.MpsMps001Detail;
import org.springframework.beans.factory.annotation.Value;
public class MpsMps001Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(MpsMps001Sort.class);
