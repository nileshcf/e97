  ...
  @Component("MpsMps004SortOut2")
  @JobScope
  public class MpsMps004SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps004SortOut2.class);
  	@Value("${MpsMps004SortOut[2]:CLOUDFRM.MC.MPS.SORT.OUT0043}")
      ...
      @Value("#{'${MpsMps004SortOut2RecordType:${MpsMps004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps004SortOut2RecordLen:${MpsMps004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps004SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
