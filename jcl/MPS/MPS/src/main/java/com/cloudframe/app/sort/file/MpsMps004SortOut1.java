  ...
  @Component("MpsMps004SortOut1")
  @JobScope
  public class MpsMps004SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps004SortOut1.class);
  	@Value("${MpsMps004SortOut[1]:CLOUDFRM.MC.MPS.SORT.OUT0042}")
      ...
      @Value("#{'${MpsMps004SortOut1RecordType:${MpsMps004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps004SortOut1RecordLen:${MpsMps004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps004SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
