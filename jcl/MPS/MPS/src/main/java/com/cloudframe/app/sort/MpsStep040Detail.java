...
@Component("batch_mpsstep040")
@JobScope
public class MpsStep040Detail {

	private List<MpsStep040Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsStep040Keys> sortComp = null;
	 ...
	 */
	public List<MpsStep040Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsStep040Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsStep040Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsStep040Keys> sortComp) {
