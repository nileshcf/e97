  ...
  @Component("MpsMps001SortIn")
  @JobScope
  public class MpsMps001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps001SortIn.class);
  	@Value("${MpsMps001SortIn:CLOUDFRM.MC.MPS.SORT.IN001}")
  	...
  	@Value("#{'${MpsMps001SortInRecordType:${MpsMps001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps001SortInRecordLen:${MpsMps001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps001SortIn Read: {}",e.getMessage()); 
  		}
  	}
