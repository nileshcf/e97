  ...
  @Component("MpsMps001SortOut")
  @JobScope
  public class MpsMps001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps001SortOut.class);
  	@Value("${MpsMps001SortOut:CLOUDFRM.MC.MPS.SORT.OUT001}")
      ...
      @Value("#{'${MpsMps001SortOutRecordType:${MpsMps001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps001SortOutRecordLen:${MpsMps001SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
