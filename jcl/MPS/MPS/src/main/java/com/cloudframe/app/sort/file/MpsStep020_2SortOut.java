  ...
  @Component("MpsStep020_2SortOut")
  @JobScope
  public class MpsStep020_2SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep020_2SortOut.class);
  	@Value("${MpsStep020_2SortOut:&&HEADER}")
      ...
      @Value("#{'${MpsStep020_2SortOutRecordType:${MpsStep020_2SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsStep020_2SortOutRecordLen:${MpsStep020_2SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsStep020_2SortOut Write: {}",e.getMessage()); 		
  		}
  	}
