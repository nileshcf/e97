  ...
  @Component("MpsStep020SortOut")
  @JobScope
  public class MpsStep020SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep020SortOut.class);
  	@Value("${MpsStep020SortOut:CLOUDFRM.MC.MPS.SORT.OUT001A}")
      ...
      @Value("#{'${MpsStep020SortOutRecordType:${MpsStep020SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsStep020SortOutRecordLen:${MpsStep020SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsStep020SortOut Write: {}",e.getMessage()); 		
  		}
  	}
