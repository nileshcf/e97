...
import com.cloudframe.app.sort.file.records.MpsMps003Keys;
import com.cloudframe.app.data.Field;

@Component("batch_mpsmps003")
@JobScope
public class MpsMps003Detail {

	private List<MpsMps003Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsMps003Keys> sortComp = null;
	 ...
	 */
	public List<MpsMps003Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsMps003Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsMps003Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsMps003Keys> sortComp) {
