  ...
  @Component("MpsStep040SortIn0")
  @JobScope
  public class MpsStep040SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep040SortIn0.class);
  	@Value("${MpsStep040SortIn[0]:&&HEADER}")
  	...
  	@Value("#{'${MpsStep040SortIn0RecordType:${MpsStep040SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsStep040SortIn0RecordLen:${MpsStep040SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsStep040SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
