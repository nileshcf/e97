...
public class MpsMps003InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(MpsMps003InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<MpsMps003Keys> sortRecKeys = sortDetail.getSortRecKeys();
		MpsMps003Keys relKey = new MpsMps003Keys();
