  ...
  @Component("MpsMps004SortIn")
  @JobScope
  public class MpsMps004SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps004SortIn.class);
  	@Value("${MpsMps004SortIn:CLOUDFRM.MC.MPS.SORT.IN004}")
  	...
  	@Value("#{'${MpsMps004SortInRecordType:${MpsMps004SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps004SortInRecordLen:${MpsMps004SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps004SortIn Read: {}",e.getMessage()); 
  		}
  	}
