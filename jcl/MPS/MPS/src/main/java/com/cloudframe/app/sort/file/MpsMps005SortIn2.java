  ...
  @Component("MpsMps005SortIn2")
  @JobScope
  public class MpsMps005SortIn2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps005SortIn2.class);
  	@Value("${MpsMps005SortIn[2]:CLOUDFRM.MC.MPS.SORT.IN053}")
  	...
  	@Value("#{'${MpsMps005SortIn2RecordType:${MpsMps005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps005SortIn2RecordLen:${MpsMps005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps005SortIn2 Read: {}",e.getMessage()); 
  		}
  	}
