...
public class MpsMps004Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(MpsMps004Processor.class);
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		// Sort algorithm here
		List<MpsMps004Keys> sortRecKeys = sortDetail.getSortRecKeys();
