...
import com.cloudframe.app.sort.MpsMps005Detail;
import org.springframework.beans.factory.annotation.Value;
public class MpsMps005Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(MpsMps005Sort.class);
...
@Override
   ...
   public void writeRec(byte[] record) throws Exception {
          byte[] outRecBytes = record;
