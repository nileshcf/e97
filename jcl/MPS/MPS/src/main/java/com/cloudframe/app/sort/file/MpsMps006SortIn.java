  ...
  @Component("MpsMps006SortIn")
  @JobScope
  public class MpsMps006SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps006SortIn.class);
  	@Value("${MpsMps006SortIn:CLOUDFRM.MC.MPS.SORT.IN061}")
  	...
  	@Value("#{'${MpsMps006SortInRecordType:${MpsMps006SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps006SortInRecordLen:${MpsMps006SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps006SortIn Read: {}",e.getMessage()); 
  		}
  	}
