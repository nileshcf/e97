  ...
  @Component("MpsStep040SortOut")
  @JobScope
  public class MpsStep040SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep040SortOut.class);
  	@Value("${MpsStep040SortOut:CLOUDFRM.MC.MPS.SORT.OUT11824}")
      ...
      @Value("#{'${MpsStep040SortOutRecordType:${MpsStep040SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsStep040SortOutRecordLen:${MpsStep040SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsStep040SortOut Write: {}",e.getMessage()); 		
  		}
  	}
