  ...
  @Component("MpsMps005SortOut1")
  @JobScope
  public class MpsMps005SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps005SortOut1.class);
  	@Value("${MpsMps005SortOut[1]:CLOUDFRM.MC.MPS.SORT.OUT052}")
      ...
      @Value("#{'${MpsMps005SortOut1RecordType:${MpsMps005SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps005SortOut1RecordLen:${MpsMps005SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps005SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
