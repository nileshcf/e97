...
@Component("batch_mpsmps002")
@JobScope
public class MpsMps002Detail {

	private List<MpsMps002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsMps002Keys> sortComp = null;
	 ...
	 */
	public List<MpsMps002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsMps002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsMps002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsMps002Keys> sortComp) {
