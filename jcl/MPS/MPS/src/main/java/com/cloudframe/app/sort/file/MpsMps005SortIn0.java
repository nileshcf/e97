  ...
  @Component("MpsMps005SortIn0")
  @JobScope
  public class MpsMps005SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps005SortIn0.class);
  	@Value("${MpsMps005SortIn[0]:CLOUDFRM.MC.MPS.SORT.IN051}")
  	...
  	@Value("#{'${MpsMps005SortIn0RecordType:${MpsMps005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps005SortIn0RecordLen:${MpsMps005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps005SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
