...
@Component("batch_mpsmps006")
@JobScope
public class MpsMps006Detail {

	private List<MpsMps006Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<MpsMps006Keys> sortComp = null;
	 ...
	 */
	public List<MpsMps006Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<MpsMps006Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<MpsMps006Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<MpsMps006Keys> sortComp) {
