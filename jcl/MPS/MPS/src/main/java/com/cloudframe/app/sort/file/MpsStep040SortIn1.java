  ...
  @Component("MpsStep040SortIn1")
  @JobScope
  public class MpsStep040SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsStep040SortIn1.class);
  	@Value("${MpsStep040SortIn[1]:CLOUDFRM.MC.MPS.SORT.IN118220}")
  	...
  	@Value("#{'${MpsStep040SortIn1RecordType:${MpsStep040SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsStep040SortIn1RecordLen:${MpsStep040SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsStep040SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
