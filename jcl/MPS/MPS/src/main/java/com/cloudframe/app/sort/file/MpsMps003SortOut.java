  ...
  @Component("MpsMps003SortOut")
  @JobScope
  public class MpsMps003SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps003SortOut.class);
  	@Value("${MpsMps003SortOut:CLOUDFRM.MC.MPS.SORT.OUT003}")
      ...
      @Value("#{'${MpsMps003SortOutRecordType:${MpsMps003SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${MpsMps003SortOutRecordLen:${MpsMps003SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during MpsMps003SortOut Write: {}",e.getMessage()); 		
  		}
  	}
