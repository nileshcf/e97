  ...
  @Component("MpsMps005SortIn1")
  @JobScope
  public class MpsMps005SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(MpsMps005SortIn1.class);
  	@Value("${MpsMps005SortIn[1]:CLOUDFRM.MC.MPS.SORT.IN052}")
  	...
  	@Value("#{'${MpsMps005SortIn1RecordType:${MpsMps005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${MpsMps005SortIn1RecordLen:${MpsMps005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during MpsMps005SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
