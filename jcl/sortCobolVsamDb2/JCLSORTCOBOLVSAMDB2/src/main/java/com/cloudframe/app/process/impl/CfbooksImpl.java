...
//  SELECT BOOK_ID , RTRIM ( TITLE ) , TOTAL_PAGES , RATING , ISBN , PUBLISHED_DATE , PUBLISHER_ID FROM BOOKS WITH UR
...
//  FETCH BOOKSCUR INTO ? , ? , ? , ? , ? , ? , ?
          cfbooksRepository.fetchBookscurCfbooks(programCtx.getBookscurResultSet(),methodOut.getNullvars(),methodOut.getDclbooks(),programCtx.getSqlca());
