...
public class WorkSerialized  extends Field { 
   ...
   protected char[] checkIsItFirstTime100Constraints(char[] value) {
     ...
     int localIsItEndOfData100Counter = -1;
     public boolean isIsItEndOfData100Modified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localIsItEndOfData100Counter != sharedCounter;
         localIsItEndOfData100Counter = sharedCounter; return hasModified;
     }

   protected char[] checkIsItEndOfData100Constraints(char[] value) {
   			return super.checkConstraints(value , 1 ,false, false);
   }
   ...
   protected int checkAbendCode300MaxLimit(long number) {
	 ...
	 */ 
     ...
     int localPrevKey800Counter = -1;
     public boolean isPrevKey800Modified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localPrevKey800Counter != sharedCounter;
         localPrevKey800Counter = sharedCounter; return hasModified;
     }

   protected char[] checkPrevKey800Constraints(char[] value) {
