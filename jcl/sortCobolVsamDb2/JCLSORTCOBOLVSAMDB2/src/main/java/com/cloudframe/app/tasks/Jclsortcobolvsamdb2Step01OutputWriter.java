...
public class Jclsortcobolvsamdb2Step01OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Jclsortcobolvsamdb2Step01OutputWriter.class);
	@Autowired
