...
public class Jclsortcobolvsamdb2Step01InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Jclsortcobolvsamdb2Step01InputReader.class);
/**
