...
@Component("batch_jclsortcobolvsamdb2step01")
@JobScope
public class Jclsortcobolvsamdb2Step01Detail {

	private List<Jclsortcobolvsamdb2Step01Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Jclsortcobolvsamdb2Step01Keys> sortComp = null;
	 ...
	 */
	public List<Jclsortcobolvsamdb2Step01Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Jclsortcobolvsamdb2Step01Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Jclsortcobolvsamdb2Step01Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Jclsortcobolvsamdb2Step01Keys> sortComp) {
