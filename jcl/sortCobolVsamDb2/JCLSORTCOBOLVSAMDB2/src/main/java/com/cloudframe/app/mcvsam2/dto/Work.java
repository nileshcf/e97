...
import com.cloudframe.app.mcvsam2.dto.serialize.*;
...
public class Work extends WorkSerialized { 
						...
						private char[] isItEndOfData100 = new char[1];
						...
						private char[] prevKey800 = new char[31];
	...
	*/
	...
	/**
	 *	Returns the value of isItEndOfData100
	 *	@return isItEndOfData100
	 */
   public char[] getIsItEndOfData100() throws CFException{
   		return isItEndOfData100;
   }

  
	/**
	*  set variable isItEndOfData100
	*  Corresponding COBOL Variable is 100-IS-IT-END-OF-DATA
	*  @param value
	**/
   public void setIsItEndOfData100(char[] value) {
       value = checkIsItEndOfData100Constraints(value);
       arraycopy(value,0,isItEndOfData100,0,value.length);
   } 
	public void setIsItEndOfData100(char[] value , int beginIndex, int endIndex) {
       //value = checkL1CtlData801Constraints(value);
       arraycopy(value,beginIndex,isItEndOfData100,0,beginIndex + endIndex);
   }
	char[] endOfDataN8810088Value = "N".toCharArray();
	/**
   ...
   public boolean isEndOfDataN88100() throws CFException {
      return (  compareChars( getIsItEndOfData100() , endOfDataN8810088Value)  == 0  );
   }
	...
	*  set values "N"
	*/
   	public void setEndOfDataN88100True() {  			
    	setIsItEndOfData100( endOfDataN8810088Value);
   	}
	char[] endOfDataY8810088Value = "Y".toCharArray();
	/**
   ...
   public boolean isEndOfDataY88100() throws CFException {
      return (  compareChars( getIsItEndOfData100() , endOfDataY8810088Value)  == 0  );
   }
	...
	*  set values "Y"
	*/
   	public void setEndOfDataY88100True() {  			
    	setIsItEndOfData100( endOfDataY8810088Value);
   	}
	/**
	...
	*  Corresponding COBOL Variable is 800-PREV-KEY
	*  @param value
	**/
   public void setPrevKey800(char[] value) {
       value = checkPrevKey800Constraints(value);
       arraycopy(value,0,prevKey800,0,value.length);
   } 
	public void setPrevKey800(char[] value , int beginIndex, int endIndex) {
       //value = checkL1CtlData801Constraints(value);
       arraycopy(value,beginIndex,prevKey800,0,beginIndex + endIndex);
   }
	/**
