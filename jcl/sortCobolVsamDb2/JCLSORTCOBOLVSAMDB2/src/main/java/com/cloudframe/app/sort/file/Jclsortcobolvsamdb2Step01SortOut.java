  ...
  @Component("Jclsortcobolvsamdb2Step01SortOut")
  @JobScope
  public class Jclsortcobolvsamdb2Step01SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Jclsortcobolvsamdb2Step01SortOut.class);
  	@Value("${Jclsortcobolvsamdb2Step01SortOut:CLOUDFRM.DEMO.CFCARD.INPUT.FILE.SORTED}")
      ...
      @Value("#{'${Jclsortcobolvsamdb2Step01SortOutRecordType:${Jclsortcobolvsamdb2Step01SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Jclsortcobolvsamdb2Step01SortOutRecordLen:${Jclsortcobolvsamdb2Step01SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Jclsortcobolvsamdb2Step01SortOut Write: {}",e.getMessage()); 		
  		}
  	}
