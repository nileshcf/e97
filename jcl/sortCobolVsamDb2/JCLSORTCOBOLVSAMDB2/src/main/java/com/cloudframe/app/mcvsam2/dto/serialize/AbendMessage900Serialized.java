...
public class AbendMessage900Serialized  extends Field { 
   ...
   /*  offset of each of Child Fields when serialized as a String */
            ...
            protected  int beginErrorText900;
	...
	**/
	...
	protected void init(int begin) {
	   ...
	   /*  set the offset/position of each field when this object is serialized as String */
             ...
             beginErrorText900 = getStartOffset() + 14;	// set offset for serialization
   ...
   protected char[] checkAbendCode900Constraints(char[] value) {
	 ...
	 */ 
     ...
     int localErrorText900Counter = -1;
     public boolean isErrorText900Modified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localErrorText900Counter != sharedCounter;
         localErrorText900Counter = sharedCounter; return hasModified;
     }
	protected static final int ERROR_TEXT_900_LEN = 66;
	/**
	 * 	serialize this ErrorText900
	 */
   protected void serializeErrorText900(char[] errorText900) {
        shareString.getSerializedField().incrementCounter();
        arraycopy(errorText900,0,getStringValue(),beginErrorText900,ERROR_TEXT_900_LEN);
       localErrorText900Counter = shareString.getSerializedField().getModifiedCounter();  	
   }

   protected char[] checkErrorText900Constraints(char[] value) {
   			return super.checkConstraints(value , 66 ,false, false);
   }
    /**
	 *	refreshErrorText900 is used to refresh the latest value of a variable from the Serialized String
	 *  the most common reason to serialize an Object as a string in to write to a file. There can be several other reasons for serialization as well
	 */ 
   	public char[] refreshErrorText900() {	 
   		return (substring(getStringValue(),beginErrorText900,beginErrorText900 + ERROR_TEXT_900_LEN));
   	}
