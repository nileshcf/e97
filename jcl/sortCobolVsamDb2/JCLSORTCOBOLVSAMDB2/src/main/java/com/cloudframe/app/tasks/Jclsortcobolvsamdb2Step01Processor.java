...
public class Jclsortcobolvsamdb2Step01Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Jclsortcobolvsamdb2Step01Processor.class);
