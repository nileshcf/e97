  ...
  @Component("Ice002P030_13SortOut")
  @JobScope
  public class Ice002P030_13SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_13SortOut.class);
  	@Value("${Ice002P030_13SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_13SortOutRecordType:${Ice002P030_13SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_13SortOutRecordLen:${Ice002P030_13SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_13SortOut Write: {}",e.getMessage()); 		
  		}
  	}
