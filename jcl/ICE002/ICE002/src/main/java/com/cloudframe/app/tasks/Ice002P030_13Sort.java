...
import com.cloudframe.app.sort.Ice002P030_13Detail;
import org.springframework.batch.core.ExitStatus;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import com.cloudframe.app.utility.CFUtil;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.records.Ice002P030_13Keys;
...
import com.cloudframe.app.sort.file.Ice002P030_13SortIn;
...
import com.cloudframe.app.sort.file.Ice002P030_13SortOut;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
import com.cloudframe.app.sort.file.Ice002P030_13SortIn;
public class Ice002P030_13Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_13Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_13")
	Ice002P030_13Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_13SortOut")
	Ice002P030_13SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_13SortIn")
	Ice002P030_13SortIn sortIn;
	...
	static final int OUTFIL_BUILD_LEN00 = 66;
	static final int OUTFIL_BUILD_SRCPOS01 = 0;
	static final int OUTFIL_BUILD_POS01 = 66;
	static final int OUTFIL_BUILD_LEN01 = 14;


	byte[] outfilBuildLtrl00 = convertChar2EbcdicBytes("END 00000000 00000000 00000000 00000000 00000001 00000000 00000000".toCharArray());
	final byte[] outfilBuildLtrl01 = convertChar2EbcdicBytes(CFUtil.fillSpaces(14));
    private String filePath = "";

	List<Ice002P030_13Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_13");
...
logger.info("STEPNAME: ICE002P030_13 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Ice002P030_13Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Ice002P030_13Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Ice002P030_13Keys relKey = new Ice002P030_13Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_13Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_13Keys> sortComp = sortDetail.getSortComp();
