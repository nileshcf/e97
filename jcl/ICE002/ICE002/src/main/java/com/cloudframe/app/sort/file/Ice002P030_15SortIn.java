  ...
  @Component("Ice002P030_15SortIn")
  @JobScope
  public class Ice002P030_15SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_15SortIn.class);
  	@Value("${Ice002P030_15SortIn:Y900.P.TM.Y90DCABR.SORTITM}")
  	...
  	@Value("#{'${Ice002P030_15SortInRecordType:${Ice002P030_15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_15SortInRecordLen:${Ice002P030_15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_15SortIn Read: {}",e.getMessage()); 
  		}
  	}
