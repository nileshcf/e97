...
import com.cloudframe.app.sort.file.Ice002P030_03SortOut;
...
public class Ice002P030_03Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_03Sort.class);
	@Autowired
	...
	@Autowired
	@Qualifier("Ice002P030_03SortOut")
	Ice002P030_03SortOut sortOut;
	...
	List<Ice002P030_03Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_03");
...
logger.info("STEPNAME: ICE002P030_03 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	byte[] sumRec = null;
	Ice002P030_03Keys sortKey = null;
	int sortKey1Len = 41;
	int sumKey1Pos = 44;
	int sumKey1Len = 8;
	private void addSumRecord(int index) throws Exception {
		try {
			Ice002P030_03Keys recKey = sortRecKeys.get(index);
			byte[] recBytes = null;
  ...
  private void setSumRecord(Ice002P030_03Keys key, byte[] recBytes) {
  ...
  private void writeSumOut(byte[] outRecBytes) throws CFException{
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_03Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_03Keys> sortComp = sortDetail.getSortComp();
