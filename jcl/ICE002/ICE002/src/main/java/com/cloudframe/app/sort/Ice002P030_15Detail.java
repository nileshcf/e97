...
@Component("batch_ice002p030_15")
@JobScope
public class Ice002P030_15Detail {

	private List<Ice002P030_15Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_15Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_15Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_15Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_15Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_15Keys> sortComp) {
