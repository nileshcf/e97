...
@Component("batch_ice002p060")
@JobScope
public class Ice002P060Detail {

	private List<Ice002P060Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P060Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P060Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P060Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P060Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P060Keys> sortComp) {
