  ...
  @Component("Ice002P030_07SortOut")
  @JobScope
  public class Ice002P030_07SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_07SortOut.class);
  	@Value("${Ice002P030_07SortOut:Y900.P.TM.Y90DCABR.SORTBA4}")
      ...
      @Value("#{'${Ice002P030_07SortOutRecordType:${Ice002P030_07SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_07SortOutRecordLen:${Ice002P030_07SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_07SortOut Write: {}",e.getMessage()); 		
  		}
  	}
