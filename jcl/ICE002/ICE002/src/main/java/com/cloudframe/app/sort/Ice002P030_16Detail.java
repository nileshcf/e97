...
@Component("batch_ice002p030_16")
@JobScope
public class Ice002P030_16Detail {

	private List<Ice002P030_16Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_16Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_16Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_16Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_16Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_16Keys> sortComp) {
