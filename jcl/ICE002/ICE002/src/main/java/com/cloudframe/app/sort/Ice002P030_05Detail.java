...
@Component("batch_ice002p030_05")
@JobScope
public class Ice002P030_05Detail {

	private List<Ice002P030_05Keys> sortRecKeys = null;
	private Set<Ice002P030_05Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_05Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_05Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_05Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<Ice002P030_05Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<Ice002P030_05Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_05Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_05Keys> sortComp) {
