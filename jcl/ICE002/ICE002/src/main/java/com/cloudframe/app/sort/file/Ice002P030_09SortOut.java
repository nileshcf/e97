  ...
  @Component("Ice002P030_09SortOut")
  @JobScope
  public class Ice002P030_09SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_09SortOut.class);
  	@Value("${Ice002P030_09SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_09SortOutRecordType:${Ice002P030_09SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_09SortOutRecordLen:${Ice002P030_09SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_09SortOut Write: {}",e.getMessage()); 		
  		}
  	}
