...
@Component("batch_ice002p030_12")
@JobScope
public class Ice002P030_12Detail {

	private List<Ice002P030_12Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_12Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_12Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_12Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_12Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_12Keys> sortComp) {
