...
@Component("batch_ice002p030_01")
@JobScope
public class Ice002P030_01Detail {

	private List<Ice002P030_01Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_01Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_01Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_01Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_01Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_01Keys> sortComp) {
