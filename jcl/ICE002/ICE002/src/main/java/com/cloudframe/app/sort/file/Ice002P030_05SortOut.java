  ...
  @Component("Ice002P030_05SortOut")
  @JobScope
  public class Ice002P030_05SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_05SortOut.class);
  	@Value("${Ice002P030_05SortOut:Y900.P.TM.Y90DCABR.SORTBAW}")
      ...
      @Value("#{'${Ice002P030_05SortOutRecordType:${Ice002P030_05SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_05SortOutRecordLen:${Ice002P030_05SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_05SortOut Write: {}",e.getMessage()); 		
  		}
  	}
