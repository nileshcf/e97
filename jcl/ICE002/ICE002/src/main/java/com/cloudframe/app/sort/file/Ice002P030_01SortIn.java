  ...
  @Component("Ice002P030_01SortIn")
  @JobScope
  public class Ice002P030_01SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_01SortIn.class);
  	@Value("${Ice002P030_01SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_01SortInRecordType:${Ice002P030_01SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_01SortInRecordLen:${Ice002P030_01SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_01SortIn Read: {}",e.getMessage()); 
  		}
  	}
