  ...
  @Component("Ice002P030_11SortIn")
  @JobScope
  public class Ice002P030_11SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_11SortIn.class);
  	@Value("${Ice002P030_11SortIn:Y900.P.TM.Y90DCABR.SORTBA1}")
  	...
  	@Value("#{'${Ice002P030_11SortInRecordType:${Ice002P030_11SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_11SortInRecordLen:${Ice002P030_11SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_11SortIn Read: {}",e.getMessage()); 
  		}
  	}
