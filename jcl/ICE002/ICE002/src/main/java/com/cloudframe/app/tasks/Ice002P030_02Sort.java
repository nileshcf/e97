...
import com.cloudframe.app.sort.file.Ice002P030_02SortIn;
...
import com.cloudframe.app.sort.file.records.Ice002P030_02Keys;
import com.cloudframe.app.sort.file.Ice002P030_02SortIn;
import org.springframework.beans.factory.annotation.Autowired;
import java.io.FileNotFoundException;
import java.util.Arrays; 
import com.cloudframe.app.sort.Ice002P030_02Detail;
...
import com.cloudframe.app.sort.file.Ice002P030_02SortOut;
public class Ice002P030_02Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_02Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_02")
	Ice002P030_02Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_02SortOut")
	Ice002P030_02SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_02SortIn")
	Ice002P030_02SortIn sortIn;
	...
	List<Ice002P030_02Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_LEN0 = 41;
     byte[] filter1 = convertChar2EbcdicBytes("CLC".toCharArray());
	@Override
...
logger.info("STEPNAME: ICE002P030_02 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	byte[] sumRec = null;
	Ice002P030_02Keys sortKey = null;
	int sortKey1Len = 41;
	int sumKey1Pos = 44;
	int sumKey1Len = 8;
	private void addSumRecord(int index) throws Exception {
		try {
			Ice002P030_02Keys recKey = sortRecKeys.get(index);
			byte[] recBytes = null;
  ...
  private void setSumRecord(Ice002P030_02Keys key, byte[] recBytes) {
  ...
  private void writeSumOut(byte[] outRecBytes) throws CFException{
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Ice002P030_02Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Ice002P030_02Keys relKey = new Ice002P030_02Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_02Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_02Keys> sortComp = sortDetail.getSortComp();
