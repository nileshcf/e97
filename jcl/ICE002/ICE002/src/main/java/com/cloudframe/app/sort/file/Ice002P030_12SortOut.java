  ...
  @Component("Ice002P030_12SortOut")
  @JobScope
  public class Ice002P030_12SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_12SortOut.class);
  	@Value("${Ice002P030_12SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_12SortOutRecordType:${Ice002P030_12SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_12SortOutRecordLen:${Ice002P030_12SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_12SortOut Write: {}",e.getMessage()); 		
  		}
  	}
