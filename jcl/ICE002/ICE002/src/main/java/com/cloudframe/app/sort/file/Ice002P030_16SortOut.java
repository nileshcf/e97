  ...
  @Component("Ice002P030_16SortOut")
  @JobScope
  public class Ice002P030_16SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_16SortOut.class);
  	@Value("${Ice002P030_16SortOut:Y900.P.TM.Y90DCABR.SUMALL}")
      ...
      @Value("#{'${Ice002P030_16SortOutRecordType:${Ice002P030_16SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_16SortOutRecordLen:${Ice002P030_16SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_16SortOut Write: {}",e.getMessage()); 		
  		}
  	}
