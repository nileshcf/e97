...
public class Ice002P030_02OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Ice002P030_02OutputWriter.class);
	@Autowired
