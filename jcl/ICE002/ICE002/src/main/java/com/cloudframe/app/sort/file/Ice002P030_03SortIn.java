  ...
  @Component("Ice002P030_03SortIn")
  @JobScope
  public class Ice002P030_03SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_03SortIn.class);
  	@Value("${Ice002P030_03SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_03SortInRecordType:${Ice002P030_03SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_03SortInRecordLen:${Ice002P030_03SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_03SortIn Read: {}",e.getMessage()); 
  		}
  	}
