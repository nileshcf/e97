...
public class Ice002P030_05Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_05Sort.class);
	@Autowired
    ...
    byte[] outrecOverlay1 = convertChar2EbcdicBytes("                     ".toCharArray());
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_POS1 = 37;
	static final int KEY_LEN0 = 29;
	static final int KEY_LEN1 = 3;
     byte[] filter1 = convertChar2EbcdicBytes("BA3".toCharArray());
	@Override
...
logger.info("STEPNAME: ICE002P030_05 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
    ...
    private byte[] getOutrecRecord(byte[] record) {  
        byte[] tempRecord = new byte[OVERLAY_OUTREC_SIZE];
         ...
         copyRecordBytes(outrecOverlay1,tempRecord, 0, 59, outrecOverlay1.length); 
          return tempRecord;
    }
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<Ice002P030_05Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		Ice002P030_05Keys relKey = new Ice002P030_05Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_05Keys.getKeyBinary1Comparator(true/*isAscending*/)               
                   .thenComparing(Ice002P030_05Keys.getKeyBinary2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_05Keys> sortComp = sortDetail.getSortComp();
