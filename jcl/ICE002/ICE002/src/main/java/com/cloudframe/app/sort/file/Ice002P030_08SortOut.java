  ...
  @Component("Ice002P030_08SortOut")
  @JobScope
  public class Ice002P030_08SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_08SortOut.class);
  	@Value("${Ice002P030_08SortOut:Y900.P.TM.Y90DCABR.SORTITM}")
      ...
      @Value("#{'${Ice002P030_08SortOutRecordType:${Ice002P030_08SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_08SortOutRecordLen:${Ice002P030_08SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_08SortOut Write: {}",e.getMessage()); 		
  		}
  	}
