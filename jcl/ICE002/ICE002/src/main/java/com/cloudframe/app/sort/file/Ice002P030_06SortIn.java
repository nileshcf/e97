  ...
  @Component("Ice002P030_06SortIn")
  @JobScope
  public class Ice002P030_06SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_06SortIn.class);
  	@Value("${Ice002P030_06SortIn:Y900.P.TM.Y90DCABR.SORTBAW}")
  	...
  	@Value("#{'${Ice002P030_06SortInRecordType:${Ice002P030_06SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_06SortInRecordLen:${Ice002P030_06SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_06SortIn Read: {}",e.getMessage()); 
  		}
  	}
