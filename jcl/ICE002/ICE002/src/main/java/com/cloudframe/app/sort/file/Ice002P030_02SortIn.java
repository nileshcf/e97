  ...
  @Component("Ice002P030_02SortIn")
  @JobScope
  public class Ice002P030_02SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_02SortIn.class);
  	@Value("${Ice002P030_02SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_02SortInRecordType:${Ice002P030_02SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_02SortInRecordLen:${Ice002P030_02SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_02SortIn Read: {}",e.getMessage()); 
  		}
  	}
