...
public class Ice002P030_08InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_08InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_LEN0 = 58;
     byte[] filter1 = convertChar2EbcdicBytes("ITM".toCharArray());
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<Ice002P030_08Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		Ice002P030_08Keys relKey = new Ice002P030_08Keys();
