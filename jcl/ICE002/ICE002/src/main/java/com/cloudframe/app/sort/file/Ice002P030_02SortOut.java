  ...
  @Component("Ice002P030_02SortOut")
  @JobScope
  public class Ice002P030_02SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_02SortOut.class);
  	@Value("${Ice002P030_02SortOut:Y900.P.TM.Y90DCABR.SORTCLC}")
      ...
      @Value("#{'${Ice002P030_02SortOutRecordType:${Ice002P030_02SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_02SortOutRecordLen:${Ice002P030_02SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_02SortOut Write: {}",e.getMessage()); 		
  		}
  	}
