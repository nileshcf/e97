  ...
  @Component("Ice002P030_10SortOut")
  @JobScope
  public class Ice002P030_10SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_10SortOut.class);
  	@Value("${Ice002P030_10SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_10SortOutRecordType:${Ice002P030_10SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_10SortOutRecordLen:${Ice002P030_10SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_10SortOut Write: {}",e.getMessage()); 		
  		}
  	}
