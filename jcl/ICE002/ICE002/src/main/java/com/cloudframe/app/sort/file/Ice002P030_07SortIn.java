  ...
  @Component("Ice002P030_07SortIn")
  @JobScope
  public class Ice002P030_07SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_07SortIn.class);
  	@Value("${Ice002P030_07SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_07SortInRecordType:${Ice002P030_07SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_07SortInRecordLen:${Ice002P030_07SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_07SortIn Read: {}",e.getMessage()); 
  		}
  	}
