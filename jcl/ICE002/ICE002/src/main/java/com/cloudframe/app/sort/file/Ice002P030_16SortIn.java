  ...
  @Component("Ice002P030_16SortIn")
  @JobScope
  public class Ice002P030_16SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_16SortIn.class);
  	@Value("${Ice002P030_16SortIn:Y900.P.TM.Y90DCABR.SUMWORK}")
  	...
  	@Value("#{'${Ice002P030_16SortInRecordType:${Ice002P030_16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_16SortInRecordLen:${Ice002P030_16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_16SortIn Read: {}",e.getMessage()); 
  		}
  	}
