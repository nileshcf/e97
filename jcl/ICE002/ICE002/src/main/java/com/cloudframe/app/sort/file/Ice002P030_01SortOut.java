  ...
  @Component("Ice002P030_01SortOut")
  @JobScope
  public class Ice002P030_01SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_01SortOut.class);
  	@Value("${Ice002P030_01SortOut:Y900.P.TM.Y90DCABR.SORTAK1}")
      ...
      @Value("#{'${Ice002P030_01SortOutRecordType:${Ice002P030_01SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_01SortOutRecordLen:${Ice002P030_01SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_01SortOut Write: {}",e.getMessage()); 		
  		}
  	}
