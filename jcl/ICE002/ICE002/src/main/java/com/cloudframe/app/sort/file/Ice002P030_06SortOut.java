  ...
  @Component("Ice002P030_06SortOut")
  @JobScope
  public class Ice002P030_06SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_06SortOut.class);
  	@Value("${Ice002P030_06SortOut:Y900.P.TM.Y90DCABR.SORTBA3}")
      ...
      @Value("#{'${Ice002P030_06SortOutRecordType:${Ice002P030_06SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_06SortOutRecordLen:${Ice002P030_06SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_06SortOut Write: {}",e.getMessage()); 		
  		}
  	}
