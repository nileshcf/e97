  ...
  @Component("Ice002P030_13SortIn")
  @JobScope
  public class Ice002P030_13SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_13SortIn.class);
  	@Value("${Ice002P030_13SortIn:Y900.P.TM.Y90DCABR.SORTBA3}")
  	...
  	@Value("#{'${Ice002P030_13SortInRecordType:${Ice002P030_13SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_13SortInRecordLen:${Ice002P030_13SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_13SortIn Read: {}",e.getMessage()); 
  		}
  	}
