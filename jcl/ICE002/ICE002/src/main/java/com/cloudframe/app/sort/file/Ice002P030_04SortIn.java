  ...
  @Component("Ice002P030_04SortIn")
  @JobScope
  public class Ice002P030_04SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_04SortIn.class);
  	@Value("${Ice002P030_04SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_04SortInRecordType:${Ice002P030_04SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_04SortInRecordLen:${Ice002P030_04SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_04SortIn Read: {}",e.getMessage()); 
  		}
  	}
