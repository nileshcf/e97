...
@Component("batch_ice002p030_14")
@JobScope
public class Ice002P030_14Detail {

	private List<Ice002P030_14Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_14Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_14Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_14Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_14Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_14Keys> sortComp) {
