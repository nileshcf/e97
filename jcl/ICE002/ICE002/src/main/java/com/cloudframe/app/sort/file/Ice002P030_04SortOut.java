  ...
  @Component("Ice002P030_04SortOut")
  @JobScope
  public class Ice002P030_04SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_04SortOut.class);
  	@Value("${Ice002P030_04SortOut:Y900.P.TM.Y90DCABR.SORTBA2}")
      ...
      @Value("#{'${Ice002P030_04SortOutRecordType:${Ice002P030_04SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_04SortOutRecordLen:${Ice002P030_04SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_04SortOut Write: {}",e.getMessage()); 		
  		}
  	}
