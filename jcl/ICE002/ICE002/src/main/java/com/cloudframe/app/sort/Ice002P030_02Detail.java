...
@Component("batch_ice002p030_02")
@JobScope
public class Ice002P030_02Detail {

	private List<Ice002P030_02Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_02Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_02Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_02Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_02Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_02Keys> sortComp) {
