...
@Component("batch_ice002p030_09")
@JobScope
public class Ice002P030_09Detail {

	private List<Ice002P030_09Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_09Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_09Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_09Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_09Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_09Keys> sortComp) {
