...
import com.cloudframe.app.sort.file.Ice002P030_15SortIn;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import com.cloudframe.app.utility.CFUtil;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.records.Ice002P030_15Keys;
...
import com.cloudframe.app.sort.file.Ice002P030_15SortOut;
import com.cloudframe.app.sort.Ice002P030_15Detail;
...
public class Ice002P030_15Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_15Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_15")
	Ice002P030_15Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_15SortOut")
	Ice002P030_15SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_15SortIn")
	Ice002P030_15SortIn sortIn;
	...
	byte[] outfilBuildLtrl00 = convertChar2EbcdicBytes("END 00000000 00000000 00000000 00000000 00000000 00000000 00000001".toCharArray());
	final byte[] outfilBuildLtrl01 = convertChar2EbcdicBytes(CFUtil.fillSpaces(14));
    private String filePath = "";

	List<Ice002P030_15Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_15");
...
logger.info("STEPNAME: ICE002P030_15 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Ice002P030_15Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Ice002P030_15Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Ice002P030_15Keys relKey = new Ice002P030_15Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_15Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_15Keys> sortComp = sortDetail.getSortComp();
