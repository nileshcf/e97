...
@Component("batch_ice002p030_13")
@JobScope
public class Ice002P030_13Detail {

	private List<Ice002P030_13Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_13Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_13Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_13Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_13Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_13Keys> sortComp) {
