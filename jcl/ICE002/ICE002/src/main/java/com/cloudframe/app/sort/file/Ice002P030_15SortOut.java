  ...
  @Component("Ice002P030_15SortOut")
  @JobScope
  public class Ice002P030_15SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_15SortOut.class);
  	@Value("${Ice002P030_15SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_15SortOutRecordType:${Ice002P030_15SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_15SortOutRecordLen:${Ice002P030_15SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_15SortOut Write: {}",e.getMessage()); 		
  		}
  	}
