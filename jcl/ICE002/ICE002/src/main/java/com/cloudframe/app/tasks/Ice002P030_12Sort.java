...
import com.cloudframe.app.sort.Ice002P030_12Detail;
import com.cloudframe.app.sort.file.records.Ice002P030_12Keys;
import com.cloudframe.app.sort.file.Ice002P030_12SortOut;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import com.cloudframe.app.sort.file.Ice002P030_12SortIn;
...
public class Ice002P030_12Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_12Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_12")
	Ice002P030_12Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_12SortOut")
	Ice002P030_12SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_12SortIn")
	Ice002P030_12SortIn sortIn;
	...
	byte[] outfilBuildLtrl00 = convertChar2EbcdicBytes("END 00000000 00000000 00000000 00000001 00000000 00000000 00000000".toCharArray());
	final byte[] outfilBuildLtrl01 = convertChar2EbcdicBytes(CFUtil.fillSpaces(14));
    private String filePath = "";

	List<Ice002P030_12Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_12");
...
logger.info("STEPNAME: ICE002P030_12 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Ice002P030_12Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Ice002P030_12Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Ice002P030_12Keys relKey = new Ice002P030_12Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_12Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_12Keys> sortComp = sortDetail.getSortComp();
