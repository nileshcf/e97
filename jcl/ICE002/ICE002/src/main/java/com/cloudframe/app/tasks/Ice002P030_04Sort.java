...
import com.cloudframe.app.sort.file.Ice002P030_04SortOut;
import com.cloudframe.app.data.Field;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import org.springframework.batch.repeat.RepeatStatus;
import com.cloudframe.app.sort.Ice002P030_04Detail;
import java.util.List;
import java.io.RandomAccessFile;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.process.BaseProcess;
import com.cloudframe.app.sort.file.records.Ice002P030_04Keys;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import com.cloudframe.app.sort.file.Ice002P030_04SortIn;
...
public class Ice002P030_04Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_04Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_04")
	Ice002P030_04Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_04SortOut")
	Ice002P030_04SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_04SortIn")
	Ice002P030_04SortIn sortIn;
	...
	List<Ice002P030_04Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_LEN0 = 32;
     byte[] filter1 = convertChar2EbcdicBytes("BA2".toCharArray());
	@Override
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_04");
...
logger.info("STEPNAME: ICE002P030_04 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	byte[] sumRec = null;
	Ice002P030_04Keys sortKey = null;
	int sortKey1Len = 32;
	int sumKey1Pos = 33;
	int sumKey1Len = 8;
	private void addSumRecord(int index) throws Exception {
		try {
			Ice002P030_04Keys recKey = sortRecKeys.get(index);
			byte[] recBytes = null;
  ...
  private void setSumRecord(Ice002P030_04Keys key, byte[] recBytes) {
  ...
  private void writeSumOut(byte[] outRecBytes) throws CFException{
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Ice002P030_04Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Ice002P030_04Keys relKey = new Ice002P030_04Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_04Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_04Keys> sortComp = sortDetail.getSortComp();
