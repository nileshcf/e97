  ...
  @Component("Ice002P030_12SortIn")
  @JobScope
  public class Ice002P030_12SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_12SortIn.class);
  	@Value("${Ice002P030_12SortIn:Y900.P.TM.Y90DCABR.SORTBA2}")
  	...
  	@Value("#{'${Ice002P030_12SortInRecordType:${Ice002P030_12SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_12SortInRecordLen:${Ice002P030_12SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_12SortIn Read: {}",e.getMessage()); 
  		}
  	}
