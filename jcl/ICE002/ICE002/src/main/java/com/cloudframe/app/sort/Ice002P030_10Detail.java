...
@Component("batch_ice002p030_10")
@JobScope
public class Ice002P030_10Detail {

	private List<Ice002P030_10Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_10Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_10Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_10Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_10Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_10Keys> sortComp) {
