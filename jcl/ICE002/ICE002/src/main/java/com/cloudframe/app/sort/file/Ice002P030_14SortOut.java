  ...
  @Component("Ice002P030_14SortOut")
  @JobScope
  public class Ice002P030_14SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_14SortOut.class);
  	@Value("${Ice002P030_14SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_14SortOutRecordType:${Ice002P030_14SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_14SortOutRecordLen:${Ice002P030_14SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_14SortOut Write: {}",e.getMessage()); 		
  		}
  	}
