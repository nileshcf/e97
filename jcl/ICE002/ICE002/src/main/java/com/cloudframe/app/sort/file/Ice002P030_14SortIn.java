  ...
  @Component("Ice002P030_14SortIn")
  @JobScope
  public class Ice002P030_14SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_14SortIn.class);
  	@Value("${Ice002P030_14SortIn:Y900.P.TM.Y90DCABR.SORTBA4}")
  	...
  	@Value("#{'${Ice002P030_14SortInRecordType:${Ice002P030_14SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_14SortInRecordLen:${Ice002P030_14SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_14SortIn Read: {}",e.getMessage()); 
  		}
  	}
