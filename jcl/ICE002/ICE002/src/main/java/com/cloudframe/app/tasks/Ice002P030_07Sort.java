...
import com.cloudframe.app.sort.file.records.Ice002P030_07Keys;
...
import com.cloudframe.app.sort.file.Ice002P030_07SortIn;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import com.cloudframe.app.sort.Ice002P030_07Detail;
...
import com.cloudframe.app.sort.file.Ice002P030_07SortOut;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class Ice002P030_07Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_07Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_07")
	Ice002P030_07Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_07SortOut")
	Ice002P030_07SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_07SortIn")
	Ice002P030_07SortIn sortIn;
	...
	List<Ice002P030_07Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_LEN0 = 30;
     byte[] filter1 = convertChar2EbcdicBytes("BA4".toCharArray());
	@Override
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_07");
...
logger.info("STEPNAME: ICE002P030_07 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Ice002P030_07Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<Ice002P030_07Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		Ice002P030_07Keys relKey = new Ice002P030_07Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_07Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_07Keys> sortComp = sortDetail.getSortComp();
