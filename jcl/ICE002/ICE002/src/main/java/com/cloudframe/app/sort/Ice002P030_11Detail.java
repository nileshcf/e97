...
@Component("batch_ice002p030_11")
@JobScope
public class Ice002P030_11Detail {

	private List<Ice002P030_11Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_11Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_11Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_11Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_11Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_11Keys> sortComp) {
