  ...
  @Component("Ice002P030_11SortOut")
  @JobScope
  public class Ice002P030_11SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_11SortOut.class);
  	@Value("${Ice002P030_11SortOut:Y900.P.TM.Y90DCABR.SUMWORK}")
      ...
      @Value("#{'${Ice002P030_11SortOutRecordType:${Ice002P030_11SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P030_11SortOutRecordLen:${Ice002P030_11SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P030_11SortOut Write: {}",e.getMessage()); 		
  		}
  	}
