...
@Component("batch_ice002p030_08")
@JobScope
public class Ice002P030_08Detail {

	private List<Ice002P030_08Keys> sortRecKeys = null;
	private Set<Ice002P030_08Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_08Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_08Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_08Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<Ice002P030_08Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<Ice002P030_08Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_08Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_08Keys> sortComp) {
