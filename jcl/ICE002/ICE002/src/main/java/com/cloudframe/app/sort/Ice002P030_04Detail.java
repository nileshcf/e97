...
@Component("batch_ice002p030_04")
@JobScope
public class Ice002P030_04Detail {

	private List<Ice002P030_04Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_04Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_04Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_04Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_04Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_04Keys> sortComp) {
