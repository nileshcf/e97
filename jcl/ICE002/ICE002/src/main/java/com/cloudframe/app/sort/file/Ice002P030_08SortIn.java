  ...
  @Component("Ice002P030_08SortIn")
  @JobScope
  public class Ice002P030_08SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_08SortIn.class);
  	@Value("${Ice002P030_08SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_08SortInRecordType:${Ice002P030_08SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_08SortInRecordLen:${Ice002P030_08SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_08SortIn Read: {}",e.getMessage()); 
  		}
  	}
