...
@Component("batch_ice002p030_03")
@JobScope
public class Ice002P030_03Detail {

	private List<Ice002P030_03Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_03Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_03Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_03Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_03Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_03Keys> sortComp) {
