  ...
  @Component("Ice002P060SortOut")
  @JobScope
  public class Ice002P060SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P060SortOut.class);
  	@Value("${Ice002P060SortOut:Y900.P.TM.ITEMSUMM.TMS}")
      ...
      @Value("#{'${Ice002P060SortOutRecordType:${Ice002P060SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Ice002P060SortOutRecordLen:${Ice002P060SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Ice002P060SortOut Write: {}",e.getMessage()); 		
  		}
  	}
