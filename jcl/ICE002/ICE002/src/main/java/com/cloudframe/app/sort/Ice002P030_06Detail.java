...
@Component("batch_ice002p030_06")
@JobScope
public class Ice002P030_06Detail {

	private List<Ice002P030_06Keys> sortRecKeys = null;
	private Set<Ice002P030_06Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<Ice002P030_06Keys> sortComp = null;
	 ...
	 */
	public List<Ice002P030_06Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Ice002P030_06Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<Ice002P030_06Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<Ice002P030_06Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<Ice002P030_06Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Ice002P030_06Keys> sortComp) {
