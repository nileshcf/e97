  ...
  @Component("Ice002P060SortIn")
  @JobScope
  public class Ice002P060SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P060SortIn.class);
  	@Value("${Ice002P060SortIn:Y900.P.TM.ITEMSUMM.X350}")
  	...
  	@Value("#{'${Ice002P060SortInRecordType:${Ice002P060SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P060SortInRecordLen:${Ice002P060SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P060SortIn Read: {}",e.getMessage()); 
  		}
  	}
