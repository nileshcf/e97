...
import com.cloudframe.app.sort.Ice002P030_14Detail;
import com.cloudframe.app.sort.file.records.Ice002P030_14Keys;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;
import com.cloudframe.app.sort.file.Ice002P030_14SortIn;

import org.springframework.batch.repeat.RepeatStatus;
import com.cloudframe.app.sort.file.Ice002P030_14SortOut;
...
public class Ice002P030_14Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Ice002P030_14Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_ice002p030_14")
	Ice002P030_14Detail sortDetail;
	
	@Autowired
	@Qualifier("Ice002P030_14SortOut")
	Ice002P030_14SortOut sortOut;
	

	
	@Autowired
	@Qualifier("Ice002P030_14SortIn")
	Ice002P030_14SortIn sortIn;
	...
	byte[] outfilBuildLtrl00 = convertChar2EbcdicBytes("END 00000000 00000000 00000000 00000000 00000000 00000001 00000000".toCharArray());
	final byte[] outfilBuildLtrl01 = convertChar2EbcdicBytes(CFUtil.fillSpaces(14));
    private String filePath = "";

	List<Ice002P030_14Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("p030_14");
...
logger.info("STEPNAME: ICE002P030_14 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Ice002P030_14Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Ice002P030_14Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Ice002P030_14Keys relKey = new Ice002P030_14Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   Ice002P030_14Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<Ice002P030_14Keys> sortComp = sortDetail.getSortComp();
