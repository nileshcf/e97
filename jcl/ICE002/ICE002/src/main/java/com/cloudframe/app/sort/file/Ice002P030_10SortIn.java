  ...
  @Component("Ice002P030_10SortIn")
  @JobScope
  public class Ice002P030_10SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_10SortIn.class);
  	@Value("${Ice002P030_10SortIn:Y900.P.TM.Y90DCABR.SORTCLC}")
  	...
  	@Value("#{'${Ice002P030_10SortInRecordType:${Ice002P030_10SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_10SortInRecordLen:${Ice002P030_10SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_10SortIn Read: {}",e.getMessage()); 
  		}
  	}
