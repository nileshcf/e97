  ...
  @Component("Ice002P030_05SortIn")
  @JobScope
  public class Ice002P030_05SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Ice002P030_05SortIn.class);
  	@Value("${Ice002P030_05SortIn:Y900.P.TM.USBTBITM.FILEOUT(+0)}")
  	...
  	@Value("#{'${Ice002P030_05SortInRecordType:${Ice002P030_05SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Ice002P030_05SortInRecordLen:${Ice002P030_05SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Ice002P030_05SortIn Read: {}",e.getMessage()); 
  		}
  	}
