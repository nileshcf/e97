  ...
  @Component("McgcmsSort003SortOut")
  @JobScope
  public class McgcmsSort003SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort003SortOut.class);
  	@Value("${McgcmsSort003SortOut:CLOUDFRM.MC.GCMS.SORT.OUT003}")
      ...
      @Value("#{'${McgcmsSort003SortOutRecordType:${McgcmsSort003SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort003SortOutRecordLen:${McgcmsSort003SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 24;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort003SortOut Write: {}",e.getMessage()); 		
  		}
  	}
