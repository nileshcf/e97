  ...
  @Component("McgcmsSort011SortOut2")
  @JobScope
  public class McgcmsSort011SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortOut2.class);
  	@Value("${McgcmsSort011SortOut[2]:CLOUDFRM.MC.GCMS.SORT.OUT0113}")
      ...
      @Value("#{'${McgcmsSort011SortOut2RecordType:${McgcmsSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort011SortOut2RecordLen:${McgcmsSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
