...
import com.cloudframe.app.sort.file.records.McgcmsSort002Keys;
import com.cloudframe.app.data.Field;

@Component("batch_mcgcmssort002")
@JobScope
public class McgcmsSort002Detail {

	private List<McgcmsSort002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort002Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort002Keys> sortComp) {
