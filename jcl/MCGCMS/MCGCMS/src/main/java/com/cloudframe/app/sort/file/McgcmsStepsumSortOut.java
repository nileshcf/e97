  ...
  @Component("McgcmsStepsumSortOut")
  @JobScope
  public class McgcmsStepsumSortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsStepsumSortOut.class);
  	@Value("${McgcmsStepsumSortOut:CLOUDFRM.MC.GCMS.SORT.OUTSUM}")
      ...
      @Value("#{'${McgcmsStepsumSortOutRecordType:${McgcmsStepsumSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsStepsumSortOutRecordLen:${McgcmsStepsumSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsStepsumSortOut Write: {}",e.getMessage()); 		
  		}
  	}
