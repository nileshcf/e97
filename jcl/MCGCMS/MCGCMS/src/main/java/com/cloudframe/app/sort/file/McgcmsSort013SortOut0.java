  ...
  @Component("McgcmsSort013SortOut0")
  @JobScope
  public class McgcmsSort013SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort013SortOut0.class);
  	@Value("${McgcmsSort013SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0131}")
      ...
      @Value("#{'${McgcmsSort013SortOut0RecordType:${McgcmsSort013SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort013SortOut0RecordLen:${McgcmsSort013SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort013SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
