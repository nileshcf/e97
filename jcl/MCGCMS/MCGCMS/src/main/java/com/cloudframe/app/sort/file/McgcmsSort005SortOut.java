  ...
  @Component("McgcmsSort005SortOut")
  @JobScope
  public class McgcmsSort005SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort005SortOut.class);
  	@Value("${McgcmsSort005SortOut:CLOUDFRM.MC.GCMS.SORT.OUT005}")
      ...
      @Value("#{'${McgcmsSort005SortOutRecordType:${McgcmsSort005SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort005SortOutRecordLen:${McgcmsSort005SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 62;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort005SortOut Write: {}",e.getMessage()); 		
  		}
  	}
