  ...
  @Component("McgcmsSort017SortIn")
  @JobScope
  public class McgcmsSort017SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort017SortIn.class);
  	@Value("${McgcmsSort017SortIn:CLOUDFRM.MC.GCMS.SORT.IN017}")
  	...
  	@Value("#{'${McgcmsSort017SortInRecordType:${McgcmsSort017SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort017SortInRecordLen:${McgcmsSort017SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort017SortIn Read: {}",e.getMessage()); 
  		}
  	}
