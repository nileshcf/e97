  ...
  @Component("McgcmsSort005SortIn")
  @JobScope
  public class McgcmsSort005SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort005SortIn.class);
  	@Value("${McgcmsSort005SortIn:CLOUDFRM.MC.GCMS.SORT.IN005}")
  	...
  	@Value("#{'${McgcmsSort005SortInRecordType:${McgcmsSort005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort005SortInRecordLen:${McgcmsSort005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort005SortIn Read: {}",e.getMessage()); 
  		}
  	}
