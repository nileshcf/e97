  ...
  @Component("McgcmsSort009SortOut")
  @JobScope
  public class McgcmsSort009SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort009SortOut.class);
  	@Value("${McgcmsSort009SortOut:CLOUDFRM.MC.GCMS.SORT.OUT009}")
      ...
      @Value("#{'${McgcmsSort009SortOutRecordType:${McgcmsSort009SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort009SortOutRecordLen:${McgcmsSort009SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort009SortOut Write: {}",e.getMessage()); 		
  		}
  	}
