  ...
  @Component("McgcmsSort012SortOut0")
  @JobScope
  public class McgcmsSort012SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort012SortOut0.class);
  	@Value("${McgcmsSort012SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0121}")
      ...
      @Value("#{'${McgcmsSort012SortOut0RecordType:${McgcmsSort012SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort012SortOut0RecordLen:${McgcmsSort012SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort012SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
