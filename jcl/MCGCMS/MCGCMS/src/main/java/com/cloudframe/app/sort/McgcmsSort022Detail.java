...
@Component("batch_mcgcmssort022")
@JobScope
public class McgcmsSort022Detail {

	private List<McgcmsSort022Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort022Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort022Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort022Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort022Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort022Keys> sortComp) {
