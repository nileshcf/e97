  ...
  @Component("McgcmsSort022SortOut0")
  @JobScope
  public class McgcmsSort022SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort022SortOut0.class);
  	@Value("${McgcmsSort022SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0221}")
      ...
      @Value("#{'${McgcmsSort022SortOut0RecordType:${McgcmsSort022SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort022SortOut0RecordLen:${McgcmsSort022SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 394;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort022SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
