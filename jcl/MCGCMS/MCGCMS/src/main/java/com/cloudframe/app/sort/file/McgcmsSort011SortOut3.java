  ...
  @Component("McgcmsSort011SortOut3")
  @JobScope
  public class McgcmsSort011SortOut3 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortOut3.class);
  	@Value("${McgcmsSort011SortOut[3]:CLOUDFRM.MC.GCMS.SORT.OUT0114}")
      ...
      @Value("#{'${McgcmsSort011SortOut3RecordType:${McgcmsSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort011SortOut3RecordLen:${McgcmsSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortOut3 Write: {}",e.getMessage()); 		
  		}
  	}
