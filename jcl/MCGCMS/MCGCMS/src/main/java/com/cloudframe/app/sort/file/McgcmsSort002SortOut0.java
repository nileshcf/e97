  ...
  @Component("McgcmsSort002SortOut0")
  @JobScope
  public class McgcmsSort002SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort002SortOut0.class);
  	@Value("${McgcmsSort002SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0021}")
      ...
      @Value("#{'${McgcmsSort002SortOut0RecordType:${McgcmsSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort002SortOut0RecordLen:${McgcmsSort002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort002SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
