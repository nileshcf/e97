  ...
  @Component("McgcmsSort022SortIn")
  @JobScope
  public class McgcmsSort022SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort022SortIn.class);
  	@Value("${McgcmsSort022SortIn:CLOUDFRM.MC.GCMS.SORT.IN022}")
  	...
  	@Value("#{'${McgcmsSort022SortInRecordType:${McgcmsSort022SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort022SortInRecordLen:${McgcmsSort022SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort022SortIn Read: {}",e.getMessage()); 
  		}
  	}
