  ...
  @Component("McgcmsSort011SortOut0")
  @JobScope
  public class McgcmsSort011SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortOut0.class);
  	@Value("${McgcmsSort011SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0111}")
      ...
      @Value("#{'${McgcmsSort011SortOut0RecordType:${McgcmsSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort011SortOut0RecordLen:${McgcmsSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
