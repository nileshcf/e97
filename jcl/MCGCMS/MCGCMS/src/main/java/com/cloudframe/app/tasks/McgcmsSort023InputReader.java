...
public class McgcmsSort023InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort023InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsSort023Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsSort023Keys relKey = new McgcmsSort023Keys();
