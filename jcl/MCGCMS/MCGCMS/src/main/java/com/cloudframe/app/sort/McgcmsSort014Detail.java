...
@Component("batch_mcgcmssort014")
@JobScope
public class McgcmsSort014Detail {

	private List<McgcmsSort014Keys> sortRecKeys = null;
	private List<McgcmsSort014JoinKeys> joinRecKey1 = null;
	private List<McgcmsSort014JoinKeys> joinRecKey2 = null;
	private Comparator<McgcmsSort014JoinKeys> joinkeyComp = null;
	...
	private Comparator<McgcmsSort014Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort014JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McgcmsSort014JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McgcmsSort014JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McgcmsSort014JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McgcmsSort014JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McgcmsSort014JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McgcmsSort014Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort014Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort014Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort014Keys> sortComp) {
