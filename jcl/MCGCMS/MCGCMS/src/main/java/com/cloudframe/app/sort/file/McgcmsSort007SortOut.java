  ...
  @Component("McgcmsSort007SortOut")
  @JobScope
  public class McgcmsSort007SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort007SortOut.class);
  	@Value("${McgcmsSort007SortOut:CLOUDFRM.MC.GCMS.SORT.OUT007}")
      ...
      @Value("#{'${McgcmsSort007SortOutRecordType:${McgcmsSort007SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort007SortOutRecordLen:${McgcmsSort007SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 150;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort007SortOut Write: {}",e.getMessage()); 		
  		}
  	}
