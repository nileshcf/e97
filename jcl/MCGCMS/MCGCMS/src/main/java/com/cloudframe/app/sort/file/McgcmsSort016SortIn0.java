  ...
  @Component("McgcmsSort016SortIn0")
  @JobScope
  public class McgcmsSort016SortIn0 extends CFFile {
  	@Value("${McgcmsSort016SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0161}")
  	...
  	@Value("#{'${McgcmsSort016SortIn0RecordType:${McgcmsSort016SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort016SortIn0RecordLen:${McgcmsSort016SortInRecordLen:80}}'}")
