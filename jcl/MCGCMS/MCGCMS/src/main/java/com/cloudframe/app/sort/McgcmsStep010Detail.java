...
@Component("batch_mcgcmsstep010")
@JobScope
public class McgcmsStep010Detail {

	private List<McgcmsStep010Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsStep010Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsStep010Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsStep010Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsStep010Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsStep010Keys> sortComp) {
