  ...
  @Component("McgcmsStepsumSortIn")
  @JobScope
  public class McgcmsStepsumSortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsStepsumSortIn.class);
  	@Value("${McgcmsStepsumSortIn:CLOUDFRM.MC.GCMS.SORT.INSUM}")
  	...
  	@Value("#{'${McgcmsStepsumSortInRecordType:${McgcmsStepsumSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsStepsumSortInRecordLen:${McgcmsStepsumSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsStepsumSortIn Read: {}",e.getMessage()); 
  		}
  	}
