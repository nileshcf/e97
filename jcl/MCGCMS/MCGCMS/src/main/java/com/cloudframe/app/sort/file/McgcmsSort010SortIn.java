  ...
  @Component("McgcmsSort010SortIn")
  @JobScope
  public class McgcmsSort010SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort010SortIn.class);
  	@Value("${McgcmsSort010SortIn:CLOUDFRM.MC.GCMS.SORT.IN010}")
  	...
  	@Value("#{'${McgcmsSort010SortInRecordType:${McgcmsSort010SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort010SortInRecordLen:${McgcmsSort010SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort010SortIn Read: {}",e.getMessage()); 
  		}
  	}
