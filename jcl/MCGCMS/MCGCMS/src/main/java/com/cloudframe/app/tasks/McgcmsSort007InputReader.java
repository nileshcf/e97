...
public class McgcmsSort007InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort007InputReader.class);
/**
...
copyRecordBytes(fillBytes01,buildRec,0,126,24);
