...
public class McgcmsStepsumSort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsStepsumSort.class);
	@Autowired
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_POS1 = 7;
	static final int KEY_POS2 = 18;
	static final int KEY_POS3 = 20;
	static final int KEY_POS4 = 24;
	static final int KEY_LEN0 = 7;
	static final int KEY_LEN1 = 11;
	static final int KEY_LEN2 = 2;
	static final int KEY_LEN3 = 4;
...
logger.info("STEPNAME: MCGCMSSTEPSUM Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
  ...
  private void writeSumOut(byte[] outRecBytes) throws CFException{
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsStepsumKeys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsStepsumKeys relKey = new McgcmsStepsumKeys();
        ...
        relKey.setKeyCharacter5(getZoneDecimalRecordKeyBytes(recordByte, KEY_POS4 , KEY_LEN4)); 
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McgcmsStepsumKeys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(McgcmsStepsumKeys.getKeyCharacter2Comparator(true/*isAscending*/))               
                   .thenComparing(McgcmsStepsumKeys.getKeyCharacter3Comparator(true/*isAscending*/))               
                   .thenComparing(McgcmsStepsumKeys.getKeyCharacter4Comparator(true/*isAscending*/))               
                   .thenComparing(McgcmsStepsumKeys.getKeyCharacter5Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McgcmsStepsumKeys> sortComp = sortDetail.getSortComp();
