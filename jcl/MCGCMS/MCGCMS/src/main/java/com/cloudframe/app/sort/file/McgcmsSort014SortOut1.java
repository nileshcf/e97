  ...
  @Component("McgcmsSort014SortOut1")
  @JobScope
  public class McgcmsSort014SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort014SortOut1.class);
  	@Value("${McgcmsSort014SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0142}")
      ...
      @Value("#{'${McgcmsSort014SortOut1RecordType:${McgcmsSort014SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort014SortOut1RecordLen:${McgcmsSort014SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort014SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
