  ...
  @Component("McgcmsSort002SortIn")
  @JobScope
  public class McgcmsSort002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort002SortIn.class);
  	@Value("${McgcmsSort002SortIn:CLOUDFRM.MC.GCMS.SORT.IN002}")
  	...
  	@Value("#{'${McgcmsSort002SortInRecordType:${McgcmsSort002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort002SortInRecordLen:${McgcmsSort002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort002SortIn Read: {}",e.getMessage()); 
  		}
  	}
