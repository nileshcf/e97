...
import com.cloudframe.app.sort.file.records.McgcmsSort013JoinKeys;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.data.Field;

@Component("batch_mcgcmssort013")
@JobScope
public class McgcmsSort013Detail {

	private List<McgcmsSort013Keys> sortRecKeys = null;
	private List<McgcmsSort013JoinKeys> joinRecKey1 = null;
	private List<McgcmsSort013JoinKeys> joinRecKey2 = null;
	private Comparator<McgcmsSort013JoinKeys> joinkeyComp = null;
	...
	private Comparator<McgcmsSort013Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort013JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McgcmsSort013JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McgcmsSort013JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McgcmsSort013JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McgcmsSort013JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McgcmsSort013JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McgcmsSort013Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort013Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort013Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort013Keys> sortComp) {
