...
import com.cloudframe.app.sort.file.records.McgcmsSort016JoinKeys;
import com.cloudframe.app.sort.model.InMemoryKeySortKeyObject;
import com.cloudframe.app.data.Field;

@Component("batch_mcgcmssort016")
@JobScope
public class McgcmsSort016Detail {

	private List<McgcmsSort016Keys> sortRecKeys = null;
	private List<McgcmsSort016JoinKeys> joinRecKey1 = null;
	private List<McgcmsSort016JoinKeys> joinRecKey2 = null;
	private Comparator<McgcmsSort016JoinKeys> joinkeyComp = null;
	...
	private Comparator<McgcmsSort016Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort016JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McgcmsSort016JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McgcmsSort016JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McgcmsSort016JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McgcmsSort016JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McgcmsSort016JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McgcmsSort016Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort016Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort016Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort016Keys> sortComp) {
