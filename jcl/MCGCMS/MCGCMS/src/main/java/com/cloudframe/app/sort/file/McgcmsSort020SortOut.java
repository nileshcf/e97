  ...
  @Component("McgcmsSort020SortOut")
  @JobScope
  public class McgcmsSort020SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort020SortOut.class);
  	@Value("${McgcmsSort020SortOut:CLOUDFRM.MC.GCMS.SORT.OUT020}")
      ...
      @Value("#{'${McgcmsSort020SortOutRecordType:${McgcmsSort020SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort020SortOutRecordLen:${McgcmsSort020SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort020SortOut Write: {}",e.getMessage()); 		
  		}
  	}
