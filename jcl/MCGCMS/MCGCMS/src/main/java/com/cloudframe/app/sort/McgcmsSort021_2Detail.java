...
@Component("batch_mcgcmssort021_2")
@JobScope
public class McgcmsSort021_2Detail {

	private List<McgcmsSort021_2Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort021_2Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort021_2Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort021_2Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort021_2Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort021_2Keys> sortComp) {
