  ...
  @Component("McgcmsSort011SortIn")
  @JobScope
  public class McgcmsSort011SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortIn.class);
  	@Value("${McgcmsSort011SortIn:CLOUDFRM.MC.GCMS.SORT.IN011}")
  	...
  	@Value("#{'${McgcmsSort011SortInRecordType:${McgcmsSort011SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort011SortInRecordLen:${McgcmsSort011SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortIn Read: {}",e.getMessage()); 
  		}
  	}
