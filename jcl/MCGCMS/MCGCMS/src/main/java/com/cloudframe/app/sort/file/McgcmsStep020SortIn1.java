  ...
  @Component("McgcmsStep020SortIn1")
  @JobScope
  public class McgcmsStep020SortIn1 extends CFFile {
  	@Value("${McgcmsStep020SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0262}")
  	...
  	@Value("#{'${McgcmsStep020SortIn1RecordType:${McgcmsStep020SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsStep020SortIn1RecordLen:${McgcmsStep020SortInRecordLen:80}}'}")
