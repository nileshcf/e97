  ...
  @Component("McgcmsSort021_2SortIn1")
  @JobScope
  public class McgcmsSort021_2SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort021_2SortIn1.class);
  	@Value("${McgcmsSort021_2SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0212}")
  	...
  	@Value("#{'${McgcmsSort021_2SortIn1RecordType:${McgcmsSort021_2SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort021_2SortIn1RecordLen:${McgcmsSort021_2SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort021_2SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
