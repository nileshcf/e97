  ...
  @Component("McgcmsSort012SortOut1")
  @JobScope
  public class McgcmsSort012SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort012SortOut1.class);
  	@Value("${McgcmsSort012SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0122}")
      ...
      @Value("#{'${McgcmsSort012SortOut1RecordType:${McgcmsSort012SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort012SortOut1RecordLen:${McgcmsSort012SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort012SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
