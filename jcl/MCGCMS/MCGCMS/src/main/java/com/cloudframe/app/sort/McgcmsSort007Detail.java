...
@Component("batch_mcgcmssort007")
@JobScope
public class McgcmsSort007Detail {

	private List<McgcmsSort007Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort007Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort007Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort007Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort007Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort007Keys> sortComp) {
