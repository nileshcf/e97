  ...
  @Component("McgcmsSort024SortOut")
  @JobScope
  public class McgcmsSort024SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort024SortOut.class);
  	@Value("${McgcmsSort024SortOut:CLOUDFRM.MC.GCMS.SORT.OUT024}")
      ...
      @Value("#{'${McgcmsSort024SortOutRecordType:${McgcmsSort024SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort024SortOutRecordLen:${McgcmsSort024SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 58;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort024SortOut Write: {}",e.getMessage()); 		
  		}
  	}
