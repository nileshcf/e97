  ...
  @Component("McgcmsSort004SortIn")
  @JobScope
  public class McgcmsSort004SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort004SortIn.class);
  	@Value("${McgcmsSort004SortIn:CLOUDFRM.MC.GCMS.SORT.IN004}")
  	...
  	@Value("#{'${McgcmsSort004SortInRecordType:${McgcmsSort004SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort004SortInRecordLen:${McgcmsSort004SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort004SortIn Read: {}",e.getMessage()); 
  		}
  	}
