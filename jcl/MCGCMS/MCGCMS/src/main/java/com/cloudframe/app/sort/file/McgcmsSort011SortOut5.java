  ...
  @Component("McgcmsSort011SortOut5")
  @JobScope
  public class McgcmsSort011SortOut5 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortOut5.class);
  	@Value("${McgcmsSort011SortOut[5]:CLOUDFRM.MC.GCMS.SORT.OUT0116}")
      ...
      @Value("#{'${McgcmsSort011SortOut5RecordType:${McgcmsSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort011SortOut5RecordLen:${McgcmsSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortOut5 Write: {}",e.getMessage()); 		
  		}
  	}
