  ...
  @Component("McgcmsSort003SortIn")
  @JobScope
  public class McgcmsSort003SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort003SortIn.class);
  	@Value("${McgcmsSort003SortIn:CLOUDFRM.MC.GCMS.SORT.IN003}")
  	...
  	@Value("#{'${McgcmsSort003SortInRecordType:${McgcmsSort003SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort003SortInRecordLen:${McgcmsSort003SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort003SortIn Read: {}",e.getMessage()); 
  		}
  	}
