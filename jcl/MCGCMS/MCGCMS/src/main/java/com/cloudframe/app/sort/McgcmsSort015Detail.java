...
@Component("batch_mcgcmssort015")
@JobScope
public class McgcmsSort015Detail {

	private List<McgcmsSort015Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort015Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort015Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort015Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort015Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort015Keys> sortComp) {
