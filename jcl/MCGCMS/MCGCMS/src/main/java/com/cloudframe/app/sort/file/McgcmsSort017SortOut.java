  ...
  @Component("McgcmsSort017SortOut")
  @JobScope
  public class McgcmsSort017SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort017SortOut.class);
  	@Value("${McgcmsSort017SortOut:CLOUDFRM.MC.GCMS.SORT.OUT017}")
      ...
      @Value("#{'${McgcmsSort017SortOutRecordType:${McgcmsSort017SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort017SortOutRecordLen:${McgcmsSort017SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 10;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort017SortOut Write: {}",e.getMessage()); 		
  		}
  	}
