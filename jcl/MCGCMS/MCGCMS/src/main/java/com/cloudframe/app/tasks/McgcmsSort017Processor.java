...
public class McgcmsSort017Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(McgcmsSort017Processor.class);
	...
	public void beforeStep(StepExecution stepExecution) {
		...
		sortDetail.setSortComp(
                   McgcmsSort017Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		// Sort algorithm here
		Comparator<McgcmsSort017Keys> sortComp = sortDetail.getSortComp();
