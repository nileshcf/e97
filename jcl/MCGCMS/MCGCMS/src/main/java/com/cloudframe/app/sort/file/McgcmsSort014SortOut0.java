  ...
  @Component("McgcmsSort014SortOut0")
  @JobScope
  public class McgcmsSort014SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort014SortOut0.class);
  	@Value("${McgcmsSort014SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0141}")
      ...
      @Value("#{'${McgcmsSort014SortOut0RecordType:${McgcmsSort014SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort014SortOut0RecordLen:${McgcmsSort014SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort014SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
