  ...
  @Component("McgcmsSort014SortIn1")
  @JobScope
  public class McgcmsSort014SortIn1 extends CFFile {
  	@Value("${McgcmsSort014SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0142}")
  	...
  	@Value("#{'${McgcmsSort014SortIn1RecordType:${McgcmsSort014SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort014SortIn1RecordLen:${McgcmsSort014SortInRecordLen:80}}'}")
