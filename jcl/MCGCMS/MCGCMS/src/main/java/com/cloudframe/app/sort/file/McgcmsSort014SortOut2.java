  ...
  @Component("McgcmsSort014SortOut2")
  @JobScope
  public class McgcmsSort014SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort014SortOut2.class);
  	@Value("${McgcmsSort014SortOut[2]:CLOUDFRM.MC.GCMS.SORT.OUT0143}")
      ...
      @Value("#{'${McgcmsSort014SortOut2RecordType:${McgcmsSort014SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort014SortOut2RecordLen:${McgcmsSort014SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 43;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort014SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
