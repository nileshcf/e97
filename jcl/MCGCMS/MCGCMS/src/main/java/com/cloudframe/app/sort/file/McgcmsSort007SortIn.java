  ...
  @Component("McgcmsSort007SortIn")
  @JobScope
  public class McgcmsSort007SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort007SortIn.class);
  	@Value("${McgcmsSort007SortIn:CLOUDFRM.MC.GCMS.SORT.IN007}")
  	...
  	@Value("#{'${McgcmsSort007SortInRecordType:${McgcmsSort007SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort007SortInRecordLen:${McgcmsSort007SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort007SortIn Read: {}",e.getMessage()); 
  		}
  	}
