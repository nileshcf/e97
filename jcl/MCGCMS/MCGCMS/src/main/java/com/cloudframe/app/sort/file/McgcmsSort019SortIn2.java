  ...
  @Component("McgcmsSort019SortIn2")
  @JobScope
  public class McgcmsSort019SortIn2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort019SortIn2.class);
  	@Value("${McgcmsSort019SortIn[2]:CLOUDFRM.MC.GCMS.SORT.IN0193}")
  	...
  	@Value("#{'${McgcmsSort019SortIn2RecordType:${McgcmsSort019SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort019SortIn2RecordLen:${McgcmsSort019SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort019SortIn2 Read: {}",e.getMessage()); 
  		}
  	}
