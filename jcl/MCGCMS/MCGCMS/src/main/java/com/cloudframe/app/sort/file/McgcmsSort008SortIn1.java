  ...
  @Component("McgcmsSort008SortIn1")
  @JobScope
  public class McgcmsSort008SortIn1 extends CFFile {
  	@Value("${McgcmsSort008SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0082}")
  	...
  	@Value("#{'${McgcmsSort008SortIn1RecordType:${McgcmsSort008SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort008SortIn1RecordLen:${McgcmsSort008SortInRecordLen:80}}'}")
