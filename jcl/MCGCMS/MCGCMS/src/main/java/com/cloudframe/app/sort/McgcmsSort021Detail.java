...
@Component("batch_mcgcmssort021")
@JobScope
public class McgcmsSort021Detail {

	private List<McgcmsSort021Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort021Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort021Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort021Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort021Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort021Keys> sortComp) {
