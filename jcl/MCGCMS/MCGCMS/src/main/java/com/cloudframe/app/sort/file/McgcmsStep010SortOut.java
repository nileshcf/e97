  ...
  @Component("McgcmsStep010SortOut")
  @JobScope
  public class McgcmsStep010SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsStep010SortOut.class);
  	@Value("${McgcmsStep010SortOut:CLOUDFRM.MC.GCMS.SORT.OUT025}")
      ...
      @Value("#{'${McgcmsStep010SortOutRecordType:${McgcmsStep010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsStep010SortOutRecordLen:${McgcmsStep010SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsStep010SortOut Write: {}",e.getMessage()); 		
  		}
  	}
