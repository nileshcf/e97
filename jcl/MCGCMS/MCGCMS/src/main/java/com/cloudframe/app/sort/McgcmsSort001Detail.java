...
@Component("batch_mcgcmssort001")
@JobScope
public class McgcmsSort001Detail {

	private List<McgcmsSort001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort001Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort001Keys> sortComp) {
