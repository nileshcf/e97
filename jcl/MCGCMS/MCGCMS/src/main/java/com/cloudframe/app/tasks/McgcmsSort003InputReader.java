...
public class McgcmsSort003InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort003InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	final int OUTREC_LEN2=16;
	final int OUTREC_DES_POS1=0;
	final int OUTREC_DES_POS2=9;
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsSort003Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsSort003Keys relKey = new McgcmsSort003Keys();
