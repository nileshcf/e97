  ...
  @Component("McgcmsSort008SortOut")
  @JobScope
  public class McgcmsSort008SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort008SortOut.class);
  	@Value("${McgcmsSort008SortOut:CLOUDFRM.MC.GCMS.SORT.OUT008}")
      ...
      @Value("#{'${McgcmsSort008SortOutRecordType:${McgcmsSort008SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort008SortOutRecordLen:${McgcmsSort008SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort008SortOut Write: {}",e.getMessage()); 		
  		}
  	}
