...
@Component("batch_mcgcmssort012")
@JobScope
public class McgcmsSort012Detail {

	private List<McgcmsSort012Keys> sortRecKeys = null;
	private List<McgcmsSort012JoinKeys> joinRecKey1 = null;
	private List<McgcmsSort012JoinKeys> joinRecKey2 = null;
	private Comparator<McgcmsSort012JoinKeys> joinkeyComp = null;
	...
	private Comparator<McgcmsSort012Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort012JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McgcmsSort012JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McgcmsSort012JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McgcmsSort012JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McgcmsSort012JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McgcmsSort012JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McgcmsSort012Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort012Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort012Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort012Keys> sortComp) {
