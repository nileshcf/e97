  ...
  @Component("McgcmsSort014SortIn0")
  @JobScope
  public class McgcmsSort014SortIn0 extends CFFile {
  	@Value("${McgcmsSort014SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0141}")
  	...
  	@Value("#{'${McgcmsSort014SortIn0RecordType:${McgcmsSort014SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort014SortIn0RecordLen:${McgcmsSort014SortInRecordLen:80}}'}")
