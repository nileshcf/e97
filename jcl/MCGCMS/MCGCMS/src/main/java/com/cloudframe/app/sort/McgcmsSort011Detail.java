...
@Component("batch_mcgcmssort011")
@JobScope
public class McgcmsSort011Detail {

	private List<McgcmsSort011Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort011Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort011Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort011Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort011Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort011Keys> sortComp) {
