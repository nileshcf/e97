  ...
  @Component("McgcmsSort016SortIn1")
  @JobScope
  public class McgcmsSort016SortIn1 extends CFFile {
  	@Value("${McgcmsSort016SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0162}")
  	...
  	@Value("#{'${McgcmsSort016SortIn1RecordType:${McgcmsSort016SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort016SortIn1RecordLen:${McgcmsSort016SortInRecordLen:80}}'}")
