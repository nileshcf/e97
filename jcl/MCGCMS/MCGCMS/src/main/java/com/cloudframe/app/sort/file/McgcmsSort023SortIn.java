  ...
  @Component("McgcmsSort023SortIn")
  @JobScope
  public class McgcmsSort023SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort023SortIn.class);
  	@Value("${McgcmsSort023SortIn:CLOUDFRM.MC.GCMS.SORT.IN023}")
  	...
  	@Value("#{'${McgcmsSort023SortInRecordType:${McgcmsSort023SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort023SortInRecordLen:${McgcmsSort023SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort023SortIn Read: {}",e.getMessage()); 
  		}
  	}
