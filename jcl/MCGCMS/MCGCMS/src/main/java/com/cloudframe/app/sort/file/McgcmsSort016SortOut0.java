  ...
  @Component("McgcmsSort016SortOut0")
  @JobScope
  public class McgcmsSort016SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort016SortOut0.class);
  	@Value("${McgcmsSort016SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0161}")
      ...
      @Value("#{'${McgcmsSort016SortOut0RecordType:${McgcmsSort016SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort016SortOut0RecordLen:${McgcmsSort016SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 247;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort016SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
