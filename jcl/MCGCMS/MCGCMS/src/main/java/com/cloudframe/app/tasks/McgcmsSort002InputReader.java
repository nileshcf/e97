...
public class McgcmsSort002InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort002InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsSort002Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsSort002Keys relKey = new McgcmsSort002Keys();
