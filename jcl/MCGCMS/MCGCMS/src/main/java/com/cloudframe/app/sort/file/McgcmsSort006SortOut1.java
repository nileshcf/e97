  ...
  @Component("McgcmsSort006SortOut1")
  @JobScope
  public class McgcmsSort006SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort006SortOut1.class);
  	@Value("${McgcmsSort006SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0062}")
      ...
      @Value("#{'${McgcmsSort006SortOut1RecordType:${McgcmsSort006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort006SortOut1RecordLen:${McgcmsSort006SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 98;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort006SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
