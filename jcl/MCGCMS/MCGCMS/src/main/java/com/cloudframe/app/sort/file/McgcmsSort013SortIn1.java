  ...
  @Component("McgcmsSort013SortIn1")
  @JobScope
  public class McgcmsSort013SortIn1 extends CFFile {
  	@Value("${McgcmsSort013SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0132}")
  	...
  	@Value("#{'${McgcmsSort013SortIn1RecordType:${McgcmsSort013SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort013SortIn1RecordLen:${McgcmsSort013SortInRecordLen:80}}'}")
