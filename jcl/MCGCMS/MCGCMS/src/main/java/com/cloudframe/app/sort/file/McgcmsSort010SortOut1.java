  ...
  @Component("McgcmsSort010SortOut1")
  @JobScope
  public class McgcmsSort010SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort010SortOut1.class);
  	@Value("${McgcmsSort010SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0102}")
      ...
      @Value("#{'${McgcmsSort010SortOut1RecordType:${McgcmsSort010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort010SortOut1RecordLen:${McgcmsSort010SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort010SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
