  ...
  @Component("McgcmsSort010SortOut0")
  @JobScope
  public class McgcmsSort010SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort010SortOut0.class);
  	@Value("${McgcmsSort010SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0101}")
      ...
      @Value("#{'${McgcmsSort010SortOut0RecordType:${McgcmsSort010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort010SortOut0RecordLen:${McgcmsSort010SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 56;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort010SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
