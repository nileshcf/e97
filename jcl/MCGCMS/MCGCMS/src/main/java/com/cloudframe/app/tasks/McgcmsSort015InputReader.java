...
public class McgcmsSort015InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort015InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	final int OUTREC_POS1=19;
	final int OUTREC_POS2=33;
	final int OUTREC_POS3=0;
	final int OUTREC_LEN1=2;
	final int OUTREC_LEN2=1;
	final int OUTREC_LEN3=18;
	final int OUTREC_DES_POS1=0;
	final int OUTREC_DES_POS2=2;
	final int OUTREC_DES_POS3=3;
...
copyRecordBytes(repBytes, recBytes, OUTREC_POS3,OUTREC_DES_POS3,OUTREC_LEN3);
