...
@Component("batch_mcgcmssort019")
@JobScope
public class McgcmsSort019Detail {

	private List<McgcmsSort019Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort019Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort019Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort019Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort019Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort019Keys> sortComp) {
