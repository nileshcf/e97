...
public class McgcmsSort012Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort012Sort.class);
	@Autowired
...
private void processJoinKeys2() throws Exception {	
	...
	reformatCount++;
		...
		logger.info("STEPNAME: SORT012 Joinkey Formatter execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), reformatCount);
		clearMemMapFiles();
