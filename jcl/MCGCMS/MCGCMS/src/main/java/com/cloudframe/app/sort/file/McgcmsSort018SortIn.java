  ...
  @Component("McgcmsSort018SortIn")
  @JobScope
  public class McgcmsSort018SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort018SortIn.class);
  	@Value("${McgcmsSort018SortIn:CLOUDFRM.MC.GCMS.SORT.IN018}")
  	...
  	@Value("#{'${McgcmsSort018SortInRecordType:${McgcmsSort018SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort018SortInRecordLen:${McgcmsSort018SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort018SortIn Read: {}",e.getMessage()); 
  		}
  	}
