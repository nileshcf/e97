  ...
  @Component("McgcmsSort015SortIn")
  @JobScope
  public class McgcmsSort015SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort015SortIn.class);
  	@Value("${McgcmsSort015SortIn:CLOUDFRM.MC.GCMS.SORT.IN015}")
  	...
  	@Value("#{'${McgcmsSort015SortInRecordType:${McgcmsSort015SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort015SortInRecordLen:${McgcmsSort015SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort015SortIn Read: {}",e.getMessage()); 
  		}
  	}
