  ...
  @Component("McgcmsSort013SortOut1")
  @JobScope
  public class McgcmsSort013SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort013SortOut1.class);
  	@Value("${McgcmsSort013SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0132}")
      ...
      @Value("#{'${McgcmsSort013SortOut1RecordType:${McgcmsSort013SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort013SortOut1RecordLen:${McgcmsSort013SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort013SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
