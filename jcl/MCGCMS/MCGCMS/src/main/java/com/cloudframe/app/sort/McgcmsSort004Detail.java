...
@Component("batch_mcgcmssort004")
@JobScope
public class McgcmsSort004Detail {

	private List<McgcmsSort004Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort004Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort004Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort004Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort004Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort004Keys> sortComp) {
