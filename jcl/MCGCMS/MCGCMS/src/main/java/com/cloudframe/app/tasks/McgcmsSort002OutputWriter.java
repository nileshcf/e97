...
public class McgcmsSort002OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(McgcmsSort002OutputWriter.class);
	@Autowired
	...
	List<McgcmsSort002Keys> sortRecKeys = null;
	...
	private byte[] getSortedRecord(int index) {
		try {
			McgcmsSort002Keys k = sortRecKeys.get(index);
