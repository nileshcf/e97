  ...
  @Component("McgcmsSort008SortIn0")
  @JobScope
  public class McgcmsSort008SortIn0 extends CFFile {
  	@Value("${McgcmsSort008SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0081}")
  	...
  	@Value("#{'${McgcmsSort008SortIn0RecordType:${McgcmsSort008SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort008SortIn0RecordLen:${McgcmsSort008SortInRecordLen:80}}'}")
