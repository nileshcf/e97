  ...
  @Component("McgcmsSort001SortIn")
  @JobScope
  public class McgcmsSort001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort001SortIn.class);
  	@Value("${McgcmsSort001SortIn:CLOUDFRM.MC.GCMS.SORT.IN001}")
  	...
  	@Value("#{'${McgcmsSort001SortInRecordType:${McgcmsSort001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort001SortInRecordLen:${McgcmsSort001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort001SortIn Read: {}",e.getMessage()); 
  		}
  	}
