  ...
  @Component("McgcmsSort002SortOut1")
  @JobScope
  public class McgcmsSort002SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort002SortOut1.class);
  	@Value("${McgcmsSort002SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0022}")
      ...
      @Value("#{'${McgcmsSort002SortOut1RecordType:${McgcmsSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort002SortOut1RecordLen:${McgcmsSort002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort002SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
