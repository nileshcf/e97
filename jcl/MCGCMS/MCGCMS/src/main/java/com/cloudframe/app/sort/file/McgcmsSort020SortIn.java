  ...
  @Component("McgcmsSort020SortIn")
  @JobScope
  public class McgcmsSort020SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort020SortIn.class);
  	@Value("${McgcmsSort020SortIn:CLOUDFRM.MC.GCMS.SORT.IN020}")
  	...
  	@Value("#{'${McgcmsSort020SortInRecordType:${McgcmsSort020SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort020SortInRecordLen:${McgcmsSort020SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort020SortIn Read: {}",e.getMessage()); 
  		}
  	}
