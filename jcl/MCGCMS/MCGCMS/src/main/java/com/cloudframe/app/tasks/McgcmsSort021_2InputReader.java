...
public class McgcmsSort021_2InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort021_2InputReader.class);
/**
