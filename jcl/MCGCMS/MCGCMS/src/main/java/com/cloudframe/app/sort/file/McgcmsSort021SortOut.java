  ...
  @Component("McgcmsSort021SortOut")
  @JobScope
  public class McgcmsSort021SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort021SortOut.class);
  	@Value("${McgcmsSort021SortOut:CLOUDFRM.MC.GCMS.SORT.OUT021}")
      ...
      @Value("#{'${McgcmsSort021SortOutRecordType:${McgcmsSort021SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort021SortOutRecordLen:${McgcmsSort021SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort021SortOut Write: {}",e.getMessage()); 		
  		}
  	}
