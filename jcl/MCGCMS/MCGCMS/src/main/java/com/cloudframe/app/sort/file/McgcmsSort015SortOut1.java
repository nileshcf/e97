  ...
  @Component("McgcmsSort015SortOut1")
  @JobScope
  public class McgcmsSort015SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort015SortOut1.class);
  	@Value("${McgcmsSort015SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0152}")
      ...
      @Value("#{'${McgcmsSort015SortOut1RecordType:${McgcmsSort015SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort015SortOut1RecordLen:${McgcmsSort015SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort015SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
