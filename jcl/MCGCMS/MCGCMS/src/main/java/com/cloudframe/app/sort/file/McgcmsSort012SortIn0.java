  ...
  @Component("McgcmsSort012SortIn0")
  @JobScope
  public class McgcmsSort012SortIn0 extends CFFile {
  	@Value("${McgcmsSort012SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0121}")
  	...
  	@Value("#{'${McgcmsSort012SortIn0RecordType:${McgcmsSort012SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort012SortIn0RecordLen:${McgcmsSort012SortInRecordLen:80}}'}")
