...
import com.cloudframe.app.sort.file.records.McgcmsSort023Keys;
import com.cloudframe.app.data.Field;

@Component("batch_mcgcmssort023")
@JobScope
public class McgcmsSort023Detail {

	private List<McgcmsSort023Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort023Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort023Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort023Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort023Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort023Keys> sortComp) {
