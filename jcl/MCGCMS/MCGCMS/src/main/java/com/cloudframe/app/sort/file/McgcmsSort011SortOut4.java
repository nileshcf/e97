  ...
  @Component("McgcmsSort011SortOut4")
  @JobScope
  public class McgcmsSort011SortOut4 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortOut4.class);
  	@Value("${McgcmsSort011SortOut[4]:CLOUDFRM.MC.GCMS.SORT.OUT0115}")
      ...
      @Value("#{'${McgcmsSort011SortOut4RecordType:${McgcmsSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort011SortOut4RecordLen:${McgcmsSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortOut4 Write: {}",e.getMessage()); 		
  		}
  	}
