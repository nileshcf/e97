...
@Component("batch_mcgcmssort017")
@JobScope
public class McgcmsSort017Detail {

	private List<McgcmsSort017Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort017Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort017Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort017Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort017Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort017Keys> sortComp) {
