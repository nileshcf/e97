  ...
  @Component("McgcmsSort012SortIn1")
  @JobScope
  public class McgcmsSort012SortIn1 extends CFFile {
  	@Value("${McgcmsSort012SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0122}")
  	...
  	@Value("#{'${McgcmsSort012SortIn1RecordType:${McgcmsSort012SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort012SortIn1RecordLen:${McgcmsSort012SortInRecordLen:80}}'}")
