  ...
  @Component("McgcmsSort013SortIn0")
  @JobScope
  public class McgcmsSort013SortIn0 extends CFFile {
  	@Value("${McgcmsSort013SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0131}")
  	...
  	@Value("#{'${McgcmsSort013SortIn0RecordType:${McgcmsSort013SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort013SortIn0RecordLen:${McgcmsSort013SortInRecordLen:80}}'}")
