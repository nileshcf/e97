...
@Component("batch_mcgcmssort006")
@JobScope
public class McgcmsSort006Detail {

	private List<McgcmsSort006Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort006Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort006Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort006Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort006Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort006Keys> sortComp) {
