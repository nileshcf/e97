  ...
  @Component("McgcmsSort011SortOut1")
  @JobScope
  public class McgcmsSort011SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort011SortOut1.class);
  	@Value("${McgcmsSort011SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0112}")
      ...
      @Value("#{'${McgcmsSort011SortOut1RecordType:${McgcmsSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort011SortOut1RecordLen:${McgcmsSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort011SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
