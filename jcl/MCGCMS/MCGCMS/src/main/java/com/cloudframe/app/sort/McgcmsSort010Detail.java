...
@Component("batch_mcgcmssort010")
@JobScope
public class McgcmsSort010Detail {

	private List<McgcmsSort010Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort010Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort010Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort010Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort010Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort010Keys> sortComp) {
