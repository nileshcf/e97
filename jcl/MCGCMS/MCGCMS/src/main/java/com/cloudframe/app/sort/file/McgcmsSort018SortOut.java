  ...
  @Component("McgcmsSort018SortOut")
  @JobScope
  public class McgcmsSort018SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort018SortOut.class);
  	@Value("${McgcmsSort018SortOut:CLOUDFRM.MC.GCMS.SORT.OUT018}")
      ...
      @Value("#{'${McgcmsSort018SortOutRecordType:${McgcmsSort018SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort018SortOutRecordLen:${McgcmsSort018SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort018SortOut Write: {}",e.getMessage()); 		
  		}
  	}
