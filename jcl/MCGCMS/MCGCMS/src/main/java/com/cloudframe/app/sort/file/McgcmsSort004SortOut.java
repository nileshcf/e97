  ...
  @Component("McgcmsSort004SortOut")
  @JobScope
  public class McgcmsSort004SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort004SortOut.class);
  	@Value("${McgcmsSort004SortOut:CLOUDFRM.MC.GCMS.SORT.OUT004}")
      ...
      @Value("#{'${McgcmsSort004SortOutRecordType:${McgcmsSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort004SortOutRecordLen:${McgcmsSort004SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 264;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort004SortOut Write: {}",e.getMessage()); 		
  		}
  	}
