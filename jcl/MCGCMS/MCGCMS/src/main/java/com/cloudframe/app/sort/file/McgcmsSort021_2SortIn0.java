  ...
  @Component("McgcmsSort021_2SortIn0")
  @JobScope
  public class McgcmsSort021_2SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort021_2SortIn0.class);
  	@Value("${McgcmsSort021_2SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0211}")
  	...
  	@Value("#{'${McgcmsSort021_2SortIn0RecordType:${McgcmsSort021_2SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort021_2SortIn0RecordLen:${McgcmsSort021_2SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort021_2SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
