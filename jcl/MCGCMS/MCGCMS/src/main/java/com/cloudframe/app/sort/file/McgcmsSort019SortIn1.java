  ...
  @Component("McgcmsSort019SortIn1")
  @JobScope
  public class McgcmsSort019SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort019SortIn1.class);
  	@Value("${McgcmsSort019SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0192}")
  	...
  	@Value("#{'${McgcmsSort019SortIn1RecordType:${McgcmsSort019SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort019SortIn1RecordLen:${McgcmsSort019SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort019SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
