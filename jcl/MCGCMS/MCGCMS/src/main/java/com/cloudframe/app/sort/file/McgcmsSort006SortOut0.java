  ...
  @Component("McgcmsSort006SortOut0")
  @JobScope
  public class McgcmsSort006SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort006SortOut0.class);
  	@Value("${McgcmsSort006SortOut[0]:CLOUDFRM.MC.GCMS.SORT.OUT0061}")
      ...
      @Value("#{'${McgcmsSort006SortOut0RecordType:${McgcmsSort006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort006SortOut0RecordLen:${McgcmsSort006SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort006SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
