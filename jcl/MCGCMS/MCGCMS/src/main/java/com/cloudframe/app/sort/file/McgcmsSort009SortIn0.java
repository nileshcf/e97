  ...
  @Component("McgcmsSort009SortIn0")
  @JobScope
  public class McgcmsSort009SortIn0 extends CFFile {
  	@Value("${McgcmsSort009SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0091}")
  	...
  	@Value("#{'${McgcmsSort009SortIn0RecordType:${McgcmsSort009SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort009SortIn0RecordLen:${McgcmsSort009SortInRecordLen:80}}'}")
