...
public class McgcmsSort022InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort022InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsSort022Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsSort022Keys relKey = new McgcmsSort022Keys();
