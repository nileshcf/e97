...
@Component("batch_mcgcmssort024")
@JobScope
public class McgcmsSort024Detail {

	private List<McgcmsSort024Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort024Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort024Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort024Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort024Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort024Keys> sortComp) {
