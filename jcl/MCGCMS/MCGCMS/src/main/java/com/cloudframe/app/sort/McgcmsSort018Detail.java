...
@Component("batch_mcgcmssort018")
@JobScope
public class McgcmsSort018Detail {

	private List<McgcmsSort018Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort018Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort018Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort018Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort018Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort018Keys> sortComp) {
