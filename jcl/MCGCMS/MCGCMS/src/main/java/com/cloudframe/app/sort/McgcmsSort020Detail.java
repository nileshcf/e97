...
@Component("batch_mcgcmssort020")
@JobScope
public class McgcmsSort020Detail {

	private List<McgcmsSort020Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort020Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort020Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort020Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort020Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort020Keys> sortComp) {
