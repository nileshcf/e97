  ...
  @Component("McgcmsSort023SortOut")
  @JobScope
  public class McgcmsSort023SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort023SortOut.class);
  	@Value("${McgcmsSort023SortOut:CLOUDFRM.MC.GCMS.SORT.OUT023}")
      ...
      @Value("#{'${McgcmsSort023SortOutRecordType:${McgcmsSort023SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort023SortOutRecordLen:${McgcmsSort023SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort023SortOut Write: {}",e.getMessage()); 		
  		}
  	}
