...
import com.cloudframe.app.sort.file.records.McgcmsStep010Keys;
import org.springframework.batch.core.ExitStatus;
import com.cloudframe.app.sort.file.McgcmsStep010SortIn;
...
import com.cloudframe.app.sort.McgcmsStep010Detail;
import com.cloudframe.app.sort.file.McgcmsStep010SortOut;
import com.cloudframe.app.sort.file.McgcmsStep010SortIn;
...
public class McgcmsStep010Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsStep010Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcgcmsstep010")
	McgcmsStep010Detail sortDetail;
	
	@Autowired
	@Qualifier("McgcmsStep010SortOut")
	McgcmsStep010SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McgcmsStep010SortIn")
	McgcmsStep010SortIn sortIn;
	...
	List<McgcmsStep010Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
    ...
    int recCounter = 0;
	static final int KEY_POS0 = 7;
	static final int KEY_POS1 = 24;
	static final int KEY_LEN0 = 11;
	static final int KEY_LEN1 = 16;
	@Override
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("step010");
...
logger.info("STEPNAME: MCGCMSSTEP010 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			McgcmsStep010Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsStep010Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsStep010Keys relKey = new McgcmsStep010Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McgcmsStep010Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(McgcmsStep010Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McgcmsStep010Keys> sortComp = sortDetail.getSortComp();
