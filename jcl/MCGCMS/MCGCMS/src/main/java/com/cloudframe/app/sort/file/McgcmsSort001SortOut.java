  ...
  @Component("McgcmsSort001SortOut")
  @JobScope
  public class McgcmsSort001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort001SortOut.class);
  	@Value("${McgcmsSort001SortOut:CLOUDFRM.MC.GCMS.SORT.OUT001}")
      ...
      @Value("#{'${McgcmsSort001SortOutRecordType:${McgcmsSort001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort001SortOutRecordLen:${McgcmsSort001SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
