  ...
  @Component("McgcmsSort021SortIn0")
  @JobScope
  public class McgcmsSort021SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort021SortIn0.class);
  	@Value("${McgcmsSort021SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0211}")
  	...
  	@Value("#{'${McgcmsSort021SortIn0RecordType:${McgcmsSort021SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort021SortIn0RecordLen:${McgcmsSort021SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort021SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
