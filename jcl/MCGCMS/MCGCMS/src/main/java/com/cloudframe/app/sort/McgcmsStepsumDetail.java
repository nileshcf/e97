...
@Component("batch_mcgcmsstepsum")
@JobScope
public class McgcmsStepsumDetail {

	private List<McgcmsStepsumKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsStepsumKeys> sortComp = null;
	 ...
	 */
	public List<McgcmsStepsumKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsStepsumKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsStepsumKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsStepsumKeys> sortComp) {
