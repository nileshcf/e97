  ...
  @Component("McgcmsSort021SortIn1")
  @JobScope
  public class McgcmsSort021SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort021SortIn1.class);
  	@Value("${McgcmsSort021SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0211}")
  	...
  	@Value("#{'${McgcmsSort021SortIn1RecordType:${McgcmsSort021SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort021SortIn1RecordLen:${McgcmsSort021SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort021SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
