  ...
  @Component("McgcmsSort019SortOut")
  @JobScope
  public class McgcmsSort019SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort019SortOut.class);
  	@Value("${McgcmsSort019SortOut:CLOUDFRM.MC.GCMS.SORT.OUT019}")
      ...
      @Value("#{'${McgcmsSort019SortOutRecordType:${McgcmsSort019SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort019SortOutRecordLen:${McgcmsSort019SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort019SortOut Write: {}",e.getMessage()); 		
  		}
  	}
