...
import com.cloudframe.app.sort.McgcmsSort021_2Detail;
import java.math.BigDecimal;
import com.cloudframe.app.sort.file.McgcmsSort021_2SortIn0;
import org.springframework.batch.core.ExitStatus;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import com.cloudframe.app.sort.file.McgcmsSort021_2SortIn1;
import com.cloudframe.app.exception.CFException;
import java.util.stream.Collectors;
import com.cloudframe.app.utility.ByteUtil;
import com.cloudframe.app.sort.file.McgcmsSort021_2SortOut;
import com.cloudframe.app.data.Field;
import com.cloudframe.app.sort.file.records.McgcmsSort021_2Keys;
...
public class McgcmsSort021_2Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort021_2Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_mcgcmssort021_2")
	McgcmsSort021_2Detail sortDetail;
	
	@Autowired
	@Qualifier("McgcmsSort021_2SortOut")
	McgcmsSort021_2SortOut sortOut;
	

	
	@Autowired
	@Qualifier("McgcmsSort021_2SortIn0")
	McgcmsSort021_2SortIn0 sortIn0;
	
	@Autowired
	@Qualifier("McgcmsSort021_2SortIn1")
	McgcmsSort021_2SortIn1 sortIn1;
	...
	List<McgcmsSort021_2Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		cfStepHandler.updateSortStepExecution("sort021_2");
...
logger.info("STEPNAME: MCGCMSSORT021_2 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	byte[] sumRec = null;
	McgcmsSort021_2Keys sortKey = null;
	int sortKey1Len = 17;
	int sumKey1Pos = 17;
	int sumKey1Len = 11;
	...
	private void addSumRecord(int index) throws Exception {
		try {
			McgcmsSort021_2Keys recKey = sortRecKeys.get(index);
			byte[] recBytes = null;
			if(isWriteInTempFile())
  ...
  private void setSumRecord(McgcmsSort021_2Keys key, byte[] recBytes) {
  ...
  private void writeSumOut(byte[] outRecBytes) throws CFException{
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<McgcmsSort021_2Keys> sortRecKeys = sortDetail.getSortRecKeys();
		McgcmsSort021_2Keys relKey = new McgcmsSort021_2Keys();
...
copyRecordBytes(record, recBytes, INREC_POS8, INREC_DES_POS8,INREC_LEN8);
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   McgcmsSort021_2Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<McgcmsSort021_2Keys> sortComp = sortDetail.getSortComp();
