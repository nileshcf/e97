  ...
  @Component("McgcmsSort022SortOut1")
  @JobScope
  public class McgcmsSort022SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort022SortOut1.class);
  	@Value("${McgcmsSort022SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0222}")
      ...
      @Value("#{'${McgcmsSort022SortOut1RecordType:${McgcmsSort022SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort022SortOut1RecordLen:${McgcmsSort022SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort022SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
