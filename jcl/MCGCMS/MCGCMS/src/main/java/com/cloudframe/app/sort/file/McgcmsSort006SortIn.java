  ...
  @Component("McgcmsSort006SortIn")
  @JobScope
  public class McgcmsSort006SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort006SortIn.class);
  	@Value("${McgcmsSort006SortIn:CLOUDFRM.MC.GCMS.SORT.IN006}")
  	...
  	@Value("#{'${McgcmsSort006SortInRecordType:${McgcmsSort006SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort006SortInRecordLen:${McgcmsSort006SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort006SortIn Read: {}",e.getMessage()); 
  		}
  	}
