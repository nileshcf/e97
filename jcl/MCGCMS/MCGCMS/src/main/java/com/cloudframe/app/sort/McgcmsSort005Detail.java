...
@Component("batch_mcgcmssort005")
@JobScope
public class McgcmsSort005Detail {

	private List<McgcmsSort005Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<McgcmsSort005Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsSort005Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsSort005Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsSort005Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsSort005Keys> sortComp) {
