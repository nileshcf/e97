  ...
  @Component("McgcmsSort016SortOut1")
  @JobScope
  public class McgcmsSort016SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort016SortOut1.class);
  	@Value("${McgcmsSort016SortOut[1]:CLOUDFRM.MC.GCMS.SORT.OUT0162}")
      ...
      @Value("#{'${McgcmsSort016SortOut1RecordType:${McgcmsSort016SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort016SortOut1RecordLen:${McgcmsSort016SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort016SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
