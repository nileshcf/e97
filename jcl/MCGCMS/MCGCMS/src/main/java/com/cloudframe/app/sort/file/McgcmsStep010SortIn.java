  ...
  @Component("McgcmsStep010SortIn")
  @JobScope
  public class McgcmsStep010SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsStep010SortIn.class);
  	@Value("${McgcmsStep010SortIn:CLOUDFRM.MC.GCMS.SORT.IN025}")
  	...
  	@Value("#{'${McgcmsStep010SortInRecordType:${McgcmsStep010SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsStep010SortInRecordLen:${McgcmsStep010SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsStep010SortIn Read: {}",e.getMessage()); 
  		}
  	}
