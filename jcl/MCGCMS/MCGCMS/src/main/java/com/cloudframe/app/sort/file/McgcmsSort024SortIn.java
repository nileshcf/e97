  ...
  @Component("McgcmsSort024SortIn")
  @JobScope
  public class McgcmsSort024SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort024SortIn.class);
  	@Value("${McgcmsSort024SortIn:CLOUDFRM.MC.GCMS.SORT.IN024}")
  	...
  	@Value("#{'${McgcmsSort024SortInRecordType:${McgcmsSort024SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort024SortInRecordLen:${McgcmsSort024SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort024SortIn Read: {}",e.getMessage()); 
  		}
  	}
