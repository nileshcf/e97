  ...
  @Component("McgcmsSort009SortIn1")
  @JobScope
  public class McgcmsSort009SortIn1 extends CFFile {
  	@Value("${McgcmsSort009SortIn[1]:CLOUDFRM.MC.GCMS.SORT.IN0092}")
  	...
  	@Value("#{'${McgcmsSort009SortIn1RecordType:${McgcmsSort009SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort009SortIn1RecordLen:${McgcmsSort009SortInRecordLen:80}}'}")
