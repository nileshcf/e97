  ...
  @Component("McgcmsSort002SortOut2")
  @JobScope
  public class McgcmsSort002SortOut2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort002SortOut2.class);
  	@Value("${McgcmsSort002SortOut[2]:CLOUDFRM.MC.GCMS.SORT.OUT0023}")
      ...
      @Value("#{'${McgcmsSort002SortOut2RecordType:${McgcmsSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${McgcmsSort002SortOut2RecordLen:${McgcmsSort002SortOutRecordLen:80}}'}")
  	private int recordLen;
  	
  	private int outRecLen = 164;
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during McgcmsSort002SortOut2 Write: {}",e.getMessage()); 		
  		}
  	}
