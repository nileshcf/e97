...
@Component("batch_mcgcmsstep020")
@JobScope
public class McgcmsStep020Detail {

	private List<McgcmsStep020Keys> sortRecKeys = null;
	private List<McgcmsStep020JoinKeys> joinRecKey1 = null;
	private List<McgcmsStep020JoinKeys> joinRecKey2 = null;
	private Comparator<McgcmsStep020JoinKeys> joinkeyComp = null;
	...
	private Comparator<McgcmsStep020Keys> sortComp = null;
	 ...
	 */
	public List<McgcmsStep020JoinKeys> getJoinRecKey1() {
		return joinRecKey1;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey1(List<McgcmsStep020JoinKeys> joinRecKey1) {
	 ...
	 * @return the JoinRecKeys
	 */
	public List<McgcmsStep020JoinKeys> getJoinRecKey2() {
		return joinRecKey2;
	}
	/**
	 * @param JoinRecKeys to set
	 */
	public void setJoinRecKey2(List<McgcmsStep020JoinKeys> joinRecKey2) {
		this.joinRecKey2 = joinRecKey2;
	}
	
		/** @return the joinKeysComp */
	public Comparator<McgcmsStep020JoinKeys> getJoinkeySortComp() {
		return joinkeyComp;
	}

	/** @param joinKeysComp to set */
	public void setJoinkeySortComp(Comparator<McgcmsStep020JoinKeys> jnkeyComp) {
	 ...
	 */
	public List<McgcmsStep020Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<McgcmsStep020Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<McgcmsStep020Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<McgcmsStep020Keys> sortComp) {
