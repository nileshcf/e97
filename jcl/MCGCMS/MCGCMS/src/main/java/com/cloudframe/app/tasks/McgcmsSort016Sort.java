...
public class McgcmsSort016Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(McgcmsSort016Sort.class);
	@Autowired
...
private void processJoinKeys2() throws Exception {	
	...
	public void processReformat() throws Exception {
		...
		logger.info("STEPNAME: SORT016 Joinkey Formatter execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), reformatCount);
		clearMemMapFiles();
