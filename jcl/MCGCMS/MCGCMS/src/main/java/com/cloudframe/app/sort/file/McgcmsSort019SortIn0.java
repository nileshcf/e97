  ...
  @Component("McgcmsSort019SortIn0")
  @JobScope
  public class McgcmsSort019SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(McgcmsSort019SortIn0.class);
  	@Value("${McgcmsSort019SortIn[0]:CLOUDFRM.MC.GCMS.SORT.IN0191}")
  	...
  	@Value("#{'${McgcmsSort019SortIn0RecordType:${McgcmsSort019SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${McgcmsSort019SortIn0RecordLen:${McgcmsSort019SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during McgcmsSort019SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
