...
public class McgcmsSort013OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(McgcmsSort013OutputWriter.class);
	@Autowired
