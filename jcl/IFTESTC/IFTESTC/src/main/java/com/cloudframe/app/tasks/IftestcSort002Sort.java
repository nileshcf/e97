...
public class IftestcSort002Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IftestcSort002Sort.class);
	@Autowired
...
logger.info("STEPNAME: IFTESTCSORT002 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<IftestcSort002Keys> sortRecKeys = sortDetail.getSortRecKeys();
		IftestcSort002Keys relKey = new IftestcSort002Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IftestcSort002Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(IftestcSort002Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IftestcSort002Keys> sortComp = sortDetail.getSortComp();
