...
@Component("batch_iftestcsort002")
@JobScope
public class IftestcSort002Detail {

	private List<IftestcSort002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IftestcSort002Keys> sortComp = null;
	 ...
	 */
	public List<IftestcSort002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IftestcSort002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IftestcSort002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IftestcSort002Keys> sortComp) {
