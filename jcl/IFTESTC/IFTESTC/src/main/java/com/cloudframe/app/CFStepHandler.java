...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP1_STEP10 = "step1_step10";
    private static final String SORT001 = "sort001";
    private static final String ABEND001 = "abend001";
    private static final String STEP2_STEP10 = "step2_step10";
    private static final String STEP3_STEP10 = "step3_step10";
    ...
    private static final String ABEND002 = "abend002";
...
*/
    public boolean stepDecider(String stepName) {
	      ...
	      switch (stepName) {
	          ...
	          break;
	          case ABEND001:
	              canExecute = abendList.isEmpty() && deciderForAbend001();
	          break;
	          case STEP4:
	          ...
	          break;
	          case SORT002:
	              canExecute = abendList.isEmpty() && deciderForSort002();
	          break;
	          case STEP6:
	              canExecute = abendList.isEmpty() && deciderForStep6();
	          break;
	          case STEP7:
	              canExecute = abendList.isEmpty() && deciderForStep7();
	          break;
	          case ABEND002:
	              canExecute = abendList.isEmpty() && deciderForAbend002();
	          break;
	          default:
	              canExecute = false;
	          break;
...
return canExecute;
    ...
    private boolean deciderForAbend001() {
        return (getRcForStep(SORT001) != null && getRcForStep(SORT001) != 0 ) /* 1 */  /*IF COND*/ ;
    }
    
    private boolean deciderForStep4() {
        return (getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) == 2  || getRcForStep(STEP3_STEP10) != null && getRcForStep(STEP3_STEP10) == 3 ) /* 1 */  /*IF COND*/ && ( CFUtil.validateStepRc(stepMap, STEP1_STEP10, 4, Cond.NE) ) /*COND CODE*/ ;
    }
    
    private boolean deciderForStep5() {
        return ((getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) == 2  || getRcForStep(STEP3_STEP10) != null && getRcForStep(STEP3_STEP10) == 3 ) ) /* 1 */  && ((getRcForStep(STEP1_STEP10) != null && getRcForStep(STEP1_STEP10) == 1 ) ) /* 2 */  /*IF COND*/ ;
    }
    
    private boolean deciderForSort002() {
        return ((getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) == 2  || getRcForStep(STEP3_STEP10) != null && getRcForStep(STEP3_STEP10) == 3 ) ) /* 1 */  && ((getRcForStep(STEP1_STEP10) != null && getRcForStep(STEP1_STEP10) == 1 ) ) /* 2 */  /*IF COND*/ ;
    }
    
    private boolean deciderForStep6() {
        return ! ((!((getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) == 2  || getRcForStep(STEP3_STEP10) != null && getRcForStep(STEP3_STEP10) == 3 ) ) ) ) /* 1 */  && ((getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) != 2 ) ) /* 2 */  /*IF COND*/ ;
    }
    
    private boolean deciderForStep7() {
        return ! ((!((getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) == 2  || getRcForStep(STEP3_STEP10) != null && getRcForStep(STEP3_STEP10) == 3 ) ) ) ) /* 1 */  && !((!((getRcForStep(STEP2_STEP10) != null && getRcForStep(STEP2_STEP10) != 2 ) ) ) ) /* 2 */  /*IF COND*/ ;
    }
    
    private boolean deciderForAbend002() {
        return (jobRc > 0 ) /* 1 */  /*IF COND*/ ;
    }
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort001":  /* setting the disp position for file(s) info for this step(SORT001). */
                         SpringContextHandler.setFileDispPosition("IftestcSort001SortIn","IftestcSort001SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("IftestcSort001SortOut","IftestcSort001SortOut.DISP");
            break;
            case "sort002":  /* setting the disp position for file(s) info for this step(SORT002). */
                         SpringContextHandler.setFileDispPosition("IftestcSort002SortIn","IftestcSort002SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("IftestcSort002SortOut","IftestcSort002SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : IFTESTC ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : IFTESTC ENDED -  ABEND={}", abendCode);
      } 
