  ...
  @Component("IftestcSort002SortOut")
  @JobScope
  public class IftestcSort002SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IftestcSort002SortOut.class);
  	@Value("${IftestcSort002SortOut:CLOUDFRM.MC.SORT.OUT002}")
      ...
      @Value("#{'${IftestcSort002SortOutRecordType:${IftestcSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IftestcSort002SortOutRecordLen:${IftestcSort002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IftestcSort002SortOut Write: {}",e.getMessage()); 		
  		}
  	}
