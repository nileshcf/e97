...
public class IftestcSort002Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(IftestcSort002Processor.class);
