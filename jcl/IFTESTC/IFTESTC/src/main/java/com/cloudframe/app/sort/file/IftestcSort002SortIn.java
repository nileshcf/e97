  ...
  @Component("IftestcSort002SortIn")
  @JobScope
  public class IftestcSort002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IftestcSort002SortIn.class);
  	@Value("${IftestcSort002SortIn:CLOUDFRM.MC.SORT.IN002}")
  	...
  	@Value("#{'${IftestcSort002SortInRecordType:${IftestcSort002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IftestcSort002SortInRecordLen:${IftestcSort002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IftestcSort002SortIn Read: {}",e.getMessage()); 
  		}
  	}
