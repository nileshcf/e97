...
public class IftestcSort002InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IftestcSort002InputReader.class);
/**
