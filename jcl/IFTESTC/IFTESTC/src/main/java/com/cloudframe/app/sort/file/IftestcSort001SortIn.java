  ...
  @Component("IftestcSort001SortIn")
  @JobScope
  public class IftestcSort001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IftestcSort001SortIn.class);
  	@Value("${IftestcSort001SortIn:CLOUDFRM.MC.SORT.IN001}")
  	...
  	@Value("#{'${IftestcSort001SortInRecordType:${IftestcSort001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IftestcSort001SortInRecordLen:${IftestcSort001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IftestcSort001SortIn Read: {}",e.getMessage()); 
  		}
  	}
