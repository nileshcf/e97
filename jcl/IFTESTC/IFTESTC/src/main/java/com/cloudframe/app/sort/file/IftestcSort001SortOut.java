  ...
  @Component("IftestcSort001SortOut")
  @JobScope
  public class IftestcSort001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IftestcSort001SortOut.class);
  	@Value("${IftestcSort001SortOut:CLOUDFRM.MC.SORT.OUT001}")
      ...
      @Value("#{'${IftestcSort001SortOutRecordType:${IftestcSort001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IftestcSort001SortOutRecordLen:${IftestcSort001SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IftestcSort001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
