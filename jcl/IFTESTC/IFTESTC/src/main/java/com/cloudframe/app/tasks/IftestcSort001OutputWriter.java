...
public class IftestcSort001OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(IftestcSort001OutputWriter.class);
	@Autowired
