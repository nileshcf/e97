...
@Component("batch_iftestcsort001")
@JobScope
public class IftestcSort001Detail {

	private List<IftestcSort001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IftestcSort001Keys> sortComp = null;
	 ...
	 */
	public List<IftestcSort001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IftestcSort001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IftestcSort001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IftestcSort001Keys> sortComp) {
