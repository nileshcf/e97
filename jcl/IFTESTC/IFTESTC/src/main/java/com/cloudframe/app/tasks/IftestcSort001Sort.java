...
public class IftestcSort001Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IftestcSort001Sort.class);
	@Autowired
	...
	List<IftestcSort001Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: IFTESTCSORT001 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IftestcSort001Keys k = sortRecKeys.get(index);
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IftestcSort001Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(IftestcSort001Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IftestcSort001Keys> sortComp = sortDetail.getSortComp();
