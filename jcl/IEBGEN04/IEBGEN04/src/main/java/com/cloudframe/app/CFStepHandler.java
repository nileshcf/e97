...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP003 = "step003";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step003":
 		    	   		SpringContextHandler.handleDispPostion("STEP003.IEBGENER.Sysut1[1]","STEP003.IEBGENER.Sysut1[1].DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP003.IEBGENER.Sysut1[2]","STEP003.IEBGENER.Sysut1[2].DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP003.IEBGENER.Sysut1[3]","STEP003.IEBGENER.Sysut1[3].DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP003.IEBGENER.Sysut1[4]","STEP003.IEBGENER.Sysut1[4].DISP");
 		    	   		SpringContextHandler.handleDispPostion("STEP003.IEBGENER.Sysut2","STEP003.IEBGENER.Sysut2.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : IEBGEN04 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : IEBGEN04 ENDED -  ABEND={}", abendCode);
      } 
