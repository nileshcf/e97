...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public UsbrecdatDate1inSort usbrecdatDate1inSort() {
    	return new UsbrecdatDate1inSort();
    }
    
    @Bean
    @JobScope
    protected Step UsbrecdatDate1inSort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("UsbrecdatDate1inSort",jobRepository).tasklet(usbrecdatDate1inSort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow date1inExecutor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("date1inExecutor")
             ...
             .to(UsbrecdatDate1inSort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public UsbrecdatDate1outSort usbrecdatDate1outSort() {
    	return new UsbrecdatDate1outSort();
    }
    
    @Bean
    @JobScope
    protected Step UsbrecdatDate1outSort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("UsbrecdatDate1outSort",jobRepository).tasklet(usbrecdatDate1outSort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow date1outExecutor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("date1outExecutor")
             ...
             .to(UsbrecdatDate1outSort(jobRepository, transactionManager))
