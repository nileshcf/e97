...
public class UsbrecdatDate1outInputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(UsbrecdatDate1outInputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<UsbrecdatDate1outKeys> sortRecKeys = sortDetail.getSortRecKeys();
		UsbrecdatDate1outKeys relKey = new UsbrecdatDate1outKeys();
