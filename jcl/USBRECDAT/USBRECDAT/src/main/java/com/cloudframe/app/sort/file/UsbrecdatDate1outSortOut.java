  ...
  @Component("UsbrecdatDate1outSortOut")
  @JobScope
  public class UsbrecdatDate1outSortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbrecdatDate1outSortOut.class);
  	@Value("${UsbrecdatDate1outSortOut:CLOUDFRM.DATE.OUT2}")
      ...
      @Value("#{'${UsbrecdatDate1outSortOutRecordType:${UsbrecdatDate1outSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbrecdatDate1outSortOutRecordLen:${UsbrecdatDate1outSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbrecdatDate1outSortOut Write: {}",e.getMessage()); 		
  		}
  	}
