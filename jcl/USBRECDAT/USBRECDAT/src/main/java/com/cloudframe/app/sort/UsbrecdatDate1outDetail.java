...
import com.cloudframe.app.sort.file.records.UsbrecdatDate1outKeys;
import com.cloudframe.app.data.Field;

@Component("batch_usbrecdatdate1out")
@JobScope
public class UsbrecdatDate1outDetail {

	private List<UsbrecdatDate1outKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbrecdatDate1outKeys> sortComp = null;
	 ...
	 */
	public List<UsbrecdatDate1outKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbrecdatDate1outKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbrecdatDate1outKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbrecdatDate1outKeys> sortComp) {
