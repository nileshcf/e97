...
@Component("batch_usbrecdatdate1in")
@JobScope
public class UsbrecdatDate1inDetail {

	private List<UsbrecdatDate1inKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<UsbrecdatDate1inKeys> sortComp = null;
	 ...
	 */
	public List<UsbrecdatDate1inKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<UsbrecdatDate1inKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<UsbrecdatDate1inKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<UsbrecdatDate1inKeys> sortComp) {
