  ...
  @Component("UsbrecdatDate1outSortIn")
  @JobScope
  public class UsbrecdatDate1outSortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbrecdatDate1outSortIn.class);
  	@Value("${UsbrecdatDate1outSortIn:CLOUDFRM.DATE.INPUT}")
  	...
  	@Value("#{'${UsbrecdatDate1outSortInRecordType:${UsbrecdatDate1outSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${UsbrecdatDate1outSortInRecordLen:${UsbrecdatDate1outSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during UsbrecdatDate1outSortIn Read: {}",e.getMessage()); 
  		}
  	}
