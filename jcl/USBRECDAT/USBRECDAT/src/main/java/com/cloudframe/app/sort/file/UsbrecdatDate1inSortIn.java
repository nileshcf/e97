  ...
  @Component("UsbrecdatDate1inSortIn")
  @JobScope
  public class UsbrecdatDate1inSortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbrecdatDate1inSortIn.class);
  	@Value("${UsbrecdatDate1inSortIn:CLOUDFRM.DATE.INPUT}")
  	...
  	@Value("#{'${UsbrecdatDate1inSortInRecordType:${UsbrecdatDate1inSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${UsbrecdatDate1inSortInRecordLen:${UsbrecdatDate1inSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during UsbrecdatDate1inSortIn Read: {}",e.getMessage()); 
  		}
  	}
