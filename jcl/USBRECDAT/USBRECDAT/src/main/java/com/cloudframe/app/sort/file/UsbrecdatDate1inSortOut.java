  ...
  @Component("UsbrecdatDate1inSortOut")
  @JobScope
  public class UsbrecdatDate1inSortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(UsbrecdatDate1inSortOut.class);
  	@Value("${UsbrecdatDate1inSortOut:CLOUDFRM.DATE.OUT5}")
      ...
      @Value("#{'${UsbrecdatDate1inSortOutRecordType:${UsbrecdatDate1inSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${UsbrecdatDate1inSortOutRecordLen:${UsbrecdatDate1inSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during UsbrecdatDate1inSortOut Write: {}",e.getMessage()); 		
  		}
  	}
