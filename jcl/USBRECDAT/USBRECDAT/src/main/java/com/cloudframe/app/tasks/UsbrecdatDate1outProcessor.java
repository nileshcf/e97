...
public class UsbrecdatDate1outProcessor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(UsbrecdatDate1outProcessor.class);
