...
public class Sort038Step020OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Sort038Step020OutputWriter.class);
	@Autowired
