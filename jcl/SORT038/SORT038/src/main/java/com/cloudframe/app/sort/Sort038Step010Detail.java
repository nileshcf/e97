...
@Component("batch_sort038step010")
@JobScope
public class Sort038Step010Detail {

	private List<Sort038Step010Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Sort038Step010Keys> sortComp = null;
	 ...
	 */
	public List<Sort038Step010Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Sort038Step010Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Sort038Step010Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Sort038Step010Keys> sortComp) {
