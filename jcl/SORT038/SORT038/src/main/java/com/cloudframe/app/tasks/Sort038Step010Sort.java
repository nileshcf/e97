...
import com.cloudframe.app.sort.file.Sort038Step010SortOut;
...
public class Sort038Step010Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Sort038Step010Sort.class);
	@Autowired
	...
	@Autowired
	@Qualifier("Sort038Step010SortOut")
	Sort038Step010SortOut sortOut;
	...
	List<Sort038Step010Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SORT038STEP010 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			Sort038Step010Keys k = sortRecKeys.get(index);
