  ...
  @Component("Sort038Step020SortOut")
  @JobScope
  public class Sort038Step020SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort038Step020SortOut.class);
  	@Value("${Sort038Step020SortOut:CLOUDFRM.MC.GCMS.SORT.OUT0382}")
      ...
      @Value("#{'${Sort038Step020SortOutRecordType:${Sort038Step020SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sort038Step020SortOutRecordLen:${Sort038Step020SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sort038Step020SortOut Write: {}",e.getMessage()); 		
  		}
  	}
