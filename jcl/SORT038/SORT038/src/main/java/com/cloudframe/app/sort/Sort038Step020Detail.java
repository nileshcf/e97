...
@Component("batch_sort038step020")
@JobScope
public class Sort038Step020Detail {

	private List<Sort038Step020Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Sort038Step020Keys> sortComp = null;
	 ...
	 */
	public List<Sort038Step020Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Sort038Step020Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Sort038Step020Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Sort038Step020Keys> sortComp) {
