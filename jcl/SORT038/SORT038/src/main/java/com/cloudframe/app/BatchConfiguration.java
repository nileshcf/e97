...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public Sort038Step010Sort sort038Step010Sort() {
    	return new Sort038Step010Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort038Step010Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort038Step010Sort",jobRepository).tasklet(sort038Step010Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step010Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step010Executor")
             ...
             .to(Sort038Step010Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Sort038Step020Sort sort038Step020Sort() {
    	return new Sort038Step020Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort038Step020Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort038Step020Sort",jobRepository).tasklet(sort038Step020Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step020Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step020Executor")
             ...
             .to(Sort038Step020Sort(jobRepository, transactionManager))
