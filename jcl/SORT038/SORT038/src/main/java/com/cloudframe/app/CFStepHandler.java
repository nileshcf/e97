  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step010":  /* setting the disp position for file(s) info for this step(STEP010). */
                         SpringContextHandler.setFileDispPosition("Sort038Step010SortIn","Sort038Step010SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Sort038Step010SortOut","Sort038Step010SortOut.DISP");
            break;
            case "step020":  /* setting the disp position for file(s) info for this step(STEP020). */
                         SpringContextHandler.setFileDispPosition("Sort038Step020SortIn","Sort038Step020SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Sort038Step020SortOut","Sort038Step020SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORT038 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORT038 ENDED -  ABEND={}", abendCode);
      } 
