  ...
  @Component("Sort038Step010SortIn")
  @JobScope
  public class Sort038Step010SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort038Step010SortIn.class);
  	@Value("${Sort038Step010SortIn:CLOUDFRM.MC.GCMS.SORT.IN0381}")
  	...
  	@Value("#{'${Sort038Step010SortInRecordType:${Sort038Step010SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sort038Step010SortInRecordLen:${Sort038Step010SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sort038Step010SortIn Read: {}",e.getMessage()); 
  		}
  	}
