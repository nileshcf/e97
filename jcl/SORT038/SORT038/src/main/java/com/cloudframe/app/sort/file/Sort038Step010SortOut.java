  ...
  @Component("Sort038Step010SortOut")
  @JobScope
  public class Sort038Step010SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort038Step010SortOut.class);
  	@Value("${Sort038Step010SortOut:CLOUDFRM.MC.GCMS.SORT.OUT0381}")
      ...
      @Value("#{'${Sort038Step010SortOutRecordType:${Sort038Step010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sort038Step010SortOutRecordLen:${Sort038Step010SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sort038Step010SortOut Write: {}",e.getMessage()); 		
  		}
  	}
