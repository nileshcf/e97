  ...
  @Component("SyncsortSort9SortOut")
  @JobScope
  public class SyncsortSort9SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort9SortOut.class);
  	@Value("${SyncsortSort9SortOut:CLOUDFRM.JPM.SORT.OUTPUT9}")
      ...
      @Value("#{'${SyncsortSort9SortOutRecordType:${SyncsortSort9SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort9SortOutRecordLen:${SyncsortSort9SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort9SortOut Write: {}",e.getMessage()); 		
  		}
  	}
