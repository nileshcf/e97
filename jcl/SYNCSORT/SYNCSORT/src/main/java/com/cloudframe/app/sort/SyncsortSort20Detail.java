...
@Component("batch_syncsortsort20")
@JobScope
public class SyncsortSort20Detail {

	private List<SyncsortSort20Keys> sortRecKeys = null;
	private Set<SyncsortSort20Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort20Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort20Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort20Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort20Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort20Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort20Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort20Keys> sortComp) {
