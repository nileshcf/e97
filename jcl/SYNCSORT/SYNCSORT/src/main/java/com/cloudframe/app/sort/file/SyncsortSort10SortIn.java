  ...
  @Component("SyncsortSort10SortIn")
  @JobScope
  public class SyncsortSort10SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort10SortIn.class);
  	@Value("${SyncsortSort10SortIn:CLOUDFRM.JPM.SORT.INPUT10}")
  	...
  	@Value("#{'${SyncsortSort10SortInRecordType:${SyncsortSort10SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort10SortInRecordLen:${SyncsortSort10SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort10SortIn Read: {}",e.getMessage()); 
  		}
  	}
