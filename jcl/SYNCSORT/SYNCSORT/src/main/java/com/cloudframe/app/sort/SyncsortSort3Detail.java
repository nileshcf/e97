...
@Component("batch_syncsortsort3")
@JobScope
public class SyncsortSort3Detail {

	private List<SyncsortSort3Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort3Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort3Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort3Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort3Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort3Keys> sortComp) {
