...
@Component("batch_syncsortsort11")
@JobScope
public class SyncsortSort11Detail {

	private List<SyncsortSort11Keys> sortRecKeys = null;
	private Set<SyncsortSort11Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort11Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort11Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort11Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort11Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort11Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort11Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort11Keys> sortComp) {
