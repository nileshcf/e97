  ...
  @Component("SyncsortSort3SortIn")
  @JobScope
  public class SyncsortSort3SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort3SortIn.class);
  	@Value("${SyncsortSort3SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort3SortInRecordType:${SyncsortSort3SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort3SortInRecordLen:${SyncsortSort3SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort3SortIn Read: {}",e.getMessage()); 
  		}
  	}
