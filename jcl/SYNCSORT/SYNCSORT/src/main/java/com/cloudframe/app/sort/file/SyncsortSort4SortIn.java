  ...
  @Component("SyncsortSort4SortIn")
  @JobScope
  public class SyncsortSort4SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort4SortIn.class);
  	@Value("${SyncsortSort4SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort4SortInRecordType:${SyncsortSort4SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort4SortInRecordLen:${SyncsortSort4SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort4SortIn Read: {}",e.getMessage()); 
  		}
  	}
