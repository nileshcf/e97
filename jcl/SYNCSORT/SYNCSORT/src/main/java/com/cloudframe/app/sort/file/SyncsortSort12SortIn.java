  ...
  @Component("SyncsortSort12SortIn")
  @JobScope
  public class SyncsortSort12SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort12SortIn.class);
  	@Value("${SyncsortSort12SortIn:CLOUDFRM.JPM.SORT.INPUT12}")
  	...
  	@Value("#{'${SyncsortSort12SortInRecordType:${SyncsortSort12SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort12SortInRecordLen:${SyncsortSort12SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort12SortIn Read: {}",e.getMessage()); 
  		}
  	}
