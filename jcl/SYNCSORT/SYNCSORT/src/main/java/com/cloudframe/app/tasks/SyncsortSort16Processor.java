...
public class SyncsortSort16Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SyncsortSort16Processor.class);
