  ...
  @Component("SyncsortSort2SortIn")
  @JobScope
  public class SyncsortSort2SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort2SortIn.class);
  	@Value("${SyncsortSort2SortIn:CLOUDFRM.JPM.SORT.INPUT2}")
  	...
  	@Value("#{'${SyncsortSort2SortInRecordType:${SyncsortSort2SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort2SortInRecordLen:${SyncsortSort2SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort2SortIn Read: {}",e.getMessage()); 
  		}
  	}
