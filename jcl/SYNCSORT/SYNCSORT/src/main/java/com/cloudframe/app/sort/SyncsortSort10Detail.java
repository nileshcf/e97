...
@Component("batch_syncsortsort10")
@JobScope
public class SyncsortSort10Detail {

	private List<SyncsortSort10Keys> sortRecKeys = null;
	private Set<SyncsortSort10Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort10Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort10Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort10Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort10Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort10Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort10Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort10Keys> sortComp) {
