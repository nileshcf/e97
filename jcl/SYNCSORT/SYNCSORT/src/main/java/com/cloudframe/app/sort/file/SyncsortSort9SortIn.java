  ...
  @Component("SyncsortSort9SortIn")
  @JobScope
  public class SyncsortSort9SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort9SortIn.class);
  	@Value("${SyncsortSort9SortIn:CLOUDFRM.JPM.SORT.INPUT9}")
  	...
  	@Value("#{'${SyncsortSort9SortInRecordType:${SyncsortSort9SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort9SortInRecordLen:${SyncsortSort9SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort9SortIn Read: {}",e.getMessage()); 
  		}
  	}
