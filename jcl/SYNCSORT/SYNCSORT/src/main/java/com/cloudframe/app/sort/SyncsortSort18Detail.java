...
@Component("batch_syncsortsort18")
@JobScope
public class SyncsortSort18Detail {

	private List<SyncsortSort18Keys> sortRecKeys = null;
	private Set<SyncsortSort18Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort18Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort18Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort18Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort18Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort18Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort18Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort18Keys> sortComp) {
