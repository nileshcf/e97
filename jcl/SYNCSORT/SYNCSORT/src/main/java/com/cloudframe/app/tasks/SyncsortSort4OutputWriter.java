...
public class SyncsortSort4OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SyncsortSort4OutputWriter.class);
	@Autowired
