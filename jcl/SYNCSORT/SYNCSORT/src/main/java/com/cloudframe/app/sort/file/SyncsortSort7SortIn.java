  ...
  @Component("SyncsortSort7SortIn")
  @JobScope
  public class SyncsortSort7SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort7SortIn.class);
  	@Value("${SyncsortSort7SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort7SortInRecordType:${SyncsortSort7SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort7SortInRecordLen:${SyncsortSort7SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort7SortIn Read: {}",e.getMessage()); 
  		}
  	}
