...
import com.cloudframe.app.sort.file.records.SyncsortSort19Keys;
import java.io.File;
import java.util.HashSet;
import com.cloudframe.app.sort.file.SyncsortSort19SortOut;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.SyncsortSort19Detail;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import com.cloudframe.app.sort.file.SyncsortSort19SortIn;
...
public class SyncsortSort19Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort19Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort19")
	SyncsortSort19Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort19SortOut")
	SyncsortSort19SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort19SortIn")
	SyncsortSort19SortIn sortIn;
	...
	List<SyncsortSort19Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT19 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort19Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort19Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort19Keys relKey = new SyncsortSort19Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort19Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SyncsortSort19Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort19Keys> sortComp = sortDetail.getSortComp();
