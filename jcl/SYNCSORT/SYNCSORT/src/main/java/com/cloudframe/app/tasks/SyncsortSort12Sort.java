...
import com.cloudframe.app.sort.file.SyncsortSort12SortOut;
import org.springframework.beans.factory.annotation.Autowired;
import java.io.FileNotFoundException;
import java.util.Arrays; 
import com.cloudframe.app.sort.file.records.SyncsortSort12Keys;
import com.cloudframe.app.sort.SyncsortSort12Detail;
import org.springframework.batch.core.StepExecutionListener;
import org.springframework.batch.core.StepExecution;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.sort.file.SyncsortSort12SortIn;
import com.cloudframe.app.sort.file.SyncsortSort12SortIn;
import com.cloudframe.app.CFStepHandler;
public class SyncsortSort12Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort12Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort12")
	SyncsortSort12Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort12SortOut")
	SyncsortSort12SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort12SortIn")
	SyncsortSort12SortIn sortIn;
	...
	List<SyncsortSort12Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT12 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort12Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort12Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort12Keys relKey = new SyncsortSort12Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort12Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort12Keys> sortComp = sortDetail.getSortComp();
