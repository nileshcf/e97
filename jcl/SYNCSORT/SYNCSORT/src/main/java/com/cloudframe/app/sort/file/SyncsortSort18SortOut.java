  ...
  @Component("SyncsortSort18SortOut")
  @JobScope
  public class SyncsortSort18SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort18SortOut.class);
  	@Value("${SyncsortSort18SortOut:CLOUDFRM.JPM.SORT.OUTPUT18}")
      ...
      @Value("#{'${SyncsortSort18SortOutRecordType:${SyncsortSort18SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort18SortOutRecordLen:${SyncsortSort18SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort18SortOut Write: {}",e.getMessage()); 		
  		}
  	}
