  ...
  @Component("SyncsortSort20SortIn")
  @JobScope
  public class SyncsortSort20SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort20SortIn.class);
  	@Value("${SyncsortSort20SortIn:CLOUDFRM.JPM.SORT.INPUT20}")
  	...
  	@Value("#{'${SyncsortSort20SortInRecordType:${SyncsortSort20SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort20SortInRecordLen:${SyncsortSort20SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort20SortIn Read: {}",e.getMessage()); 
  		}
  	}
