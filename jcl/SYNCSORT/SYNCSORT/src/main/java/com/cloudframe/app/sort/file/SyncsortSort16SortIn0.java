  ...
  @Component("SyncsortSort16SortIn0")
  @JobScope
  public class SyncsortSort16SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort16SortIn0.class);
  	@Value("${SyncsortSort16SortIn[0]:CLOUDFRM.JPM.SORT.INPUT161}")
  	...
  	@Value("#{'${SyncsortSort16SortIn0RecordType:${SyncsortSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort16SortIn0RecordLen:${SyncsortSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort16SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
