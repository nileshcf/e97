  ...
  @Component("SyncsortSort8SortIn")
  @JobScope
  public class SyncsortSort8SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort8SortIn.class);
  	@Value("${SyncsortSort8SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort8SortInRecordType:${SyncsortSort8SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort8SortInRecordLen:${SyncsortSort8SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort8SortIn Read: {}",e.getMessage()); 
  		}
  	}
