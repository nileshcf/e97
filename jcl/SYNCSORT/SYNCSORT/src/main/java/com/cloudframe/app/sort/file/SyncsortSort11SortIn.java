  ...
  @Component("SyncsortSort11SortIn")
  @JobScope
  public class SyncsortSort11SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort11SortIn.class);
  	@Value("${SyncsortSort11SortIn:CLOUDFRM.JPM.SORT.INPUT11}")
  	...
  	@Value("#{'${SyncsortSort11SortInRecordType:${SyncsortSort11SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort11SortInRecordLen:${SyncsortSort11SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort11SortIn Read: {}",e.getMessage()); 
  		}
  	}
