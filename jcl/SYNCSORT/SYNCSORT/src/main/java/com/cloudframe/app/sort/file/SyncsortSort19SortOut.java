  ...
  @Component("SyncsortSort19SortOut")
  @JobScope
  public class SyncsortSort19SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort19SortOut.class);
  	@Value("${SyncsortSort19SortOut:CLOUDFRM.JPM.SORT.OUTPUT19}")
      ...
      @Value("#{'${SyncsortSort19SortOutRecordType:${SyncsortSort19SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort19SortOutRecordLen:${SyncsortSort19SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort19SortOut Write: {}",e.getMessage()); 		
  		}
  	}
