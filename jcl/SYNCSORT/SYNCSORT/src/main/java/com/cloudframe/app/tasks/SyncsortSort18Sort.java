...
import com.cloudframe.app.sort.file.SyncsortSort18SortIn;
import com.cloudframe.app.sort.file.SyncsortSort18SortOut;
import java.util.Set;
import org.springframework.batch.core.ExitStatus;
import com.cloudframe.app.sort.SyncsortSort18Detail;
...
import com.cloudframe.app.sort.file.records.SyncsortSort18Keys;
import org.springframework.batch.core.StepExecution;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SyncsortSort18Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort18Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort18")
	SyncsortSort18Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort18SortOut")
	SyncsortSort18SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort18SortIn")
	SyncsortSort18SortIn sortIn;
	...
	List<SyncsortSort18Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT18 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort18Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort18Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort18Keys relKey = new SyncsortSort18Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort18Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort18Keys> sortComp = sortDetail.getSortComp();
