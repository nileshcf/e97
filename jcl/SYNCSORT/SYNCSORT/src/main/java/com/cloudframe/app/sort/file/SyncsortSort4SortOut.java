  ...
  @Component("SyncsortSort4SortOut")
  @JobScope
  public class SyncsortSort4SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort4SortOut.class);
  	@Value("${SyncsortSort4SortOut:CLOUDFRM.JPM.SORT.OUTPUT4}")
      ...
      @Value("#{'${SyncsortSort4SortOutRecordType:${SyncsortSort4SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort4SortOutRecordLen:${SyncsortSort4SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort4SortOut Write: {}",e.getMessage()); 		
  		}
  	}
