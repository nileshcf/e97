  ...
  @Component("SyncsortSort1SortIn")
  @JobScope
  public class SyncsortSort1SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort1SortIn.class);
  	@Value("${SyncsortSort1SortIn:CLOUDFRM.JPM.SORT.INPUT1}")
  	...
  	@Value("#{'${SyncsortSort1SortInRecordType:${SyncsortSort1SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort1SortInRecordLen:${SyncsortSort1SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort1SortIn Read: {}",e.getMessage()); 
  		}
  	}
