  ...
  @Component("SyncsortSort3SortOut")
  @JobScope
  public class SyncsortSort3SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort3SortOut.class);
  	@Value("${SyncsortSort3SortOut:CLOUDFRM.JPM.SORT.OUTPUT3}")
      ...
      @Value("#{'${SyncsortSort3SortOutRecordType:${SyncsortSort3SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort3SortOutRecordLen:${SyncsortSort3SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort3SortOut Write: {}",e.getMessage()); 		
  		}
  	}
