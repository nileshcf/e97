  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort1":  /* setting the disp position for file(s) info for this step(SORT1). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort1SortIn","SyncsortSort1SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort1SortOut","SyncsortSort1SortOut.DISP");
            break;
            case "sort2":  /* setting the disp position for file(s) info for this step(SORT2). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort2SortIn","SyncsortSort2SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort2SortOut","SyncsortSort2SortOut.DISP");
            break;
            case "sort3":  /* setting the disp position for file(s) info for this step(SORT3). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort3SortIn","SyncsortSort3SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort3SortOut","SyncsortSort3SortOut.DISP");
            break;
            case "sort4":  /* setting the disp position for file(s) info for this step(SORT4). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort4SortIn","SyncsortSort4SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort4SortOut","SyncsortSort4SortOut.DISP");
            break;
            case "sort5":  /* setting the disp position for file(s) info for this step(SORT5). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort5SortIn","SyncsortSort5SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort5SortOut","SyncsortSort5SortOut.DISP");
            break;
            case "sort6":  /* setting the disp position for file(s) info for this step(SORT6). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort6SortIn","SyncsortSort6SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort6SortOut","SyncsortSort6SortOut.DISP");
            break;
            case "sort7":  /* setting the disp position for file(s) info for this step(SORT7). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort7SortIn","SyncsortSort7SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort7SortOut","SyncsortSort7SortOut.DISP");
            break;
            case "sort8":  /* setting the disp position for file(s) info for this step(SORT8). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort8SortIn","SyncsortSort8SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort8SortOut","SyncsortSort8SortOut.DISP");
            break;
            case "sort9":  /* setting the disp position for file(s) info for this step(SORT9). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort9SortIn","SyncsortSort9SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort9SortOut","SyncsortSort9SortOut.DISP");
            break;
            case "sort10":  /* setting the disp position for file(s) info for this step(SORT10). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort10SortIn","SyncsortSort10SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort10SortOut","SyncsortSort10SortOut.DISP");
            break;
            case "sort11":  /* setting the disp position for file(s) info for this step(SORT11). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort11SortIn","SyncsortSort11SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort11SortOut","SyncsortSort11SortOut.DISP");
            break;
            case "sort12":  /* setting the disp position for file(s) info for this step(SORT12). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort12SortIn","SyncsortSort12SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort12SortOut","SyncsortSort12SortOut.DISP");
            break;
            case "sort13":  /* setting the disp position for file(s) info for this step(SORT13). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort13SortIn","SyncsortSort13SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort13SortOut","SyncsortSort13SortOut.DISP");
            break;
            case "sort14":  /* setting the disp position for file(s) info for this step(SORT14). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort14SortIn","SyncsortSort14SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort14SortOut","SyncsortSort14SortOut.DISP");
            break;
            case "sort15":  /* setting the disp position for file(s) info for this step(SORT15). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort15SortIn0","SyncsortSort15SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort15SortIn1","SyncsortSort15SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort15SortOut","SyncsortSort15SortOut.DISP");
            break;
            case "sort16":  /* setting the disp position for file(s) info for this step(SORT16). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort16SortIn0","SyncsortSort16SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort16SortIn1","SyncsortSort16SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort16SortIn2","SyncsortSort16SortIn[2].DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort16SortOut","SyncsortSort16SortOut.DISP");
            break;
            case "sort18":  /* setting the disp position for file(s) info for this step(SORT18). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort18SortIn","SyncsortSort18SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort18SortOut","SyncsortSort18SortOut.DISP");
            break;
            case "sort19":  /* setting the disp position for file(s) info for this step(SORT19). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort19SortIn","SyncsortSort19SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort19SortOut","SyncsortSort19SortOut.DISP");
            break;
            case "sort20":  /* setting the disp position for file(s) info for this step(SORT20). */
                         SpringContextHandler.setFileDispPosition("SyncsortSort20SortIn","SyncsortSort20SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SyncsortSort20SortOut","SyncsortSort20SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SYNCSORT ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SYNCSORT ENDED -  ABEND={}", abendCode);
      } 
