...
import com.cloudframe.app.sort.SyncsortSort13Detail;
import java.util.Set;
import org.springframework.batch.core.ExitStatus;
import org.springframework.beans.factory.annotation.Value;
import com.cloudframe.app.sort.file.SyncsortSort13SortIn;
import java.io.File;
...
import com.cloudframe.app.sort.file.SyncsortSort13SortOut;
import java.io.FileNotFoundException;
import com.cloudframe.app.sort.file.records.SyncsortSort13Keys;
...
public class SyncsortSort13Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort13Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort13")
	SyncsortSort13Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort13SortOut")
	SyncsortSort13SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort13SortIn")
	SyncsortSort13SortIn sortIn;
	...
	List<SyncsortSort13Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT13 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort13Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort13Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort13Keys relKey = new SyncsortSort13Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort13Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort13Keys> sortComp = sortDetail.getSortComp();
