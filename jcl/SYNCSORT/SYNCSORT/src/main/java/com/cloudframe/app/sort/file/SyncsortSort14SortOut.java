  ...
  @Component("SyncsortSort14SortOut")
  @JobScope
  public class SyncsortSort14SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort14SortOut.class);
  	@Value("${SyncsortSort14SortOut:CLOUDFRM.JPM.SORT.OUTPUT14}")
      ...
      @Value("#{'${SyncsortSort14SortOutRecordType:${SyncsortSort14SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort14SortOutRecordLen:${SyncsortSort14SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort14SortOut Write: {}",e.getMessage()); 		
  		}
  	}
