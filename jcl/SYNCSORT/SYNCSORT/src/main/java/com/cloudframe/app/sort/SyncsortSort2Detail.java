...
@Component("batch_syncsortsort2")
@JobScope
public class SyncsortSort2Detail {

	private List<SyncsortSort2Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort2Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort2Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort2Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort2Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort2Keys> sortComp) {
