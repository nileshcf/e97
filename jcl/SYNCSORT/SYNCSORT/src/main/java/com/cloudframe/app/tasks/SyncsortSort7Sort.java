...
import com.cloudframe.app.sort.file.SyncsortSort7SortOut;
import java.io.RandomAccessFile;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.sort.file.SyncsortSort7SortIn;
import com.cloudframe.app.process.BaseProcess;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import org.springframework.beans.factory.annotation.Autowired;
import com.cloudframe.app.sort.SyncsortSort7Detail;
import java.io.FileNotFoundException;
import com.cloudframe.app.sort.file.records.SyncsortSort7Keys;
...
public class SyncsortSort7Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort7Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort7")
	SyncsortSort7Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort7SortOut")
	SyncsortSort7SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort7SortIn")
	SyncsortSort7SortIn sortIn;
	...
	List<SyncsortSort7Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT7 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort7Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort7Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort7Keys relKey = new SyncsortSort7Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort7Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort7Keys> sortComp = sortDetail.getSortComp();
