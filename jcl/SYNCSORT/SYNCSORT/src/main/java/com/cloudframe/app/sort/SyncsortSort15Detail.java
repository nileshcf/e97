...
@Component("batch_syncsortsort15")
@JobScope
public class SyncsortSort15Detail {

	private List<SyncsortSort15Keys> sortRecKeys = null;
	private Set<SyncsortSort15Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort15Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort15Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort15Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort15Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort15Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort15Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort15Keys> sortComp) {
