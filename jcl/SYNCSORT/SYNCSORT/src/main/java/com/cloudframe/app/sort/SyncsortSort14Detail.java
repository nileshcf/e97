...
@Component("batch_syncsortsort14")
@JobScope
public class SyncsortSort14Detail {

	private List<SyncsortSort14Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort14Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort14Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort14Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort14Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort14Keys> sortComp) {
