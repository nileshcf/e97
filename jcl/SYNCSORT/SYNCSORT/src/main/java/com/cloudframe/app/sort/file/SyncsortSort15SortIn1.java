  ...
  @Component("SyncsortSort15SortIn1")
  @JobScope
  public class SyncsortSort15SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort15SortIn1.class);
  	@Value("${SyncsortSort15SortIn[1]:CLOUDFRM.JPM.SORT.INPUT152}")
  	...
  	@Value("#{'${SyncsortSort15SortIn1RecordType:${SyncsortSort15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort15SortIn1RecordLen:${SyncsortSort15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort15SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
