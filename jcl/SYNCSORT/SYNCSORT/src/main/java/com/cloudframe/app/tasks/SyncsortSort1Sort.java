...
import com.cloudframe.app.sort.file.SyncsortSort1SortIn;
import java.util.stream.Collectors;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import org.springframework.batch.repeat.RepeatStatus;
import com.cloudframe.app.sort.SyncsortSort1Detail;
...
import com.cloudframe.app.sort.file.records.SyncsortSort1Keys;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import com.cloudframe.app.sort.file.SyncsortSort1SortOut;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SyncsortSort1Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort1Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort1")
	SyncsortSort1Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort1SortOut")
	SyncsortSort1SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort1SortIn")
	SyncsortSort1SortIn sortIn;
	...
	List<SyncsortSort1Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT1 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort1Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort1Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort1Keys relKey = new SyncsortSort1Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort1Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SyncsortSort1Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort1Keys> sortComp = sortDetail.getSortComp();
