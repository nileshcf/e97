...
@Component("batch_syncsortsort16")
@JobScope
public class SyncsortSort16Detail {

	private List<SyncsortSort16Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort16Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort16Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort16Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort16Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort16Keys> sortComp) {
