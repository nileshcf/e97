  ...
  @Component("SyncsortSort18SortIn")
  @JobScope
  public class SyncsortSort18SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort18SortIn.class);
  	@Value("${SyncsortSort18SortIn:CLOUDFRM.JPM.SORT.INPUT18}")
  	...
  	@Value("#{'${SyncsortSort18SortInRecordType:${SyncsortSort18SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort18SortInRecordLen:${SyncsortSort18SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort18SortIn Read: {}",e.getMessage()); 
  		}
  	}
