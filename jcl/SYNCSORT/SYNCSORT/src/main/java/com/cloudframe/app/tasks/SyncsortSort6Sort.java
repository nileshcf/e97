...
import java.io.File;
import com.cloudframe.app.sort.file.SyncsortSort6SortIn;
...
import com.cloudframe.app.sort.file.SyncsortSort6SortOut;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.sort.SyncsortSort6Detail;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
import com.cloudframe.app.sort.file.records.SyncsortSort6Keys;
public class SyncsortSort6Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort6Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort6")
	SyncsortSort6Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort6SortOut")
	SyncsortSort6SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort6SortIn")
	SyncsortSort6SortIn sortIn;
	...
	List<SyncsortSort6Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT6 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort6Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort6Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort6Keys relKey = new SyncsortSort6Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort6Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort6Keys> sortComp = sortDetail.getSortComp();
