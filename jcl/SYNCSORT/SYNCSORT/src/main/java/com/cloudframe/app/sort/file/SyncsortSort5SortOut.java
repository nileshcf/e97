  ...
  @Component("SyncsortSort5SortOut")
  @JobScope
  public class SyncsortSort5SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort5SortOut.class);
  	@Value("${SyncsortSort5SortOut:CLOUDFRM.JPM.SORT.OUTPUT5}")
      ...
      @Value("#{'${SyncsortSort5SortOutRecordType:${SyncsortSort5SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort5SortOutRecordLen:${SyncsortSort5SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort5SortOut Write: {}",e.getMessage()); 		
  		}
  	}
