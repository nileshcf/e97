...
@Component("batch_syncsortsort7")
@JobScope
public class SyncsortSort7Detail {

	private List<SyncsortSort7Keys> sortRecKeys = null;
	private Set<SyncsortSort7Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort7Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort7Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort7Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort7Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort7Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort7Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort7Keys> sortComp) {
