...
@Component("batch_syncsortsort5")
@JobScope
public class SyncsortSort5Detail {

	private List<SyncsortSort5Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort5Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort5Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort5Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort5Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort5Keys> sortComp) {
