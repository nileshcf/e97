...
import com.cloudframe.app.sort.file.SyncsortSort20SortIn;
...
import com.cloudframe.app.sort.SyncsortSort20Detail;
import com.cloudframe.app.sort.file.SyncsortSort20SortOut;
...
import com.cloudframe.app.sort.file.records.SyncsortSort20Keys;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SyncsortSort20Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort20Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort20")
	SyncsortSort20Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort20SortOut")
	SyncsortSort20SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort20SortIn")
	SyncsortSort20SortIn sortIn;
	...
	List<SyncsortSort20Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT20 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort20Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort20Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort20Keys relKey = new SyncsortSort20Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort20Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort20Keys> sortComp = sortDetail.getSortComp();
