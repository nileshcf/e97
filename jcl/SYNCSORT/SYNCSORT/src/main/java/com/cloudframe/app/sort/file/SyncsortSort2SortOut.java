  ...
  @Component("SyncsortSort2SortOut")
  @JobScope
  public class SyncsortSort2SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort2SortOut.class);
  	@Value("${SyncsortSort2SortOut:CLOUDFRM.JPM.SORT.OUTPUT2}")
      ...
      @Value("#{'${SyncsortSort2SortOutRecordType:${SyncsortSort2SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort2SortOutRecordLen:${SyncsortSort2SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort2SortOut Write: {}",e.getMessage()); 		
  		}
  	}
