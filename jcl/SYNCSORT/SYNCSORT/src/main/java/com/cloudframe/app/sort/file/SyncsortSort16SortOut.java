  ...
  @Component("SyncsortSort16SortOut")
  @JobScope
  public class SyncsortSort16SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort16SortOut.class);
  	@Value("${SyncsortSort16SortOut:CLOUDFRM.JPM.SORT.OUTPUT16}")
      ...
      @Value("#{'${SyncsortSort16SortOutRecordType:${SyncsortSort16SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort16SortOutRecordLen:${SyncsortSort16SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort16SortOut Write: {}",e.getMessage()); 		
  		}
  	}
