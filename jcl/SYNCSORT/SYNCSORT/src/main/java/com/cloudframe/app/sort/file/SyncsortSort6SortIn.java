  ...
  @Component("SyncsortSort6SortIn")
  @JobScope
  public class SyncsortSort6SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort6SortIn.class);
  	@Value("${SyncsortSort6SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort6SortInRecordType:${SyncsortSort6SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort6SortInRecordLen:${SyncsortSort6SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort6SortIn Read: {}",e.getMessage()); 
  		}
  	}
