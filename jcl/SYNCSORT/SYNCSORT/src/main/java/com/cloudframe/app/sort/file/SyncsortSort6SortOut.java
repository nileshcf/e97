  ...
  @Component("SyncsortSort6SortOut")
  @JobScope
  public class SyncsortSort6SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort6SortOut.class);
  	@Value("${SyncsortSort6SortOut:CLOUDFRM.JPM.SORT.OUTPUT6}")
      ...
      @Value("#{'${SyncsortSort6SortOutRecordType:${SyncsortSort6SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort6SortOutRecordLen:${SyncsortSort6SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort6SortOut Write: {}",e.getMessage()); 		
  		}
  	}
