...
import com.cloudframe.app.sort.file.SyncsortSort11SortIn;
...
import com.cloudframe.app.sort.SyncsortSort11Detail;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import org.springframework.beans.factory.annotation.Autowired;
import java.io.FileNotFoundException;
import java.util.Arrays; 
import com.cloudframe.app.sort.file.records.SyncsortSort11Keys;
import com.cloudframe.app.sort.file.SyncsortSort11SortOut;
...
public class SyncsortSort11Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort11Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort11")
	SyncsortSort11Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort11SortOut")
	SyncsortSort11SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort11SortIn")
	SyncsortSort11SortIn sortIn;
	...
	List<SyncsortSort11Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT11 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort11Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort11Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort11Keys relKey = new SyncsortSort11Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort11Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort11Keys> sortComp = sortDetail.getSortComp();
