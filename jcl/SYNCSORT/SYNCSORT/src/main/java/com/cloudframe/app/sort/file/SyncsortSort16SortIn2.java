  ...
  @Component("SyncsortSort16SortIn2")
  @JobScope
  public class SyncsortSort16SortIn2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort16SortIn2.class);
  	@Value("${SyncsortSort16SortIn[2]:CLOUDFRM.JPM.SORT.INPUT163}")
  	...
  	@Value("#{'${SyncsortSort16SortIn2RecordType:${SyncsortSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort16SortIn2RecordLen:${SyncsortSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort16SortIn2 Read: {}",e.getMessage()); 
  		}
  	}
