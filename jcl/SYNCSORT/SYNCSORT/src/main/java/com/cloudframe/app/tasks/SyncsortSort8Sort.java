...
import com.cloudframe.app.sort.file.SyncsortSort8SortOut;
...
import com.cloudframe.app.sort.file.SyncsortSort8SortIn;
import org.springframework.batch.repeat.RepeatStatus;
import java.util.List;
import com.cloudframe.app.sort.SyncsortSort8Detail;
...
import com.cloudframe.app.sort.file.records.SyncsortSort8Keys;
import com.cloudframe.app.CFStepHandler;
public class SyncsortSort8Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort8Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort8")
	SyncsortSort8Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort8SortOut")
	SyncsortSort8SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort8SortIn")
	SyncsortSort8SortIn sortIn;
	...
	List<SyncsortSort8Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT8 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort8Keys k = sortRecKeys.get(index);
...
copyRecordBytes(repBytes, recBytes, OUTREC_POS2,OUTREC_DES_POS2,OUTREC_LEN2);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort8Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort8Keys relKey = new SyncsortSort8Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort8Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort8Keys> sortComp = sortDetail.getSortComp();
