...
@Component("batch_syncsortsort12")
@JobScope
public class SyncsortSort12Detail {

	private List<SyncsortSort12Keys> sortRecKeys = null;
	private Set<SyncsortSort12Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort12Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort12Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort12Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort12Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort12Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort12Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort12Keys> sortComp) {
