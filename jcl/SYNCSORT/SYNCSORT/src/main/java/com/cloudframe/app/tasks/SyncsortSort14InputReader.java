...
public class SyncsortSort14InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort14InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SyncsortSort14Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SyncsortSort14Keys relKey = new SyncsortSort14Keys();
