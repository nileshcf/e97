  ...
  @Component("SyncsortSort13SortOut")
  @JobScope
  public class SyncsortSort13SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort13SortOut.class);
  	@Value("${SyncsortSort13SortOut:CLOUDFRM.JPM.SORT.OUTPUT13}")
      ...
      @Value("#{'${SyncsortSort13SortOutRecordType:${SyncsortSort13SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort13SortOutRecordLen:${SyncsortSort13SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort13SortOut Write: {}",e.getMessage()); 		
  		}
  	}
