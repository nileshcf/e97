...
@Component("batch_syncsortsort19")
@JobScope
public class SyncsortSort19Detail {

	private List<SyncsortSort19Keys> sortRecKeys = null;
	private Set<SyncsortSort19Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort19Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort19Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort19Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort19Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort19Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort19Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort19Keys> sortComp) {
