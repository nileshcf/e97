  ...
  @Component("SyncsortSort8SortOut")
  @JobScope
  public class SyncsortSort8SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort8SortOut.class);
  	@Value("${SyncsortSort8SortOut:CLOUDFRM.JPM.SORT.OUTPUT8}")
      ...
      @Value("#{'${SyncsortSort8SortOutRecordType:${SyncsortSort8SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort8SortOutRecordLen:${SyncsortSort8SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort8SortOut Write: {}",e.getMessage()); 		
  		}
  	}
