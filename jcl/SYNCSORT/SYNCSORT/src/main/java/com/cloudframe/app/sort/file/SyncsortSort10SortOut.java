  ...
  @Component("SyncsortSort10SortOut")
  @JobScope
  public class SyncsortSort10SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort10SortOut.class);
  	@Value("${SyncsortSort10SortOut:CLOUDFRM.JPM.SORT.OUTPUT10}")
      ...
      @Value("#{'${SyncsortSort10SortOutRecordType:${SyncsortSort10SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort10SortOutRecordLen:${SyncsortSort10SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort10SortOut Write: {}",e.getMessage()); 		
  		}
  	}
