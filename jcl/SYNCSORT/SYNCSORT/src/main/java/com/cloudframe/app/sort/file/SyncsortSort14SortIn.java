  ...
  @Component("SyncsortSort14SortIn")
  @JobScope
  public class SyncsortSort14SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort14SortIn.class);
  	@Value("${SyncsortSort14SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort14SortInRecordType:${SyncsortSort14SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort14SortInRecordLen:${SyncsortSort14SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort14SortIn Read: {}",e.getMessage()); 
  		}
  	}
