  ...
  @Component("SyncsortSort12SortOut")
  @JobScope
  public class SyncsortSort12SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort12SortOut.class);
  	@Value("${SyncsortSort12SortOut:CLOUDFRM.JPM.SORT.OUTPUT12}")
      ...
      @Value("#{'${SyncsortSort12SortOutRecordType:${SyncsortSort12SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort12SortOutRecordLen:${SyncsortSort12SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort12SortOut Write: {}",e.getMessage()); 		
  		}
  	}
