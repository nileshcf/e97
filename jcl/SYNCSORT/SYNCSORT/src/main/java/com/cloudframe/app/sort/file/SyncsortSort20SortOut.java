  ...
  @Component("SyncsortSort20SortOut")
  @JobScope
  public class SyncsortSort20SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort20SortOut.class);
  	@Value("${SyncsortSort20SortOut:CLOUDFRM.JPM.SORT.OUTPUT20}")
      ...
      @Value("#{'${SyncsortSort20SortOutRecordType:${SyncsortSort20SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort20SortOutRecordLen:${SyncsortSort20SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort20SortOut Write: {}",e.getMessage()); 		
  		}
  	}
