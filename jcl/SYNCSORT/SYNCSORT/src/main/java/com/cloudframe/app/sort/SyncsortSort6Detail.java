...
@Component("batch_syncsortsort6")
@JobScope
public class SyncsortSort6Detail {

	private List<SyncsortSort6Keys> sortRecKeys = null;
	private Set<SyncsortSort6Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort6Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort6Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort6Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort6Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort6Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort6Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort6Keys> sortComp) {
