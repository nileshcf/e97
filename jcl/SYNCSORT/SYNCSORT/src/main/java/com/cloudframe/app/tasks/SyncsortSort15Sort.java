...
import com.cloudframe.app.sort.file.SyncsortSort15SortIn0;
import com.cloudframe.app.sort.file.SyncsortSort15SortOut;
...
import com.cloudframe.app.sort.file.SyncsortSort15SortIn1;
import org.springframework.beans.factory.annotation.Autowired;
import java.io.FileNotFoundException;
import java.io.IOException;
import com.cloudframe.app.sort.file.SyncsortSort15SortIn1;
import com.cloudframe.app.sort.file.records.SyncsortSort15Keys;
import org.springframework.batch.core.StepExecutionListener;
import org.springframework.batch.core.StepExecution;
import com.cloudframe.app.sort.SyncsortSort15Detail;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.sort.file.SyncsortSort15SortIn0;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class SyncsortSort15Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort15Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort15")
	SyncsortSort15Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort15SortOut")
	SyncsortSort15SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort15SortIn0")
	SyncsortSort15SortIn0 sortIn0;
	
	@Autowired
	@Qualifier("SyncsortSort15SortIn1")
	SyncsortSort15SortIn1 sortIn1;
	...
	List<SyncsortSort15Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT15 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort15Keys k = sortRecKeys.get(index);
           if (isWriteInTempFile()) {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<SyncsortSort15Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		SyncsortSort15Keys relKey = new SyncsortSort15Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort15Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SyncsortSort15Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort15Keys> sortComp = sortDetail.getSortComp();
