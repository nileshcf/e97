...
@Component("batch_syncsortsort13")
@JobScope
public class SyncsortSort13Detail {

	private List<SyncsortSort13Keys> sortRecKeys = null;
	private Set<SyncsortSort13Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort13Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort13Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort13Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort13Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort13Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort13Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort13Keys> sortComp) {
