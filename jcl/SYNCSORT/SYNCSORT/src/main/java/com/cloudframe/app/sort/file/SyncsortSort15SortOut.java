  ...
  @Component("SyncsortSort15SortOut")
  @JobScope
  public class SyncsortSort15SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort15SortOut.class);
  	@Value("${SyncsortSort15SortOut:CLOUDFRM.JPM.SORT.OUTPUT15}")
      ...
      @Value("#{'${SyncsortSort15SortOutRecordType:${SyncsortSort15SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort15SortOutRecordLen:${SyncsortSort15SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort15SortOut Write: {}",e.getMessage()); 		
  		}
  	}
