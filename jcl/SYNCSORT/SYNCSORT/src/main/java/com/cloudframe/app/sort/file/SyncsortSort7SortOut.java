  ...
  @Component("SyncsortSort7SortOut")
  @JobScope
  public class SyncsortSort7SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort7SortOut.class);
  	@Value("${SyncsortSort7SortOut:CLOUDFRM.JPM.SORT.OUTPUT7}")
      ...
      @Value("#{'${SyncsortSort7SortOutRecordType:${SyncsortSort7SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort7SortOutRecordLen:${SyncsortSort7SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort7SortOut Write: {}",e.getMessage()); 		
  		}
  	}
