...
@Component("batch_syncsortsort1")
@JobScope
public class SyncsortSort1Detail {

	private List<SyncsortSort1Keys> sortRecKeys = null;
	private Set<SyncsortSort1Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort1Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort1Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort1Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort1Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort1Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort1Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort1Keys> sortComp) {
