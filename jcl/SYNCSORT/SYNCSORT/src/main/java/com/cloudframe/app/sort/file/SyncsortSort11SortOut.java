  ...
  @Component("SyncsortSort11SortOut")
  @JobScope
  public class SyncsortSort11SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort11SortOut.class);
  	@Value("${SyncsortSort11SortOut:CLOUDFRM.JPM.SORT.OUTPUT11}")
      ...
      @Value("#{'${SyncsortSort11SortOutRecordType:${SyncsortSort11SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort11SortOutRecordLen:${SyncsortSort11SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort11SortOut Write: {}",e.getMessage()); 		
  		}
  	}
