...
import com.cloudframe.app.sort.file.SyncsortSort3SortIn;
import com.cloudframe.app.sort.SyncsortSort3Detail;
...
import com.cloudframe.app.sort.file.SyncsortSort3SortOut;
import com.cloudframe.app.sort.file.SyncsortSort3SortIn;
...
import com.cloudframe.app.sort.file.records.SyncsortSort3Keys;
public class SyncsortSort3Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort3Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_syncsortsort3")
	SyncsortSort3Detail sortDetail;
	
	@Autowired
	@Qualifier("SyncsortSort3SortOut")
	SyncsortSort3SortOut sortOut;
	

	
	@Autowired
	@Qualifier("SyncsortSort3SortIn")
	SyncsortSort3SortIn sortIn;
	...
	List<SyncsortSort3Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: SYNCSORTSORT3 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			SyncsortSort3Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SyncsortSort3Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SyncsortSort3Keys relKey = new SyncsortSort3Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   SyncsortSort3Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(SyncsortSort3Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<SyncsortSort3Keys> sortComp = sortDetail.getSortComp();
