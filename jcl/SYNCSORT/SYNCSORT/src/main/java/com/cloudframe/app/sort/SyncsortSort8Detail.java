...
@Component("batch_syncsortsort8")
@JobScope
public class SyncsortSort8Detail {

	private List<SyncsortSort8Keys> sortRecKeys = null;
	private Set<SyncsortSort8Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<SyncsortSort8Keys> sortComp = null;
	 ...
	 */
	public List<SyncsortSort8Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SyncsortSort8Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<SyncsortSort8Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<SyncsortSort8Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<SyncsortSort8Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SyncsortSort8Keys> sortComp) {
