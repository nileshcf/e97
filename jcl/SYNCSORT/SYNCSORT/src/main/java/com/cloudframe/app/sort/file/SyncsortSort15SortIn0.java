  ...
  @Component("SyncsortSort15SortIn0")
  @JobScope
  public class SyncsortSort15SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort15SortIn0.class);
  	@Value("${SyncsortSort15SortIn[0]:CLOUDFRM.JPM.SORT.INPUT151}")
  	...
  	@Value("#{'${SyncsortSort15SortIn0RecordType:${SyncsortSort15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort15SortIn0RecordLen:${SyncsortSort15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort15SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
