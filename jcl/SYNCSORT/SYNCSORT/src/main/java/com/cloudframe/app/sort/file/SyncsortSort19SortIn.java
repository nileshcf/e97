  ...
  @Component("SyncsortSort19SortIn")
  @JobScope
  public class SyncsortSort19SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort19SortIn.class);
  	@Value("${SyncsortSort19SortIn:CLOUDFRM.JPM.SORT.INPUT19}")
  	...
  	@Value("#{'${SyncsortSort19SortInRecordType:${SyncsortSort19SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort19SortInRecordLen:${SyncsortSort19SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort19SortIn Read: {}",e.getMessage()); 
  		}
  	}
