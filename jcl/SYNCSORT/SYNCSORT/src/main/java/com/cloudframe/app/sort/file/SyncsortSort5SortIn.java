  ...
  @Component("SyncsortSort5SortIn")
  @JobScope
  public class SyncsortSort5SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort5SortIn.class);
  	@Value("${SyncsortSort5SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${SyncsortSort5SortInRecordType:${SyncsortSort5SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SyncsortSort5SortInRecordLen:${SyncsortSort5SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SyncsortSort5SortIn Read: {}",e.getMessage()); 
  		}
  	}
