...
public class SyncsortSort5InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SyncsortSort5InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SyncsortSort5Keys> sortRecKeys = sortDetail.getSortRecKeys();
		SyncsortSort5Keys relKey = new SyncsortSort5Keys();
