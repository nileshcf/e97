  ...
  @Component("SyncsortSort1SortOut")
  @JobScope
  public class SyncsortSort1SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SyncsortSort1SortOut.class);
  	@Value("${SyncsortSort1SortOut:CLOUDFRM.JPM.SORT.OUTPUT1}")
      ...
      @Value("#{'${SyncsortSort1SortOutRecordType:${SyncsortSort1SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SyncsortSort1SortOutRecordLen:${SyncsortSort1SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SyncsortSort1SortOut Write: {}",e.getMessage()); 		
  		}
  	}
