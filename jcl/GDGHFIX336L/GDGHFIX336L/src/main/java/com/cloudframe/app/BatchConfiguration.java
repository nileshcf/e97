...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public Gdghfix336lStep001InputReader oldnewStep001InputReader() {
    	return new Gdghfix336lStep001InputReader();
    }
    
    @Bean
    @JobScope
    public Gdghfix336lStep001Processor oldnewStep001Processor() {
    	return new Gdghfix336lStep001Processor();
    }
    
    @Bean
    @JobScope
    public Gdghfix336lStep001OutputWriter oldnewStep001OutputWriter() {
    	return new Gdghfix336lStep001OutputWriter();
    }
    
    @Bean
    @JobScope
    protected Step readGdghfix336lStep001SortInput(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("readGdghfix336lStep001SortInput",jobRepository).tasklet(oldnewStep001InputReader(), transactionManager).build();  
    }
    
    @Bean
    @JobScope
    protected Step processGdghfix336lStep001Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("sortGdghfix336lStep001Process",jobRepository).tasklet(oldnewStep001Processor(), transactionManager).build();  
    }
    
    @Bean
    @JobScope
    protected Step writeGdghfix336lStep001SortOutput(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("writeGdghfix336lStep001SortOutput",jobRepository).tasklet(oldnewStep001OutputWriter(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow step001Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("step001Executor")
             ...
             .to(readGdghfix336lStep001SortInput(jobRepository, transactionManager))
             .next(processGdghfix336lStep001Sort(jobRepository, transactionManager))
             .next(writeGdghfix336lStep001SortOutput(jobRepository, transactionManager))
