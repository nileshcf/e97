...
public class Sys001MipSpecrtOld extends CFFile {
    ...
    **/
	@Value("${OLDNEW.Sys001MipSpecrtOldCharSet:cp1047}")
	private String charSet;
	
	@Value("${OLDNEW.Sys001MipSpecrtOldCRLFflag:no}")
