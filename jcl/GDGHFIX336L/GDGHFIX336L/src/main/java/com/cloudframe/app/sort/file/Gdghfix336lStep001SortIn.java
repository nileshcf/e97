  ...
  @Component("Gdghfix336lStep001SortIn")
  @JobScope
  public class Gdghfix336lStep001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Gdghfix336lStep001SortIn.class);
  	@Value("${Gdghfix336lStep001SortIn:CLOUDFRM.SF.P3GX.PRSF2130.SORT.IN}")
  	...
  	@Value("#{'${Gdghfix336lStep001SortInRecordType:${Gdghfix336lStep001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Gdghfix336lStep001SortInRecordLen:${Gdghfix336lStep001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Gdghfix336lStep001SortIn Read: {}",e.getMessage()); 
  		}
  	}
