  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step001":  /* setting the disp position for file(s) info for this step(STEP001). */
                         SpringContextHandler.setFileDispPosition("Gdghfix336lStep001SortIn","Gdghfix336lStep001SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("Gdghfix336lStep001SortOut","Gdghfix336lStep001SortOut.DISP");
            break;
            case "step002":
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : GDGHFIX336L ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : GDGHFIX336L ENDED -  ABEND={}", abendCode);
      } 
