...
import com.cloudframe.app.sort.Gdghfix336lStep001Detail;
import org.springframework.beans.factory.annotation.Value;
public class Gdghfix336lStep001Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(Gdghfix336lStep001Sort.class);
