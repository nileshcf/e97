...
@Component("batch_gdghfix336lstep001")
@JobScope
public class Gdghfix336lStep001Detail {

	private List<Gdghfix336lStep001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Gdghfix336lStep001Keys> sortComp = null;
	 ...
	 */
	public List<Gdghfix336lStep001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Gdghfix336lStep001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Gdghfix336lStep001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Gdghfix336lStep001Keys> sortComp) {
