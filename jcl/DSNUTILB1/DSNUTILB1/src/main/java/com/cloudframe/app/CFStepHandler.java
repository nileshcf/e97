...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String CLP_DSNUPROC = "clp_dsnuproc";
    private static final String STEP011 = "step011";
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : DSNUTILB1 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : DSNUTILB1 ENDED -  ABEND={}", abendCode);
      } 
