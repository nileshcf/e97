package com.cloudframe.app.tstcdpag.file;
...
import com.cloudframe.app.tstcdpag.file.records.*;

@Component("tstcdpag_inputFile")
public class InputFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(InputFile.class);
	
	@Value("${TSTCDPAG.InputFile:INFILE}")
    ...
    **/
	@Value("${TSTCDPAG.InputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${TSTCDPAG.InputFileCRLFflag:no}")
