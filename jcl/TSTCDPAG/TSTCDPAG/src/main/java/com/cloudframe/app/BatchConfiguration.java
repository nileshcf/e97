...
public class BatchConfiguration {
    ...
    private static final String JOBNAME = "TSTCDPAG";
    
    /* Driver Programs used in steps */  
    private static final String TSTCDPAG_BEAN = "tstcdpag";
    ...
    public Step step01(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Tstcdpag)cfStepHandler.initAndGetProcessBean(STEP01_STEP,TSTCDPAG_BEAN)).process(new GlobalExecutorCtx().getContext("TSTCDPAG"));
...
cfStepHandler.setAbendCode(cfe);
 		    	  		...
 		    	  		rcStatus+=rc;
 		    	   		cfStepHandler.postStepExecution(STEP01_STEP, rc ,TSTCDPAG_BEAN);
                      } 
