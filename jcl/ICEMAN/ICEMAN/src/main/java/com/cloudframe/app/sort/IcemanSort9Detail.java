...
@Component("batch_icemansort9")
@JobScope
public class IcemanSort9Detail {

	private List<IcemanSort9Keys> sortRecKeys = null;
	private Set<IcemanSort9Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort9Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort9Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort9Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort9Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort9Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort9Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort9Keys> sortComp) {
