...
import com.cloudframe.app.sort.file.IcemanSort20SortIn;
...
import com.cloudframe.app.sort.file.IcemanSort20SortOut;
...
import com.cloudframe.app.sort.file.records.IcemanSort20Keys;
...
import com.cloudframe.app.sort.IcemanSort20Detail;
...
public class IcemanSort20Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort20Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort20")
	IcemanSort20Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort20SortOut")
	IcemanSort20SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort20SortIn")
	IcemanSort20SortIn sortIn;
	...
	List<IcemanSort20Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT20 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort20Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort20Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort20Keys relKey = new IcemanSort20Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort20Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort20Keys> sortComp = sortDetail.getSortComp();
