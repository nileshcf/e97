...
import com.cloudframe.app.sort.file.records.IcemanSort19Keys;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import org.springframework.batch.repeat.RepeatStatus;
import java.util.List;
import com.cloudframe.app.sort.IcemanSort19Detail;
import java.io.RandomAccessFile;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.process.BaseProcess;
import com.cloudframe.app.sort.file.IcemanSort19SortIn;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import com.cloudframe.app.sort.file.IcemanSort19SortIn;
import org.springframework.beans.factory.annotation.Autowired;
import com.cloudframe.app.sort.file.IcemanSort19SortOut;
...
public class IcemanSort19Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort19Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort19")
	IcemanSort19Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort19SortOut")
	IcemanSort19SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort19SortIn")
	IcemanSort19SortIn sortIn;
	...
	List<IcemanSort19Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT19 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort19Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort19Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort19Keys relKey = new IcemanSort19Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort19Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(IcemanSort19Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort19Keys> sortComp = sortDetail.getSortComp();
