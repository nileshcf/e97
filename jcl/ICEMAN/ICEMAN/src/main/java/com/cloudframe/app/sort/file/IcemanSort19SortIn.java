  ...
  @Component("IcemanSort19SortIn")
  @JobScope
  public class IcemanSort19SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort19SortIn.class);
  	@Value("${IcemanSort19SortIn:CLOUDFRM.JPM.SORT.INPUT19}")
  	...
  	@Value("#{'${IcemanSort19SortInRecordType:${IcemanSort19SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort19SortInRecordLen:${IcemanSort19SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort19SortIn Read: {}",e.getMessage()); 
  		}
  	}
