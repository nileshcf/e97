  ...
  @Component("IcemanSort16SortOut")
  @JobScope
  public class IcemanSort16SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort16SortOut.class);
  	@Value("${IcemanSort16SortOut:CLOUDFRM.JPM.SORT.OUTPUT16}")
      ...
      @Value("#{'${IcemanSort16SortOutRecordType:${IcemanSort16SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort16SortOutRecordLen:${IcemanSort16SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort16SortOut Write: {}",e.getMessage()); 		
  		}
  	}
