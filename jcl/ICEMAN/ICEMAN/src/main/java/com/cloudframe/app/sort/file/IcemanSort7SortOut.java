  ...
  @Component("IcemanSort7SortOut")
  @JobScope
  public class IcemanSort7SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort7SortOut.class);
  	@Value("${IcemanSort7SortOut:CLOUDFRM.JPM.SORT.OUTPUT7}")
      ...
      @Value("#{'${IcemanSort7SortOutRecordType:${IcemanSort7SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort7SortOutRecordLen:${IcemanSort7SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort7SortOut Write: {}",e.getMessage()); 		
  		}
  	}
