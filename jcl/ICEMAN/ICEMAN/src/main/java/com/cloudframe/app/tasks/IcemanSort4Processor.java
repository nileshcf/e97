...
public class IcemanSort4Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(IcemanSort4Processor.class);
