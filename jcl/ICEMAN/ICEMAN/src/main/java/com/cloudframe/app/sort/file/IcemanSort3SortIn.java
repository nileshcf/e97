  ...
  @Component("IcemanSort3SortIn")
  @JobScope
  public class IcemanSort3SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort3SortIn.class);
  	@Value("${IcemanSort3SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort3SortInRecordType:${IcemanSort3SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort3SortInRecordLen:${IcemanSort3SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort3SortIn Read: {}",e.getMessage()); 
  		}
  	}
