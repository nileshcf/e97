  ...
  @Component("IcemanSort6SortOut")
  @JobScope
  public class IcemanSort6SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort6SortOut.class);
  	@Value("${IcemanSort6SortOut:CLOUDFRM.JPM.SORT.OUTPUT6}")
      ...
      @Value("#{'${IcemanSort6SortOutRecordType:${IcemanSort6SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort6SortOutRecordLen:${IcemanSort6SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort6SortOut Write: {}",e.getMessage()); 		
  		}
  	}
