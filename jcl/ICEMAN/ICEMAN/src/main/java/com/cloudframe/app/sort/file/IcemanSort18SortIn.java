  ...
  @Component("IcemanSort18SortIn")
  @JobScope
  public class IcemanSort18SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort18SortIn.class);
  	@Value("${IcemanSort18SortIn:CLOUDFRM.JPM.SORT.INPUT18}")
  	...
  	@Value("#{'${IcemanSort18SortInRecordType:${IcemanSort18SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort18SortInRecordLen:${IcemanSort18SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort18SortIn Read: {}",e.getMessage()); 
  		}
  	}
