...
@Component("batch_icemansort3")
@JobScope
public class IcemanSort3Detail {

	private List<IcemanSort3Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort3Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort3Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort3Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IcemanSort3Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort3Keys> sortComp) {
