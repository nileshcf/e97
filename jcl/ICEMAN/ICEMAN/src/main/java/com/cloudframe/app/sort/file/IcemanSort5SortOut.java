  ...
  @Component("IcemanSort5SortOut")
  @JobScope
  public class IcemanSort5SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort5SortOut.class);
  	@Value("${IcemanSort5SortOut:CLOUDFRM.JPM.SORT.OUTPUT5}")
      ...
      @Value("#{'${IcemanSort5SortOutRecordType:${IcemanSort5SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort5SortOutRecordLen:${IcemanSort5SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort5SortOut Write: {}",e.getMessage()); 		
  		}
  	}
