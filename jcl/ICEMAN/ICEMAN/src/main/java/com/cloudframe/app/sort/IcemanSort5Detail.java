...
@Component("batch_icemansort5")
@JobScope
public class IcemanSort5Detail {

	private List<IcemanSort5Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort5Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort5Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort5Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IcemanSort5Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort5Keys> sortComp) {
