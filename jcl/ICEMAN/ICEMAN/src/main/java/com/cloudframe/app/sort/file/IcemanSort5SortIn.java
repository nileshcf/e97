  ...
  @Component("IcemanSort5SortIn")
  @JobScope
  public class IcemanSort5SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort5SortIn.class);
  	@Value("${IcemanSort5SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort5SortInRecordType:${IcemanSort5SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort5SortInRecordLen:${IcemanSort5SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort5SortIn Read: {}",e.getMessage()); 
  		}
  	}
