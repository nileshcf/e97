  ...
  @Component("IcemanSort12SortOut")
  @JobScope
  public class IcemanSort12SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort12SortOut.class);
  	@Value("${IcemanSort12SortOut:CLOUDFRM.JPM.SORT.OUTPUT12}")
      ...
      @Value("#{'${IcemanSort12SortOutRecordType:${IcemanSort12SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort12SortOutRecordLen:${IcemanSort12SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort12SortOut Write: {}",e.getMessage()); 		
  		}
  	}
