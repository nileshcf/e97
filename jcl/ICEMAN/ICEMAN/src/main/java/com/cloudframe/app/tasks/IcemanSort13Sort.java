...
import com.cloudframe.app.sort.file.IcemanSort13SortOut;
import com.cloudframe.app.data.Field;
import com.cloudframe.app.sort.IcemanSort13Detail;
import com.cloudframe.app.sort.file.IcemanSort13SortIn;
...
public class IcemanSort13Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort13Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort13")
	IcemanSort13Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort13SortOut")
	IcemanSort13SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort13SortIn")
	IcemanSort13SortIn sortIn;
	...
	List<IcemanSort13Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT13 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort13Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort13Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort13Keys relKey = new IcemanSort13Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort13Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort13Keys> sortComp = sortDetail.getSortComp();
