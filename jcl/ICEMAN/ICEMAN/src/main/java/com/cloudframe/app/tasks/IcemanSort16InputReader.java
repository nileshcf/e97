...
public class IcemanSort16InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort16InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<IcemanSort16Keys> sortRecKeys = sortDetail.getSortRecKeys();
		IcemanSort16Keys relKey = new IcemanSort16Keys();
