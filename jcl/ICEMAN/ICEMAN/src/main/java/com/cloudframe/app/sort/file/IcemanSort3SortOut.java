  ...
  @Component("IcemanSort3SortOut")
  @JobScope
  public class IcemanSort3SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort3SortOut.class);
  	@Value("${IcemanSort3SortOut:CLOUDFRM.JPM.SORT.OUTPUT3}")
      ...
      @Value("#{'${IcemanSort3SortOutRecordType:${IcemanSort3SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort3SortOutRecordLen:${IcemanSort3SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort3SortOut Write: {}",e.getMessage()); 		
  		}
  	}
