...
@Component("batch_icemansort16")
@JobScope
public class IcemanSort16Detail {

	private List<IcemanSort16Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort16Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort16Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort16Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IcemanSort16Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort16Keys> sortComp) {
