...
public class IcemanSort2InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort2InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<IcemanSort2Keys> sortRecKeys = sortDetail.getSortRecKeys();
		IcemanSort2Keys relKey = new IcemanSort2Keys();
