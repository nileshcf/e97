  ...
  @Component("IcemanSort14SortOut")
  @JobScope
  public class IcemanSort14SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort14SortOut.class);
  	@Value("${IcemanSort14SortOut:CLOUDFRM.JPM.SORT.OUTPUT14}")
      ...
      @Value("#{'${IcemanSort14SortOutRecordType:${IcemanSort14SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort14SortOutRecordLen:${IcemanSort14SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort14SortOut Write: {}",e.getMessage()); 		
  		}
  	}
