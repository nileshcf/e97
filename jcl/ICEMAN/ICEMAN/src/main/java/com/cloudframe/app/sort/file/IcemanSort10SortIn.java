  ...
  @Component("IcemanSort10SortIn")
  @JobScope
  public class IcemanSort10SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort10SortIn.class);
  	@Value("${IcemanSort10SortIn:CLOUDFRM.JPM.SORT.INPUT10}")
  	...
  	@Value("#{'${IcemanSort10SortInRecordType:${IcemanSort10SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort10SortInRecordLen:${IcemanSort10SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort10SortIn Read: {}",e.getMessage()); 
  		}
  	}
