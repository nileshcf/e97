...
import com.cloudframe.app.sort.file.IcemanSort7SortOut;
...
import com.cloudframe.app.sort.IcemanSort7Detail;
import com.cloudframe.app.sort.file.IcemanSort7SortIn;
...
import com.cloudframe.app.sort.file.records.IcemanSort7Keys;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class IcemanSort7Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort7Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort7")
	IcemanSort7Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort7SortOut")
	IcemanSort7SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort7SortIn")
	IcemanSort7SortIn sortIn;
	...
	List<IcemanSort7Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT7 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort7Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort7Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort7Keys relKey = new IcemanSort7Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort7Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort7Keys> sortComp = sortDetail.getSortComp();
