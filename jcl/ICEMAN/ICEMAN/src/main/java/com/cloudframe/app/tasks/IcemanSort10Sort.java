...
import com.cloudframe.app.sort.file.IcemanSort10SortIn;
import org.springframework.batch.repeat.RepeatStatus;
import java.util.List;
import com.cloudframe.app.sort.file.IcemanSort10SortOut;
import com.cloudframe.app.sort.file.records.IcemanSort10Keys;
...
import com.cloudframe.app.sort.IcemanSort10Detail;
import org.springframework.batch.core.StepExecution;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class IcemanSort10Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort10Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort10")
	IcemanSort10Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort10SortOut")
	IcemanSort10SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort10SortIn")
	IcemanSort10SortIn sortIn;
	...
	List<IcemanSort10Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT10 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort10Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort10Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort10Keys relKey = new IcemanSort10Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort10Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort10Keys> sortComp = sortDetail.getSortComp();
