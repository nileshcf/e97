  ...
  @Component("IcemanSort13SortIn")
  @JobScope
  public class IcemanSort13SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort13SortIn.class);
  	@Value("${IcemanSort13SortIn:CLOUDFRM.JPM.SORT.INPUT13}")
  	...
  	@Value("#{'${IcemanSort13SortInRecordType:${IcemanSort13SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort13SortInRecordLen:${IcemanSort13SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort13SortIn Read: {}",e.getMessage()); 
  		}
  	}
