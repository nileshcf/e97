  ...
  @Component("IcemanSort1SortOut")
  @JobScope
  public class IcemanSort1SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort1SortOut.class);
  	@Value("${IcemanSort1SortOut:CLOUDFRM.JPM.SORT.OUTPUT1}")
      ...
      @Value("#{'${IcemanSort1SortOutRecordType:${IcemanSort1SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort1SortOutRecordLen:${IcemanSort1SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort1SortOut Write: {}",e.getMessage()); 		
  		}
  	}
