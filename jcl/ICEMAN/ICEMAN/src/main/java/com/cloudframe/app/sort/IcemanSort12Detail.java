...
@Component("batch_icemansort12")
@JobScope
public class IcemanSort12Detail {

	private List<IcemanSort12Keys> sortRecKeys = null;
	private Set<IcemanSort12Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort12Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort12Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort12Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort12Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort12Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort12Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort12Keys> sortComp) {
