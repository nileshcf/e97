...
public class IcemanSort9Processor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(IcemanSort9Processor.class);
