  ...
  @Component("IcemanSort4SortOut")
  @JobScope
  public class IcemanSort4SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort4SortOut.class);
  	@Value("${IcemanSort4SortOut:CLOUDFRM.JPM.SORT.OUTPUT4}")
      ...
      @Value("#{'${IcemanSort4SortOutRecordType:${IcemanSort4SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort4SortOutRecordLen:${IcemanSort4SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort4SortOut Write: {}",e.getMessage()); 		
  		}
  	}
