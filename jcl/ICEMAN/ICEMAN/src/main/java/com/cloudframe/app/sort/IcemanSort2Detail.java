...
@Component("batch_icemansort2")
@JobScope
public class IcemanSort2Detail {

	private List<IcemanSort2Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort2Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort2Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort2Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IcemanSort2Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort2Keys> sortComp) {
