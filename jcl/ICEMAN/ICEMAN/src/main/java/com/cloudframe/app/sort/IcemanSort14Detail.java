...
@Component("batch_icemansort14")
@JobScope
public class IcemanSort14Detail {

	private List<IcemanSort14Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort14Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort14Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort14Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<IcemanSort14Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort14Keys> sortComp) {
