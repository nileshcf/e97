  ...
  @Component("IcemanSort6SortIn")
  @JobScope
  public class IcemanSort6SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort6SortIn.class);
  	@Value("${IcemanSort6SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort6SortInRecordType:${IcemanSort6SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort6SortInRecordLen:${IcemanSort6SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort6SortIn Read: {}",e.getMessage()); 
  		}
  	}
