  ...
  @Component("IcemanSort15SortIn0")
  @JobScope
  public class IcemanSort15SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort15SortIn0.class);
  	@Value("${IcemanSort15SortIn[0]:CLOUDFRM.JPM.SORT.INPUT151}")
  	...
  	@Value("#{'${IcemanSort15SortIn0RecordType:${IcemanSort15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort15SortIn0RecordLen:${IcemanSort15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort15SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
