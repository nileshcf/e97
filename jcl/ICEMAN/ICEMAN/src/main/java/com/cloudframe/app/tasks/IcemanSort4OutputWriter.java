...
public class IcemanSort4OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(IcemanSort4OutputWriter.class);
	@Autowired
