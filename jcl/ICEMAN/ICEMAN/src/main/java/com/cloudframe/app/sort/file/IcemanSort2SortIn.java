  ...
  @Component("IcemanSort2SortIn")
  @JobScope
  public class IcemanSort2SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort2SortIn.class);
  	@Value("${IcemanSort2SortIn:CLOUDFRM.JPM.SORT.INPUT2}")
  	...
  	@Value("#{'${IcemanSort2SortInRecordType:${IcemanSort2SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort2SortInRecordLen:${IcemanSort2SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort2SortIn Read: {}",e.getMessage()); 
  		}
  	}
