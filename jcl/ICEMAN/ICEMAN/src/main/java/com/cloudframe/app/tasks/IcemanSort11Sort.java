...
import com.cloudframe.app.sort.file.records.IcemanSort11Keys;
...
import com.cloudframe.app.sort.file.IcemanSort11SortOut;
import org.springframework.batch.repeat.RepeatStatus;
import java.util.List;
import java.io.RandomAccessFile;
import com.cloudframe.app.sort.IcemanSort11Detail;
import org.springframework.beans.factory.InitializingBean;
import com.cloudframe.app.process.BaseProcess;
import com.cloudframe.app.sort.file.IcemanSort11SortIn;
...
public class IcemanSort11Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort11Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort11")
	IcemanSort11Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort11SortOut")
	IcemanSort11SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort11SortIn")
	IcemanSort11SortIn sortIn;
	...
	List<IcemanSort11Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT11 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort11Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort11Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort11Keys relKey = new IcemanSort11Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort11Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort11Keys> sortComp = sortDetail.getSortComp();
