  ...
  @Component("IcemanSort18SortOut")
  @JobScope
  public class IcemanSort18SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort18SortOut.class);
  	@Value("${IcemanSort18SortOut:CLOUDFRM.JPM.SORT.OUTPUT18}")
      ...
      @Value("#{'${IcemanSort18SortOutRecordType:${IcemanSort18SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort18SortOutRecordLen:${IcemanSort18SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort18SortOut Write: {}",e.getMessage()); 		
  		}
  	}
