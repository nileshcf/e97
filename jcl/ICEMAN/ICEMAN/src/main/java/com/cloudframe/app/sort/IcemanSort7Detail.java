...
@Component("batch_icemansort7")
@JobScope
public class IcemanSort7Detail {

	private List<IcemanSort7Keys> sortRecKeys = null;
	private Set<IcemanSort7Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort7Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort7Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort7Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort7Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort7Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort7Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort7Keys> sortComp) {
