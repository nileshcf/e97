...
@Component("batch_icemansort4")
@JobScope
public class IcemanSort4Detail {

	private List<IcemanSort4Keys> sortRecKeys = null;
	private Set<IcemanSort4Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort4Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort4Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort4Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort4Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort4Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort4Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort4Keys> sortComp) {
