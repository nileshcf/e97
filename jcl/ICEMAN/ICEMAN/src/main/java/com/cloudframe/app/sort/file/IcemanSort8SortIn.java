  ...
  @Component("IcemanSort8SortIn")
  @JobScope
  public class IcemanSort8SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort8SortIn.class);
  	@Value("${IcemanSort8SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort8SortInRecordType:${IcemanSort8SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort8SortInRecordLen:${IcemanSort8SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort8SortIn Read: {}",e.getMessage()); 
  		}
  	}
