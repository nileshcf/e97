  ...
  @Component("IcemanSort2SortOut")
  @JobScope
  public class IcemanSort2SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort2SortOut.class);
  	@Value("${IcemanSort2SortOut:CLOUDFRM.JPM.SORT.OUTPUT2}")
      ...
      @Value("#{'${IcemanSort2SortOutRecordType:${IcemanSort2SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort2SortOutRecordLen:${IcemanSort2SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort2SortOut Write: {}",e.getMessage()); 		
  		}
  	}
