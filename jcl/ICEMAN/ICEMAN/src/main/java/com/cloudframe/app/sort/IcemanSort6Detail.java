...
@Component("batch_icemansort6")
@JobScope
public class IcemanSort6Detail {

	private List<IcemanSort6Keys> sortRecKeys = null;
	private Set<IcemanSort6Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort6Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort6Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort6Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort6Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort6Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort6Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort6Keys> sortComp) {
