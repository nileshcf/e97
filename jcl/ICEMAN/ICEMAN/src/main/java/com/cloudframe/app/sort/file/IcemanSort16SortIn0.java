  ...
  @Component("IcemanSort16SortIn0")
  @JobScope
  public class IcemanSort16SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort16SortIn0.class);
  	@Value("${IcemanSort16SortIn[0]:CLOUDFRM.JPM.SORT.INPUT161}")
  	...
  	@Value("#{'${IcemanSort16SortIn0RecordType:${IcemanSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort16SortIn0RecordLen:${IcemanSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort16SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
