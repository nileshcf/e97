...
@Component("batch_icemansort15")
@JobScope
public class IcemanSort15Detail {

	private List<IcemanSort15Keys> sortRecKeys = null;
	private Set<IcemanSort15Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort15Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort15Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort15Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort15Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort15Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort15Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort15Keys> sortComp) {
