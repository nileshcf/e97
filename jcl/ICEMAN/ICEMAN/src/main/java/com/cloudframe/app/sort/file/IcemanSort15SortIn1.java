  ...
  @Component("IcemanSort15SortIn1")
  @JobScope
  public class IcemanSort15SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort15SortIn1.class);
  	@Value("${IcemanSort15SortIn[1]:CLOUDFRM.JPM.SORT.INPUT152}")
  	...
  	@Value("#{'${IcemanSort15SortIn1RecordType:${IcemanSort15SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort15SortIn1RecordLen:${IcemanSort15SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort15SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
