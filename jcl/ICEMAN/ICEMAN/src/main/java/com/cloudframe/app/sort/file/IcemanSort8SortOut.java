  ...
  @Component("IcemanSort8SortOut")
  @JobScope
  public class IcemanSort8SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort8SortOut.class);
  	@Value("${IcemanSort8SortOut:CLOUDFRM.JPM.SORT.OUTPUT8}")
      ...
      @Value("#{'${IcemanSort8SortOutRecordType:${IcemanSort8SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort8SortOutRecordLen:${IcemanSort8SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort8SortOut Write: {}",e.getMessage()); 		
  		}
  	}
