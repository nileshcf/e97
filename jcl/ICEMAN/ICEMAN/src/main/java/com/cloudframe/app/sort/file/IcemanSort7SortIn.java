  ...
  @Component("IcemanSort7SortIn")
  @JobScope
  public class IcemanSort7SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort7SortIn.class);
  	@Value("${IcemanSort7SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort7SortInRecordType:${IcemanSort7SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort7SortInRecordLen:${IcemanSort7SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort7SortIn Read: {}",e.getMessage()); 
  		}
  	}
