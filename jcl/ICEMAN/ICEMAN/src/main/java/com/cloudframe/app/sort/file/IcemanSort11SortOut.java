  ...
  @Component("IcemanSort11SortOut")
  @JobScope
  public class IcemanSort11SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort11SortOut.class);
  	@Value("${IcemanSort11SortOut:CLOUDFRM.JPM.SORT.OUTPUT11}")
      ...
      @Value("#{'${IcemanSort11SortOutRecordType:${IcemanSort11SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort11SortOutRecordLen:${IcemanSort11SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort11SortOut Write: {}",e.getMessage()); 		
  		}
  	}
