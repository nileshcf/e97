  ...
  @Component("IcemanSort10SortOut")
  @JobScope
  public class IcemanSort10SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort10SortOut.class);
  	@Value("${IcemanSort10SortOut:CLOUDFRM.JPM.SORT.OUTPUT10}")
      ...
      @Value("#{'${IcemanSort10SortOutRecordType:${IcemanSort10SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort10SortOutRecordLen:${IcemanSort10SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort10SortOut Write: {}",e.getMessage()); 		
  		}
  	}
