...
import com.cloudframe.app.sort.file.records.IcemanSort5Keys;
import com.cloudframe.app.process.BaseProcess;
import com.cloudframe.app.sort.IcemanSort5Detail;
import com.cloudframe.app.sort.file.IcemanSort5SortIn;
public class IcemanSort5InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort5InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<IcemanSort5Keys> sortRecKeys = sortDetail.getSortRecKeys();
		IcemanSort5Keys relKey = new IcemanSort5Keys();
