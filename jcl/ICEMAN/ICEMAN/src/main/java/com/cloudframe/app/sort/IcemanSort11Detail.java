...
@Component("batch_icemansort11")
@JobScope
public class IcemanSort11Detail {

	private List<IcemanSort11Keys> sortRecKeys = null;
	private Set<IcemanSort11Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort11Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort11Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort11Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort11Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort11Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort11Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort11Keys> sortComp) {
