...
import com.cloudframe.app.sort.file.IcemanSort12SortIn;
...
import com.cloudframe.app.sort.IcemanSort12Detail;
import org.springframework.batch.repeat.RepeatStatus;
import java.util.List;
import java.io.RandomAccessFile;
import com.cloudframe.app.sort.file.records.IcemanSort12Keys;
...
import com.cloudframe.app.sort.file.IcemanSort12SortOut;
import org.springframework.batch.core.StepExecution;
import org.slf4j.LoggerFactory;
import com.cloudframe.app.utility.SpringContextHandler;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
public class IcemanSort12Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort12Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort12")
	IcemanSort12Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort12SortOut")
	IcemanSort12SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort12SortIn")
	IcemanSort12SortIn sortIn;
	...
	List<IcemanSort12Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT12 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort12Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort12Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort12Keys relKey = new IcemanSort12Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort12Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort12Keys> sortComp = sortDetail.getSortComp();
