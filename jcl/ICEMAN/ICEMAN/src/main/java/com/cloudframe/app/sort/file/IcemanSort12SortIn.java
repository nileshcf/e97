  ...
  @Component("IcemanSort12SortIn")
  @JobScope
  public class IcemanSort12SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort12SortIn.class);
  	@Value("${IcemanSort12SortIn:CLOUDFRM.JPM.SORT.INPUT12}")
  	...
  	@Value("#{'${IcemanSort12SortInRecordType:${IcemanSort12SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort12SortInRecordLen:${IcemanSort12SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort12SortIn Read: {}",e.getMessage()); 
  		}
  	}
