...
import com.cloudframe.app.sort.IcemanSort18Detail;
...
import com.cloudframe.app.sort.file.IcemanSort18SortIn;
...
import com.cloudframe.app.sort.file.IcemanSort18SortOut;
...
public class IcemanSort18Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort18Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort18")
	IcemanSort18Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort18SortOut")
	IcemanSort18SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort18SortIn")
	IcemanSort18SortIn sortIn;
	...
	List<IcemanSort18Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT18 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort18Keys k = sortRecKeys.get(index);
...
setChangeBytes(record,recBytes,8,0/*caseId*/);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort18Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort18Keys relKey = new IcemanSort18Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort18Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort18Keys> sortComp = sortDetail.getSortComp();
