  ...
  @Component("IcemanSort16SortIn1")
  @JobScope
  public class IcemanSort16SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort16SortIn1.class);
  	@Value("${IcemanSort16SortIn[1]:CLOUDFRM.JPM.SORT.INPUT162}")
  	...
  	@Value("#{'${IcemanSort16SortIn1RecordType:${IcemanSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort16SortIn1RecordLen:${IcemanSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort16SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
