...
@Component("batch_icemansort19")
@JobScope
public class IcemanSort19Detail {

	private List<IcemanSort19Keys> sortRecKeys = null;
	private Set<IcemanSort19Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort19Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort19Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort19Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort19Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort19Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort19Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort19Keys> sortComp) {
