...
import com.cloudframe.app.sort.IcemanSort6Detail;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.IcemanSort6SortIn;
import com.cloudframe.app.sort.file.IcemanSort6SortOut;
...
import com.cloudframe.app.sort.file.records.IcemanSort6Keys;
import com.cloudframe.app.CFStepHandler;
public class IcemanSort6Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort6Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort6")
	IcemanSort6Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort6SortOut")
	IcemanSort6SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort6SortIn")
	IcemanSort6SortIn sortIn;
	...
	List<IcemanSort6Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT6 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort6Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort6Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort6Keys relKey = new IcemanSort6Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort6Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort6Keys> sortComp = sortDetail.getSortComp();
