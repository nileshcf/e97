  ...
  @Component("IcemanSort20SortIn")
  @JobScope
  public class IcemanSort20SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort20SortIn.class);
  	@Value("${IcemanSort20SortIn:CLOUDFRM.JPM.SORT.INPUT20}")
  	...
  	@Value("#{'${IcemanSort20SortInRecordType:${IcemanSort20SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort20SortInRecordLen:${IcemanSort20SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort20SortIn Read: {}",e.getMessage()); 
  		}
  	}
