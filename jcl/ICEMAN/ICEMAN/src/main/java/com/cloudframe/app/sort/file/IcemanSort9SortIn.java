  ...
  @Component("IcemanSort9SortIn")
  @JobScope
  public class IcemanSort9SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort9SortIn.class);
  	@Value("${IcemanSort9SortIn:CLOUDFRM.JPM.SORT.INPUT9}")
  	...
  	@Value("#{'${IcemanSort9SortInRecordType:${IcemanSort9SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort9SortInRecordLen:${IcemanSort9SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort9SortIn Read: {}",e.getMessage()); 
  		}
  	}
