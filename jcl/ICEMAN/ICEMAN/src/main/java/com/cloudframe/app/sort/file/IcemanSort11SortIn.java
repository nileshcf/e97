  ...
  @Component("IcemanSort11SortIn")
  @JobScope
  public class IcemanSort11SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort11SortIn.class);
  	@Value("${IcemanSort11SortIn:CLOUDFRM.JPM.SORT.INPUT11}")
  	...
  	@Value("#{'${IcemanSort11SortInRecordType:${IcemanSort11SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort11SortInRecordLen:${IcemanSort11SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort11SortIn Read: {}",e.getMessage()); 
  		}
  	}
