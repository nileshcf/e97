  ...
  @Component("IcemanSort9SortOut")
  @JobScope
  public class IcemanSort9SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort9SortOut.class);
  	@Value("${IcemanSort9SortOut:CLOUDFRM.JPM.SORT.OUTPUT9}")
      ...
      @Value("#{'${IcemanSort9SortOutRecordType:${IcemanSort9SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort9SortOutRecordLen:${IcemanSort9SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort9SortOut Write: {}",e.getMessage()); 		
  		}
  	}
