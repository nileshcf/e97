...
import com.cloudframe.app.sort.file.IcemanSort1SortIn;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import java.util.HashSet;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.IcemanSort1SortIn;
import com.cloudframe.app.sort.IcemanSort1Detail;
import com.cloudframe.app.sort.file.IcemanSort1SortOut;
...
import com.cloudframe.app.sort.file.records.IcemanSort1Keys;
public class IcemanSort1Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort1Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort1")
	IcemanSort1Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort1SortOut")
	IcemanSort1SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort1SortIn")
	IcemanSort1SortIn sortIn;
	...
	List<IcemanSort1Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT1 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort1Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort1Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort1Keys relKey = new IcemanSort1Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort1Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(IcemanSort1Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort1Keys> sortComp = sortDetail.getSortComp();
