...
@Component("batch_icemansort10")
@JobScope
public class IcemanSort10Detail {

	private List<IcemanSort10Keys> sortRecKeys = null;
	private Set<IcemanSort10Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort10Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort10Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort10Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort10Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort10Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort10Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort10Keys> sortComp) {
