  ...
  @Component("IcemanSort20SortOut")
  @JobScope
  public class IcemanSort20SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort20SortOut.class);
  	@Value("${IcemanSort20SortOut:CLOUDFRM.JPM.SORT.OUTPUT20}")
      ...
      @Value("#{'${IcemanSort20SortOutRecordType:${IcemanSort20SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort20SortOutRecordLen:${IcemanSort20SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort20SortOut Write: {}",e.getMessage()); 		
  		}
  	}
