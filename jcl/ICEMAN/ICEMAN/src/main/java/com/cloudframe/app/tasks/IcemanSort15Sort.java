...
import com.cloudframe.app.sort.file.IcemanSort15SortIn1;
import java.util.Set;
import org.springframework.batch.core.ExitStatus;
import com.cloudframe.app.sort.file.IcemanSort15SortOut;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import java.util.HashSet;
import com.cloudframe.app.sort.file.records.IcemanSort15Keys;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.IcemanSort15SortIn0;
import com.cloudframe.app.sort.IcemanSort15Detail;
import com.cloudframe.app.sort.file.IcemanSort15SortIn1;
...
public class IcemanSort15Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort15Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort15")
	IcemanSort15Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort15SortOut")
	IcemanSort15SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort15SortIn0")
	IcemanSort15SortIn0 sortIn0;
	
	@Autowired
	@Qualifier("IcemanSort15SortIn1")
	IcemanSort15SortIn1 sortIn1;
	...
	List<IcemanSort15Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT15 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort15Keys k = sortRecKeys.get(index);
           if (isWriteInTempFile()) {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		Set<IcemanSort15Keys> setRecKeys = sortDetail.getSortDistRecKeys();
		IcemanSort15Keys relKey = new IcemanSort15Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort15Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(IcemanSort15Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort15Keys> sortComp = sortDetail.getSortComp();
