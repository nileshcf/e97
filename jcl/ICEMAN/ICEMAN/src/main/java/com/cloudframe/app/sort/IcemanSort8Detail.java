...
@Component("batch_icemansort8")
@JobScope
public class IcemanSort8Detail {

	private List<IcemanSort8Keys> sortRecKeys = null;
	private Set<IcemanSort8Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort8Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort8Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort8Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort8Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort8Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort8Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort8Keys> sortComp) {
