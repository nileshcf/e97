  ...
  @Component("IcemanSort1SortIn")
  @JobScope
  public class IcemanSort1SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort1SortIn.class);
  	@Value("${IcemanSort1SortIn:CLOUDFRM.JPM.SORT.INPUT1}")
  	...
  	@Value("#{'${IcemanSort1SortInRecordType:${IcemanSort1SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort1SortInRecordLen:${IcemanSort1SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort1SortIn Read: {}",e.getMessage()); 
  		}
  	}
