  ...
  @Component("IcemanSort15SortOut")
  @JobScope
  public class IcemanSort15SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort15SortOut.class);
  	@Value("${IcemanSort15SortOut:CLOUDFRM.JPM.SORT.OUTPUT15}")
      ...
      @Value("#{'${IcemanSort15SortOutRecordType:${IcemanSort15SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort15SortOutRecordLen:${IcemanSort15SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort15SortOut Write: {}",e.getMessage()); 		
  		}
  	}
