  ...
  @Component("IcemanSort16SortIn2")
  @JobScope
  public class IcemanSort16SortIn2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort16SortIn2.class);
  	@Value("${IcemanSort16SortIn[2]:CLOUDFRM.JPM.SORT.INPUT163}")
  	...
  	@Value("#{'${IcemanSort16SortIn2RecordType:${IcemanSort16SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort16SortIn2RecordLen:${IcemanSort16SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort16SortIn2 Read: {}",e.getMessage()); 
  		}
  	}
