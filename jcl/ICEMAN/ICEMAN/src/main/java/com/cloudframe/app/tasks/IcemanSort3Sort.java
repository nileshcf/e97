...
import com.cloudframe.app.sort.file.IcemanSort3SortIn;
...
import com.cloudframe.app.sort.IcemanSort3Detail;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import com.cloudframe.app.sort.file.IcemanSort3SortOut;
...
import com.cloudframe.app.sort.file.records.IcemanSort3Keys;
import com.cloudframe.app.CFStepHandler;
public class IcemanSort3Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(IcemanSort3Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_icemansort3")
	IcemanSort3Detail sortDetail;
	
	@Autowired
	@Qualifier("IcemanSort3SortOut")
	IcemanSort3SortOut sortOut;
	

	
	@Autowired
	@Qualifier("IcemanSort3SortIn")
	IcemanSort3SortIn sortIn;
	...
	List<IcemanSort3Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: ICEMANSORT3 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			IcemanSort3Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<IcemanSort3Keys> sortRecKeys = sortDetail.getSortRecKeys();
		IcemanSort3Keys relKey = new IcemanSort3Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   IcemanSort3Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
                   .thenComparing(IcemanSort3Keys.getKeyCharacter2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<IcemanSort3Keys> sortComp = sortDetail.getSortComp();
