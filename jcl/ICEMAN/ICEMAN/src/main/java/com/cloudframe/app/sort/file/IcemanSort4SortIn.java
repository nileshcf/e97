  ...
  @Component("IcemanSort4SortIn")
  @JobScope
  public class IcemanSort4SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort4SortIn.class);
  	@Value("${IcemanSort4SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort4SortInRecordType:${IcemanSort4SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort4SortInRecordLen:${IcemanSort4SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort4SortIn Read: {}",e.getMessage()); 
  		}
  	}
