  ...
  @Component("IcemanSort14SortIn")
  @JobScope
  public class IcemanSort14SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort14SortIn.class);
  	@Value("${IcemanSort14SortIn:CLOUDFRM.JPM.SORT.INPUT}")
  	...
  	@Value("#{'${IcemanSort14SortInRecordType:${IcemanSort14SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${IcemanSort14SortInRecordLen:${IcemanSort14SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during IcemanSort14SortIn Read: {}",e.getMessage()); 
  		}
  	}
