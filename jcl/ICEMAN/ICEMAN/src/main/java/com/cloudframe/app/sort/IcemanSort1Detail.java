...
@Component("batch_icemansort1")
@JobScope
public class IcemanSort1Detail {

	private List<IcemanSort1Keys> sortRecKeys = null;
	private Set<IcemanSort1Keys> setRecKeys = null;

	protected Field field = new Field();
	private Comparator<IcemanSort1Keys> sortComp = null;
	 ...
	 */
	public List<IcemanSort1Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<IcemanSort1Keys> sortRecKeys) {
	 ...
	 * @return the sortRecKeys
	 */
	public Set<IcemanSort1Keys> getSortDistRecKeys() {
		return setRecKeys;
	}
	 ...
	 * @param sortRecKeys the sortRecKeys to set
	 */
	public void setSortDistRecKeys(Set<IcemanSort1Keys> sortRecKeys) {
		this.setRecKeys = sortRecKeys;
	}
	/**
	 * @return the sortComp
	 */
	public Comparator<IcemanSort1Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<IcemanSort1Keys> sortComp) {
