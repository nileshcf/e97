  ...
  @Component("IcemanSort13SortOut")
  @JobScope
  public class IcemanSort13SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(IcemanSort13SortOut.class);
  	@Value("${IcemanSort13SortOut:CLOUDFRM.JPM.SORT.OUTPUT13}")
      ...
      @Value("#{'${IcemanSort13SortOutRecordType:${IcemanSort13SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${IcemanSort13SortOutRecordLen:${IcemanSort13SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during IcemanSort13SortOut Write: {}",e.getMessage()); 		
  		}
  	}
