  ...
  @Component("SortvsamQsam2vsamSortIn")
  @JobScope
  public class SortvsamQsam2vsamSortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortvsamQsam2vsamSortIn.class);
  	@Value("${SortvsamQsam2vsamSortIn:CLOUDFRM.IDCAMS.MONITOR.INPUT}")
  	...
  	@Value("#{'${SortvsamQsam2vsamSortInRecordType:${SortvsamQsam2vsamSortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortvsamQsam2vsamSortInRecordLen:${SortvsamQsam2vsamSortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortvsamQsam2vsamSortIn Read: {}",e.getMessage()); 
  		}
  	}
