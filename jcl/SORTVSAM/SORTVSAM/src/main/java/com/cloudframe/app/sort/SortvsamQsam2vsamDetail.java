...
@Component("batch_sortvsamqsam2vsam")
@JobScope
public class SortvsamQsam2vsamDetail {

	private List<SortvsamQsam2vsamKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortvsamQsam2vsamKeys> sortComp = null;
	 ...
	 */
	public List<SortvsamQsam2vsamKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortvsamQsam2vsamKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SortvsamQsam2vsamKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortvsamQsam2vsamKeys> sortComp) {
