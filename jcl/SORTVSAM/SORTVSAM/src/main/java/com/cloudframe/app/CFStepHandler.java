...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String DELCLUSR = "delclusr";
    private static final String DEFCLUSR = "defclusr";
    private static final String QSAM2VSAM = "qsam2vsam";
    private static final String VSAM2QSAM = "vsam2qsam";
    private static final String IDCAMSOUT = "idcamsout";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "qsam2vsam":  /* setting the disp position for file(s) info for this step(QSAM2VSAM). */
                         SpringContextHandler.setFileDispPosition("SortvsamQsam2vsamSortIn","SortvsamQsam2vsamSortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortvsamQsam2vsamSortOut","SortvsamQsam2vsamSortOut.DISP");
            break;
            case "vsam2qsam":  /* setting the disp position for file(s) info for this step(VSAM2QSAM). */
                         SpringContextHandler.setFileDispPosition("SortvsamVsam2qsamSortIn","SortvsamVsam2qsamSortIn.DISP");
                         SpringContextHandler.setFileDispPosition("SortvsamVsam2qsamSortOut","SortvsamVsam2qsamSortOut.DISP");
            break;
            case "idcamsout":
 		    	   		SpringContextHandler.handleDispPostion("IDCAMSOUT.IDCAMS.Outdd","IDCAMSOUT.IDCAMS.Outdd.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORTVSAM ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORTVSAM ENDED -  ABEND={}", abendCode);
      } 
