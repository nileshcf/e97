  ...
  @Component("SortvsamVsam2qsamSortOut")
  @JobScope
  public class SortvsamVsam2qsamSortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortvsamVsam2qsamSortOut.class);
  	@Value("${SortvsamVsam2qsamSortOut:CLOUDFRM.SORT.MONITOR.OUTPUT}")
      ...
      @Value("#{'${SortvsamVsam2qsamSortOutRecordType:${SortvsamVsam2qsamSortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortvsamVsam2qsamSortOutRecordLen:${SortvsamVsam2qsamSortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortvsamVsam2qsamSortOut Write: {}",e.getMessage()); 		
  		}
  	}
