...
public class SortvsamVsam2qsamProcessor extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(SortvsamVsam2qsamProcessor.class);
