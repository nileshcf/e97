...
public class SortvsamQsam2vsamInputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortvsamQsam2vsamInputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<SortvsamQsam2vsamKeys> sortRecKeys = sortDetail.getSortRecKeys();
		SortvsamQsam2vsamKeys relKey = new SortvsamQsam2vsamKeys();
