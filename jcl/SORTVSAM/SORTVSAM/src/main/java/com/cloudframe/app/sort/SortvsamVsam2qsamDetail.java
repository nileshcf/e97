...
@Component("batch_sortvsamvsam2qsam")
@JobScope
public class SortvsamVsam2qsamDetail {

	private List<SortvsamVsam2qsamKeys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<SortvsamVsam2qsamKeys> sortComp = null;
	 ...
	 */
	public List<SortvsamVsam2qsamKeys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<SortvsamVsam2qsamKeys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<SortvsamVsam2qsamKeys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<SortvsamVsam2qsamKeys> sortComp) {
