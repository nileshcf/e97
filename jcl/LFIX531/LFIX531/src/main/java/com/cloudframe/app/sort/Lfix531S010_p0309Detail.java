...
@Component("batch_lfix531s010_p0309")
@JobScope
public class Lfix531S010_p0309Detail {

	private List<Lfix531S010_p0309Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Lfix531S010_p0309Keys> sortComp = null;
	 ...
	 */
	public List<Lfix531S010_p0309Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Lfix531S010_p0309Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Lfix531S010_p0309Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Lfix531S010_p0309Keys> sortComp) {
