  ...
  @Component("Lfix531S010_p0309SortIn5")
  @JobScope
  public class Lfix531S010_p0309SortIn5 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortIn5.class);
  	@Value("${Lfix531S010_p0309SortIn[5]:Y900.P.TM.Y90DCABR.SORTBA4}")
  	...
  	@Value("#{'${Lfix531S010_p0309SortIn5RecordType:${Lfix531S010_p0309SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Lfix531S010_p0309SortIn5RecordLen:${Lfix531S010_p0309SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortIn5 Read: {}",e.getMessage()); 
  		}
  	}
