...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String S010_P0309 = "s010_p0309";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "s010_p0309":  /* setting the disp position for file(s) info for this step(S010_P0309). */
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn0","Lfix531S010_p0309SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn1","Lfix531S010_p0309SortIn[1].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn2","Lfix531S010_p0309SortIn[2].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn3","Lfix531S010_p0309SortIn[3].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn4","Lfix531S010_p0309SortIn[4].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn5","Lfix531S010_p0309SortIn[5].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortIn6","Lfix531S010_p0309SortIn[6].DISP");
                         SpringContextHandler.setFileDispPosition("Lfix531S010_p0309SortOut","Lfix531S010_p0309SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : LFIX531 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : LFIX531 ENDED -  ABEND={}", abendCode);
      } 
