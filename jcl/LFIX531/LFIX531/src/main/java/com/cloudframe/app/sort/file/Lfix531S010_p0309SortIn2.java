  ...
  @Component("Lfix531S010_p0309SortIn2")
  @JobScope
  public class Lfix531S010_p0309SortIn2 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortIn2.class);
  	@Value("${Lfix531S010_p0309SortIn[2]:Y900.P.TM.Y90DCABR.SORTBA1}")
  	...
  	@Value("#{'${Lfix531S010_p0309SortIn2RecordType:${Lfix531S010_p0309SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Lfix531S010_p0309SortIn2RecordLen:${Lfix531S010_p0309SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortIn2 Read: {}",e.getMessage()); 
  		}
  	}
