  ...
  @Component("Lfix531S010_p0309SortIn6")
  @JobScope
  public class Lfix531S010_p0309SortIn6 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortIn6.class);
  	@Value("${Lfix531S010_p0309SortIn[6]:Y900.P.TM.Y90DCABR.SORTITM}")
  	...
  	@Value("#{'${Lfix531S010_p0309SortIn6RecordType:${Lfix531S010_p0309SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Lfix531S010_p0309SortIn6RecordLen:${Lfix531S010_p0309SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortIn6 Read: {}",e.getMessage()); 
  		}
  	}
