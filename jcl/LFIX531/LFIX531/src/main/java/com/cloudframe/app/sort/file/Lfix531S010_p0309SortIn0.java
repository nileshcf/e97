  ...
  @Component("Lfix531S010_p0309SortIn0")
  @JobScope
  public class Lfix531S010_p0309SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortIn0.class);
  	@Value("${Lfix531S010_p0309SortIn[0]:Y900.P.TM.Y90DCABR.SORTAK1}")
  	...
  	@Value("#{'${Lfix531S010_p0309SortIn0RecordType:${Lfix531S010_p0309SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Lfix531S010_p0309SortIn0RecordLen:${Lfix531S010_p0309SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
