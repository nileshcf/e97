  ...
  @Component("Lfix531S010_p0309SortOut")
  @JobScope
  public class Lfix531S010_p0309SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortOut.class);
  	@Value("${Lfix531S010_p0309SortOut:Y900.P.TM.Y90DCABR.SBRTSALL}")
      ...
      @Value("#{'${Lfix531S010_p0309SortOutRecordType:${Lfix531S010_p0309SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Lfix531S010_p0309SortOutRecordLen:${Lfix531S010_p0309SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortOut Write: {}",e.getMessage()); 		
  		}
  	}
