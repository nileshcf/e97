  ...
  @Component("Lfix531S010_p0309SortIn3")
  @JobScope
  public class Lfix531S010_p0309SortIn3 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortIn3.class);
  	@Value("${Lfix531S010_p0309SortIn[3]:Y900.P.TM.Y90DCABR.SORTBA2}")
  	...
  	@Value("#{'${Lfix531S010_p0309SortIn3RecordType:${Lfix531S010_p0309SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Lfix531S010_p0309SortIn3RecordLen:${Lfix531S010_p0309SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortIn3 Read: {}",e.getMessage()); 
  		}
  	}
