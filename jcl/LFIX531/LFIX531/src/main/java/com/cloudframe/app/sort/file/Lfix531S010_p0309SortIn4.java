  ...
  @Component("Lfix531S010_p0309SortIn4")
  @JobScope
  public class Lfix531S010_p0309SortIn4 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Lfix531S010_p0309SortIn4.class);
  	@Value("${Lfix531S010_p0309SortIn[4]:Y900.P.TM.Y90DCABR.SORTBA3}")
  	...
  	@Value("#{'${Lfix531S010_p0309SortIn4RecordType:${Lfix531S010_p0309SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Lfix531S010_p0309SortIn4RecordLen:${Lfix531S010_p0309SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Lfix531S010_p0309SortIn4 Read: {}",e.getMessage()); 
  		}
  	}
