...
import com.cloudframe.app.sort.Y91dext2S030_p080Detail;
import org.springframework.beans.factory.annotation.Value;
public class Y91dext2S030_p080Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(Y91dext2S030_p080Sort.class);
