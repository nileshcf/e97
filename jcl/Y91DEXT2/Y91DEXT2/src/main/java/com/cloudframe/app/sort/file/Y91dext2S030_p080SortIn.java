  ...
  @Component("Y91dext2S030_p080SortIn")
  @JobScope
  public class Y91dext2S030_p080SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Y91dext2S030_p080SortIn.class);
  	@Value("${Y91dext2S030_p080SortIn:Y910.P.ATM.BACKUP.TLFDUP1(+0)}")
  	...
  	@Value("#{'${Y91dext2S030_p080SortInRecordType:${Y91dext2S030_p080SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Y91dext2S030_p080SortInRecordLen:${Y91dext2S030_p080SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Y91dext2S030_p080SortIn Read: {}",e.getMessage()); 
  		}
  	}
