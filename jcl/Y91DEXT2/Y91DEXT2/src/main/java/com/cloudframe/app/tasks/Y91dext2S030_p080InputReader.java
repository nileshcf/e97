...
public class Y91dext2S030_p080InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Y91dext2S030_p080InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Y91dext2S030_p080Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Y91dext2S030_p080Keys relKey = new Y91dext2S030_p080Keys();
