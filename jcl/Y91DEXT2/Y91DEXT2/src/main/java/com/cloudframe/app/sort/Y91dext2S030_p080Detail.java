...
@Component("batch_y91dext2s030_p080")
@JobScope
public class Y91dext2S030_p080Detail {

	private List<Y91dext2S030_p080Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<Y91dext2S030_p080Keys> sortComp = null;
	 ...
	 */
	public List<Y91dext2S030_p080Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<Y91dext2S030_p080Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<Y91dext2S030_p080Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<Y91dext2S030_p080Keys> sortComp) {
