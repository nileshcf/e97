...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String S030_P070 = "s030_p070";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "s030_p070":
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup1in","S030_P070.IDCAMS.Dup1in.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup1ot","S030_P070.IDCAMS.Dup1ot.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup2in","S030_P070.IDCAMS.Dup2in.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup2ot","S030_P070.IDCAMS.Dup2ot.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup3in","S030_P070.IDCAMS.Dup3in.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup3ot","S030_P070.IDCAMS.Dup3ot.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup4in","S030_P070.IDCAMS.Dup4in.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Dup4ot","S030_P070.IDCAMS.Dup4ot.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Holdin[1]","S030_P070.IDCAMS.Holdin.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Holdin[2]","S030_P070.IDCAMS.Holdin.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Holdin[3]","S030_P070.IDCAMS.Holdin.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Holdin[4]","S030_P070.IDCAMS.Holdin.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Holdin[5]","S030_P070.IDCAMS.Holdin.DISP");
 		    	   		SpringContextHandler.handleDispPostion("S030_P070.IDCAMS.Holdot","S030_P070.IDCAMS.Holdot.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : LFIX454 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : LFIX454 ENDED -  ABEND={}", abendCode);
      } 
