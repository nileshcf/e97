  ...
  @Component("SortzdcompPrip7001_step030SortOut")
  @JobScope
  public class SortzdcompPrip7001_step030SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortzdcompPrip7001_step030SortOut.class);
  	@Value("${SortzdcompPrip7001_step030SortOut:MCI.IP.P2BX.TABLE130.SORTED.MPS}")
      ...
      @Value("#{'${SortzdcompPrip7001_step030SortOutRecordType:${SortzdcompPrip7001_step030SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${SortzdcompPrip7001_step030SortOutRecordLen:${SortzdcompPrip7001_step030SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during SortzdcompPrip7001_step030SortOut Write: {}",e.getMessage()); 		
  		}
  	}
