  ...
  @Component("SortzdcompPrip7001_step030SortIn")
  @JobScope
  public class SortzdcompPrip7001_step030SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(SortzdcompPrip7001_step030SortIn.class);
  	@Value("${SortzdcompPrip7001_step030SortIn:MCI.IP.P2BX.TABLE130.UNLOAD.MPS}")
  	...
  	@Value("#{'${SortzdcompPrip7001_step030SortInRecordType:${SortzdcompPrip7001_step030SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${SortzdcompPrip7001_step030SortInRecordLen:${SortzdcompPrip7001_step030SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during SortzdcompPrip7001_step030SortIn Read: {}",e.getMessage()); 
  		}
  	}
