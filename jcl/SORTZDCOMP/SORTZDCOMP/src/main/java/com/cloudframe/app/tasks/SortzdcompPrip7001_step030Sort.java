...
public class SortzdcompPrip7001_step030Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(SortzdcompPrip7001_step030Sort.class);
	@Autowired
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_POS1 = 19;
	static final int KEY_POS2 = 65;
	static final int KEY_POS3 = 38;
	static final int KEY_LEN0 = 19;
	static final int KEY_LEN1 = 19;
...
logger.info("STEPNAME: SORTZDCOMPPRIP7001_STEP030 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		...
		SortzdcompPrip7001_step030Keys relKey = new SortzdcompPrip7001_step030Keys();
        ...
        relKey.setKeyBinary3(getRecordKeyBytes(recordByte, KEY_POS2 , KEY_LEN2)); 
