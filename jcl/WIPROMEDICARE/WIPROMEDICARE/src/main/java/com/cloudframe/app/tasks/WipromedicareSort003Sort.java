...
import com.cloudframe.app.sort.file.WipromedicareSort003SortIn;
import org.springframework.batch.core.ExitStatus;
import org.springframework.beans.factory.annotation.Value;
import java.io.File;
import com.cloudframe.app.sort.WipromedicareSort003Detail;
import java.util.stream.Collectors;
import com.cloudframe.app.sort.file.WipromedicareSort003SortIn;
import com.cloudframe.app.sort.file.records.WipromedicareSort003Keys;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;

import org.springframework.batch.repeat.RepeatStatus;
import java.util.List;
import com.cloudframe.app.sort.file.WipromedicareSort003SortOut;
...
public class WipromedicareSort003Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort003Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_wipromedicaresort003")
	WipromedicareSort003Detail sortDetail;
	
	@Autowired
	@Qualifier("WipromedicareSort003SortOut")
	WipromedicareSort003SortOut sortOut;
	

	
	@Autowired
	@Qualifier("WipromedicareSort003SortIn")
	WipromedicareSort003SortIn sortIn;
	...
	List<WipromedicareSort003Keys> sortRecKeys = null;
/**
...
public void afterPropertiesSet() throws Exception {
	...
	static final int KEY_POS1 = 60;
	static final int KEY_LEN0 = 1;
	static final int KEY_LEN1 = 2;
	@Override
...
logger.info("STEPNAME: WIPROMEDICARESORT003 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			WipromedicareSort003Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<WipromedicareSort003Keys> sortRecKeys = sortDetail.getSortRecKeys();
		WipromedicareSort003Keys relKey = new WipromedicareSort003Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   WipromedicareSort003Keys.getKeyBinary1Comparator(true/*isAscending*/)               
                   .thenComparing(WipromedicareSort003Keys.getKeyBinary2Comparator(true/*isAscending*/))               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<WipromedicareSort003Keys> sortComp = sortDetail.getSortComp();
