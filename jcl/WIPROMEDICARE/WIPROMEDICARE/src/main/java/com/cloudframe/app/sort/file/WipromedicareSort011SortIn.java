  ...
  @Component("WipromedicareSort011SortIn")
  @JobScope
  public class WipromedicareSort011SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort011SortIn.class);
  	@Value("${WipromedicareSort011SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN011}")
  	...
  	@Value("#{'${WipromedicareSort011SortInRecordType:${WipromedicareSort011SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort011SortInRecordLen:${WipromedicareSort011SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort011SortIn Read: {}",e.getMessage()); 
  		}
  	}
