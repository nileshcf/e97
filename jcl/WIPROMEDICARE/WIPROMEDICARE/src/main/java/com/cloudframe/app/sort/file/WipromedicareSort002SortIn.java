  ...
  @Component("WipromedicareSort002SortIn")
  @JobScope
  public class WipromedicareSort002SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort002SortIn.class);
  	@Value("${WipromedicareSort002SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN002}")
  	...
  	@Value("#{'${WipromedicareSort002SortInRecordType:${WipromedicareSort002SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort002SortInRecordLen:${WipromedicareSort002SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort002SortIn Read: {}",e.getMessage()); 
  		}
  	}
