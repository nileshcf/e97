  ...
  @Component("WipromedicareSort007SortOut")
  @JobScope
  public class WipromedicareSort007SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort007SortOut.class);
  	@Value("${WipromedicareSort007SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort007SortOutRecordType:${WipromedicareSort007SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort007SortOutRecordLen:${WipromedicareSort007SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort007SortOut Write: {}",e.getMessage()); 		
  		}
  	}
