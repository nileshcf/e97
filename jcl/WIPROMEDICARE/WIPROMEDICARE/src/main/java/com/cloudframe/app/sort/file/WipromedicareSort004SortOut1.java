  ...
  @Component("WipromedicareSort004SortOut1")
  @JobScope
  public class WipromedicareSort004SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort004SortOut1.class);
  	@Value("${WipromedicareSort004SortOut[1]:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort004SortOut1RecordType:${WipromedicareSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort004SortOut1RecordLen:${WipromedicareSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort004SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
