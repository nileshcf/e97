  ...
  @Component("WipromedicareSort008SortOut")
  @JobScope
  public class WipromedicareSort008SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort008SortOut.class);
  	@Value("${WipromedicareSort008SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort008SortOutRecordType:${WipromedicareSort008SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort008SortOutRecordLen:${WipromedicareSort008SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort008SortOut Write: {}",e.getMessage()); 		
  		}
  	}
