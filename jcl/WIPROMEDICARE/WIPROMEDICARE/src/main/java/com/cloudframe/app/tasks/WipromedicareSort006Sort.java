...
import com.cloudframe.app.sort.WipromedicareSort006Detail;
import org.springframework.beans.factory.annotation.Value;
public class WipromedicareSort006Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {

	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort006Sort.class);
