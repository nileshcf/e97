...
@Component("batch_wipromedicaresort009")
@JobScope
public class WipromedicareSort009Detail {

	private List<WipromedicareSort009Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort009Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort009Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort009Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort009Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort009Keys> sortComp) {
