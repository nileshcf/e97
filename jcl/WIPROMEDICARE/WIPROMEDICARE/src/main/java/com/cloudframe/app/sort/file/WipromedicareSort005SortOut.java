  ...
  @Component("WipromedicareSort005SortOut")
  @JobScope
  public class WipromedicareSort005SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort005SortOut.class);
  	@Value("${WipromedicareSort005SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort005SortOutRecordType:${WipromedicareSort005SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort005SortOutRecordLen:${WipromedicareSort005SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort005SortOut Write: {}",e.getMessage()); 		
  		}
  	}
