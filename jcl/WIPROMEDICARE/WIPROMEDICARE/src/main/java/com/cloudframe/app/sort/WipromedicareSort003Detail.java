...
@Component("batch_wipromedicaresort003")
@JobScope
public class WipromedicareSort003Detail {

	private List<WipromedicareSort003Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort003Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort003Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort003Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort003Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort003Keys> sortComp) {
