...
public class WipromedicareSort007OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort007OutputWriter.class);
	@Autowired
