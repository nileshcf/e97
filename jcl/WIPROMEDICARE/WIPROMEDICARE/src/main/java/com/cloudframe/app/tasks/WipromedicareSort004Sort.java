...
public class WipromedicareSort004Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort004Sort.class);
	@Autowired
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<WipromedicareSort004Keys> sortRecKeys = sortDetail.getSortRecKeys();
		WipromedicareSort004Keys relKey = new WipromedicareSort004Keys();
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   WipromedicareSort004Keys.getKeyBinary1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<WipromedicareSort004Keys> sortComp = sortDetail.getSortComp();
