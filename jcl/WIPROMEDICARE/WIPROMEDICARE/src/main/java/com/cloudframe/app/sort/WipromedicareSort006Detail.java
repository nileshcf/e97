...
@Component("batch_wipromedicaresort006")
@JobScope
public class WipromedicareSort006Detail {

	private List<WipromedicareSort006Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort006Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort006Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort006Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort006Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort006Keys> sortComp) {
