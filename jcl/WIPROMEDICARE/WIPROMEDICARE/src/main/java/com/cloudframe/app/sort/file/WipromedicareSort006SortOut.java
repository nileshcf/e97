  ...
  @Component("WipromedicareSort006SortOut")
  @JobScope
  public class WipromedicareSort006SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort006SortOut.class);
  	@Value("${WipromedicareSort006SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort006SortOutRecordType:${WipromedicareSort006SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort006SortOutRecordLen:${WipromedicareSort006SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort006SortOut Write: {}",e.getMessage()); 		
  		}
  	}
