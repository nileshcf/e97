  ...
  @Component("WipromedicareSort008SortIn")
  @JobScope
  public class WipromedicareSort008SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort008SortIn.class);
  	@Value("${WipromedicareSort008SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN008}")
  	...
  	@Value("#{'${WipromedicareSort008SortInRecordType:${WipromedicareSort008SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort008SortInRecordLen:${WipromedicareSort008SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort008SortIn Read: {}",e.getMessage()); 
  		}
  	}
