  ...
  @Component("WipromedicareSort003SortIn")
  @JobScope
  public class WipromedicareSort003SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort003SortIn.class);
  	@Value("${WipromedicareSort003SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN003}")
  	...
  	@Value("#{'${WipromedicareSort003SortInRecordType:${WipromedicareSort003SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort003SortInRecordLen:${WipromedicareSort003SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort003SortIn Read: {}",e.getMessage()); 
  		}
  	}
