...
@Component("batch_wipromedicaresort011")
@JobScope
public class WipromedicareSort011Detail {

	private List<WipromedicareSort011Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort011Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort011Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort011Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort011Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort011Keys> sortComp) {
