  ...
  @Component("WipromedicareSort001SortOut")
  @JobScope
  public class WipromedicareSort001SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort001SortOut.class);
  	@Value("${WipromedicareSort001SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort001SortOutRecordType:${WipromedicareSort001SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort001SortOutRecordLen:${WipromedicareSort001SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort001SortOut Write: {}",e.getMessage()); 		
  		}
  	}
