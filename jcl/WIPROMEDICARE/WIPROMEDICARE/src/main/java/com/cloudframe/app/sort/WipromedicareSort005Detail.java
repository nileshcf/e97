...
@Component("batch_wipromedicaresort005")
@JobScope
public class WipromedicareSort005Detail {

	private List<WipromedicareSort005Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort005Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort005Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort005Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort005Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort005Keys> sortComp) {
