...
public class WipromedicareSort008InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort008InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<WipromedicareSort008Keys> sortRecKeys = sortDetail.getSortRecKeys();
		WipromedicareSort008Keys relKey = new WipromedicareSort008Keys();
