  ...
  @Component("WipromedicareSort009SortOut")
  @JobScope
  public class WipromedicareSort009SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort009SortOut.class);
  	@Value("${WipromedicareSort009SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort009SortOutRecordType:${WipromedicareSort009SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort009SortOutRecordLen:${WipromedicareSort009SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort009SortOut Write: {}",e.getMessage()); 		
  		}
  	}
