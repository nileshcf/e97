  ...
  @Component("WipromedicareSort006SortIn")
  @JobScope
  public class WipromedicareSort006SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort006SortIn.class);
  	@Value("${WipromedicareSort006SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN006}")
  	...
  	@Value("#{'${WipromedicareSort006SortInRecordType:${WipromedicareSort006SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort006SortInRecordLen:${WipromedicareSort006SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort006SortIn Read: {}",e.getMessage()); 
  		}
  	}
