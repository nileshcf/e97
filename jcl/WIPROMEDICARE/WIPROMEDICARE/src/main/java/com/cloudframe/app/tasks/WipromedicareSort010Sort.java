...
import com.cloudframe.app.sort.file.WipromedicareSort010SortOut;
...
import com.cloudframe.app.sort.file.WipromedicareSort010SortIn;
import com.cloudframe.app.sort.file.records.WipromedicareSort010Keys;
import java.util.Comparator;
import org.springframework.batch.core.step.tasklet.Tasklet;
import com.cloudframe.app.sort.WipromedicareSort010Detail;
...
public class WipromedicareSort010Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort010Sort.class);
	@Autowired
	CFStepHandler cfStepHandler;

	@Autowired
	@Qualifier("batch_wipromedicaresort010")
	WipromedicareSort010Detail sortDetail;
	
	@Autowired
	@Qualifier("WipromedicareSort010SortOut")
	WipromedicareSort010SortOut sortOut;
	

	
	@Autowired
	@Qualifier("WipromedicareSort010SortIn")
	WipromedicareSort010SortIn sortIn;
	...
	List<WipromedicareSort010Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: WIPROMEDICARESORT010 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			WipromedicareSort010Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<WipromedicareSort010Keys> sortRecKeys = sortDetail.getSortRecKeys();
		WipromedicareSort010Keys relKey = new WipromedicareSort010Keys();
   ...
   private byte[] getAltSeqRecordBytes(byte[] record) {
	...
	public void sortProcessor() throws Exception {
		...
		sortDetail.setSortComp(
                   WipromedicareSort010Keys.getKeyCharacter1Comparator(true/*isAscending*/)               
		);
	  doSort();
    }	
	public void doSort() throws Exception {
		// Sort algorithm here
		Comparator<WipromedicareSort010Keys> sortComp = sortDetail.getSortComp();
