...
import com.cloudframe.app.sort.file.WipromedicareSort011SortIn;
import org.springframework.batch.core.StepContribution;
import org.springframework.batch.core.scope.context.ChunkContext;
import com.cloudframe.app.sort.file.WipromedicareSort011SortOut;
...
public class WipromedicareSort011Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort011Sort.class);
	@Autowired
	...
	@Autowired
	@Qualifier("WipromedicareSort011SortOut")
	WipromedicareSort011SortOut sortOut;
	

	
	@Autowired
	@Qualifier("WipromedicareSort011SortIn")
	WipromedicareSort011SortIn sortIn;
	...
	List<WipromedicareSort011Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: WIPROMEDICARESORT011 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			WipromedicareSort011Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		...
		WipromedicareSort011Keys relKey = new WipromedicareSort011Keys();
