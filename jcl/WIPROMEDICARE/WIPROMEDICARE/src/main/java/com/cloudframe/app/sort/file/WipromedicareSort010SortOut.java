  ...
  @Component("WipromedicareSort010SortOut")
  @JobScope
  public class WipromedicareSort010SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort010SortOut.class);
  	@Value("${WipromedicareSort010SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort010SortOutRecordType:${WipromedicareSort010SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort010SortOutRecordLen:${WipromedicareSort010SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort010SortOut Write: {}",e.getMessage()); 		
  		}
  	}
