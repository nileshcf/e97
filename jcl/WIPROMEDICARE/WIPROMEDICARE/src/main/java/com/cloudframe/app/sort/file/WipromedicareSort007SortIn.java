  ...
  @Component("WipromedicareSort007SortIn")
  @JobScope
  public class WipromedicareSort007SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort007SortIn.class);
  	@Value("${WipromedicareSort007SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN007}")
  	...
  	@Value("#{'${WipromedicareSort007SortInRecordType:${WipromedicareSort007SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort007SortInRecordLen:${WipromedicareSort007SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort007SortIn Read: {}",e.getMessage()); 
  		}
  	}
