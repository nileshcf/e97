  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort001":  /* setting the disp position for file(s) info for this step(SORT001). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort001SortIn","WipromedicareSort001SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort001SortOut","WipromedicareSort001SortOut.DISP");
            break;
            case "sort002":  /* setting the disp position for file(s) info for this step(SORT002). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort002SortIn","WipromedicareSort002SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort002SortOut0","WipromedicareSort002SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort002SortOut1","WipromedicareSort002SortOut[1].DISP");
            break;
            case "sort003":  /* setting the disp position for file(s) info for this step(SORT003). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort003SortIn","WipromedicareSort003SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort003SortOut","WipromedicareSort003SortOut.DISP");
            break;
            case "sort004":  /* setting the disp position for file(s) info for this step(SORT004). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort004SortIn","WipromedicareSort004SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort004SortOut0","WipromedicareSort004SortOut[0].DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort004SortOut1","WipromedicareSort004SortOut[1].DISP");
            break;
            case "sort005":  /* setting the disp position for file(s) info for this step(SORT005). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort005SortIn","WipromedicareSort005SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort005SortOut","WipromedicareSort005SortOut.DISP");
            break;
            case "sort006":  /* setting the disp position for file(s) info for this step(SORT006). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort006SortIn","WipromedicareSort006SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort006SortOut","WipromedicareSort006SortOut.DISP");
            break;
            case "sort007":  /* setting the disp position for file(s) info for this step(SORT007). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort007SortIn","WipromedicareSort007SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort007SortOut","WipromedicareSort007SortOut.DISP");
            break;
            case "sort008":  /* setting the disp position for file(s) info for this step(SORT008). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort008SortIn","WipromedicareSort008SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort008SortOut","WipromedicareSort008SortOut.DISP");
            break;
            case "sort009":  /* setting the disp position for file(s) info for this step(SORT009). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort009SortIn","WipromedicareSort009SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort009SortOut","WipromedicareSort009SortOut.DISP");
            break;
            case "sort010":  /* setting the disp position for file(s) info for this step(SORT010). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort010SortIn","WipromedicareSort010SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort010SortOut","WipromedicareSort010SortOut.DISP");
            break;
            case "sort011":  /* setting the disp position for file(s) info for this step(SORT011). */
                         SpringContextHandler.setFileDispPosition("WipromedicareSort011SortIn","WipromedicareSort011SortIn.DISP");
                         SpringContextHandler.setFileDispPosition("WipromedicareSort011SortOut","WipromedicareSort011SortOut.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : WIPROMEDICARE ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : WIPROMEDICARE ENDED -  ABEND={}", abendCode);
      } 
