  ...
  @Component("WipromedicareSort010SortIn")
  @JobScope
  public class WipromedicareSort010SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort010SortIn.class);
  	@Value("${WipromedicareSort010SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT009}")
  	...
  	@Value("#{'${WipromedicareSort010SortInRecordType:${WipromedicareSort010SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort010SortInRecordLen:${WipromedicareSort010SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort010SortIn Read: {}",e.getMessage()); 
  		}
  	}
