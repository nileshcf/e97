...
@Component("batch_wipromedicaresort010")
@JobScope
public class WipromedicareSort010Detail {

	private List<WipromedicareSort010Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort010Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort010Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort010Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort010Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort010Keys> sortComp) {
