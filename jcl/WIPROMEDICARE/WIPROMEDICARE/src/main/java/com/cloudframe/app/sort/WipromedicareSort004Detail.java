...
@Component("batch_wipromedicaresort004")
@JobScope
public class WipromedicareSort004Detail {

	private List<WipromedicareSort004Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort004Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort004Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort004Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort004Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort004Keys> sortComp) {
