  ...
  @Component("WipromedicareSort002SortOut0")
  @JobScope
  public class WipromedicareSort002SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort002SortOut0.class);
  	@Value("${WipromedicareSort002SortOut[0]:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort002SortOut0RecordType:${WipromedicareSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort002SortOut0RecordLen:${WipromedicareSort002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort002SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
