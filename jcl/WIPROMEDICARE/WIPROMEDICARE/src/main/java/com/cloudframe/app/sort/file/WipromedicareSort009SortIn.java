  ...
  @Component("WipromedicareSort009SortIn")
  @JobScope
  public class WipromedicareSort009SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort009SortIn.class);
  	@Value("${WipromedicareSort009SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN009}")
  	...
  	@Value("#{'${WipromedicareSort009SortInRecordType:${WipromedicareSort009SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort009SortInRecordLen:${WipromedicareSort009SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort009SortIn Read: {}",e.getMessage()); 
  		}
  	}
