  ...
  @Component("WipromedicareSort004SortOut0")
  @JobScope
  public class WipromedicareSort004SortOut0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort004SortOut0.class);
  	@Value("${WipromedicareSort004SortOut[0]:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort004SortOut0RecordType:${WipromedicareSort004SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort004SortOut0RecordLen:${WipromedicareSort004SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort004SortOut0 Write: {}",e.getMessage()); 		
  		}
  	}
