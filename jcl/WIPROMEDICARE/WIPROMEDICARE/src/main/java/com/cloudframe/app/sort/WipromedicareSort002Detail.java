...
@Component("batch_wipromedicaresort002")
@JobScope
public class WipromedicareSort002Detail {

	private List<WipromedicareSort002Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort002Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort002Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort002Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort002Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort002Keys> sortComp) {
