  ...
  @Component("WipromedicareSort002SortOut1")
  @JobScope
  public class WipromedicareSort002SortOut1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort002SortOut1.class);
  	@Value("${WipromedicareSort002SortOut[1]:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort002SortOut1RecordType:${WipromedicareSort002SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort002SortOut1RecordLen:${WipromedicareSort002SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort002SortOut1 Write: {}",e.getMessage()); 		
  		}
  	}
