...
@Component("batch_wipromedicaresort001")
@JobScope
public class WipromedicareSort001Detail {

	private List<WipromedicareSort001Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort001Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort001Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort001Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort001Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort001Keys> sortComp) {
