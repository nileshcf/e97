  ...
  @Component("WipromedicareSort011SortOut")
  @JobScope
  public class WipromedicareSort011SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort011SortOut.class);
  	@Value("${WipromedicareSort011SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort011SortOutRecordType:${WipromedicareSort011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort011SortOutRecordLen:${WipromedicareSort011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort011SortOut Write: {}",e.getMessage()); 		
  		}
  	}
