  ...
  @Component("WipromedicareSort001SortIn")
  @JobScope
  public class WipromedicareSort001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort001SortIn.class);
  	@Value("${WipromedicareSort001SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN001}")
  	...
  	@Value("#{'${WipromedicareSort001SortInRecordType:${WipromedicareSort001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort001SortInRecordLen:${WipromedicareSort001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort001SortIn Read: {}",e.getMessage()); 
  		}
  	}
