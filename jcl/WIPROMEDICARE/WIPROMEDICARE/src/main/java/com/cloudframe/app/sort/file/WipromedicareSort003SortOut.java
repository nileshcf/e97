  ...
  @Component("WipromedicareSort003SortOut")
  @JobScope
  public class WipromedicareSort003SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort003SortOut.class);
  	@Value("${WipromedicareSort003SortOut:CLOUDFRM.WIPRO.MEDICARE.SORT.OUT0}")
      ...
      @Value("#{'${WipromedicareSort003SortOutRecordType:${WipromedicareSort003SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${WipromedicareSort003SortOutRecordLen:${WipromedicareSort003SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during WipromedicareSort003SortOut Write: {}",e.getMessage()); 		
  		}
  	}
