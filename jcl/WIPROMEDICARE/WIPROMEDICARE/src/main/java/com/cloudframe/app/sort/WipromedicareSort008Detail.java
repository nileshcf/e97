...
@Component("batch_wipromedicaresort008")
@JobScope
public class WipromedicareSort008Detail {

	private List<WipromedicareSort008Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort008Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort008Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort008Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort008Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort008Keys> sortComp) {
