  ...
  @Component("WipromedicareSort005SortIn")
  @JobScope
  public class WipromedicareSort005SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(WipromedicareSort005SortIn.class);
  	@Value("${WipromedicareSort005SortIn:CLOUDFRM.WIPRO.MEDICARE.SORT.IN005}")
  	...
  	@Value("#{'${WipromedicareSort005SortInRecordType:${WipromedicareSort005SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${WipromedicareSort005SortInRecordLen:${WipromedicareSort005SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during WipromedicareSort005SortIn Read: {}",e.getMessage()); 
  		}
  	}
