...
@Component("batch_wipromedicaresort007")
@JobScope
public class WipromedicareSort007Detail {

	private List<WipromedicareSort007Keys> sortRecKeys = null;

	protected Field field = new Field();
	private Comparator<WipromedicareSort007Keys> sortComp = null;
	 ...
	 */
	public List<WipromedicareSort007Keys> getSortRecKeys() {
		return sortRecKeys;
	}
	 ...
	 */
	public void setSortRecKeys(List<WipromedicareSort007Keys> sortRecKeys) {
	 ...
	 * @return the sortComp
	 */
	public Comparator<WipromedicareSort007Keys> getSortComp() {
		return sortComp;
	}
	 ...
	 */
	public void setSortComp(Comparator<WipromedicareSort007Keys> sortComp) {
