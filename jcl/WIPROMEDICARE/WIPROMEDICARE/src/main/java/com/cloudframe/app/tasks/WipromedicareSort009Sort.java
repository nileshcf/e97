...
import com.cloudframe.app.sort.file.WipromedicareSort009SortIn;
...
import com.cloudframe.app.sort.file.WipromedicareSort009SortOut;
import org.springframework.beans.factory.annotation.Qualifier;
import com.cloudframe.app.CFStepHandler;
import com.cloudframe.app.sort.WipromedicareSort009Detail;
public class WipromedicareSort009Sort extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(WipromedicareSort009Sort.class);
	@Autowired
	...
	@Autowired
	@Qualifier("WipromedicareSort009SortOut")
	WipromedicareSort009SortOut sortOut;
	

	
	@Autowired
	@Qualifier("WipromedicareSort009SortIn")
	WipromedicareSort009SortIn sortIn;
	...
	List<WipromedicareSort009Keys> sortRecKeys = null;
/**
...
logger.info("STEPNAME: WIPROMEDICARESORT009 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
		sortOut.close();
	...
	private byte[] getSortedRecord(int index) {
		try {
			WipromedicareSort009Keys k = sortRecKeys.get(index);
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		...
		WipromedicareSort009Keys relKey = new WipromedicareSort009Keys();
