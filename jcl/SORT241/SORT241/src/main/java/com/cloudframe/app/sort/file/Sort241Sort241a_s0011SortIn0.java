  ...
  @Component("Sort241Sort241a_s0011SortIn0")
  @JobScope
  public class Sort241Sort241a_s0011SortIn0 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort241Sort241a_s0011SortIn0.class);
  	@Value("${Sort241Sort241a_s0011SortIn[0]:CLOUDFRM.MS.SORT.IN241.PART1}")
  	...
  	@Value("#{'${Sort241Sort241a_s0011SortIn0RecordType:${Sort241Sort241a_s0011SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sort241Sort241a_s0011SortIn0RecordLen:${Sort241Sort241a_s0011SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sort241Sort241a_s0011SortIn0 Read: {}",e.getMessage()); 
  		}
  	}
