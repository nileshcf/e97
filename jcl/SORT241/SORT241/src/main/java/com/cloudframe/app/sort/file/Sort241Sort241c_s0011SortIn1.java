  ...
  @Component("Sort241Sort241c_s0011SortIn1")
  @JobScope
  public class Sort241Sort241c_s0011SortIn1 extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort241Sort241c_s0011SortIn1.class);
  	@Value("${Sort241Sort241c_s0011SortIn[1]:CLOUDFRM.MS.SORT.IN241.PART2OVR}")
  	...
  	@Value("#{'${Sort241Sort241c_s0011SortIn1RecordType:${Sort241Sort241c_s0011SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Sort241Sort241c_s0011SortIn1RecordLen:${Sort241Sort241c_s0011SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Sort241Sort241c_s0011SortIn1 Read: {}",e.getMessage()); 
  		}
  	}
