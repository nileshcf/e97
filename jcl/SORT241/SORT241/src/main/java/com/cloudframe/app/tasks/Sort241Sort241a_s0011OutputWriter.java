...
public class Sort241Sort241a_s0011OutputWriter extends BaseProcess implements Tasklet, StepExecutionListener {

	private final Logger logger = LoggerFactory.getLogger(Sort241Sort241a_s0011OutputWriter.class);
	@Autowired
	...
	List<Sort241Sort241a_s0011Keys> sortRecKeys = null;
...
logger.info("STEPNAME: SORT241SORT241A_S0011 Execution completed, number of RECORDS - IN: {},  OUT: {}", sortDetail.getRecInCounter(), recordCount);
	...
	private byte[] getSortedRecord(int index) {
		try {
			Sort241Sort241a_s0011Keys k = sortRecKeys.get(index);
           if (isWriteInTempFile()) {
