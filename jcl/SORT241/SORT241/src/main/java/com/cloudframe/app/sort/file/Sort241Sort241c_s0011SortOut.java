  ...
  @Component("Sort241Sort241c_s0011SortOut")
  @JobScope
  public class Sort241Sort241c_s0011SortOut extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Sort241Sort241c_s0011SortOut.class);
  	@Value("${Sort241Sort241c_s0011SortOut:SORT241C_S0011.SORT241.SYSOUT}")
      ...
      @Value("#{'${Sort241Sort241c_s0011SortOutRecordType:${Sort241Sort241c_s0011SortOutRecordType:FB}}'}")
  	private String recordType;
  	
      @Value("#{'${Sort241Sort241c_s0011SortOutRecordLen:${Sort241Sort241c_s0011SortOutRecordLen:80}}'}")
  	...
  	public void write(int len) {
  		try {
  			...
  			logger.error("Error during Sort241Sort241c_s0011SortOut Write: {}",e.getMessage()); 		
  		}
  	}
