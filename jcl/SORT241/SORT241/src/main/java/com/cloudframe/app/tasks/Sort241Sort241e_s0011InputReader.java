...
public class Sort241Sort241e_s0011InputReader extends BaseProcess implements Tasklet, StepExecutionListener, InitializingBean {
	private final Logger logger = LoggerFactory.getLogger(Sort241Sort241e_s0011InputReader.class);
/**
...
public void afterPropertiesSet() throws Exception {
	...
	public void addRecordBytes4Sorting(byte[] recordByte, int byteLen) {
		List<Sort241Sort241e_s0011Keys> sortRecKeys = sortDetail.getSortRecKeys();
		Sort241Sort241e_s0011Keys relKey = new Sort241Sort241e_s0011Keys();
