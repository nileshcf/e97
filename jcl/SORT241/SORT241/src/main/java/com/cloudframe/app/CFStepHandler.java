...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String SORT241A_S0011 = "sort241a_s0011";
    private static final String SORT241B_S0011 = "sort241b_s0011";
    private static final String SORT241C_S0011 = "sort241c_s0011";
    private static final String SORT241D_S0011 = "sort241d_s0011";
    private static final String SORT241E_S0011 = "sort241e_s0011";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "sort241a_s0011":  /* setting the disp position for file(s) info for this step(SORT241A_S0011). */
                         SpringContextHandler.setFileDispPosition("Sort241Sort241a_s0011SortIn0","Sort241Sort241a_s0011SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort241Sort241a_s0011SortIn1","Sort241Sort241a_s0011SortIn[1].DISP");
            break;
            case "sort241b_s0011":  /* setting the disp position for file(s) info for this step(SORT241B_S0011). */
                         SpringContextHandler.setFileDispPosition("Sort241Sort241b_s0011SortIn0","Sort241Sort241b_s0011SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort241Sort241b_s0011SortIn1","Sort241Sort241b_s0011SortIn[1].DISP");
            break;
            case "sort241c_s0011":  /* setting the disp position for file(s) info for this step(SORT241C_S0011). */
                         SpringContextHandler.setFileDispPosition("Sort241Sort241c_s0011SortIn0","Sort241Sort241c_s0011SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort241Sort241c_s0011SortIn1","Sort241Sort241c_s0011SortIn[1].DISP");
            break;
            case "sort241d_s0011":  /* setting the disp position for file(s) info for this step(SORT241D_S0011). */
                         SpringContextHandler.setFileDispPosition("Sort241Sort241d_s0011SortIn0","Sort241Sort241d_s0011SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort241Sort241d_s0011SortIn1","Sort241Sort241d_s0011SortIn[1].DISP");
            break;
            case "sort241e_s0011":  /* setting the disp position for file(s) info for this step(SORT241E_S0011). */
                         SpringContextHandler.setFileDispPosition("Sort241Sort241e_s0011SortIn0","Sort241Sort241e_s0011SortIn[0].DISP");
                         SpringContextHandler.setFileDispPosition("Sort241Sort241e_s0011SortIn1","Sort241Sort241e_s0011SortIn[1].DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : SORT241 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : SORT241 ENDED -  ABEND={}", abendCode);
      } 
