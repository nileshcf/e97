...
public class BatchConfiguration {
   ...
   private static final String SORT = "SORT";
    ...
    @Bean
    @JobScope
    public Sort241Sort241a_s0011Sort sort241Sort241a_s0011Sort() {
    	return new Sort241Sort241a_s0011Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort241Sort241a_s0011Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort241Sort241a_s0011Sort",jobRepository).tasklet(sort241Sort241a_s0011Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort241a_s0011Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort241a_s0011Executor")
             ...
             .to(Sort241Sort241a_s0011Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Sort241Sort241b_s0011Sort sort241Sort241b_s0011Sort() {
    	return new Sort241Sort241b_s0011Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort241Sort241b_s0011Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort241Sort241b_s0011Sort",jobRepository).tasklet(sort241Sort241b_s0011Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort241b_s0011Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort241b_s0011Executor")
             ...
             .to(Sort241Sort241b_s0011Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Sort241Sort241c_s0011Sort sort241Sort241c_s0011Sort() {
    	return new Sort241Sort241c_s0011Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort241Sort241c_s0011Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort241Sort241c_s0011Sort",jobRepository).tasklet(sort241Sort241c_s0011Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort241c_s0011Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort241c_s0011Executor")
             ...
             .to(Sort241Sort241c_s0011Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Sort241Sort241d_s0011Sort sort241Sort241d_s0011Sort() {
    	return new Sort241Sort241d_s0011Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort241Sort241d_s0011Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort241Sort241d_s0011Sort",jobRepository).tasklet(sort241Sort241d_s0011Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort241d_s0011Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort241d_s0011Executor")
             ...
             .to(Sort241Sort241d_s0011Sort(jobRepository, transactionManager))
    ...
    @Bean
    @JobScope
    public Sort241Sort241e_s0011Sort sort241Sort241e_s0011Sort() {
    	return new Sort241Sort241e_s0011Sort();
    }
    
    @Bean
    @JobScope
    protected Step Sort241Sort241e_s0011Sort(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    	return new StepBuilder("Sort241Sort241e_s0011Sort",jobRepository).tasklet(sort241Sort241e_s0011Sort(), transactionManager).build();  
    }
  ...
  /*  
    ...
    public Flow sort241e_s0011Executor(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
       return new FlowBuilder<SimpleFlow>("sort241e_s0011Executor")
             ...
             .to(Sort241Sort241e_s0011Sort(jobRepository, transactionManager))
