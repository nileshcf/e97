...
/**
 * The Crazy88 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Crazy88 crazy88 = (Crazy88) context.getBean("crazy88");
        	    crazy88.process(new GlobalExecutorCtx().getContext(Crazy88Ctx.class)); /*  Crazy88 requires no input parameters  */
