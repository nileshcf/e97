...
@Component("blkdblk_umodeFile")
public class UmodeFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(UmodeFile.class);
	
	@Value("${BLKDBLK.UmodeFile:UMODEASC}")
    ...
    **/
	@Value("${BLKDBLK.UmodeFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${BLKDBLK.UmodeFileCRLFflag:no}")
	private String crlfFlag;

	public String getUmodeFileCharSet() {
		return charSet;
	}
	
	public String getUmodeFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during UmodeFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during UmodeFile Write: {}",e.getMessage() ); 		}
	}
