package com.cloudframe.app.blkdblk.file;
...
import com.cloudframe.app.blkdblk.file.records.*;

@Component("blkdblk_vbsFile")
public class VbsFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(VbsFile.class);
	
	@Value("${BLKDBLK.VbsFile:VBSEBC}")
    ...
    **/
	@Value("${BLKDBLK.VbsFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${BLKDBLK.VbsFileCRLFflag:no}")
	private String crlfFlag;

	public String getVbsFileCharSet() {
		return charSet;
	}
	
	public String getVbsFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during VbsFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during VbsFile Write: {}",e.getMessage() ); 		}
	}
