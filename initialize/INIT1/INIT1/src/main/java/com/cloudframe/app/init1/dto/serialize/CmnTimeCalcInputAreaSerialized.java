...
public class CmnTimeCalcInputAreaSerialized  extends Field { 
   ...
   /*  offset of each of Child Fields when serialized as a String */
            protected  int beginCmnTimeCalcType;
            protected  int beginCmnTimeCalcStart;
            protected  int beginCmnTimeCalcEnd;
            protected  int beginCmnTimeCalcNumOfSecIn;
	...
	**/
	...
	protected void init(int begin) {
	   ...
	   /*  set the offset/position of each field when this object is serialized as String */
             beginCmnTimeCalcType = getStartOffset() + 0;	// set offset for serialization
             ...
             beginCmnTimeCalcNumOfSecIn = getStartOffset() + 13;	// set offset for serialization
  
	   /*  end of offset */
	}
     int localCmnTimeCalcTypeCounter = -1;
     public boolean isCmnTimeCalcTypeModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localCmnTimeCalcTypeCounter != sharedCounter;
         localCmnTimeCalcTypeCounter = sharedCounter; return hasModified;
     }
	protected static final int CMN_TIME_CALC_TYPE_LEN = 1;
	/**
	 * 	serialize this CmnTimeCalcType
	 */
   protected void serializeCmnTimeCalcType(char[] cmnTimeCalcType) {
        shareString.getSerializedField().incrementCounter();
        arraycopy(cmnTimeCalcType,0,getStringValue(),beginCmnTimeCalcType,CMN_TIME_CALC_TYPE_LEN);
       localCmnTimeCalcTypeCounter = shareString.getSerializedField().getModifiedCounter();  	
   }

   protected char[] checkCmnTimeCalcTypeConstraints(char[] value) {
   			return super.checkConstraints(value , 1 ,false, false);
   }
    /**
	 *	refreshCmnTimeCalcType is used to refresh the latest value of a variable from the Serialized String
	 *  the most common reason to serialize an Object as a string in to write to a file. There can be several other reasons for serialization as well
	 */ 
   	public char[] refreshCmnTimeCalcType() {	 
   		return (substring(getStringValue(),beginCmnTimeCalcType,beginCmnTimeCalcType + CMN_TIME_CALC_TYPE_LEN));
   	}
   ...
   protected long checkCmnTimeCalcEndMaxLimit(long number) {
	 ...
	 */ 
     ...
     int localCmnTimeCalcNumOfSecInCounter = -1;
     public boolean isCmnTimeCalcNumOfSecInModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localCmnTimeCalcNumOfSecInCounter != sharedCounter;
         localCmnTimeCalcNumOfSecInCounter = sharedCounter; return hasModified; 
     }     

	/**
	 *	Returns String value of cmnTimeCalcNumOfSecIn
	 *	@return cmnTimeCalcNumOfSecIn
	 */
	public char[]  getCmnTimeCalcNumOfSecInString() {
	     return getCharArray(beginCmnTimeCalcNumOfSecIn,CMN_TIME_CALC_NUM_OF_SEC_IN_LEN);
	}
	 ...
	 *	@return true if numeric value is stored in the string
	 */
	public boolean cmnTimeCalcNumOfSecInIsNumeric() {
	    return isNumeric(beginCmnTimeCalcNumOfSecIn
	                    ,beginCmnTimeCalcNumOfSecIn + CMN_TIME_CALC_NUM_OF_SEC_IN_LEN
	                    ,false/*Signed*/,true/*isSign trailing*/,false/*isSignStoredSeparately*/);
	}

  
   protected  static final int CMN_TIME_CALC_NUM_OF_SEC_IN_LEN = 9;
  	/**
	 * serializeCmnTimeCalcNumOfSecIn
	 */
	protected void serializeCmnTimeCalcNumOfSecIn(long cmnTimeCalcNumOfSecIn) {
		 putNumber(beginCmnTimeCalcNumOfSecIn,cmnTimeCalcNumOfSecIn,CMN_TIME_CALC_NUM_OF_SEC_IN_LEN,false/*isSigned?*/,true/*signTrailing?*/,false/*storeSignSeparate?*/); 
		 localCmnTimeCalcNumOfSecInCounter = shareString.getSerializedField().getModifiedCounter();

    }
    /**
	 * serializeCmnTimeCalcNumOfSecIn
	 */
   	protected  long serializeCmnTimeCalcNumOfSecIn(char[] value) {
	    long  cmnTimeCalcNumOfSecIn;
	    if(value.length >0 && value.length!= 9)
            value = new String(value).trim().toCharArray();
	    if (value.length < 9) value = pad(9, value, ' ', LEFT_PAD);
	    else if (value.length > 9) value = substring(value,0,9);
	    /*  String can consists of digit or a non digit characters, in case of non digit characters, mimic COBOL Behavior and take only the last 4 bits per char and convert that to a number */
	    cmnTimeCalcNumOfSecIn = convertString2Number(value,false/*isSigned?*/,true/*signTrailing?*/,false/*storeSignSeparate?*/);
		replaceValue(
		       padNumber(9,value,false/*isSigned?*/)
		       ,beginCmnTimeCalcNumOfSecIn
		       ,9
		      );
		 localCmnTimeCalcNumOfSecInCounter = shareString.getSerializedField().getModifiedCounter();
		return  cmnTimeCalcNumOfSecIn;
   ...
   protected long checkCmnTimeCalcNumOfSecInMaxLimit(long number) {

        return checkMaxLimit(number , MAX_1G/*limit*/  , false/*isSigned*/);
   }
    /**
	 *	refreshCmnTimeCalcNumOfSecIn is used to refresh the latest value of a variable from the Serialized String
	 *  the most common reason to serialize an Object as a string in to write to a file. There can be several other reasons for serialization as well
	 */ 
   	public long refreshCmnTimeCalcNumOfSecIn() throws CFException {
   	try {	 
			return (
			          getLongNumber(
			                  beginCmnTimeCalcNumOfSecIn
			                 ,CMN_TIME_CALC_NUM_OF_SEC_IN_LEN
			                 ,false/*isSigned*/,true/*isSignTrailing*/,false/*isSignStoredSeparate*/)              			                 
			          ); 
	} catch(Exception ex) {
    	throw getSoc7ABend("cmnTimeCalcNumOfSecIn", beginCmnTimeCalcNumOfSecIn,CMN_TIME_CALC_NUM_OF_SEC_IN_LEN);
    }
   	}
