...
public class CmnTimeConvInputArea extends CmnTimeConvInputAreaSerialized { 
								...
								@Getter @Setter private int cmnTimeConvType;
				@Getter @Setter private CmnTimeConvInput cmnTimeConvInput = new CmnTimeConvInput();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getCmnTimeConvInput().setParent(this,getStartOffset() + 1);
    } 
