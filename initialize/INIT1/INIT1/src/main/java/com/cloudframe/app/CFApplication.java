...
/**
 * The Init1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Init1 init1 = (Init1) context.getBean("init1");
        	    init1.process(new GlobalExecutorCtx().getContext(Init1Ctx.class)); /*  Init1 requires no input parameters  */
