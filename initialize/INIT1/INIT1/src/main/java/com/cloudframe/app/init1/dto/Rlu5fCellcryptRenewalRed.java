...
public class Rlu5fCellcryptRenewalRed extends Rlu5fCellcryptRenewalRedSerialized { 
								...
								@Getter @Setter private int rlu5fCellcryptRenewalMm;

								@Getter @Setter private int rlu5fCellcryptRenewalDd;

								@Getter @Setter private int rlu5fCellcryptRenewalCc;

								@Getter @Setter private int rlu5fCellcryptRenewalYy;
