...
public class CmnDateCalcInputArea extends CmnDateCalcInputAreaSerialized { 
						...
						@Getter @Setter private char[] cmnDateCalcType = Field.fillLowValue(1);
				@Getter @Setter private CmnDateCalcCalcTypOptions cmnDateCalcCalcTypOptions = new CmnDateCalcCalcTypOptions();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getCmnDateCalcCalcTypOptions().setParent(this,getStartOffset() + 1);
