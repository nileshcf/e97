...
public class Dfhcommarea11 extends Dfhcommarea11Serialized { 
				...
				private CmnDateValidInputArea cmnDateValidInputArea = new CmnDateValidInputArea();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
	       			cmnDateValidInputArea.setParent(this,getStartOffset() + 0);
	       			cmnDateValidOutputArea.setParent(this,getStartOffset() + 10);
    } 

	/**
	 *	Returns the value of cmnDateValidInputArea
	 *	@return cmnDateValidInputArea
	 */   
	 public CmnDateValidInputArea getCmnDateValidInputArea() {
   	return cmnDateValidInputArea;
   }
   /**
	* 	Update CmnDateValidInputArea with the passed value
	*   Corresponding COBOL Variable is CMN-DATE-VALID-INPUT-AREA
	*	@param value
	*/
   public void setCmnDateValidInputArea(char[] value) {
      cmnDateValidInputArea.setString(value); 
   }   
    
     /**
	 * 	Update CmnDateValidInputArea 
	 *     with a String from an offset and length             
	 *	@param value
	 */
   public void setCmnDateValidInputArea(char[] source, int sourceIndex,int sourceLen) {
   	replace(source,sourceIndex,sourceLen,cmnDateValidInputArea.begin,cmnDateValidInputArea.length());
   }
	 ...
	 *	@param value
	 */
   public void setCmnDateValidInputArea(char[] source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
   	replace(source,sourceIndex,sourceLen,cmnDateValidInputArea.begin+targetIndex,targetLen);
   }
   
    /**
	 * 	Update CmnDateValidInputArea with another Field
	 *	@param value
	 */
   public void setCmnDateValidInputArea(Field source) {
   	replace(source,0,source.length(),cmnDateValidInputArea.begin,cmnDateValidInputArea.length());
   }  
	 ...
	 *	@param value
	 */
   public void setCmnDateValidInputArea(Field source, int sourceIndex,int sourceLen) {
   	replace(source,sourceIndex,sourceLen,cmnDateValidInputArea.begin,cmnDateValidInputArea.length());
   }
	 ...
	 *	@param value
	 */
   public void setCmnDateValidInputArea(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
   	replace(source,sourceIndex,sourceLen,cmnDateValidInputArea.begin+targetIndex,targetLen);
   }
	/**
