...
/**
 * The Init4 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Init4 init4 = (Init4) context.getBean("init4");
        	    init4.process(new GlobalExecutorCtx().getContext(Init4Ctx.class)); /*  Init4 requires no input parameters  */
