...
/**
 * The Init2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Init2 init2 = (Init2) context.getBean("init2");
        	    init2.process(new GlobalExecutorCtx().getContext(Init2Ctx.class)); /*  Init2 requires no input parameters  */
