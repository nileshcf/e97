package com.cloudframe.app.ip224620;
...
import com.cloudframe.app.ip224620.dto.Pds501S1s2s3Table500;
import com.cloudframe.app.global.sharedvar.Ip30331FinAddndmEntries;


@Context
public class Ip224620Ctx implements ProgramContext, Cloneable {
    ...
    public Ip224620Ctx clone() {
        Ip224620Ctx cloneObj = new Ip224620Ctx();
 ...
 */
     ...
     Work work = Ip224620Ctx.this.getWork();
     Ip30331FinAddndmEntries ip30331FinAddndmEntries = Ip224620Ctx.this.getIp30331FinAddndmEntries();
     Pds501S1s2s3Entries500 pds501S1s2s3Entries500 = Ip224620Ctx.this.getPds501S1s2s3Entries500();
	...
	*/
	...
	public void setValueOne300(long number)  throws CFException{
        ...
        public Ip224620Ctx getIp224620Ctx() {
            return Ip224620Ctx.this;
        }
	...
	*/
    ...
    public PerformInitializationOutCtx getPerformInitializationOutCtx() {
     ...
     McIpmMsg mcIpmMsg = Ip224620Ctx.this.getMcIpmMsg();
     Pds501Value800 pds501Value800 = Ip224620Ctx.this.getPds501Value800();
     Work work = Ip224620Ctx.this.getWork();
...
public void setPds501TblIdx500(int pds501TblIdx500) { 
    Ip224620Ctx.this.pds501TblIdx500 = pds501TblIdx500;
}

public int getPds501TblIdx500() { 
    return Ip224620Ctx.this.pds501TblIdx500;
}
	/**
	 *	Returns the value of pds501S1s2s3Tcnt500
	 *	@return pds501S1s2s3Tcnt500
...
public int getPds501TblIdx500() { 
   ...
   public void setPds501s1Value800(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public EnterNewCombinationOutCtx getEnterNewCombinationOutCtx() {
     ...
     AbendMessage900 abendMessage900 = Ip224620Ctx.this.getAbendMessage900();
     Work work = Ip224620Ctx.this.getWork();
     AbendParaName900 abendParaName900 = Ip224620Ctx.this.getAbendParaName900();
