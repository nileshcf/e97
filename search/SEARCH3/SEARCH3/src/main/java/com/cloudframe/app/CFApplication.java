...
/**
 * The Search3 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Search3 search3 = (Search3) context.getBean("search3");
        	    search3.process(new GlobalExecutorCtx().getContext(Search3Ctx.class)); /*  Search3 requires no input parameters  */
