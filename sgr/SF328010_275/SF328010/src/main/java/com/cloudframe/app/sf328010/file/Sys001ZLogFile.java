...
@Component("sf328010_sys001ZLogFile")
public class Sys001ZLogFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001ZLogFile.class);
	
	@Value("${SF328010.Sys001ZLogFile:SYS001}")
    ...
    **/
	@Value("${SF328010.Sys001ZLogFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF328010.Sys001ZLogFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys001ZLogFileCharSet() {
		return charSet;
	}
	
	public String getSys001ZLogFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys001ZLogFile()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001ZLogFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
