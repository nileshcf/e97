...
/**
 * The Sf328010 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Sf328010 sf328010 = (Sf328010) context.getBean("sf328010");
        	    sf328010.process(new GlobalExecutorCtx().getContext(Sf328010Ctx.class)); /*  Sf328010 requires no input parameters  */
