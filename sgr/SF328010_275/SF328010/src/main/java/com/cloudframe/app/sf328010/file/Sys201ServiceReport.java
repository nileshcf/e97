package com.cloudframe.app.sf328010.file;
...
import com.cloudframe.app.sf328010.file.records.*;

@Component("sf328010_sys201ServiceReport")
public class Sys201ServiceReport extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201ServiceReport.class);
	
	@Value("${SF328010.Sys201ServiceReport:SYS201}")
    ...
    **/
	@Value("${SF328010.Sys201ServiceReportCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF328010.Sys201ServiceReportCRLFflag:no}")
	private String crlfFlag;

	public String getSys201ServiceReportCharSet() {
		return charSet;
	}
	
	public String getSys201ServiceReportCrlfFlag() {
		return crlfFlag;
	}

	public Sys201ServiceReport()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201ServiceReport Write: {}",e.getMessage() ); 		}
	}
