...
/**
 * The Wm001 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Wm001 wm001 = (Wm001) context.getBean("wm001");
        	    wm001.process(new GlobalExecutorCtx().getContext(Wm001Ctx.class)); /*  Wm001 requires no input parameters  */
