...
import com.cloudframe.app.process.Calldrvr;
...
/**
 * The Calldrvr application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
		 	try {
		 		...
		 		Calldrvr calldrvr = (Calldrvr) context.getBean("calldrvr");
        	    calldrvr.process(); /*  Calldrvr requires no input parameters  */
