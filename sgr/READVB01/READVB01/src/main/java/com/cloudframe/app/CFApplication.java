...
/**
 * The Readvb01 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Readvb01 readvb01 = (Readvb01) context.getBean("readvb01");
        	    readvb01.process(new GlobalExecutorCtx().getContext(Readvb01Ctx.class)); /*  Readvb01 requires no input parameters  */
