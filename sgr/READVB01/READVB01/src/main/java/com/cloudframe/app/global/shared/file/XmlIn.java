...
@Component("global_xmlIn")
public class XmlIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(XmlIn.class);
	
	@Value("${GLOBAL.XmlIn:XMLDATA}")
    ...
    **/
	@Value("${GLOBAL.XmlInCharSet:cp1047}")
	private String charSet;
	
	@Value("${GLOBAL.XmlInCRLFflag:no}")
	private String crlfFlag;

	public String getXmlInCharSet() {
		return charSet;
	}
	
	public String getXmlInCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during XmlIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during XmlIn Write: {}",e.getMessage() ); 		}
	}
