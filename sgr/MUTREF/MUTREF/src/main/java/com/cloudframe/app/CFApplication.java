...
import com.cloudframe.app.process.Mutref;
...
/**
 * The Mutref application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
		 	try {
		 		...
		 		Mutref mutref = (Mutref) context.getBean("mutref");
        	    mutref.process(); /*  Mutref requires no input parameters  */
