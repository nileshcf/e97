...
@Component("sf320010_infoSecFileOut")
public class InfoSecFileOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(InfoSecFileOut.class);
	
	@Value("${SF320010.InfoSecFileOut:SYS202}")
    ...
    **/
	@Value("${SF320010.InfoSecFileOutCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF320010.InfoSecFileOutCRLFflag:no}")
	private String crlfFlag;

	public String getInfoSecFileOutCharSet() {
		return charSet;
	}
	
	public String getInfoSecFileOutCrlfFlag() {
		return crlfFlag;
	}

	public InfoSecFileOut()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during InfoSecFileOut Write: {}",e.getMessage() ); 		}
	}
