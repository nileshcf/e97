...
@Component("sf320010_tempWorkFile")
public class TempWorkFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(TempWorkFile.class);
	
	@Value("${SF320010.TempWorkFile:SYS301}")
    ...
    **/
	@Value("${SF320010.TempWorkFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF320010.TempWorkFileCRLFflag:no}")
	private String crlfFlag;

	public String getTempWorkFileCharSet() {
		return charSet;
	}
	
	public String getTempWorkFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during TempWorkFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during TempWorkFile Write: {}",e.getMessage() ); 		}
	}
