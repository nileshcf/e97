...
/**
 * The Sf320010 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Sf320010 sf320010 = (Sf320010) context.getBean("sf320010");
        	    sf320010.process(new GlobalExecutorCtx().getContext(Sf320010Ctx.class)); /*  Sf320010 requires no input parameters  */
