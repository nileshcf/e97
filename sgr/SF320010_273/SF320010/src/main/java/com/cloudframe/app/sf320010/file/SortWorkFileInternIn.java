...
@Component("sf320010_sortWorkFileInternIn")
public class SortWorkFileInternIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(SortWorkFileInternIn.class);
    ...
    **/
	...
	public void setSortWorkFileInternInCharSet(String charSet) {
	   this.charSet = charSet;
	}
	
	private String crlfFlag;
	
	public void setSortWorkFileInternInCRLFflag(String crlfFlag) {
	   this.crlfFlag = crlfFlag;
	}

	public String getSortWorkFileInternInCharSet() {
		return charSet;
	}
	
	public String getSortWorkFileInternInCrlfFlag() {
		return crlfFlag;
	}
	public SortWorkFileInternIn()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[336]);
		setFileName("SortWorkFileInternIn");
		setSortWorkFileInternInCharSet("cp1047");
		setSortWorkFileInternInCRLFflag("no");
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during SortWorkFileInternIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
