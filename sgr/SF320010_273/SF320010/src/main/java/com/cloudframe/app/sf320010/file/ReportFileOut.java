...
@Component("sf320010_reportFileOut")
public class ReportFileOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(ReportFileOut.class);
	
	@Value("${SF320010.ReportFileOut:SYS201}")
    ...
    **/
	@Value("${SF320010.ReportFileOutCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF320010.ReportFileOutCRLFflag:no}")
	private String crlfFlag;

	public String getReportFileOutCharSet() {
		return charSet;
	}
	
	public String getReportFileOutCrlfFlag() {
		return crlfFlag;
	}

	public ReportFileOut()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during ReportFileOut Write: {}",e.getMessage() ); 		}
	}
