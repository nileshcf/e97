...
@Component("sf320010_generalLogFileIn")
public class GeneralLogFileIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(GeneralLogFileIn.class);
	
	@Value("${SF320010.GeneralLogFileIn:SYS001}")
    ...
    **/
	@Value("${SF320010.GeneralLogFileInCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF320010.GeneralLogFileInCRLFflag:no}")
	private String crlfFlag;

	public String getGeneralLogFileInCharSet() {
		return charSet;
	}
	
	public String getGeneralLogFileInCrlfFlag() {
		return crlfFlag;
	}

	public GeneralLogFileIn()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during GeneralLogFileIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
