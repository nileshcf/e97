...
@Component("sf320010_sys203EmailFileOut")
public class Sys203EmailFileOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys203EmailFileOut.class);
	
	@Value("${SF320010.Sys203EmailFileOut:SYS203}")
    ...
    **/
	@Value("${SF320010.Sys203EmailFileOutCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF320010.Sys203EmailFileOutCRLFflag:no}")
	private String crlfFlag;

	public String getSys203EmailFileOutCharSet() {
		return charSet;
	}
	
	public String getSys203EmailFileOutCrlfFlag() {
		return crlfFlag;
	}

	public Sys203EmailFileOut()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys203EmailFileOut Write: {}",e.getMessage() ); 		}
	}
