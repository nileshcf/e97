...
/**
 * The Cfdate02 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfdate02 cfdate02 = (Cfdate02) context.getBean("cfdate02");
        	    cfdate02.process(new GlobalExecutorCtx().getContext(Cfdate02Ctx.class)); /*  Cfdate02 requires no input parameters  */
