package com.cloudframe.app.echoqsam.file;
...
import com.cloudframe.app.echoqsam.file.records.*;

@Component("echoqsam_outputFile")
public class OutputFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(OutputFile.class);
	
	@Value("${ECHOQSAM.OutputFile:OUTFILE}")
    ...
    **/
	@Value("${ECHOQSAM.OutputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${ECHOQSAM.OutputFileCRLFflag:no}")
