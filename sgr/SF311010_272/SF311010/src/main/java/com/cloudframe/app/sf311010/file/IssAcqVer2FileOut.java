...
@Component("sf311010_issAcqVer2FileOut")
public class IssAcqVer2FileOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(IssAcqVer2FileOut.class);
	
	@Value("${SF311010.IssAcqVer2FileOut:SYS202}")
    ...
    **/
	@Value("${SF311010.IssAcqVer2FileOutCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF311010.IssAcqVer2FileOutCRLFflag:no}")
	private String crlfFlag;

	public String getIssAcqVer2FileOutCharSet() {
		return charSet;
	}
	
	public String getIssAcqVer2FileOutCrlfFlag() {
		return crlfFlag;
	}

	public IssAcqVer2FileOut()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[900]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during IssAcqVer2FileOut Write: {}",e.getMessage() ); 		}
	}
