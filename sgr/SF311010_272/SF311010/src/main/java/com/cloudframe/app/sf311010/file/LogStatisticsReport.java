...
@Component("sf311010_logStatisticsReport")
public class LogStatisticsReport extends CFFile {

	private Logger logger = LoggerFactory.getLogger(LogStatisticsReport.class);
	
	@Value("${SF311010.LogStatisticsReport:SYS201}")
    ...
    **/
	@Value("${SF311010.LogStatisticsReportCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF311010.LogStatisticsReportCRLFflag:no}")
	private String crlfFlag;

	public String getLogStatisticsReportCharSet() {
		return charSet;
	}
	
	public String getLogStatisticsReportCrlfFlag() {
		return crlfFlag;
	}

	public LogStatisticsReport()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[145]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during LogStatisticsReport Write: {}",e.getMessage() ); 		}
	}
