...
@GlobalDto
public class Ip996011ProgramStartMessage extends Ip996011ProgramStartMessageSerialized { 
				...
				private Ip996011StartTimestamp ip996011StartTimestamp = new Ip996011StartTimestamp();
						...
						private char[] ip996011WhenCompiledX = Field.fillLowValue(17);
   ...
   public void setIp996011WhenCompiled(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	/**
	 *	Returns the value of ip996011WhenCompiledX
	 *	@return ip996011WhenCompiledX
	 */
   public char[] getIp996011WhenCompiledX() throws CFException{
     if (isIp996011WhenCompiledXModified()) { 
        ip996011WhenCompiledX = refreshIp996011WhenCompiledX();
     }
   		return ip996011WhenCompiledX;
   }
	...
	/**
	*  set variable ip996011WhenCompiledX
	*  Corresponding COBOL Variable is IP996011-WHEN-COMPILED-X
	*  @param value
	**/
   public void setIp996011WhenCompiledX(char[] value) {
      ip996011WhenCompiledX = checkIp996011WhenCompiledXConstraints(value);
      serializeIp996011WhenCompiledX(ip996011WhenCompiledX);
   } 

     /**
	 * 	Update Ip996011WhenCompiledX 
	 *     with a char[] from an offset and length             
	 *	@param value
	 */
   public void setIp996011WhenCompiledX(char[] source, int sourceIndex) {
       replace(source,sourceIndex,source.length,beginIp996011WhenCompiledX,ip996011WhenCompiledX.length);
   	
   }
   
   public void setIp996011WhenCompiledX(char[] source, int sourceIndex , int sourceLen) {
       replace(source,sourceIndex,sourceLen,beginIp996011WhenCompiledX,ip996011WhenCompiledX.length);
	 ...
	 *	@param value
	 */
   public void setIp996011WhenCompiledX(char[] source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
       replace(source,sourceIndex,sourceLen,beginIp996011WhenCompiledX+targetIndex,targetLen);
   
   }
   
    /**
	 * 	Update Ip996011WhenCompiledX with another Field
	 *	@param value
	 */
   public void setIp996011WhenCompiledX(Field source) {
       replace(source,0,source.length(),beginIp996011WhenCompiledX,IP_996011_WHEN_COMPILED_X_LEN);
	 ...
	 *	@param value
	 */
   public void setIp996011WhenCompiledX(Field source, int sourceIndex,int sourceLen) {
        replace(source,sourceIndex,sourceLen,beginIp996011WhenCompiledX,IP_996011_WHEN_COMPILED_X_LEN);
	 ...
	 *	@param value
	 */
   public void setIp996011WhenCompiledX(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
       replace(source,sourceIndex,sourceLen,beginIp996011WhenCompiledX+targetIndex,targetLen);
