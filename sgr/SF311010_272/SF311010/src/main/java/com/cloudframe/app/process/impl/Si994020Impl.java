  ...
  @Component("si994020")
  public class Si994020Impl extends BaseProcess implements Si994020 {
  	Logger logger = LoggerFactory.getLogger(Si994020Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Si994020impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
