  ...
  @Component("mcabend")
  public class McabendImpl extends BaseProcess implements Mcabend {
  	Logger logger = LoggerFactory.getLogger(McabendImpl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Mcabendimpl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
