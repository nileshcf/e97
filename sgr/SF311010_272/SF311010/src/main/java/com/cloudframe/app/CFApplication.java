...
/**
 * The Sf311010 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Sf311010 sf311010 = (Sf311010) context.getBean("sf311010");
				...
				sf311010.setParameter(new GlobalExecutorCtx().getContext(Sf311010Ctx.class),inputValue);
