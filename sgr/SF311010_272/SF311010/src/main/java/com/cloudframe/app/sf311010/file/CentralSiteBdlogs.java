package com.cloudframe.app.sf311010.file;
...
import com.cloudframe.app.sf311010.file.records.*;

@Component("sf311010_centralSiteBdlogs")
public class CentralSiteBdlogs extends CFFile {

	private Logger logger = LoggerFactory.getLogger(CentralSiteBdlogs.class);
	
	@Value("${SF311010.CentralSiteBdlogs:SYS001}")
    ...
    **/
	@Value("${SF311010.CentralSiteBdlogsCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF311010.CentralSiteBdlogsCRLFflag:no}")
	private String crlfFlag;

	public String getCentralSiteBdlogsCharSet() {
		return charSet;
	}
	
	public String getCentralSiteBdlogsCrlfFlag() {
		return crlfFlag;
	}

	public CentralSiteBdlogs()
	{
		setVariableBlockFile(true);	
		setRecord(new byte[8000]);
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during CentralSiteBdlogs Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
