...
/**
 * The Sup01751 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Sup01751 sup01751 = (Sup01751) context.getBean("sup01751");
        	    sup01751.process(new GlobalExecutorCtx().getContext(Sup01751Ctx.class)); /*  Sup01751 requires no input parameters  */
