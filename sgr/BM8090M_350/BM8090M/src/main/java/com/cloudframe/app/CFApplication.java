...
/**
 * The Bm8090m application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Bm8090m bm8090m = (Bm8090m) context.getBean("bm8090m");
        	    bm8090m.process(new GlobalExecutorCtx().getContext(Bm8090mCtx.class)); /*  Bm8090m requires no input parameters  */
