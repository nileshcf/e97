...
/**
 * The Callfd01 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Callfd01 callfd01 = (Callfd01) context.getBean("callfd01");
        	    callfd01.process(new GlobalExecutorCtx().getContext(Callfd01Ctx.class)); /*  Callfd01 requires no input parameters  */
