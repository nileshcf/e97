...
@Component("ms00d363_curcyFile")
public class CurcyFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(CurcyFile.class);
	
	@Value("${MS00D363.CurcyFile:SWCHCUR}")
    ...
    **/
	@Value("${MS00D363.CurcyFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.CurcyFileCRLFflag:no}")
	private String crlfFlag;

	public String getCurcyFileCharSet() {
		return charSet;
	}
	
	public String getCurcyFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during CurcyFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
