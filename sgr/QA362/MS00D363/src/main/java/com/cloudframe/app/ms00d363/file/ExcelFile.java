...
@Component("ms00d363_excelFile")
public class ExcelFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(ExcelFile.class);
	
	@Value("${MS00D363.ExcelFile:EXCEL}")
    ...
    **/
	@Value("${MS00D363.ExcelFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.ExcelFileCRLFflag:no}")
	private String crlfFlag;

	public String getExcelFileCharSet() {
		return charSet;
	}
	
	public String getExcelFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during ExcelFile Write: {}",e.getMessage() ); 		}
	}
