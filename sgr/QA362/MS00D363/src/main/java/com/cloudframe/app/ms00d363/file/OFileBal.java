...
@Component("ms00d363_oFileBal")
public class OFileBal extends CFFile {

	private Logger logger = LoggerFactory.getLogger(OFileBal.class);
	
	@Value("${MS00D363.OFileBal:BALFILE}")
    ...
    **/
	@Value("${MS00D363.OFileBalCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.OFileBalCRLFflag:no}")
	private String crlfFlag;

	public String getOFileBalCharSet() {
		return charSet;
	}
	
	public String getOFileBalCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during OFileBal Write: {}",e.getMessage() ); 		}
	}
