...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP050 = "step050";
...
*/
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "step050":  /* setting the appropriate file(s) info for this step(STEP050). */
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_certificationFile", "MS00D363.CertificationFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_rptkeyFile", "MS00D363.RptkeyFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_curcyFile", "MS00D363.CurcyFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_samapcFile", "MS00D363.SamapcFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_inputFile", "MS00D363.InputFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_reportFile", "MS00D363.ReportFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_excelFile", "MS00D363.ExcelFile.DISP");
 		    	   		SpringContextHandler.setFileDispPosition("ms00d363_oFileBal", "MS00D363.OFileBal.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : MS00D363 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : MS00D363 ENDED -  ABEND={}", abendCode);
      } 
