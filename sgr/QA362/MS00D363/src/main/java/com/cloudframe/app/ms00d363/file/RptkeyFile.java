...
@Component("ms00d363_rptkeyFile")
public class RptkeyFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(RptkeyFile.class);
	
	@Value("${MS00D363.RptkeyFile:RPTKEYS}")
    ...
    **/
	@Value("${MS00D363.RptkeyFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.RptkeyFileCRLFflag:no}")
	private String crlfFlag;

	public String getRptkeyFileCharSet() {
		return charSet;
	}
	
	public String getRptkeyFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during RptkeyFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
