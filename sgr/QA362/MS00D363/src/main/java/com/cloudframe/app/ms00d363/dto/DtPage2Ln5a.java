...
public class DtPage2Ln5a extends DtPage2Ln5aSerialized {
						...
						@Getter @Setter private char[] dt25aCc = new char[1];




						@Getter @Setter private char[] dt25aR09DbAmt = Field.fillLowValue(18);



						@Getter @Setter private char[] dt25aR09CrAmt = Field.fillLowValue(18);
