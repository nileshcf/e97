...
public class InputFile extends CFFile {
    ...
    **/
	@Value("${MS00D363.InputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.InputFileCRLFflag:no}")
