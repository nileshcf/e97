...
@Component("ms00d363_certificationFile")
public class CertificationFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(CertificationFile.class);
	
	@Value("${MS00D363.CertificationFile:CERTTEST}")
    ...
    **/
	@Value("${MS00D363.CertificationFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.CertificationFileCRLFflag:no}")
	private String crlfFlag;

	public String getCertificationFileCharSet() {
		return charSet;
	}
	
	public String getCertificationFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during CertificationFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
