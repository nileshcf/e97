...
@Component("ms00d363_samapcFile")
public class SamapcFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(SamapcFile.class);
	
	@Value("${MS00D363.SamapcFile:SWCHAPC}")
    ...
    **/
	@Value("${MS00D363.SamapcFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MS00D363.SamapcFileCRLFflag:no}")
	private String crlfFlag;

	public String getSamapcFileCharSet() {
		return charSet;
	}
	
	public String getSamapcFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during SamapcFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
