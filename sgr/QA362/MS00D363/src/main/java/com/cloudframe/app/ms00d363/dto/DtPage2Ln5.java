...
public class DtPage2Ln5 extends DtPage2Ln5Serialized {
						...
						@Getter @Setter private char[] dt25Cc = new char[1];





						@Getter @Setter private char[] dt25TfnDbAmt = Field.fillLowValue(18);




						@Getter @Setter private char[] dt25TfnCrAmt = Field.fillLowValue(18);
