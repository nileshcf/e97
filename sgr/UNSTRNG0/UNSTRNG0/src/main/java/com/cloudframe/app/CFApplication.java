...
/**
 * The Unstrng0 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Unstrng0 unstrng0 = (Unstrng0) context.getBean("unstrng0");
        	    unstrng0.process(new GlobalExecutorCtx().getContext(Unstrng0Ctx.class)); /*  Unstrng0 requires no input parameters  */
