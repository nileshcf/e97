...
public class CompileDate600 extends CompileDate600Serialized { 
						...
						@Getter @Setter private char[] compDateYyyy600 = new char[4];


						@Getter @Setter private char[] compDateMm600 = new char[2];


						@Getter @Setter private char[] compDateDd600 = new char[2];
