...
/**
 * The Sf326010 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Sf326010 sf326010 = (Sf326010) context.getBean("sf326010");
        	    sf326010.process(new GlobalExecutorCtx().getContext(Sf326010Ctx.class)); /*  Sf326010 requires no input parameters  */
