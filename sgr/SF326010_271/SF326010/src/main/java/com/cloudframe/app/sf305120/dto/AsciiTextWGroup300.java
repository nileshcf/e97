...
public class AsciiTextWGroup300 extends AsciiTextWGroup300Serialized {
					...
					@Getter @Setter private AsciiTextW300 asciiTextW300 = new AsciiTextW300();

						@Getter @Setter private char[] asciiText300 = Field.fillLowValue(86);
	...
	**/
    public AsciiTextWGroup300() {
		...
		/*  set the parent of each child as this which are a group variable */
					getAsciiTextW300().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
