...
public class X86Int32X800 extends X86Int32X800Serialized { 
						...
						@Getter @Setter private char[] x86Int32B4800 = Field.fillLowValue(1);

						@Getter @Setter private char[] x86Int32B3800 = Field.fillLowValue(1);

						@Getter @Setter private char[] x86Int32B2800 = Field.fillLowValue(1);

						@Getter @Setter private char[] x86Int32B1800 = Field.fillLowValue(1);
