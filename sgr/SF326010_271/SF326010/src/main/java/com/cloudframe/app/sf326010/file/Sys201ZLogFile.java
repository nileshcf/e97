...
@Component("sf326010_sys201ZLogFile")
public class Sys201ZLogFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201ZLogFile.class);
	
	@Value("${SF326010.Sys201ZLogFile:SYS201}")
    ...
    **/
	@Value("${SF326010.Sys201ZLogFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF326010.Sys201ZLogFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys201ZLogFileCharSet() {
		return charSet;
	}
	
	public String getSys201ZLogFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys201ZLogFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201ZLogFile Write: {}",e.getMessage() ); 		}
	}
