package com.cloudframe.app.sf327010.file;
...
import com.cloudframe.app.sf327010.file.records.*;

@Component("sf327010_sys201AsaServerReport")
public class Sys201AsaServerReport extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201AsaServerReport.class);
	
	@Value("${SF327010.Sys201AsaServerReport:SYS201}")
    ...
    **/
	@Value("${SF327010.Sys201AsaServerReportCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF327010.Sys201AsaServerReportCRLFflag:no}")
	private String crlfFlag;

	public String getSys201AsaServerReportCharSet() {
		return charSet;
	}
	
	public String getSys201AsaServerReportCrlfFlag() {
		return crlfFlag;
	}

	public Sys201AsaServerReport()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201AsaServerReport Write: {}",e.getMessage() ); 		}
	}
