...
@Component("sf327010_sys001ExtractZLogFile")
public class Sys001ExtractZLogFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001ExtractZLogFile.class);
	
	@Value("${SF327010.Sys001ExtractZLogFile:SYS001}")
    ...
    **/
	@Value("${SF327010.Sys001ExtractZLogFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${SF327010.Sys001ExtractZLogFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys001ExtractZLogFileCharSet() {
		return charSet;
	}
	
	public String getSys001ExtractZLogFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys001ExtractZLogFile()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[75]);
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001ExtractZLogFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
