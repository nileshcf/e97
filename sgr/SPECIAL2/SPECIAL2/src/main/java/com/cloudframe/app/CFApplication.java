...
/**
 * The Special2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Special2 special2 = (Special2) context.getBean("special2");
        	    special2.process(new GlobalExecutorCtx().getContext(Special2Ctx.class)); /*  Special2 requires no input parameters  */
