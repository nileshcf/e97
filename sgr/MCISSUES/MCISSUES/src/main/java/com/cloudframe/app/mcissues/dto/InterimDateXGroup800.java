...
public class InterimDateXGroup800 extends InterimDateXGroup800Serialized {
						...
						@Getter @Setter private char[] interimDateX800 = Field.fillLowValue(8);
					@Getter @Setter private InterimDate800 interimDate800 = new InterimDate800();
	...
	**/
    public InterimDateXGroup800() {
		...
		/*  set the parent of each child as this which are a group variable */
					getInterimDate800().setParent(this,getStartOffset() + 0);
	   	/*  end of offset */
    }
