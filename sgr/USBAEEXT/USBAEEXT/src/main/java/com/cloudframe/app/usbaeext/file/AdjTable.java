...
@Component("usbaeext_adjTable")
public class AdjTable extends CFFile {

	private Logger logger = LoggerFactory.getLogger(AdjTable.class);
	
	@Value("${USBAEEXT.AdjTable:ADJTBL}")
    ...
    **/
	@Value("${USBAEEXT.AdjTableCharSet:cp1047}")
	private String charSet;
	
	@Value("${USBAEEXT.AdjTableCRLFflag:no}")
	private String crlfFlag;

	public String getAdjTableCharSet() {
		return charSet;
	}
	
	public String getAdjTableCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during AdjTable Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
