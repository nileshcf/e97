...
@Component("usbaeext_tmFile")
public class TmFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(TmFile.class);
	
	@Value("${USBAEEXT.TmFile:TMFILEIN}")
    ...
    **/
	@Value("${USBAEEXT.TmFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${USBAEEXT.TmFileCRLFflag:no}")
	private String crlfFlag;

	public String getTmFileCharSet() {
		return charSet;
	}
	
	public String getTmFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during TmFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
