...
public class LsDfhcommarea {
    ...
    @Hidden
public void populateToDto(org.optum.uhg.dto.cics0009.LsDfhcommarea dto) {
        dto.setLsRequestType(getLsRequestType());
        getLsRequestDataGroup().populateToDto(dto.getLsRequestDataGroup());
        dto.setLsReturnCode(getLsReturnCode());
        dto.setLsReturnEibresp(getLsReturnEibresp());
        dto.setLsReturnEibresp2(getLsReturnEibresp2());
    }
}
