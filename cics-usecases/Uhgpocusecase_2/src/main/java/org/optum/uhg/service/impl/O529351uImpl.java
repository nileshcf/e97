...
import org.optum.uhg.dto.o529351u.O529351uCtx;
import org.optum.uhg.service.O529351u;
import com.cloudframe.app.process.BaseProcess;
...
import org.optum.uhg.dto.o529351u.*;
import org.optum.uhg.dto.o529351u.Dfhcommarea;
import org.optum.uhg.dto.o529351u.W02FnuLineStartbr;
import org.optum.uhg.dto.o529351u.DsmCallArea;
import org.optum.uhg.dto.o529351u.FesaKey1;
import org.optum.uhg.dto.o529351u.DdEqisAlt;
import org.optum.uhg.dto.o529351u.FeSpiRulesRecord;
import org.optum.uhg.dto.o529351u.W02FnuLineRead;
import org.optum.uhg.dto.o529351u.W02DsplMsgArea;
import org.optum.uhg.dto.o529351u.Vyspi51uCallArea;
import org.optum.uhg.dto.o529351u.W02FnuLineReadnext;
import org.optum.uhg.dto.o529351u.CsvcProc;
import org.optum.uhg.dto.o529351u.FeSpiAltPlanRecord;
import org.optum.uhg.dto.o529351u.EqiRecord;
import org.optum.uhg.dto.o529351u.FesrKey;
import org.optum.uhg.dto.o529351u.CetCicsErrorTableGroup;
import org.optum.uhg.dto.o529351u.GenTransSpiTableGroup;
import org.optum.uhg.dto.o529351u.NewTransSpiTableGroup;
import org.optum.uhg.dto.o529351u.CsvcCodeGroup;
import org.optum.uhg.dto.o529351u.Ioi02bInterface;
import org.optum.uhg.dto.o529351u.WorkFields;
import org.optum.uhg.dto.o529351u.DrstRestartDataArea;
import org.optum.uhg.dto.o529351u.LsSaveRecord1;
import org.optum.uhg.dto.o529351u.LsSaveRecord3;
import org.optum.uhg.dto.o529351u.LsSaveRecord4;
import org.optum.uhg.dto.o529351u.LsSaveRec1Clminf;
import org.optum.uhg.dto.o529351u.FrontendHdPmtIcnRecord;
import org.optum.uhg.dto.o529351u.FrontendMedPmtIcnRecord;
import org.optum.uhg.dto.o529351u.Work;
...
public class O529351uImpl extends CommonProcess implements O529351u {
    ...
    public ReadEqiOutCtx readEqi(ReadEqiInCtx methodIn) throws Exception {
        ...
        // *END-EXEC.
        // MOVE LENGTH OF SCE-ALT-KEY TO DFHB0020
        ...
        // *    RESP      (CICS-DFHRESP-CODE)
        // *END-EXEC.
        // MOVE LENGTH OF LS-EQI-RECORD TO DFHB0020
        methodOut.setDfhb0020(LS_EQI_RECORD_LENGTH);
        // MOVE LENGTH OF SCE-ALT-KEY TO DFHB0021
    ...
    public StartBrowsePlanvaraOutCtx startBrowsePlanvara(StartBrowsePlanvaraInCtx methodIn) throws Exception {
        ...
        // *    RESP      (CICS-DFHRESP-CODE)
        // *END-EXEC.
        // MOVE LENGTH OF FESA-KEY TO DFHB0020
    ...
    public ReadNextPlanvaraOutCtx readNextPlanvara(ReadNextPlanvaraInCtx methodIn) throws Exception {
        ...
        // *    RESP      (CICS-DFHRESP-CODE)
        // *END-EXEC.
        // MOVE LENGTH OF FE-SPI-ALT-PLAN-RECORD TO DFHB0020
        methodOut.setDfhb0020(FeSpiAltPlanRecord.getFeSpiAltPlanRecordFieldLength());
        // MOVE LENGTH OF FESA-KEY TO DFHB0021
    ...
    public StartBrowseSpirulesOutCtx startBrowseSpirules(StartBrowseSpirulesInCtx methodIn) throws Exception {
        ...
        // *     RESP(CICS-DFHRESP-CODE)
        // *END-EXEC.
        // MOVE LENGTH OF FESR-KEY TO DFHB0020
    ...
    public ReadNextSpirulesOutCtx readNextSpirules(ReadNextSpirulesInCtx methodIn) throws Exception {
        ...
        // *     RESP      (CICS-DFHRESP-CODE)
        // *END-EXEC.
        // MOVE LENGTH OF FE-SPI-RULES-RECORD TO DFHB0020
        methodOut.setDfhb0020(FeSpiRulesRecord.getFeSpiRulesRecordFieldLength());
        // MOVE LENGTH OF FESR-KEY TO DFHB0021
    ...
    public WriteToSysmOutCtx writeToSysm(WriteToSysmInCtx methodIn) throws Exception {
        ...
        // MOVE 'SYSM' TO DFHC0040
        // LITERAL_SYSM = 'SYSM'
        methodOut.setDfhc0040(CONSTANTS.LITERAL_SYSM);
        // MOVE LENGTH OF W02-DSPL-MSG-AREA TO DFHB0020
