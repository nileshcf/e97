...
public class CacheKeyFixedArea extends CacheKeyFixedAreaSerialized {
  ...
  public char[] getCacheKeyOverflowInd() throws CFException {
    if (isCacheKeyOverflowIndModified()) {
      cacheKeyOverflowInd = refreshCacheKeyOverflowInd();
    }
    return cacheKeyOverflowInd;
  }

  /**
   * set variable cacheKeyOverflowInd Corresponding COBOL Variable is CACHE-KEY-OVERFLOW-IND
   *
   * @param value
   */
  public void setCacheKeyOverflowInd(char[] value) {
    cacheKeyOverflowInd = checkCacheKeyOverflowIndConstraints(value);
    serializeCacheKeyOverflowInd(cacheKeyOverflowInd);
  }

  /**
   * Update CacheKeyOverflowInd with a char[] from an offset and length
   *
   * @param value
   */
  public void setCacheKeyOverflowInd(char[] source, int sourceIndex) {
    replace(
        source, sourceIndex, source.length, beginCacheKeyOverflowInd, cacheKeyOverflowInd.length);
  }

  public void setCacheKeyOverflowInd(char[] source, int sourceIndex, int sourceLen) {
    replace(source, sourceIndex, sourceLen, beginCacheKeyOverflowInd, cacheKeyOverflowInd.length);
  }

  /**
   * Update CacheKeyOverflowInd with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCacheKeyOverflowInd(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
    replace(source, sourceIndex, sourceLen, beginCacheKeyOverflowInd + targetIndex, targetLen);
  }

  /**
   * Update CacheKeyOverflowInd with another Field
   *
   * @param value
   */
  public void setCacheKeyOverflowInd(Field source) {
    replace(source, 0, source.length(), beginCacheKeyOverflowInd, CACHE_KEY_OVERFLOW_IND_LEN);
  }

  /**
   * Update CacheKeyOverflowInd with another Field from an offset and length
   *
   * @param value
   */
  public void setCacheKeyOverflowInd(Field source, int sourceIndex, int sourceLen) {
    replace(source, sourceIndex, sourceLen, beginCacheKeyOverflowInd, CACHE_KEY_OVERFLOW_IND_LEN);
  }

  /**
   * Update CacheKeyOverflowInd with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setCacheKeyOverflowInd(
  ...
  public boolean isCacheKeyOverflowYes() throws CFException {
    return (compareChars(getCacheKeyOverflowInd(), cacheKeyOverflowYes88Value) == 0);
  }

  /** set values "Y" */
  public void setCacheKeyOverflowYesTrue() {
    setCacheKeyOverflowInd(cacheKeyOverflowYes88Value);
  }
  ...
  public boolean isCacheKeyOverflowNo() throws CFException {
    return (compareChars(getCacheKeyOverflowInd(), cacheKeyOverflowNo88Value) == 0);
  }

  /** set values "N" */
  public void setCacheKeyOverflowNoTrue() {
    setCacheKeyOverflowInd(cacheKeyOverflowNo88Value);
  }
