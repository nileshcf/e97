...
public class ScnReqArea extends ScnReqAreaSerialized {
  ...
  /**
   * initializes ScnReqArea String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setScnReqSrvcCd(CONSTANTS.SPACE_6);
    setScnReqEffDt(CONSTANTS.SPACE_10);
    setScnReqCancDt(CONSTANTS.SPACE_10);
    setScnReqClngProg(CONSTANTS.SPACE_8);
  }
