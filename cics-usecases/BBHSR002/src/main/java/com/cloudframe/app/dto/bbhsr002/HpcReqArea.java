...
public class HpcReqArea extends HpcReqAreaSerialized {
  ...
  /**
   * initializes HpcReqArea String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setHpcReqHipaaCd(CONSTANTS.SPACE_2);
    setHpcReqHipaaVerNbr(CONSTANTS.SPACE);
    setHpcReqClngProg(CONSTANTS.SPACE_8);
  }
