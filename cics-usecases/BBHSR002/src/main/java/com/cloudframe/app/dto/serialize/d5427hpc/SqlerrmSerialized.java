...
/**
 * The class SqlerrmSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqlerrmSerialized extends Field {
  ...
  /**
   * sets parent for this SqlerrmSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isSqlerrmlModified() {
    ...
    localSqlerrmlCounter = sharedCounter;
    return hasModified;
  }
  ...
  protected void serializeSqlerrml(short sqlerrml) {
    replaceValue( //  save the value as string
        getBinaryString(sqlerrml, SQLERRML_LEN), beginSqlerrml, SQLERRML_LEN);
  ...
  public boolean isSqlerrmcModified() {
    ...
    localSqlerrmcCounter = sharedCounter;
    return hasModified;
  }
