package com.cloudframe.app.rest.dphpctsq;

/**
 * The class DfhcommareaGroup is used to handle fields declared in it
 *
 * @author CloudFrame Inc. created on 2025-03-25 at 08:30.
 */
...
public class DfhcommareaGroup {
  ...
  @JsonIgnore
  public void setDfhcommareaGroup(com.cloudframe.app.dto.dphpctsq.DfhcommareaGroup dfhcommareaGroup)
      throws CFException {
  ...
  @JsonIgnore
  public void populateFrom(com.cloudframe.app.dto.dphpctsq.DfhcommareaGroup dfhcommareaGroup)
      throws CFException {
