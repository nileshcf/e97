...
public class BhiReturnRow extends BhiReturnRowSerialized {
  ...
  char[] bhiRowNotFound88Value = "NF".toCharArray();
  /**
   * Test condition "NF" for isBhiRowNotFound()
   *
   * @return Returns true if isBhiRowNotFound() is "NF"
   */
  public boolean isBhiRowNotFound() throws CFException {
    return (compareChars(getBhiRowReturnCd(), bhiRowNotFound88Value) == 0);
  }

  /** set values "NF" */
  public void setBhiRowNotFoundTrue() {
    setBhiRowReturnCd(bhiRowNotFound88Value);
  }
  ...
  /**
   * initializes BhiReturnRow String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setBhiRowReturnCd(CONSTANTS.SPACE_2);
    setBhiRowDb2Code(CFUtil.cobolNumberFormatter(CONSTANTS.FORMAT261490060, "0".toCharArray()));
    setBhiRowAction(CONSTANTS.SPACE);
    bhiRowReturnDet.initialize();
  }
