...
public class WorkSerialized extends Field {
  ...
  int localPriorHipaaCdCounter = -1;

  public boolean isPriorHipaaCdModified() {
    int sharedCounter = shareString.getSerializedField().getModifiedCounter();
    boolean hasModified = localPriorHipaaCdCounter != sharedCounter;
    localPriorHipaaCdCounter = sharedCounter;
    return hasModified;
  }

  protected char[] checkPriorHipaaCdConstraints(char[] value) {
    return super.checkConstraints(value, 2, false, false);
  }

  int localPriorGrnrcRqstCdCounter = -1;

  public boolean isPriorGrnrcRqstCdModified() {
    int sharedCounter = shareString.getSerializedField().getModifiedCounter();
    boolean hasModified = localPriorGrnrcRqstCdCounter != sharedCounter;
    localPriorGrnrcRqstCdCounter = sharedCounter;
    return hasModified;
  }

  protected char[] checkPriorGrnrcRqstCdConstraints(char[] value) {
    return super.checkConstraints(value, 1, false, false);
  }

  int localDphpctsq01Counter = -1;

  public boolean isDphpctsq01Modified() {
    int sharedCounter = shareString.getSerializedField().getModifiedCounter();
    boolean hasModified = localDphpctsq01Counter != sharedCounter;
    localDphpctsq01Counter = sharedCounter;
    return hasModified;
  }

  protected char[] checkDphpctsq01Constraints(char[] value) {
