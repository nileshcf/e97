...
public class Sqlext extends SqlextSerialized {
  ...
  /**
   * set variable sqlwarn8 Corresponding COBOL Variable is SQLWARN8
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn8 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn8 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn8(
  ...
  /**
   * Update Sqlwarn8 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn8 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn8(
  ...
  /**
   * set variable sqlwarn9 Corresponding COBOL Variable is SQLWARN9
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn9 with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn9 with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn9(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarn9 with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarn9 with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarn9(
  ...
  /**
   * set variable sqlwarna Corresponding COBOL Variable is SQLWARNA
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarna with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarna with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarna(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlwarna with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlwarna with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlwarna(
  ...
  /**
   * set variable sqlstate Corresponding COBOL Variable is SQLSTATE
   *
   * @param value
   */
  ...
  /**
   * Update Sqlstate with a char[] from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlstate with a char[] from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlstate(
      char[] source, int sourceIndex, int sourceLen, int targetIndex, int targetLen) {
  ...
  /**
   * Update Sqlstate with another Field from an offset and length
   *
   * @param value
   */
  ...
  /**
   * Update Sqlstate with another Field from an offset and length to an offset and length
   *
   * @param value
   */
  public void setSqlstate(
