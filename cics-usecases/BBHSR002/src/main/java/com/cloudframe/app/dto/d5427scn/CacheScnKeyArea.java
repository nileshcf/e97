...
/**
 * The class CacheScnKeyArea is used to handle fields declared in it
 *
...
public class CacheScnKeyArea extends CacheScnKeyAreaSerialized {
  ...
  public static int getCacheScnKeyAreaFieldLength() {
    return CACHE_SCN_KEY_AREA_LENGTH;
  }
}
