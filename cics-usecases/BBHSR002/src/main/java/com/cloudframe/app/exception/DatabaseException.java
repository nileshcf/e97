...
/**
 * The {@code DatabaseException} class is used to be thrown by the application in case of any caught
 * error.
 */
public class DatabaseException extends Exception {
  ...
  public static DatabaseException getException(
      String message, String errorCode, Exception exception) {
    DatabaseException variableName = new DatabaseException(message);
    variableName.exception = exception;
