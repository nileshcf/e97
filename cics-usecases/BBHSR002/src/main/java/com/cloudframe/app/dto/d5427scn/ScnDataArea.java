...
/**
 * The class ScnDataArea is used to handle fields declared in it
 *
...
public class ScnDataArea extends ScnDataAreaSerialized {

  private ScnReqRetArea scnReqRetArea = new ScnReqRetArea();

  /** Constructor for ScnDataArea */
  public ScnDataArea() {
    super();
  ...
  public static int getScnDataAreaFieldLength() {
    return SCN_DATA_AREA_LENGTH;
  }
}
