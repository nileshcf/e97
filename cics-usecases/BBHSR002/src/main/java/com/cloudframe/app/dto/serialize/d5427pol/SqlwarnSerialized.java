...
/**
 * The class SqlwarnSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqlwarnSerialized extends Field {
  ...
  /**
   * sets parent for this SqlwarnSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isSqlwarn0Modified() {
    ...
    localSqlwarn0Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn1Modified() {
    ...
    localSqlwarn1Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn2Modified() {
    ...
    localSqlwarn2Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn3Modified() {
    ...
    localSqlwarn3Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn4Modified() {
    ...
    localSqlwarn4Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn5Modified() {
    ...
    localSqlwarn5Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn6Modified() {
    ...
    localSqlwarn6Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn7Modified() {
    ...
    localSqlwarn7Counter = sharedCounter;
    return hasModified;
  }
