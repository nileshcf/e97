...
/**
 * The class DsmPolRet7Block is used to handle fields declared in it
 *
...
public class DsmPolRet7Block extends DsmPolRet7BlockSerialized {

  private Pol7RetArea3 pol7RetArea3 = new Pol7RetArea3();

  /** Constructor for DsmPolRet7Block */
  public DsmPolRet7Block() {
    super();
  ...
  /**
   * initializes DsmPolRet7Block String fields defaults to Spaces short/int/long defaults to zero
  ...
  public static int getDsmPolRet7BlockFieldLength() {
    return DSM_POL_RET_7_BLOCK_LENGTH;
  }
}
