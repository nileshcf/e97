...
public class DsmSqlErrorMsgArea extends DsmSqlErrorMsgAreaSerialized {
  ...
  /**
   * set variable dsmErrTblName Corresponding COBOL Variable is DSM-ERR-TBL-NAME
   *
   * @param value
   */
  ...
  /**
   * set variable dsmErrSectnName Corresponding COBOL Variable is DSM-ERR-SECTN-NAME
   *
   * @param value
   */
  ...
  /**
   * set variable dsmErrPgmName Corresponding COBOL Variable is DSM-ERR-PGM-NAME
   *
   * @param value
   */
  ...
  /**
   * set variable dsmErrTblAction Corresponding COBOL Variable is DSM-ERR-TBL-ACTION
   *
   * @param value
   */
  ...
  /**
   * set variable dsmErrTxt Corresponding COBOL Variable is DSM-ERR-TXT
   *
   * @param value
   */
  ...
  /**
   * initializes DsmSqlErrorMsgArea String fields defaults to Spaces short/int/long defaults to zero
