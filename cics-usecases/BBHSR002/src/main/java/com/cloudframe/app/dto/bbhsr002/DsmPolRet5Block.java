...
/**
 * The class DsmPolRet5Block is used to handle fields declared in it
 *
...
public class DsmPolRet5Block extends DsmPolRet5BlockSerialized {

  private Pol5RetArea5 pol5RetArea5 = new Pol5RetArea5();

  /** Constructor for DsmPolRet5Block */
  public DsmPolRet5Block() {
    super();
  ...
  /**
   * initializes DsmPolRet5Block String fields defaults to Spaces short/int/long defaults to zero
  ...
  public static int getDsmPolRet5BlockFieldLength() {
    return DSM_POL_RET_5_BLOCK_LENGTH;
  }
}
