...
public class ReqViewName {
  ...
  @Hidden
  public void populateToDto(com.cloudframe.app.dto.bbhsr002.ReqViewName dto) {
    dto.setReqViewProjCode(getReqViewProjCode().toCharArray());
    getReqView().populateToDto(dto.getReqView());
  }
}
