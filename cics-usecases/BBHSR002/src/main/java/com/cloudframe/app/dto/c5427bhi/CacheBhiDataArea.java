...
/**
 * The class CacheBhiDataArea is used to handle fields declared in it
 *
...
public class CacheBhiDataArea extends CacheBhiDataAreaSerialized {
  ...
  /** Constructor for CacheBhiDataArea */
  public CacheBhiDataArea() {
    super();
  ...
  public static int getCacheBhiDataAreaFieldLength() {
    return CACHE_BHI_DATA_AREA_LENGTH;
  }
}
