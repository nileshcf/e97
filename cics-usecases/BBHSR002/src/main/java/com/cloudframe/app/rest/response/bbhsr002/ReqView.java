...
public class ReqView {
  ...
  @Hidden
  public void populateFromDto(com.cloudframe.app.dto.bbhsr002.ReqView dto) throws CFException {
    setReqView2Bytes(CFUtil.trim(dto.getReqView2Bytes()));
    setReqView1Byte(CFUtil.trim(dto.getReqView1Byte()));
  }
}
