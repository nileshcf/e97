...
/**
 * The class CacheCommArea is used to handle fields declared in it
 *
...
public class CacheCommArea extends CacheCommAreaSerialized {
  ...
  /** Constructor for CacheCommArea */
  public CacheCommArea() {
    super();
    /*  set the parent of each child as this which are a group variable */
    crtnSrchKey.setParent(this, getStartOffset() + 0);
    crtnRequestData.setParent(this, getStartOffset() + 10);
    crtnSrchReturnArea.setParent(this, getStartOffset() + 33);
    /*  end of offset */
  }
  ...
  public static int getCacheCommAreaFieldLength() {
    return CACHE_COMM_AREA_LENGTH;
  }
}
