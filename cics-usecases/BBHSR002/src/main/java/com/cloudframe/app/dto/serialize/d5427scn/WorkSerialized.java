...
public class WorkSerialized extends Field {
  ...
  int localCsrchFoundSwCounter = -1;

  public boolean isCsrchFoundSwModified() {
    int sharedCounter = shareString.getSerializedField().getModifiedCounter();
    boolean hasModified = localCsrchFoundSwCounter != sharedCounter;
    localCsrchFoundSwCounter = sharedCounter;
    return hasModified;
  }

  protected char[] checkCsrchFoundSwConstraints(char[] value) {
