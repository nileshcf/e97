...
public class ReqAddressTbl {
  ...
  @Hidden
  public void populateToDto(com.cloudframe.app.dto.bbhsr002.ReqAddressTbl dto) {
    dto.setReqTblLength(getReqTblLength());
    getReqTblLengthRedefined().populateToDto(dto.getReqTblLengthRedefined());
  }
}
