...
/**
 * The class HpcDataArea is used to handle fields declared in it
 *
...
public class HpcDataArea extends HpcDataAreaSerialized {

  private HpcReqRetArea hpcReqRetArea = new HpcReqRetArea();

  /** Constructor for HpcDataArea */
  public HpcDataArea() {
    super();
  ...
  public static int getHpcDataAreaFieldLength() {
    return HPC_DATA_AREA_LENGTH;
  }
}
