...
/**
 * The class DsmPolRet4Block is used to handle fields declared in it
 *
...
public class DsmPolRet4Block extends DsmPolRet4BlockSerialized {

  private Pol4RetArea4 pol4RetArea4 = new Pol4RetArea4();

  /** Constructor for DsmPolRet4Block */
  public DsmPolRet4Block() {
    super();
  ...
  /**
   * initializes DsmPolRet4Block String fields defaults to Spaces short/int/long defaults to zero
  ...
  public static int getDsmPolRet4BlockFieldLength() {
    return DSM_POL_RET_4_BLOCK_LENGTH;
  }
}
