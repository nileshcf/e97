...
public class CacheKeyArraySerialized extends Field {
  ...
  protected static final int CACHE_KEY_ARRAY_LENGTH = 18;
  ...
  protected void init(int begin) {
    ...
    beginCacheDataOffset = getStartOffset() + 10; // set offset for serialization

    beginCacheDataNbrOfEntries = getStartOffset() + 14; // set offset for serialization
