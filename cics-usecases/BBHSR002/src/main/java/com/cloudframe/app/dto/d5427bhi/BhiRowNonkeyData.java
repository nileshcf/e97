...
public class BhiRowNonkeyData extends BhiRowNonkeyDataSerialized {
  ...
  /**
   * initializes BhiRowNonkeyData String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setBhiRowSrvcCd(CONSTANTS.SPACE_6);
    setBhiRowPlofsrvcCd(CONSTANTS.SPACE_2);
    setBhiRowCausCd(CONSTANTS.SPACE);
    setBhiRowBenLvlCd(CONSTANTS.SPACE);
    setBhiRowProcFrom(CONSTANTS.SPACE_7);
    setBhiRowProcTo(CONSTANTS.SPACE_7);
    setBhiRowProcType(CONSTANTS.SPACE);
    setBhiRowInn(CONSTANTS.SPACE);
    setBhiRowTier(CONSTANTS.SPACE);
    setBhiRowLstupdDttm(CONSTANTS.SPACE_26);
    setBhiRowLstupdUsrid(CONSTANTS.SPACE_6);
    setBhiRowStsCd(CONSTANTS.SPACE);
    setBhiRowProvOrgTypCd(CONSTANTS.SPACE_3);
  }
