...
public class BhiRowKey extends BhiRowKeySerialized {
  ...
  /**
   * initializes BhiRowKey String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setBhiRowSlotTblId(CONSTANTS.SPACE_6);
    setBhiRowHipaaVerNbr(CONSTANTS.SPACE);
    setBhiRowHipaaCd(CONSTANTS.SPACE_2);
    setBhiRowNetId(CONSTANTS.SPACE);
    setBhiRowEffDate(CONSTANTS.SPACE_10);
    setBhiRowCancDt(CONSTANTS.SPACE_10);
    setBhiRowCreateDttm(CONSTANTS.SPACE_26);
  }
