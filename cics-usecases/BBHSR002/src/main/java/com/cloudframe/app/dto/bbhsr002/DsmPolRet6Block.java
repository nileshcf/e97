...
/**
 * The class DsmPolRet6Block is used to handle fields declared in it
 *
...
public class DsmPolRet6Block extends DsmPolRet6BlockSerialized {

  private Pol6RetArea6 pol6RetArea6 = new Pol6RetArea6();

  /** Constructor for DsmPolRet6Block */
  public DsmPolRet6Block() {
    super();
  ...
  /**
   * initializes DsmPolRet6Block String fields defaults to Spaces short/int/long defaults to zero
  ...
  public static int getDsmPolRet6BlockFieldLength() {
    return DSM_POL_RET_6_BLOCK_LENGTH;
  }
}
