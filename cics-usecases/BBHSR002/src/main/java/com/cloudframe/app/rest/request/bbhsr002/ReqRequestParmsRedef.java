...
public class ReqRequestParmsRedef {
  ...
  @Hidden
  public void populateToDto(com.cloudframe.app.dto.bbhsr002.ReqRequestParmsRedef dto) {
    dto.setReqRequestParms146(getReqRequestParms146().toCharArray());
    dto.setReqRequestParms147149(getReqRequestParms147149().toCharArray());
    dto.setReqRequestParms150(getReqRequestParms150().toCharArray());
  }
}
