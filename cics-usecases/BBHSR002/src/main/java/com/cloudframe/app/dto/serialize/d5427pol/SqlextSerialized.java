...
/**
 * The class SqlextSerialized is used to define offsets in order to serialize in a fixed String
 *
...
public class SqlextSerialized extends Field {
  ...
  /**
   * sets parent for this SqlextSerialized to the parent and set the serialize offset to parameter
   * begin
   *
   * @param parent
  ...
  public boolean isSqlwarn8Modified() {
    ...
    localSqlwarn8Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarn9Modified() {
    ...
    localSqlwarn9Counter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlwarnaModified() {
    ...
    localSqlwarnaCounter = sharedCounter;
    return hasModified;
  }
  ...
  public boolean isSqlstateModified() {
    ...
    localSqlstateCounter = sharedCounter;
    return hasModified;
  }
