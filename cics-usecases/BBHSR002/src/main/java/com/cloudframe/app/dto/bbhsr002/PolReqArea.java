...
public class PolReqArea extends PolReqAreaSerialized {
  ...
  /**
   * initializes PolReqArea String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setPolReqClngProg(CONSTANTS.SPACE_8);
    setPolReqCovTypCd(CONSTANTS.SPACE);
    setPolReqMxiPolNbr(CONSTANTS.SPACE_6);
    setPolReqMxiPlnNbr(0);
    setPolReqMxiClssNbr(0);
    setPolReqEffDt(CONSTANTS.SPACE_10);
    setPolReqCancDt(CONSTANTS.SPACE_10);
    setPolReqGetmainCreator(CONSTANTS.SPACE_8);
  }
