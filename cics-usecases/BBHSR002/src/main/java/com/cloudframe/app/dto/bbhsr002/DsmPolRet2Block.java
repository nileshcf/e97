...
/**
 * The class DsmPolRet2Block is used to handle fields declared in it
 *
...
public class DsmPolRet2Block extends DsmPolRet2BlockSerialized {

  private Pol2RetArea2 pol2RetArea2 = new Pol2RetArea2();

  /** Constructor for DsmPolRet2Block */
  public DsmPolRet2Block() {
    super();
  ...
  /**
   * initializes DsmPolRet2Block String fields defaults to Spaces short/int/long defaults to zero
  ...
  public static int getDsmPolRet2BlockFieldLength() {
    return DSM_POL_RET_2_BLOCK_LENGTH;
  }
}
