...
/**
 * The class CacheBhiKeyArea is used to handle fields declared in it
 *
...
public class CacheBhiKeyArea extends CacheBhiKeyAreaSerialized {
  ...
  public static int getCacheBhiKeyAreaFieldLength() {
    return CACHE_BHI_KEY_AREA_LENGTH;
  }
}
