...
public class TliReqArea extends TliReqAreaSerialized {
  ...
  /**
   * initializes TliReqArea String fields defaults to Spaces short/int/long defaults to zero
   * BigDecimal defaults to BigDecimal.ZERO
   */
  public void initialize() {
    setTliReqClngProg(CONSTANTS.SPACE_8);
    setTliReqPolNbr(CONSTANTS.SPACE_6);
    setTliReqPlnNbr(CONSTANTS.SPACE_4);
    setTliReqObligId(CONSTANTS.SPACE_2);
    setTliReqShrArngCd(CONSTANTS.SPACE_2);
    setTliReqStartDt(CONSTANTS.SPACE_10);
  }
