...
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.CompareAscending0300InCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.CompareAscending0300OutCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.CompareDescending0400InCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.CompareDescending0400OutCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.Mainline0000OutCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.SortTheTable0200InCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.SortTheTable0200OutCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.ValidateRequest0100InCtx;
import org.optum.uhg.dto.vp776a00.Vp776a00Ctx.ValidateRequest0100OutCtx;
...
public interface Vp776a00 {
  ...
  public int setParameter(
      Vp776a00Ctx programCtx, String parm, String parm2, String parm3, String parm4)
      throws Exception;
