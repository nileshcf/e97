...
/**
 * The Proga1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Proga1 proga1 = (Proga1) context.getBean("proga1");
        	    proga1.process(new GlobalExecutorCtx().getContext(Proga1Ctx.class)); /*  Proga1 requires no input parameters  */
