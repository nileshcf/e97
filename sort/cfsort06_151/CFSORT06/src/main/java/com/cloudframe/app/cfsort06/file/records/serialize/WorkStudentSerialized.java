package com.cloudframe.app.cfsort06.file.records.serialize;
...
public class WorkStudentSerialized  extends Field { 
   ...
   /*  offset of each of Child Fields when serialized as a String */
            ...
            protected  int beginStudentNameW;
	...
	**/
	...
	protected void init(int begin) {
	   ...
	   /*  set the offset/position of each field when this object is serialized as String */
             ...
             beginStudentNameW = getStartOffset() + 5;	// set offset for serialization
   ...
   protected long checkStudentIdWMaxLimit(long number) {
	 ...
	 */ 
     ...
     int localStudentNameWCounter = -1;
     public boolean isStudentNameWModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localStudentNameWCounter != sharedCounter;
         localStudentNameWCounter = sharedCounter; return hasModified;
     }
	protected static final int STUDENT_NAME_W_LEN = 25;
	/**
	 * 	serialize this StudentNameW
	 */
   protected void serializeStudentNameW(char[] studentNameW) {
        shareString.getSerializedField().incrementCounter();
        arraycopy(studentNameW,0,getStringValue(),beginStudentNameW,STUDENT_NAME_W_LEN);
       localStudentNameWCounter = shareString.getSerializedField().getModifiedCounter();  	
   }

   protected char[] checkStudentNameWConstraints(char[] value) {
   			return super.checkConstraints(value , 25 ,false, false);
   }
    /**
	 *	refreshStudentNameW is used to refresh the latest value of a variable from the Serialized String
	 *  the most common reason to serialize an Object as a string in to write to a file. There can be several other reasons for serialization as well
	 */ 
   	public char[] refreshStudentNameW() {	 
   		return (substring(getStringValue(),beginStudentNameW,beginStudentNameW + STUDENT_NAME_W_LEN));
   	}
