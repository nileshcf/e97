...
import com.cloudframe.app.process.Cfsort06;
...
/**
 * The Cfsort06 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort06 cfsort06 = (Cfsort06) context.getBean("cfsort06");
        	    cfsort06.process(new GlobalExecutorCtx().getContext(Cfsort06Ctx.class)); /*  Cfsort06 requires no input parameters  */
