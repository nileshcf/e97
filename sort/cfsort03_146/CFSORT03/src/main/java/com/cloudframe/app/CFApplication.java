...
import com.cloudframe.app.process.Cfsort03;
...
/**
 * The Cfsort03 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort03 cfsort03 = (Cfsort03) context.getBean("cfsort03");
        	    cfsort03.process(new GlobalExecutorCtx().getContext(Cfsort03Ctx.class)); /*  Cfsort03 requires no input parameters  */
