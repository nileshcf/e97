package com.cloudframe.app.sorttbl.file;
...
@Component("sorttbl_scanner")
public class Scanner extends CFFile {


	private Logger logger = LoggerFactory.getLogger(Scanner.class);
	
	@Value("${SORTTBL.Scanner:SYSIN}")
	private String fileName;	

	@Value("${SORTTBL.ScannerCharSet:cp1047}")
	private String charSet;
	
	@Value("${SORTTBL.ScannerCRLFflag:no}")
