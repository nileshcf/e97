  ...
  @Component("ip666040")
  public class Ip666040Impl extends BaseProcess implements Ip666040 {
  	Logger logger = LoggerFactory.getLogger(Ip666040Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip666040impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
