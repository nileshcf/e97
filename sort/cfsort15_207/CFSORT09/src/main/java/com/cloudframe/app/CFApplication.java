...
/**
 * The Cfsort09 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort09 cfsort09 = (Cfsort09) context.getBean("cfsort09");
				...
				cfsort09.setParameter(new GlobalExecutorCtx().getContext(Cfsort09Ctx.class),inputValue);
