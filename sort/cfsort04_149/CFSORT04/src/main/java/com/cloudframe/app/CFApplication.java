...
import com.cloudframe.app.process.Cfsort04;
...
/**
 * The Cfsort04 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort04 cfsort04 = (Cfsort04) context.getBean("cfsort04");
        	    cfsort04.process(new GlobalExecutorCtx().getContext(Cfsort04Ctx.class)); /*  Cfsort04 requires no input parameters  */
