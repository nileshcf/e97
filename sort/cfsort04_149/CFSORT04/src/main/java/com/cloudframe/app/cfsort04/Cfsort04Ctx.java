package com.cloudframe.app.cfsort04;
...
@Context
public class Cfsort04Ctx implements ProgramContext, Cloneable {
    ...
    public Cfsort04Ctx clone() {
        Cfsort04Ctx cloneObj = new Cfsort04Ctx();
 ...
 */
     ...
     InputStudent inputStudent = Cfsort04Ctx.this.getInputStudent();
     WorkStudent workStudent = Cfsort04Ctx.this.getWorkStudent();
	 ...
	 */   
	 public WorkStudent getWorkStudent() {
   	return workStudent;
        ...
        public Cfsort04Ctx getCfsort04Ctx() {
            return Cfsort04Ctx.this;
        }
    ...
    public ProcessInCtx getProcessInCtx() {
     ...
     OutputStudent outputStudent = Cfsort04Ctx.this.getOutputStudent();
     Work work = Cfsort04Ctx.this.getWork();
     WorkStudent workStudent = Cfsort04Ctx.this.getWorkStudent();
