package com.cloudframe.app.cfsort05.file;
...
import com.cloudframe.app.cfsort05.file.records.*;

@Component("cfsort05_workInternOut")
public class WorkInternOut extends CFFile {

	private Logger logger = LoggerFactory.getLogger(WorkInternOut.class);
    ...
    **/
	...
	public void setWorkInternOutCharSet(String charSet) {
	   this.charSet = charSet;
	}
	
	private String crlfFlag;
	
	public void setWorkInternOutCRLFflag(String crlfFlag) {
	   this.crlfFlag = crlfFlag;
	}

	public String getWorkInternOutCharSet() {
		return charSet;
	}
	
	public String getWorkInternOutCrlfFlag() {
		return crlfFlag;
	}
	public WorkInternOut()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[30]);
		setFileName("WorkInternOut");
		setWorkInternOutCharSet("cp1047");
		setWorkInternOutCRLFflag("no");
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during WorkInternOut Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
