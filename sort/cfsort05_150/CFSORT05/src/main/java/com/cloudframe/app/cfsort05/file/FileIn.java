...
@Component("cfsort05_fileIn")
public class FileIn extends CFFile {

	private Logger logger = LoggerFactory.getLogger(FileIn.class);
	
	@Value("${CFSORT05.FileIn:FILEIN}")
    ...
    **/
	@Value("${CFSORT05.FileInCharSet:cp1047}")
	private String charSet;
	
	@Value("${CFSORT05.FileInCRLFflag:no}")
	private String crlfFlag;

	public String getFileInCharSet() {
		return charSet;
	}
	
	public String getFileInCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during FileIn Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
