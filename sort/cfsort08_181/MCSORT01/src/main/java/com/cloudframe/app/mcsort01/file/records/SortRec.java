...
public class SortRec extends SortRecSerialized { 
				...
				private SortRec2 sortRec2 = new SortRec2();
				private SortRec3 sortRec3 = new SortRec3();
	...
	**/
    public SortRec() {
		...
		/*  set the parent of each child as this which are a group variable */
	       			...
	       			sortRec2.setParent(this,getStartOffset() + 0);
	       			sortRec3.setParent(this,getStartOffset() + 0);
   ...
   public void setSortRec1(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	/**
	 *	Returns the value of sortRec2
	 *	@return sortRec2
	 */   
	 public SortRec2 getSortRec2() {
   	return sortRec2;
   }
   /**
	* 	Update SortRec2 with the passed value
	*   Corresponding COBOL Variable is SORT-REC2
	*	@param value
	*/
   public void setSortRec2(char[] value) {
      sortRec2.setString(value); 
   }   
	 ...
	 *	@param value
	 */
   public void setSortRec2(char[] source, int sourceIndex,int sourceLen) {
   	replace(source,sourceIndex,sourceLen,sortRec2.begin,sortRec2.length());
   }
	 ...
	 *	@param value
	 */
   public void setSortRec2(char[] source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
   	replace(source,sourceIndex,sourceLen,sortRec2.begin+targetIndex,targetLen);
   }
   
    /**
	 * 	Update SortRec2 with another Field
	 *	@param value
	 */
   public void setSortRec2(Field source) {
   	replace(source,0,source.length(),sortRec2.begin,sortRec2.length());
   }  
	 ...
	 *	@param value
	 */
   public void setSortRec2(Field source, int sourceIndex,int sourceLen) {
   	replace(source,sourceIndex,sourceLen,sortRec2.begin,sortRec2.length());
   }
	 ...
	 *	@param value
	 */
   public void setSortRec2(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
   	replace(source,sourceIndex,sourceLen,sortRec2.begin+targetIndex,targetLen);
   }
	/**
	 *	Returns the value of sortRec3
	 *	@return sortRec3
	 */   
	 public SortRec3 getSortRec3() {
   	return sortRec3;
   }
   /**
	* 	Update SortRec3 with the passed value
	*   Corresponding COBOL Variable is SORT-REC3
	*	@param value
	*/
   public void setSortRec3(char[] value) {
      sortRec3.setString(value); 
   }   
	 ...
	 *	@param value
	 */
   public void setSortRec3(char[] source, int sourceIndex,int sourceLen) {
   	replace(source,sourceIndex,sourceLen,sortRec3.begin,sortRec3.length());
   }
	 ...
	 *	@param value
	 */
   public void setSortRec3(char[] source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
   	replace(source,sourceIndex,sourceLen,sortRec3.begin+targetIndex,targetLen);
   }
   
    /**
	 * 	Update SortRec3 with another Field
	 *	@param value
	 */
   public void setSortRec3(Field source) {
   	replace(source,0,source.length(),sortRec3.begin,sortRec3.length());
   }  
	 ...
	 *	@param value
	 */
   public void setSortRec3(Field source, int sourceIndex,int sourceLen) {
   	replace(source,sourceIndex,sourceLen,sortRec3.begin,sortRec3.length());
   }
	 ...
	 *	@param value
	 */
   public void setSortRec3(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
   	replace(source,sourceIndex,sourceLen,sortRec3.begin+targetIndex,targetLen);
   }
	/**
