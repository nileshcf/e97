...
/**
 * The Mcsort01 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mcsort01 mcsort01 = (Mcsort01) context.getBean("mcsort01");
        	    mcsort01.process(new GlobalExecutorCtx().getContext(Mcsort01Ctx.class)); /*  Mcsort01 requires no input parameters  */
