...
/**
 * The Mcsort05 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mcsort05 mcsort05 = (Mcsort05) context.getBean("mcsort05");
        	    mcsort05.process(new GlobalExecutorCtx().getContext(Mcsort05Ctx.class)); /*  Mcsort05 requires no input parameters  */
