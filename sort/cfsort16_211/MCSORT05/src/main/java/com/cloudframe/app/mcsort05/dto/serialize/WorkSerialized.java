package com.cloudframe.app.mcsort05.dto.serialize;
...
public class WorkSerialized  extends Field { 
   ...
   protected char[] checkPgmVersion300Constraints(char[] value) {
     ...
     int localPgmMcsort05300Counter = -1;
     public boolean isPgmMcsort05300Modified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localPgmMcsort05300Counter != sharedCounter;
         localPgmMcsort05300Counter = sharedCounter; return hasModified;
     }

   protected char[] checkPgmMcsort05300Constraints(char[] value) {
   ...
   protected char[] checkPgmIp996010300Constraints(char[] value) {
     ...
     int localEndOfStepMsg301Counter = -1;
     public boolean isEndOfStepMsg301Modified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localEndOfStepMsg301Counter != sharedCounter;
         localEndOfStepMsg301Counter = sharedCounter; return hasModified;
     }

   protected char[] checkEndOfStepMsg301Constraints(char[] value) {
