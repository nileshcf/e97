...
@Component("mcsort05_sys201SortedGroupStatFile")
public class Sys201SortedGroupStatFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201SortedGroupStatFile.class);
	
	@Value("${MCSORT05.Sys201SortedGroupStatFile:SYS201}")
    ...
    **/
	@Value("${MCSORT05.Sys201SortedGroupStatFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${MCSORT05.Sys201SortedGroupStatFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys201SortedGroupStatFileCharSet() {
		return charSet;
	}
	
	public String getSys201SortedGroupStatFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys201SortedGroupStatFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201SortedGroupStatFile Write: {}",e.getMessage() ); 		}
	}
