...
/**
 * The Mcsort02 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mcsort02 mcsort02 = (Mcsort02) context.getBean("mcsort02");
        	    mcsort02.process(new GlobalExecutorCtx().getContext(Mcsort02Ctx.class)); /*  Mcsort02 requires no input parameters  */
