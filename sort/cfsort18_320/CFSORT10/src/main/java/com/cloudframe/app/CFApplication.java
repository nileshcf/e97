...
/**
 * The Cfsort10 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Cfsort10 cfsort10 = (Cfsort10) context.getBean("cfsort10");
        	    cfsort10.process(new GlobalExecutorCtx().getContext(Cfsort10Ctx.class)); /*  Cfsort10 requires no input parameters  */
