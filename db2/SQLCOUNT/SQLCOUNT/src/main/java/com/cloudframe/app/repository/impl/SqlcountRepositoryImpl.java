...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(1/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec1(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(2/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec2(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(3/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec3(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(4/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec4(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(5/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec5(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(6/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec6(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(7/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
...
******  FROM TBDEMSEC                                              
**/
    public void selectTbdemsec7(Sqlca sqlca, Work work) throws Exception {
try {
	// SELECT 
	// reset SQLCODE
	sqlca.setSqlcode(0);
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(8/* SQL Sequence*/, CONSTANTS.LITERAL_SQLCOUNT)
