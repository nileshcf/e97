package com.cloudframe.app.db2funci.file;
...
@Component("db2funci_scanner")
public class Scanner extends CFFile {


	private Logger logger = LoggerFactory.getLogger(Scanner.class);
	
	@Value("${DB2FUNCI.Scanner:SYSIN}")
	private String fileName;	

	@Value("${DB2FUNCI.ScannerCharSet:cp1047}")
	private String charSet;
	
	@Value("${DB2FUNCI.ScannerCRLFflag:no}")
