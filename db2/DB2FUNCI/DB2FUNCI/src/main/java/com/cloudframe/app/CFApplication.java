...
/**
 * The Db2funci application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Db2funci db2funci = (Db2funci) context.getBean("db2funci");
				...
				db2funci.setParameter(new GlobalExecutorCtx().getContext(Db2funciCtx.class),inputValue);
