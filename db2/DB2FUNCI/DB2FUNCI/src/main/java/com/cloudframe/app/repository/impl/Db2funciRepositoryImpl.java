...
public class Db2funciRepositoryImpl implements Db2funciRepository {
    Logger logger = LoggerFactory.getLogger(Db2funciRepositoryImpl.class);
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(21/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
   ...
   java.sql.CallableStatement cs = db2Base.callableStatement(22/* SQL Sequence*/,SQLS.SQL_112483823,CONSTANTS.LITERAL_DB2FUNCI);
...
try {
   ...
   // execute Call procedure
   // make sure currentSchema and currentFunctionPath are both set
   java.sql.CallableStatement cs = db2Base.callableStatement(26/* SQL Sequence*/,SQLS.SQL_1772696462,CONSTANTS.LITERAL_DB2FUNCI);
   // set input and output
   db2Base.setInput(cs, inputParms, dataTypes);
   // dataType is also an output
   db2Base.setOutput(cs, dataTypes);
...
// methodEnd:call1
// methodStart:openPositionCursorDb2funci
...
try {
	//OPEN CURSOR
	sqlca.setSqlcode(0);
	positionCursorResultSet = db2Base.startQuery(12/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
return positionCursorResultSet;
    }
// methodEnd:openPositionCursorDb2funci
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(28/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(29/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(30/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
// methodStart:openXrefCursorDb2funci
...
try {
	//OPEN CURSOR
	sqlca.setSqlcode(0);
	xrefCursorResultSet = db2Base.startQuery(17/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
return xrefCursorResultSet;
    }
// methodEnd:openXrefCursorDb2funci
// methodStart:fetchXrefCursorDb2funci
...
// methodEnd:fetchXrefCursorDb2funci
// methodStart:closeXrefCursorDb2funci
...
**/
	...
	closeCursor(xrefCursorResultSet,sqlca);

    }
// methodEnd:closeXrefCursorDb2funci
// methodStart:openIsinCursorDb2funci
...
try {
	//OPEN CURSOR
	sqlca.setSqlcode(0);
	isinCursorResultSet = db2Base.startQuery(16/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
return isinCursorResultSet;
    }
// methodEnd:openIsinCursorDb2funci
// methodStart:fetchIsinCursorDb2funci
...
// methodEnd:fetchIsinCursorDb2funci
...
try {
    ...
    sqlca.setSqlcode(0);
    // execute SQLJ query
    int count = db2Base.startQuery(36/* SQL Sequence*/,CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(37/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
// methodStart:closeIsinCursorDb2funci
...
**/
	...
	closeCursor(isinCursorResultSet,sqlca);

    }
// methodEnd:closeIsinCursorDb2funci
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(40/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(41/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(42/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
