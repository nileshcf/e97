...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(21/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(28/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(29/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(30/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(37/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(40/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(41/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(42/* SQL Sequence*/, CONSTANTS.LITERAL_DB2FUNCI)
