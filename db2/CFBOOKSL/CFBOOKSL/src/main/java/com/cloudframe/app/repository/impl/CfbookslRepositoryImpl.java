...
public class CfbookslRepositoryImpl implements CfbookslRepository {
    Logger logger = LoggerFactory.getLogger(CfbookslRepositoryImpl.class);
...
// methodStart:openBookscurCfbooksl
...
try {
	//OPEN CURSOR
	sqlca.setSqlcode(0);
	bookscurResultSet = db2Base.startQuery(1/* SQL Sequence*/, CONSTANTS.LITERAL_CFBOOKSL)
    .withSql(SQLS.SQL_951825871)
		.queryForList();
}
...
// methodEnd:openBookscurCfbooksl
// methodStart:closeBookscurCfbooksl
...
// methodEnd:closeBookscurCfbooksl
// methodStart:fetchBookscurCfbooksl
...
**/
    public void fetchBookscurCfbooksl(Nullvars nullvars, Sqlca sqlca, Dclbooks dclbooks) throws Exception {
try {
...
// methodEnd:fetchBookscurCfbooksl
