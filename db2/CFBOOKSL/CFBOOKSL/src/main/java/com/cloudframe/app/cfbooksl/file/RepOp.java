package com.cloudframe.app.cfbooksl.file;
...
import com.cloudframe.app.cfbooksl.file.records.*;

@Component("cfbooksl_repOp")
public class RepOp extends CFFile {

	private Logger logger = LoggerFactory.getLogger(RepOp.class);
	
	@Value("${CFBOOKSL.RepOp:REPOP}")
    ...
    **/
	@Value("${CFBOOKSL.RepOpCharSet:cp1047}")
	private String charSet;
	
	@Value("${CFBOOKSL.RepOpCRLFflag:no}")
