package com.cloudframe.app.cfbooksl;
...
import com.cloudframe.app.cfbooksl.dto.Sqlwarn;
...
import com.cloudframe.app.cfbooksl.dto.BooksIsbn;
...
import com.cloudframe.app.cfbooksl.dto.BooksTitle;
import com.cloudframe.app.cfbooksl.file.records.RepOpFields;


@Context
public class CfbookslCtx implements ProgramContext, Cloneable {
    ...
    public CfbookslCtx clone() {
        CfbookslCtx cloneObj = new CfbookslCtx();
 ...
 */
     ...
     HeaderTime headerTime = CfbookslCtx.this.getHeaderTime();
     Sqlca sqlca = CfbookslCtx.this.getSqlca();
     Work work = CfbookslCtx.this.getWork();
   ...
   public void setSqlwarn(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	public void setSqlerrd(int index,long number)  throws CFException{
        ...
        public CfbookslCtx getCfbookslCtx() {
            return CfbookslCtx.this;
        }
	...
	*/
    ...
    public MainOutCtx getMainOutCtx() {
     ...
     HeaderTime headerTime = CfbookslCtx.this.getHeaderTime();
     Vars vars = CfbookslCtx.this.getVars();
     Sqlca sqlca = CfbookslCtx.this.getSqlca();
     Work work = CfbookslCtx.this.getWork();
     RepOpFields repOpFields = CfbookslCtx.this.getRepOpFields();
     HeaderTitle headerTitle = CfbookslCtx.this.getHeaderTitle();
     Dclbooks dclbooks = CfbookslCtx.this.getDclbooks();
   ...
   public void setErrLoc(char[] value) throws CFException {
    ...
    public WriteHeaderOutCtx getWriteHeaderOutCtx() {
     ...
     Sqlca sqlca = CfbookslCtx.this.getSqlca();
     Nullvars nullvars = CfbookslCtx.this.getNullvars();
     Work work = CfbookslCtx.this.getWork();
     Dclbooks dclbooks = CfbookslCtx.this.getDclbooks();
