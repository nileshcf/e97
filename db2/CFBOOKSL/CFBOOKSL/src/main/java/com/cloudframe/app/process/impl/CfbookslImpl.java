...
*/
  ...
  import com.cloudframe.app.cfbooksl.CfbookslCtx;
  import com.cloudframe.app.process.Cfbooksl;
  ...
  import com.cloudframe.app.repository.CfbookslRepository;
  import com.cloudframe.app.exception.Terminate;
  import com.cloudframe.app.cfbooksl.file.*;
  ...
  import com.cloudframe.app.cfbooksl.dto.HeaderTime;
  import com.cloudframe.app.cfbooksl.dto.Sqlca;
  import com.cloudframe.app.cfbooksl.dto.HeaderTitle;
  import com.cloudframe.app.cfbooksl.dto.Vars;
  import com.cloudframe.app.cfbooksl.file.records.RepOpFields;
  import com.cloudframe.app.cfbooksl.dto.Dclbooks;
  import com.cloudframe.app.cfbooksl.dto.Nullvars;
  import com.cloudframe.app.cfbooksl.dto.Work;
  ...
  public class CfbookslImpl extends CommonProcess implements Cfbooksl {
  
  Logger logger = LoggerFactory.getLogger(CfbookslImpl.class);
  
  
  @Value("${CFBOOKSL.dbQualifier:}")
  ...
  Db2Base db2Base;
  @Autowired 
  @Qualifier("cfbookslRepository")
  CfbookslRepository cfbookslRepository;
  @Autowired 
  @Qualifier("cfbooksl_repOp")
  RepOp repOp;
      ...
      */
      public int process(CfbookslCtx programCtx) throws Exception {
       ...
       setCodePage("1047");
      	...
      	db2Base.reset("CFBOOKSL" ,dbQualifier, true/*use Dynamic SQL*/);
          ;
//  PERFORM 0000-MAIN
...
//  SELECT BOOK_ID , RTRIM ( TITLE ) , TOTAL_PAGES , RATING , ISBN , PUBLISHED_DATE , PUBLISHER_ID FROM BOOKS ORDER BY BOOK_ID ASC WITH UR
          programCtx.setBookscurResultSet(cfbookslRepository.openBookscurCfbooksl(programCtx.getSqlca()));
...
//  CLOSE BOOKSCUR
          cfbookslRepository.closeBookscurCfbooksl(programCtx.getBookscurResultSet(),programCtx.getSqlca());
...
// *-----------------------------------------------------------------
CfbookslCtx programCtx = methodIn.getCfbookslCtx();
...
//  FETCH BOOKSCUR INTO ? , ? , ? , ? , ? , ? , ?
          cfbookslRepository.fetchBookscurCfbooksl(programCtx.getBookscurResultSet(),programCtx.getSqlca(),methodOut.getNullvars(),methodOut.getDclbooks());
