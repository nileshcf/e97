...
/**
 * The Db2prog1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Db2prog1 db2prog1 = (Db2prog1) context.getBean("db2prog1");
        	    db2prog1.process(new GlobalExecutorCtx().getContext(Db2prog1Ctx.class)); /*  Db2prog1 requires no input parameters  */
