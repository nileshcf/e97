...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(3/* SQL Sequence*/, CONSTANTS.LITERAL_DB2PROG1)
...
**/
	...
	closeCursor(widgetResultSet,sqlca);
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(13/* SQL Sequence*/, CONSTANTS.LITERAL_DB2PROG1)
