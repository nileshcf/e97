...
public class Db2prog1RepositoryImpl implements Db2prog1Repository {
    Logger logger = LoggerFactory.getLogger(Db2prog1RepositoryImpl.class);
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(3/* SQL Sequence*/, CONSTANTS.LITERAL_DB2PROG1)
...
try {
    ...
    sqlca.setSqlcode(0);
    // execute SQLJ query
    int count = db2Base.startQuery(4/* SQL Sequence*/,CONSTANTS.LITERAL_DB2PROG1)
    .withSql(SQLS.SQL_598208237)
...
try {
    ...
    sqlca.setSqlcode(0);
    // execute SQLJ query
    int count = db2Base.startQuery(6/* SQL Sequence*/,CONSTANTS.LITERAL_DB2PROG1)
    .withSql(SQLS.SQL_158960836)
...
// methodStart:openWidgetDb2prog1
...
try {
	//OPEN CURSOR
	sqlca.setSqlcode(0);
	widgetResultSet = db2Base.startQuery(2/* SQL Sequence*/, CONSTANTS.LITERAL_DB2PROG1)
...
// methodEnd:openWidgetDb2prog1
// methodStart:fetchWidgetDb2prog1
...
******             :WIDGET-LEAD-TIME                               
**/
    public void fetchWidgetDb2prog1(Tbwidget tbwidget, Sqlca sqlca) throws Exception {
try {
...
// methodEnd:fetchWidgetDb2prog1
// methodStart:closeWidgetDb2prog1
...
try {
	...
	sqlca.setSqlcode(0);
	// execute SQLJ query
	int count = db2Base.startQuery(11/* SQL Sequence*/,CONSTANTS.LITERAL_DB2PROG1)
...
try {
	...
	// execute SQLJ query
	resultSet = db2Base.startQuery(13/* SQL Sequence*/, CONSTANTS.LITERAL_DB2PROG1)
