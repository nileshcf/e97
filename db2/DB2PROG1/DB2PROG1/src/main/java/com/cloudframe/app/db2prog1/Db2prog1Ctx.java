package com.cloudframe.app.db2prog1;
...
import com.cloudframe.app.db2prog1.dto.Sqlwarn;
...
@Context
public class Db2prog1Ctx implements ProgramContext, Cloneable {
    ...
    public Db2prog1Ctx clone() {
        Db2prog1Ctx cloneObj = new Db2prog1Ctx();
 ...
 */
     ...
     Work work = Db2prog1Ctx.this.getWork();
	...
	*  @param value
	**/
   public void setDb2prog201(char[] value) throws CFException {
      work.setDb2prog201(value);
   } 


        public Db2prog1Ctx getDb2prog1Ctx() {
            return Db2prog1Ctx.this;
        }
    ...
    public MainOutCtx getMainOutCtx() {
     ...
     Dclbooks dclbooks = Db2prog1Ctx.this.getDclbooks();
     Sqlca sqlca = Db2prog1Ctx.this.getSqlca();
   ...
   public void setSqlwarn(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public Process1000OutCtx getProcess1000OutCtx() {
     ...
     Tbwidget tbwidget = Db2prog1Ctx.this.getTbwidget();
     Sqlca sqlca = Db2prog1Ctx.this.getSqlca();
     Work work = Db2prog1Ctx.this.getWork();
