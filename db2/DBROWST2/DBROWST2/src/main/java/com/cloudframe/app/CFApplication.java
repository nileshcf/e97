...
/**
 * The Dbrowst2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Dbrowst2 dbrowst2 = (Dbrowst2) context.getBean("dbrowst2");
        	    dbrowst2.process(new GlobalExecutorCtx().getContext(Dbrowst2Ctx.class)); /*  Dbrowst2 requires no input parameters  */
