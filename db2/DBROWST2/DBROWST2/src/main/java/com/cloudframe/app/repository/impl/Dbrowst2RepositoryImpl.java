...
public class Dbrowst2RepositoryImpl implements Dbrowst2Repository {
    Logger logger = LoggerFactory.getLogger(Dbrowst2RepositoryImpl.class);
...
// methodStart:openSecCursorDbrowst2
...
try {
	//OPEN CURSOR
	sqlca.setSqlcode(0);
	secCursorResultSet = db2Base.startQuery(1/* SQL Sequence*/, CONSTANTS.LITERAL_DBROWST2)
...
// methodEnd:openSecCursorDbrowst2
// methodStart:fetchSecCursorDbrowst2
...
******             ,:WS-RIC                                        
**/
    public void fetchSecCursorDbrowst2(Sqlca sqlca, SecTable secTable) throws Exception {
try {
   boolean hasResults = true;
   sqlca.setSqlcode(0);
   int ftchRowCnt = 0;
   while (hasResults && ftchRowCnt < 30) {
...
// methodEnd:fetchSecCursorDbrowst2
// methodStart:closeSecCursorDbrowst2
...
// methodEnd:closeSecCursorDbrowst2
