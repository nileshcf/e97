...
/**
 * The Db2set3 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Db2set3 db2set3 = (Db2set3) context.getBean("db2set3");
        	    db2set3.process(new GlobalExecutorCtx().getContext(Db2set3Ctx.class)); /*  Db2set3 requires no input parameters  */
