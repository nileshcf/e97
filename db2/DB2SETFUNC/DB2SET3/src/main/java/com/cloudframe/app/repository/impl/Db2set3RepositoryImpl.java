...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(0/* SQL Sequence*/, CONSTANTS.LITERAL_DB2SET3)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(1/* SQL Sequence*/, CONSTANTS.LITERAL_DB2SET3)
