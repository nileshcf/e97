...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(0/* SQL Sequence*/, CONSTANTS.LITERAL_VARCHAR1)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(1/* SQL Sequence*/, CONSTANTS.LITERAL_VARCHAR1)
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(2/* SQL Sequence*/, CONSTANTS.LITERAL_VARCHAR1)
