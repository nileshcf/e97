...
/**
 * The Varchar1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Varchar1 varchar1 = (Varchar1) context.getBean("varchar1");
        	    varchar1.process(new GlobalExecutorCtx().getContext(Varchar1Ctx.class)); /*  Varchar1 requires no input parameters  */
