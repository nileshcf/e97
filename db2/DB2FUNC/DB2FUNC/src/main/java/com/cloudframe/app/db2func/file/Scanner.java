package com.cloudframe.app.db2func.file;
...
@Component("db2func_scanner")
public class Scanner extends CFFile {


	private Logger logger = LoggerFactory.getLogger(Scanner.class);
	
	@Value("${DB2FUNC.Scanner:SYSIN}")
	private String fileName;	

	@Value("${DB2FUNC.ScannerCharSet:cp1047}")
	private String charSet;
	
	@Value("${DB2FUNC.ScannerCRLFflag:no}")
