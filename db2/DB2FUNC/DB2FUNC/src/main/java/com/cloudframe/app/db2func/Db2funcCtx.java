package com.cloudframe.app.db2func;
...
import com.cloudframe.app.db2func.dto.MsdSecurityDesc1;
import com.cloudframe.app.db2func.dto.Bdms01CallParameters;
import com.cloudframe.app.db2func.dto.Dclvbsscrdt;
import com.cloudframe.app.db2func.dto.MsdAddedCcyymmdd;
...
import com.cloudframe.app.db2func.dto.Sqlwarn;
import com.cloudframe.app.db2func.dto.MsdSecTypeCodes;
...
public class Db2funcCtx implements ProgramContext, Cloneable {
    ...
    public Db2funcCtx clone() {
        Db2funcCtx cloneObj = new Db2funcCtx();
 ...
 */
     ...
     Parm parm = Db2funcCtx.this.getParm();


        public Db2funcCtx getDb2funcCtx() {
            return Db2funcCtx.this;
        }
    ...
    public ProcessInCtx getProcessInCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     Parm parm = Db2funcCtx.this.getParm();
     AcceptInput acceptInput = Db2funcCtx.this.getAcceptInput();
     Work work = Db2funcCtx.this.getWork();
	...
	*/
    ...
    public ProcessCommandInCtx getProcessCommandInCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     DateFields dateFields = Db2funcCtx.this.getDateFields();
   ...
   public void setCurrentDate(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public Date1000OutCtx getDate1000OutCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     ParmlstGroup parmlstGroup = Db2funcCtx.this.getParmlstGroup();
     Work work = Db2funcCtx.this.getWork();
   ...
   public void setSqlerrmc(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	 ...
	 *	@return loc1
	 */
	public int getLoc1() throws CFException {        
   		return work.getLoc1();
	}
	
	/**
	 * 	Update Loc1 with the passed value
	 *	@param number
	 */
	public void setLoc1(int number)  throws CFException{
		work.setLoc1(number);
	}


	public void setLoc1(long number)  throws CFException{
		work.setLoc1((int)number);
	}
   ...
   public void setProcnm(char[] value) throws CFException {
	...
	/**
	 *	Returns the value of dsnpnm
	 *	@return dsnpnm
	 */
   public char[] getDsnpnm() throws CFException  {              
   		return work.getDsnpnm();
   }
	...
	*  @param value
	**/
   public void setDsnpnm(char[] value) throws CFException {
      work.setDsnpnm(value);
   } 
   ...
   public void setSqlcodeDisp(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public SpGetprmlOutCtx getSpGetprmlOutCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     Dcltbdemsec dcltbdemsec = Db2funcCtx.this.getDcltbdemsec();
     C1Dtl c1Dtl = Db2funcCtx.this.getC1Dtl();
     Work work = Db2funcCtx.this.getWork();
   ...
   public void setCurrency(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	/**
	 *	Returns the value of dsncnm
	 *	@return dsncnm
	 */
   public char[] getDsncnm() throws CFException  {              
   		return work.getDsncnm();
   }
	...
	*  @param value
	**/
   public void setDsncnm(char[] value) throws CFException {
      work.setDsncnm(value);
   } 
   ...
   public void setSedol01(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public GetIsinDtlsOutCtx getGetIsinDtlsOutCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     Bdms01CallParameters bdms01CallParameters = Db2funcCtx.this.getBdms01CallParameters();
     Sdms01Parm sdms01Parm = Db2funcCtx.this.getSdms01Parm();
     Work work = Db2funcCtx.this.getWork();
   ...
   public void setMsdTypeOfRecordInd(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public SpGetdataOutCtx getSpGetdataOutCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     ApplicationCodeListGroup applicationCodeListGroup = Db2funcCtx.this.getApplicationCodeListGroup();
     Dclscpsectb dclscpsectb = Db2funcCtx.this.getDclscpsectb();
     HostVariables hostVariables = Db2funcCtx.this.getHostVariables();
   ...
   public void setCurrentDate(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public DateSubstringCharOutCtx getDateSubstringCharOutCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     Bdms01CallParameters bdms01CallParameters = Db2funcCtx.this.getBdms01CallParameters();
     Dclvmstranb dclvmstranb = Db2funcCtx.this.getDclvmstranb();
     Db2Indicators db2Indicators = Db2funcCtx.this.getDb2Indicators();
...
public int getMcgillCd() throws CFException {  
   ...
   public void setSecurityAdpNbr(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public SecurityLookupOutCtx getSecurityLookupOutCtx() {
     ...
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
     Dclvcrrexrt dclvcrrexrt = Db2funcCtx.this.getDclvcrrexrt();
     Work work = Db2funcCtx.this.getWork();
   ...
   public void setDecimalEdit(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
    ...
    public CurrencyOutCtx getCurrencyOutCtx() {
     ...
     Dclvmsdxrfk dclvmsdxrfk = Db2funcCtx.this.getDclvmsdxrfk();
     Sqlca sqlca = Db2funcCtx.this.getSqlca();
	...
	*/
    ...
    public IsinOutCtx getIsinOutCtx() {
     ...
     Bdms01CallParameters bdms01CallParameters = Db2funcCtx.this.getBdms01CallParameters();
     Db2Indicators db2Indicators = Db2funcCtx.this.getDb2Indicators();
     Dclvbsscrdt dclvbsscrdt = Db2funcCtx.this.getDclvbsscrdt();
     Work work = Db2funcCtx.this.getWork();
