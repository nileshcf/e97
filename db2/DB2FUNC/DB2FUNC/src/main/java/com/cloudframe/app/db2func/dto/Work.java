...
public class Work extends WorkSerialized {
						...
						private char[] dsnpnm = Field.fillLowValue(386);

						private char[] dsncnm = Field.fillLowValue(128);
	...
	*/
	 ...
	 *	@param number
	 */
	public void setLoc1(int number) {
	     // Truncate if the number is beyond +/- Max range
	    loc1 = checkLoc1MaxLimit(number); 
	}


	public void setLoc1(long number) {
	    number = checkLoc1MaxLimit(number); // Truncate if value is beyond +/- Max range
		setLoc1((int)number);
	}
   ...
   public char[] getDsnpnm() throws CFException{
	...
	/**
	*  set variable dsnpnm
	*  Corresponding COBOL Variable is DSNPNM
	*  @param value
	**/
   public void setDsnpnm(char[] value) {
       value = checkDsnpnmConstraints(value);
       arraycopy(value,0,dsnpnm,0,value.length);
   } 
	public void setDsnpnm(char[] value , int beginIndex, int endIndex) {
       //value = checkL1CtlData801Constraints(value);
       arraycopy(value,beginIndex,dsnpnm,0,beginIndex + endIndex);
   }
	/**
   ...
   public char[] getDsncnm() throws CFException{
	...
	/**
	*  set variable dsncnm
	*  Corresponding COBOL Variable is DSNCNM
	*  @param value
	**/
   public void setDsncnm(char[] value) {
       value = checkDsncnmConstraints(value);
       arraycopy(value,0,dsncnm,0,value.length);
   } 
	public void setDsncnm(char[] value , int beginIndex, int endIndex) {
       //value = checkL1CtlData801Constraints(value);
       arraycopy(value,beginIndex,dsncnm,0,beginIndex + endIndex);
   }
