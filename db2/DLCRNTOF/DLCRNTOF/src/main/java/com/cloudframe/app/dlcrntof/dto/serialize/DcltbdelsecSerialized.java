...
/**
*  The class DcltbdelsecSerialized is used to define offsets in order to serialize
*  in a fixed String
...
public class DcltbdelsecSerialized  extends Field { 

    protected Logger logger = LoggerFactory.getLogger(DcltbdelsecSerialized.class);
	/*  Length of the field, if serialized as a String */
	protected static final int DCLTBDELSEC_LENGTH = 175;
   /*  offset of each of Child Fields when serialized as a String */
	...
	/**
	* Constructor for DcltbdelsecSerialized
	**/
    public DcltbdelsecSerialized() {
		   			init(0);
    }
 
	/**
	* initializes the field in DcltbdelsecSerialized
	**/
	@Override
	protected void init(int begin) {
	   setStartOffset(begin);
	   setLength(DCLTBDELSEC_LENGTH);
