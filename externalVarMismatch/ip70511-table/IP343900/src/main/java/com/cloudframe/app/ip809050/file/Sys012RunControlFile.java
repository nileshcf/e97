...
@Component("ip809050_sys012RunControlFile")
public class Sys012RunControlFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys012RunControlFile.class);
	
	@Value("${IP809050.Sys012RunControlFile:SYS012}")
    ...
    **/
	@Value("${IP809050.Sys012RunControlFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys012RunControlFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys012RunControlFileCharSet() {
		return charSet;
	}
	
	public String getSys012RunControlFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys012RunControlFile()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys012RunControlFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
