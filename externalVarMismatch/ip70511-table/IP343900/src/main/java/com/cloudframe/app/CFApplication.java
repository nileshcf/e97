...
/**
 * The Ip343900 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Ip343900 ip343900 = (Ip343900) context.getBean("ip343900");
				...
				ip343900.setParameter(new GlobalExecutorCtx().getContext(Ip343900Ctx.class),inputValue);
