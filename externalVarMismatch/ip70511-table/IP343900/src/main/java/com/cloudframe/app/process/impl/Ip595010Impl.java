  ...
  @Component("ip595010")
  public class Ip595010Impl extends BaseProcess implements Ip595010 {
  	Logger logger = LoggerFactory.getLogger(Ip595010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip595010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
