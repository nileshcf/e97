  ...
  @Component("ip282240")
  public class Ip282240Impl extends BaseProcess implements Ip282240 {
  	Logger logger = LoggerFactory.getLogger(Ip282240Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip282240impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
