  ...
  @Component("ip760010")
  public class Ip760010Impl extends BaseProcess implements Ip760010 {
  	Logger logger = LoggerFactory.getLogger(Ip760010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip760010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
