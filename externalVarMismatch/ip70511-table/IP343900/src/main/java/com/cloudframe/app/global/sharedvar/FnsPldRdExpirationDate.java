...
public class FnsPldRdExpirationDate extends FnsPldRdExpirationDateSerialized { 
						...
						@Getter @Setter private char[] fnsPldRdExprMonth = Field.fillLowValue(2);
				@Getter @Setter private FnsPldRdExprYear fnsPldRdExprYear = new FnsPldRdExprYear();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getFnsPldRdExprYear().setParent(this,getStartOffset() + 2);
    } 
   ...
   public void initialize() {
         setFnsPldRdExprMonth(CONSTANTS.SPACE_2);
          getFnsPldRdExprYear().initialize();
