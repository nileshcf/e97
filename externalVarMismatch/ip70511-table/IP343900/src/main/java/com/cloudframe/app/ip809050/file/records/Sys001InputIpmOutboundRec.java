...
/**
*  The class Sys001InputIpmOutboundRec is used to handle fields declared in it
...
public class Sys001InputIpmOutboundRec extends Sys001InputIpmOutboundRecSerialized {
   
      private List<char[]> filler; 

	
	/**
	* Constructor for Sys001InputIpmOutboundRec
	**/
    public Sys001InputIpmOutboundRec() {
		super();
   ...
   private void setFiller(int index,char[] value,boolean setModified) {
	...
	// String array will always read from stringValue so no need to explicitly set the array item
  	if (setModified) {
		...
		public static int getSys001InputIpmOutboundRecFieldLength() {
			return SYS_001_INPUT_IPM_OUTBOUND_REC_LENGTH;
		}
