  ...
  @Component("ip595210")
  public class Ip595210Impl extends BaseProcess implements Ip595210 {
  	Logger logger = LoggerFactory.getLogger(Ip595210Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip595210impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
