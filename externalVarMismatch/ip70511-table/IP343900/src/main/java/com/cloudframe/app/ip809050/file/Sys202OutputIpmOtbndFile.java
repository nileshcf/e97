...
@Component("ip809050_sys202OutputIpmOtbndFile")
public class Sys202OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys202OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys202OutputIpmOtbndFile:SYS202}")
    ...
    **/
	@Value("${IP809050.Sys202OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys202OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys202OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys202OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys202OutputIpmOtbndFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys202OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
