...
@Component("ip809050_sys201OutputIpmOtbndFile")
public class Sys201OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys201OutputIpmOtbndFile:SYS201}")
    ...
    **/
	@Value("${IP809050.Sys201OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys201OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys201OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys201OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys201OutputIpmOtbndFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
