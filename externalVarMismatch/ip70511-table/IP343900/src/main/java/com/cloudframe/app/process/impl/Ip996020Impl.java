  ...
  @Component("ip996020")
  public class Ip996020Impl extends BaseProcess implements Ip996020 {
  	Logger logger = LoggerFactory.getLogger(Ip996020Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip996020impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
