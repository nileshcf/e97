  ...
  @Component("ip752010")
  public class Ip752010Impl extends BaseProcess implements Ip752010 {
  	Logger logger = LoggerFactory.getLogger(Ip752010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip752010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
