  ...
  @Component("ip708010")
  public class Ip708010Impl extends BaseProcess implements Ip708010 {
  	Logger logger = LoggerFactory.getLogger(Ip708010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip708010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
