...
@Component("ip809050_sys203OutputIpmOtbndFile")
public class Sys203OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys203OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys203OutputIpmOtbndFile:SYS203}")
    ...
    **/
	@Value("${IP809050.Sys203OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys203OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys203OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys203OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys203OutputIpmOtbndFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys203OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
