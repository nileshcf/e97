...
@Component("ip809050_sys205OutputIpmOtbndFile")
public class Sys205OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys205OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys205OutputIpmOtbndFile:SYS205}")
    ...
    **/
	@Value("${IP809050.Sys205OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys205OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys205OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys205OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys205OutputIpmOtbndFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys205OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
