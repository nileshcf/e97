  ...
  @Component("ip521010")
  public class Ip521010Impl extends BaseProcess implements Ip521010 {
  	Logger logger = LoggerFactory.getLogger(Ip521010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip521010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
