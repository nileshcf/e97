...
@Component("ip798030_sys202PmaFile")
public class Sys202PmaFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys202PmaFile.class);
	
	@Value("${IP798030.Sys202PmaFile:SYS202}")
    ...
    **/
	@Value("${IP798030.Sys202PmaFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP798030.Sys202PmaFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys202PmaFileCharSet() {
		return charSet;
	}
	
	public String getSys202PmaFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys202PmaFile()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys202PmaFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys202PmaFile Write: {}",e.getMessage() ); 		}
	}
