...
@Component("ip809050_sys204OutputIpmOtbndFile")
public class Sys204OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys204OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys204OutputIpmOtbndFile:SYS204}")
    ...
    **/
	@Value("${IP809050.Sys204OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys204OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys204OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys204OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys204OutputIpmOtbndFile()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[600]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys204OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
