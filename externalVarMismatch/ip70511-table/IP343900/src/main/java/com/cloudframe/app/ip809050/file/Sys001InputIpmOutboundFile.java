package com.cloudframe.app.ip809050.file;
...
import com.cloudframe.app.ip809050.file.records.*;

@Component("ip809050_sys001InputIpmOutboundFile")
public class Sys001InputIpmOutboundFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001InputIpmOutboundFile.class);
	
	@Value("${IP809050.Sys001InputIpmOutboundFile:SYS001}")
    ...
    **/
	@Value("${IP809050.Sys001InputIpmOutboundFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys001InputIpmOutboundFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys001InputIpmOutboundFileCharSet() {
		return charSet;
	}
	
	public String getSys001InputIpmOutboundFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys001InputIpmOutboundFile()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001InputIpmOutboundFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
