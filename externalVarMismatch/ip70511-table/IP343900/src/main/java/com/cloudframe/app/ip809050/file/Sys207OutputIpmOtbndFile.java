...
@Component("ip809050_sys207OutputIpmOtbndFile")
public class Sys207OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys207OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys207OutputIpmOtbndFile:SYS207}")
    ...
    **/
	@Value("${IP809050.Sys207OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys207OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys207OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys207OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys207OutputIpmOtbndFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys207OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
