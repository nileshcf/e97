  ...
  @Component("ip586010")
  public class Ip586010Impl extends BaseProcess implements Ip586010 {
  	Logger logger = LoggerFactory.getLogger(Ip586010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip586010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
