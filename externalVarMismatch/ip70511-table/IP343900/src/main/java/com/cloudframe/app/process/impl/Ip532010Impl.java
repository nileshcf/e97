  ...
  @Component("ip532010")
  public class Ip532010Impl extends BaseProcess implements Ip532010 {
  	Logger logger = LoggerFactory.getLogger(Ip532010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip532010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
