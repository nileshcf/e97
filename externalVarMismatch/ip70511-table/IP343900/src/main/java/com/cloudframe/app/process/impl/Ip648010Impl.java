  ...
  @Component("ip648010")
  public class Ip648010Impl extends BaseProcess implements Ip648010 {
  	Logger logger = LoggerFactory.getLogger(Ip648010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip648010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
