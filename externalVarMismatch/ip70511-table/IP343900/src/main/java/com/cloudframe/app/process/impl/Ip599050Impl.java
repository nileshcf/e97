  ...
  @Component("ip599050")
  public class Ip599050Impl extends BaseProcess implements Ip599050 {
  	Logger logger = LoggerFactory.getLogger(Ip599050Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip599050impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
