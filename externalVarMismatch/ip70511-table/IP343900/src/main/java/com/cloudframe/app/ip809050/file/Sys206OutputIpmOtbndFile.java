...
@Component("ip809050_sys206OutputIpmOtbndFile")
public class Sys206OutputIpmOtbndFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys206OutputIpmOtbndFile.class);
	
	@Value("${IP809050.Sys206OutputIpmOtbndFile:SYS206}")
    ...
    **/
	@Value("${IP809050.Sys206OutputIpmOtbndFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP809050.Sys206OutputIpmOtbndFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys206OutputIpmOtbndFileCharSet() {
		return charSet;
	}
	
	public String getSys206OutputIpmOtbndFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys206OutputIpmOtbndFile()
	{
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys206OutputIpmOtbndFile Write: {}",e.getMessage() ); 		}
	}
