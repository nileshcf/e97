...
@Component("ip798030_sys001CutoffFile")
public class Sys001CutoffFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001CutoffFile.class);
	
	@Value("${IP798030.Sys001CutoffFile:SYS001}")
    ...
    **/
	@Value("${IP798030.Sys001CutoffFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP798030.Sys001CutoffFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys001CutoffFileCharSet() {
		return charSet;
	}
	
	public String getSys001CutoffFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys001CutoffFile()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[182]);
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001CutoffFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys001CutoffFile Write: {}",e.getMessage() ); 		}
	}
