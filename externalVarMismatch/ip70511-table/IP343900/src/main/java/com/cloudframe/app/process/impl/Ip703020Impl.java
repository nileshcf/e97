  ...
  @Component("ip703020")
  public class Ip703020Impl extends BaseProcess implements Ip703020 {
  	Logger logger = LoggerFactory.getLogger(Ip703020Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip703020impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
