  ...
  @Component("ip500920")
  public class Ip500920Impl extends BaseProcess implements Ip500920 {
  	Logger logger = LoggerFactory.getLogger(Ip500920Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip500920impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
