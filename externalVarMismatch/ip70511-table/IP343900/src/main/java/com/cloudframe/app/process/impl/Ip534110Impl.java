  ...
  @Component("ip534110")
  public class Ip534110Impl extends BaseProcess implements Ip534110 {
  	Logger logger = LoggerFactory.getLogger(Ip534110Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip534110impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
