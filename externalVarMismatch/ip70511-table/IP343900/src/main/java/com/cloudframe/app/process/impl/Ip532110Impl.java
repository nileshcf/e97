  ...
  @Component("ip532110")
  public class Ip532110Impl extends BaseProcess implements Ip532110 {
  	Logger logger = LoggerFactory.getLogger(Ip532110Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip532110impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
