...
public class Ip00404MpePeRecDataCs extends Ip00404MpePeRecDataCsSerialized { 
				...
				private Ip00404FloorExpiryDate ip00404FloorExpiryDate = new Ip00404FloorExpiryDate();
						...
						private char[] ip00404MemberFiller = Field.fillLowValue(14);
				...
				private Ip00404GrpCode ip00404GrpCode = new Ip00404GrpCode();
						...
						private char[] ip00404MstrpassAchProgInd = Field.fillLowValue(1);
...
static { 
   ...
   public void setIp00404Filler(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	/**
	 *	Returns the value of ip00404MstrpassAchProgInd
	 *	@return ip00404MstrpassAchProgInd
	 */
   public char[] getIp00404MstrpassAchProgInd() throws CFException{
     if (isIp00404MstrpassAchProgIndModified()) { 
        ip00404MstrpassAchProgInd = refreshIp00404MstrpassAchProgInd();
     }
   		return ip00404MstrpassAchProgInd;
   }
	...
	/**
	*  set variable ip00404MstrpassAchProgInd
	*  Corresponding COBOL Variable is IP00404-MSTRPASS-ACH-PROG-IND
	*  @param value
	**/
   public void setIp00404MstrpassAchProgInd(char[] value) {
      ip00404MstrpassAchProgInd = checkIp00404MstrpassAchProgIndConstraints(value);
      serializeIp00404MstrpassAchProgInd(ip00404MstrpassAchProgInd);
   } 

     /**
	 * 	Update Ip00404MstrpassAchProgInd 
	 *     with a char[] from an offset and length             
	 *	@param value
	 */
   public void setIp00404MstrpassAchProgInd(char[] source, int sourceIndex) {
       replace(source,sourceIndex,source.length,beginIp00404MstrpassAchProgInd,ip00404MstrpassAchProgInd.length);
   	
   }
   
   public void setIp00404MstrpassAchProgInd(char[] source, int sourceIndex , int sourceLen) {
       replace(source,sourceIndex,sourceLen,beginIp00404MstrpassAchProgInd,ip00404MstrpassAchProgInd.length);
	 ...
	 *	@param value
	 */
   public void setIp00404MstrpassAchProgInd(char[] source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
       replace(source,sourceIndex,sourceLen,beginIp00404MstrpassAchProgInd+targetIndex,targetLen);
   
   }
   
    /**
	 * 	Update Ip00404MstrpassAchProgInd with another Field
	 *	@param value
	 */
   public void setIp00404MstrpassAchProgInd(Field source) {
       replace(source,0,source.length(),beginIp00404MstrpassAchProgInd,IP_00404_MSTRPASS_ACH_PROG_IND_LEN);
	 ...
	 *	@param value
	 */
   public void setIp00404MstrpassAchProgInd(Field source, int sourceIndex,int sourceLen) {
        replace(source,sourceIndex,sourceLen,beginIp00404MstrpassAchProgInd,IP_00404_MSTRPASS_ACH_PROG_IND_LEN);
	 ...
	 *	@param value
	 */
   public void setIp00404MstrpassAchProgInd(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
       replace(source,sourceIndex,sourceLen,beginIp00404MstrpassAchProgInd+targetIndex,targetLen);
    
   }
	char[] ip00404MpachProgIndY8888Value = "Y".toCharArray();
	/**
	 *	Test condition "Y" for isIp00404MpachProgIndY88()
	 *	@return  Returns true if isIp00404MpachProgIndY88() is "Y"
	 */
   public boolean isIp00404MpachProgIndY88() throws CFException {
      return (  compareChars( getIp00404MstrpassAchProgInd() , ip00404MpachProgIndY8888Value)  == 0  );
   }
	...
	*  set values "Y"
	*/
   	public void setIp00404MpachProgIndY88True() {  			
    	setIp00404MstrpassAchProgInd( ip00404MpachProgIndY8888Value);
   	}
	char[] ip00404MpachProgIndN8888Value = "N".toCharArray();
	/**
	 *	Test condition "N" for isIp00404MpachProgIndN88()
	 *	@return  Returns true if isIp00404MpachProgIndN88() is "N"
	 */
   public boolean isIp00404MpachProgIndN88() throws CFException {
      return (  compareChars( getIp00404MstrpassAchProgInd() , ip00404MpachProgIndN8888Value)  == 0  );
   }
	...
	*  set values "N"
	*/
   	public void setIp00404MpachProgIndN88True() {  			
    	setIp00404MstrpassAchProgInd( ip00404MpachProgIndN8888Value);
   	}
	/**
   ...
   public void initialize() {
         ...
         setIp00404MemberFiller(CONSTANTS.SPACE_14);
         ...
         setIp00404MstrpassAchProgInd(CONSTANTS.SPACE);
