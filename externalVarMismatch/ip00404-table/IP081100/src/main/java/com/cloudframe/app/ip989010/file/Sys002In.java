...
@Component("ip989010_sys002In")
public class Sys002In extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys002In.class);
	
	@Value("${IP989010.Sys002In:SYS002}")
    ...
    **/
	@Value("${IP989010.Sys002InCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys002InCRLFflag:no}")
	private String crlfFlag;

	public String getSys002InCharSet() {
		return charSet;
	}
	
	public String getSys002InCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys002In Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
