  ...
  @Component("ip280510")
  public class Ip280510Impl extends BaseProcess implements Ip280510 {
  	Logger logger = LoggerFactory.getLogger(Ip280510Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip280510impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
