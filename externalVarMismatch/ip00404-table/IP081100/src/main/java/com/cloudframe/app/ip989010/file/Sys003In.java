...
@Component("ip989010_sys003In")
public class Sys003In extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys003In.class);
	
	@Value("${IP989010.Sys003In:SYS003}")
    ...
    **/
	@Value("${IP989010.Sys003InCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys003InCRLFflag:no}")
	private String crlfFlag;

	public String getSys003InCharSet() {
		return charSet;
	}
	
	public String getSys003InCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys003In Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
