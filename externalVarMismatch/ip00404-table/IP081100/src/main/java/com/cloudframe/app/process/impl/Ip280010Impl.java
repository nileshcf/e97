  ...
  @Component("ip280010")
  public class Ip280010Impl extends BaseProcess implements Ip280010 {
  	Logger logger = LoggerFactory.getLogger(Ip280010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip280010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
