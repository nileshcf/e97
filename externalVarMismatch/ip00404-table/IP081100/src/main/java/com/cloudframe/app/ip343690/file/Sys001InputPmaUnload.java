...
@Component("ip343690_sys001InputPmaUnload")
public class Sys001InputPmaUnload extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001InputPmaUnload.class);
	
	@Value("${IP343690.Sys001InputPmaUnload:SYS001}")
    ...
    **/
	@Value("${IP343690.Sys001InputPmaUnloadCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP343690.Sys001InputPmaUnloadCRLFflag:no}")
	private String crlfFlag;

	public String getSys001InputPmaUnloadCharSet() {
		return charSet;
	}
	
	public String getSys001InputPmaUnloadCrlfFlag() {
		return crlfFlag;
	}

	public Sys001InputPmaUnload()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[116]);
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001InputPmaUnload Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
