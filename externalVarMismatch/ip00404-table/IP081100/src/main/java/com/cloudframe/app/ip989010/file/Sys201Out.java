...
@Component("ip989010_sys201Out")
public class Sys201Out extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201Out.class);
	
	@Value("${IP989010.Sys201Out:SYS201}")
    ...
    **/
	@Value("${IP989010.Sys201OutCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys201OutCRLFflag:no}")
	private String crlfFlag;

	public String getSys201OutCharSet() {
		return charSet;
	}
	
	public String getSys201OutCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201Out Write: {}",e.getMessage() ); 		}
	}
