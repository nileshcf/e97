...
@Component("ip088030_sys001TjfIp370File")
public class Sys001TjfIp370File extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001TjfIp370File.class);
	
	@Value("${IP088030.Sys001TjfIp370File:SYS001}")
    ...
    **/
	@Value("${IP088030.Sys001TjfIp370FileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP088030.Sys001TjfIp370FileCRLFflag:no}")
	private String crlfFlag;

	public String getSys001TjfIp370FileCharSet() {
		return charSet;
	}
	
	public String getSys001TjfIp370FileCrlfFlag() {
		return crlfFlag;
	}

	public Sys001TjfIp370File()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[750]);
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001TjfIp370File Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
