  ...
  @Component("ip599810")
  public class Ip599810Impl extends BaseProcess implements Ip599810 {
  	Logger logger = LoggerFactory.getLogger(Ip599810Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip599810impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
