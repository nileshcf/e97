  ...
  @Component("ip783510")
  public class Ip783510Impl extends BaseProcess implements Ip783510 {
  	Logger logger = LoggerFactory.getLogger(Ip783510Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip783510impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
