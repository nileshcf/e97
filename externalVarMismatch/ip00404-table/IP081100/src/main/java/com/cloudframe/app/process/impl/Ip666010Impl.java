  ...
  @Component("ip666010")
  public class Ip666010Impl extends BaseProcess implements Ip666010 {
  	Logger logger = LoggerFactory.getLogger(Ip666010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip666010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
