...
public class Ip67002Date2Redefined01 extends Ip67002Date2Redefined01Serialized { 
				...
				@Getter @Setter private Ip67002Hhmm ip67002Hhmm = new Ip67002Hhmm();
				@Getter @Setter private Ip67002UtcOffsetHhmm ip67002UtcOffsetHhmm = new Ip67002UtcOffsetHhmm();
	...
	**/
    ...
    public void setParent(Field parent,int begin) {
    	super.setParent(parent, begin);
					getIp67002Hhmm().setParent(this,getStartOffset() + 0);
					getIp67002UtcOffsetHhmm().setParent(this,getStartOffset() + 4);
    } 
   ...
   public void initialize() {
          getIp67002Hhmm().initialize();
     
          getIp67002UtcOffsetHhmm().initialize();
