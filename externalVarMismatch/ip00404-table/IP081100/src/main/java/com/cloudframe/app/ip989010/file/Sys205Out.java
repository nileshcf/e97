...
@Component("ip989010_sys205Out")
public class Sys205Out extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys205Out.class);
	
	@Value("${IP989010.Sys205Out:SYS205}")
    ...
    **/
	@Value("${IP989010.Sys205OutCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys205OutCRLFflag:no}")
	private String crlfFlag;

	public String getSys205OutCharSet() {
		return charSet;
	}
	
	public String getSys205OutCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys205Out Write: {}",e.getMessage() ); 		}
	}
