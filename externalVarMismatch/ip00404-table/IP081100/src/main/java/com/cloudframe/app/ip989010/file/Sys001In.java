...
@Component("ip989010_sys001In")
public class Sys001In extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001In.class);
	
	@Value("${IP989010.Sys001In:SYS001}")
    ...
    **/
	@Value("${IP989010.Sys001InCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys001InCRLFflag:no}")
	private String crlfFlag;

	public String getSys001InCharSet() {
		return charSet;
	}
	
	public String getSys001InCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001In Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
