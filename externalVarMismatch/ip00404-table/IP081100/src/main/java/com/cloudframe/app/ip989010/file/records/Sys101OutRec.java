...
/**
*  The class Sys101OutRec is used to handle fields declared in it
...
public class Sys101OutRec extends Sys101OutRecSerialized {
   
      private List<char[]> filler1; 

	
	/**
	* Constructor for Sys101OutRec
	**/
    public Sys101OutRec() {
		super();
   ...
   private void setFiller1(int index,char[] value,boolean setModified) {
	...
	// String array will always read from stringValue so no need to explicitly set the array item
  	if (setModified) {
		...
		public static int getSys101OutRecFieldLength() {
			return SYS_101_OUT_REC_LENGTH;
		}
