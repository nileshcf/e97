...
@Component("ip989010_sys005In")
public class Sys005In extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys005In.class);
	
	@Value("${IP989010.Sys005In:SYS005}")
    ...
    **/
	@Value("${IP989010.Sys005InCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys005InCRLFflag:no}")
	private String crlfFlag;

	public String getSys005InCharSet() {
		return charSet;
	}
	
	public String getSys005InCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys005In Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
