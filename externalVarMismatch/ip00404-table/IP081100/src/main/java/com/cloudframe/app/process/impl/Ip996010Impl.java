  ...
  @Component("ip996010")
  public class Ip996010Impl extends BaseProcess implements Ip996010 {
  	Logger logger = LoggerFactory.getLogger(Ip996010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip996010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
