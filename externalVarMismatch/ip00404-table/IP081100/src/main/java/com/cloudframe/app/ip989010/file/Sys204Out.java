...
@Component("ip989010_sys204Out")
public class Sys204Out extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys204Out.class);
	
	@Value("${IP989010.Sys204Out:SYS204}")
    ...
    **/
	@Value("${IP989010.Sys204OutCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys204OutCRLFflag:no}")
	private String crlfFlag;

	public String getSys204OutCharSet() {
		return charSet;
	}
	
	public String getSys204OutCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys204Out Write: {}",e.getMessage() ); 		}
	}
