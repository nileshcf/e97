...
@Component("ip989010_sys004In")
public class Sys004In extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys004In.class);
	
	@Value("${IP989010.Sys004In:SYS004}")
    ...
    **/
	@Value("${IP989010.Sys004InCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys004InCRLFflag:no}")
	private String crlfFlag;

	public String getSys004InCharSet() {
		return charSet;
	}
	
	public String getSys004InCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys004In Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
