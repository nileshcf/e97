...
@Component("ip989010_sys202Out")
public class Sys202Out extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys202Out.class);
	
	@Value("${IP989010.Sys202Out:SYS202}")
    ...
    **/
	@Value("${IP989010.Sys202OutCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP989010.Sys202OutCRLFflag:no}")
	private String crlfFlag;

	public String getSys202OutCharSet() {
		return charSet;
	}
	
	public String getSys202OutCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys202Out Write: {}",e.getMessage() ); 		}
	}
