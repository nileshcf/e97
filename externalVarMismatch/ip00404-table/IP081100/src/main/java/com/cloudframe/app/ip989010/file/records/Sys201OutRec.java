...
/**
*  The class Sys201OutRec is used to handle fields declared in it
...
public class Sys201OutRec extends Sys201OutRecSerialized {
   
      private List<char[]> filler1; 

	
	/**
	* Constructor for Sys201OutRec
	**/
    public Sys201OutRec() {
		super();
   ...
   private void setFiller1(int index,char[] value,boolean setModified) {
	...
	// String array will always read from stringValue so no need to explicitly set the array item
  	if (setModified) {
		...
		public static int getSys201OutRecFieldLength() {
			return SYS_201_OUT_REC_LENGTH;
		}
