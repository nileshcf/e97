...
@Component("ip088030_sys201OutputFile")
public class Sys201OutputFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys201OutputFile.class);
	
	@Value("${IP088030.Sys201OutputFile:SYS201}")
    ...
    **/
	@Value("${IP088030.Sys201OutputFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP088030.Sys201OutputFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys201OutputFileCharSet() {
		return charSet;
	}
	
	public String getSys201OutputFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys201OutputFile()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[790]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Sys201OutputFile Write: {}",e.getMessage() ); 		}
	}
