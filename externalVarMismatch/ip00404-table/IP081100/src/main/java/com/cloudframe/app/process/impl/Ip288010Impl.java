  ...
  @Component("ip288010")
  public class Ip288010Impl extends BaseProcess implements Ip288010 {
  	Logger logger = LoggerFactory.getLogger(Ip288010Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip288010impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
