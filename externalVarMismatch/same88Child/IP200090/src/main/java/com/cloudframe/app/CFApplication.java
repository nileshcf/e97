...
/**
 * The Ip200090 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Ip200090 ip200090 = (Ip200090) context.getBean("ip200090");
        	    ip200090.process(new GlobalExecutorCtx().getContext(Ip200090Ctx.class)); /*  Ip200090 requires no input parameters  */
