  ...
  @Component("ip200110")
  public class Ip200110Impl extends BaseProcess implements Ip200110 {
  	Logger logger = LoggerFactory.getLogger(Ip200110Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip200110impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
