...
/**
*  The class Ip000604DeAttrUserRowSerialized is used to define offsets in order to serialize
*  in a fixed String
...
public class Ip000604DeAttrUserRowSerialized  extends Field { 

    protected Logger logger = LoggerFactory.getLogger(Ip000604DeAttrUserRowSerialized.class);
	/*  Length of the field, if serialized as a String */
	protected static final int IP_000604_DE_ATTR_USER_ROW_LENGTH = 80;
   /*  offset of each of Child Fields when serialized as a String */
	...
	/**
	* Constructor for Ip000604DeAttrUserRowSerialized
	**/
    public Ip000604DeAttrUserRowSerialized() {
	// TO-DO auto generated code
    }
 
	/**
	* Constructor for Ip000604DeAttrUserRowSerialized. sets the parent value to the parent
	* @param parent
	* @param begin
	**/
    public Ip000604DeAttrUserRowSerialized(Field parent,int begin) {
    	   setParent(parent,begin);
    }
    
	/**
	* sets parent for this Ip000604DeAttrUserRowSerialized to the parent
	* @param parent
	**/
    @Override
	...
	**/
	...
	/**
	* initializes the field in Ip000604DeAttrUserRowSerialized
	**/
	@Override
	protected void init(int begin) {
	   setStartOffset(begin);
	   setLength(IP_000604_DE_ATTR_USER_ROW_LENGTH);
	   /*  set the offset/position of each field when this object is serialized as String */
             beginIp000604DeAb = getStartOffset() + 0;	// set offset for serialization
  
             beginIp000604DeNo = getStartOffset() + 3;	// set offset for serialization
  
             beginIp000604DeName = getStartOffset() + 6;	// set offset for serialization
  
             beginIp000604DeFormat = getStartOffset() + 63;	// set offset for serialization
  
             beginIp000604DeMinLngth = getStartOffset() + 66;	// set offset for serialization
  
             beginIp000604DeMcMaxLngth = getStartOffset() + 68;	// set offset for serialization
  
             beginIp000604DeIsoMaxLngth = getStartOffset() + 70;	// set offset for serialization
  
             beginIp000604DeLllSize = getStartOffset() + 72;	// set offset for serialization
  
             beginIp000604DeSubflds = getStartOffset() + 74;	// set offset for serialization
  
             beginIp000604DeFirstSubfld = getStartOffset() + 76;	// set offset for serialization
  
             beginIp000604DeFirstSubfldRedefined = getStartOffset() + 76;	// set offset for serialization
