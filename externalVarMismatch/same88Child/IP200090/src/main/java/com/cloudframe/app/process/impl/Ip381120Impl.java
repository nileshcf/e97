  ...
  @Component("ip381120")
  public class Ip381120Impl extends BaseProcess implements Ip381120 {
  	Logger logger = LoggerFactory.getLogger(Ip381120Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip381120impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
