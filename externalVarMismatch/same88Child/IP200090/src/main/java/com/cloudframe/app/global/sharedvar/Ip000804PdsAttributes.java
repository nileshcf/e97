...
public class Ip000804PdsAttributes extends Ip000804PdsAttributesSerialized  implements InitializingBean {
								...
								@Getter @Setter private short ip000804MaxPdsNo;
				@Getter @Setter private Ip000804PdsAttrTable ip000804PdsAttrTable = new Ip000804PdsAttrTable();
	...
	**/
	...
	public void afterPropertiesSet() throws Exception {
    	...
    	/*  set the parent of each child as this which are a group variable */
					getIp000804PdsAttrTable().setParent(this,getStartOffset() + 2);
	   	/*  end of offset */
    }
   ...
   public void initialize() {
          ...
          getIp000804PdsAttrTable().initialize();
