  ...
  @Component("ip200100")
  public class Ip200100Impl extends BaseProcess implements Ip200100 {
  	Logger logger = LoggerFactory.getLogger(Ip200100Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip200100impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
