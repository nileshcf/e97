...
/**
 * The Ip313010 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Ip313010 ip313010 = (Ip313010) context.getBean("ip313010");
        	    ip313010.process(new GlobalExecutorCtx().getContext(Ip313010Ctx.class)); /*  Ip313010 requires no input parameters  */
