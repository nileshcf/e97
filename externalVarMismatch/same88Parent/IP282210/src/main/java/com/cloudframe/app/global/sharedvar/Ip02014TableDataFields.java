...
public class Ip02014TableDataFields extends Ip02014TableDataFieldsSerialized { 
				...
				@Getter @Setter private Ip02014ImpBulkId ip02014ImpBulkId = new Ip02014ImpBulkId();
						...
						@Getter @Setter private char[] ip02014MrchntSplitCd = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014MrchntSplitSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014CurrSplitCd = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014CurrSplitSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014AcquirerSplitCd = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014AcquirerSplitSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014DomCollOnlyCd = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014OnsoilDataShrSw = Field.fillLowValue(1);
						...
						@Getter @Setter private char[] ip02014PushOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014IncontrolOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014EsrvcOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014GftOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014BnknetOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014MdesOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014ZappOnsoilSw = Field.fillLowValue(1);

						@Getter @Setter private char[] ip02014CemOnsoilSw = Field.fillLowValue(1);
			...
			@Getter @Setter private List<Ip02014Db2Table> ip02014Db2Table = new ArrayList<>();
						...
						@Getter @Setter private char[] ip02014Filler = Field.fillLowValue(750);
