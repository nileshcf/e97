  ...
  @Component("ip750080")
  public class Ip750080Impl extends BaseProcess implements Ip750080 {
  	Logger logger = LoggerFactory.getLogger(Ip750080Impl.class);
   	private boolean isFirstCall = true;
   	
  	
    	public int process(ProgramContext programCtx) throws CFException {
    	     if(isFirstCall) {
    	     	logger.info("Class Ip750080impl not converted to Java, using default" ); 
    	     	isFirstCall = false;
    	     } 
    	     return getRc();
    	}
