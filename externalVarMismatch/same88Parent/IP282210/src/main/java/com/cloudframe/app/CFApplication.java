...
/**
 * The Ip282210 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Ip282210 ip282210 = (Ip282210) context.getBean("ip282210");
				...
				ip282210.setParameter(new GlobalExecutorCtx().getContext(Ip282210Ctx.class),inputValue);
