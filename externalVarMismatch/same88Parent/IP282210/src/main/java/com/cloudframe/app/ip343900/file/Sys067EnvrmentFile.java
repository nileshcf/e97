...
@Component("ip343900_sys067EnvrmentFile")
public class Sys067EnvrmentFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys067EnvrmentFile.class);
	
	@Value("${IP343900.Sys067EnvrmentFile:SYS067}")
    ...
    **/
	@Value("${IP343900.Sys067EnvrmentFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP343900.Sys067EnvrmentFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys067EnvrmentFileCharSet() {
		return charSet;
	}
	
	public String getSys067EnvrmentFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys067EnvrmentFile()
	{
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys067EnvrmentFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
