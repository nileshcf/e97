package com.cloudframe.app.ip343900.file;
...
import com.cloudframe.app.ip343900.file.records.*;

@Component("ip343900_sys001PmmFixUnloadFile")
public class Sys001PmmFixUnloadFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Sys001PmmFixUnloadFile.class);
	
	@Value("${IP343900.Sys001PmmFixUnloadFile:SYS001}")
    ...
    **/
	@Value("${IP343900.Sys001PmmFixUnloadFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP343900.Sys001PmmFixUnloadFileCRLFflag:no}")
	private String crlfFlag;

	public String getSys001PmmFixUnloadFileCharSet() {
		return charSet;
	}
	
	public String getSys001PmmFixUnloadFileCrlfFlag() {
		return crlfFlag;
	}

	public Sys001PmmFixUnloadFile()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[94]);
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during Sys001PmmFixUnloadFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
