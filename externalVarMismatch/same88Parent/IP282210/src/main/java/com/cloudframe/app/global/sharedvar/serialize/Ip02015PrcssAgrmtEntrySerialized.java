...
public class Ip02015PrcssAgrmtEntrySerialized  extends Field { 
   ...
   /*  offset of each of Child Fields when serialized as a String */
            ...
            protected  int beginIp02015AcquirerSplitSw;
	...
	**/
	...
	protected void init(int begin) {
	   ...
	   /*  set the offset/position of each field when this object is serialized as String */
             ...
             beginIp02015AcquirerSplitSw = getStartOffset() + 25;	// set offset for serialization
   ...
   protected char[] checkIp02015CurrSplitCdConstraints(char[] value) {
	 ...
	 */ 
     ...
     int localIp02015AcquirerSplitSwCounter = -1;
     public boolean isIp02015AcquirerSplitSwModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localIp02015AcquirerSplitSwCounter != sharedCounter;
         localIp02015AcquirerSplitSwCounter = sharedCounter; return hasModified;
     }
	protected static final int IP_02015_ACQUIRER_SPLIT_SW_LEN = 1;
	/**
	 * 	serialize this Ip02015AcquirerSplitSw
	 */
   protected void serializeIp02015AcquirerSplitSw(char[] ip02015AcquirerSplitSw) {
        shareString.getSerializedField().incrementCounter();
        arraycopy(ip02015AcquirerSplitSw,0,getStringValue(),beginIp02015AcquirerSplitSw,IP_02015_ACQUIRER_SPLIT_SW_LEN);
       localIp02015AcquirerSplitSwCounter = shareString.getSerializedField().getModifiedCounter();  	
   }

   protected char[] checkIp02015AcquirerSplitSwConstraints(char[] value) {
   			return super.checkConstraints(value , 1 ,false, false);
   }
    /**
	 *	refreshIp02015AcquirerSplitSw is used to refresh the latest value of a variable from the Serialized String
	 *  the most common reason to serialize an Object as a string in to write to a file. There can be several other reasons for serialization as well
	 */ 
   	public char[] refreshIp02015AcquirerSplitSw() {	 
   		return (substring(getStringValue(),beginIp02015AcquirerSplitSw,beginIp02015AcquirerSplitSw + IP_02015_ACQUIRER_SPLIT_SW_LEN));
   	}
