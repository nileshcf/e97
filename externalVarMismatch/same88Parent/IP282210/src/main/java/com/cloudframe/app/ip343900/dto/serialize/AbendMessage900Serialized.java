...
public class AbendMessage900Serialized  extends Field { 
	...
	protected static final int ABEND_MESSAGE_900_LENGTH = 71;
	...
	**/
	...
	protected void init(int begin) {
	   ...
	   /*  set the offset/position of each field when this object is serialized as String */
             ...
             beginAbendText900 = getStartOffset() + 16;	// set offset for serialization
   ...
   protected char[] checkAbendCode900Constraints(char[] value) {
	...
	protected static final int ABEND_TEXT_900_LEN = 55;
	/**
