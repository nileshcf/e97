...
public class Ip02015PrcssAgrmtEntry extends Ip02015PrcssAgrmtEntrySerialized { 
				...
				private Ip02015ImpBulkId ip02015ImpBulkId = new Ip02015ImpBulkId();
						...
						private char[] ip02015AcquirerSplitSw = Field.fillLowValue(1);
	...
	*/
	...
	/**
	 *	Returns the value of ip02015AcquirerSplitSw
	 *	@return ip02015AcquirerSplitSw
	 */
   public char[] getIp02015AcquirerSplitSw() throws CFException{
     if (isIp02015AcquirerSplitSwModified()) { 
        ip02015AcquirerSplitSw = refreshIp02015AcquirerSplitSw();
     }
   		return ip02015AcquirerSplitSw;
   }
	...
	/**
	*  set variable ip02015AcquirerSplitSw
	*  Corresponding COBOL Variable is IP02015-ACQUIRER-SPLIT-SW
	*  @param value
	**/
   public void setIp02015AcquirerSplitSw(char[] value) {
      ip02015AcquirerSplitSw = checkIp02015AcquirerSplitSwConstraints(value);
      serializeIp02015AcquirerSplitSw(ip02015AcquirerSplitSw);
   } 

     /**
	 * 	Update Ip02015AcquirerSplitSw 
	 *     with a char[] from an offset and length             
	 *	@param value
	 */
   public void setIp02015AcquirerSplitSw(char[] source, int sourceIndex) {
       replace(source,sourceIndex,source.length,beginIp02015AcquirerSplitSw,ip02015AcquirerSplitSw.length);
   	
   }
   
   public void setIp02015AcquirerSplitSw(char[] source, int sourceIndex , int sourceLen) {
       replace(source,sourceIndex,sourceLen,beginIp02015AcquirerSplitSw,ip02015AcquirerSplitSw.length);
	 ...
	 *	@param value
	 */
   public void setIp02015AcquirerSplitSw(char[] source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
       replace(source,sourceIndex,sourceLen,beginIp02015AcquirerSplitSw+targetIndex,targetLen);
   
   }
   
    /**
	 * 	Update Ip02015AcquirerSplitSw with another Field
	 *	@param value
	 */
   public void setIp02015AcquirerSplitSw(Field source) {
       replace(source,0,source.length(),beginIp02015AcquirerSplitSw,IP_02015_ACQUIRER_SPLIT_SW_LEN);
	 ...
	 *	@param value
	 */
   public void setIp02015AcquirerSplitSw(Field source, int sourceIndex,int sourceLen) {
        replace(source,sourceIndex,sourceLen,beginIp02015AcquirerSplitSw,IP_02015_ACQUIRER_SPLIT_SW_LEN);
	 ...
	 *	@param value
	 */
   public void setIp02015AcquirerSplitSw(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
       replace(source,sourceIndex,sourceLen,beginIp02015AcquirerSplitSw+targetIndex,targetLen);
   ...
   public boolean isIp02015AcquirerSplitYes88() throws CFException {
      return (  compareChars( getIp02015AcquirerSplitSw() , ip02015AcquirerSplitYes8888Value)  == 0  );
   }
	...
	*/
   	public void setIp02015AcquirerSplitYes88True() {  			
    	setIp02015AcquirerSplitSw( ip02015AcquirerSplitYes8888Value);
   	}
   ...
   public boolean isIp02015AcquirerSplitNo88() throws CFException {
      return (  compareChars( getIp02015AcquirerSplitSw() , ip02015AcquirerSplitNo8888Value)  == 0  );
   }
	...
	*/
   	public void setIp02015AcquirerSplitNo88True() {  			
    	setIp02015AcquirerSplitSw( ip02015AcquirerSplitNo8888Value);
   	}
	/**
   ...
   public void setIp02015AcquirerSplitCd(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	char[] ip02015AcquirerSplitYes88288Value = "Y".toCharArray();
	/**
	 *	Test condition "Y" for isIp02015AcquirerSplitYes882()
	 *	@return  Returns true if isIp02015AcquirerSplitYes882() is "Y"
	 */
   public boolean isIp02015AcquirerSplitYes882() throws CFException {
      return (  compareChars( getIp02015AcquirerSplitCd() , ip02015AcquirerSplitYes88288Value)  == 0  );
   }
	...
	*  set values "Y"
	*/
   	public void setIp02015AcquirerSplitYes882True() {  			
    	setIp02015AcquirerSplitCd( ip02015AcquirerSplitYes88288Value);
   	}
	char[] ip02015AcquirerSplitNo88288Value = "N".toCharArray();
	/**
	 *	Test condition "N" for isIp02015AcquirerSplitNo882()
	 *	@return  Returns true if isIp02015AcquirerSplitNo882() is "N"
	 */
   public boolean isIp02015AcquirerSplitNo882() throws CFException {
      return (  compareChars( getIp02015AcquirerSplitCd() , ip02015AcquirerSplitNo88288Value)  == 0  );
   }
	...
	*  set values "N"
	*/
   	public void setIp02015AcquirerSplitNo882True() {  			
    	setIp02015AcquirerSplitCd( ip02015AcquirerSplitNo88288Value);
   	}
