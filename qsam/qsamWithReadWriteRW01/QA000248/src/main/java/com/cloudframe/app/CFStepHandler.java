...
public class CFStepHandler implements InitializingBean {
    ...
    private static final String STEP02 = "step02";
  ...
  public void handleStepOverrides(String stepName) throws CFException {
        switch(stepName) {
            case "delete":  /* setting the disp position for file(s) info for this step(DELETE). */
 		    	   		SpringContextHandler.handleDispPostion("DELETE.IEFBR14.Sys103","DELETE.IEFBR14.Sys103.DISP");
 		    	   		SpringContextHandler.handleDispPostion("DELETE.IEFBR14.Sysout","DELETE.IEFBR14.Sysout.DISP");
            break;
            case "alloc":  /* setting the disp position for file(s) info for this step(ALLOC). */
 		    	   		SpringContextHandler.handleDispPostion("ALLOC.IEFBR14.Sys103","ALLOC.IEFBR14.Sys103.DISP");
 		    	   		SpringContextHandler.handleDispPostion("ALLOC.IEFBR14.Sysout","ALLOC.IEFBR14.Sysout.DISP");
            break;
            case "step01":  /* setting the appropriate file(s) info for this step(STEP01). */
 		    	   		SpringContextHandler.setFileName("qsamrw01_sys103FileIdHistoryFile", "STEP01.QSAMRW01.Sys103FileIdHistoryFile");
 		    	   		SpringContextHandler.setFileDispPosition("qsamrw01_sys103FileIdHistoryFile", "STEP01.QSAMRW01.Sys103FileIdHistoryFile.DISP");
            break;
            case "step02":  /* setting the appropriate file(s) info for this step(STEP02). */
 		    	   		SpringContextHandler.setFileName("qsamrw01_sys103FileIdHistoryFile", "STEP02.QSAMRW01.Sys103FileIdHistoryFile");
 		    	   		SpringContextHandler.setFileDispPosition("qsamrw01_sys103FileIdHistoryFile", "STEP02.QSAMRW01.Sys103FileIdHistoryFile.DISP");
            break;
                default: break;
        }
}
...
*/ 
    ...
    public void printExecutionSummary() {
      ...
      if(abendList.isEmpty()) {
          ...
          logger.info("JOB : QA000248 ENDED -  {}", formattedJobRc);
      } else { 
          logger.info("JOB : QA000248 ENDED -  ABEND={}", abendCode);
      } 
