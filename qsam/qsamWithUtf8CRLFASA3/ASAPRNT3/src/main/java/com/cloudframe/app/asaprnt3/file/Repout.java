package com.cloudframe.app.asaprnt3.file;
...
import com.cloudframe.app.asaprnt3.file.records.*;

@Component("asaprnt3_repout")
public class Repout extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Repout.class);
	
	@Value("${ASAPRNT3.Repout:REPOUT}")
    ...
    **/
	@Value("${ASAPRNT3.RepoutCharSet:cp1047}")
	private String charSet;
	
	@Value("${ASAPRNT3.RepoutCRLFflag:no}")
