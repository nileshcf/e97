package com.cloudframe.app.asaprnt3.file.records.serialize;
...
public class ReprecSerialized  extends Field { 
	...
	protected static final int REPREC_LENGTH = 133;
	...
	**/
	...
	protected static final int REPREC_STRING_LEN = 133;
	/**
