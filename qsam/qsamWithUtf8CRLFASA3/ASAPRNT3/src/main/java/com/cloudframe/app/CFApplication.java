...
import com.cloudframe.app.process.Asaprnt3;
...
/**
 * The Asaprnt3 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Asaprnt3 asaprnt3 = (Asaprnt3) context.getBean("asaprnt3");
        	    asaprnt3.process(new GlobalExecutorCtx().getContext(Asaprnt3Ctx.class)); /*  Asaprnt3 requires no input parameters  */
