...
/**
 * The Read0001 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Read0001 read0001 = (Read0001) context.getBean("read0001");
        	    read0001.process(new GlobalExecutorCtx().getContext(Read0001Ctx.class)); /*  Read0001 requires no input parameters  */
