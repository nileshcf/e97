package com.cloudframe.app.asaprnt.file;
...
import com.cloudframe.app.asaprnt.file.records.*;

@Component("asaprnt_repout")
public class Repout extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Repout.class);
	
	@Value("${ASAPRNT.Repout:REPOUT}")
    ...
    **/
	@Value("${ASAPRNT.RepoutCharSet:cp1047}")
	private String charSet;
	
	@Value("${ASAPRNT.RepoutCRLFflag:no}")
