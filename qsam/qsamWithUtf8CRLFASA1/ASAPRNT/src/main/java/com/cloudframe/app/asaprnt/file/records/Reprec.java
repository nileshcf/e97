package com.cloudframe.app.asaprnt.file.records;
...
import com.cloudframe.app.asaprnt.file.records.serialize.*;
...
public class Reprec extends ReprecSerialized {
						...
						private char[] reprecString = Field.fillLowValue(132);
