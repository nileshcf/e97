package com.cloudframe.app.global.shared.file;
...
@Component("global_ipmFile")
public class IpmFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(IpmFile.class);
	
	@Value("${GLOBAL.IpmFile:SYS003}")
    ...
    **/
	@Value("${GLOBAL.IpmFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${GLOBAL.IpmFileCRLFflag:no}")
	private String crlfFlag;

	public String getIpmFileCharSet() {
		return charSet;
	}
	
	public String getIpmFileCrlfFlag() {
		return crlfFlag;
	}
	...
	public void read() throws Exception {
		try {
			...
			logger.error("Error during IpmFile Read: {}",e.getMessage() ); 
		    throw e;
		}
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during IpmFile Write: {}",e.getMessage() ); 		}
	}
