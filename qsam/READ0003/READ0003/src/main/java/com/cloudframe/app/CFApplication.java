...
import com.cloudframe.app.process.Read0003;
...
/**
 * The Read0003 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Read0003 read0003 = (Read0003) context.getBean("read0003");
        	    read0003.process(new GlobalExecutorCtx().getContext(Read0003Ctx.class)); /*  Read0003 requires no input parameters  */
