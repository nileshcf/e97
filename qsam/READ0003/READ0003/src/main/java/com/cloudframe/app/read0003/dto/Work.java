...
import com.cloudframe.app.read0003.dto.serialize.*;
...
public class Work extends WorkSerialized {
						...
						private char[] read000401 = new char[8];
	...
	*  Corresponding COBOL Variable is WS-READ0004
	*  @param value
	**/
   public void setRead000401(char[] value) {
       value = checkRead000401Constraints(value);
       arraycopy(value,0,read000401,0,value.length);
   } 
	public void setRead000401(char[] value , int beginIndex, int endIndex) {
       //value = checkL1CtlData801Constraints(value);
       arraycopy(value,beginIndex,read000401,0,beginIndex + endIndex);
   }
	/**
