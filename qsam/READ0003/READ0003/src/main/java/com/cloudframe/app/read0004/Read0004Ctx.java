package com.cloudframe.app.read0004;
...
@Context
public class Read0004Ctx implements ProgramContext, Cloneable {
    ...
    public Read0004Ctx clone() {
        Read0004Ctx cloneObj = new Read0004Ctx();
 ...
 */
     ...
     Ip66102IpmFileInformation ip66102IpmFileInformation = Read0004Ctx.this.getIp66102IpmFileInformation();
     Ip66102IpmMsg ip66102IpmMsg = Read0004Ctx.this.getIp66102IpmMsg();
     IpmMessage ipmMessage = Read0004Ctx.this.getIpmMessage();
	 ...
	 */   
	 public Ip66102IpmMsg getIp66102IpmMsg() {
   	return ip66102IpmMsg;
        ...
        public Read0004Ctx getRead0004Ctx() {
            return Read0004Ctx.this;
        }
	...
	*/
    ...
    public OpenReadClose3rdTimeOutCtx getOpenReadClose3rdTimeOutCtx() {
     ...
     Work work = Read0004Ctx.this.getWork();
     Ip66102IpmMsg ip66102IpmMsg = Read0004Ctx.this.getIp66102IpmMsg();
