package com.cloudframe.app.asaprnt4.file;
...
import com.cloudframe.app.asaprnt4.file.records.*;

@Component("asaprnt4_repout")
public class Repout extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Repout.class);
	
	@Value("${ASAPRNT4.Repout:REPOUT}")
    ...
    **/
	@Value("${ASAPRNT4.RepoutCharSet:cp1047}")
	private String charSet;
	
	@Value("${ASAPRNT4.RepoutCRLFflag:no}")
