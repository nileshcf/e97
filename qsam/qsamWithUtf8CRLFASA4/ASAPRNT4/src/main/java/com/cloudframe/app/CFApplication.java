...
import com.cloudframe.app.process.Asaprnt4;
...
/**
 * The Asaprnt4 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Asaprnt4 asaprnt4 = (Asaprnt4) context.getBean("asaprnt4");
        	    asaprnt4.process(new GlobalExecutorCtx().getContext(Asaprnt4Ctx.class)); /*  Asaprnt4 requires no input parameters  */
