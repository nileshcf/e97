...
import com.cloudframe.app.process.Asaprnt2;
...
/**
 * The Asaprnt2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Asaprnt2 asaprnt2 = (Asaprnt2) context.getBean("asaprnt2");
        	    asaprnt2.process(new GlobalExecutorCtx().getContext(Asaprnt2Ctx.class)); /*  Asaprnt2 requires no input parameters  */
