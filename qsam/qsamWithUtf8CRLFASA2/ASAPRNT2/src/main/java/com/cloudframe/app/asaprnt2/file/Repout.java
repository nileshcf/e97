package com.cloudframe.app.asaprnt2.file;
...
import com.cloudframe.app.asaprnt2.file.records.*;

@Component("asaprnt2_repout")
public class Repout extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Repout.class);
	
	@Value("${ASAPRNT2.Repout:REPOUT}")
    ...
    **/
	@Value("${ASAPRNT2.RepoutCharSet:cp1047}")
	private String charSet;
	
	@Value("${ASAPRNT2.RepoutCRLFflag:no}")
