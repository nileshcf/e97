...
@Component("vsammon4_repout")
public class Repout extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Repout.class);
	
	@Value("${VSAMMON4.Repout:REPOUT}")
    ...
    **/
	@Value("${VSAMMON4.RepoutCharSet:cp1047}")
	private String charSet;
	
	@Value("${VSAMMON4.RepoutCRLFflag:no}")
	private String crlfFlag;

	public String getRepoutCharSet() {
		return charSet;
	}
	
	public String getRepoutCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Repout Write: {}",e.getMessage() ); 		}
	}
