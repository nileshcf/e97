...
public class Vsamdb2RepositoryImpl implements Vsamdb2Repository {
    Logger logger = LoggerFactory.getLogger(Vsamdb2RepositoryImpl.class);
...
******         ,:WIDGET-DESC                                       
******     FROM TBWIDGET                                           
******     WHERE WIDGET_COLOR = :WIDGET-COLOR                      
******     ORDER BY WIDGET_NUM ASC                                 
**/
...
try {
	...
	// execute SQLJ query
	ResultSet resultSet = db2Base.startQuery(1/* SQL Sequence*/, CONSTANTS.LITERAL_VSAMDB2)
.withSql(SQLS.SQL_1721319705)
				.withInputs(tbxmlwgt.getWidgetColor())
