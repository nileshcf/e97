...
/**
 * The Vsamdb2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Vsamdb2 vsamdb2 = (Vsamdb2) context.getBean("vsamdb2");
        	    vsamdb2.process(new GlobalExecutorCtx().getContext(Vsamdb2Ctx.class)); /*  Vsamdb2 requires no input parameters  */
