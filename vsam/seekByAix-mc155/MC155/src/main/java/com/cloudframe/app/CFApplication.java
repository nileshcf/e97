...
/**
 * The Mc155 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mc155 mc155 = (Mc155) context.getBean("mc155");
        	    mc155.process(new GlobalExecutorCtx().getContext(Mc155Ctx.class)); /*  Mc155 requires no input parameters  */
