package com.cloudframe.app.vsammon9.dto;
...
import com.cloudframe.app.vsammon9.dto.serialize.*;
...
public class Work extends WorkSerialized {
						...
						private char[] monitorFileStatus = Field.fillLowValue(2);
	...
	*  Corresponding COBOL Variable is MONITOR-FILE-STATUS
	*  @param value
	**/
   public void setMonitorFileStatus(char[] value) {
       value = checkMonitorFileStatusConstraints(value);
       arraycopy(value,0,monitorFileStatus,0,value.length);
   } 
	public void setMonitorFileStatus(char[] value , int beginIndex, int endIndex) {
       //value = checkL1CtlData801Constraints(value);
       arraycopy(value,beginIndex,monitorFileStatus,0,beginIndex + endIndex);
   }
	/**
