...
/**
 * The Vsammon9 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Vsammon9 vsammon9 = (Vsammon9) context.getBean("vsammon9");
        	    vsammon9.process(new GlobalExecutorCtx().getContext(Vsammon9Ctx.class)); /*  Vsammon9 requires no input parameters  */
