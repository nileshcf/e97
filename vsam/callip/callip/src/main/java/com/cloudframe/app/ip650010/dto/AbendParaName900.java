...
public class AbendParaName900 extends AbendParaName900Serialized { 
   ...
   public void setAbendPara900(Field source, int sourceIndex,int sourceLen, int targetIndex,int targetLen) {
	...
	char[] para12008890088Value = "1200-OPEN-OPT-PARM-FILE       ".toCharArray();
	/**
   ...
   public boolean isPara120088900() throws CFException {
      return (  compareChars( getAbendPara900() , para12008890088Value)  == 0  );
   }
	...
	*/
   	public void setPara120088900True() {  			
    	setAbendPara900( para12008890088Value);
   	}
	char[] para81008890088Value = "8100-READ-CHECK-STATUS        ".toCharArray();
	/**
	 *	Test condition "8100-READ-CHECK-STATUS" for isPara810088900()
	 *	@return  Returns true if isPara810088900() is "8100-READ-CHECK-STATUS"
	 */
   public boolean isPara810088900() throws CFException {
      return (  compareChars( getAbendPara900() , para81008890088Value)  == 0  );
   }


	/**
	*  set values "8100-READ-CHECK-STATUS"
	*/
   	public void setPara810088900True() {  			
    	setAbendPara900( para81008890088Value);
   	}
	char[] para83008890088Value = "8300-CLOSE-OPT-PARM-FILE      ".toCharArray();
	/**
   ...
   public boolean isPara830088900() throws CFException {
      return (  compareChars( getAbendPara900() , para83008890088Value)  == 0  );
   }
	...
	*/
   	public void setPara830088900True() {  			
    	setAbendPara900( para83008890088Value);
   	}
