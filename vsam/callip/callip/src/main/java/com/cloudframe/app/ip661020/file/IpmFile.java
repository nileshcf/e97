package com.cloudframe.app.ip661020.file;
...
import com.cloudframe.app.ip661020.file.records.*;

@Component("ip661020_ipmFile")
public class IpmFile extends CFFile {

	private Logger logger = LoggerFactory.getLogger(IpmFile.class);
	
	@Value("${IP661020.IpmFile:SYS003}")
    ...
    **/
	@Value("${IP661020.IpmFileCharSet:cp1047}")
	private String charSet;
	
	@Value("${IP661020.IpmFileCRLFflag:no}")
