...
/**
 * The Vsammon7 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Vsammon7 vsammon7 = (Vsammon7) context.getBean("vsammon7");
        	    vsammon7.process(new GlobalExecutorCtx().getContext(Vsammon7Ctx.class)); /*  Vsammon7 requires no input parameters  */
