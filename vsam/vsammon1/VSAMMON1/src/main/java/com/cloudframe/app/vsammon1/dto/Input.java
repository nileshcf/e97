...
public class Input extends InputSerialized { 
	...
	*/
	...
	char[] cProgram188Value = "PROGRM*".toCharArray();
	/**
   ...
   public boolean isCProgram1() throws CFException {
      return (  compareChars( getInputCommand() , cProgram188Value)  == 0  );
   }
	...
	*  set values "PROGRM*"
	*/
   	public void setCProgram1True() {  			
    	setInputCommand( cProgram188Value);
   	}
	...
	*/
	...
	char[] cKeyreadn88Value = "KYREADN".toCharArray();
	/**
   ...
   public boolean isCKeyreadn() throws CFException {
      return (  compareChars( getInputCommand() , cKeyreadn88Value)  == 0  );
   }
	...
	*  set values "KYREADN"
	*/
   	public void setCKeyreadnTrue() {  			
    	setInputCommand( cKeyreadn88Value);
   	}
