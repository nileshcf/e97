...
/**
 * The Vsammon1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Vsammon1 vsammon1 = (Vsammon1) context.getBean("vsammon1");
        	    vsammon1.process(new GlobalExecutorCtx().getContext(Vsammon1Ctx.class)); /*  Vsammon1 requires no input parameters  */
