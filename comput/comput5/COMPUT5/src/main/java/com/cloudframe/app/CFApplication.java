...
/**
 * The Comput5 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Comput5 comput5 = (Comput5) context.getBean("comput5");
        	    comput5.process(new GlobalExecutorCtx().getContext(Comput5Ctx.class)); /*  Comput5 requires no input parameters  */
