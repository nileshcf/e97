...
/**
 * The Comput1 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Comput1 comput1 = (Comput1) context.getBean("comput1");
        	    comput1.process(new GlobalExecutorCtx().getContext(Comput1Ctx.class)); /*  Comput1 requires no input parameters  */
