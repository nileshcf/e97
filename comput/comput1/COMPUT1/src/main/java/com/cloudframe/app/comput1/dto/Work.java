...
import com.cloudframe.app.comput1.dto.serialize.*;
...
public class Work extends WorkSerialized { 
								...
								private BigDecimal rlu3aAcctPlanDataAllow = BigDecimal.ZERO;

								private int cGigabyteNum;

								private int cKilobyteNum;

								private int cMegabyteNum;
	...
	**/
	...
	public BigDecimal getRlu3aAcctPlanDataAllow() throws CFException {
        if (isRlu3aAcctPlanDataAllowModified()) { 
           rlu3aAcctPlanDataAllow = refreshRlu3aAcctPlanDataAllow();
        }
   		return rlu3aAcctPlanDataAllow;
	}

    public char[] getRlu3aAcctPlanDataAllowString() {
          return  rlu3aAcctPlanDataAllowString();
    }
	
	/**
	 * 	Update Rlu3aAcctPlanDataAllow with the passed number
	 *  Corresponding COBOL Variable is LK-RLU3A-ACCT-PLAN-DATA-ALLOW
	 *	@param number
	 */
	public void setRlu3aAcctPlanDataAllow(BigDecimal number) {	
     rlu3aAcctPlanDataAllow = checkRlu3aAcctPlanDataAllowMaxLimit(number);
	    serializeRlu3aAcctPlanDataAllow(rlu3aAcctPlanDataAllow);
   }
	/**
	 ...
	 *  Corresponding COBOL Variable is C-GIGABYTE-NUM
	 *	@param number
	 */
	public void setCGigabyteNum(int number) {
	     // Truncate if the number is beyond +/- Max range
	    cGigabyteNum = checkCGigabyteNumMaxLimit(number); 
	}


	public void setCGigabyteNum(long number) {
	    number = checkCGigabyteNumMaxLimit(number); // Truncate if value is beyond +/- Max range
		setCGigabyteNum((int)number);
	}
	 ...
	 *  Corresponding COBOL Variable is C-MEGABYTE-NUM
	 *	@param number
	 */
	public void setCMegabyteNum(int number) {
	     // Truncate if the number is beyond +/- Max range
	    cMegabyteNum = checkCMegabyteNumMaxLimit(number); 
	}


	public void setCMegabyteNum(long number) {
	    number = checkCMegabyteNumMaxLimit(number); // Truncate if value is beyond +/- Max range
		setCMegabyteNum((int)number);
	}
