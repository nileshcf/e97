...
/**
 * The Comput2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Comput2 comput2 = (Comput2) context.getBean("comput2");
        	    comput2.process(new GlobalExecutorCtx().getContext(Comput2Ctx.class)); /*  Comput2 requires no input parameters  */
