...
/**
 * The Comput3 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Comput3 comput3 = (Comput3) context.getBean("comput3");
        	    comput3.process(new GlobalExecutorCtx().getContext(Comput3Ctx.class)); /*  Comput3 requires no input parameters  */
