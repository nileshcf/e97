...
/**
*  The class MiscAreasSerialized is used to define offsets in order to serialize
*  in a fixed String
...
public class MiscAreasSerialized  extends Field { 

    protected Logger logger = LoggerFactory.getLogger(MiscAreasSerialized.class);
	/*  Length of the field, if serialized as a String */
	protected static final int MISC_AREAS_LENGTH = 18;
   /*  offset of each of Child Fields when serialized as a String */
	...
	/**
	* Constructor for MiscAreasSerialized
	**/
    public MiscAreasSerialized() {
		   			init(0);
    }
 
	/**
	* initializes the field in MiscAreasSerialized
	**/
	@Override
	protected void init(int begin) {
	   setStartOffset(begin);
	   setLength(MISC_AREAS_LENGTH);
